...
@org.osgi.service.component.annotations.Component(
        immediate = true,
        service = party.mkkp.edemokracia.edemokracia.operation.edemokracia.service.userissues.CreateIssue.class)
public class CreateIssueCustomImplementation
        implements party.mkkp.edemokracia.edemokracia.operation.edemokracia.service.userissues.CreateIssue {
    ...
    public party.mkkp.edemokracia.edemokracia.api.edemokracia.service.issue.Issue apply(
            party.mkkp.edemokracia.edemokracia.api.edemokracia.service.createissueinput.CreateIssueInput input) {
        ...
        IssueForCreate issueCreate = IssueForCreate.builder()
                ...
                .withIssueType(
                        input.getIssueType() != null && input.getIssueType().isPresent()
                                ? input.getIssueType().get().adaptTo(IssueType.class)
                                : null)
                .withCounty(
                        input.getCounty() != null && input.getCounty().isPresent()
                                ? input.getCounty().get().adaptTo(County.class)
                                : null)
                .withCity(
                        input.getCity() != null && input.getCity().isPresent()
                                ? input.getCity().get().adaptTo(City.class)
                                : null)
                .withDistrict(
                        input.getDistrict() != null && input.getDistrict().isPresent()
                                ? input.getDistrict().get().adaptTo(District.class)
                                : null)
                .withCreatedBy(user)
                .withOwner(user)
                .build();
        ...
        return adminIssueDao
                .getById(issue.identifier().adaptTo(IssueIdentifier.class))
                .get();
    }
}
