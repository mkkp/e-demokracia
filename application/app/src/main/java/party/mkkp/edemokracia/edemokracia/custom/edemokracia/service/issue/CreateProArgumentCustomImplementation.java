 ...
 * }
 * 
 * issue.pros += new edemokracia::Pro(createdBy = user, title = this.title, description = input.description);
 * 
 * 
 * Usage:
 ...
 */
//@org.osgi.service.component.annotations.Component(immediate = true, service = party.mkkp.edemokracia.edemokracia.operation.edemokracia.service.issue.CreateProArgument.class)
public class CreateProArgumentCustomImplementation implements party.mkkp.edemokracia.edemokracia.operation.edemokracia.service.issue.CreateProArgument {
    ...
    public void accept(party.mkkp.edemokracia.edemokracia.api.edemokracia.service.issue.Issue _this, party.mkkp.edemokracia.edemokracia.api.edemokracia.createargumentinput.CreateArgumentInput input)  {
        throw new java.lang.UnsupportedOperationException("Operation not implemented: party.mkkp.edemokracia.edemokracia.osgi.edemokracia.service.issue.CreateProArgumentExchangeFunctionsComponent");
    }
