...
package party.mkkp.edemokracia.edemokracia.custom.edemokracia.admin.userissues;
...
import party.mkkp.edemokracia.edemokracia.api.edemokracia._default_transferobjecttypes.debate.Debate;
import party.mkkp.edemokracia.edemokracia.api.edemokracia._default_transferobjecttypes.debate.DebateAttachedRelationsForCreate;
import party.mkkp.edemokracia.edemokracia.api.edemokracia._default_transferobjecttypes.debate.DebateDao;
...
import party.mkkp.edemokracia.edemokracia.api.edemokracia.admin.issue.IssueIdentifier;
import party.mkkp.edemokracia.edemokracia.api.edemokracia.debatestatus.DebateStatus;
 ...
 *
 * 
 * var edemokracia::Debate debate = new edemokracia::Debate(
 * 	title = input.title, 
 * 	description = input.description,
 * 	closeAt = input.debateCloseAt,
 * 	createdBy = owner,
 * 	status = edemokracia::DebateStatus#CREATED
 * );
 * 
 * issue.debates += debate;
 * 
 * return issue; 
 * 
 * Usage:
 ...
 */
@org.osgi.service.component.annotations.Component(immediate = true, service = party.mkkp.edemokracia.edemokracia.operation.edemokracia.admin.userissues.CreateIssue.class)
public class CreateIssueCustomImplementation implements party.mkkp.edemokracia.edemokracia.operation.edemokracia.admin.userissues.CreateIssue {
    ...
    @Reference
    party.mkkp.edemokracia.edemokracia.api.edemokracia.admin.issue.IssueDao adminIssueDao;

    @Reference
    DebateDao debateDao;

    public party.mkkp.edemokracia.edemokracia.api.edemokracia.admin.issue.Issue apply(party.mkkp.edemokracia.edemokracia.api.edemokracia.admin.createissueinput.CreateIssueInput input)  {
        ...
        Debate debate = Debate.builder()
                .withStatus(DebateStatus.CREATED)
                .withCloseAt(input.getDebateCloseAt())
                .withDescription(input.getDescription())
                .withTitle(input.getTitle())
                .build();

        debate = debateDao.create(debate, DebateAttachedRelationsForCreate.builder()
                        .withCreatedBy(user)
                        .withOwner(user)
                        .withIssue(issue)
                .build());
