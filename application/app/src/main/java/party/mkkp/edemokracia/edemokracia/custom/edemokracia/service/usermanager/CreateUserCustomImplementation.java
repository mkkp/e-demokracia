 ...
 * 
 * 
 * var edemokracia::service::ServicePrincipalUser user = edemokracia::service::ServicePrincipalUser!filter(u | u.userName == input.userName)!any();
 * 
 * if (user!isUndefined()) {
 * 	user = new edemokracia::service::ServicePrincipalUser(
 * 	    userName = input.userName,
 * 	    email = input.email,
 * 	    lastName = input.lastName,
 * 	    firstName = input.firstName,
 * 	    isAdmin = input.hasAdminAccess,
 * 	    phone = input.phone
 *     )
 * }
 * return user;
 * 
 * Usage:
 *  1. Rename this file from CreateUserCustomImplementation.java.default to CreateUserCustomImplementation.java
 *  2. Implement method
