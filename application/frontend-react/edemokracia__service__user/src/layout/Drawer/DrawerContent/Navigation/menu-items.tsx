...
export const menus: NavItemType[] = [
  ...
  {
    id: 'NavigationItemedemokraciaServiceUserEdemokraciaServiceUserNavigationControllerEdemokraciaServiceUserUserDebatesNavigationItem',
    type: 'item',
    url: 'service/user/user_debates/view/:signedIdentifier',
    icon: 'wechat',
    title: 'Debates',
    children: [],
  },
  ...
  },
  {
    ...
    children: [
      ...
      {
        id: 'NavigationItemedemokraciaServiceUserEdemokraciaServiceUserNavigationControllerEdemokraciaServiceUserMenuItemGroupAdministrativeMenuGroupEdemokraciaServiceUserAdminDebatesNavigationItem',
        type: 'item',
        url: 'service/user/admin_debates/table',
        icon: 'wechat',
        title: 'All Debates',
        children: [],
      },
