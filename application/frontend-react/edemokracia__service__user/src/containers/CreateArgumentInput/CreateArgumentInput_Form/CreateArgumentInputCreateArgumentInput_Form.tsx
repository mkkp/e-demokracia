      ...
      <Grid item data-name="CreateArgumentInput_Form" xs={12} sm={12} md={36.0}>
        ...
        >
          <Grid item data-name="group" xs={12} sm={12}>
            <Card id="User/(esm/_h6ID0IfREe2u0fVmwtP5bA)/GroupVisualElement" data-name="group" sx={{ height: '100%' }}>
              <CardContent>
                <Grid
                  container
                  direction="row"
                  ...
                  <Grid item>
                    <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                      ...
                      <Typography
                        ...
                        component="h1"
                      >
                        {t('CreateArgumentInput.CreateArgumentInput_Form.group', { defaultValue: 'Add argument' })}
                      </Typography>
                    </Grid>
                  </Grid>
                </Grid>
