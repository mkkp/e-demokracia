  ...
  return (
    <Grid container spacing={2} direction="column" alignItems="stretch" justifyContent="flex-start">
      <Grid item xs={12} sm={12}>
        <Grid
          id="_fo3cpn2GEe6V8KKnnZfChA)/LabelWrapper"
          container
          direction="column"
          alignItems="center"
        ...
        >
          <Grid item xs={12} sm={12}>
            <Grid container direction="row" alignItems="center" justifyContent="flex-start">
              ...
              <Typography id="_fo3cpn2GEe6V8KKnnZfChA)/Label" variant="h5" component="h1">
                {t(
                  'YesNoVoteInput.YesNoVoteInput.Form.value::Label.value::LabelWrapper.YesNoVoteInput_Form.YesNoVoteInput::YesNoVoteInput_Form',
                  { defaultValue: 'Vote' },
                )}
              </Typography>
            </Grid>
          ...
          <Grid item xs={12} sm={12}>
            ...
            >
              <InputLabel id="User/(esm/_HrXDYKlbEe2kkPT1Lcj30A)/EnumerationTypeRadio" shrink={true} size={'small'}>
                {t(
                  'YesNoVoteInput.YesNoVoteInput.Form.value.value::LabelWrapper.YesNoVoteInput_Form.YesNoVoteInput::YesNoVoteInput_Form',
                  { defaultValue: 'Vote' },
                )}
              </InputLabel>
              <RadioGroup
                ...
                name="value"
                id="User/(esm/_HrXDYKlbEe2kkPT1Lcj30A)/EnumerationTypeRadio"
                value={data.value || ''}
                onChange={(event) => {
      ...
      <Grid item xs={12} sm={12}>
        <TextField
          ...
          label={
            t('YesNoVoteInput.YesNoVoteInput.Form.value.YesNoVoteInput_Form.YesNoVoteInput::YesNoVoteInput_Form', {
              defaultValue: 'Vote',
            }) as string
          }
          value={data.value || ''}
