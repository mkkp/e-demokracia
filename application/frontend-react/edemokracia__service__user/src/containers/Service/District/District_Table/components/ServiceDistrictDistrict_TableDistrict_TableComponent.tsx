...
export interface ServiceDistrictDistrict_TableDistrict_TableComponentActionDefinitions {
  ...
  exportAction?: (queryCustomizer: ServiceDistrictQueryCustomizer) => Promise<void>;
  ...
  openPageAction?: (row: ServiceDistrictStored, isDraft?: boolean) => Promise<void>;
...
export const SERVICE_DISTRICT_DISTRICT_TABLE_DISTRICT_TABLE_COMPONENT_SIDEKICK_COMPONENT_INTERFACE_KEY =
  'ServiceDistrictDistrict_TableDistrict_TableComponentSidekickComponent';
...
export function ServiceDistrictDistrict_TableDistrict_TableComponent(
  ...
  const sidekickComponentFilter = `(&(${OBJECTCLASS}=${CUSTOM_VISUAL_ELEMENT_INTERFACE_KEY})(component=${SERVICE_DISTRICT_DISTRICT_TABLE_DISTRICT_TABLE_COMPONENT_SIDEKICK_COMPONENT_INTERFACE_KEY}))`;
  const filterModelKey = `User/(esm/_a0UhZX2iEe2LTNnGda5kaw)/TransferObjectTableTable-${uniqueId}-${generatorUUIDv4}-filterModel`;
  const filtersKey = `User/(esm/_a0UhZX2iEe2LTNnGda5kaw)/TransferObjectTableTable-${uniqueId}-${generatorUUIDv4}-filters`;
  const rowsPerPageKey = `User/(esm/_a0UhZX2iEe2LTNnGda5kaw)/TransferObjectTableTable-${uniqueId}-${generatorUUIDv4}-rowsPerPage`;
    ...
    () => [
      {
        ...
        isCRUD: true,
        disabled: (row: ServiceDistrictStored) => getSelectedRows().length > 0 || isLoading,
      ...
      },
      {
        ...
        isCRUD: true,
        disabled: (row: ServiceDistrictStored) => getSelectedRows().length > 0 || !row.__deleteable || isLoading,
  ...
  const filterOptions = useMemo<FilterOption[]>(
    () => [
      {
        id: 'User/(esm/_1ZdVoIX1Ee2kLcMqsIbMgQ)/TableColumnFilter/(discriminator/User/(esm/_a0UhZX2iEe2LTNnGda5kaw)/TransferObjectTableTable)',
      ...
      {
        id: 'User/(esm/_1ZcukIX1Ee2kLcMqsIbMgQ)/TableColumnFilter/(discriminator/User/(esm/_a0UhZX2iEe2LTNnGda5kaw)/TransferObjectTableTable)',
        attributeName: 'city',
      ...
      {
        id: 'User/(esm/_dMVWoH4bEe2j59SYy0JH0Q)/TableColumnFilter/(discriminator/User/(esm/_a0UhZX2iEe2LTNnGda5kaw)/TransferObjectTableTable)',
        attributeName: 'name',
      ...
      <StripedDataGrid
        ...
        onRowClick={
          actions.openPageAction
            ? async (params: GridRowParams<ServiceDistrictStored>) => await actions.openPageAction!(params.row, false)
            : undefined
        }
        sortModel={sortModel}
          ...
          Toolbar: () => (
            <GridToolbarContainer>
              ...
              {actions.exportAction && true ? (
                <Button
                  id="User/(esm/_a0UhZX2iEe2LTNnGda5kaw)/TransferObjectTableExportButton"
