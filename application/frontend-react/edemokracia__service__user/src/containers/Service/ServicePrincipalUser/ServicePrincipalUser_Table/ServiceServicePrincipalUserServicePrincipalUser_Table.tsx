          ...
          <CardContent>
            <Grid item xs={12} sm={12}>
              <Typography id="User/(esm/_ndKGgGkwEe25ONJ3V89cVA)/TransferObjectTableEmpty">
                {
                  t(
                    'service.ServicePrincipalUser.ServicePrincipalUser.Table.ServicePrincipalUser_Table.ServicePrincipalUser_Table.service::ServicePrincipalUser::ServicePrincipalUser_Table',
