    ...
    <Grid container spacing={2} direction="column" alignItems="stretch" justifyContent="flex-start">
      <Grid item xs={12} sm={12}>
        <TextField
          ...
          autoFocus
          label={
            t('service.City.City.View.Edit.name.City_View_Edit.service::City::City_View_Edit', {
      ...
      <Grid item xs={12} sm={12}>
        <Grid
          id="User/(esm/_cLC8gIXhEe2kLcMqsIbMgQ)/TabularReferenceFieldRelationDefinedTable)/LabelWrapper"
          container
          direction="column"
          alignItems="center"
        ...
        >
          <Grid item xs={12} sm={12}>
            <Grid container direction="row" alignItems="center" justifyContent="flex-start">
              ...
              <Typography
                id="User/(esm/_cLC8gIXhEe2kLcMqsIbMgQ)/TabularReferenceFieldRelationDefinedTable)/Label"
                variant="h5"
                component="h1"
              >
                {t(
                  'service.City.City.View.Edit.districts::Label.districts::LabelWrapper.City_View_Edit.service::City::City_View_Edit',
