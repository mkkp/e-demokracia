...
export interface ServiceCityCity_TableSetSelectorCity_TableSetSelectorComponentProps {
  uniqueId: string;
  actions: ServiceCityCity_TableSetSelectorCity_TableSetSelectorComponentActionDefinitions;
...
// XMIID: User/(esm/_a0Xkt32iEe2LTNnGda5kaw)/TransferObjectTableSetSelectorTable
// Name: City_Table::Set::Selector
export function ServiceCityCity_TableSetSelectorCity_TableSetSelectorComponent(
  props: ServiceCityCity_TableSetSelectorCity_TableSetSelectorComponentProps,
) {
  const {
    uniqueId,
    actions,
  ...
  const filterModelKey = `User/(esm/_a0Xkt32iEe2LTNnGda5kaw)/TransferObjectTableSetSelectorTable-${uniqueId}-filterModel`;
  const filtersKey = `User/(esm/_a0Xkt32iEe2LTNnGda5kaw)/TransferObjectTableSetSelectorTable-${uniqueId}-filters`;
  ...
  const filterOptions = useMemo<FilterOption[]>(
    () => [
      {
        id: 'User/(esm/_IgwWoIX2Ee2kLcMqsIbMgQ)/TableColumnFilter/(discriminator/User/(esm/_a0Xkt32iEe2LTNnGda5kaw)/TransferObjectTableSetSelectorTable)',
      ...
      {
        id: 'User/(esm/_dL7uAH4bEe2j59SYy0JH0Q)/TableColumnFilter/(discriminator/User/(esm/_a0Xkt32iEe2LTNnGda5kaw)/TransferObjectTableSetSelectorTable)',
        attributeName: 'name',
          ...
          Toolbar: () => (
            <GridToolbarContainer>
              ...
              {actions.openFormAction && true ? (
                <Button
                  id="User/(esm/_a0Xkt32iEe2LTNnGda5kaw)/TransferObjectTableSetSelectorTableCreateButton"
