      ...
      <DialogActions>
        {!editMode && actions.backAction && (
          <Grid className="page-action" item>
            ...
            >
              <span>
                {t('service.RatingVoteDefinition.RatingVoteDefinition_View_Edit.VoteEntryBase.virtual.owner.Back', {
                  defaultValue: 'Back',
                })}
              </span>
            </LoadingButton>
        ...
        {!editMode && actions.setAction && (
          <Grid className="page-action" item>
            ...
            >
              <span>
                {t('service.RatingVoteDefinition.RatingVoteDefinition_View_Edit.VoteEntryBase.virtual.owner.Set', {
                  defaultValue: 'Set',
                })}
              </span>
            </LoadingButton>
