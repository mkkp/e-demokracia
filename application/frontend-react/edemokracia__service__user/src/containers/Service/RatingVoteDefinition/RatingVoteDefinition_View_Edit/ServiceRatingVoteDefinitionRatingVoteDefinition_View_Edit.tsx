...
export interface ServiceRatingVoteDefinitionRatingVoteDefinition_View_EditActionDefinitions
  ...
  getCloseAtValidationProps?: (data: ServiceRatingVoteDefinition) => BaseDateValidationProps;
  getCreatedValidationProps?: (data: ServiceRatingVoteDefinition) => BaseDateValidationProps;
  getMask?: () => string;
}
      ...
      <Grid item data-name="RatingVoteDefinition_View_Edit" xs={12} sm={12} md={36.0}>
        ...
        >
                  ...
                  <Grid item>
                    <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                      <Typography
                        ...
                        component="h1"
                      >
                        {t('service.RatingVoteDefinition.RatingVoteDefinition_View_Edit.userVoteEntryGroup', {
          ...
          <Grid item data-name="VoteEntryBase" xs={12} sm={12}>
            <Card
              id="User/(esm/_NHnIwFsoEe6Mx9dH3yj5gQ)/GroupVisualElement"
