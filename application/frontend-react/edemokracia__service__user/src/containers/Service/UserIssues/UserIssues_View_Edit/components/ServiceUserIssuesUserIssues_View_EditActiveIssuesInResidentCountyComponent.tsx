...
export interface ServiceUserIssuesUserIssues_View_EditActiveIssuesInResidentCountyComponentActionDefinitions {
  ...
  activeIssuesInResidentCountyOpenPageAction?: (row: ServiceIssueStored) => Promise<void>;
}
...
export function ServiceUserIssuesUserIssues_View_EditActiveIssuesInResidentCountyComponent(
  ...
  const rowActions: TableRowAction<ServiceIssueStored>[] = [
    {
      id: 'User/(esm/_8M4nYHj_Ee6cB8og8p0UuQ)/OperationFormTableRowCallOperationButton/(discriminator/_WoFt9I7EEe6rlbj78nBB0Q)',
    ...
    {
      id: 'User/(esm/_FzSAQHkIEe6cB8og8p0UuQ)/OperationFormTableRowCallOperationButton/(discriminator/_WoFt9I7EEe6rlbj78nBB0Q)',
    ...
    {
      id: 'User/(esm/_qJPPA3jvEe6cB8og8p0UuQ)/OperationFormTableRowCallOperationButton/(discriminator/_WoFt9I7EEe6rlbj78nBB0Q)',
    ...
    {
      id: 'User/(esm/_S8tEQIydEe2VSOmaAz6G9Q)/OperationFormTableRowCallOperationButton/(discriminator/_WoFt9I7EEe6rlbj78nBB0Q)',
    ...
    {
      id: 'User/(esm/_pXWdEHkFEe6cB8og8p0UuQ)/OperationFormTableRowCallOperationButton/(discriminator/_WoFt9I7EEe6rlbj78nBB0Q)',
    ...
    {
      id: 'User/(esm/_knYd0FxEEe6ma86ynyYZNw)/OperationFormTableRowCallOperationButton/(discriminator/_WoFt9I7EEe6rlbj78nBB0Q)',
    ...
    {
      id: 'User/(esm/_FzSnUHkIEe6cB8og8p0UuQ)/OperationFormTableRowCallOperationButton/(discriminator/_WoFt9I7EEe6rlbj78nBB0Q)',
    ...
    {
      id: 'User/(esm/_qJPPC3jvEe6cB8og8p0UuQ)/OperationFormTableRowCallOperationButton/(discriminator/_WoFt9I7EEe6rlbj78nBB0Q)',
    ...
    {
      id: 'User/(esm/_knZE4FxEEe6ma86ynyYZNw)/OperationFormTableRowCallOperationButton/(discriminator/_WoFt9I7EEe6rlbj78nBB0Q)',
  ...
  async function fetchData() {
    if (!isLoading && ownerData.__signedIdentifier) {
      ...
      try {
        const res = await actions.activeIssuesInResidentCountyRefreshAction!(processQueryCustomizer(queryCustomizer));
        ...
        onRowClick={
          actions.activeIssuesInResidentCountyOpenPageAction
            ? async (params: GridRowParams<ServiceIssueStored>) =>
                await actions.activeIssuesInResidentCountyOpenPageAction!(params.row)
            : undefined
        }
        sortModel={sortModel}
          ...
          Toolbar: () => (
            <GridToolbarContainer>
              {actions.activeIssuesInResidentCountyFilterAction && true ? (
                ...
                >
                  {t(
                    'service.UserIssues.UserIssues_View_Edit.root.tabBar.activeIssuesByResidentArea.tabBar.activeByResidentInCounty.activeIssuesInResidentCounty.Filter',
              ...
              {actions.activeIssuesInResidentCountyRefreshAction && true ? (
                <Button
                  ...
                  variant={'text'}
                  onClick={async () => {
                    await actions.activeIssuesInResidentCountyRefreshAction!(processQueryCustomizer(queryCustomizer));
                  }}
                  disabled={isLoading}
                >
                  {t(
                    'service.UserIssues.UserIssues_View_Edit.root.tabBar.activeIssuesByResidentArea.tabBar.activeByResidentInCounty.activeIssuesInResidentCounty.Refresh',
