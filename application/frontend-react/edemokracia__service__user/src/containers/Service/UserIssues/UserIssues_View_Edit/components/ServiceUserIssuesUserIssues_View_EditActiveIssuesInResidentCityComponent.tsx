...
export interface ServiceUserIssuesUserIssues_View_EditActiveIssuesInResidentCityComponentActionDefinitions {
  ...
  activeIssuesInResidentCityOpenPageAction?: (row: ServiceIssueStored, isDraft?: boolean) => Promise<void>;
  activeIssuesInResidentCityAdditionalToolbarButtons?: (
...
export const SERVICE_USER_ISSUES_USER_ISSUES_VIEW_EDIT_ACTIVE_ISSUES_IN_RESIDENT_CITY_COMPONENT_SIDEKICK_COMPONENT_INTERFACE_KEY =
  'ServiceUserIssuesUserIssues_View_EditActiveIssuesInResidentCityComponentSidekickComponent';
...
export function ServiceUserIssuesUserIssues_View_EditActiveIssuesInResidentCityComponent(
  ...
  const sidekickComponentFilter = `(&(${OBJECTCLASS}=${CUSTOM_VISUAL_ELEMENT_INTERFACE_KEY})(component=${SERVICE_USER_ISSUES_USER_ISSUES_VIEW_EDIT_ACTIVE_ISSUES_IN_RESIDENT_CITY_COMPONENT_SIDEKICK_COMPONENT_INTERFACE_KEY}))`;
  const filterModelKey = `User/(esm/_BZzIUVrcEe6gN-oVBDDIOQ)/TabularReferenceFieldRelationDefinedTable-${uniqueId}-${generatorUUIDv4}-filterModel`;
  const filtersKey = `User/(esm/_BZzIUVrcEe6gN-oVBDDIOQ)/TabularReferenceFieldRelationDefinedTable-${uniqueId}-${generatorUUIDv4}-filters`;
  const rowsPerPageKey = `User/(esm/_BZzIUVrcEe6gN-oVBDDIOQ)/TabularReferenceFieldRelationDefinedTable-${uniqueId}-${generatorUUIDv4}-rowsPerPage`;
  ...
  const countyRepresentationColumn: GridColDef<ServiceIssueStored> = {
    ...
    headerName: t('service.UserIssues.UserIssues_View_Edit.activeIssuesInResidentCity.countyRepresentation', {
  ...
  const cityRepresentationColumn: GridColDef<ServiceIssueStored> = {
    ...
    headerName: t('service.UserIssues.UserIssues_View_Edit.activeIssuesInResidentCity.cityRepresentation', {
  ...
  const titleColumn: GridColDef<ServiceIssueStored> = {
    ...baseColumnConfig,
    field: 'title',
    headerName: t('service.UserIssues.UserIssues_View_Edit.activeIssuesInResidentCity.title', {
      defaultValue: 'Title',
    }) as string,
    headerClassName: 'data-grid-column-header',
  ...
  const createdColumn: GridColDef<ServiceIssueStored> = {
    ...baseColumnConfig,
    field: 'created',
    headerName: t('service.UserIssues.UserIssues_View_Edit.activeIssuesInResidentCity.created', {
  ...
  const statusColumn: GridColDef<ServiceIssueStored> = {
    ...baseColumnConfig,
    field: 'status',
    headerName: t('service.UserIssues.UserIssues_View_Edit.activeIssuesInResidentCity.status', {
      defaultValue: 'Status',
    }) as string,
    headerClassName: 'data-grid-column-header',
  ...
  const rowActions: TableRowAction<ServiceIssueStored>[] = useMemo(
    () => [
      ...
      {
        id: 'User/(esm/_qJPPC3jvEe6cB8og8p0UuQ)/OperationFormTableRowCallOperationButton/(discriminator/User/(esm/_BZzIUVrcEe6gN-oVBDDIOQ)/TabularReferenceTableRowButtonGroup)',
      ...
      {
        id: 'User/(esm/_qJPPA3jvEe6cB8og8p0UuQ)/OperationFormTableRowCallOperationButton/(discriminator/User/(esm/_BZzIUVrcEe6gN-oVBDDIOQ)/TabularReferenceTableRowButtonGroup)',
  ...
  const additionalToolbarActions: Record<string, ElementType> =
    actions?.activeIssuesInResidentCityAdditionalToolbarButtons
      ? actions.activeIssuesInResidentCityAdditionalToolbarButtons(
          data,
          isLoading,
          getSelectedRows(),
  ...
  const filterOptions = useMemo<FilterOption[]>(
    () => [
      {
        id: 'User/(esm/_2-ZgIFw-Ee6gN-oVBDDIOQ)/TableColumnFilter/(discriminator/User/(esm/_BZzIUVrcEe6gN-oVBDDIOQ)/TabularReferenceFieldRelationDefinedTable)',
      ...
      {
        id: 'User/(esm/_0yPKkFw-Ee6gN-oVBDDIOQ)/TableColumnFilter/(discriminator/User/(esm/_BZzIUVrcEe6gN-oVBDDIOQ)/TabularReferenceFieldRelationDefinedTable)',
      ...
      {
        id: 'User/(esm/_SRGAIFrdEe6gN-oVBDDIOQ)/TableColumnFilter/(discriminator/User/(esm/_BZzIUVrcEe6gN-oVBDDIOQ)/TabularReferenceFieldRelationDefinedTable)',
        attributeName: 'title',
      ...
      {
        id: 'User/(esm/_Xc9BAFrdEe6gN-oVBDDIOQ)/TableColumnFilter/(discriminator/User/(esm/_BZzIUVrcEe6gN-oVBDDIOQ)/TabularReferenceFieldRelationDefinedTable)',
      ...
      {
        id: 'User/(esm/_Xc9oEFrdEe6gN-oVBDDIOQ)/TableColumnFilter/(discriminator/User/(esm/_BZzIUVrcEe6gN-oVBDDIOQ)/TabularReferenceFieldRelationDefinedTable)',
    ...
    if (ownerData.__signedIdentifier) {
      ...
      try {
        const processedQueryCustomizer = {
          ...
          _mask: actions.getActiveIssuesInResidentCityMask
        ...
        onRowClick={
          actions.activeIssuesInResidentCityOpenPageAction
            ? async (params: GridRowParams<ServiceIssueStored>) =>
                await actions.activeIssuesInResidentCityOpenPageAction!(params.row, false)
            : undefined
        }
        sortModel={sortModel}
              ...
              {actions.activeIssuesInResidentCityRefreshAction && true ? (
                <Button
                  ...
                  onClick={async () => {
                    ...
                    await actions.activeIssuesInResidentCityRefreshAction!(processedQueryCustomizer);
                  }}
                  disabled={isLoading}
                >
