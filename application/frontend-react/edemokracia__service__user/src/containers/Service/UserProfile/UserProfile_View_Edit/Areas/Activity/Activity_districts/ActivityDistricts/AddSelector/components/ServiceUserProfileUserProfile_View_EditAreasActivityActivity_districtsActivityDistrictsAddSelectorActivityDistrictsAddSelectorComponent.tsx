...
export interface ServiceUserProfileUserProfile_View_EditAreasActivityActivity_districtsActivityDistrictsAddSelectorActivityDistrictsAddSelectorComponentProps {
  uniqueId: string;
  actions: ServiceUserProfileUserProfile_View_EditAreasActivityActivity_districtsActivityDistrictsAddSelectorActivityDistrictsAddSelectorComponentActionDefinitions;
...
export function ServiceUserProfileUserProfile_View_EditAreasActivityActivity_districtsActivityDistrictsAddSelectorActivityDistrictsAddSelectorComponent(
  props: ServiceUserProfileUserProfile_View_EditAreasActivityActivity_districtsActivityDistrictsAddSelectorActivityDistrictsAddSelectorComponentProps,
) {
  const {
    uniqueId,
    actions,
  ...
  const filterModelKey = `User/(esm/_fsW_sFvTEe6jm_SkPSYEYw)/TabularReferenceFieldTableAddSelectorTable-${uniqueId}-${generatorUUIDv4}-filterModel`;
  const filtersKey = `User/(esm/_fsW_sFvTEe6jm_SkPSYEYw)/TabularReferenceFieldTableAddSelectorTable-${uniqueId}-${generatorUUIDv4}-filters`;
  const rowsPerPageKey = `User/(esm/_fsW_sFvTEe6jm_SkPSYEYw)/TabularReferenceFieldTableAddSelectorTable-${uniqueId}-${generatorUUIDv4}-rowsPerPage`;
  ...
  const representationColumn: GridColDef<ServiceDistrictStored> = {
    ...
    headerName: t(
      'service.UserProfile.UserProfile_View_Edit.Areas.activity.activity_districts.activityDistricts.AddSelector.representation',
  ...
  const filterOptions = useMemo<FilterOption[]>(
    () => [
      {
        id: 'User/(esm/_fsW_sVvTEe6jm_SkPSYEYw)/TableColumnFilter/(discriminator/User/(esm/_fsW_sFvTEe6jm_SkPSYEYw)/TabularReferenceFieldTableAddSelectorTable)',
          ...
          Toolbar: () => (
            <GridToolbarContainer>
              {actions.filterAction && true ? (
                <Button
                  id="User/(esm/_fsW_sFvTEe6jm_SkPSYEYw)/TabularReferenceFieldTableAddSelectorTableFilterButton"
                  startIcon={<MdiIcon path="filter" />}
                  variant={'text'}
                  onClick={async () => {
                    const filterResults = await actions.filterAction!(
                      'User/(esm/_fsW_sFvTEe6jm_SkPSYEYw)/TabularReferenceFieldTableAddSelectorTableFilterButton',
                      filterOptions,
                      filterModel,
                      filters,
                    );
              ...
              {actions.selectorRangeAction && true ? (
                <Button
                  id="User/(esm/_fsW_sFvTEe6jm_SkPSYEYw)/TabularReferenceFieldTableAddSelectorTableRefreshButton"
              ...
              {actions.openCreateFormAction && true ? (
                <Button
                  id="User/(esm/_fsW_sFvTEe6jm_SkPSYEYw)/TabularReferenceFieldTableAddSelectorTableCreateButton"
