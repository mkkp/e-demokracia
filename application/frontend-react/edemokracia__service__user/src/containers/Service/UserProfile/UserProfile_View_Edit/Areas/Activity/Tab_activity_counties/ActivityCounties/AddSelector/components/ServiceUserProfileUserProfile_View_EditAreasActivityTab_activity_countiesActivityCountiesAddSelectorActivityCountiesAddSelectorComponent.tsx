...
export interface ServiceUserProfileUserProfile_View_EditAreasActivityTab_activity_countiesActivityCountiesAddSelectorActivityCountiesAddSelectorComponentProps {
  uniqueId: string;
  actions: ServiceUserProfileUserProfile_View_EditAreasActivityTab_activity_countiesActivityCountiesAddSelectorActivityCountiesAddSelectorComponentActionDefinitions;
...
export const SERVICE_USER_PROFILE_USER_PROFILE_VIEW_EDIT_AREAS_ACTIVITY_TAB_ACTIVITY_COUNTIES_ACTIVITY_COUNTIES_ADD_SELECTOR_ACTIVITY_COUNTIES_ADD_SELECTOR_COMPONENT_SIDEKICK_COMPONENT_INTERFACE_KEY =
  'ServiceUserProfileUserProfile_View_EditAreasActivityTab_activity_countiesActivityCountiesAddSelectorActivityCountiesAddSelectorComponentSidekickComponent';

// XMIID: User/(esm/_fsW_qlvTEe6jm_SkPSYEYw)/TabularReferenceFieldTableAddSelectorTable
// Name: activityCounties::Add::Selector
export function ServiceUserProfileUserProfile_View_EditAreasActivityTab_activity_countiesActivityCountiesAddSelectorActivityCountiesAddSelectorComponent(
  props: ServiceUserProfileUserProfile_View_EditAreasActivityTab_activity_countiesActivityCountiesAddSelectorActivityCountiesAddSelectorComponentProps,
) {
  const {
    uniqueId,
    actions,
  ...
  const sidekickComponentFilter = `(&(${OBJECTCLASS}=${CUSTOM_VISUAL_ELEMENT_INTERFACE_KEY})(component=${SERVICE_USER_PROFILE_USER_PROFILE_VIEW_EDIT_AREAS_ACTIVITY_TAB_ACTIVITY_COUNTIES_ACTIVITY_COUNTIES_ADD_SELECTOR_ACTIVITY_COUNTIES_ADD_SELECTOR_COMPONENT_SIDEKICK_COMPONENT_INTERFACE_KEY}))`;
  const filterModelKey = `User/(esm/_fsW_qlvTEe6jm_SkPSYEYw)/TabularReferenceFieldTableAddSelectorTable-${uniqueId}-${generatorUUIDv4}-filterModel`;
  const filtersKey = `User/(esm/_fsW_qlvTEe6jm_SkPSYEYw)/TabularReferenceFieldTableAddSelectorTable-${uniqueId}-${generatorUUIDv4}-filters`;
  const rowsPerPageKey = `User/(esm/_fsW_qlvTEe6jm_SkPSYEYw)/TabularReferenceFieldTableAddSelectorTable-${uniqueId}-${generatorUUIDv4}-rowsPerPage`;
  ...
  const representationColumn: GridColDef<ServiceCountyStored> = {
    ...
    headerName: t(
      'service.UserProfile.UserProfile_View_Edit.Areas.activity.tab_activity_counties.activityCounties.AddSelector.representation',
      { defaultValue: 'County' },
    ) as string,
  ...
  const filterOptions = useMemo<FilterOption[]>(
    () => [
      {
        id: 'User/(esm/_fsW_q1vTEe6jm_SkPSYEYw)/TableColumnFilter/(discriminator/User/(esm/_fsW_qlvTEe6jm_SkPSYEYw)/TabularReferenceFieldTableAddSelectorTable)',
          ...
          Toolbar: () => (
            <GridToolbarContainer>
              {actions.filterAction && true ? (
                <Button
                  id="User/(esm/_fsW_qlvTEe6jm_SkPSYEYw)/TabularReferenceFieldTableAddSelectorTableFilterButton"
                  startIcon={<MdiIcon path="filter" />}
                  variant={'text'}
                  onClick={async () => {
                    const filterResults = await actions.filterAction!(
                      'User/(esm/_fsW_qlvTEe6jm_SkPSYEYw)/TabularReferenceFieldTableAddSelectorTableFilterButton',
                      filterOptions,
                      filterModel,
                      filters,
                    );
              ...
              {actions.selectorRangeAction && true ? (
                <Button
                  id="User/(esm/_fsW_qlvTEe6jm_SkPSYEYw)/TabularReferenceFieldTableAddSelectorTableRefreshButton"
