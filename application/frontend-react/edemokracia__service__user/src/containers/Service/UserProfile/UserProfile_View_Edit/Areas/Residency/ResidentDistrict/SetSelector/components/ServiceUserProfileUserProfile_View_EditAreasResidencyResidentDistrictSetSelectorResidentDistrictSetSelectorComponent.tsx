...
export function ServiceUserProfileUserProfile_View_EditAreasResidencyResidentDistrictSetSelectorResidentDistrictSetSelectorComponent(
  ...
  const filterModelKey = `User/(esm/_fsW_plvTEe6jm_SkPSYEYw)/TabularReferenceFieldLinkSetSelectorTable-${uniqueId}-filterModel`;
  const filtersKey = `User/(esm/_fsW_plvTEe6jm_SkPSYEYw)/TabularReferenceFieldLinkSetSelectorTable-${uniqueId}-filters`;
  const rowsPerPageKey = `User/(esm/_fsW_plvTEe6jm_SkPSYEYw)/TabularReferenceFieldLinkSetSelectorTable-${uniqueId}-rowsPerPage`;
