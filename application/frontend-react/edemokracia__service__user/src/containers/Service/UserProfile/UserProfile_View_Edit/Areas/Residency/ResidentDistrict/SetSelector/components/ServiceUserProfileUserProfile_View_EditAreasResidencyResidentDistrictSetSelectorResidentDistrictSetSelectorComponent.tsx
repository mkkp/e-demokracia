...
export interface ServiceUserProfileUserProfile_View_EditAreasResidencyResidentDistrictSetSelectorResidentDistrictSetSelectorComponentActionDefinitions {
...
export interface ServiceUserProfileUserProfile_View_EditAreasResidencyResidentDistrictSetSelectorResidentDistrictSetSelectorComponentProps {
  uniqueId: string;
  actions: ServiceUserProfileUserProfile_View_EditAreasResidencyResidentDistrictSetSelectorResidentDistrictSetSelectorComponentActionDefinitions;
...
export const SERVICE_USER_PROFILE_USER_PROFILE_VIEW_EDIT_AREAS_RESIDENCY_RESIDENT_DISTRICT_SET_SELECTOR_RESIDENT_DISTRICT_SET_SELECTOR_COMPONENT_SIDEKICK_COMPONENT_INTERFACE_KEY =
  'ServiceUserProfileUserProfile_View_EditAreasResidencyResidentDistrictSetSelectorResidentDistrictSetSelectorComponentSidekickComponent';

// XMIID: User/(esm/_fsW_plvTEe6jm_SkPSYEYw)/TabularReferenceFieldLinkSetSelectorTable
// Name: residentDistrict::Set::Selector
export function ServiceUserProfileUserProfile_View_EditAreasResidencyResidentDistrictSetSelectorResidentDistrictSetSelectorComponent(
  props: ServiceUserProfileUserProfile_View_EditAreasResidencyResidentDistrictSetSelectorResidentDistrictSetSelectorComponentProps,
) {
  const {
    uniqueId,
    actions,
  ...
  const sidekickComponentFilter = `(&(${OBJECTCLASS}=${CUSTOM_VISUAL_ELEMENT_INTERFACE_KEY})(component=${SERVICE_USER_PROFILE_USER_PROFILE_VIEW_EDIT_AREAS_RESIDENCY_RESIDENT_DISTRICT_SET_SELECTOR_RESIDENT_DISTRICT_SET_SELECTOR_COMPONENT_SIDEKICK_COMPONENT_INTERFACE_KEY}))`;
  const filterModelKey = `User/(esm/_fsW_plvTEe6jm_SkPSYEYw)/TabularReferenceFieldLinkSetSelectorTable-${uniqueId}-${generatorUUIDv4}-filterModel`;
  const filtersKey = `User/(esm/_fsW_plvTEe6jm_SkPSYEYw)/TabularReferenceFieldLinkSetSelectorTable-${uniqueId}-${generatorUUIDv4}-filters`;
  const rowsPerPageKey = `User/(esm/_fsW_plvTEe6jm_SkPSYEYw)/TabularReferenceFieldLinkSetSelectorTable-${uniqueId}-${generatorUUIDv4}-rowsPerPage`;
  ...
  const representationColumn: GridColDef<ServiceDistrictStored> = {
    ...
    headerName: t(
      'service.UserProfile.UserProfile_View_Edit.Areas.Residency.residentDistrict.SetSelector.representation',
  ...
  const effectiveTableColumns = useMemo(() => {
    const cols = [
      ...columns,
      ...columnsActionCalculator('User/(esm/_CQxg0FvSEe6jm_SkPSYEYw)/RelationType', rowActions, t, {
  ...
  const filterOptions = useMemo<FilterOption[]>(
    () => [
      {
        id: 'User/(esm/_fsW_p1vTEe6jm_SkPSYEYw)/TableColumnFilter/(discriminator/User/(esm/_fsW_plvTEe6jm_SkPSYEYw)/TabularReferenceFieldLinkSetSelectorTable)',
          ...
          Toolbar: () => (
            <GridToolbarContainer>
              {actions.filterAction && true ? (
                <Button
                  id="User/(esm/_fsW_plvTEe6jm_SkPSYEYw)/TabularReferenceFieldLinkSetSelectorTableFilterButton"
                  startIcon={<MdiIcon path="filter" />}
                  variant={'text'}
                  onClick={async () => {
                    const filterResults = await actions.filterAction!(
                      'User/(esm/_fsW_plvTEe6jm_SkPSYEYw)/TabularReferenceFieldLinkSetSelectorTableFilterButton',
                      filterOptions,
                      filterModel,
                      filters,
                    );
              ...
              {actions.selectorRangeAction && true ? (
                <Button
                  id="User/(esm/_fsW_plvTEe6jm_SkPSYEYw)/TabularReferenceFieldLinkSetSelectorTableRefreshButton"
              ...
              {actions.openCreateFormAction && true ? (
                <Button
                  id="User/(esm/_fsW_plvTEe6jm_SkPSYEYw)/TabularReferenceFieldLinkSetSelectorTableCreateButton"
