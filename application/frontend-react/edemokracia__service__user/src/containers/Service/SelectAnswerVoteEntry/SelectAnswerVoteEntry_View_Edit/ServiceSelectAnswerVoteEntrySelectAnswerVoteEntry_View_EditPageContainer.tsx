...
export interface ServiceSelectAnswerVoteEntrySelectAnswerVoteEntry_View_EditPageActions
...
export default function ServiceSelectAnswerVoteEntrySelectAnswerVoteEntry_View_EditPage(
  props: ServiceSelectAnswerVoteEntrySelectAnswerVoteEntry_View_EditPageProps,
) {
