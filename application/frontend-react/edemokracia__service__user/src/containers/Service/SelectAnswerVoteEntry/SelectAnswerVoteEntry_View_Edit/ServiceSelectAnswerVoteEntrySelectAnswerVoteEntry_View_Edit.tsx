    ...
    <Grid container spacing={2} direction="column" alignItems="stretch" justifyContent="flex-start">
      <Grid item xs={12} sm={12}>
        <DateTimePicker
          ...
          label={
            t(
              'service.SelectAnswerVoteEntry.SelectAnswerVoteEntry.View.Edit.created.SelectAnswerVoteEntry_View_Edit.service::SelectAnswerVoteEntry::SelectAnswerVoteEntry_View_Edit',
      ...
      <Grid item xs={12} sm={12}>
        <TextField
          ...
          label={
            t(
              'service.SelectAnswerVoteEntry.SelectAnswerVoteEntry.View.Edit.valueRepresentation.SelectAnswerVoteEntry_View_Edit.service::SelectAnswerVoteEntry::SelectAnswerVoteEntry_View_Edit',
