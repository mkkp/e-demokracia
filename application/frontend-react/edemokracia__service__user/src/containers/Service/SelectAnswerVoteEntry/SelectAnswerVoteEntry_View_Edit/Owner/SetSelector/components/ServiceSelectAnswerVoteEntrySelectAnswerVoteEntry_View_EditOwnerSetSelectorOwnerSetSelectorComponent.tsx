...
export interface ServiceSelectAnswerVoteEntrySelectAnswerVoteEntry_View_EditOwnerSetSelectorOwnerSetSelectorComponentProps {
  uniqueId: string;
  actions: ServiceSelectAnswerVoteEntrySelectAnswerVoteEntry_View_EditOwnerSetSelectorOwnerSetSelectorComponentActionDefinitions;
...
export const SERVICE_SELECT_ANSWER_VOTE_ENTRY_SELECT_ANSWER_VOTE_ENTRY_VIEW_EDIT_OWNER_SET_SELECTOR_OWNER_SET_SELECTOR_COMPONENT_SIDEKICK_COMPONENT_INTERFACE_KEY =
  'ServiceSelectAnswerVoteEntrySelectAnswerVoteEntry_View_EditOwnerSetSelectorOwnerSetSelectorComponentSidekickComponent';

// XMIID: User/(esm/_Eq0jMFuXEe6T042_LMmSdQ)/TabularReferenceFieldLinkSetSelectorTable
// Name: owner::Set::Selector
export function ServiceSelectAnswerVoteEntrySelectAnswerVoteEntry_View_EditOwnerSetSelectorOwnerSetSelectorComponent(
  props: ServiceSelectAnswerVoteEntrySelectAnswerVoteEntry_View_EditOwnerSetSelectorOwnerSetSelectorComponentProps,
) {
  const {
    uniqueId,
    actions,
  ...
  const sidekickComponentFilter = `(&(${OBJECTCLASS}=${CUSTOM_VISUAL_ELEMENT_INTERFACE_KEY})(component=${SERVICE_SELECT_ANSWER_VOTE_ENTRY_SELECT_ANSWER_VOTE_ENTRY_VIEW_EDIT_OWNER_SET_SELECTOR_OWNER_SET_SELECTOR_COMPONENT_SIDEKICK_COMPONENT_INTERFACE_KEY}))`;
  const filterModelKey = `User/(esm/_Eq0jMFuXEe6T042_LMmSdQ)/TabularReferenceFieldLinkSetSelectorTable-${uniqueId}-${generatorUUIDv4}-filterModel`;
  const filtersKey = `User/(esm/_Eq0jMFuXEe6T042_LMmSdQ)/TabularReferenceFieldLinkSetSelectorTable-${uniqueId}-${generatorUUIDv4}-filters`;
  const rowsPerPageKey = `User/(esm/_Eq0jMFuXEe6T042_LMmSdQ)/TabularReferenceFieldLinkSetSelectorTable-${uniqueId}-${generatorUUIDv4}-rowsPerPage`;
  ...
  const representationColumn: GridColDef<ServiceServiceUserStored> = {
    ...
    headerName: t('service.SelectAnswerVoteEntry.SelectAnswerVoteEntry_View_Edit.owner.SetSelector.representation', {
  ...
  const effectiveTableColumns = useMemo(() => {
    const cols = [
      ...columns,
      ...columnsActionCalculator('User/(esm/_vVuuYFtpEe6Mx9dH3yj5gQ)/RelationType', rowActions, t, {
  ...
  const filterOptions = useMemo<FilterOption[]>(
    () => [
      {
        id: 'User/(esm/_Eq2YYVuXEe6T042_LMmSdQ)/TableColumnFilter/(discriminator/User/(esm/_Eq0jMFuXEe6T042_LMmSdQ)/TabularReferenceFieldLinkSetSelectorTable)',
        attributeName: 'representation',
        label: t('service.SelectAnswerVoteEntry.SelectAnswerVoteEntry_View_Edit.owner.SetSelector.representation', {
          defaultValue: 'Representation',
        }) as string,
          ...
          Toolbar: () => (
            <GridToolbarContainer>
              {actions.filterAction && true ? (
                <Button
                  id="User/(esm/_Eq0jMFuXEe6T042_LMmSdQ)/TabularReferenceFieldLinkSetSelectorTableFilterButton"
                  startIcon={<MdiIcon path="filter" />}
                  variant={'text'}
                  onClick={async () => {
                    const filterResults = await actions.filterAction!(
                      'User/(esm/_Eq0jMFuXEe6T042_LMmSdQ)/TabularReferenceFieldLinkSetSelectorTableFilterButton',
                      filterOptions,
                      filterModel,
                      filters,
                    );
              ...
              {actions.selectorRangeAction && true ? (
                <Button
                  id="User/(esm/_Eq0jMFuXEe6T042_LMmSdQ)/TabularReferenceFieldLinkSetSelectorTableRefreshButton"
