...
export interface ServiceSimpleVoteSimpleVote_View_EditPageActions
...
export interface ServiceSimpleVoteSimpleVote_View_EditPageProps {
  actions: ServiceSimpleVoteSimpleVote_View_EditPageActions;
  isLoading: boolean;
  editMode: boolean;
...
export default function ServiceSimpleVoteSimpleVote_View_EditPage(
  props: ServiceSimpleVoteSimpleVote_View_EditPageProps,
) {
