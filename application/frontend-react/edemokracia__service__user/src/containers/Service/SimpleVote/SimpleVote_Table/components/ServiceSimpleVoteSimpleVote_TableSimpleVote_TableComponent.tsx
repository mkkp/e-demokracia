...
export interface ServiceSimpleVoteSimpleVote_TableSimpleVote_TableComponentActionDefinitions {
  ...
  openPageAction?: (row: ServiceSimpleVoteStored, isDraft?: boolean) => Promise<void>;
...
export function ServiceSimpleVoteSimpleVote_TableSimpleVote_TableComponent(
  ...
  const filterModelKey = `User/(esm/_p9JT0GksEe25ONJ3V89cVA)/TransferObjectTableTable-${uniqueId}-${generatorUUIDv4}-filterModel`;
  const filtersKey = `User/(esm/_p9JT0GksEe25ONJ3V89cVA)/TransferObjectTableTable-${uniqueId}-${generatorUUIDv4}-filters`;
  const rowsPerPageKey = `User/(esm/_p9JT0GksEe25ONJ3V89cVA)/TransferObjectTableTable-${uniqueId}-${generatorUUIDv4}-rowsPerPage`;
  ...
  const rowActions: TableRowAction<ServiceSimpleVoteStored>[] = useMemo(
    () => [
      {
      ...
      <StripedDataGrid
        ...
        onRowClick={
          actions.openPageAction
            ? async (params: GridRowParams<ServiceSimpleVoteStored>) => await actions.openPageAction!(params.row, false)
            : undefined
        }
        sortModel={sortModel}
          ...
          Toolbar: () => (
            <GridToolbarContainer>
              ...
              {actions.exportAction && true ? (
                <Button
                  id="User/(esm/_p9JT0GksEe25ONJ3V89cVA)/TransferObjectTableExportButton"
