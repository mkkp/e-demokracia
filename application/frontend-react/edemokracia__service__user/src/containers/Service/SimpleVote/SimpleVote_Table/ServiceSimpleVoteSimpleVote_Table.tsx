...
export const SERVICE_SIMPLE_VOTE_SIMPLE_VOTE_TABLE_CONTAINER_ACTIONS_HOOK_INTERFACE_KEY =
  'SERVICE_SIMPLE_VOTE_SIMPLE_VOTE_TABLE_CONTAINER_ACTIONS_HOOK';
  ...
  return (
    <Grid container>
      <Grid item data-name="SimpleVote_Table" xs={12} sm={12} md={36.0}>
        <Card id="User/(esm/_p9JT0GksEe25ONJ3V89cVA)/TransferObjectTableVisualElement" data-name="SimpleVote_Table">
          <CardContent>
