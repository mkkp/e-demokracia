...
export const SERVICE_SIMPLE_VOTE_SIMPLE_VOTE_TABLE_ADD_SELECTOR_SIMPLE_VOTE_TABLE_ADD_SELECTOR_COMPONENT_SIDEKICK_COMPONENT_INTERFACE_KEY =
  'ServiceSimpleVoteSimpleVote_TableAddSelectorSimpleVote_TableAddSelectorComponentSidekickComponent';
