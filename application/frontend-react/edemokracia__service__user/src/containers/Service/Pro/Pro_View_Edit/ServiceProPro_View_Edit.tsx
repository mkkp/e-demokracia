      ...
      <Grid item data-name="Pro_View_Edit" xs={12} sm={12} md={36.0}>
        ...
        >
          <Grid item data-name="pro" xs={12} sm={12}>
            <Card id="User/(esm/_OUB-QIfiEe2u0fVmwtP5bA)/GroupVisualElement" data-name="pro" sx={{ height: '100%' }}>
              <CardContent>
                <Grid
                  container
                  direction="row"
                  ...
                  <Grid item>
                    <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                      ...
                      <Typography
                        ...
                        component="h1"
                      >
                        {t('service.Pro.Pro_View_Edit.pro', { defaultValue: 'Pro' })}
                      </Typography>
                    </Grid>
                  </Grid>
                </Grid>
          ...
          <Grid item data-name="Arguments" xs={12} sm={12}>
            ...
            >
              <Grid item data-name="pros" xs={12} sm={12} md={6.0}>
                <Card id="User/(esm/_KRUbMXjvEe6cB8og8p0UuQ)/GroupVisualElement" data-name="pros">
                  <CardContent>
                    <Grid
                      container
                      direction="row"
                      ...
                      <Grid item>
                        <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                          ...
                          <Typography
                            ...
                            component="h1"
                          >
                            {t('service.Pro.Pro_View_Edit.pros', { defaultValue: 'Pros' })}
                          </Typography>
                        </Grid>
                      </Grid>
                    </Grid>
              ...
              <Grid item data-name="cons" xs={12} sm={12} md={6.0}>
                <Card id="User/(esm/_KRUbOXjvEe6cB8og8p0UuQ)/GroupVisualElement" data-name="cons">
                  <CardContent>
                    <Grid
                      container
                      direction="row"
                      ...
                      <Grid item>
                        <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                          ...
                          <Typography
                            ...
                            component="h1"
                          >
                            {t('service.Pro.Pro_View_Edit.cons', { defaultValue: 'Cons' })}
                          </Typography>
                        </Grid>
                      </Grid>
                    </Grid>
