...
export interface ServiceProPro_FormDialogActions extends ServiceProPro_FormActionDefinitions {
  getTemplateAction?: () => Promise<JudoRestResponse<ServicePro>>;
...
export default function ServiceProPro_FormDialog(props: ServiceProPro_FormDialogProps) {
  ...
  const queryCustomizer: ServiceProQueryCustomizer = {
    _mask:
      '{created,createdByName,description,downVotes,title,upVotes,cons{created,createdByName,description,downVotes,title,upVotes},pros{created,createdByName,description,downVotes,title,upVotes},createdBy{created,email,firstName,isAdmin,lastName,phone,representation,userName}}',
  };
              ...
              >
                <span>
                  {isDraft
                    ...
                    : t('service.Pro.Pro_Form.Create', { defaultValue: 'Create' })}
                </span>
              </LoadingButton>
              {!isDraft && (
                <Button
