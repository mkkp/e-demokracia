...
export interface ServiceDashboardDashboard_View_EditSelectorVotesVotesTabBarFavoriteVotesGroupFavoriteVoteDefinitionsAddSelectorFavoriteVoteDefinitionsAddSelectorComponentProps {
  uniqueId: string;
  actions: ServiceDashboardDashboard_View_EditSelectorVotesVotesTabBarFavoriteVotesGroupFavoriteVoteDefinitionsAddSelectorFavoriteVoteDefinitionsAddSelectorComponentActionDefinitions;
...
export const SERVICE_DASHBOARD_DASHBOARD_VIEW_EDIT_SELECTOR_VOTES_VOTES_TAB_BAR_FAVORITE_VOTES_GROUP_FAVORITE_VOTE_DEFINITIONS_ADD_SELECTOR_FAVORITE_VOTE_DEFINITIONS_ADD_SELECTOR_COMPONENT_SIDEKICK_COMPONENT_INTERFACE_KEY =
  'ServiceDashboardDashboard_View_EditSelectorVotesVotesTabBarFavoriteVotesGroupFavoriteVoteDefinitionsAddSelectorFavoriteVoteDefinitionsAddSelectorComponentSidekickComponent';

// XMIID: User/(esm/_vp60sGBWEe6M1JBD8stPIg)/TabularReferenceFieldTableAddSelectorTable
// Name: favoriteVoteDefinitions::Add::Selector
export function ServiceDashboardDashboard_View_EditSelectorVotesVotesTabBarFavoriteVotesGroupFavoriteVoteDefinitionsAddSelectorFavoriteVoteDefinitionsAddSelectorComponent(
  props: ServiceDashboardDashboard_View_EditSelectorVotesVotesTabBarFavoriteVotesGroupFavoriteVoteDefinitionsAddSelectorFavoriteVoteDefinitionsAddSelectorComponentProps,
) {
  const {
    uniqueId,
    actions,
  ...
  const scopeColumn: GridColDef<ServiceVoteDefinitionStored> = {
    ...
    field: 'scope',
    headerName: t(
      'service.Dashboard.Dashboard_View_Edit.Selector.votes.votesTabBar.favoriteVotesGroup.favoriteVoteDefinitions.AddSelector.scope',
      { defaultValue: 'Scope' },
    ) as string,
  ...
  const countyRepresentationColumn: GridColDef<ServiceVoteDefinitionStored> = {
    ...
    headerName: t(
      'service.Dashboard.Dashboard_View_Edit.Selector.votes.votesTabBar.favoriteVotesGroup.favoriteVoteDefinitions.AddSelector.countyRepresentation',
  ...
  const cityRepresentationColumn: GridColDef<ServiceVoteDefinitionStored> = {
    ...
    headerName: t(
      'service.Dashboard.Dashboard_View_Edit.Selector.votes.votesTabBar.favoriteVotesGroup.favoriteVoteDefinitions.AddSelector.cityRepresentation',
  ...
  const districtRepresentationColumn: GridColDef<ServiceVoteDefinitionStored> = {
    ...
    headerName: t(
      'service.Dashboard.Dashboard_View_Edit.Selector.votes.votesTabBar.favoriteVotesGroup.favoriteVoteDefinitions.AddSelector.districtRepresentation',
  ...
  const titleColumn: GridColDef<ServiceVoteDefinitionStored> = {
    ...
    field: 'title',
    headerName: t(
      'service.Dashboard.Dashboard_View_Edit.Selector.votes.votesTabBar.favoriteVotesGroup.favoriteVoteDefinitions.AddSelector.title',
      { defaultValue: 'Title' },
    ) as string,
    headerClassName: 'data-grid-column-header',
  ...
  const voteTypeColumn: GridColDef<ServiceVoteDefinitionStored> = {
    ...
    field: 'voteType',
    headerName: t(
      'service.Dashboard.Dashboard_View_Edit.Selector.votes.votesTabBar.favoriteVotesGroup.favoriteVoteDefinitions.AddSelector.voteType',
  ...
  const createdColumn: GridColDef<ServiceVoteDefinitionStored> = {
    ...
    field: 'created',
    headerName: t(
      'service.Dashboard.Dashboard_View_Edit.Selector.votes.votesTabBar.favoriteVotesGroup.favoriteVoteDefinitions.AddSelector.created',
  ...
  const closeAtColumn: GridColDef<ServiceVoteDefinitionStored> = {
    ...
    field: 'closeAt',
    headerName: t(
      'service.Dashboard.Dashboard_View_Edit.Selector.votes.votesTabBar.favoriteVotesGroup.favoriteVoteDefinitions.AddSelector.closeAt',
  ...
  const numberOfVotesColumn: GridColDef<ServiceVoteDefinitionStored> = {
    ...
    field: 'numberOfVotes',
    headerName: t(
      'service.Dashboard.Dashboard_View_Edit.Selector.votes.votesTabBar.favoriteVotesGroup.favoriteVoteDefinitions.AddSelector.numberOfVotes',
  ...
  const statusColumn: GridColDef<ServiceVoteDefinitionStored> = {
    ...
    field: 'status',
    headerName: t(
      'service.Dashboard.Dashboard_View_Edit.Selector.votes.votesTabBar.favoriteVotesGroup.favoriteVoteDefinitions.AddSelector.status',
      { defaultValue: 'Status' },
    ) as string,
    headerClassName: 'data-grid-column-header',
  ...
  const additionalToolbarActions: Record<string, ElementType> = actions?.favoriteVoteDefinitionsAdditionalToolbarButtons
    ? actions.favoriteVoteDefinitionsAdditionalToolbarButtons(data, isLoading, getSelectedRows(), clearSelections)
    : {};
  ...
  const filterOptions = useMemo<FilterOption[]>(
    () => [
      {
        id: 'User/(esm/_vp94A2BWEe6M1JBD8stPIg)/TableColumnFilter/(discriminator/User/(esm/_vp60sGBWEe6M1JBD8stPIg)/TabularReferenceFieldTableAddSelectorTable)',
        attributeName: 'scope',
        label: t(
          'service.Dashboard.Dashboard_View_Edit.Selector.votes.votesTabBar.favoriteVotesGroup.favoriteVoteDefinitions.AddSelector.scope',
          { defaultValue: 'Scope' },
      ...
      {
        id: 'User/(esm/_vp-fEWBWEe6M1JBD8stPIg)/TableColumnFilter/(discriminator/User/(esm/_vp60sGBWEe6M1JBD8stPIg)/TabularReferenceFieldTableAddSelectorTable)',
      ...
      {
        id: 'User/(esm/_vp-fE2BWEe6M1JBD8stPIg)/TableColumnFilter/(discriminator/User/(esm/_vp60sGBWEe6M1JBD8stPIg)/TabularReferenceFieldTableAddSelectorTable)',
      ...
      {
        id: 'User/(esm/_vp-fEGBWEe6M1JBD8stPIg)/TableColumnFilter/(discriminator/User/(esm/_vp60sGBWEe6M1JBD8stPIg)/TabularReferenceFieldTableAddSelectorTable)',
      ...
      {
        id: 'User/(esm/_vp7bwGBWEe6M1JBD8stPIg)/TableColumnFilter/(discriminator/User/(esm/_vp60sGBWEe6M1JBD8stPIg)/TabularReferenceFieldTableAddSelectorTable)',
        attributeName: 'title',
        label: t(
          'service.Dashboard.Dashboard_View_Edit.Selector.votes.votesTabBar.favoriteVotesGroup.favoriteVoteDefinitions.AddSelector.title',
          { defaultValue: 'Title' },
      ...
      {
        id: 'User/(esm/_vp94AmBWEe6M1JBD8stPIg)/TableColumnFilter/(discriminator/User/(esm/_vp60sGBWEe6M1JBD8stPIg)/TabularReferenceFieldTableAddSelectorTable)',
      ...
      {
        id: 'User/(esm/_vp7bwWBWEe6M1JBD8stPIg)/TableColumnFilter/(discriminator/User/(esm/_vp60sGBWEe6M1JBD8stPIg)/TabularReferenceFieldTableAddSelectorTable)',
      ...
      {
        id: 'User/(esm/_vp8C0mBWEe6M1JBD8stPIg)/TableColumnFilter/(discriminator/User/(esm/_vp60sGBWEe6M1JBD8stPIg)/TabularReferenceFieldTableAddSelectorTable)',
      ...
      {
        id: 'User/(esm/_vp94AWBWEe6M1JBD8stPIg)/TableColumnFilter/(discriminator/User/(esm/_vp60sGBWEe6M1JBD8stPIg)/TabularReferenceFieldTableAddSelectorTable)',
      ...
      {
        id: 'User/(esm/_vp8C0WBWEe6M1JBD8stPIg)/TableColumnFilter/(discriminator/User/(esm/_vp60sGBWEe6M1JBD8stPIg)/TabularReferenceFieldTableAddSelectorTable)',
  ...
  return (
    <div
      ...
      data-table-name="favoriteVoteDefinitions::Add::Selector"
    >
      <ComponentProxy
          ...
          Toolbar: () => (
            <GridToolbarContainer>
              {actions.filterAction && true ? (
                <Button
                  id="User/(esm/_vp60sGBWEe6M1JBD8stPIg)/TabularReferenceFieldTableAddSelectorTableFilterButton"
                  startIcon={<MdiIcon path="filter" />}
                  variant={'text'}
                  onClick={async () => {
                    const filterResults = await actions.filterAction!(
                      'User/(esm/_vp60sGBWEe6M1JBD8stPIg)/TabularReferenceFieldTableAddSelectorTableFilterButton',
                      filterOptions,
                      filterModel,
                      filters,
                    );
              ...
              {actions.selectorRangeAction && true ? (
                <Button
                  id="User/(esm/_vp60sGBWEe6M1JBD8stPIg)/TabularReferenceFieldTableAddSelectorTableRefreshButton"
