...
export default function ServiceYesNoVoteDefinitionYesNoVoteDefinition_View_Edit(
  ...
  return (
    <Grid container spacing={2} direction="column" alignItems="stretch" justifyContent="flex-start">
      ...
      <Grid item xs={12} sm={12}>
        <Card id="_twx_ko1KEe6sgdrBpAinBQ)/LabelWrapper">
          <CardContent>
            <Grid container direction="column" alignItems="stretch" justifyContent="flex-start" spacing={2}>
              <Grid item xs={12} sm={12}>
                <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                  <Typography id="_twx_ko1KEe6sgdrBpAinBQ)/Label" variant="h5" component="h1">
              ...
              <Grid item xs={12} sm={12}>
                ...
                >
                  ...
                  <Grid item xs={12} sm={12} md={4.0}>
                    ...
                    >
                      {t('service.YesNoVoteDefinition.YesNoVoteDefinition_View_Edit.issue', { defaultValue: 'Issue' })}
      ...
      <Grid item xs={12} sm={12}>
        <Grid
          id="_tw24EI1KEe6sgdrBpAinBQ)/LabelWrapper"
          container
          direction="column"
          alignItems="center"
          justifyContent="flex-start"
        ...
        >
          <Grid item xs={12} sm={12}>
            <Grid container direction="row" alignItems="center" justifyContent="flex-start">
              <Typography id="_tw24EI1KEe6sgdrBpAinBQ)/Label" variant="h5" component="h1">
