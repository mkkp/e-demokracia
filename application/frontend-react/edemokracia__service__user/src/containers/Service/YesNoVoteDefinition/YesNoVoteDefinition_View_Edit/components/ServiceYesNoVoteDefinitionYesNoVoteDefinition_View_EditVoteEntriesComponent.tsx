...
export const SERVICE_YES_NO_VOTE_DEFINITION_YES_NO_VOTE_DEFINITION_VIEW_EDIT_VOTE_ENTRIES_COMPONENT_SIDEKICK_COMPONENT_INTERFACE_KEY =
  'ServiceYesNoVoteDefinitionYesNoVoteDefinition_View_EditVoteEntriesComponentSidekickComponent';
...
export function ServiceYesNoVoteDefinitionYesNoVoteDefinition_View_EditVoteEntriesComponent(
  ...
  const sidekickComponentFilter = `(&(${OBJECTCLASS}=${CUSTOM_VISUAL_ELEMENT_INTERFACE_KEY})(component=${SERVICE_YES_NO_VOTE_DEFINITION_YES_NO_VOTE_DEFINITION_VIEW_EDIT_VOTE_ENTRIES_COMPONENT_SIDEKICK_COMPONENT_INTERFACE_KEY}))`;
  const filterModelKey = `User/(esm/_jimiQFovEe6_67aMO2jOsw)/TabularReferenceFieldRelationDefinedTable-${uniqueId}-${generatorUUIDv4}-filterModel`;
  const filtersKey = `User/(esm/_jimiQFovEe6_67aMO2jOsw)/TabularReferenceFieldRelationDefinedTable-${uniqueId}-${generatorUUIDv4}-filters`;
  const rowsPerPageKey = `User/(esm/_jimiQFovEe6_67aMO2jOsw)/TabularReferenceFieldRelationDefinedTable-${uniqueId}-${generatorUUIDv4}-rowsPerPage`;
  ...
  const SidekickComponent =
    useTrackComponent<FC<SidekickComponentProps<ServiceYesNoVoteEntryStored>>>(sidekickComponentFilter);
  ...
  const valueColumn: GridColDef<ServiceYesNoVoteEntryStored> = {
    ...baseColumnConfig,
    field: 'value',
    headerName: t('service.YesNoVoteDefinition.YesNoVoteDefinition_View_Edit.voteEntries.value', {
      defaultValue: 'Value',
    }) as string,
  ...
  const createdColumn: GridColDef<ServiceYesNoVoteEntryStored> = {
    ...baseColumnConfig,
    field: 'created',
    headerName: t('service.YesNoVoteDefinition.YesNoVoteDefinition_View_Edit.voteEntries.created', {
  ...
  const createdByColumn: GridColDef<ServiceYesNoVoteEntryStored> = {
    ...baseColumnConfig,
    field: 'createdBy',
    headerName: t('service.YesNoVoteDefinition.YesNoVoteDefinition_View_Edit.voteEntries.createdBy', {
  ...
  const getSelectedRows: () => ServiceYesNoVoteEntryStored[] = () => {
    return [];
  };
