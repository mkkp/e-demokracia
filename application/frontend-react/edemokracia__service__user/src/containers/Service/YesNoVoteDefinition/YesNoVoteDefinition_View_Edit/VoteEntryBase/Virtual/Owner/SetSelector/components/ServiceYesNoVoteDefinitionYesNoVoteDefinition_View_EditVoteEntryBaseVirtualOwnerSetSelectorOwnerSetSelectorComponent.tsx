...
export interface ServiceYesNoVoteDefinitionYesNoVoteDefinition_View_EditVoteEntryBaseVirtualOwnerSetSelectorOwnerSetSelectorComponentProps {
  uniqueId: string;
  actions: ServiceYesNoVoteDefinitionYesNoVoteDefinition_View_EditVoteEntryBaseVirtualOwnerSetSelectorOwnerSetSelectorComponentActionDefinitions;
...
export const SERVICE_YES_NO_VOTE_DEFINITION_YES_NO_VOTE_DEFINITION_VIEW_EDIT_VOTE_ENTRY_BASE_VIRTUAL_OWNER_SET_SELECTOR_OWNER_SET_SELECTOR_COMPONENT_SIDEKICK_COMPONENT_INTERFACE_KEY =
  'ServiceYesNoVoteDefinitionYesNoVoteDefinition_View_EditVoteEntryBaseVirtualOwnerSetSelectorOwnerSetSelectorComponentSidekickComponent';

// XMIID: User/(esm/_UUiHQHz6Ee6Q9LyUVjs1Qw)/TabularReferenceFieldLinkSetSelectorTable
// Name: owner::Set::Selector
export function ServiceYesNoVoteDefinitionYesNoVoteDefinition_View_EditVoteEntryBaseVirtualOwnerSetSelectorOwnerSetSelectorComponent(
  props: ServiceYesNoVoteDefinitionYesNoVoteDefinition_View_EditVoteEntryBaseVirtualOwnerSetSelectorOwnerSetSelectorComponentProps,
) {
  const {
    uniqueId,
    actions,
  ...
  const sidekickComponentFilter = `(&(${OBJECTCLASS}=${CUSTOM_VISUAL_ELEMENT_INTERFACE_KEY})(component=${SERVICE_YES_NO_VOTE_DEFINITION_YES_NO_VOTE_DEFINITION_VIEW_EDIT_VOTE_ENTRY_BASE_VIRTUAL_OWNER_SET_SELECTOR_OWNER_SET_SELECTOR_COMPONENT_SIDEKICK_COMPONENT_INTERFACE_KEY}))`;
  const filterModelKey = `User/(esm/_UUiHQHz6Ee6Q9LyUVjs1Qw)/TabularReferenceFieldLinkSetSelectorTable-${uniqueId}-${generatorUUIDv4}-filterModel`;
  const filtersKey = `User/(esm/_UUiHQHz6Ee6Q9LyUVjs1Qw)/TabularReferenceFieldLinkSetSelectorTable-${uniqueId}-${generatorUUIDv4}-filters`;
  const rowsPerPageKey = `User/(esm/_UUiHQHz6Ee6Q9LyUVjs1Qw)/TabularReferenceFieldLinkSetSelectorTable-${uniqueId}-${generatorUUIDv4}-rowsPerPage`;
  ...
  const representationColumn: GridColDef<ServiceServiceUserStored> = {
    ...
    headerName: t(
      'service.YesNoVoteDefinition.YesNoVoteDefinition_View_Edit.VoteEntryBase.virtual.owner.SetSelector.representation',
  ...
  const effectiveTableColumns = useMemo(() => {
    const cols = [
      ...columns,
      ...columnsActionCalculator('User/(esm/_DxjSkHz5Ee6Q9LyUVjs1Qw)/RelationType', rowActions, t, {
  ...
  const filterOptions = useMemo<FilterOption[]>(
    () => [
      {
        id: 'User/(esm/_UUlKkHz6Ee6Q9LyUVjs1Qw)/TableColumnFilter/(discriminator/User/(esm/_UUiHQHz6Ee6Q9LyUVjs1Qw)/TabularReferenceFieldLinkSetSelectorTable)',
          ...
          Toolbar: () => (
            <GridToolbarContainer>
              {actions.filterAction && true ? (
                <Button
                  id="User/(esm/_UUiHQHz6Ee6Q9LyUVjs1Qw)/TabularReferenceFieldLinkSetSelectorTableFilterButton"
                  startIcon={<MdiIcon path="filter" />}
                  variant={'text'}
                  onClick={async () => {
                    const filterResults = await actions.filterAction!(
                      'User/(esm/_UUiHQHz6Ee6Q9LyUVjs1Qw)/TabularReferenceFieldLinkSetSelectorTableFilterButton',
                      filterOptions,
                      filterModel,
                      filters,
                    );
              ...
              {actions.selectorRangeAction && true ? (
                <Button
                  id="User/(esm/_UUiHQHz6Ee6Q9LyUVjs1Qw)/TabularReferenceFieldLinkSetSelectorTableRefreshButton"
