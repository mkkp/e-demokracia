            ...
            <GridToolbarContainer>
              {actions.filterAction && true ? (
                <Button
                  ...
                  disabled={isLoading}
                >
                  {t('service.RatingVoteEntry.RatingVoteEntry_View_Edit.owner.Table.Filter', {
              ...
              {actions.selectorRangeAction && true ? (
                <Button
                  ...
                  disabled={isLoading}
                >
                  {t('service.RatingVoteEntry.RatingVoteEntry_View_Edit.owner.Table.Refresh', {
              ...
              {actions.openFormAction && true ? (
                <Button
                  ...
                  disabled={isLoading}
                >
                  {t('service.RatingVoteEntry.RatingVoteEntry_View_Edit.owner.Table.Create', {
                    defaultValue: 'Create',
                  })}
                </Button>
              ) : null}
