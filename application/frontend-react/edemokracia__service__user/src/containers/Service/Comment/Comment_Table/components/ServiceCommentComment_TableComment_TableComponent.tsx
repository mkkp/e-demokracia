...
export const SERVICE_COMMENT_COMMENT_TABLE_COMMENT_TABLE_COMPONENT_SIDEKICK_COMPONENT_INTERFACE_KEY =
  'ServiceCommentComment_TableComment_TableComponentSidekickComponent';
...
export function ServiceCommentComment_TableComment_TableComponent(
  ...
  const sidekickComponentFilter = `(&(${OBJECTCLASS}=${CUSTOM_VISUAL_ELEMENT_INTERFACE_KEY})(component=${SERVICE_COMMENT_COMMENT_TABLE_COMMENT_TABLE_COMPONENT_SIDEKICK_COMPONENT_INTERFACE_KEY}))`;
  const filterModelKey = `User/(esm/_p_So4GksEe25ONJ3V89cVA)/TransferObjectTableTable-${uniqueId}-${generatorUUIDv4}-filterModel`;
  const filtersKey = `User/(esm/_p_So4GksEe25ONJ3V89cVA)/TransferObjectTableTable-${uniqueId}-${generatorUUIDv4}-filters`;
  const rowsPerPageKey = `User/(esm/_p_So4GksEe25ONJ3V89cVA)/TransferObjectTableTable-${uniqueId}-${generatorUUIDv4}-rowsPerPage`;
