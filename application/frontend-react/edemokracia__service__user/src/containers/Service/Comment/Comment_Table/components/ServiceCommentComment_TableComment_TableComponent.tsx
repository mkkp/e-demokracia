...
export function ServiceCommentComment_TableComment_TableComponent(
  ...
  const [queryCustomizer, setQueryCustomizer] = useState<ServiceCommentQueryCustomizer>({
    _mask: '{createdByName,comment,created,upVotes,downVotes}',
    _seek: {
      limit: 10 + 1,
    },
