    ...
    <Grid container spacing={2} direction="column" alignItems="stretch" justifyContent="flex-start">
      <Grid item xs={12} sm={12}>
        <TextField
          ...
          label={
            t(
              'service.SelectAnswerVoteSelection.SelectAnswerVoteSelection.View.Edit.title.SelectAnswerVoteSelection_View_Edit.service::SelectAnswerVoteSelection::SelectAnswerVoteSelection_View_Edit',
              { defaultValue: 'Title' },
            ) as string
          }
          value={data.title ?? ''}
      ...
      <Grid item xs={12} sm={12}>
        <TextField
          ...
          label={
            t(
              'service.SelectAnswerVoteSelection.SelectAnswerVoteSelection.View.Edit.description.SelectAnswerVoteSelection_View_Edit.service::SelectAnswerVoteSelection::SelectAnswerVoteSelection_View_Edit',
