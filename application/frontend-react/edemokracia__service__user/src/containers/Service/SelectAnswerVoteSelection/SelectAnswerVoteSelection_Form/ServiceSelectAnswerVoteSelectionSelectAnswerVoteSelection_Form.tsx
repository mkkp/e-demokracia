...
export default function ServiceSelectAnswerVoteSelectionSelectAnswerVoteSelection_Form(
  ...
  const { service: customContainerHook } =
    useTrackService<ServiceSelectAnswerVoteSelectionSelectAnswerVoteSelection_FormContainerHook>(
      `(${OBJECTCLASS}=${SERVICE_SELECT_ANSWER_VOTE_SELECTION_SELECT_ANSWER_VOTE_SELECTION_FORM_CONTAINER_ACTIONS_HOOK_INTERFACE_KEY})`,
    );
