    ...
    <Grid container spacing={2} direction="column" alignItems="stretch" justifyContent="flex-start">
      <Grid item xs={12} sm={12}>
        <TextField
          ...
          label={
            t(
              'service.SelectAnswerVoteSelection.SelectAnswerVoteSelection.Form.title.SelectAnswerVoteSelection_Form.service::SelectAnswerVoteSelection::SelectAnswerVoteSelection_Form',
              { defaultValue: 'Title' },
            ) as string
          }
          value={data.title ?? ''}
      ...
      <Grid item xs={12} sm={12}>
        <TextField
          ...
          label={
            t(
              'service.SelectAnswerVoteSelection.SelectAnswerVoteSelection.Form.description.SelectAnswerVoteSelection_Form.service::SelectAnswerVoteSelection::SelectAnswerVoteSelection_Form',
