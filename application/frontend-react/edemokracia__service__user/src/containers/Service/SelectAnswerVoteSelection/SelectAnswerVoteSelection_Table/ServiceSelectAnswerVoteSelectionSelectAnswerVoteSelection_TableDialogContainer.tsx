...
export interface ServiceSelectAnswerVoteSelectionSelectAnswerVoteSelection_TableDialogActions
  extends ServiceSelectAnswerVoteSelectionSelectAnswerVoteSelection_TableActionDefinitions {
  backAction?: () => Promise<void>;
}

export interface ServiceSelectAnswerVoteSelectionSelectAnswerVoteSelection_TableDialogProps {
  ownerData: any;
  onClose: () => Promise<void>;
  actions: ServiceSelectAnswerVoteSelectionSelectAnswerVoteSelection_TableDialogActions;
  isLoading: boolean;
  editMode: boolean;
...
export default function ServiceSelectAnswerVoteSelectionSelectAnswerVoteSelection_TableDialog(
  props: ServiceSelectAnswerVoteSelectionSelectAnswerVoteSelection_TableDialogProps,
) {
  ...
  return (
    <>
      <DialogTitle>
        ...
        <IconButton
          id="User/(esm/_pSMpMFtqEe6Mx9dH3yj5gQ)/TransferObjectTablePageContainer-dialog-close-wrapper"
          aria-label="close"
          onClick={onClose}
          sx={{
            position: 'absolute',
