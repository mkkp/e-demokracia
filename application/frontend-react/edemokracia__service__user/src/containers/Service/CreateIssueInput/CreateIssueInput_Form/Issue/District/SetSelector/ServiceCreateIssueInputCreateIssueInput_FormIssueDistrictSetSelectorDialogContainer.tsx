      ...
      <DialogActions>
        {!editMode && actions.backAction && (
          <Grid className="page-action" item>
            ...
            >
              <span>
                {t('service.CreateIssueInput.CreateIssueInput_Form.issue.district.Back', { defaultValue: 'Back' })}
              </span>
            </LoadingButton>
          </Grid>
        )}
        {!editMode && actions.setAction && (
          <Grid className="page-action" item>
            ...
            >
              <span>
                {t('service.CreateIssueInput.CreateIssueInput_Form.issue.district.Set', { defaultValue: 'Set' })}
              </span>
            </LoadingButton>
          </Grid>
        )}
