...
export interface ServiceIssueCategoryIssueCategory_FormOwnerSetSelectorOwnerSetSelectorComponentProps {
  uniqueId: string;
  actions: ServiceIssueCategoryIssueCategory_FormOwnerSetSelectorOwnerSetSelectorComponentActionDefinitions;
...
export function ServiceIssueCategoryIssueCategory_FormOwnerSetSelectorOwnerSetSelectorComponent(
  props: ServiceIssueCategoryIssueCategory_FormOwnerSetSelectorOwnerSetSelectorComponentProps,
) {
  const {
    uniqueId,
    actions,
  ...
  const filterModelKey = `User/(esm/_8svcEIdgEe2kLcMqsIbMgQ)/TabularReferenceFieldLinkSetSelectorTable-${uniqueId}-${generatorUUIDv4}-filterModel`;
  const filtersKey = `User/(esm/_8svcEIdgEe2kLcMqsIbMgQ)/TabularReferenceFieldLinkSetSelectorTable-${uniqueId}-${generatorUUIDv4}-filters`;
  const rowsPerPageKey = `User/(esm/_8svcEIdgEe2kLcMqsIbMgQ)/TabularReferenceFieldLinkSetSelectorTable-${uniqueId}-${generatorUUIDv4}-rowsPerPage`;
  ...
  const representationColumn: GridColDef<ServiceServiceUserStored> = {
    ...
    headerName: t('service.IssueCategory.IssueCategory_Form.owner.SetSelector.representation', {
  ...
  const filterOptions = useMemo<FilterOption[]>(
    () => [
      {
        id: 'User/(esm/_OLt-8IdiEe2kLcMqsIbMgQ)/TableColumnFilter/(discriminator/User/(esm/_8svcEIdgEe2kLcMqsIbMgQ)/TabularReferenceFieldLinkSetSelectorTable)',
        attributeName: 'representation',
        label: t('service.IssueCategory.IssueCategory_Form.owner.SetSelector.representation', {
          defaultValue: 'Representation',
        }) as string,
          ...
          Toolbar: () => (
            <GridToolbarContainer>
              {actions.filterAction && true ? (
                <Button
                  id="User/(esm/_8svcEIdgEe2kLcMqsIbMgQ)/TabularReferenceFieldLinkSetSelectorTableFilterButton"
                  startIcon={<MdiIcon path="filter" />}
                  variant={'text'}
                  onClick={async () => {
                    const filterResults = await actions.filterAction!(
                      'User/(esm/_8svcEIdgEe2kLcMqsIbMgQ)/TabularReferenceFieldLinkSetSelectorTableFilterButton',
                      filterOptions,
                      filterModel,
                      filters,
                    );
              ...
              {actions.selectorRangeAction && true ? (
                <Button
                  id="User/(esm/_8svcEIdgEe2kLcMqsIbMgQ)/TabularReferenceFieldLinkSetSelectorTableRefreshButton"
              ...
              {actions.openCreateFormAction && true ? (
                <Button
                  id="User/(esm/_8svcEIdgEe2kLcMqsIbMgQ)/TabularReferenceFieldLinkSetSelectorTableCreateButton"
