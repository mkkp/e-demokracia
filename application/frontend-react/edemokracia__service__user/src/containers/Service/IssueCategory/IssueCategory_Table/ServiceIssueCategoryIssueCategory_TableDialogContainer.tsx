...
export interface ServiceIssueCategoryIssueCategory_TableDialogActions
  extends ServiceIssueCategoryIssueCategory_TableActionDefinitions {
  backAction?: () => Promise<void>;
}

export interface ServiceIssueCategoryIssueCategory_TableDialogProps {
  ownerData: any;
  onClose: () => Promise<void>;
  actions: ServiceIssueCategoryIssueCategory_TableDialogActions;
  isLoading: boolean;
  editMode: boolean;
...
export default function ServiceIssueCategoryIssueCategory_TableDialog(
  props: ServiceIssueCategoryIssueCategory_TableDialogProps,
) {
  ...
  return (
    <>
      <DialogTitle>
        ...
        <IconButton
          id="User/(esm/_qJVVsGksEe25ONJ3V89cVA)/TransferObjectTablePageContainer-dialog-close-wrapper"
          aria-label="close"
          onClick={onClose}
          sx={{
            position: 'absolute',
