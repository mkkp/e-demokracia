          ...
          <CardContent>
            <Grid item xs={12} sm={12}>
              <Typography id="User/(esm/_L2wXIFsjEe6Mx9dH3yj5gQ)/TransferObjectTableEmpty">
                {
                  t(
                    'service.YesNoAbstainVoteEntry.YesNoAbstainVoteEntry.Table.YesNoAbstainVoteEntry_Table.YesNoAbstainVoteEntry_Table.service::YesNoAbstainVoteEntry::YesNoAbstainVoteEntry_Table',
