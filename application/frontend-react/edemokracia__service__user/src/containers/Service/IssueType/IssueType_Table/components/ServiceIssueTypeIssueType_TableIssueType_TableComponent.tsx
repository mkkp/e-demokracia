...
export interface ServiceIssueTypeIssueType_TableIssueType_TableComponentActionDefinitions {
  ...
  exportAction?: (queryCustomizer: ServiceIssueTypeQueryCustomizer) => Promise<void>;
  ...
  openPageAction?: (row: ServiceIssueTypeStored, isDraft?: boolean) => Promise<void>;
...
export const SERVICE_ISSUE_TYPE_ISSUE_TYPE_TABLE_ISSUE_TYPE_TABLE_COMPONENT_SIDEKICK_COMPONENT_INTERFACE_KEY =
  'ServiceIssueTypeIssueType_TableIssueType_TableComponentSidekickComponent';
...
export function ServiceIssueTypeIssueType_TableIssueType_TableComponent(
  ...
  const sidekickComponentFilter = `(&(${OBJECTCLASS}=${CUSTOM_VISUAL_ELEMENT_INTERFACE_KEY})(component=${SERVICE_ISSUE_TYPE_ISSUE_TYPE_TABLE_ISSUE_TYPE_TABLE_COMPONENT_SIDEKICK_COMPONENT_INTERFACE_KEY}))`;
  const filterModelKey = `User/(esm/_J4eloNu4Ee2Bgcx6em3jZg)/TransferObjectTableTable-${uniqueId}-${generatorUUIDv4}-filterModel`;
  const filtersKey = `User/(esm/_J4eloNu4Ee2Bgcx6em3jZg)/TransferObjectTableTable-${uniqueId}-${generatorUUIDv4}-filters`;
  const rowsPerPageKey = `User/(esm/_J4eloNu4Ee2Bgcx6em3jZg)/TransferObjectTableTable-${uniqueId}-${generatorUUIDv4}-rowsPerPage`;
  ...
  const rowActions: TableRowAction<ServiceIssueTypeStored>[] = useMemo(
    () => [
      {
        ...
        isCRUD: true,
        disabled: (row: ServiceIssueTypeStored) => getSelectedRows().length > 0 || isLoading,
      ...
      },
      {
        ...
        isCRUD: true,
        disabled: (row: ServiceIssueTypeStored) => getSelectedRows().length > 0 || !row.__deleteable || isLoading,
  ...
  const filterOptions = useMemo<FilterOption[]>(
    () => [
      {
        id: 'User/(esm/_DaKn8dvEEe2Bgcx6em3jZg)/TableColumnFilter/(discriminator/User/(esm/_J4eloNu4Ee2Bgcx6em3jZg)/TransferObjectTableTable)',
        attributeName: 'title',
      ...
      {
        id: 'User/(esm/_mCUjMOMhEe2Bgcx6em3jZg)/TableColumnFilter/(discriminator/User/(esm/_J4eloNu4Ee2Bgcx6em3jZg)/TransferObjectTableTable)',
      ...
      {
        id: 'User/(esm/_DaKn8NvEEe2Bgcx6em3jZg)/TableColumnFilter/(discriminator/User/(esm/_J4eloNu4Ee2Bgcx6em3jZg)/TransferObjectTableTable)',
      ...
      <StripedDataGrid
        ...
        onRowClick={
          actions.openPageAction
            ? async (params: GridRowParams<ServiceIssueTypeStored>) => await actions.openPageAction!(params.row, false)
            : undefined
        }
        sortModel={sortModel}
          ...
          Toolbar: () => (
            <GridToolbarContainer>
              ...
              {actions.exportAction && true ? (
                <Button
                  id="User/(esm/_J4eloNu4Ee2Bgcx6em3jZg)/TransferObjectTableExportButton"
