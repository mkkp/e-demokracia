            ...
            <Grid container direction="column" alignItems="stretch" justifyContent="flex-start" spacing={2}>
              <Grid item xs={12} sm={12}>
                <TextField
                  ...
                  label={
                    t(
                      'service.IssueType.IssueType.View.Edit.title.group.IssueType_View_Edit.service::IssueType::IssueType_View_Edit',
                      { defaultValue: 'Title' },
                    ) as string
                  }
                  value={data.title ?? ''}
              ...
              <Grid item xs={12} sm={12}>
                <Grid
                  id="_foqoUX2GEe6V8KKnnZfChA)/LabelWrapper"
                  container
                  direction="column"
                  alignItems="center"
                ...
                >
                  <Grid item xs={12} sm={12}>
                    <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                      ...
                      <Typography id="_foqoUX2GEe6V8KKnnZfChA)/Label" variant="h5" component="h1">
                        {t(
                          'service.IssueType.IssueType.View.Edit.voteType::Label.voteType::LabelWrapper.group.IssueType_View_Edit.service::IssueType::IssueType_View_Edit',
                  ...
                  <Grid item xs={12} sm={12}>
                    ...
                    >
                      <InputLabel
                        id="User/(esm/_XP9UYOMcEe2Bgcx6em3jZg)/EnumerationTypeRadio"
                        shrink={true}
                        size={'small'}
                      >
                        {t(
                          'service.IssueType.IssueType.View.Edit.voteType.voteType::LabelWrapper.group.IssueType_View_Edit.service::IssueType::IssueType_View_Edit',
                          { defaultValue: 'VoteType' },
                        )}
                      </InputLabel>
                      <RadioGroup
              ...
              <Grid item xs={12} sm={12}>
                <TextField
                  ...
                  label={
                    t(
                      'service.IssueType.IssueType.View.Edit.voteType.group.IssueType_View_Edit.service::IssueType::IssueType_View_Edit',
                      { defaultValue: 'VoteType' },
                    ) as string
                  }
                  value={data.voteType || ''}
              ...
              <Grid item xs={12} sm={12}>
                <TextField
                  ...
                  label={
                    t(
                      'service.IssueType.IssueType.View.Edit.description.group.IssueType_View_Edit.service::IssueType::IssueType_View_Edit',
