...
export function ServiceServiceUserServiceUser_View_EditAreasResidencyResidentDistrictSetSelectorResidentDistrictSetSelectorComponent(
  ...
  const filterModelKey = `User/(esm/_I_CEgIXqEe2kLcMqsIbMgQ)/TabularReferenceFieldLinkSetSelectorTable-${uniqueId}-filterModel`;
  const filtersKey = `User/(esm/_I_CEgIXqEe2kLcMqsIbMgQ)/TabularReferenceFieldLinkSetSelectorTable-${uniqueId}-filters`;
            ...
            <GridToolbarContainer>
              {actions.filterAction && true ? (
                <Button
                  ...
                  disabled={isLoading}
                >
                  {t('service.ServiceUser.ServiceUser_View_Edit.Areas.Residency.residentDistrict.Table.Filter', {
              ...
              {actions.selectorRangeAction && true ? (
                <Button
                  ...
                  disabled={isLoading}
                >
                  {t('service.ServiceUser.ServiceUser_View_Edit.Areas.Residency.residentDistrict.Table.Refresh', {
              ...
              {actions.openFormAction && true ? (
                <Button
                  ...
                  disabled={isLoading}
                >
                  {t('service.ServiceUser.ServiceUser_View_Edit.Areas.Residency.residentDistrict.Table.Create', {
                    defaultValue: 'Create',
                  })}
                </Button>
              ) : null}
