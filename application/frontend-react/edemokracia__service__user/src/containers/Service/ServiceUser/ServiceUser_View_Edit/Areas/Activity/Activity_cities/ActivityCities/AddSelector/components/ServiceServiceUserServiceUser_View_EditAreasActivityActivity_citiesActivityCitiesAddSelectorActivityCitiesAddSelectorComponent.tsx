...
export function ServiceServiceUserServiceUser_View_EditAreasActivityActivity_citiesActivityCitiesAddSelectorActivityCitiesAddSelectorComponent(
  ...
  const filterModelKey = `User/(esm/_I-1QMIXqEe2kLcMqsIbMgQ)/TabularReferenceFieldTableAddSelectorTable-${uniqueId}-filterModel`;
  const filtersKey = `User/(esm/_I-1QMIXqEe2kLcMqsIbMgQ)/TabularReferenceFieldTableAddSelectorTable-${uniqueId}-filters`;
          ...
          Toolbar: () => (
            <GridToolbarContainer>
              {actions.filterAction && true ? (
                ...
                >
                  {t(
                    'service.ServiceUser.ServiceUser_View_Edit.Areas.activity.activity_cities.activityCities.Table.Filter',
              ...
              {actions.selectorRangeAction && true ? (
                ...
                >
                  {t(
                    'service.ServiceUser.ServiceUser_View_Edit.Areas.activity.activity_cities.activityCities.Table.Refresh',
              ...
              {actions.openFormAction && true ? (
                ...
                >
                  {t(
                    'service.ServiceUser.ServiceUser_View_Edit.Areas.activity.activity_cities.activityCities.Table.Create',
                    { defaultValue: 'Create' },
                  )}
                </Button>
              ) : null}
