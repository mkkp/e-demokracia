...
export function ServiceServiceUserServiceUser_View_EditAreasActivityActivity_districtsActivityDistrictsAddSelectorActivityDistrictsAddSelectorComponent(
  ...
  const filterModelKey = `User/(esm/_I-9zEIXqEe2kLcMqsIbMgQ)/TabularReferenceFieldTableAddSelectorTable-${uniqueId}-filterModel`;
  const filtersKey = `User/(esm/_I-9zEIXqEe2kLcMqsIbMgQ)/TabularReferenceFieldTableAddSelectorTable-${uniqueId}-filters`;
  const rowsPerPageKey = `User/(esm/_I-9zEIXqEe2kLcMqsIbMgQ)/TabularReferenceFieldTableAddSelectorTable-${uniqueId}-rowsPerPage`;
