...
export interface ServiceServiceUserServiceUser_View_EditActionDefinitions
  ...
  getCreatedValidationProps?: (data: ServiceServiceUser) => BaseDateValidationProps;
  getMask?: () => string;
}
      ...
      <Grid item data-name="ServiceUser_View_Edit" xs={12} sm={12} md={36.0}>
        ...
        >
                  ...
                  <Grid item>
                    <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                      ...
                      <Typography
                        ...
                        component="h1"
                      >
                        {t('service.ServiceUser.ServiceUser_View_Edit.Security', { defaultValue: 'Security' })}
                      </Typography>
                    </Grid>
                  </Grid>
                </Grid>
                <Grid container direction="row" alignItems="flex-start" justifyContent="flex-start" spacing={2}>
                  <Grid item xs={12} sm={12} md={4.0}>
                    <TextField
                      ...
                      label={
                        t('service.ServiceUser.ServiceUser_View_Edit.userName', { defaultValue: 'Username' }) as string
                      }
                      value={data.userName ?? ''}
                      className={clsx({
                  ...
                  <Grid item xs={12} sm={12} md={4.0}>
                    <DateTimePicker
                      ...
                      label={
                        t('service.ServiceUser.ServiceUser_View_Edit.created', { defaultValue: 'Created' }) as string
                      }
                  ...
                  <Grid item>
                    <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                      ...
                      <Typography
                        ...
                        component="h1"
                      >
                        {t('service.ServiceUser.ServiceUser_View_Edit.personal', { defaultValue: 'Personal' })}
                      </Typography>
                    </Grid>
                  </Grid>
                </Grid>
                    ...
                    >
                      <Grid item xs={12} sm={12} md={4.0}>
                        <TextField
                          ...
                          label={
                            t('service.ServiceUser.ServiceUser_View_Edit.email', { defaultValue: 'Email' }) as string
                          }
                          value={data.email ?? ''}
                          className={clsx({
                            'JUDO-viewMode': !editMode,
                      ...
                      <Grid item xs={12} sm={12} md={4.0}>
                        <TextField
                          ...
                          label={
                            t('service.ServiceUser.ServiceUser_View_Edit.phone', { defaultValue: 'Phone' }) as string
                          }
                          value={data.phone ?? ''}
                          className={clsx({
                            'JUDO-viewMode': !editMode,
          ...
          <Grid item data-name="Areas" xs={12} sm={12}>
            <Card id="User/(esm/_vzaQsGk5Ee25ONJ3V89cVA)/GroupVisualElement" data-name="Areas" sx={{ height: '100%' }}>
              <CardContent>
                <Grid
                  container
                  direction="row"
                  ...
                  <Grid item>
                    <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                      ...
                      <Typography
                        ...
                        component="h1"
                      >
                        {t('service.ServiceUser.ServiceUser_View_Edit.Areas', { defaultValue: 'Areas' })}
                      </Typography>
                    </Grid>
                  </Grid>
                </Grid>
