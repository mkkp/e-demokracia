      ...
      <DialogActions>
        {!editMode && actions.backAction && (
          <Grid className="page-action" item>
            ...
            >
              <span>
                {t('service.ServiceUser.ServiceUser_View_Edit.Areas.Residency.residentCity.Back', {
                  defaultValue: 'Back',
                })}
              </span>
            </LoadingButton>
        ...
        {!editMode && actions.setAction && (
          <Grid className="page-action" item>
            ...
            >
              <span>
                {t('service.ServiceUser.ServiceUser_View_Edit.Areas.Residency.residentCity.Set', {
                  defaultValue: 'Set',
                })}
              </span>
            </LoadingButton>
