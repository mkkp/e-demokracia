...
export const SERVICE_SERVICE_USER_SERVICE_USER_VIEW_EDIT_ACTIVITY_CITIES_COMPONENT_SIDEKICK_COMPONENT_INTERFACE_KEY =
  'ServiceServiceUserServiceUser_View_EditActivityCitiesComponentSidekickComponent';
...
export function ServiceServiceUserServiceUser_View_EditActivityCitiesComponent(
  ...
  const sidekickComponentFilter = `(&(${OBJECTCLASS}=${CUSTOM_VISUAL_ELEMENT_INTERFACE_KEY})(component=${SERVICE_SERVICE_USER_SERVICE_USER_VIEW_EDIT_ACTIVITY_CITIES_COMPONENT_SIDEKICK_COMPONENT_INTERFACE_KEY}))`;
  const filterModelKey = `User/(esm/_I-1QMIXqEe2kLcMqsIbMgQ)/TabularReferenceFieldRelationDefinedTable-${uniqueId}-${generatorUUIDv4}-filterModel`;
  const filtersKey = `User/(esm/_I-1QMIXqEe2kLcMqsIbMgQ)/TabularReferenceFieldRelationDefinedTable-${uniqueId}-${generatorUUIDv4}-filters`;
  const rowsPerPageKey = `User/(esm/_I-1QMIXqEe2kLcMqsIbMgQ)/TabularReferenceFieldRelationDefinedTable-${uniqueId}-${generatorUUIDv4}-rowsPerPage`;
  ...
  const representationColumn: GridColDef<ServiceCityStored> = {
    ...
    headerName: t('service.ServiceUser.ServiceUser_View_Edit.activityCities.representation', {
      defaultValue: 'City',
    }) as string,
