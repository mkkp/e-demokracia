...
export function ServiceVoteDefinitionVoteDefinition_View_EditTabBarSelectanswervoteVoteSelectAnswerCallOperationVoteSelectAnswerCallOperationSelectorComponent(
  ...
  const { uniqueId, actions, refreshCounter, validationError, selectionDiff, setSelectionDiff } = props;
          ...
          Toolbar: () => (
            <GridToolbarContainer>
              {actions.filterAction && true ? (
                ...
                >
                  {t(
                    'service.VoteDefinition.VoteDefinition_View_Edit.tabBar.selectanswervote.voteSelectAnswer.Table.Filter',
              ...
              {actions.selectorRangeAction && true ? (
                ...
                >
                  {t(
                    'service.VoteDefinition.VoteDefinition_View_Edit.tabBar.selectanswervote.voteSelectAnswer.Table.Refresh',
