...
export function ServiceUserVoteDefinitionUserVoteDefinition_View_EditActiveVoteDefinitionsGlobalComponent(
  ...
  const rowActions: TableRowAction<ServiceVoteDefinitionStored>[] = [
    {
      id: 'User/(esm/_T6ChAI4jEe29qs15q2b6yw)/OperationFormTableRowCallOperationButton/(discriminator/_CTUHU4sNEe6E6KmeUhRZew)',
    ...
    {
      id: 'User/(esm/_T6DvII4jEe29qs15q2b6yw)/OperationFormTableRowCallOperationButton/(discriminator/_CTUHU4sNEe6E6KmeUhRZew)',
    ...
    {
      id: 'User/(esm/_T5_dsI4jEe29qs15q2b6yw)/OperationFormTableRowCallOperationButton/(discriminator/_CTUHU4sNEe6E6KmeUhRZew)',
    ...
    {
      id: 'User/(esm/_T6Ar0I4jEe29qs15q2b6yw)/OperationFormTableRowCallOperationButton/(discriminator/_CTUHU4sNEe6E6KmeUhRZew)',
  ...
  async function fetchData() {
    if (!isLoading && ownerData.__signedIdentifier) {
      ...
      try {
        const res = await actions.activeVoteDefinitionsGlobalRefreshAction!(processQueryCustomizer(queryCustomizer));
        ...
        onRowClick={
          actions.activeVoteDefinitionsGlobalOpenPageAction
            ? async (params: GridRowParams<ServiceVoteDefinitionStored>) =>
                await actions.activeVoteDefinitionsGlobalOpenPageAction!(params.row)
            : undefined
        }
        sortModel={sortModel}
            ...
            <GridToolbarContainer>
              ...
              {actions.activeVoteDefinitionsGlobalRefreshAction && true ? (
                <Button
                  ...
                  variant={'text'}
                  onClick={async () => {
                    await actions.activeVoteDefinitionsGlobalRefreshAction!(processQueryCustomizer(queryCustomizer));
                  }}
                  disabled={isLoading}
                >
                  {t(
