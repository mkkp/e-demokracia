...
export interface ServiceUserVoteDefinitionUserVoteDefinition_View_EditRootTabBarOwnedVoteDefinitionsGroupOwnedVoteDefinitionsAddSelectorOwnedVoteDefinitionsAddSelectorComponentProps {
  uniqueId: string;
  actions: ServiceUserVoteDefinitionUserVoteDefinition_View_EditRootTabBarOwnedVoteDefinitionsGroupOwnedVoteDefinitionsAddSelectorOwnedVoteDefinitionsAddSelectorComponentActionDefinitions;
...
export function ServiceUserVoteDefinitionUserVoteDefinition_View_EditRootTabBarOwnedVoteDefinitionsGroupOwnedVoteDefinitionsAddSelectorOwnedVoteDefinitionsAddSelectorComponent(
  props: ServiceUserVoteDefinitionUserVoteDefinition_View_EditRootTabBarOwnedVoteDefinitionsGroupOwnedVoteDefinitionsAddSelectorOwnedVoteDefinitionsAddSelectorComponentProps,
) {
  const {
    uniqueId,
    actions,
  ...
  const filterModelKey = `User/(esm/_GBBigF5HEe6vsex_cZNQbQ)/TabularReferenceFieldTableAddSelectorTable-${uniqueId}-${generatorUUIDv4}-filterModel`;
  const filtersKey = `User/(esm/_GBBigF5HEe6vsex_cZNQbQ)/TabularReferenceFieldTableAddSelectorTable-${uniqueId}-${generatorUUIDv4}-filters`;
  const rowsPerPageKey = `User/(esm/_GBBigF5HEe6vsex_cZNQbQ)/TabularReferenceFieldTableAddSelectorTable-${uniqueId}-${generatorUUIDv4}-rowsPerPage`;
  ...
  const scopeColumn: GridColDef<ServiceVoteDefinitionStored> = {
    ...
    field: 'scope',
    headerName: t(
      'service.UserVoteDefinition.UserVoteDefinition_View_Edit.root.tabBar.OwnedVoteDefinitionsGroup.ownedVoteDefinitions.AddSelector.scope',
      { defaultValue: 'Scope' },
    ) as string,
  ...
  const titleColumn: GridColDef<ServiceVoteDefinitionStored> = {
    ...
    field: 'title',
    headerName: t(
      'service.UserVoteDefinition.UserVoteDefinition_View_Edit.root.tabBar.OwnedVoteDefinitionsGroup.ownedVoteDefinitions.AddSelector.title',
      { defaultValue: 'Title' },
    ) as string,
    headerClassName: 'data-grid-column-header',
  ...
  const voteTypeColumn: GridColDef<ServiceVoteDefinitionStored> = {
    ...
    field: 'voteType',
    headerName: t(
      'service.UserVoteDefinition.UserVoteDefinition_View_Edit.root.tabBar.OwnedVoteDefinitionsGroup.ownedVoteDefinitions.AddSelector.voteType',
  ...
  const countyRepresentationColumn: GridColDef<ServiceVoteDefinitionStored> = {
    ...
    headerName: t(
      'service.UserVoteDefinition.UserVoteDefinition_View_Edit.root.tabBar.OwnedVoteDefinitionsGroup.ownedVoteDefinitions.AddSelector.countyRepresentation',
  ...
  const cityRepresentationColumn: GridColDef<ServiceVoteDefinitionStored> = {
    ...
    headerName: t(
      'service.UserVoteDefinition.UserVoteDefinition_View_Edit.root.tabBar.OwnedVoteDefinitionsGroup.ownedVoteDefinitions.AddSelector.cityRepresentation',
  ...
  const districtRepresentationColumn: GridColDef<ServiceVoteDefinitionStored> = {
    ...
    headerName: t(
      'service.UserVoteDefinition.UserVoteDefinition_View_Edit.root.tabBar.OwnedVoteDefinitionsGroup.ownedVoteDefinitions.AddSelector.districtRepresentation',
  ...
  const numberOfVotesColumn: GridColDef<ServiceVoteDefinitionStored> = {
    ...
    field: 'numberOfVotes',
    headerName: t(
      'service.UserVoteDefinition.UserVoteDefinition_View_Edit.root.tabBar.OwnedVoteDefinitionsGroup.ownedVoteDefinitions.AddSelector.numberOfVotes',
  ...
  const createdColumn: GridColDef<ServiceVoteDefinitionStored> = {
    ...
    field: 'created',
    headerName: t(
      'service.UserVoteDefinition.UserVoteDefinition_View_Edit.root.tabBar.OwnedVoteDefinitionsGroup.ownedVoteDefinitions.AddSelector.created',
  ...
  const closeAtColumn: GridColDef<ServiceVoteDefinitionStored> = {
    ...
    field: 'closeAt',
    headerName: t(
      'service.UserVoteDefinition.UserVoteDefinition_View_Edit.root.tabBar.OwnedVoteDefinitionsGroup.ownedVoteDefinitions.AddSelector.closeAt',
  ...
  const statusColumn: GridColDef<ServiceVoteDefinitionStored> = {
    ...
    field: 'status',
    headerName: t(
      'service.UserVoteDefinition.UserVoteDefinition_View_Edit.root.tabBar.OwnedVoteDefinitionsGroup.ownedVoteDefinitions.AddSelector.status',
      { defaultValue: 'Status' },
    ) as string,
    headerClassName: 'data-grid-column-header',
  ...
  const filterOptions = useMemo<FilterOption[]>(
    () => [
      {
        id: 'User/(esm/_ytoJwF5HEe6vsex_cZNQbQ)/TableColumnFilter/(discriminator/User/(esm/_GBBigF5HEe6vsex_cZNQbQ)/TabularReferenceFieldTableAddSelectorTable)',
        attributeName: 'scope',
        label: t(
          'service.UserVoteDefinition.UserVoteDefinition_View_Edit.root.tabBar.OwnedVoteDefinitionsGroup.ownedVoteDefinitions.AddSelector.scope',
          { defaultValue: 'Scope' },
      ...
      {
        id: 'User/(esm/_GBCwoF5HEe6vsex_cZNQbQ)/TableColumnFilter/(discriminator/User/(esm/_GBBigF5HEe6vsex_cZNQbQ)/TabularReferenceFieldTableAddSelectorTable)',
        attributeName: 'title',
        label: t(
          'service.UserVoteDefinition.UserVoteDefinition_View_Edit.root.tabBar.OwnedVoteDefinitionsGroup.ownedVoteDefinitions.AddSelector.title',
          { defaultValue: 'Title' },
      ...
      {
        id: 'User/(esm/_GBEl015HEe6vsex_cZNQbQ)/TableColumnFilter/(discriminator/User/(esm/_GBBigF5HEe6vsex_cZNQbQ)/TabularReferenceFieldTableAddSelectorTable)',
      ...
      {
        id: 'User/(esm/_9xK6QV5IEe6vsex_cZNQbQ)/TableColumnFilter/(discriminator/User/(esm/_GBBigF5HEe6vsex_cZNQbQ)/TabularReferenceFieldTableAddSelectorTable)',
      ...
      {
        id: 'User/(esm/_9xK6QF5IEe6vsex_cZNQbQ)/TableColumnFilter/(discriminator/User/(esm/_GBBigF5HEe6vsex_cZNQbQ)/TabularReferenceFieldTableAddSelectorTable)',
      ...
      {
        id: 'User/(esm/_9xLhUF5IEe6vsex_cZNQbQ)/TableColumnFilter/(discriminator/User/(esm/_GBBigF5HEe6vsex_cZNQbQ)/TabularReferenceFieldTableAddSelectorTable)',
      ...
      {
        id: 'User/(esm/_GBEl0l5HEe6vsex_cZNQbQ)/TableColumnFilter/(discriminator/User/(esm/_GBBigF5HEe6vsex_cZNQbQ)/TabularReferenceFieldTableAddSelectorTable)',
      ...
      {
        id: 'User/(esm/_GBDXsF5HEe6vsex_cZNQbQ)/TableColumnFilter/(discriminator/User/(esm/_GBBigF5HEe6vsex_cZNQbQ)/TabularReferenceFieldTableAddSelectorTable)',
      ...
      {
        id: 'User/(esm/_GBD-wl5HEe6vsex_cZNQbQ)/TableColumnFilter/(discriminator/User/(esm/_GBBigF5HEe6vsex_cZNQbQ)/TabularReferenceFieldTableAddSelectorTable)',
      ...
      {
        id: 'User/(esm/_GBD-wV5HEe6vsex_cZNQbQ)/TableColumnFilter/(discriminator/User/(esm/_GBBigF5HEe6vsex_cZNQbQ)/TabularReferenceFieldTableAddSelectorTable)',
          ...
          Toolbar: () => (
            <GridToolbarContainer>
              {actions.filterAction && true ? (
                <Button
                  id="User/(esm/_GBBigF5HEe6vsex_cZNQbQ)/TabularReferenceFieldTableAddSelectorTableFilterButton"
                  startIcon={<MdiIcon path="filter" />}
                  variant={'text'}
                  onClick={async () => {
                    const filterResults = await actions.filterAction!(
                      'User/(esm/_GBBigF5HEe6vsex_cZNQbQ)/TabularReferenceFieldTableAddSelectorTableFilterButton',
                      filterOptions,
                      filterModel,
                      filters,
                    );
              ...
              {actions.selectorRangeAction && true ? (
                <Button
                  id="User/(esm/_GBBigF5HEe6vsex_cZNQbQ)/TabularReferenceFieldTableAddSelectorTableRefreshButton"
              ...
              {actions.openCreateFormAction && true ? (
                <Button
                  id="User/(esm/_GBBigF5HEe6vsex_cZNQbQ)/TabularReferenceFieldTableAddSelectorTableCreateButton"
