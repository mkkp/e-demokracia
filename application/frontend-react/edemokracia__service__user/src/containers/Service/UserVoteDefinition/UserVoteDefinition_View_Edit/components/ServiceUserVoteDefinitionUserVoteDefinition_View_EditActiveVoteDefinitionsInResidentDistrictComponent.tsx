...
export interface ServiceUserVoteDefinitionUserVoteDefinition_View_EditActiveVoteDefinitionsInResidentDistrictComponentActionDefinitions {
  ...
  getActiveVoteDefinitionsInResidentDistrictMask?: () => string;
  activeVoteDefinitionsInResidentDistrictOpenPageAction?: (
    row: ServiceVoteDefinitionStored,
    isDraft?: boolean,
  ) => Promise<void>;
  activeVoteDefinitionsInResidentDistrictVoteRatingAction?: (row: ServiceVoteDefinitionStored) => Promise<void>;
  activeVoteDefinitionsInResidentDistrictVoteSelectAnswerAction?: (row: ServiceVoteDefinitionStored) => Promise<void>;
  activeVoteDefinitionsInResidentDistrictVoteYesNoAction?: (row: ServiceVoteDefinitionStored) => Promise<void>;
  activeVoteDefinitionsInResidentDistrictVoteYesNoAbstainAction?: (row: ServiceVoteDefinitionStored) => Promise<void>;
  activeVoteDefinitionsInResidentDistrictAdditionalToolbarButtons?: (
...
export function ServiceUserVoteDefinitionUserVoteDefinition_View_EditActiveVoteDefinitionsInResidentDistrictComponent(
  ...
  const countyRepresentationColumn: GridColDef<ServiceVoteDefinitionStored> = {
    ...
    headerName: t(
      'service.UserVoteDefinition.UserVoteDefinition_View_Edit.activeVoteDefinitionsInResidentDistrict.countyRepresentation',
  ...
  const cityRepresentationColumn: GridColDef<ServiceVoteDefinitionStored> = {
    ...
    headerName: t(
      'service.UserVoteDefinition.UserVoteDefinition_View_Edit.activeVoteDefinitionsInResidentDistrict.cityRepresentation',
  ...
  const districtRepresentationColumn: GridColDef<ServiceVoteDefinitionStored> = {
    ...
    headerName: t(
      'service.UserVoteDefinition.UserVoteDefinition_View_Edit.activeVoteDefinitionsInResidentDistrict.districtRepresentation',
  ...
  const titleColumn: GridColDef<ServiceVoteDefinitionStored> = {
    ...
    field: 'title',
    headerName: t(
      'service.UserVoteDefinition.UserVoteDefinition_View_Edit.activeVoteDefinitionsInResidentDistrict.title',
      { defaultValue: 'Title' },
    ) as string,
    headerClassName: 'data-grid-column-header',
  ...
  const voteTypeColumn: GridColDef<ServiceVoteDefinitionStored> = {
    ...
    field: 'voteType',
    headerName: t(
      'service.UserVoteDefinition.UserVoteDefinition_View_Edit.activeVoteDefinitionsInResidentDistrict.voteType',
  ...
  const numberOfVotesColumn: GridColDef<ServiceVoteDefinitionStored> = {
    ...
    field: 'numberOfVotes',
    headerName: t(
      'service.UserVoteDefinition.UserVoteDefinition_View_Edit.activeVoteDefinitionsInResidentDistrict.numberOfVotes',
  ...
  const createdColumn: GridColDef<ServiceVoteDefinitionStored> = {
    ...
    field: 'created',
    headerName: t(
      'service.UserVoteDefinition.UserVoteDefinition_View_Edit.activeVoteDefinitionsInResidentDistrict.created',
  ...
  const closeAtColumn: GridColDef<ServiceVoteDefinitionStored> = {
    ...
    field: 'closeAt',
    headerName: t(
      'service.UserVoteDefinition.UserVoteDefinition_View_Edit.activeVoteDefinitionsInResidentDistrict.closeAt',
  ...
  const statusColumn: GridColDef<ServiceVoteDefinitionStored> = {
    ...
    field: 'status',
    headerName: t(
      'service.UserVoteDefinition.UserVoteDefinition_View_Edit.activeVoteDefinitionsInResidentDistrict.status',
      { defaultValue: 'Status' },
    ) as string,
    headerClassName: 'data-grid-column-header',
    ...
    () => [
      {
        ...
        action: actions.activeVoteDefinitionsInResidentDistrictVoteRatingAction
          ? async (rowData) => {
              await actions.activeVoteDefinitionsInResidentDistrictVoteRatingAction!(rowData);
            }
          : undefined,
      },
      {
        ...
        action: actions.activeVoteDefinitionsInResidentDistrictVoteSelectAnswerAction
          ? async (rowData) => {
              await actions.activeVoteDefinitionsInResidentDistrictVoteSelectAnswerAction!(rowData);
            }
          : undefined,
      },
      {
        ...
        action: actions.activeVoteDefinitionsInResidentDistrictVoteYesNoAbstainAction
          ? async (rowData) => {
              await actions.activeVoteDefinitionsInResidentDistrictVoteYesNoAbstainAction!(rowData);
            }
          : undefined,
      },
      {
        ...
        action: actions.activeVoteDefinitionsInResidentDistrictVoteYesNoAction
          ? async (rowData) => {
              await actions.activeVoteDefinitionsInResidentDistrictVoteYesNoAction!(rowData);
            }
          : undefined,
      },
    ],
  ...
  const additionalToolbarActions: Record<string, ElementType> =
    actions?.activeVoteDefinitionsInResidentDistrictAdditionalToolbarButtons
      ? actions.activeVoteDefinitionsInResidentDistrictAdditionalToolbarButtons(
          data,
          isLoading,
          getSelectedRows(),
  ...
  const filterOptions = useMemo<FilterOption[]>(
    () => [
      {
        id: 'User/(esm/_BdOYcV5NEe6vsex_cZNQbQ)/TableColumnFilter/(discriminator/User/(esm/_BdNKUF5NEe6vsex_cZNQbQ)/TabularReferenceFieldRelationDefinedTable)',
      ...
      {
        id: 'User/(esm/_BdOYc15NEe6vsex_cZNQbQ)/TableColumnFilter/(discriminator/User/(esm/_BdNKUF5NEe6vsex_cZNQbQ)/TabularReferenceFieldRelationDefinedTable)',
      ...
      {
        id: 'User/(esm/_BdOYcF5NEe6vsex_cZNQbQ)/TableColumnFilter/(discriminator/User/(esm/_BdNKUF5NEe6vsex_cZNQbQ)/TabularReferenceFieldRelationDefinedTable)',
      ...
      {
        id: 'User/(esm/_BdNKUV5NEe6vsex_cZNQbQ)/TableColumnFilter/(discriminator/User/(esm/_BdNKUF5NEe6vsex_cZNQbQ)/TabularReferenceFieldRelationDefinedTable)',
        attributeName: 'title',
      ...
      {
        id: 'User/(esm/_BdNxaF5NEe6vsex_cZNQbQ)/TableColumnFilter/(discriminator/User/(esm/_BdNKUF5NEe6vsex_cZNQbQ)/TabularReferenceFieldRelationDefinedTable)',
      ...
      {
        id: 'User/(esm/_BdNxZ15NEe6vsex_cZNQbQ)/TableColumnFilter/(discriminator/User/(esm/_BdNKUF5NEe6vsex_cZNQbQ)/TabularReferenceFieldRelationDefinedTable)',
      ...
      {
        id: 'User/(esm/_BdNKUl5NEe6vsex_cZNQbQ)/TableColumnFilter/(discriminator/User/(esm/_BdNKUF5NEe6vsex_cZNQbQ)/TabularReferenceFieldRelationDefinedTable)',
      ...
      {
        id: 'User/(esm/_BdNKVV5NEe6vsex_cZNQbQ)/TableColumnFilter/(discriminator/User/(esm/_BdNKUF5NEe6vsex_cZNQbQ)/TabularReferenceFieldRelationDefinedTable)',
      ...
      {
        id: 'User/(esm/_BdNKVF5NEe6vsex_cZNQbQ)/TableColumnFilter/(discriminator/User/(esm/_BdNKUF5NEe6vsex_cZNQbQ)/TabularReferenceFieldRelationDefinedTable)',
    ...
    if (!isLoading && ownerData.__signedIdentifier) {
      ...
      try {
        const processedQueryCustomizer = {
          ...
          _mask: actions.getActiveVoteDefinitionsInResidentDistrictMask
            ? actions.getActiveVoteDefinitionsInResidentDistrictMask()
            : queryCustomizer._mask,
        };
        const res = await actions.activeVoteDefinitionsInResidentDistrictRefreshAction!(processedQueryCustomizer);
  ...
  return (
    ...
    >
      <StripedDataGrid
        ...
        onRowClick={
          actions.activeVoteDefinitionsInResidentDistrictOpenPageAction
            ? async (params: GridRowParams<ServiceVoteDefinitionStored>) =>
                await actions.activeVoteDefinitionsInResidentDistrictOpenPageAction!(params.row, false)
            : undefined
        }
        sortModel={sortModel}
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              {actions.activeVoteDefinitionsInResidentDistrictFilterAction && true ? (
                <Button
                  id="User/(esm/_BdNKUF5NEe6vsex_cZNQbQ)/TabularReferenceTableFilterButton"
                  startIcon={<MdiIcon path="filter" />}
                  variant={'text'}
                  onClick={async () => {
                    const filterResults = await actions.activeVoteDefinitionsInResidentDistrictFilterAction!(
                ...
                >
                  {t(
                    'service.UserVoteDefinition.UserVoteDefinition_View_Edit.root.tabBar.ActiveVoteDefinitionsByOwnerResidentAreaGroup.tabBar.ActiveDebatesInResidentDistrictGroup.activeVoteDefinitionsInResidentDistrict.Filter',
                    { defaultValue: 'Set Filters' },
                  )}
                  {filters.length ? ` (${filters.length})` : ''}
                </Button>
              ) : null}
              {actions.activeVoteDefinitionsInResidentDistrictRefreshAction && true ? (
                <Button
                  ...
                  onClick={async () => {
                    ...
                    await actions.activeVoteDefinitionsInResidentDistrictRefreshAction!(processedQueryCustomizer);
                  }}
                  disabled={isLoading}
                >
                  {t(
                    'service.UserVoteDefinition.UserVoteDefinition_View_Edit.root.tabBar.ActiveVoteDefinitionsByOwnerResidentAreaGroup.tabBar.ActiveDebatesInResidentDistrictGroup.activeVoteDefinitionsInResidentDistrict.Refresh',
