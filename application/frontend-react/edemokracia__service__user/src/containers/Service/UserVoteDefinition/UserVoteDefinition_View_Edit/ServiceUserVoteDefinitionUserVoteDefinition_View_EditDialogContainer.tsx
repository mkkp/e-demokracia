...
export interface ServiceUserVoteDefinitionUserVoteDefinition_View_EditDialogActions
...
export interface ServiceUserVoteDefinitionUserVoteDefinition_View_EditDialogProps {
  ownerData: any;
  title: string;
  onClose: () => Promise<void>;
  actions: ServiceUserVoteDefinitionUserVoteDefinition_View_EditDialogActions;
  isLoading: boolean;
  editMode: boolean;
...
export default function ServiceUserVoteDefinitionUserVoteDefinition_View_EditDialog(
  props: ServiceUserVoteDefinitionUserVoteDefinition_View_EditDialogProps,
) {
  ...
  return (
    <>
      <DialogTitle>
        {title}
        <IconButton
          id="User/(esm/_gTanUF4-Ee6vsex_cZNQbQ)/TransferObjectViewPageContainer-dialog-close-wrapper"
          aria-label="close"
          onClick={onClose}
          sx={{
            position: 'absolute',
