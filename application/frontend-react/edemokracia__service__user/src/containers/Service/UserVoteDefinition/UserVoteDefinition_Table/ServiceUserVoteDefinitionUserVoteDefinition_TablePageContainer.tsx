...
export interface ServiceUserVoteDefinitionUserVoteDefinition_TablePageProps {
  actions: ServiceUserVoteDefinitionUserVoteDefinition_TablePageActions;
  isLoading: boolean;
  editMode: boolean;
...
export default function ServiceUserVoteDefinitionUserVoteDefinition_TablePage(
  props: ServiceUserVoteDefinitionUserVoteDefinition_TablePageProps,
) {
    ...
    <>
      ...
      <Suspense>
        <Box sx={mainContainerPadding}>
          <ServiceUserVoteDefinitionUserVoteDefinition_Table
            actions={actions}
