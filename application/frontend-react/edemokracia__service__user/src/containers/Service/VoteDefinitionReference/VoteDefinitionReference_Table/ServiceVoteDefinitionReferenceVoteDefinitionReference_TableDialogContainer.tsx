...
export interface ServiceVoteDefinitionReferenceVoteDefinitionReference_TableDialogActions
  extends ServiceVoteDefinitionReferenceVoteDefinitionReference_TableActionDefinitions {
  backAction?: () => Promise<void>;
}

export interface ServiceVoteDefinitionReferenceVoteDefinitionReference_TableDialogProps {
  ownerData: any;
  onClose: () => Promise<void>;
  actions: ServiceVoteDefinitionReferenceVoteDefinitionReference_TableDialogActions;
  isLoading: boolean;
  editMode: boolean;
...
export default function ServiceVoteDefinitionReferenceVoteDefinitionReference_TableDialog(
  props: ServiceVoteDefinitionReferenceVoteDefinitionReference_TableDialogProps,
) {
  ...
  return (
    <>
      <DialogTitle>
        ...
        <IconButton
          id="User/(esm/_y8PgoM6tEe6ddqBfFzCBZg)/TransferObjectTablePageContainer-dialog-close-wrapper"
          aria-label="close"
          onClick={onClose}
          sx={{
            position: 'absolute',
