...
export interface ServiceIssueIssue_View_EditOtherCategoriesCategoriesAddSelectorCategoriesAddSelectorComponentActionDefinitions {
...
export interface ServiceIssueIssue_View_EditOtherCategoriesCategoriesAddSelectorCategoriesAddSelectorComponentProps {
  uniqueId: string;
  actions: ServiceIssueIssue_View_EditOtherCategoriesCategoriesAddSelectorCategoriesAddSelectorComponentActionDefinitions;
...
export const SERVICE_ISSUE_ISSUE_VIEW_EDIT_OTHER_CATEGORIES_CATEGORIES_ADD_SELECTOR_CATEGORIES_ADD_SELECTOR_COMPONENT_SIDEKICK_COMPONENT_INTERFACE_KEY =
  'ServiceIssueIssue_View_EditOtherCategoriesCategoriesAddSelectorCategoriesAddSelectorComponentSidekickComponent';

// XMIID: User/(esm/_LRJ3AId9Ee2kLcMqsIbMgQ)/TabularReferenceFieldTableAddSelectorTable
// Name: categories::Add::Selector
export function ServiceIssueIssue_View_EditOtherCategoriesCategoriesAddSelectorCategoriesAddSelectorComponent(
  props: ServiceIssueIssue_View_EditOtherCategoriesCategoriesAddSelectorCategoriesAddSelectorComponentProps,
) {
  const {
    uniqueId,
    actions,
  ...
  const sidekickComponentFilter = `(&(${OBJECTCLASS}=${CUSTOM_VISUAL_ELEMENT_INTERFACE_KEY})(component=${SERVICE_ISSUE_ISSUE_VIEW_EDIT_OTHER_CATEGORIES_CATEGORIES_ADD_SELECTOR_CATEGORIES_ADD_SELECTOR_COMPONENT_SIDEKICK_COMPONENT_INTERFACE_KEY}))`;
  const filterModelKey = `User/(esm/_LRJ3AId9Ee2kLcMqsIbMgQ)/TabularReferenceFieldTableAddSelectorTable-${uniqueId}-${generatorUUIDv4}-filterModel`;
  const filtersKey = `User/(esm/_LRJ3AId9Ee2kLcMqsIbMgQ)/TabularReferenceFieldTableAddSelectorTable-${uniqueId}-${generatorUUIDv4}-filters`;
  const rowsPerPageKey = `User/(esm/_LRJ3AId9Ee2kLcMqsIbMgQ)/TabularReferenceFieldTableAddSelectorTable-${uniqueId}-${generatorUUIDv4}-rowsPerPage`;
  ...
  const titleColumn: GridColDef<ServiceIssueCategoryStored> = {
    ...baseColumnConfig,
    field: 'title',
    headerName: t('service.Issue.Issue_View_Edit.other.categories.categories.AddSelector.title', {
      defaultValue: 'Title',
    }) as string,
  ...
  const descriptionColumn: GridColDef<ServiceIssueCategoryStored> = {
    ...baseColumnConfig,
    field: 'description',
    headerName: t('service.Issue.Issue_View_Edit.other.categories.categories.AddSelector.description', {
  ...
  const rowActions: TableRowAction<ServiceIssueCategoryStored>[] = useMemo(() => [], [actions, isLoading]);
  ...
  const additionalToolbarActions: Record<string, ElementType> = actions?.categoriesAdditionalToolbarButtons
    ? actions.categoriesAdditionalToolbarButtons(data, isLoading, getSelectedRows(), clearSelections)
    : {};
  ...
  const filterOptions = useMemo<FilterOption[]>(
    () => [
      {
        id: 'User/(esm/_LRJ3AYd9Ee2kLcMqsIbMgQ)/TableColumnFilter/(discriminator/User/(esm/_LRJ3AId9Ee2kLcMqsIbMgQ)/TabularReferenceFieldTableAddSelectorTable)',
        attributeName: 'title',
        label: t('service.Issue.Issue_View_Edit.other.categories.categories.AddSelector.title', {
          defaultValue: 'Title',
        }) as string,
      ...
      {
        id: 'User/(esm/_LRJ3Aod9Ee2kLcMqsIbMgQ)/TableColumnFilter/(discriminator/User/(esm/_LRJ3AId9Ee2kLcMqsIbMgQ)/TabularReferenceFieldTableAddSelectorTable)',
        attributeName: 'description',
        label: t('service.Issue.Issue_View_Edit.other.categories.categories.AddSelector.description', {
          defaultValue: 'Description',
        }) as string,
        filterType: FilterType.string,
      },
  ...
  return (
    <div
      id="User/(esm/_LRJ3AId9Ee2kLcMqsIbMgQ)/TabularReferenceFieldTableAddSelectorTable"
      data-table-name="categories::Add::Selector"
    >
      <ComponentProxy
          ...
          Toolbar: () => (
            <GridToolbarContainer>
              {actions.filterAction && true ? (
                <Button
                  id="User/(esm/_LRJ3AId9Ee2kLcMqsIbMgQ)/TabularReferenceFieldTableAddSelectorTableFilterButton"
                  startIcon={<MdiIcon path="filter" />}
                  variant={'text'}
                  onClick={async () => {
                    const filterResults = await actions.filterAction!(
                      'User/(esm/_LRJ3AId9Ee2kLcMqsIbMgQ)/TabularReferenceFieldTableAddSelectorTableFilterButton',
                      filterOptions,
                      filterModel,
                      filters,
                    );
              ...
              {actions.selectorRangeAction && true ? (
                <Button
                  id="User/(esm/_LRJ3AId9Ee2kLcMqsIbMgQ)/TabularReferenceFieldTableAddSelectorTableRefreshButton"
              ...
              {actions.openCreateFormAction && true ? (
                <Button
                  id="User/(esm/_LRJ3AId9Ee2kLcMqsIbMgQ)/TabularReferenceFieldTableAddSelectorTableCreateButton"
