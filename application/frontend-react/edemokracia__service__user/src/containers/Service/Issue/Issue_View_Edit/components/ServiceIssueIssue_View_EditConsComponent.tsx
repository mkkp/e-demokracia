...
export const SERVICE_ISSUE_ISSUE_VIEW_EDIT_CONS_COMPONENT_SIDEKICK_COMPONENT_INTERFACE_KEY =
  'ServiceIssueIssue_View_EditConsComponentSidekickComponent';
...
export function ServiceIssueIssue_View_EditConsComponent(props: ServiceIssueIssue_View_EditConsComponentProps) {
  ...
  const sidekickComponentFilter = `(&(${OBJECTCLASS}=${CUSTOM_VISUAL_ELEMENT_INTERFACE_KEY})(component=${SERVICE_ISSUE_ISSUE_VIEW_EDIT_CONS_COMPONENT_SIDEKICK_COMPONENT_INTERFACE_KEY}))`;
  const filterModelKey = `User/(esm/_qJPPDXjvEe6cB8og8p0UuQ)/TabularReferenceFieldRelationDefinedTable-${uniqueId}-${generatorUUIDv4}-filterModel`;
  const filtersKey = `User/(esm/_qJPPDXjvEe6cB8og8p0UuQ)/TabularReferenceFieldRelationDefinedTable-${uniqueId}-${generatorUUIDv4}-filters`;
  const rowsPerPageKey = `User/(esm/_qJPPDXjvEe6cB8og8p0UuQ)/TabularReferenceFieldRelationDefinedTable-${uniqueId}-${generatorUUIDv4}-rowsPerPage`;
  ...
  const titleColumn: GridColDef<ServiceConStored> = {
    ...baseColumnConfig,
    field: 'title',
    headerName: t('service.Issue.Issue_View_Edit.cons.title', { defaultValue: 'Title' }) as string,
  ...
  const upVotesColumn: GridColDef<ServiceConStored> = {
    ...baseColumnConfig,
    field: 'upVotes',
    headerName: t('service.Issue.Issue_View_Edit.cons.upVotes', { defaultValue: 'up' }) as string,
    headerClassName: 'data-grid-column-header',
  ...
  const downVotesColumn: GridColDef<ServiceConStored> = {
    ...baseColumnConfig,
    field: 'downVotes',
    headerName: t('service.Issue.Issue_View_Edit.cons.downVotes', { defaultValue: 'down' }) as string,
    headerClassName: 'data-grid-column-header',
  ...
  const filterOptions = useMemo<FilterOption[]>(
    () => [
      {
        id: 'User/(esm/_qJPPDnjvEe6cB8og8p0UuQ)/TableColumnFilter/(discriminator/User/(esm/_qJPPDXjvEe6cB8og8p0UuQ)/TabularReferenceFieldRelationDefinedTable)',
        attributeName: 'title',
      ...
      {
        id: 'User/(esm/_qJPPD3jvEe6cB8og8p0UuQ)/TableColumnFilter/(discriminator/User/(esm/_qJPPDXjvEe6cB8og8p0UuQ)/TabularReferenceFieldRelationDefinedTable)',
      ...
      {
        id: 'User/(esm/_qJPPEHjvEe6cB8og8p0UuQ)/TableColumnFilter/(discriminator/User/(esm/_qJPPDXjvEe6cB8og8p0UuQ)/TabularReferenceFieldRelationDefinedTable)',
  ...
  return (
    <div id="User/(esm/_qJPPDXjvEe6cB8og8p0UuQ)/TabularReferenceFieldRelationDefinedTable" data-table-name="cons">
      <ComponentProxy
