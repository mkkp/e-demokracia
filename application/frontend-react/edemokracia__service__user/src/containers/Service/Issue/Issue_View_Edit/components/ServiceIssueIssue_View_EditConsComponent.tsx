...
export function ServiceIssueIssue_View_EditConsComponent(props: ServiceIssueIssue_View_EditConsComponentProps) {
  ...
  const rowActions: TableRowAction<ServiceConStored>[] = [
    ...
    {
      id: 'User/(esm/_3sP2oIriEe2VSOmaAz6G9Q)/OperationFormTableRowCallOperationButton/(discriminator/_t35UMo1KEe6sgdrBpAinBQ)',
    ...
    {
      id: 'User/(esm/_3sNaYIriEe2VSOmaAz6G9Q)/OperationFormTableRowCallOperationButton/(discriminator/_t35UMo1KEe6sgdrBpAinBQ)',
    ...
    {
      id: 'User/(esm/_DBZYMHjsEe6cB8og8p0UuQ)/OperationFormTableRowCallOperationButton/(discriminator/_t35UMo1KEe6sgdrBpAinBQ)',
    ...
    {
      id: 'User/(esm/_DBYxIHjsEe6cB8og8p0UuQ)/OperationFormTableRowCallOperationButton/(discriminator/_t35UMo1KEe6sgdrBpAinBQ)',
