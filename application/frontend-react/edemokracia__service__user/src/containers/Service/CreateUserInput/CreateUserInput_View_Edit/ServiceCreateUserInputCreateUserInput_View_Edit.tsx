    ...
    <Grid container spacing={2} direction="column" alignItems="stretch" justifyContent="flex-start">
      <Grid item xs={12} sm={12}>
        <TextField
          ...
          label={
            t(
              'service.CreateUserInput.CreateUserInput.View.Edit.userName.CreateUserInput_View_Edit.service::CreateUserInput::CreateUserInput_View_Edit',
      ...
      <Grid item xs={12} sm={12}>
        <TextField
          ...
          label={
            t(
              'service.CreateUserInput.CreateUserInput.View.Edit.email.CreateUserInput_View_Edit.service::CreateUserInput::CreateUserInput_View_Edit',
              { defaultValue: 'Email' },
            ) as string
          }
          value={data.email ?? ''}
      ...
      <Grid item xs={12} sm={12}>
        <FormGroup>
          <FormControlLabel
            ...
            label={
              t(
                'service.CreateUserInput.CreateUserInput.View.Edit.hasAdminAccess.CreateUserInput_View_Edit.service::CreateUserInput::CreateUserInput_View_Edit',
      ...
      <Grid item xs={12} sm={12}>
        <TextField
          ...
          label={
            t(
              'service.CreateUserInput.CreateUserInput.View.Edit.firstName.CreateUserInput_View_Edit.service::CreateUserInput::CreateUserInput_View_Edit',
      ...
      <Grid item xs={12} sm={12}>
        <TextField
          ...
          label={
            t(
              'service.CreateUserInput.CreateUserInput.View.Edit.lastName.CreateUserInput_View_Edit.service::CreateUserInput::CreateUserInput_View_Edit',
