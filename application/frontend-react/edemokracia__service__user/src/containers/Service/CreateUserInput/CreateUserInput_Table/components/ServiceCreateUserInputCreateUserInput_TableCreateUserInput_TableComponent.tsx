...
export const SERVICE_CREATE_USER_INPUT_CREATE_USER_INPUT_TABLE_CREATE_USER_INPUT_TABLE_COMPONENT_SIDEKICK_COMPONENT_INTERFACE_KEY =
  'ServiceCreateUserInputCreateUserInput_TableCreateUserInput_TableComponentSidekickComponent';
...
export function ServiceCreateUserInputCreateUserInput_TableCreateUserInput_TableComponent(
  ...
  const sidekickComponentFilter = `(&(${OBJECTCLASS}=${CUSTOM_VISUAL_ELEMENT_INTERFACE_KEY})(component=${SERVICE_CREATE_USER_INPUT_CREATE_USER_INPUT_TABLE_CREATE_USER_INPUT_TABLE_COMPONENT_SIDEKICK_COMPONENT_INTERFACE_KEY}))`;
  const filterModelKey = `User/(esm/_eNzsYI1eEe2J66C5CrhpQw)/TransferObjectTableTable-${uniqueId}-${generatorUUIDv4}-filterModel`;
  const filtersKey = `User/(esm/_eNzsYI1eEe2J66C5CrhpQw)/TransferObjectTableTable-${uniqueId}-${generatorUUIDv4}-filters`;
  const rowsPerPageKey = `User/(esm/_eNzsYI1eEe2J66C5CrhpQw)/TransferObjectTableTable-${uniqueId}-${generatorUUIDv4}-rowsPerPage`;
  ...
  const SidekickComponent =
    useTrackComponent<FC<SidekickComponentProps<ServiceCreateUserInputStored>>>(sidekickComponentFilter);
