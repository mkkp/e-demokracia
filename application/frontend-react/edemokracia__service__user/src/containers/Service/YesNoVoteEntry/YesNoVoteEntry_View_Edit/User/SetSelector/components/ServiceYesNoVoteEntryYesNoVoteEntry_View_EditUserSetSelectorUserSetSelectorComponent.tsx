            ...
            <GridToolbarContainer>
              {actions.filterAction && true ? (
                <Button
                  ...
                  disabled={isLoading}
                >
                  {t('service.YesNoVoteEntry.YesNoVoteEntry_View_Edit.user.Table.Filter', {
              ...
              {actions.selectorRangeAction && true ? (
                <Button
                  ...
                  disabled={isLoading}
                >
                  {t('service.YesNoVoteEntry.YesNoVoteEntry_View_Edit.user.Table.Refresh', { defaultValue: 'Refresh' })}
                </Button>
              ) : null}
              {actions.openFormAction && true ? (
                <Button
                  ...
                  disabled={isLoading}
                >
                  {t('service.YesNoVoteEntry.YesNoVoteEntry_View_Edit.user.Table.Create', { defaultValue: 'Create' })}
                </Button>
              ) : null}
