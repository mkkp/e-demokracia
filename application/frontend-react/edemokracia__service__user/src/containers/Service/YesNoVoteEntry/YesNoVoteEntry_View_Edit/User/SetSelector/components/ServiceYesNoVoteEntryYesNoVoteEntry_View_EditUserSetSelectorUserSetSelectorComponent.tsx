...
export interface ServiceYesNoVoteEntryYesNoVoteEntry_View_EditUserSetSelectorUserSetSelectorComponentProps {
  uniqueId: string;
  actions: ServiceYesNoVoteEntryYesNoVoteEntry_View_EditUserSetSelectorUserSetSelectorComponentActionDefinitions;
...
export function ServiceYesNoVoteEntryYesNoVoteEntry_View_EditUserSetSelectorUserSetSelectorComponent(
  props: ServiceYesNoVoteEntryYesNoVoteEntry_View_EditUserSetSelectorUserSetSelectorComponentProps,
) {
  const {
    uniqueId,
    actions,
  ...
  const filterModelKey = `User/(esm/_88iwkFowEe6_67aMO2jOsw)/TabularReferenceFieldLinkSetSelectorTable-${uniqueId}-${generatorUUIDv4}-filterModel`;
  const filtersKey = `User/(esm/_88iwkFowEe6_67aMO2jOsw)/TabularReferenceFieldLinkSetSelectorTable-${uniqueId}-${generatorUUIDv4}-filters`;
  const rowsPerPageKey = `User/(esm/_88iwkFowEe6_67aMO2jOsw)/TabularReferenceFieldLinkSetSelectorTable-${uniqueId}-${generatorUUIDv4}-rowsPerPage`;
  ...
  const representationColumn: GridColDef<ServiceServiceUserStored> = {
    ...
    headerName: t('service.YesNoVoteEntry.YesNoVoteEntry_View_Edit.user.SetSelector.representation', {
  ...
  const effectiveTableColumns = useMemo(() => {
    const cols = [
      ...columns,
      ...columnsActionCalculator('User/(esm/_X3OWsFojEe6_67aMO2jOsw)/RelationType', rowActions, t, {
  ...
  const filterOptions = useMemo<FilterOption[]>(
    () => [
      {
        id: 'User/(esm/_88nCAFowEe6_67aMO2jOsw)/TableColumnFilter/(discriminator/User/(esm/_88iwkFowEe6_67aMO2jOsw)/TabularReferenceFieldLinkSetSelectorTable)',
        attributeName: 'representation',
        label: t('service.YesNoVoteEntry.YesNoVoteEntry_View_Edit.user.SetSelector.representation', {
          defaultValue: 'Representation',
        }) as string,
          ...
          Toolbar: () => (
            <GridToolbarContainer>
              {actions.filterAction && true ? (
                <Button
                  id="User/(esm/_88iwkFowEe6_67aMO2jOsw)/TabularReferenceFieldLinkSetSelectorTableFilterButton"
                  startIcon={<MdiIcon path="filter" />}
                  variant={'text'}
                  onClick={async () => {
                    const filterResults = await actions.filterAction!(
                      'User/(esm/_88iwkFowEe6_67aMO2jOsw)/TabularReferenceFieldLinkSetSelectorTableFilterButton',
                      filterOptions,
                      filterModel,
                      filters,
                    );
              ...
              {actions.selectorRangeAction && true ? (
                <Button
                  id="User/(esm/_88iwkFowEe6_67aMO2jOsw)/TabularReferenceFieldLinkSetSelectorTableRefreshButton"
              ...
              {actions.openCreateFormAction && true ? (
                <Button
                  id="User/(esm/_88iwkFowEe6_67aMO2jOsw)/TabularReferenceFieldLinkSetSelectorTableCreateButton"
