...
export const SERVICE_CON_CON_FORM_CONS_COMPONENT_SIDEKICK_COMPONENT_INTERFACE_KEY =
  'ServiceConCon_FormConsComponentSidekickComponent';
...
export function ServiceConCon_FormConsComponent(props: ServiceConCon_FormConsComponentProps) {
  ...
  const sidekickComponentFilter = `(&(${OBJECTCLASS}=${CUSTOM_VISUAL_ELEMENT_INTERFACE_KEY})(component=${SERVICE_CON_CON_FORM_CONS_COMPONENT_SIDEKICK_COMPONENT_INTERFACE_KEY}))`;
  const filterModelKey = `User/(esm/_cI62AIfYEe2u0fVmwtP5bA)/TabularReferenceFieldRelationDefinedTable-${uniqueId}-${generatorUUIDv4}-filterModel`;
  const filtersKey = `User/(esm/_cI62AIfYEe2u0fVmwtP5bA)/TabularReferenceFieldRelationDefinedTable-${uniqueId}-${generatorUUIDv4}-filters`;
  const rowsPerPageKey = `User/(esm/_cI62AIfYEe2u0fVmwtP5bA)/TabularReferenceFieldRelationDefinedTable-${uniqueId}-${generatorUUIDv4}-rowsPerPage`;
  ...
  const createdByNameColumn: GridColDef<ServiceConStored> = {
    ...baseColumnConfig,
    field: 'createdByName',
    headerName: t('service.Con.Con_Form.cons.createdByName', { defaultValue: 'CreatedByName' }) as string,
  ...
  const createdColumn: GridColDef<ServiceConStored> = {
    ...baseColumnConfig,
    field: 'created',
    headerName: t('service.Con.Con_Form.cons.created', { defaultValue: 'Created' }) as string,
    headerClassName: 'data-grid-column-header',
  ...
  const descriptionColumn: GridColDef<ServiceConStored> = {
    ...baseColumnConfig,
    field: 'description',
    headerName: t('service.Con.Con_Form.cons.description', { defaultValue: 'Description' }) as string,
    headerClassName: 'data-grid-column-header',
  ...
  const titleColumn: GridColDef<ServiceConStored> = {
    ...baseColumnConfig,
    field: 'title',
    headerName: t('service.Con.Con_Form.cons.title', { defaultValue: 'Title' }) as string,
    headerClassName: 'data-grid-column-header',
  ...
  const upVotesColumn: GridColDef<ServiceConStored> = {
    ...baseColumnConfig,
    field: 'upVotes',
    headerName: t('service.Con.Con_Form.cons.upVotes', { defaultValue: 'UpVotes' }) as string,
    headerClassName: 'data-grid-column-header',
  ...
  const downVotesColumn: GridColDef<ServiceConStored> = {
    ...baseColumnConfig,
    field: 'downVotes',
    headerName: t('service.Con.Con_Form.cons.downVotes', { defaultValue: 'DownVotes' }) as string,
    headerClassName: 'data-grid-column-header',
  ...
  const filterOptions = useMemo<FilterOption[]>(
    () => [
      {
        id: 'User/(esm/_cI8rMIfYEe2u0fVmwtP5bA)/TableColumnFilter/(discriminator/User/(esm/_cI62AIfYEe2u0fVmwtP5bA)/TabularReferenceFieldRelationDefinedTable)',
      ...
      {
        id: 'User/(esm/_cI95UIfYEe2u0fVmwtP5bA)/TableColumnFilter/(discriminator/User/(esm/_cI62AIfYEe2u0fVmwtP5bA)/TabularReferenceFieldRelationDefinedTable)',
      ...
      {
        id: 'User/(esm/_cI_ugIfYEe2u0fVmwtP5bA)/TableColumnFilter/(discriminator/User/(esm/_cI62AIfYEe2u0fVmwtP5bA)/TabularReferenceFieldRelationDefinedTable)',
      ...
      {
        id: 'User/(esm/_cJBjsIfYEe2u0fVmwtP5bA)/TableColumnFilter/(discriminator/User/(esm/_cI62AIfYEe2u0fVmwtP5bA)/TabularReferenceFieldRelationDefinedTable)',
        attributeName: 'title',
      ...
      {
        id: 'User/(esm/_cJDY4IfYEe2u0fVmwtP5bA)/TableColumnFilter/(discriminator/User/(esm/_cI62AIfYEe2u0fVmwtP5bA)/TabularReferenceFieldRelationDefinedTable)',
      ...
      {
        id: 'User/(esm/_cJFOEIfYEe2u0fVmwtP5bA)/TableColumnFilter/(discriminator/User/(esm/_cI62AIfYEe2u0fVmwtP5bA)/TabularReferenceFieldRelationDefinedTable)',
