...
export function ServiceConCon_View_EditConsComponent(props: ServiceConCon_View_EditConsComponentProps) {
  ...
  const rowActions: TableRowAction<ServiceConStored>[] = [
    ...
    {
      id: 'User/(esm/_DBYxIHjsEe6cB8og8p0UuQ)/OperationFormTableRowCallOperationButton/(discriminator/_v7OOxI0GEe6vroMdQ80Hug)',
    ...
    {
      id: 'User/(esm/_DBZYMHjsEe6cB8og8p0UuQ)/OperationFormTableRowCallOperationButton/(discriminator/_v7OOxI0GEe6vroMdQ80Hug)',
    ...
    {
      id: 'User/(esm/_3sNaYIriEe2VSOmaAz6G9Q)/OperationFormTableRowCallOperationButton/(discriminator/_v7OOxI0GEe6vroMdQ80Hug)',
    ...
    {
      id: 'User/(esm/_3sP2oIriEe2VSOmaAz6G9Q)/OperationFormTableRowCallOperationButton/(discriminator/_v7OOxI0GEe6vroMdQ80Hug)',
