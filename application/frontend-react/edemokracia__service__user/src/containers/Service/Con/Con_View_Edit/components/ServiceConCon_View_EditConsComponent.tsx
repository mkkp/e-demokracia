...
export function ServiceConCon_View_EditConsComponent(props: ServiceConCon_View_EditConsComponentProps) {
  ...
  const rowActions: TableRowAction<ServiceConStored>[] = [
    ...
    {
      id: 'User/(esm/_3sP2oIriEe2VSOmaAz6G9Q)/OperationFormTableRowCallOperationButton/(discriminator/_t1F30o1KEe6sgdrBpAinBQ)',
    ...
    {
      id: 'User/(esm/_3sNaYIriEe2VSOmaAz6G9Q)/OperationFormTableRowCallOperationButton/(discriminator/_t1F30o1KEe6sgdrBpAinBQ)',
    ...
    {
      id: 'User/(esm/_DBZYMHjsEe6cB8og8p0UuQ)/OperationFormTableRowCallOperationButton/(discriminator/_t1F30o1KEe6sgdrBpAinBQ)',
    ...
    {
      id: 'User/(esm/_DBYxIHjsEe6cB8og8p0UuQ)/OperationFormTableRowCallOperationButton/(discriminator/_t1F30o1KEe6sgdrBpAinBQ)',
