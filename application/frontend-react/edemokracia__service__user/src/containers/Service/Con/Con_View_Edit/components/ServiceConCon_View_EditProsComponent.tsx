...
export const SERVICE_CON_CON_VIEW_EDIT_PROS_COMPONENT_SIDEKICK_COMPONENT_INTERFACE_KEY =
  'ServiceConCon_View_EditProsComponentSidekickComponent';
...
export function ServiceConCon_View_EditProsComponent(props: ServiceConCon_View_EditProsComponentProps) {
  ...
  const sidekickComponentFilter = `(&(${OBJECTCLASS}=${CUSTOM_VISUAL_ELEMENT_INTERFACE_KEY})(component=${SERVICE_CON_CON_VIEW_EDIT_PROS_COMPONENT_SIDEKICK_COMPONENT_INTERFACE_KEY}))`;
  const filterModelKey = `User/(esm/_WihOMIfYEe2u0fVmwtP5bA)/TabularReferenceFieldRelationDefinedTable-${uniqueId}-${generatorUUIDv4}-filterModel`;
  const filtersKey = `User/(esm/_WihOMIfYEe2u0fVmwtP5bA)/TabularReferenceFieldRelationDefinedTable-${uniqueId}-${generatorUUIDv4}-filters`;
  const rowsPerPageKey = `User/(esm/_WihOMIfYEe2u0fVmwtP5bA)/TabularReferenceFieldRelationDefinedTable-${uniqueId}-${generatorUUIDv4}-rowsPerPage`;
  ...
  const titleColumn: GridColDef<ServiceProStored> = {
    ...baseColumnConfig,
    field: 'title',
    headerName: t('service.Con.Con_View_Edit.pros.title', { defaultValue: 'Title' }) as string,
  ...
  const upVotesColumn: GridColDef<ServiceProStored> = {
    ...baseColumnConfig,
    field: 'upVotes',
    headerName: t('service.Con.Con_View_Edit.pros.upVotes', { defaultValue: 'up' }) as string,
    headerClassName: 'data-grid-column-header',
  ...
  const downVotesColumn: GridColDef<ServiceProStored> = {
    ...baseColumnConfig,
    field: 'downVotes',
    headerName: t('service.Con.Con_View_Edit.pros.downVotes', { defaultValue: 'down' }) as string,
    headerClassName: 'data-grid-column-header',
  ...
  const filterOptions = useMemo<FilterOption[]>(
    () => [
      {
        id: 'User/(esm/_Wih1QIfYEe2u0fVmwtP5bA)/TableColumnFilter/(discriminator/User/(esm/_WihOMIfYEe2u0fVmwtP5bA)/TabularReferenceFieldRelationDefinedTable)',
        attributeName: 'title',
      ...
      {
        id: 'User/(esm/_Wih1QYfYEe2u0fVmwtP5bA)/TableColumnFilter/(discriminator/User/(esm/_WihOMIfYEe2u0fVmwtP5bA)/TabularReferenceFieldRelationDefinedTable)',
      ...
      {
        id: 'User/(esm/_Wih1QofYEe2u0fVmwtP5bA)/TableColumnFilter/(discriminator/User/(esm/_WihOMIfYEe2u0fVmwtP5bA)/TabularReferenceFieldRelationDefinedTable)',
  ...
  return (
    <div id="User/(esm/_WihOMIfYEe2u0fVmwtP5bA)/TabularReferenceFieldRelationDefinedTable" data-table-name="pros">
      <ComponentProxy
