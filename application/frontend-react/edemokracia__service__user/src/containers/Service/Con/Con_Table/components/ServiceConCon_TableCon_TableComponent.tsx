...
export interface ServiceConCon_TableCon_TableComponentActionDefinitions {
  ...
  getMask?: () => string;
  createConArgumentAction?: (row: ServiceConStored) => Promise<void>;
  createProArgumentAction?: (row: ServiceConStored) => Promise<void>;
  deleteAction?: (row: ServiceConStored, silentMode?: boolean) => Promise<void>;
  removeAction?: (row: ServiceConStored, silentMode?: boolean) => Promise<void>;
  openPageAction?: (row: ServiceConStored, isDraft?: boolean) => Promise<void>;
  voteDownForConAction?: (row: ServiceConStored) => Promise<void>;
  voteUpForConAction?: (row: ServiceConStored) => Promise<void>;
...
export const SERVICE_CON_CON_TABLE_CON_TABLE_COMPONENT_SIDEKICK_COMPONENT_INTERFACE_KEY =
  'ServiceConCon_TableCon_TableComponentSidekickComponent';
...
export function ServiceConCon_TableCon_TableComponent(props: ServiceConCon_TableCon_TableComponentProps) {
  ...
  const sidekickComponentFilter = `(&(${OBJECTCLASS}=${CUSTOM_VISUAL_ELEMENT_INTERFACE_KEY})(component=${SERVICE_CON_CON_TABLE_CON_TABLE_COMPONENT_SIDEKICK_COMPONENT_INTERFACE_KEY}))`;
  const filterModelKey = `User/(esm/_qAs-IGksEe25ONJ3V89cVA)/TransferObjectTableTable-${uniqueId}-${generatorUUIDv4}-filterModel`;
  const filtersKey = `User/(esm/_qAs-IGksEe25ONJ3V89cVA)/TransferObjectTableTable-${uniqueId}-${generatorUUIDv4}-filters`;
  const rowsPerPageKey = `User/(esm/_qAs-IGksEe25ONJ3V89cVA)/TransferObjectTableTable-${uniqueId}-${generatorUUIDv4}-rowsPerPage`;
  ...
  const rowActions: TableRowAction<ServiceConStored>[] = useMemo(
    () => [
      ...
      {
        id: 'User/(esm/_DBYxIHjsEe6cB8og8p0UuQ)/OperationFormTableRowCallOperationButton/(discriminator/User/(esm/_qAs-IGksEe25ONJ3V89cVA)/TransferObjectTable)',
        label: t('service.Con.Con_Table.createConArgument', { defaultValue: 'createConArgument' }) as string,
  ...
  const filterOptions = useMemo<FilterOption[]>(
    () => [
      {
        id: 'User/(esm/_EuKnAG5WEe2wNaja8kBvcQ)/TableColumnFilter/(discriminator/User/(esm/_qAs-IGksEe25ONJ3V89cVA)/TransferObjectTableTable)',
      ...
      {
        id: 'User/(esm/_3nQWQH4bEe2j59SYy0JH0Q)/TableColumnFilter/(discriminator/User/(esm/_qAs-IGksEe25ONJ3V89cVA)/TransferObjectTableTable)',
      ...
      {
        id: 'User/(esm/_3naHQH4bEe2j59SYy0JH0Q)/TableColumnFilter/(discriminator/User/(esm/_qAs-IGksEe25ONJ3V89cVA)/TransferObjectTableTable)',
      ...
      {
        id: 'User/(esm/_3nj4QH4bEe2j59SYy0JH0Q)/TableColumnFilter/(discriminator/User/(esm/_qAs-IGksEe25ONJ3V89cVA)/TransferObjectTableTable)',
        attributeName: 'title',
      ...
      {
        id: 'User/(esm/_cIf_QIfYEe2u0fVmwtP5bA)/TableColumnFilter/(discriminator/User/(esm/_qAs-IGksEe25ONJ3V89cVA)/TransferObjectTableTable)',
      ...
      {
        id: 'User/(esm/_cIkQsIfYEe2u0fVmwtP5bA)/TableColumnFilter/(discriminator/User/(esm/_qAs-IGksEe25ONJ3V89cVA)/TransferObjectTableTable)',
  ...
  return (
    <div id="User/(esm/_qAs-IGksEe25ONJ3V89cVA)/TransferObjectTableTable" data-table-name="Con_Table">
      <ComponentProxy
      ...
      <StripedDataGrid
        ...
        onRowClick={
          actions.openPageAction
            ? async (params: GridRowParams<ServiceConStored>) => await actions.openPageAction!(params.row, false)
            : undefined
        }
        sortModel={sortModel}
          ...
          Toolbar: () => (
            <GridToolbarContainer>
              ...
              {actions.exportAction && true ? (
                <Button
                  id="User/(esm/_qAs-IGksEe25ONJ3V89cVA)/TransferObjectTableExportButton"
              ...
              {actions.openAddSelectorAction && true ? (
                <Button
                  id="User/(esm/_qAs-IGksEe25ONJ3V89cVA)/TransferObjectTableAddSelectorButton"
              ...
              {actions.openSetSelectorAction && true ? (
                <Button
                  id="User/(esm/_qAs-IGksEe25ONJ3V89cVA)/TransferObjectTableSetSelectorButton"
                  startIcon={<MdiIcon path="attachment-plus" />}
                  variant={'text'}
                  onClick={async () => {
                    const processedQueryCustomizer = {
