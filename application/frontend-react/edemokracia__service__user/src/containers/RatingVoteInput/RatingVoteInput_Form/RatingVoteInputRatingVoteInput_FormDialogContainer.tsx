    ...
    <>
      ...
      <DialogActions>
        ...
        {editMode && actions.voteForRatingVoteDefinitionAction && (
          <Grid className="page-action" item>
            <LoadingButton
              id="User/(esm/_NHnv2FsoEe6Mx9dH3yj5gQ)/OperationFormCallButton/(discriminator/_XlLPkIpWEe6AtscSh_kd4w)"
              loading={isLoading}
              loadingPosition="start"
              variant={'contained'}
        ...
        {editMode && actions.voteRatingForVoteDefinitionAction && (
          <Grid className="page-action" item>
            <LoadingButton
              id="User/(esm/_T5_dsI4jEe29qs15q2b6yw)/OperationFormCallButton/(discriminator/_XlLPkIpWEe6AtscSh_kd4w)"
              loading={isLoading}
              loadingPosition="start"
              variant={'contained'}
              startIcon={<MdiIcon path="vote" />}
