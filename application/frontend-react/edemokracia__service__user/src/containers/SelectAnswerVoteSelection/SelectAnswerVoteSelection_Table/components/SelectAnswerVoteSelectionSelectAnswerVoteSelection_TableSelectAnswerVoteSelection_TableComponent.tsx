...
export interface SelectAnswerVoteSelectionSelectAnswerVoteSelection_TableSelectAnswerVoteSelection_TableComponentActionDefinitions {
  ...
  openPageAction?: (row: SelectAnswerVoteSelectionStored, isDraft?: boolean) => Promise<void>;
...
export interface SelectAnswerVoteSelectionSelectAnswerVoteSelection_TableSelectAnswerVoteSelection_TableComponentProps {
  uniqueId: string;
  actions: SelectAnswerVoteSelectionSelectAnswerVoteSelection_TableSelectAnswerVoteSelection_TableComponentActionDefinitions;
...
export const SELECT_ANSWER_VOTE_SELECTION_SELECT_ANSWER_VOTE_SELECTION_TABLE_SELECT_ANSWER_VOTE_SELECTION_TABLE_COMPONENT_SIDEKICK_COMPONENT_INTERFACE_KEY =
  'SelectAnswerVoteSelectionSelectAnswerVoteSelection_TableSelectAnswerVoteSelection_TableComponentSidekickComponent';

// XMIID: User/(esm/_Xwy9EG6bEe2wNaja8kBvcQ)/TransferObjectTableTable
// Name: SelectAnswerVoteSelection_Table
export function SelectAnswerVoteSelectionSelectAnswerVoteSelection_TableSelectAnswerVoteSelection_TableComponent(
  props: SelectAnswerVoteSelectionSelectAnswerVoteSelection_TableSelectAnswerVoteSelection_TableComponentProps,
) {
  ...
  const sidekickComponentFilter = `(&(${OBJECTCLASS}=${CUSTOM_VISUAL_ELEMENT_INTERFACE_KEY})(component=${SELECT_ANSWER_VOTE_SELECTION_SELECT_ANSWER_VOTE_SELECTION_TABLE_SELECT_ANSWER_VOTE_SELECTION_TABLE_COMPONENT_SIDEKICK_COMPONENT_INTERFACE_KEY}))`;
  const filterModelKey = `User/(esm/_Xwy9EG6bEe2wNaja8kBvcQ)/TransferObjectTableTable-${uniqueId}-${generatorUUIDv4}-filterModel`;
  const filtersKey = `User/(esm/_Xwy9EG6bEe2wNaja8kBvcQ)/TransferObjectTableTable-${uniqueId}-${generatorUUIDv4}-filters`;
  const rowsPerPageKey = `User/(esm/_Xwy9EG6bEe2wNaja8kBvcQ)/TransferObjectTableTable-${uniqueId}-${generatorUUIDv4}-rowsPerPage`;
  ...
  const selectedRows = useRef<SelectAnswerVoteSelectionStored[]>([]);
  ...
  const rowActions: TableRowAction<SelectAnswerVoteSelectionStored>[] = useMemo(
    () => [
      {
  ...
  const filterOptions = useMemo<FilterOption[]>(
    () => [
      {
        id: 'User/(esm/_S9ttgFv5Ee6nEc5rp_Qy4A)/TableColumnFilter/(discriminator/User/(esm/_Xwy9EG6bEe2wNaja8kBvcQ)/TransferObjectTableTable)',
        attributeName: 'title',
        label: t('SelectAnswerVoteSelection.SelectAnswerVoteSelection_Table.title', {
          defaultValue: 'Title',
        }) as string,
      ...
      {
        id: 'User/(esm/_U3eEcFv5Ee6nEc5rp_Qy4A)/TableColumnFilter/(discriminator/User/(esm/_Xwy9EG6bEe2wNaja8kBvcQ)/TransferObjectTableTable)',
          ...
          Toolbar: () => (
            <GridToolbarContainer>
              ...
              {actions.exportAction && true ? (
                <Button
                  id="User/(esm/_Xwy9EG6bEe2wNaja8kBvcQ)/TransferObjectTableExportButton"
