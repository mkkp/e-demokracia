...
import { serviceUserProfileServiceForResidentDistrictImpl } from '~/services/data-axios';
...
export default function ServiceUserProfileResidentDistrictRelationViewPage(
  ...
  const serviceDistrictDistrict_View_EditRefresh = async (
    ...
    try {
      setIsLoading(true);
      setEditMode(false);
      const result = await serviceUserProfileServiceForResidentDistrictImpl.refresh(ownerData, pageQueryCustomizer);
