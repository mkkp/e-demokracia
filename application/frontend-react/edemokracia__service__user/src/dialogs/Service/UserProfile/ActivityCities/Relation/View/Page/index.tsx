...
import { serviceUserProfileServiceForActivityCitiesImpl } from '~/services/data-axios';
...
export default function ServiceUserProfileActivityCitiesRelationViewPage(
  ...
  const serviceCityCity_View_EditRefresh = async (
    ...
    try {
      setIsLoading(true);
      setEditMode(false);
      const result = await serviceUserProfileServiceForActivityCitiesImpl.refresh(ownerData, pageQueryCustomizer);
