...
export const SERVICE_USER_VOTE_DEFINITION_ACTIVE_VOTE_DEFINITIONS_IN_ACTIVITY_CITIES_ADD_SELECTOR_PAGE_ACTIONS_HOOK_INTERFACE_KEY =
...
export const useServiceUserVoteDefinitionActiveVoteDefinitionsInActivityCitiesAddSelectorPage = (): ((
  ownerData: any,
  ...
  return (ownerData: any, alreadySelected: ServiceVoteDefinitionStored[]) =>
    new Promise((resolve) => {
      createDialog({
        ...
        children: (
          <ServiceUserVoteDefinitionActiveVoteDefinitionsInActivityCitiesAddSelectorPage
            ownerData={ownerData}
...
export interface ServiceUserVoteDefinitionActiveVoteDefinitionsInActivityCitiesAddSelectorPageProps {
  ownerData: any;
  alreadySelected: ServiceVoteDefinitionStored[];
...
// XMIID: User/(esm/_b8NPIF5BEe6vsex_cZNQbQ)/RelationFeatureTableAddSelectorPageDefinition
// Name: service::UserVoteDefinition::activeVoteDefinitionsInActivityCities::AddSelectorPage
export default function ServiceUserVoteDefinitionActiveVoteDefinitionsInActivityCitiesAddSelectorPage(
  props: ServiceUserVoteDefinitionActiveVoteDefinitionsInActivityCitiesAddSelectorPageProps,
) {
  ...
  const { service: customActionsHook } =
    useTrackService<ServiceVoteDefinitionVoteDefinition_TableAddSelectorActionsHook>(
      `(${OBJECTCLASS}=${SERVICE_USER_VOTE_DEFINITION_ACTIVE_VOTE_DEFINITIONS_IN_ACTIVITY_CITIES_ADD_SELECTOR_PAGE_ACTIONS_HOOK_INTERFACE_KEY})`,
    );
  ...
  return (
    <div
      id="User/(esm/_b8NPIF5BEe6vsex_cZNQbQ)/RelationFeatureTableAddSelectorPageDefinition"
      data-page-name="service::UserVoteDefinition::activeVoteDefinitionsInActivityCities::AddSelectorPage"
    >
      <Suspense>
