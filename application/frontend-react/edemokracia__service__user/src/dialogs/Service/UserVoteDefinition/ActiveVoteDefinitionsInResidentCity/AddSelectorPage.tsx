...
export const SERVICE_USER_VOTE_DEFINITION_ACTIVE_VOTE_DEFINITIONS_IN_RESIDENT_CITY_ADD_SELECTOR_PAGE_ACTIONS_HOOK_INTERFACE_KEY =
...
export const useServiceUserVoteDefinitionActiveVoteDefinitionsInResidentCityAddSelectorPage = (): ((
  ownerData: any,
  ...
  return (ownerData: any, alreadySelected: ServiceVoteDefinitionStored[]) =>
    new Promise((resolve) => {
      createDialog({
        ...
        children: (
          <ServiceUserVoteDefinitionActiveVoteDefinitionsInResidentCityAddSelectorPage
            ownerData={ownerData}
...
export interface ServiceUserVoteDefinitionActiveVoteDefinitionsInResidentCityAddSelectorPageProps {
  ownerData: any;
  alreadySelected: ServiceVoteDefinitionStored[];
...
// XMIID: User/(esm/_9qDp0F5BEe6vsex_cZNQbQ)/RelationFeatureTableAddSelectorPageDefinition
// Name: service::UserVoteDefinition::activeVoteDefinitionsInResidentCity::AddSelectorPage
export default function ServiceUserVoteDefinitionActiveVoteDefinitionsInResidentCityAddSelectorPage(
  props: ServiceUserVoteDefinitionActiveVoteDefinitionsInResidentCityAddSelectorPageProps,
) {
  ...
  const { service: customActionsHook } =
    useTrackService<ServiceVoteDefinitionVoteDefinition_TableAddSelectorActionsHook>(
      `(${OBJECTCLASS}=${SERVICE_USER_VOTE_DEFINITION_ACTIVE_VOTE_DEFINITIONS_IN_RESIDENT_CITY_ADD_SELECTOR_PAGE_ACTIONS_HOOK_INTERFACE_KEY})`,
    );
  ...
  return (
    <div
      id="User/(esm/_9qDp0F5BEe6vsex_cZNQbQ)/RelationFeatureTableAddSelectorPageDefinition"
      data-page-name="service::UserVoteDefinition::activeVoteDefinitionsInResidentCity::AddSelectorPage"
    >
      <Suspense>
