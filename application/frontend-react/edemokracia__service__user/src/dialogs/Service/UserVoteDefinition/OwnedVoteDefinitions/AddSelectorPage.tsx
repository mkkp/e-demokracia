...
export const SERVICE_USER_VOTE_DEFINITION_OWNED_VOTE_DEFINITIONS_ADD_SELECTOR_PAGE_ACTIONS_HOOK_INTERFACE_KEY =
  'SERVICE_USER_VOTE_DEFINITION_OWNED_VOTE_DEFINITIONS_ADD_SELECTOR_PAGE_ACTIONS_HOOK';
...
export const useServiceUserVoteDefinitionOwnedVoteDefinitionsAddSelectorPage = (): ((
  ownerData: any,
  ...
  return (ownerData: any, alreadySelected: ServiceVoteDefinitionStored[], isDraft?: boolean) =>
    new Promise((resolve) => {
      createDialog({
        ...
        children: (
          <ServiceUserVoteDefinitionOwnedVoteDefinitionsAddSelectorPage
            ownerData={ownerData}
...
export interface ServiceUserVoteDefinitionOwnedVoteDefinitionsAddSelectorPageProps {
  ownerData: any;
...
// XMIID: User/(esm/_7OZ8MF5AEe6vsex_cZNQbQ)/RelationFeatureTableAddSelectorPageDefinition
// Name: service::UserVoteDefinition::ownedVoteDefinitions::AddSelectorPage
export default function ServiceUserVoteDefinitionOwnedVoteDefinitionsAddSelectorPage(
  props: ServiceUserVoteDefinitionOwnedVoteDefinitionsAddSelectorPageProps,
) {
  ...
  const { service: customActionsHook } =
    useTrackService<ServiceVoteDefinitionVoteDefinition_TableAddSelectorActionsHook>(
      `(${OBJECTCLASS}=${SERVICE_USER_VOTE_DEFINITION_OWNED_VOTE_DEFINITIONS_ADD_SELECTOR_PAGE_ACTIONS_HOOK_INTERFACE_KEY})`,
    );
  ...
  return (
    <ServiceVoteDefinitionVoteDefinition_TableAddSelectorViewModelContext.Provider value={viewModel}>
      <Suspense>
        <div
          id="User/(esm/_7OZ8MF5AEe6vsex_cZNQbQ)/RelationFeatureTableAddSelectorPageDefinition"
          data-page-name="service::UserVoteDefinition::ownedVoteDefinitions::AddSelectorPage"
        />
