...
export const SERVICE_USER_VOTE_DEFINITION_USER_VOTE_DEFINITION_VIEW_EDIT_ROOT_TAB_BAR_ACTIVE_GLOBAL_VOTE_DEFINITIONS_GROUP_ACTIVE_VOTE_DEFINITIONS_GLOBAL_TABLE_ADD_SELECTOR_PAGE_ACTIONS_HOOK_INTERFACE_KEY =
...
export const useServiceUserVoteDefinitionUserVoteDefinition_View_EditRootTabBarActiveGlobalVoteDefinitionsGroupActiveVoteDefinitionsGlobalTableAddSelectorPage =
  (): ((
    ownerData: any,
    ...
    return (ownerData: any, alreadySelected: ServiceVoteDefinitionStored[]) =>
      new Promise((resolve) => {
        createDialog({
          ...
          children: (
            <ServiceUserVoteDefinitionUserVoteDefinition_View_EditRootTabBarActiveGlobalVoteDefinitionsGroupActiveVoteDefinitionsGlobalTableAddSelectorPage
              ownerData={ownerData}
...
export interface ServiceUserVoteDefinitionUserVoteDefinition_View_EditRootTabBarActiveGlobalVoteDefinitionsGroupActiveVoteDefinitionsGlobalTableAddSelectorPageProps {
  ownerData: any;
  alreadySelected: ServiceVoteDefinitionStored[];
...
// XMIID: User/(esm/_XdUIUF5JEe6vsex_cZNQbQ)/TabularReferenceFieldTableAddSelectorPageDefinition
// Name: service::UserVoteDefinition::UserVoteDefinition_View_Edit::root::tabBar::ActiveGlobalVoteDefinitionsGroup::activeVoteDefinitionsGlobal::TableAddSelectorPage
export default function ServiceUserVoteDefinitionUserVoteDefinition_View_EditRootTabBarActiveGlobalVoteDefinitionsGroupActiveVoteDefinitionsGlobalTableAddSelectorPage(
  props: ServiceUserVoteDefinitionUserVoteDefinition_View_EditRootTabBarActiveGlobalVoteDefinitionsGroupActiveVoteDefinitionsGlobalTableAddSelectorPageProps,
) {
  ...
  const { service: customActionsHook } =
    useTrackService<ServiceVoteDefinitionVoteDefinition_TableAddSelectorActionsHook>(
      `(${OBJECTCLASS}=${SERVICE_USER_VOTE_DEFINITION_USER_VOTE_DEFINITION_VIEW_EDIT_ROOT_TAB_BAR_ACTIVE_GLOBAL_VOTE_DEFINITIONS_GROUP_ACTIVE_VOTE_DEFINITIONS_GLOBAL_TABLE_ADD_SELECTOR_PAGE_ACTIONS_HOOK_INTERFACE_KEY})`,
    );
  ...
  return (
    <div
      id="User/(esm/_XdUIUF5JEe6vsex_cZNQbQ)/TabularReferenceFieldTableAddSelectorPageDefinition"
      data-page-name="service::UserVoteDefinition::UserVoteDefinition_View_Edit::root::tabBar::ActiveGlobalVoteDefinitionsGroup::activeVoteDefinitionsGlobal::TableAddSelectorPage"
    >
      <Suspense>
