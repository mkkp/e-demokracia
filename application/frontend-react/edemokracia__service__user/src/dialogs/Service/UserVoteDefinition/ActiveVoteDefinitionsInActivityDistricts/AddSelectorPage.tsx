...
export const SERVICE_USER_VOTE_DEFINITION_ACTIVE_VOTE_DEFINITIONS_IN_ACTIVITY_DISTRICTS_ADD_SELECTOR_PAGE_ACTIONS_HOOK_INTERFACE_KEY =
...
export const useServiceUserVoteDefinitionActiveVoteDefinitionsInActivityDistrictsAddSelectorPage = (): ((
  ownerData: any,
  ...
  return (ownerData: any, alreadySelected: ServiceVoteDefinitionStored[]) =>
    new Promise((resolve) => {
      createDialog({
        ...
        children: (
          <ServiceUserVoteDefinitionActiveVoteDefinitionsInActivityDistrictsAddSelectorPage
            ownerData={ownerData}
...
export interface ServiceUserVoteDefinitionActiveVoteDefinitionsInActivityDistrictsAddSelectorPageProps {
  ownerData: any;
  alreadySelected: ServiceVoteDefinitionStored[];
...
// XMIID: User/(esm/_kXCGYF5BEe6vsex_cZNQbQ)/RelationFeatureTableAddSelectorPageDefinition
// Name: service::UserVoteDefinition::activeVoteDefinitionsInActivityDistricts::AddSelectorPage
export default function ServiceUserVoteDefinitionActiveVoteDefinitionsInActivityDistrictsAddSelectorPage(
  props: ServiceUserVoteDefinitionActiveVoteDefinitionsInActivityDistrictsAddSelectorPageProps,
) {
  ...
  const { service: customActionsHook } =
    useTrackService<ServiceVoteDefinitionVoteDefinition_TableAddSelectorActionsHook>(
      `(${OBJECTCLASS}=${SERVICE_USER_VOTE_DEFINITION_ACTIVE_VOTE_DEFINITIONS_IN_ACTIVITY_DISTRICTS_ADD_SELECTOR_PAGE_ACTIONS_HOOK_INTERFACE_KEY})`,
    );
  ...
  return (
    <div
      id="User/(esm/_kXCGYF5BEe6vsex_cZNQbQ)/RelationFeatureTableAddSelectorPageDefinition"
      data-page-name="service::UserVoteDefinition::activeVoteDefinitionsInActivityDistricts::AddSelectorPage"
    >
      <Suspense>
