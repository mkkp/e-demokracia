...
export const SERVICE_USER_VOTE_DEFINITION_ACTIVE_VOTE_DEFINITIONS_IN_RESIDENT_COUNTY_ADD_SELECTOR_PAGE_ACTIONS_HOOK_INTERFACE_KEY =
...
export const useServiceUserVoteDefinitionActiveVoteDefinitionsInResidentCountyAddSelectorPage = (): ((
  ownerData: any,
  ...
  return (ownerData: any, alreadySelected: ServiceVoteDefinitionStored[]) =>
    new Promise((resolve) => {
      createDialog({
        ...
        children: (
          <ServiceUserVoteDefinitionActiveVoteDefinitionsInResidentCountyAddSelectorPage
            ownerData={ownerData}
...
export interface ServiceUserVoteDefinitionActiveVoteDefinitionsInResidentCountyAddSelectorPageProps {
  ownerData: any;
  alreadySelected: ServiceVoteDefinitionStored[];
...
// XMIID: User/(esm/_yd4FQF5BEe6vsex_cZNQbQ)/RelationFeatureTableAddSelectorPageDefinition
// Name: service::UserVoteDefinition::activeVoteDefinitionsInResidentCounty::AddSelectorPage
export default function ServiceUserVoteDefinitionActiveVoteDefinitionsInResidentCountyAddSelectorPage(
  props: ServiceUserVoteDefinitionActiveVoteDefinitionsInResidentCountyAddSelectorPageProps,
) {
  ...
  const { service: customActionsHook } =
    useTrackService<ServiceVoteDefinitionVoteDefinition_TableAddSelectorActionsHook>(
      `(${OBJECTCLASS}=${SERVICE_USER_VOTE_DEFINITION_ACTIVE_VOTE_DEFINITIONS_IN_RESIDENT_COUNTY_ADD_SELECTOR_PAGE_ACTIONS_HOOK_INTERFACE_KEY})`,
    );
  ...
  return (
    <div
      id="User/(esm/_yd4FQF5BEe6vsex_cZNQbQ)/RelationFeatureTableAddSelectorPageDefinition"
      data-page-name="service::UserVoteDefinition::activeVoteDefinitionsInResidentCounty::AddSelectorPage"
    >
      <Suspense>
