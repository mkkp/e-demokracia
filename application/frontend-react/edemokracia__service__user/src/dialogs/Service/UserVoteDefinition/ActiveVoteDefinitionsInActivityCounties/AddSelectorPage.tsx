...
export const SERVICE_USER_VOTE_DEFINITION_ACTIVE_VOTE_DEFINITIONS_IN_ACTIVITY_COUNTIES_ADD_SELECTOR_PAGE_ACTIONS_HOOK_INTERFACE_KEY =
...
export const useServiceUserVoteDefinitionActiveVoteDefinitionsInActivityCountiesAddSelectorPage = (): ((
  ownerData: any,
  ...
  return (ownerData: any, alreadySelected: ServiceVoteDefinitionStored[]) =>
    new Promise((resolve) => {
      createDialog({
        ...
        children: (
          <ServiceUserVoteDefinitionActiveVoteDefinitionsInActivityCountiesAddSelectorPage
            ownerData={ownerData}
...
export interface ServiceUserVoteDefinitionActiveVoteDefinitionsInActivityCountiesAddSelectorPageProps {
  ownerData: any;
  alreadySelected: ServiceVoteDefinitionStored[];
...
// XMIID: User/(esm/_O_SswF5BEe6vsex_cZNQbQ)/RelationFeatureTableAddSelectorPageDefinition
// Name: service::UserVoteDefinition::activeVoteDefinitionsInActivityCounties::AddSelectorPage
export default function ServiceUserVoteDefinitionActiveVoteDefinitionsInActivityCountiesAddSelectorPage(
  props: ServiceUserVoteDefinitionActiveVoteDefinitionsInActivityCountiesAddSelectorPageProps,
) {
  ...
  const { service: customActionsHook } =
    useTrackService<ServiceVoteDefinitionVoteDefinition_TableAddSelectorActionsHook>(
      `(${OBJECTCLASS}=${SERVICE_USER_VOTE_DEFINITION_ACTIVE_VOTE_DEFINITIONS_IN_ACTIVITY_COUNTIES_ADD_SELECTOR_PAGE_ACTIONS_HOOK_INTERFACE_KEY})`,
    );
  ...
  return (
    <div
      id="User/(esm/_O_SswF5BEe6vsex_cZNQbQ)/RelationFeatureTableAddSelectorPageDefinition"
      data-page-name="service::UserVoteDefinition::activeVoteDefinitionsInActivityCounties::AddSelectorPage"
    >
      <Suspense>
