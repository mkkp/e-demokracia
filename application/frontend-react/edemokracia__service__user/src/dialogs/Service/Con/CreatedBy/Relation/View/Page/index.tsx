...
import { serviceConServiceForCreatedByImpl } from '~/services/data-axios';
...
// Name: service::Con::createdBy::Relation::View::Page
export default function ServiceConCreatedByRelationViewPage(props: ServiceConCreatedByRelationViewPageProps) {
  ...
  const serviceServiceUserServiceUser_View_EditRefresh = async (
    ...
    try {
      setIsLoading(true);
      setEditMode(false);
      const result = await serviceConServiceForCreatedByImpl.refresh(ownerData, pageQueryCustomizer);
  ...
  const serviceServiceUserServiceUser_View_EditAreasResidencyResidentCityAutocomplete = async (
    ...
    try {
      return serviceConServiceForCreatedByImpl.getRangeForResidentCity(data, queryCustomizer);
    } catch (error) {
      handleError(error);
  ...
  const serviceServiceUserServiceUser_View_EditAreasResidencyResidentDistrictAutocomplete = async (
    ...
    try {
      return serviceConServiceForCreatedByImpl.getRangeForResidentDistrict(data, queryCustomizer);
    } catch (error) {
      handleError(error);
      return Promise.resolve([]);
    }
  ...
  const serviceServiceUserServiceUser_View_EditAreasResidencyResidentCountyAutocomplete = async (
    ...
    try {
      return serviceConServiceForCreatedByImpl.getRangeForResidentCounty(data, queryCustomizer);
    } catch (error) {
      handleError(error);
      return Promise.resolve([]);
    }
