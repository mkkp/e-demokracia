...
export default function ServiceConCon_View_EditCreateConArgumentInputForm(
  ...
  const serviceConCon_View_EditArgumentsConsActionsCreateConArgument = async () => {
    try {
      setIsLoading(true);
  ...
  const createArgumentInputCreateArgumentInput_FormGetTemplate = async (): Promise<CreateArgumentInput> => {
    try {
      setIsLoading(true);
      const result = await serviceConServiceImpl.getTemplateForCreateConArgument();
  ...
  const actions: CreateArgumentInputCreateArgumentInput_FormDialogActions = {
    ...
    serviceConCon_View_EditArgumentsConsActionsCreateConArgument,
