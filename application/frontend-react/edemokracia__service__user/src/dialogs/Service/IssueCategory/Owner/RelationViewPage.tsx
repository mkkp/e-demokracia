...
export const SERVICE_ISSUE_CATEGORY_OWNER_RELATION_VIEW_PAGE_ACTIONS_HOOK_INTERFACE_KEY =
  'SERVICE_ISSUE_CATEGORY_OWNER_RELATION_VIEW_PAGE_ACTIONS_HOOK';
...
// Name: service::IssueCategory::owner::RelationViewPage
    ...
    <ServiceServiceUserServiceUser_View_EditViewModelContext.Provider value={viewModel}>
      <Suspense>
        <div
          ...
          data-page-name="service::IssueCategory::owner::RelationViewPage"
        />
