...
export const SERVICE_ISSUE_ISSUE_VIEW_EDIT_OTHER_CATEGORIES_CATEGORIES_TABULAR_REFERENCE_FIELD_TABLE_SET_SELECTOR_PAGE_ACTIONS_HOOK_INTERFACE_KEY =
...
export const useServiceIssueIssue_View_EditOtherCategoriesCategoriesTabularReferenceFieldTableSetSelectorPage = (): ((
  ownerData: any,
  ...
  return (ownerData: any, alreadySelected: ServiceIssueCategoryStored[]) =>
    new Promise((resolve) => {
      createDialog({
        ...
        children: (
          <ServiceIssueIssue_View_EditOtherCategoriesCategoriesTabularReferenceFieldTableSetSelectorPage
            ownerData={ownerData}
...
export interface ServiceIssueIssue_View_EditOtherCategoriesCategoriesTabularReferenceFieldTableSetSelectorPageProps {
  ownerData: any;
  alreadySelected: ServiceIssueCategoryStored[];
...
// Name: service::Issue::Issue_View_Edit::other::categories::categories::TabularReferenceField::Table::Set::Selector::Page
// Open in dialog: true
export default function ServiceIssueIssue_View_EditOtherCategoriesCategoriesTabularReferenceFieldTableSetSelectorPage(
  props: ServiceIssueIssue_View_EditOtherCategoriesCategoriesTabularReferenceFieldTableSetSelectorPageProps,
) {
  ...
  const { service: customActionsHook } = useTrackService<ServiceIssueCategoryIssueCategory_TableAddSelectorActionsHook>(
    `(${OBJECTCLASS}=${SERVICE_ISSUE_ISSUE_VIEW_EDIT_OTHER_CATEGORIES_CATEGORIES_TABULAR_REFERENCE_FIELD_TABLE_SET_SELECTOR_PAGE_ACTIONS_HOOK_INTERFACE_KEY})`,
  );
  ...
  return (
    <div
      ...
      data-page-name="service::Issue::Issue_View_Edit::other::categories::categories::TabularReferenceField::Table::Set::Selector::Page"
    >
      <Suspense>
