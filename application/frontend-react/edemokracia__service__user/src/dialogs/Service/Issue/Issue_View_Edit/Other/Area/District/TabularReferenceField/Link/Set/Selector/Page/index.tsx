...
export const SERVICE_ISSUE_ISSUE_VIEW_EDIT_OTHER_AREA_DISTRICT_TABULAR_REFERENCE_FIELD_LINK_SET_SELECTOR_PAGE_ACTIONS_HOOK_INTERFACE_KEY =
...
export const useServiceIssueIssue_View_EditOtherAreaDistrictTabularReferenceFieldLinkSetSelectorPage = (): ((
  ownerData: any,
  ...
  return (ownerData: any, alreadySelected: ServiceDistrictStored[]) =>
    new Promise((resolve) => {
      createDialog({
        ...
        children: (
          <ServiceIssueIssue_View_EditOtherAreaDistrictTabularReferenceFieldLinkSetSelectorPage
            ownerData={ownerData}
...
export interface ServiceIssueIssue_View_EditOtherAreaDistrictTabularReferenceFieldLinkSetSelectorPageProps {
  ownerData: any;
  alreadySelected: ServiceDistrictStored[];
...
// Name: service::Issue::Issue_View_Edit::other::area::district::TabularReferenceField::Link::Set::Selector::Page
// Open in dialog: true
export default function ServiceIssueIssue_View_EditOtherAreaDistrictTabularReferenceFieldLinkSetSelectorPage(
  props: ServiceIssueIssue_View_EditOtherAreaDistrictTabularReferenceFieldLinkSetSelectorPageProps,
) {
  ...
  const { service: customActionsHook } = useTrackService<ServiceDistrictDistrict_TableSetSelectorActionsHook>(
    `(${OBJECTCLASS}=${SERVICE_ISSUE_ISSUE_VIEW_EDIT_OTHER_AREA_DISTRICT_TABULAR_REFERENCE_FIELD_LINK_SET_SELECTOR_PAGE_ACTIONS_HOOK_INTERFACE_KEY})`,
  );
  ...
  return (
    <div
      ...
      data-page-name="service::Issue::Issue_View_Edit::other::area::district::TabularReferenceField::Link::Set::Selector::Page"
    >
      <Suspense>
