...
import { serviceIssueServiceForCreatedByImpl } from '~/services/data-axios';
...
// Name: service::Issue::createdBy::Relation::View::Page
export default function ServiceIssueCreatedByRelationViewPage(props: ServiceIssueCreatedByRelationViewPageProps) {
  ...
  const serviceServiceUserServiceUser_View_EditRefresh = async (
    ...
    try {
      setIsLoading(true);
      setEditMode(false);
      const result = await serviceIssueServiceForCreatedByImpl.refresh(ownerData, pageQueryCustomizer);
  ...
  const serviceServiceUserServiceUser_View_EditAreasResidencyResidentCityAutocomplete = async (
    ...
    try {
      return serviceIssueServiceForCreatedByImpl.getRangeForResidentCity(data, queryCustomizer);
    } catch (error) {
      handleError(error);
  ...
  const serviceServiceUserServiceUser_View_EditAreasResidencyResidentDistrictAutocomplete = async (
    ...
    try {
      return serviceIssueServiceForCreatedByImpl.getRangeForResidentDistrict(data, queryCustomizer);
    } catch (error) {
      handleError(error);
      return Promise.resolve([]);
    }
  ...
  const serviceServiceUserServiceUser_View_EditAreasResidencyResidentCountyAutocomplete = async (
    ...
    try {
      return serviceIssueServiceForCreatedByImpl.getRangeForResidentCounty(data, queryCustomizer);
    } catch (error) {
      handleError(error);
      return Promise.resolve([]);
    }
