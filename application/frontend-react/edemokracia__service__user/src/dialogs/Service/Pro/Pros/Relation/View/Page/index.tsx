...
import { serviceProServiceForProsImpl } from '~/services/data-axios';

export const useServiceProProsRelationViewPage = (): ((ownerData: any) => Promise<DialogResult<ServiceProStored>>) => {
...
// Name: service::Pro::pros::Relation::View::Page
export default function ServiceProProsRelationViewPage(props: ServiceProProsRelationViewPageProps) {
  ...
  const serviceProPro_View_EditRefresh = async (
    ...
    try {
      setIsLoading(true);
      setEditMode(false);
      const result = await serviceProServiceForProsImpl.refresh(ownerData, pageQueryCustomizer);
