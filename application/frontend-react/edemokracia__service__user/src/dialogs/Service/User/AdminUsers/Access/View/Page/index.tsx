...
export const useServiceUserAdminUsersAccessViewPage = (): ((
  ownerData: any,
  ...
  return (ownerData: any) =>
    new Promise((resolve) => {
      createDialog({
        ...
        children: (
          <ServiceUserAdminUsersAccessViewPage
            ownerData={ownerData}
            onClose={() => {
              closeDialog();
              resolve({
...
export const convertServiceUserAdminUsersAccessViewPagePayload = (
...
export interface ServiceUserAdminUsersAccessViewPageProps {
  ownerData: any;
...
// Name: service::User::adminUsers::Access::View::Page
export default function ServiceUserAdminUsersAccessViewPage(props: ServiceUserAdminUsersAccessViewPageProps) {
  ...
  const storeDiff: (attributeName: keyof ServiceServiceUser, value: any) => void = useCallback(
    (attributeName: keyof ServiceServiceUser, value: any) => {
      payloadDiff.current![attributeName] = convertServiceUserAdminUsersAccessViewPagePayload(attributeName, value);
      setData((prevData) => ({
        ...prevData,
        [attributeName]: value,
      }));
  ...
  const serviceServiceUserServiceUser_View_EditRefresh = async (
    ...
    try {
      setIsLoading(true);
      setEditMode(false);
      const result = await userServiceForAdminUsersImpl.refresh(ownerData, pageQueryCustomizer);
  ...
  const serviceServiceUserServiceUser_View_EditUpdate = async () => {
    ...
    try {
      const res = await userServiceForAdminUsersImpl.update(payloadDiff.current);
  ...
  const serviceServiceUserServiceUser_View_EditDelete = async () => {
    try {
      ...
      if (confirmed) {
        await userServiceForAdminUsersImpl.delete(data);
  ...
  const serviceServiceUserServiceUser_View_EditAreasResidencyResidentCityAutocomplete = async (
    ...
    try {
      return userServiceForAdminUsersImpl.getRangeForResidentCity(data, queryCustomizer);
    } catch (error) {
      handleError(error);
  ...
  const serviceServiceUserServiceUser_View_EditAreasResidencyResidentDistrictAutocomplete = async (
    ...
    try {
      return userServiceForAdminUsersImpl.getRangeForResidentDistrict(data, queryCustomizer);
    } catch (error) {
      handleError(error);
      return Promise.resolve([]);
    }
  ...
  const serviceServiceUserServiceUser_View_EditAreasResidencyResidentCountyAutocomplete = async (
    ...
    try {
      return userServiceForAdminUsersImpl.getRangeForResidentCounty(data, queryCustomizer);
    } catch (error) {
      handleError(error);
      return Promise.resolve([]);
    }
