...
export const SERVICE_USER_ADMIN_USERS_ACCESS_VIEW_PAGE_ACTIONS_HOOK_INTERFACE_KEY =
...
// XMIID: User/(esm/_hvVS8GkuEe25ONJ3V89cVA)/AccessViewPageDefinition
...
export default function ServiceUserAdminUsersAccessViewPage(props: ServiceUserAdminUsersAccessViewPageProps) {
  ...
  const { service: customActionsHook } = useTrackService<ServiceServiceUserServiceUser_View_EditActionsHook>(
    `(${OBJECTCLASS}=${SERVICE_USER_ADMIN_USERS_ACCESS_VIEW_PAGE_ACTIONS_HOOK_INTERFACE_KEY})`,
  );
  ...
  const residentCountyAutocompleteRangeAction = async (
    ...
    // page service::User::adminUsers::Access::View::Page
    try {
  ...
  return (
    <div
      id="User/(esm/_hvVS8GkuEe25ONJ3V89cVA)/AccessViewPageDefinition"
      data-page-name="service::User::adminUsers::Access::View::Page"
    >
      <Suspense>
