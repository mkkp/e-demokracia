...
export const SERVICE_YES_NO_ABSTAIN_VOTE_DEFINITION_OWNER_RELATION_VIEW_PAGE_ACTIONS_HOOK_INTERFACE_KEY =
  'SERVICE_YES_NO_ABSTAIN_VOTE_DEFINITION_OWNER_RELATION_VIEW_PAGE_ACTIONS_HOOK';
...
export const useServiceYesNoAbstainVoteDefinitionOwnerRelationViewPage = (): ((
  ownerData: any,
  templateDataOverride?: Partial<ServiceServiceUser>,
  isDraft?: boolean,
  ...
  return (
    ...
    new Promise((resolve) => {
      createDialog({
        ...
        children: (
          <ServiceYesNoAbstainVoteDefinitionOwnerRelationViewPage
            ownerData={ownerData}
...
export const convertServiceYesNoAbstainVoteDefinitionOwnerRelationViewPagePayload = (
...
export interface ServiceYesNoAbstainVoteDefinitionOwnerRelationViewPageProps {
  ownerData: any;
...
// XMIID: User/(esm/_7ox0oHz4Ee6Q9LyUVjs1Qw)/RelationFeatureView
// Name: service::YesNoAbstainVoteDefinition::owner::RelationViewPage
export default function ServiceYesNoAbstainVoteDefinitionOwnerRelationViewPage(
  props: ServiceYesNoAbstainVoteDefinitionOwnerRelationViewPageProps,
) {
  ...
  const storeDiff: (attributeName: keyof ServiceServiceUser, value: any) => void = useCallback(
    (attributeName: keyof ServiceServiceUser, value: any) => {
      payloadDiff.current![attributeName] = convertServiceYesNoAbstainVoteDefinitionOwnerRelationViewPagePayload(
        attributeName,
        value,
      );
      setData((prevData) => ({
  ...
  const { service: customActionsHook } = useTrackService<ServiceServiceUserServiceUser_View_EditActionsHook>(
    `(${OBJECTCLASS}=${SERVICE_YES_NO_ABSTAIN_VOTE_DEFINITION_OWNER_RELATION_VIEW_PAGE_ACTIONS_HOOK_INTERFACE_KEY})`,
  );
  ...
  return (
    <ServiceServiceUserServiceUser_View_EditViewModelContext.Provider value={viewModel}>
      <Suspense>
        <div
          id="User/(esm/_7ox0oHz4Ee6Q9LyUVjs1Qw)/RelationFeatureView"
          data-page-name="service::YesNoAbstainVoteDefinition::owner::RelationViewPage"
        />
