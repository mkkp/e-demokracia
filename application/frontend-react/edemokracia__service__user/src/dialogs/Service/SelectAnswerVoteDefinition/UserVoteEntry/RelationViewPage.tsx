...
export const SERVICE_SELECT_ANSWER_VOTE_DEFINITION_USER_VOTE_ENTRY_RELATION_VIEW_PAGE_ACTIONS_HOOK_INTERFACE_KEY =
  'SERVICE_SELECT_ANSWER_VOTE_DEFINITION_USER_VOTE_ENTRY_RELATION_VIEW_PAGE_ACTIONS_HOOK';
...
export const useServiceSelectAnswerVoteDefinitionUserVoteEntryRelationViewPage = (): ((
  ownerData: any,
  templateDataOverride?: Partial<ServiceSelectAnswerVoteEntry>,
  isDraft?: boolean,
  ...
  return (
    ...
    new Promise((resolve) => {
      createDialog({
        ...
        children: (
          <ServiceSelectAnswerVoteDefinitionUserVoteEntryRelationViewPage
            ownerData={ownerData}
...
export const convertServiceSelectAnswerVoteDefinitionUserVoteEntryRelationViewPagePayload = (
...
export interface ServiceSelectAnswerVoteDefinitionUserVoteEntryRelationViewPageProps {
  ownerData: any;
...
// Name: service::SelectAnswerVoteDefinition::userVoteEntry::RelationViewPage
export default function ServiceSelectAnswerVoteDefinitionUserVoteEntryRelationViewPage(
  props: ServiceSelectAnswerVoteDefinitionUserVoteEntryRelationViewPageProps,
) {
  const { ownerData, templateDataOverride, onClose, onSubmit, isDraft, ownerValidation } = props;

  // Services
  const serviceSelectAnswerVoteDefinitionServiceForUserVoteEntryImpl = useMemo(
  ...
  const storeDiff: (attributeName: keyof ServiceSelectAnswerVoteEntry, value: any) => void = useCallback(
    (attributeName: keyof ServiceSelectAnswerVoteEntry, value: any) => {
      payloadDiff.current![attributeName] =
        convertServiceSelectAnswerVoteDefinitionUserVoteEntryRelationViewPagePayload(attributeName, value);
      setData((prevData) => ({
        ...prevData,
        [attributeName]: value,
      }));
  ...
  const { service: customActionsHook } =
    useTrackService<ServiceSelectAnswerVoteEntrySelectAnswerVoteEntry_View_EditActionsHook>(
      `(${OBJECTCLASS}=${SERVICE_SELECT_ANSWER_VOTE_DEFINITION_USER_VOTE_ENTRY_RELATION_VIEW_PAGE_ACTIONS_HOOK_INTERFACE_KEY})`,
    );
  ...
  return (
    <ServiceSelectAnswerVoteEntrySelectAnswerVoteEntry_View_EditViewModelContext.Provider value={viewModel}>
      <Suspense>
        <div
          id="User/(esm/_Hpz9UFtqEe6Mx9dH3yj5gQ)/RelationFeatureView"
          data-page-name="service::SelectAnswerVoteDefinition::userVoteEntry::RelationViewPage"
        />
