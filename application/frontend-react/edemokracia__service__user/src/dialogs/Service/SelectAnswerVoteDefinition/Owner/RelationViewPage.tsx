...
export const SERVICE_SELECT_ANSWER_VOTE_DEFINITION_OWNER_RELATION_VIEW_PAGE_ACTIONS_HOOK_INTERFACE_KEY =
  'SERVICE_SELECT_ANSWER_VOTE_DEFINITION_OWNER_RELATION_VIEW_PAGE_ACTIONS_HOOK';
...
export const useServiceSelectAnswerVoteDefinitionOwnerRelationViewPage = (): ((
  ownerData: any,
  templateDataOverride?: Partial<ServiceServiceUser>,
  isDraft?: boolean,
  ...
  return (
    ...
    new Promise((resolve) => {
      createDialog({
        ...
        children: (
          <ServiceSelectAnswerVoteDefinitionOwnerRelationViewPage
            ownerData={ownerData}
...
export const convertServiceSelectAnswerVoteDefinitionOwnerRelationViewPagePayload = (
...
export interface ServiceSelectAnswerVoteDefinitionOwnerRelationViewPageProps {
  ownerData: any;
...
// XMIID: User/(esm/_K-gBcHz5Ee6Q9LyUVjs1Qw)/RelationFeatureView
// Name: service::SelectAnswerVoteDefinition::owner::RelationViewPage
export default function ServiceSelectAnswerVoteDefinitionOwnerRelationViewPage(
  props: ServiceSelectAnswerVoteDefinitionOwnerRelationViewPageProps,
) {
  ...
  const storeDiff: (attributeName: keyof ServiceServiceUser, value: any) => void = useCallback(
    (attributeName: keyof ServiceServiceUser, value: any) => {
      payloadDiff.current![attributeName] = convertServiceSelectAnswerVoteDefinitionOwnerRelationViewPagePayload(
        attributeName,
        value,
      );
      setData((prevData) => ({
  ...
  const { service: customActionsHook } = useTrackService<ServiceServiceUserServiceUser_View_EditActionsHook>(
    `(${OBJECTCLASS}=${SERVICE_SELECT_ANSWER_VOTE_DEFINITION_OWNER_RELATION_VIEW_PAGE_ACTIONS_HOOK_INTERFACE_KEY})`,
  );
  ...
  return (
    <ServiceServiceUserServiceUser_View_EditViewModelContext.Provider value={viewModel}>
      <Suspense>
        <div
          id="User/(esm/_K-gBcHz5Ee6Q9LyUVjs1Qw)/RelationFeatureView"
          data-page-name="service::SelectAnswerVoteDefinition::owner::RelationViewPage"
        />
