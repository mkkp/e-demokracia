...
// Name: service::ServiceUser::activityDistricts::Relation::View::Page
export default function ServiceServiceUserActivityDistrictsRelationViewPage(
  ...
  const serviceDistrictDistrict_View_EditRefresh = async (
    ...
    try {
      setIsLoading(true);
      setEditMode(false);
      const result = await serviceServiceUserServiceForActivityDistrictsImpl.refresh(ownerData, pageQueryCustomizer);
