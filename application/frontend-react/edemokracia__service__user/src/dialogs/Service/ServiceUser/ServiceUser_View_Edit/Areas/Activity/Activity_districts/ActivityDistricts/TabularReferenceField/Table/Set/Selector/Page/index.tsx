...
export const SERVICE_SERVICE_USER_SERVICE_USER_VIEW_EDIT_AREAS_ACTIVITY_ACTIVITY_DISTRICTS_ACTIVITY_DISTRICTS_TABULAR_REFERENCE_FIELD_TABLE_SET_SELECTOR_PAGE_ACTIONS_HOOK_INTERFACE_KEY =
...
export const useServiceServiceUserServiceUser_View_EditAreasActivityActivity_districtsActivityDistrictsTabularReferenceFieldTableSetSelectorPage =
  (): ((
    ownerData: any,
    ...
    return (ownerData: any, alreadySelected: ServiceDistrictStored[]) =>
      new Promise((resolve) => {
        createDialog({
          ...
          children: (
            <ServiceServiceUserServiceUser_View_EditAreasActivityActivity_districtsActivityDistrictsTabularReferenceFieldTableSetSelectorPage
              ownerData={ownerData}
...
export interface ServiceServiceUserServiceUser_View_EditAreasActivityActivity_districtsActivityDistrictsTabularReferenceFieldTableSetSelectorPageProps {
  ownerData: any;
  alreadySelected: ServiceDistrictStored[];
...
// Name: service::ServiceUser::ServiceUser_View_Edit::Areas::activity::activity_districts::activityDistricts::TabularReferenceField::Table::Set::Selector::Page
// Open in dialog: true
export default function ServiceServiceUserServiceUser_View_EditAreasActivityActivity_districtsActivityDistrictsTabularReferenceFieldTableSetSelectorPage(
  props: ServiceServiceUserServiceUser_View_EditAreasActivityActivity_districtsActivityDistrictsTabularReferenceFieldTableSetSelectorPageProps,
) {
  ...
  const { service: customActionsHook } = useTrackService<ServiceDistrictDistrict_TableAddSelectorActionsHook>(
    `(${OBJECTCLASS}=${SERVICE_SERVICE_USER_SERVICE_USER_VIEW_EDIT_AREAS_ACTIVITY_ACTIVITY_DISTRICTS_ACTIVITY_DISTRICTS_TABULAR_REFERENCE_FIELD_TABLE_SET_SELECTOR_PAGE_ACTIONS_HOOK_INTERFACE_KEY})`,
  );
  ...
  return (
    <div
      ...
      data-page-name="service::ServiceUser::ServiceUser_View_Edit::Areas::activity::activity_districts::activityDistricts::TabularReferenceField::Table::Set::Selector::Page"
    >
      <Suspense>
