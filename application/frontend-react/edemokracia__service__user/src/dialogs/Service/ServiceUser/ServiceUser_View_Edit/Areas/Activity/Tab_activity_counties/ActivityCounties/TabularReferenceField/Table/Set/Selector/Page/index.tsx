...
export const SERVICE_SERVICE_USER_SERVICE_USER_VIEW_EDIT_AREAS_ACTIVITY_TAB_ACTIVITY_COUNTIES_ACTIVITY_COUNTIES_TABULAR_REFERENCE_FIELD_TABLE_SET_SELECTOR_PAGE_ACTIONS_HOOK_INTERFACE_KEY =
...
export const useServiceServiceUserServiceUser_View_EditAreasActivityTab_activity_countiesActivityCountiesTabularReferenceFieldTableSetSelectorPage =
    ...
    return (ownerData: any, alreadySelected: ServiceCountyStored[]) =>
      new Promise((resolve) => {
        createDialog({
          ...
          children: (
            <ServiceServiceUserServiceUser_View_EditAreasActivityTab_activity_countiesActivityCountiesTabularReferenceFieldTableSetSelectorPage
              ownerData={ownerData}
...
export interface ServiceServiceUserServiceUser_View_EditAreasActivityTab_activity_countiesActivityCountiesTabularReferenceFieldTableSetSelectorPageProps {
  ownerData: any;
...
// Name: service::ServiceUser::ServiceUser_View_Edit::Areas::activity::tab_activity_counties::activityCounties::TabularReferenceField::Table::Set::Selector::Page
// Open in dialog: true
export default function ServiceServiceUserServiceUser_View_EditAreasActivityTab_activity_countiesActivityCountiesTabularReferenceFieldTableSetSelectorPage(
  props: ServiceServiceUserServiceUser_View_EditAreasActivityTab_activity_countiesActivityCountiesTabularReferenceFieldTableSetSelectorPageProps,
) {
  ...
  const { service: customActionsHook } = useTrackService<ServiceCountyCounty_TableAddSelectorActionsHook>(
    `(${OBJECTCLASS}=${SERVICE_SERVICE_USER_SERVICE_USER_VIEW_EDIT_AREAS_ACTIVITY_TAB_ACTIVITY_COUNTIES_ACTIVITY_COUNTIES_TABULAR_REFERENCE_FIELD_TABLE_SET_SELECTOR_PAGE_ACTIONS_HOOK_INTERFACE_KEY})`,
  );
  ...
  return (
    <div
      ...
      data-page-name="service::ServiceUser::ServiceUser_View_Edit::Areas::activity::tab_activity_counties::activityCounties::TabularReferenceField::Table::Set::Selector::Page"
    >
      <Suspense>
