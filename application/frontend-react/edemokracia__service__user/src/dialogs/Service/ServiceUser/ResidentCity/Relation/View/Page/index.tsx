...
// Name: service::ServiceUser::residentCity::Relation::View::Page
export default function ServiceServiceUserResidentCityRelationViewPage(
  ...
  const serviceCityCity_View_EditRefresh = async (
    ...
    try {
      setIsLoading(true);
      setEditMode(false);
      const result = await serviceServiceUserServiceForResidentCityImpl.refresh(ownerData, pageQueryCustomizer);
  ...
  const serviceCityCity_View_EditCancel = async () => {
    // no need to set editMode to false, given refresh should do it implicitly
    await serviceCityCity_View_EditRefresh(processQueryCustomizer(pageQueryCustomizer));
  };
  const serviceCityCity_View_EditUpdate = async () => {
    setIsLoading(true);
    ...
    try {
      ...
      if (res) {
        ...
        await actions.serviceCityCity_View_EditRefresh!(pageQueryCustomizer);
        setEditMode(false);
      }
    } catch (error) {
  ...
  const actions: ServiceCityCity_View_EditDialogActions = {
    ...
    serviceCityCity_View_EditCancel,
    serviceCityCity_View_EditUpdate,
