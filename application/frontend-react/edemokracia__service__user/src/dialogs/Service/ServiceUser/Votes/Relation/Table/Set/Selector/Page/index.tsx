...
export const SERVICE_SERVICE_USER_VOTES_RELATION_TABLE_SET_SELECTOR_PAGE_ACTIONS_HOOK_INTERFACE_KEY =
...
export const useServiceServiceUserVotesRelationTableSetSelectorPage = (): ((
  ownerData: any,
  ...
  return (ownerData: any, alreadySelected: ServiceSimpleVoteStored[]) =>
    new Promise((resolve) => {
      createDialog({
        ...
        children: (
          <ServiceServiceUserVotesRelationTableSetSelectorPage
            ownerData={ownerData}
...
export interface ServiceServiceUserVotesRelationTableSetSelectorPageProps {
  ownerData: any;
  alreadySelected: ServiceSimpleVoteStored[];
...
// Name: service::ServiceUser::votes::Relation::Table::Set::Selector::Page
// Open in dialog: true
export default function ServiceServiceUserVotesRelationTableSetSelectorPage(
  props: ServiceServiceUserVotesRelationTableSetSelectorPageProps,
) {
  ...
  const { service: customActionsHook } = useTrackService<ServiceSimpleVoteSimpleVote_TableSetSelectorActionsHook>(
    `(${OBJECTCLASS}=${SERVICE_SERVICE_USER_VOTES_RELATION_TABLE_SET_SELECTOR_PAGE_ACTIONS_HOOK_INTERFACE_KEY})`,
  );
  ...
  return (
    <div
      ...
      data-page-name="service::ServiceUser::votes::Relation::Table::Set::Selector::Page"
    >
      <Suspense>
