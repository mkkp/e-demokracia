...
export const SERVICE_CREATE_ISSUE_INPUT_CREATE_ISSUE_INPUT_FORM_ISSUE_CITY_TABULAR_REFERENCE_FIELD_LINK_SET_SELECTOR_PAGE_ACTIONS_HOOK_INTERFACE_KEY =
...
export const useServiceCreateIssueInputCreateIssueInput_FormIssueCityTabularReferenceFieldLinkSetSelectorPage = (): ((
  ownerData: any,
  ...
  return (ownerData: any, alreadySelected: ServiceCityStored[]) =>
    new Promise((resolve) => {
      createDialog({
        ...
        children: (
          <ServiceCreateIssueInputCreateIssueInput_FormIssueCityTabularReferenceFieldLinkSetSelectorPage
            ownerData={ownerData}
...
export interface ServiceCreateIssueInputCreateIssueInput_FormIssueCityTabularReferenceFieldLinkSetSelectorPageProps {
  ownerData: any;
  alreadySelected: ServiceCityStored[];
...
// Name: service::CreateIssueInput::CreateIssueInput_Form::issue::city::TabularReferenceField::Link::Set::Selector::Page
// Open in dialog: true
export default function ServiceCreateIssueInputCreateIssueInput_FormIssueCityTabularReferenceFieldLinkSetSelectorPage(
  props: ServiceCreateIssueInputCreateIssueInput_FormIssueCityTabularReferenceFieldLinkSetSelectorPageProps,
) {
  ...
  const { service: customActionsHook } = useTrackService<ServiceCityCity_TableSetSelectorActionsHook>(
    `(${OBJECTCLASS}=${SERVICE_CREATE_ISSUE_INPUT_CREATE_ISSUE_INPUT_FORM_ISSUE_CITY_TABULAR_REFERENCE_FIELD_LINK_SET_SELECTOR_PAGE_ACTIONS_HOOK_INTERFACE_KEY})`,
  );
  ...
  return (
    <div
      ...
      data-page-name="service::CreateIssueInput::CreateIssueInput_Form::issue::city::TabularReferenceField::Link::Set::Selector::Page"
    >
      <Suspense>
