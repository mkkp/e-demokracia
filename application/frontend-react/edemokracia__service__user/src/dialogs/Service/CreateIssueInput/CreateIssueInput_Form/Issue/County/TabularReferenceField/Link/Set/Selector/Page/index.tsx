...
export const SERVICE_CREATE_ISSUE_INPUT_CREATE_ISSUE_INPUT_FORM_ISSUE_COUNTY_TABULAR_REFERENCE_FIELD_LINK_SET_SELECTOR_PAGE_ACTIONS_HOOK_INTERFACE_KEY =
...
export const useServiceCreateIssueInputCreateIssueInput_FormIssueCountyTabularReferenceFieldLinkSetSelectorPage = (): ((
  ownerData: any,
  ...
  return (ownerData: any, alreadySelected: ServiceCountyStored[]) =>
    new Promise((resolve) => {
      createDialog({
        ...
        children: (
          <ServiceCreateIssueInputCreateIssueInput_FormIssueCountyTabularReferenceFieldLinkSetSelectorPage
            ownerData={ownerData}
...
export interface ServiceCreateIssueInputCreateIssueInput_FormIssueCountyTabularReferenceFieldLinkSetSelectorPageProps {
  ownerData: any;
  alreadySelected: ServiceCountyStored[];
...
// Name: service::CreateIssueInput::CreateIssueInput_Form::issue::county::TabularReferenceField::Link::Set::Selector::Page
// Open in dialog: true
export default function ServiceCreateIssueInputCreateIssueInput_FormIssueCountyTabularReferenceFieldLinkSetSelectorPage(
  props: ServiceCreateIssueInputCreateIssueInput_FormIssueCountyTabularReferenceFieldLinkSetSelectorPageProps,
) {
  ...
  const { service: customActionsHook } = useTrackService<ServiceCountyCounty_TableSetSelectorActionsHook>(
    `(${OBJECTCLASS}=${SERVICE_CREATE_ISSUE_INPUT_CREATE_ISSUE_INPUT_FORM_ISSUE_COUNTY_TABULAR_REFERENCE_FIELD_LINK_SET_SELECTOR_PAGE_ACTIONS_HOOK_INTERFACE_KEY})`,
  );
  ...
  return (
    <div
      ...
      data-page-name="service::CreateIssueInput::CreateIssueInput_Form::issue::county::TabularReferenceField::Link::Set::Selector::Page"
    >
      <Suspense>
