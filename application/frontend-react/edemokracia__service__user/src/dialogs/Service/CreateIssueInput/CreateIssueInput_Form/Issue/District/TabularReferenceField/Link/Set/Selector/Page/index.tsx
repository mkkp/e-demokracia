...
export const SERVICE_CREATE_ISSUE_INPUT_CREATE_ISSUE_INPUT_FORM_ISSUE_DISTRICT_TABULAR_REFERENCE_FIELD_LINK_SET_SELECTOR_PAGE_ACTIONS_HOOK_INTERFACE_KEY =
...
export const useServiceCreateIssueInputCreateIssueInput_FormIssueDistrictTabularReferenceFieldLinkSetSelectorPage =
  (): ((
    ownerData: any,
    ...
    return (ownerData: any, alreadySelected: ServiceDistrictStored[]) =>
      new Promise((resolve) => {
        createDialog({
          ...
          children: (
            <ServiceCreateIssueInputCreateIssueInput_FormIssueDistrictTabularReferenceFieldLinkSetSelectorPage
              ownerData={ownerData}
...
export interface ServiceCreateIssueInputCreateIssueInput_FormIssueDistrictTabularReferenceFieldLinkSetSelectorPageProps {
  ownerData: any;
  alreadySelected: ServiceDistrictStored[];
...
// Name: service::CreateIssueInput::CreateIssueInput_Form::issue::district::TabularReferenceField::Link::Set::Selector::Page
// Open in dialog: true
export default function ServiceCreateIssueInputCreateIssueInput_FormIssueDistrictTabularReferenceFieldLinkSetSelectorPage(
  props: ServiceCreateIssueInputCreateIssueInput_FormIssueDistrictTabularReferenceFieldLinkSetSelectorPageProps,
) {
  ...
  const { service: customActionsHook } = useTrackService<ServiceDistrictDistrict_TableSetSelectorActionsHook>(
    `(${OBJECTCLASS}=${SERVICE_CREATE_ISSUE_INPUT_CREATE_ISSUE_INPUT_FORM_ISSUE_DISTRICT_TABULAR_REFERENCE_FIELD_LINK_SET_SELECTOR_PAGE_ACTIONS_HOOK_INTERFACE_KEY})`,
  );
  ...
  return (
    <div
      ...
      data-page-name="service::CreateIssueInput::CreateIssueInput_Form::issue::district::TabularReferenceField::Link::Set::Selector::Page"
    >
      <Suspense>
