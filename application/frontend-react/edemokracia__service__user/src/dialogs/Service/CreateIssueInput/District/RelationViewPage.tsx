...
export const SERVICE_CREATE_ISSUE_INPUT_DISTRICT_RELATION_VIEW_PAGE_ACTIONS_HOOK_INTERFACE_KEY =
  'SERVICE_CREATE_ISSUE_INPUT_DISTRICT_RELATION_VIEW_PAGE_ACTIONS_HOOK';
...
// Name: service::CreateIssueInput::district::RelationViewPage
export default function ServiceCreateIssueInputDistrictRelationViewPage(
  ...
  const refreshAction = async (
    ...
    try {
      setIsLoading(true);
      setEditMode(false);
      const response = await serviceCreateIssueInputServiceForDistrictImpl.refresh(ownerData, getPageQueryCustomizer());
    ...
    <ServiceDistrictDistrict_View_EditViewModelContext.Provider value={viewModel}>
      <Suspense>
        <div
          ...
          data-page-name="service::CreateIssueInput::district::RelationViewPage"
        />
