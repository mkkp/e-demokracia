...
export default function ServiceVoteDefinitionVoteDefinition_View_EditVoteYesNoInputForm(
  ...
  const serviceVoteDefinitionVoteDefinition_View_EditTabBarYesnovoteVoteYesNo = async () => {
    try {
      setIsLoading(true);
  ...
  const yesNoVoteInputYesNoVoteInput_FormGetTemplate = async (): Promise<YesNoVoteInput> => {
    try {
      setIsLoading(true);
      const result = await serviceVoteDefinitionServiceImpl.getTemplateForVoteYesNo();
  ...
  const actions: YesNoVoteInputYesNoVoteInput_FormDialogActions = {
    ...
    serviceVoteDefinitionVoteDefinition_View_EditTabBarYesnovoteVoteYesNo,
