...
export const SERVICE_YES_NO_VOTE_DEFINITION_YES_NO_VOTE_DEFINITION_VIEW_EDIT_VOTE_INPUT_FORM_ACTIONS_HOOK_INTERFACE_KEY =
  'SERVICE_YES_NO_VOTE_DEFINITION_YES_NO_VOTE_DEFINITION_VIEW_EDIT_VOTE_INPUT_FORM_ACTIONS_HOOK';
...
export default function ServiceYesNoVoteDefinitionYesNoVoteDefinition_View_EditVoteInputForm(
  ...
  const voteForYesNoVoteDefinitionAction = async () => {
    try {
      setIsLoading(true);
      await serviceYesNoVoteDefinitionServiceImpl.vote(ownerData, cleanUpPayload(payloadDiff.current));
  ...
  const getTemplateAction = async (): Promise<JudoRestResponse<YesNoVoteInput>> => {
    try {
      setIsLoading(true);
      const response = await serviceYesNoVoteDefinitionServiceImpl.getTemplateOnVote();
