...
export default function ServiceYesNoVoteDefinitionOwnerRelationViewPage(
  ...
  const residentCityAutocompleteRangeAction = async (
    ...
    try {
      return serviceYesNoVoteDefinitionServiceForOwnerImpl.getRangeForResidentCity(
        cleanUpPayload(data),
        queryCustomizer,
      );
    } catch (error) {
  ...
  const residentCountyAutocompleteRangeAction = async (
    ...
    try {
      return serviceYesNoVoteDefinitionServiceForOwnerImpl.getRangeForResidentCounty(
        cleanUpPayload(data),
        queryCustomizer,
      );
    } catch (error) {
  ...
  const residentDistrictAutocompleteRangeAction = async (
    ...
    try {
      return serviceYesNoVoteDefinitionServiceForOwnerImpl.getRangeForResidentDistrict(
        cleanUpPayload(data),
        queryCustomizer,
      );
    } catch (error) {
  ...
  const refreshAction = async (
    ...
    try {
      setIsLoading(true);
      setEditMode(false);
      const result = await serviceYesNoVoteDefinitionServiceForOwnerImpl.refresh(ownerData, getPageQueryCustomizer());
      setData(result);
