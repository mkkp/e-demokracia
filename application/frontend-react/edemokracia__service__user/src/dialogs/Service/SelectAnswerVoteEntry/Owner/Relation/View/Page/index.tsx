...
import { serviceSelectAnswerVoteEntryServiceForOwnerImpl } from '~/services/data-axios';
...
// Name: service::SelectAnswerVoteEntry::owner::Relation::View::Page
export default function ServiceSelectAnswerVoteEntryOwnerRelationViewPage(
  ...
  const serviceServiceUserServiceUser_View_EditRefresh = async (
    ...
    try {
      setIsLoading(true);
      setEditMode(false);
      const result = await serviceSelectAnswerVoteEntryServiceForOwnerImpl.refresh(ownerData, pageQueryCustomizer);
  ...
  const serviceServiceUserServiceUser_View_EditAreasResidencyResidentCityAutocomplete = async (
    ...
    try {
      return serviceSelectAnswerVoteEntryServiceForOwnerImpl.getRangeForResidentCity(data, queryCustomizer);
    } catch (error) {
      handleError(error);
  ...
  const serviceServiceUserServiceUser_View_EditAreasResidencyResidentDistrictAutocomplete = async (
    ...
    try {
      return serviceSelectAnswerVoteEntryServiceForOwnerImpl.getRangeForResidentDistrict(data, queryCustomizer);
    } catch (error) {
      handleError(error);
      return Promise.resolve([]);
    }
  ...
  const serviceServiceUserServiceUser_View_EditAreasResidencyResidentCountyAutocomplete = async (
    ...
    try {
      return serviceSelectAnswerVoteEntryServiceForOwnerImpl.getRangeForResidentCounty(data, queryCustomizer);
    } catch (error) {
      handleError(error);
      return Promise.resolve([]);
    }
