...
export default function ServiceRatingVoteDefinitionOwnerRelationViewPage(
  ...
  const refreshAction = async (
    ...
    try {
      setIsLoading(true);
      setEditMode(false);
      const result = await serviceRatingVoteDefinitionServiceForOwnerImpl.refresh(ownerData, getPageQueryCustomizer());
      setData(result);
  ...
  const residentCityAutocompleteRangeAction = async (
    ...
    try {
      return serviceRatingVoteDefinitionServiceForOwnerImpl.getRangeForResidentCity(
        cleanUpPayload(data),
        queryCustomizer,
      );
    } catch (error) {
  ...
  const residentCountyAutocompleteRangeAction = async (
    ...
    try {
      return serviceRatingVoteDefinitionServiceForOwnerImpl.getRangeForResidentCounty(
        cleanUpPayload(data),
        queryCustomizer,
      );
    } catch (error) {
  ...
  const residentDistrictAutocompleteRangeAction = async (
    ...
    try {
      return serviceRatingVoteDefinitionServiceForOwnerImpl.getRangeForResidentDistrict(
        cleanUpPayload(data),
        queryCustomizer,
      );
    } catch (error) {
