...
import { serviceRatingVoteDefinitionServiceForOwnerImpl } from '~/services/data-axios';
...
export default function ServiceRatingVoteDefinitionRatingVoteDefinition_View_EditVoteEntryBaseVirtualOwnerLinkSetSelectorPage(
  ...
  const selectorRangeAction = async (
    ...
    try {
      return serviceRatingVoteDefinitionServiceForOwnerImpl.getRangeForOwner(ownerData, queryCustomizer);
    } catch (error) {
      handleError(error);
