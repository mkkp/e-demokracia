...
export default function ServiceYesNoAbstainVoteEntryOwnerRelationViewPage(
  ...
  const residentCityAutocompleteRangeAction = async (
    ...
    try {
      return serviceYesNoAbstainVoteEntryServiceForOwnerImpl.getRangeForResidentCity(
        cleanUpPayload(data),
        queryCustomizer,
      );
    } catch (error) {
  ...
  const residentCountyAutocompleteRangeAction = async (
    ...
    try {
      return serviceYesNoAbstainVoteEntryServiceForOwnerImpl.getRangeForResidentCounty(
        cleanUpPayload(data),
        queryCustomizer,
      );
    } catch (error) {
  ...
  const residentDistrictAutocompleteRangeAction = async (
    ...
    try {
      return serviceYesNoAbstainVoteEntryServiceForOwnerImpl.getRangeForResidentDistrict(
        cleanUpPayload(data),
        queryCustomizer,
      );
    } catch (error) {
  ...
  const refreshAction = async (
    ...
    try {
      setIsLoading(true);
      setEditMode(false);
      const result = await serviceYesNoAbstainVoteEntryServiceForOwnerImpl.refresh(ownerData, getPageQueryCustomizer());
      setData(result);
