...
export const SERVICE_USER_ISSUES_ACTIVE_ISSUES_IN_ACTIVITY_DISTRICTS_ADD_SELECTOR_PAGE_ACTIONS_HOOK_INTERFACE_KEY =
...
export const useServiceUserIssuesActiveIssuesInActivityDistrictsAddSelectorPage = (): ((
  ownerData: any,
  ...
  return (ownerData: any, alreadySelected: ServiceIssueStored[]) =>
    new Promise((resolve) => {
      createDialog({
        ...
        children: (
          <ServiceUserIssuesActiveIssuesInActivityDistrictsAddSelectorPage
            ownerData={ownerData}
...
export interface ServiceUserIssuesActiveIssuesInActivityDistrictsAddSelectorPageProps {
  ownerData: any;
  alreadySelected: ServiceIssueStored[];
...
// XMIID: User/(esm/_riB9EFrWEe6gN-oVBDDIOQ)/RelationFeatureTableAddSelectorPageDefinition
// Name: service::UserIssues::activeIssuesInActivityDistricts::AddSelectorPage
export default function ServiceUserIssuesActiveIssuesInActivityDistrictsAddSelectorPage(
  props: ServiceUserIssuesActiveIssuesInActivityDistrictsAddSelectorPageProps,
) {
  ...
  const { service: customActionsHook } = useTrackService<ServiceIssueIssue_TableAddSelectorActionsHook>(
    `(${OBJECTCLASS}=${SERVICE_USER_ISSUES_ACTIVE_ISSUES_IN_ACTIVITY_DISTRICTS_ADD_SELECTOR_PAGE_ACTIONS_HOOK_INTERFACE_KEY})`,
  );
  ...
  return (
    <div
      id="User/(esm/_riB9EFrWEe6gN-oVBDDIOQ)/RelationFeatureTableAddSelectorPageDefinition"
      data-page-name="service::UserIssues::activeIssuesInActivityDistricts::AddSelectorPage"
    >
      <Suspense>
