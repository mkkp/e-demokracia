...
export const SERVICE_USER_ISSUES_ACTIVE_ISSUES_IN_RESIDENT_CITY_ADD_SELECTOR_PAGE_ACTIONS_HOOK_INTERFACE_KEY =
...
export const useServiceUserIssuesActiveIssuesInResidentCityAddSelectorPage = (): ((
  ownerData: any,
  ...
  return (ownerData: any, alreadySelected: ServiceIssueStored[]) =>
    new Promise((resolve) => {
      createDialog({
        ...
        children: (
          <ServiceUserIssuesActiveIssuesInResidentCityAddSelectorPage
            ownerData={ownerData}
...
export interface ServiceUserIssuesActiveIssuesInResidentCityAddSelectorPageProps {
  ownerData: any;
  alreadySelected: ServiceIssueStored[];
...
// XMIID: User/(esm/_T07cUFrbEe6gN-oVBDDIOQ)/RelationFeatureTableAddSelectorPageDefinition
// Name: service::UserIssues::activeIssuesInResidentCity::AddSelectorPage
export default function ServiceUserIssuesActiveIssuesInResidentCityAddSelectorPage(
  props: ServiceUserIssuesActiveIssuesInResidentCityAddSelectorPageProps,
) {
  ...
  const { service: customActionsHook } = useTrackService<ServiceIssueIssue_TableAddSelectorActionsHook>(
    `(${OBJECTCLASS}=${SERVICE_USER_ISSUES_ACTIVE_ISSUES_IN_RESIDENT_CITY_ADD_SELECTOR_PAGE_ACTIONS_HOOK_INTERFACE_KEY})`,
  );
  ...
  return (
    <div
      id="User/(esm/_T07cUFrbEe6gN-oVBDDIOQ)/RelationFeatureTableAddSelectorPageDefinition"
      data-page-name="service::UserIssues::activeIssuesInResidentCity::AddSelectorPage"
    >
      <Suspense>
