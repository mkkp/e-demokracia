...
export const SERVICE_USER_ISSUES_ACTIVE_ISSUES_IN_RESIDENT_COUNTY_ADD_SELECTOR_PAGE_ACTIONS_HOOK_INTERFACE_KEY =
...
export const useServiceUserIssuesActiveIssuesInResidentCountyAddSelectorPage = (): ((
  ownerData: any,
  ...
  return (ownerData: any, alreadySelected: ServiceIssueStored[]) =>
    new Promise((resolve) => {
      createDialog({
        ...
        children: (
          <ServiceUserIssuesActiveIssuesInResidentCountyAddSelectorPage
            ownerData={ownerData}
...
export interface ServiceUserIssuesActiveIssuesInResidentCountyAddSelectorPageProps {
  ownerData: any;
  alreadySelected: ServiceIssueStored[];
...
// XMIID: User/(esm/_KOPO4FrbEe6gN-oVBDDIOQ)/RelationFeatureTableAddSelectorPageDefinition
// Name: service::UserIssues::activeIssuesInResidentCounty::AddSelectorPage
export default function ServiceUserIssuesActiveIssuesInResidentCountyAddSelectorPage(
  props: ServiceUserIssuesActiveIssuesInResidentCountyAddSelectorPageProps,
) {
  ...
  const { service: customActionsHook } = useTrackService<ServiceIssueIssue_TableAddSelectorActionsHook>(
    `(${OBJECTCLASS}=${SERVICE_USER_ISSUES_ACTIVE_ISSUES_IN_RESIDENT_COUNTY_ADD_SELECTOR_PAGE_ACTIONS_HOOK_INTERFACE_KEY})`,
  );
  ...
  return (
    <div
      id="User/(esm/_KOPO4FrbEe6gN-oVBDDIOQ)/RelationFeatureTableAddSelectorPageDefinition"
      data-page-name="service::UserIssues::activeIssuesInResidentCounty::AddSelectorPage"
    >
      <Suspense>
