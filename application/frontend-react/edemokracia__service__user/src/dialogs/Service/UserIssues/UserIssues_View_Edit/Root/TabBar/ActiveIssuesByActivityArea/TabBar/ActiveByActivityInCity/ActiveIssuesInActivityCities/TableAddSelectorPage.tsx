...
export const SERVICE_USER_ISSUES_USER_ISSUES_VIEW_EDIT_ROOT_TAB_BAR_ACTIVE_ISSUES_BY_ACTIVITY_AREA_TAB_BAR_ACTIVE_BY_ACTIVITY_IN_CITY_ACTIVE_ISSUES_IN_ACTIVITY_CITIES_TABLE_ADD_SELECTOR_PAGE_ACTIONS_HOOK_INTERFACE_KEY =
...
export const useServiceUserIssuesUserIssues_View_EditRootTabBarActiveIssuesByActivityAreaTabBarActiveByActivityInCityActiveIssuesInActivityCitiesTableAddSelectorPage =
    ...
    return (ownerData: any, alreadySelected: ServiceIssueStored[]) =>
      new Promise((resolve) => {
        createDialog({
          ...
          children: (
            <ServiceUserIssuesUserIssues_View_EditRootTabBarActiveIssuesByActivityAreaTabBarActiveByActivityInCityActiveIssuesInActivityCitiesTableAddSelectorPage
              ownerData={ownerData}
...
export interface ServiceUserIssuesUserIssues_View_EditRootTabBarActiveIssuesByActivityAreaTabBarActiveByActivityInCityActiveIssuesInActivityCitiesTableAddSelectorPageProps {
  ownerData: any;
...
// XMIID: User/(esm/_zR1kkFraEe6gN-oVBDDIOQ)/TabularReferenceFieldTableAddSelectorPageDefinition
// Name: service::UserIssues::UserIssues_View_Edit::root::tabBar::activeIssuesByActivityArea::tabBar::activeByActivityInCity::activeIssuesInActivityCities::TableAddSelectorPage
export default function ServiceUserIssuesUserIssues_View_EditRootTabBarActiveIssuesByActivityAreaTabBarActiveByActivityInCityActiveIssuesInActivityCitiesTableAddSelectorPage(
  props: ServiceUserIssuesUserIssues_View_EditRootTabBarActiveIssuesByActivityAreaTabBarActiveByActivityInCityActiveIssuesInActivityCitiesTableAddSelectorPageProps,
) {
  ...
  const { service: customActionsHook } = useTrackService<ServiceIssueIssue_TableAddSelectorActionsHook>(
    `(${OBJECTCLASS}=${SERVICE_USER_ISSUES_USER_ISSUES_VIEW_EDIT_ROOT_TAB_BAR_ACTIVE_ISSUES_BY_ACTIVITY_AREA_TAB_BAR_ACTIVE_BY_ACTIVITY_IN_CITY_ACTIVE_ISSUES_IN_ACTIVITY_CITIES_TABLE_ADD_SELECTOR_PAGE_ACTIONS_HOOK_INTERFACE_KEY})`,
  );
  ...
  return (
    <div
      id="User/(esm/_zR1kkFraEe6gN-oVBDDIOQ)/TabularReferenceFieldTableAddSelectorPageDefinition"
      data-page-name="service::UserIssues::UserIssues_View_Edit::root::tabBar::activeIssuesByActivityArea::tabBar::activeByActivityInCity::activeIssuesInActivityCities::TableAddSelectorPage"
    >
      <Suspense>
