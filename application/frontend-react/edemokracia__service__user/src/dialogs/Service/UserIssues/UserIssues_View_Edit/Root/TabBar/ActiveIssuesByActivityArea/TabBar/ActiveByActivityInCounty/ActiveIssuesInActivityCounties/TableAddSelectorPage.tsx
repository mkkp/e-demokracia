...
export const SERVICE_USER_ISSUES_USER_ISSUES_VIEW_EDIT_ROOT_TAB_BAR_ACTIVE_ISSUES_BY_ACTIVITY_AREA_TAB_BAR_ACTIVE_BY_ACTIVITY_IN_COUNTY_ACTIVE_ISSUES_IN_ACTIVITY_COUNTIES_TABLE_ADD_SELECTOR_PAGE_ACTIONS_HOOK_INTERFACE_KEY =
...
export const useServiceUserIssuesUserIssues_View_EditRootTabBarActiveIssuesByActivityAreaTabBarActiveByActivityInCountyActiveIssuesInActivityCountiesTableAddSelectorPage =
    ...
    return (ownerData: any, alreadySelected: ServiceIssueStored[]) =>
      new Promise((resolve) => {
        createDialog({
          ...
          children: (
            <ServiceUserIssuesUserIssues_View_EditRootTabBarActiveIssuesByActivityAreaTabBarActiveByActivityInCountyActiveIssuesInActivityCountiesTableAddSelectorPage
              ownerData={ownerData}
...
export interface ServiceUserIssuesUserIssues_View_EditRootTabBarActiveIssuesByActivityAreaTabBarActiveByActivityInCountyActiveIssuesInActivityCountiesTableAddSelectorPageProps {
  ownerData: any;
...
// XMIID: User/(esm/_7CQ7UFrXEe6gN-oVBDDIOQ)/TabularReferenceFieldTableAddSelectorPageDefinition
// Name: service::UserIssues::UserIssues_View_Edit::root::tabBar::activeIssuesByActivityArea::tabBar::activeByActivityInCounty::activeIssuesInActivityCounties::TableAddSelectorPage
export default function ServiceUserIssuesUserIssues_View_EditRootTabBarActiveIssuesByActivityAreaTabBarActiveByActivityInCountyActiveIssuesInActivityCountiesTableAddSelectorPage(
  props: ServiceUserIssuesUserIssues_View_EditRootTabBarActiveIssuesByActivityAreaTabBarActiveByActivityInCountyActiveIssuesInActivityCountiesTableAddSelectorPageProps,
) {
  ...
  const { service: customActionsHook } = useTrackService<ServiceIssueIssue_TableAddSelectorActionsHook>(
    `(${OBJECTCLASS}=${SERVICE_USER_ISSUES_USER_ISSUES_VIEW_EDIT_ROOT_TAB_BAR_ACTIVE_ISSUES_BY_ACTIVITY_AREA_TAB_BAR_ACTIVE_BY_ACTIVITY_IN_COUNTY_ACTIVE_ISSUES_IN_ACTIVITY_COUNTIES_TABLE_ADD_SELECTOR_PAGE_ACTIONS_HOOK_INTERFACE_KEY})`,
  );
  ...
  return (
    <div
      id="User/(esm/_7CQ7UFrXEe6gN-oVBDDIOQ)/TabularReferenceFieldTableAddSelectorPageDefinition"
      data-page-name="service::UserIssues::UserIssues_View_Edit::root::tabBar::activeIssuesByActivityArea::tabBar::activeByActivityInCounty::activeIssuesInActivityCounties::TableAddSelectorPage"
    >
      <Suspense>
