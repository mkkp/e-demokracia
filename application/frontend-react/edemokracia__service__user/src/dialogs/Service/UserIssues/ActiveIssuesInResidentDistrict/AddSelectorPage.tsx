...
export const SERVICE_USER_ISSUES_ACTIVE_ISSUES_IN_RESIDENT_DISTRICT_ADD_SELECTOR_PAGE_ACTIONS_HOOK_INTERFACE_KEY =
...
export const useServiceUserIssuesActiveIssuesInResidentDistrictAddSelectorPage = (): ((
  ownerData: any,
  ...
  return (ownerData: any, alreadySelected: ServiceIssueStored[]) =>
    new Promise((resolve) => {
      createDialog({
        ...
        children: (
          <ServiceUserIssuesActiveIssuesInResidentDistrictAddSelectorPage
            ownerData={ownerData}
...
export interface ServiceUserIssuesActiveIssuesInResidentDistrictAddSelectorPageProps {
  ownerData: any;
  alreadySelected: ServiceIssueStored[];
...
// XMIID: User/(esm/_dmHCgFrbEe6gN-oVBDDIOQ)/RelationFeatureTableAddSelectorPageDefinition
// Name: service::UserIssues::activeIssuesInResidentDistrict::AddSelectorPage
export default function ServiceUserIssuesActiveIssuesInResidentDistrictAddSelectorPage(
  props: ServiceUserIssuesActiveIssuesInResidentDistrictAddSelectorPageProps,
) {
  ...
  const { service: customActionsHook } = useTrackService<ServiceIssueIssue_TableAddSelectorActionsHook>(
    `(${OBJECTCLASS}=${SERVICE_USER_ISSUES_ACTIVE_ISSUES_IN_RESIDENT_DISTRICT_ADD_SELECTOR_PAGE_ACTIONS_HOOK_INTERFACE_KEY})`,
  );
  ...
  return (
    <div
      id="User/(esm/_dmHCgFrbEe6gN-oVBDDIOQ)/RelationFeatureTableAddSelectorPageDefinition"
      data-page-name="service::UserIssues::activeIssuesInResidentDistrict::AddSelectorPage"
    >
      <Suspense>
