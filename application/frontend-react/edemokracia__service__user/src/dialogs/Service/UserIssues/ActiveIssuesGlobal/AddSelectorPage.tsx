...
export const SERVICE_USER_ISSUES_ACTIVE_ISSUES_GLOBAL_ADD_SELECTOR_PAGE_ACTIONS_HOOK_INTERFACE_KEY =
...
export const useServiceUserIssuesActiveIssuesGlobalAddSelectorPage = (): ((
  ownerData: any,
  ...
  return (ownerData: any, alreadySelected: ServiceIssueStored[]) =>
    new Promise((resolve) => {
      createDialog({
        ...
        children: (
          <ServiceUserIssuesActiveIssuesGlobalAddSelectorPage
            ownerData={ownerData}
...
export interface ServiceUserIssuesActiveIssuesGlobalAddSelectorPageProps {
  ownerData: any;
  alreadySelected: ServiceIssueStored[];
...
// XMIID: User/(esm/_NM0voFrKEe6_67aMO2jOsw)/RelationFeatureTableAddSelectorPageDefinition
// Name: service::UserIssues::activeIssuesGlobal::AddSelectorPage
export default function ServiceUserIssuesActiveIssuesGlobalAddSelectorPage(
  props: ServiceUserIssuesActiveIssuesGlobalAddSelectorPageProps,
) {
  ...
  const { service: customActionsHook } = useTrackService<ServiceIssueIssue_TableAddSelectorActionsHook>(
    `(${OBJECTCLASS}=${SERVICE_USER_ISSUES_ACTIVE_ISSUES_GLOBAL_ADD_SELECTOR_PAGE_ACTIONS_HOOK_INTERFACE_KEY})`,
  );
  ...
  return (
    <div
      id="User/(esm/_NM0voFrKEe6_67aMO2jOsw)/RelationFeatureTableAddSelectorPageDefinition"
      data-page-name="service::UserIssues::activeIssuesGlobal::AddSelectorPage"
    >
      <Suspense>
