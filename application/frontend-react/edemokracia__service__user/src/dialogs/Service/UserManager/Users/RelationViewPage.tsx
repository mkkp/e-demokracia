...
export const SERVICE_USER_MANAGER_USERS_RELATION_VIEW_PAGE_ACTIONS_HOOK_INTERFACE_KEY =
  'SERVICE_USER_MANAGER_USERS_RELATION_VIEW_PAGE_ACTIONS_HOOK';
...
// Name: service::UserManager::users::RelationViewPage
    ...
    <ServiceServiceUserServiceUser_View_EditViewModelContext.Provider value={viewModel}>
      <Suspense>
        <div
          ...
          data-page-name="service::UserManager::users::RelationViewPage"
        />
