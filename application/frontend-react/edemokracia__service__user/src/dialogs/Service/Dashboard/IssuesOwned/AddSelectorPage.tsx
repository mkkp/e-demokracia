...
export const SERVICE_DASHBOARD_ISSUES_OWNED_ADD_SELECTOR_PAGE_ACTIONS_HOOK_INTERFACE_KEY =
...
export const useServiceDashboardIssuesOwnedAddSelectorPage = (): ((
  ownerData: any,
  ...
  return (ownerData: any, alreadySelected: ServiceIssueStored[]) =>
    new Promise((resolve) => {
      createDialog({
        ...
        children: (
          <ServiceDashboardIssuesOwnedAddSelectorPage
            ownerData={ownerData}
...
export interface ServiceDashboardIssuesOwnedAddSelectorPageProps {
  ownerData: any;
  alreadySelected: ServiceIssueStored[];
...
// Name: service::Dashboard::issuesOwned::AddSelectorPage
export default function ServiceDashboardIssuesOwnedAddSelectorPage(
  props: ServiceDashboardIssuesOwnedAddSelectorPageProps,
) {
  ...
  const { service: customActionsHook } = useTrackService<ServiceIssueIssue_TableAddSelectorActionsHook>(
    `(${OBJECTCLASS}=${SERVICE_DASHBOARD_ISSUES_OWNED_ADD_SELECTOR_PAGE_ACTIONS_HOOK_INTERFACE_KEY})`,
  );
  ...
  return (
    <div
      ...
      data-page-name="service::Dashboard::issuesOwned::AddSelectorPage"
    >
      <Suspense>
