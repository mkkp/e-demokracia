...
export const SERVICE_DASHBOARD_OWNED_ISSUES_ADD_SELECTOR_PAGE_ACTIONS_HOOK_INTERFACE_KEY =
  'SERVICE_DASHBOARD_OWNED_ISSUES_ADD_SELECTOR_PAGE_ACTIONS_HOOK';
...
export const useServiceDashboardOwnedIssuesAddSelectorPage = (): ((
  ownerData: any,
  ...
  return (ownerData: any, alreadySelected: ServiceIssueStored[], isDraft?: boolean) =>
    new Promise((resolve) => {
      createDialog({
        ...
        children: (
          <ServiceDashboardOwnedIssuesAddSelectorPage
            ownerData={ownerData}
...
export interface ServiceDashboardOwnedIssuesAddSelectorPageProps {
  ownerData: any;
...
// Name: service::Dashboard::ownedIssues::AddSelectorPage
export default function ServiceDashboardOwnedIssuesAddSelectorPage(
  props: ServiceDashboardOwnedIssuesAddSelectorPageProps,
) {
  ...
  const { service: customActionsHook } = useTrackService<ServiceIssueIssue_TableAddSelectorActionsHook>(
    `(${OBJECTCLASS}=${SERVICE_DASHBOARD_OWNED_ISSUES_ADD_SELECTOR_PAGE_ACTIONS_HOOK_INTERFACE_KEY})`,
  );
  ...
  return (
    <ServiceIssueIssue_TableAddSelectorViewModelContext.Provider value={viewModel}>
      <Suspense>
        <div
          id="User/(esm/_OQ7kkIyQEe2VSOmaAz6G9Q)/RelationFeatureTableAddSelectorPageDefinition"
          data-page-name="service::Dashboard::ownedIssues::AddSelectorPage"
        />
