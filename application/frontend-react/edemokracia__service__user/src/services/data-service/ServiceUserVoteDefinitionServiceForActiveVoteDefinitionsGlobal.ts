...
/**
 * Relation Service for ServiceUserVoteDefinition.activeVoteDefinitionsGlobal
 */
export interface ServiceUserVoteDefinitionServiceForActiveVoteDefinitionsGlobal {
  list(
