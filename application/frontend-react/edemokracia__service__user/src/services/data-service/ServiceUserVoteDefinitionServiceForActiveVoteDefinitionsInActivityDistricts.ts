...
/**
 * Relation Service for ServiceUserVoteDefinition.activeVoteDefinitionsInActivityDistricts
 */
export interface ServiceUserVoteDefinitionServiceForActiveVoteDefinitionsInActivityDistricts {
  list(
