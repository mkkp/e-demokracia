...
/**
 * Relation Service Implementation for ServiceIssue.owner
 */
export class ServiceIssueServiceForOwnerImpl extends JudoAxiosService implements ServiceIssueServiceForOwner {
  /**
