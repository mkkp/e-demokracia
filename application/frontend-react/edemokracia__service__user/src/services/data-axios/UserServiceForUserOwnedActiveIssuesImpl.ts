...
/**
 * Relation Service Implementation for User.userOwnedActiveIssues
 */
export class UserServiceForUserOwnedActiveIssuesImpl
  extends JudoAxiosService
  implements UserServiceForUserOwnedActiveIssues
{
  /**
  ...
  async list(
    ...
    const path = '/User/userOwnedActiveIssues/~list';
