...
/**
 * Relation Service Implementation for User.userCreatedIssues
 */
export class UserServiceForUserCreatedIssuesImpl extends JudoAxiosService implements UserServiceForUserCreatedIssues {
  /**
  ...
  async list(
    ...
    const path = '/User/userCreatedIssues/~list';
