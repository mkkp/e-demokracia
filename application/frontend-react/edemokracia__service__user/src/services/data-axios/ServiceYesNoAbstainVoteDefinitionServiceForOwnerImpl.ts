...
/**
 * Relation Service Implementation for ServiceYesNoAbstainVoteDefinition.owner
 */
export class ServiceYesNoAbstainVoteDefinitionServiceForOwnerImpl
  extends JudoAxiosService
  implements ServiceYesNoAbstainVoteDefinitionServiceForOwner
{
  /**
