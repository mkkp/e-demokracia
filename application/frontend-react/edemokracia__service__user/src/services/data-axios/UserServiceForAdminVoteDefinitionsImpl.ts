...
/**
 * Relation Service Implementation for User.adminVoteDefinitions
 */
export class UserServiceForAdminVoteDefinitionsImpl
  extends JudoAxiosService
  implements UserServiceForAdminVoteDefinitions
{
  /**
  ...
  async list(
    ...
    const path = '/User/adminVoteDefinitions/~list';
