...
/**
 * Relation Service Implementation for User.adminUsers
 */
export class UserServiceForAdminUsersImpl extends JudoAxiosService implements UserServiceForAdminUsers {
  /**
