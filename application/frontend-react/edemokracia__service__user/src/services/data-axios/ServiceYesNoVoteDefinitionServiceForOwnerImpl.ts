...
/**
 * Relation Service Implementation for ServiceYesNoVoteDefinition.owner
 */
export class ServiceYesNoVoteDefinitionServiceForOwnerImpl
  extends JudoAxiosService
  implements ServiceYesNoVoteDefinitionServiceForOwner
{
  /**
