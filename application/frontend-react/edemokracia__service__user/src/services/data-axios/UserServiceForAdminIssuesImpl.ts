...
/**
 * Relation Service Implementation for User.adminIssues
 */
export class UserServiceForAdminIssuesImpl extends JudoAxiosService implements UserServiceForAdminIssues {
  /**
  ...
  async list(
    ...
    const path = '/User/adminIssues/~list';
