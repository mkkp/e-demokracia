 ...
 */
export class ServiceUserVoteDefinitionServiceForActiveVoteDefinitionsInResidentCountyImpl
  extends JudoAxiosService
  implements ServiceUserVoteDefinitionServiceForActiveVoteDefinitionsInResidentCounty
{
  /**
