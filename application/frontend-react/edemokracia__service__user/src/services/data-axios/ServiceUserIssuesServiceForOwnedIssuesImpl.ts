...
/**
 * Relation Service Implementation for ServiceUserIssues.ownedIssues
 */
export class ServiceUserIssuesServiceForOwnedIssuesImpl
  extends JudoAxiosService
  implements ServiceUserIssuesServiceForOwnedIssues
{
  /**
