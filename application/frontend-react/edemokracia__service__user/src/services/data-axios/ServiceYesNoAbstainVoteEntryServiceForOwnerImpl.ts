...
/**
 * Relation Service Implementation for ServiceYesNoAbstainVoteEntry.owner
 */
export class ServiceYesNoAbstainVoteEntryServiceForOwnerImpl
  extends JudoAxiosService
  implements ServiceYesNoAbstainVoteEntryServiceForOwner
{
  /**
