...
/**
 * Relation Service Implementation for User.activeIssues
 */
export class UserServiceForActiveIssuesImpl extends JudoAxiosService implements UserServiceForActiveIssues {
  /**
  ...
  async list(
    ...
    const path = '/User/activeIssues/~list';
