...
import { registerServiceUserIssuesUserIssues_View_EditActiveIssuesGlobalComponentCardsContainerConfig } from './hooks/components/cards/registerServiceUserIssuesUserIssues_View_EditActiveIssuesGlobalComponentConfigurationHook';
import { registerServiceUserIssuesUserIssues_View_EditActiveIssuesInActivityCitiesComponentCardsContainerConfig } from './hooks/components/cards/registerServiceUserIssuesUserIssues_View_EditActiveIssuesInActivityCitiesComponentConfigurationHook';
import { registerServiceUserIssuesUserIssues_View_EditActiveIssuesInActivityCountiesComponentCardsContainerConfig } from './hooks/components/cards/registerServiceUserIssuesUserIssues_View_EditActiveIssuesInActivityCountiesComponentConfigurationHook';
import { registerServiceUserIssuesUserIssues_View_EditActiveIssuesInActivityDistrictsComponentCardsContainerConfig } from './hooks/components/cards/registerServiceUserIssuesUserIssues_View_EditActiveIssuesInActivityDistrictsComponentConfigurationHook';
import { registerServiceUserIssuesUserIssues_View_EditActiveIssuesInResidentCityComponentCardsContainerConfig } from './hooks/components/cards/registerServiceUserIssuesUserIssues_View_EditActiveIssuesInResidentCityComponentConfigurationHook';
import { registerServiceUserIssuesUserIssues_View_EditActiveIssuesInResidentCountyComponentCardsContainerConfig } from './hooks/components/cards/registerServiceUserIssuesUserIssues_View_EditActiveIssuesInResidentCountyComponentConfigurationHook';
import { registerServiceUserIssuesUserIssues_View_EditActiveIssuesInResidentDistrictComponentCardsContainerConfig } from './hooks/components/cards/registerServiceUserIssuesUserIssues_View_EditActiveIssuesInResidentDistrictComponentConfigurationHook';
...
import { registerServiceUserVoteDefinitionUserVoteDefinition_View_EditActiveVoteDefinitionsInActivityCitiesComponentCardsContainerConfig } from './hooks/components/cards/registerServiceUserVoteDefinitionUserVoteDefinition_View_EditActiveVoteDefinitionsInActivityCitiesComponentConfigurationHook';
import { registerServiceUserVoteDefinitionUserVoteDefinition_View_EditActiveVoteDefinitionsInActivityCountiesComponentCardsContainerConfig } from './hooks/components/cards/registerServiceUserVoteDefinitionUserVoteDefinition_View_EditActiveVoteDefinitionsInActivityCountiesComponentConfigurationHook';
import { registerServiceUserVoteDefinitionUserVoteDefinition_View_EditActiveVoteDefinitionsInActivityDistrictsComponentCardsContainerConfig } from './hooks/components/cards/registerServiceUserVoteDefinitionUserVoteDefinition_View_EditActiveVoteDefinitionsInActivityDistrictsComponentConfigurationHook';
import { registerServiceUserVoteDefinitionUserVoteDefinition_View_EditActiveVoteDefinitionsInResidentCityComponentCardsContainerConfig } from './hooks/components/cards/registerServiceUserVoteDefinitionUserVoteDefinition_View_EditActiveVoteDefinitionsInResidentCityComponentConfigurationHook';
import { registerServiceUserVoteDefinitionUserVoteDefinition_View_EditActiveVoteDefinitionsInResidentCountyComponentCardsContainerConfig } from './hooks/components/cards/registerServiceUserVoteDefinitionUserVoteDefinition_View_EditActiveVoteDefinitionsInResidentCountyComponentConfigurationHook';
import { registerServiceUserVoteDefinitionUserVoteDefinition_View_EditActiveVoteDefinitionsInResidentDistrictComponentCardsContainerConfig } from './hooks/components/cards/registerServiceUserVoteDefinitionUserVoteDefinition_View_EditActiveVoteDefinitionsInResidentDistrictComponentConfigurationHook';
...
export class DefaultApplicationCustomizer implements ApplicationCustomizer {
  async customize(context: BundleContext): Promise<void> {
    ...
    registerServiceUserIssuesUserIssues_View_EditActiveIssuesGlobalComponentCardsContainerConfig(context);
    registerServiceUserIssuesUserIssues_View_EditActiveIssuesInActivityCitiesComponentCardsContainerConfig(context);
    registerServiceUserIssuesUserIssues_View_EditActiveIssuesInActivityCountiesComponentCardsContainerConfig(context);
    registerServiceUserIssuesUserIssues_View_EditActiveIssuesInActivityDistrictsComponentCardsContainerConfig(context);
    registerServiceUserIssuesUserIssues_View_EditActiveIssuesInResidentCityComponentCardsContainerConfig(context);
    registerServiceUserIssuesUserIssues_View_EditActiveIssuesInResidentCountyComponentCardsContainerConfig(context);
    registerServiceUserIssuesUserIssues_View_EditActiveIssuesInResidentDistrictComponentCardsContainerConfig(context);
    ...
    registerServiceUserVoteDefinitionUserVoteDefinition_View_EditActiveVoteDefinitionsInActivityCitiesComponentCardsContainerConfig(
      context,
    );
    registerServiceUserVoteDefinitionUserVoteDefinition_View_EditActiveVoteDefinitionsInActivityCountiesComponentCardsContainerConfig(
      context,
    );
    registerServiceUserVoteDefinitionUserVoteDefinition_View_EditActiveVoteDefinitionsInActivityDistrictsComponentCardsContainerConfig(
      context,
    );
    registerServiceUserVoteDefinitionUserVoteDefinition_View_EditActiveVoteDefinitionsInResidentCityComponentCardsContainerConfig(
      context,
    );
    registerServiceUserVoteDefinitionUserVoteDefinition_View_EditActiveVoteDefinitionsInResidentCountyComponentCardsContainerConfig(
      context,
    );
    registerServiceUserVoteDefinitionUserVoteDefinition_View_EditActiveVoteDefinitionsInResidentDistrictComponentCardsContainerConfig(
      context,
    );
