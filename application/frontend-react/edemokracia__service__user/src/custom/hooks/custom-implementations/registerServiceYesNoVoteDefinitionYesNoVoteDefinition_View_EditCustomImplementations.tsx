...
import { SERVICE_YES_NO_VOTE_DEFINITION_YES_NO_VOTE_DEFINITION_VIEW_EDIT_USER_VOTE_ENTRY_GROUP_COMPONENT } from '~/containers/Service/YesNoVoteDefinition/YesNoVoteDefinition_View_Edit/customization';
...
} from '~/services/data-api/model/ServiceYesNoVoteDefinition';
import type {
  ServiceYesNoVoteEntry,
  ServiceYesNoVoteEntryStored,
} from '~/services/data-api/model/ServiceYesNoVoteEntry';
 ...
 */
export function registerServiceYesNoVoteDefinitionYesNoVoteDefinition_View_EditUserVoteEntryGroupComponentCustomImplementation(
  ...
  >(
    CUSTOM_VISUAL_ELEMENT_INTERFACE_KEY,
    serviceYesNoVoteDefinitionYesNoVoteDefinition_View_EditUserVoteEntryGroupComponentCustomImplementation,
    {
...
const serviceYesNoVoteDefinitionYesNoVoteDefinition_View_EditUserVoteEntryGroupComponentCustomImplementation: FC<
  GenericProxyProps<
    ServiceYesNoVoteDefinitionStored,
    ServiceYesNoVoteDefinitionYesNoVoteDefinition_View_EditActionDefinitions
  >
