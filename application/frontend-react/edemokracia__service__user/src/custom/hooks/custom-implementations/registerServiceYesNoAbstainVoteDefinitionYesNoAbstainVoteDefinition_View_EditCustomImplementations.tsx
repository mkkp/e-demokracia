...
} from '~/containers/Service/YesNoAbstainVoteDefinition/YesNoAbstainVoteDefinition_View_Edit/customization';
...
import type { ServiceYesNoAbstainVoteDefinition, ServiceYesNoAbstainVoteDefinitionStored } from '~/services/data-api/model/ServiceYesNoAbstainVoteDefinition';
import type { ServiceYesNoAbstainVoteEntry, ServiceYesNoAbstainVoteEntryStored } from '~/services/data-api/model/ServiceYesNoAbstainVoteEntry';
 ...
 */
export function registerServiceYesNoAbstainVoteDefinitionYesNoAbstainVoteDefinition_View_EditUserVoteEntryGroupComponentCustomImplementation(context: BundleContext) {
  context.registerService<FC<GenericProxyProps<ServiceYesNoAbstainVoteDefinitionStored, ServiceYesNoAbstainVoteDefinitionYesNoAbstainVoteDefinition_View_EditActionDefinitions>>>(CUSTOM_VISUAL_ELEMENT_INTERFACE_KEY, serviceYesNoAbstainVoteDefinitionYesNoAbstainVoteDefinition_View_EditUserVoteEntryGroupComponentCustomImplementation, {
    component: SERVICE_YES_NO_ABSTAIN_VOTE_DEFINITION_YES_NO_ABSTAIN_VOTE_DEFINITION_VIEW_EDIT_USER_VOTE_ENTRY_GROUP_COMPONENT,
  });
}

const serviceYesNoAbstainVoteDefinitionYesNoAbstainVoteDefinition_View_EditUserVoteEntryGroupComponentCustomImplementation: FC<GenericProxyProps<ServiceYesNoAbstainVoteDefinitionStored, ServiceYesNoAbstainVoteDefinitionYesNoAbstainVoteDefinition_View_EditActionDefinitions>> = (props) => {
