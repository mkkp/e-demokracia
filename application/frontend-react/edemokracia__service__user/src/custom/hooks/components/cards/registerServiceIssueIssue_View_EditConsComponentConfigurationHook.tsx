...
import { type ServiceIssueIssue_View_EditConsComponentCardsContainerConfigHook, SERVICE_ISSUE_ISSUE_VIEW_EDIT_CONS_COMPONENT_CARDS_CONTAINER_CONFIG_HOOK_INTERFACE_KEY } from '~/containers/Service/Issue/Issue_View_Edit/components/ServiceIssueIssue_View_EditConsComponent/customization';
...
export function registerServiceIssueIssue_View_EditConsComponentCardsContainerConfig(context: BundleContext) {
  context.registerService<ServiceIssueIssue_View_EditConsComponentCardsContainerConfigHook>(SERVICE_ISSUE_ISSUE_VIEW_EDIT_CONS_COMPONENT_CARDS_CONTAINER_CONFIG_HOOK_INTERFACE_KEY, serviceIssueIssue_View_EditConsComponentCardsContainerConfig);
}
...
const ServiceIssueIssue_View_EditConsComponentToolbar: FC<ToolbarElementProps<ServiceConStored>> = ({ handleFiltersChange }: ToolbarElementProps<ServiceConStored>) => {
...
const ServiceIssueIssue_View_EditConsComponentCard: FC<CardProps<ServiceConStored, ServiceIssueIssue_View_EditConsComponentRowActionDefinitions>> = ({ row, columns, onRowClick, actions }) => {
  // We can call other hooks here
