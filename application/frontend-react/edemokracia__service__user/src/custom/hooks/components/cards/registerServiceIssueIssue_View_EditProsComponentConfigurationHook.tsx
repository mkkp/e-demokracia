...
import {
  ...
  type ServiceIssueIssue_View_EditProsComponentCardsContainerConfigHook,
...
export function registerServiceIssueIssue_View_EditProsComponentCardsContainerConfig(context: BundleContext) {
  context.registerService<ServiceIssueIssue_View_EditProsComponentCardsContainerConfigHook>(
    SERVICE_ISSUE_ISSUE_VIEW_EDIT_PROS_COMPONENT_CARDS_CONTAINER_CONFIG_HOOK_INTERFACE_KEY,
    serviceIssueIssue_View_EditProsComponentCardsContainerConfig,
  );
}
...
const ServiceIssueIssue_View_EditProsComponentToolbar: FC<ToolbarElementProps<ServiceProStored>> = ({
  handleFiltersChange,
...
const ServiceIssueIssue_View_EditProsComponentCard: FC<
  CardProps<ServiceProStored, ServiceIssueIssue_View_EditProsComponentRowActionDefinitions>
