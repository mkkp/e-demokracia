...
import { type ServiceProPro_View_EditProsComponentCardsContainerConfigHook, SERVICE_PRO_PRO_VIEW_EDIT_PROS_COMPONENT_CARDS_CONTAINER_CONFIG_HOOK_INTERFACE_KEY } from '~/containers/Service/Pro/Pro_View_Edit/components/ServiceProPro_View_EditProsComponent/customization';
...
export function registerServiceProPro_View_EditProsComponentCardsContainerConfig(context: BundleContext) {
  context.registerService<ServiceProPro_View_EditProsComponentCardsContainerConfigHook>(SERVICE_PRO_PRO_VIEW_EDIT_PROS_COMPONENT_CARDS_CONTAINER_CONFIG_HOOK_INTERFACE_KEY, serviceProPro_View_EditProsComponentCardsContainerConfig);
}
...
const ServiceProPro_View_EditProsComponentToolbar: FC<ToolbarElementProps<ServiceProStored>> = ({ handleFiltersChange }: ToolbarElementProps<ServiceProStored>) => {
...
const ServiceProPro_View_EditProsComponentCard: FC<CardProps<ServiceProStored, ServiceProPro_View_EditProsComponentRowActionDefinitions>> = ({ row, columns, onRowClick, actions }) => {
  // We can call other hooks here
