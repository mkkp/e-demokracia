...
import {
  ...
  ServiceConCon_View_EditProsComponentCardsContainerConfigHook,
...
export function registerConProCards(context: BundleContext) {
  context.registerService<ServiceConCon_View_EditProsComponentCardsContainerConfigHook>(
    SERVICE_CON_CON_VIEW_EDIT_PROS_COMPONENT_CARDS_CONTAINER_CONFIG_HOOK_INTERFACE_KEY,
    ProCardsComponentCardsContainerConfigHook,
  );
}

export const ProCardsComponentCardsContainerConfigHook: ServiceConCon_View_EditProsComponentCardsContainerConfigHook =
  () => {
    return {
