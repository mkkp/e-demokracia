...
import {
  ...
  type ServiceConCon_View_EditConsComponentCardsContainerConfigHook,
...
const ServiceConCon_View_EditConsComponentToolbar: FC<ToolbarElementProps<ServiceConStored>> = ({
  handleFiltersChange,
...
const ServiceConCon_View_EditConsComponentCard: FC<
  CardProps<ServiceConStored, ServiceConCon_View_EditConsComponentRowActionDefinitions>
> = ({ row, columns, onRowClick, actions }) => {
  ...
  return (
    <Grid item xs={8} sm={8} md={10} lg={12} xl={12}>
      <ArgumentCard
        con={true}
        row={row}
