...
// Page name: edemokracia::service::Pro.cons#View
...
export type ServiceProConsViewPostRefreshAction = (
...
export const SERVICE_PRO_CONS_VIEW_POST_REFRESH_HOOK_INTERFACE_KEY = 'ServiceProConsViewPostRefreshHook';
export type ServiceProConsViewPostRefreshHook = () => ServiceProConsViewPostRefreshAction;

/**
 * Name: edemokracia::service::Pro.cons#View
 * Is Access: false
 * Type: View
 * Edit Mode Available: true
 **/
export default function ServiceProConsView() {
  ...
  const handleUpdateError = useErrorHandler<ServiceCon>(
    `(&(${OBJECTCLASS}=${ERROR_PROCESSOR_HOOK_INTERFACE_KEY})(operation=Update)(component=ServiceProConsView))`,
  );
  const handleDeleteError = useErrorHandler<ServiceCon>(
    `(&(${OBJECTCLASS}=${ERROR_PROCESSOR_HOOK_INTERFACE_KEY})(operation=Delete)(component=ServiceProConsView))`,
  );
  ...
  const { service: postRefreshHook } = useTrackService<ServiceProConsViewPostRefreshHook>(
    `(${OBJECTCLASS}=${SERVICE_PRO_CONS_VIEW_POST_REFRESH_HOOK_INTERFACE_KEY})`,
  );
  const postRefreshAction: ServiceProConsViewPostRefreshAction | undefined = postRefreshHook && postRefreshHook();
        ...
        <Box sx={mainContainerPadding}>
          ...
          >
            <Grid item xs={12} sm={12}>
              <Card id="FlexedemokraciaServiceUserEdemokraciaServiceProConsViewDefaultConViewEditConLabelWrapper">
                <CardContent>
                  <Grid container direction="column" alignItems="stretch" justifyContent="flex-start" spacing={2}>
                    <Grid item xs={12} sm={12}>
                      <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                        ...
                        <Typography
                          id="LabeledemokraciaServiceUserEdemokraciaServiceProConsViewDefaultConViewEditConLabelWrapperConLabel"
                          variant="h5"
                          component="h1"
                        >
                    ...
                    <Grid item xs={12} sm={12}>
                      <Grid
                        id="FlexedemokraciaServiceUserEdemokraciaServiceProConsViewDefaultConViewEditConLabelWrapperCon"
                        container
                        direction="row"
                        alignItems="stretch"
                        justifyContent="flex-start"
                      ...
                      >
                        <Grid item xs={12} sm={12} md={6.0}>
                          <TextField
                            required={true}
                            name="title"
                            id="TextInputedemokraciaServiceUserEdemokraciaServiceProConsViewDefaultConViewEditConLabelWrapperConTitle"
                        ...
                        <Grid item xs={12} sm={12} md={3.0}>
                          <DateTimePicker
                            ...
                            slotProps={{
                              textField: {
                                id: 'DateTimeInputedemokraciaServiceUserEdemokraciaServiceProConsViewDefaultConViewEditConLabelWrapperConCreated',
                                required: true,
                        ...
                        <Grid item xs={12} sm={12}>
                          <TextField
                            required={true}
                            name="description"
                            id="TextAreaedemokraciaServiceUserEdemokraciaServiceProConsViewDefaultConViewEditConLabelWrapperConDescription"
                        ...
                        <Grid item xs={12} sm={12} md={1.0}>
                          <NumericInput
                            required={false}
                            name="upVotes"
                            id="NumericInputedemokraciaServiceUserEdemokraciaServiceProConsViewDefaultConViewEditConLabelWrapperConUpVotes"
                        ...
                        <Grid item xs={12} sm={12} md={1.0}>
                          <NumericInput
                            required={false}
                            name="downVotes"
                            id="NumericInputedemokraciaServiceUserEdemokraciaServiceProConsViewDefaultConViewEditConLabelWrapperConDownVotes"
                        ...
                        <Grid item xs={12} sm={12} md={2.0}>
                          <CollectionAssociationButton
                            id="NavigationToPageActionedemokraciaServiceUserEdemokraciaServiceProConsViewEdemokraciaServiceUserEdemokraciaServiceConVotesButtonNavigate"
                            variant={undefined}
                            editMode={editMode}
            ...
            <Grid container item xs={12} sm={12}>
              <ModeledTabs
                id="TabControlleredemokraciaServiceUserEdemokraciaServiceProConsViewDefaultConViewEditTabBar"
                ownerData={data}
                validation={validation}
                orientation='horizontal'
                childTabs={[
                  {
                    id: 'TabedemokraciaServiceUserEdemokraciaServiceProConsViewDefaultConViewEditTabBarArguments',
                  ...
                  {
                    id: 'TabedemokraciaServiceUserEdemokraciaServiceProConsViewDefaultConViewEditTabBarComments',
              ...
              >
                <Grid item xs={12} sm={12}>
                  <Grid
                    id="FlexedemokraciaServiceUserEdemokraciaServiceProConsViewDefaultConViewEditTabBarArgumentsArguments"
                    container
                    direction="row"
                  ...
                  >
                    <Grid item xs={12} sm={12}>
                      <Grid
                        id="FlexedemokraciaServiceUserEdemokraciaServiceProConsViewDefaultConViewEditTabBarArgumentsArgumentsActions"
                        container
                        direction="row"
                        alignItems="flex-start"
                        justifyContent="flex-start"
                      ...
                      >
                        <Grid item xs={12} sm={12} md={4.0}>
                          <LoadingButton
                            id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceProConsViewEdemokraciaServiceUserEdemokraciaServiceConCreateSubArgumentButtonCallOperation"
                            loading={isLoading}
                            variant={undefined}
                    ...
                    <Grid item xs={12} sm={12} md={6.0}>
                      <Grid
                        id="FlexedemokraciaServiceUserEdemokraciaServiceProConsViewDefaultConViewEditTabBarArgumentsArgumentsProsLabelWrapper"
                        container
                        direction="column"
                        alignItems="stretch"
                        justifyContent="flex-start"
                      ...
                      >
                        <Grid item xs={12} sm={12}>
                          <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                            ...
                            <Typography
                              id="LabeledemokraciaServiceUserEdemokraciaServiceProConsViewDefaultConViewEditTabBarArgumentsArgumentsProsLabelWrapperProsLabel"
                              variant="h5"
                              component="h1"
                            >
                        ...
                        <Grid item xs={12} sm={12}>
                          <Grid
                            id="TableedemokraciaServiceUserEdemokraciaServiceProConsViewDefaultConViewEditTabBarArgumentsArgumentsProsLabelWrapperPros"
                            container
                            direction="column"
                            alignItems="stretch"
                            justifyContent="flex-start"
                    ...
                    <Grid item xs={12} sm={12} md={6.0}>
                      <Grid
                        id="FlexedemokraciaServiceUserEdemokraciaServiceProConsViewDefaultConViewEditTabBarArgumentsArgumentsConsLabelWrapper"
                        container
                        direction="column"
                        alignItems="stretch"
                        justifyContent="flex-start"
                      ...
                      >
                        <Grid item xs={12} sm={12}>
                          <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                            <MdiIcon path="chat-minus" sx={{ marginRight: 1 }} />
                            <Typography
                              id="LabeledemokraciaServiceUserEdemokraciaServiceProConsViewDefaultConViewEditTabBarArgumentsArgumentsConsLabelWrapperConsLabel"
                              variant="h5"
                              component="h1"
                            >
                        ...
                        <Grid item xs={12} sm={12}>
                          <Grid
                            id="TableedemokraciaServiceUserEdemokraciaServiceProConsViewDefaultConViewEditTabBarArgumentsArgumentsConsLabelWrapperCons"
                            container
                            direction="column"
                            alignItems="stretch"
                            justifyContent="flex-start"
                ...
                <Grid item xs={12} sm={12}>
                  <Grid
                    id="FlexedemokraciaServiceUserEdemokraciaServiceProConsViewDefaultConViewEditTabBarCommentsComments"
                    container
                    direction="row"
                    alignItems="flex-start"
                    justifyContent="flex-start"
                  ...
                  >
                    <Grid item xs={12} sm={12} md={4.0}>
                      <Grid
                        id="FlexedemokraciaServiceUserEdemokraciaServiceProConsViewDefaultConViewEditTabBarCommentsCommentsActions"
                        container
                        direction="row"
                        alignItems="flex-start"
                        justifyContent="flex-start"
                      ...
                      >
                        <Grid item xs={12} sm={12}>
                          <LoadingButton
                            id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceProConsViewEdemokraciaServiceUserEdemokraciaServiceConCreateCommentButtonCallOperation"
                            loading={isLoading}
                            variant={undefined}
                    ...
                    <Grid item xs={12} sm={12}>
                      <Grid
                        id="FlexedemokraciaServiceUserEdemokraciaServiceProConsViewDefaultConViewEditTabBarCommentsCommentsCommentsLabelWrapper"
                        container
                        direction="column"
                        alignItems="stretch"
                        justifyContent="flex-start"
                      ...
                      >
                        <Grid item xs={12} sm={12}>
                          <Grid
                            id="TableedemokraciaServiceUserEdemokraciaServiceProConsViewDefaultConViewEditTabBarCommentsCommentsCommentsLabelWrapperComments"
                            container
                            direction="column"
                            alignItems="stretch"
                            justifyContent="flex-start"
