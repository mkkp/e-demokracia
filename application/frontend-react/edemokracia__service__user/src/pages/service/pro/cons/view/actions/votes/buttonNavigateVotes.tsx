...
import { routeToServiceConVotesTable } from '~/routes';

export const BUTTON_NAVIGATE_VOTES_ACTION_INTERFACE_KEY = 'ButtonNavigateVotesAction';
export type ButtonNavigateVotesAction = () => (owner: JudoIdentifiable<ServiceCon>) => Promise<void>;
...
export const useButtonNavigateVotesAction: ButtonNavigateVotesAction = () => {
  ...
  return async function (owner: JudoIdentifiable<ServiceCon>) {
    navigate(routeToServiceConVotesTable(owner.__signedIdentifier));
  };
};
