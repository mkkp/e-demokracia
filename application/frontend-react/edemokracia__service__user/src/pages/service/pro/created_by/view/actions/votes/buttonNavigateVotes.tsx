...
import { routeToServiceServiceUserVotesTable } from '~/routes';

export const BUTTON_NAVIGATE_VOTES_ACTION_INTERFACE_KEY = 'ButtonNavigateVotesAction';
export type ButtonNavigateVotesAction = () => (owner: JudoIdentifiable<ServiceServiceUser>) => Promise<void>;
...
export const useButtonNavigateVotesAction: ButtonNavigateVotesAction = () => {
  ...
  return async function (owner: JudoIdentifiable<ServiceServiceUser>) {
    navigate(routeToServiceServiceUserVotesTable(owner.__signedIdentifier));
  };
};
