...
// Page name: edemokracia::service::Pro.createdBy#View
...
/**
 * Name: edemokracia::service::Pro.createdBy#View
 * Is Access: false
 * Type: View
      ...
      <DialogContent dividers>
        <Grid container spacing={2} direction="column" alignItems="stretch" justifyContent="flex-start">
          <Grid item xs={12} sm={12}>
            <Card id="FlexedemokraciaServiceUserEdemokraciaServiceProCreatedByViewDefaultServiceUserViewEditSecurityLabelWrapper">
              <CardContent>
                <Grid container direction="column" alignItems="stretch" justifyContent="flex-start" spacing={2}>
                  <Grid item xs={12} sm={12}>
                    <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                      ...
                      <Typography
                        id="LabeledemokraciaServiceUserEdemokraciaServiceProCreatedByViewDefaultServiceUserViewEditSecurityLabelWrapperSecurityLabel"
                        variant="h5"
                        component="h1"
                      >
                  ...
                  <Grid item xs={12} sm={12}>
                    <Grid
                      id="FlexedemokraciaServiceUserEdemokraciaServiceProCreatedByViewDefaultServiceUserViewEditSecurityLabelWrapperSecurity"
                      container
                      direction="row"
                      alignItems="stretch"
                    ...
                    >
                      <Grid item xs={12} sm={12} md={4.0}>
                        <TextField
                          required={true}
                          name="userName"
                          id="TextInputedemokraciaServiceUserEdemokraciaServiceProCreatedByViewDefaultServiceUserViewEditSecurityLabelWrapperSecurityUserName"
                      ...
                      <Grid item xs={12} sm={12} md={4.0}>
                        <DateTimePicker
                          ...
                          slotProps={{
                            textField: {
                              id: 'DateTimeInputedemokraciaServiceUserEdemokraciaServiceProCreatedByViewDefaultServiceUserViewEditSecurityLabelWrapperSecurityCreated',
                              required: false,
          ...
          <Grid item xs={12} sm={12}>
            <Card id="FlexedemokraciaServiceUserEdemokraciaServiceProCreatedByViewDefaultServiceUserViewEditPersonalLabelWrapper">
              <CardContent>
                <Grid container direction="column" alignItems="stretch" justifyContent="flex-start" spacing={2}>
                  <Grid item xs={12} sm={12}>
                    <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                      ...
                      <Typography
                        id="LabeledemokraciaServiceUserEdemokraciaServiceProCreatedByViewDefaultServiceUserViewEditPersonalLabelWrapperPersonalLabel"
                        variant="h5"
                        component="h1"
                      >
                  ...
                  <Grid item xs={12} sm={12}>
                    <Grid
                      id="FlexedemokraciaServiceUserEdemokraciaServiceProCreatedByViewDefaultServiceUserViewEditPersonalLabelWrapperPersonal"
                      container
                      direction="row"
                      alignItems="stretch"
                      justifyContent="flex-start"
                    ...
                    >
                      <Grid item xs={12} sm={12}>
                        <Grid
                          id="FlexedemokraciaServiceUserEdemokraciaServiceProCreatedByViewDefaultServiceUserViewEditPersonalLabelWrapperPersonalName"
                          container
                          direction="row"
                        ...
                        >
                          <Grid item xs={12} sm={12} md={4.0}>
                            <TextField
                              required={true}
                              name="firstName"
                              id="TextInputedemokraciaServiceUserEdemokraciaServiceProCreatedByViewDefaultServiceUserViewEditPersonalLabelWrapperPersonalNameFirstName"
                          ...
                          <Grid item xs={12} sm={12} md={4.0}>
                            <TextField
                              required={true}
                              name="lastName"
                              id="TextInputedemokraciaServiceUserEdemokraciaServiceProCreatedByViewDefaultServiceUserViewEditPersonalLabelWrapperPersonalNameLastName"
                      ...
                      <Grid item xs={12} sm={12}>
                        <Grid
                          id="FlexedemokraciaServiceUserEdemokraciaServiceProCreatedByViewDefaultServiceUserViewEditPersonalLabelWrapperPersonalContact"
                          container
                          direction="row"
                          alignItems="flex-start"
                          justifyContent="flex-start"
                        ...
                        >
                          <Grid item xs={12} sm={12} md={4.0}>
                            <TextField
                              required={true}
                              name="email"
                              id="TextInputedemokraciaServiceUserEdemokraciaServiceProCreatedByViewDefaultServiceUserViewEditPersonalLabelWrapperPersonalContactEmail"
                          ...
                          <Grid item xs={12} sm={12} md={4.0}>
                            <TextField
                              required={false}
                              name="phone"
                              id="TextInputedemokraciaServiceUserEdemokraciaServiceProCreatedByViewDefaultServiceUserViewEditPersonalLabelWrapperPersonalContactPhone"
                      ...
                      <Grid item xs={12} sm={12}>
                        <CollectionAssociationButton
                          id="NavigationToPageActionedemokraciaServiceUserEdemokraciaServiceProCreatedByViewEdemokraciaServiceUserEdemokraciaServiceServiceUserVotesButtonNavigate"
                          variant={undefined}
                          editMode={editMode}
          ...
          <Grid item xs={12} sm={12}>
            <Card id="FlexedemokraciaServiceUserEdemokraciaServiceProCreatedByViewDefaultServiceUserViewEditAreasLabelWrapper">
              <CardContent>
                <Grid container direction="column" alignItems="stretch" justifyContent="flex-start" spacing={2}>
                  <Grid item xs={12} sm={12}>
                    <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                      ...
                      <Typography
                        id="LabeledemokraciaServiceUserEdemokraciaServiceProCreatedByViewDefaultServiceUserViewEditAreasLabelWrapperAreasLabel"
                        variant="h5"
                        component="h1"
                      >
                  ...
                  <Grid item xs={12} sm={12}>
                    <Grid
                      id="FlexedemokraciaServiceUserEdemokraciaServiceProCreatedByViewDefaultServiceUserViewEditAreasLabelWrapperAreas"
                      container
                      direction="row"
                      alignItems="stretch"
                    ...
                    >
                      <Grid item xs={12} sm={12}>
                        <Grid
                          id="FlexedemokraciaServiceUserEdemokraciaServiceProCreatedByViewDefaultServiceUserViewEditAreasLabelWrapperAreasResidency"
                          container
                          direction="row"
                          alignItems="flex-start"
                          justifyContent="flex-start"
                      ...
                      <Grid container item xs={12} sm={12}>
                        <ModeledTabs
                          id="TabControlleredemokraciaServiceUserEdemokraciaServiceProCreatedByViewDefaultServiceUserViewEditAreasLabelWrapperAreasActivity"
                          ownerData={data}
                          validation={validation}
                          orientation='horizontal'
                          childTabs={[
                            {
                              id: 'TabedemokraciaServiceUserEdemokraciaServiceProCreatedByViewDefaultServiceUserViewEditAreasLabelWrapperAreasActivityTabActivityCounties',
                            ...
                            {
                              id: 'TabedemokraciaServiceUserEdemokraciaServiceProCreatedByViewDefaultServiceUserViewEditAreasLabelWrapperAreasActivityActivityCities',
                            ...
                            {
                              id: 'TabedemokraciaServiceUserEdemokraciaServiceProCreatedByViewDefaultServiceUserViewEditAreasLabelWrapperAreasActivityActivityDistricts',
                        ...
                        >
                          <Grid item xs={12} sm={12}>
                            <Grid
                              id="FlexedemokraciaServiceUserEdemokraciaServiceProCreatedByViewDefaultServiceUserViewEditAreasLabelWrapperAreasActivityTabActivityCountiesTabActivityCounties"
                              container
                              direction="row"
                              alignItems="flex-start"
                              justifyContent="flex-start"
                            ...
                            >
                              <Grid item xs={12} sm={12}>
                                <Grid
                                  id="FlexedemokraciaServiceUserEdemokraciaServiceProCreatedByViewDefaultServiceUserViewEditAreasLabelWrapperAreasActivityTabActivityCountiesTabActivityCountiesActivityCountiesLabelWrapper"
                                  container
                                  direction="column"
                                  alignItems="stretch"
                                  justifyContent="flex-start"
                                ...
                                >
                                  <Grid item xs={12} sm={12}>
                                    <Grid
                                      id="TableedemokraciaServiceUserEdemokraciaServiceProCreatedByViewDefaultServiceUserViewEditAreasLabelWrapperAreasActivityTabActivityCountiesTabActivityCountiesActivityCountiesLabelWrapperActivityCounties"
                                      container
                                      direction="column"
                                      alignItems="stretch"
                                      justifyContent="flex-start"
                          ...
                          <Grid item xs={12} sm={12} md={4.0}>
                            <Grid
                              id="FlexedemokraciaServiceUserEdemokraciaServiceProCreatedByViewDefaultServiceUserViewEditAreasLabelWrapperAreasActivityActivityCitiesActivityCities"
                              container
                              direction="row"
                              alignItems="flex-start"
                              justifyContent="flex-start"
                            ...
                            >
                              <Grid item xs={12} sm={12}>
                                <Grid
                                  id="FlexedemokraciaServiceUserEdemokraciaServiceProCreatedByViewDefaultServiceUserViewEditAreasLabelWrapperAreasActivityActivityCitiesActivityCitiesActivityCitiesLabelWrapper"
                                  container
                                  direction="column"
                                  alignItems="stretch"
                                  justifyContent="flex-start"
                                ...
                                >
                                  <Grid item xs={12} sm={12}>
                                    <Grid
                                      id="TableedemokraciaServiceUserEdemokraciaServiceProCreatedByViewDefaultServiceUserViewEditAreasLabelWrapperAreasActivityActivityCitiesActivityCitiesActivityCitiesLabelWrapperActivityCities"
                                      container
                                      direction="column"
                                      alignItems="stretch"
                                      justifyContent="flex-start"
                          ...
                          <Grid item xs={12} sm={12}>
                            <Grid
                              id="FlexedemokraciaServiceUserEdemokraciaServiceProCreatedByViewDefaultServiceUserViewEditAreasLabelWrapperAreasActivityActivityDistrictsActivityDistricts"
                              container
                              direction="row"
                              alignItems="flex-start"
                              justifyContent="flex-start"
                            ...
                            >
                              <Grid item xs={12} sm={12}>
                                <Grid
                                  id="FlexedemokraciaServiceUserEdemokraciaServiceProCreatedByViewDefaultServiceUserViewEditAreasLabelWrapperAreasActivityActivityDistrictsActivityDistrictsActivityDistrictsLabelWrapper"
                                  container
                                  direction="column"
                                  alignItems="stretch"
                                  justifyContent="flex-start"
                                ...
                                >
                                  <Grid item xs={12} sm={12}>
                                    <Grid
                                      id="TableedemokraciaServiceUserEdemokraciaServiceProCreatedByViewDefaultServiceUserViewEditAreasLabelWrapperAreasActivityActivityDistrictsActivityDistrictsActivityDistrictsLabelWrapperActivityDistricts"
                                      container
                                      direction="column"
                                      alignItems="stretch"
                                      justifyContent="flex-start"
