...
// Page name: edemokracia::service::Pro.votes#Table
...
/**
 * Name: edemokracia::service::Pro.votes#Table
 * Is Access: false
 * Type: Table
 **/
export default function ServiceProVotesTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaServiceUserEdemokraciaServiceProVotesTable-data-grid">
