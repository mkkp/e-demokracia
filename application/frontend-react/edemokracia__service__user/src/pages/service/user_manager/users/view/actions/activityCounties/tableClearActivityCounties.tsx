...
export type TableClearActivityCountiesAction = () => (
  owner: JudoIdentifiable<ServiceServiceUser>,
  successCallback: () => void,
) => Promise<void>;

export const useTableClearActivityCountiesAction: TableClearActivityCountiesAction = () => {
  ...
  return async function tableClearActivityCountiesAction(
    owner: JudoIdentifiable<ServiceServiceUser>,
    successCallback: () => void,
  ) {
    try {
      await serviceServiceUserServiceForClassImpl.setActivityCounties(
