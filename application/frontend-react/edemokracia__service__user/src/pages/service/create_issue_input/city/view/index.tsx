...
// Page name: edemokracia::service::CreateIssueInput.city#View
...
/**
 * Name: edemokracia::service::CreateIssueInput.city#View
 * Is Access: false
 * Type: View
        ...
        <Grid container spacing={2} direction="column" alignItems="stretch" justifyContent="flex-start">
          <Grid item xs={12} sm={12}>
            <TextField
              required={true}
              name="name"
              id="TextInputedemokraciaServiceUserEdemokraciaServiceCreateIssueInputCityViewDefaultCityViewEditName"
          ...
          <Grid item xs={12} sm={12}>
            <Grid
              id="FlexedemokraciaServiceUserEdemokraciaServiceCreateIssueInputCityViewDefaultCityViewEditDistrictsLabelWrapper"
              container
              direction="column"
              alignItems="stretch"
            ...
            >
              <Grid item xs={12} sm={12}>
                <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                  ...
                  <Typography
                    id="LabeledemokraciaServiceUserEdemokraciaServiceCreateIssueInputCityViewDefaultCityViewEditDistrictsLabelWrapperDistrictsLabel"
                    variant="h5"
                    component="h1"
                  >
              ...
              <Grid item xs={12} sm={12}>
                <Grid
                  id="TableedemokraciaServiceUserEdemokraciaServiceCreateIssueInputCityViewDefaultCityViewEditDistrictsLabelWrapperDistricts"
                  container
                  direction="column"
                  alignItems="stretch"
                  justifyContent="flex-start"
