...
// Page name: edemokracia::service::CreateIssueInput.county#View
...
/**
 * Name: edemokracia::service::CreateIssueInput.county#View
 * Is Access: false
 * Type: View
        ...
        <Grid container spacing={2} direction="column" alignItems="stretch" justifyContent="flex-start">
          <Grid item xs={12} sm={12}>
            <TextField
              required={true}
              name="name"
              id="TextInputedemokraciaServiceUserEdemokraciaServiceCreateIssueInputCountyViewDefaultCountyViewEditName"
          ...
          <Grid item xs={12} sm={12}>
            <Grid
              id="FlexedemokraciaServiceUserEdemokraciaServiceCreateIssueInputCountyViewDefaultCountyViewEditCitiesLabelWrapper"
              container
              direction="column"
              alignItems="stretch"
            ...
            >
              <Grid item xs={12} sm={12}>
                <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                  ...
                  <Typography
                    id="LabeledemokraciaServiceUserEdemokraciaServiceCreateIssueInputCountyViewDefaultCountyViewEditCitiesLabelWrapperCitiesLabel"
                    variant="h5"
                    component="h1"
                  >
              ...
              <Grid item xs={12} sm={12}>
                <Grid
                  id="TableedemokraciaServiceUserEdemokraciaServiceCreateIssueInputCountyViewDefaultCountyViewEditCitiesLabelWrapperCities"
                  container
                  direction="column"
                  alignItems="stretch"
                  justifyContent="flex-start"
