...
export const CitiesTable = (props: CitiesTableProps) => {
  ...
  const filterModelKey = `TableedemokraciaServiceUserEdemokraciaServiceCreateIssueInputCountyViewDefaultCountyViewEditCitiesLabelWrapperCities-${ownerData.__identifier}-filterModel`;
  const filtersKey = `TableedemokraciaServiceUserEdemokraciaServiceCreateIssueInputCountyViewDefaultCountyViewEditCitiesLabelWrapperCities-${ownerData.__identifier}-filters`;
  ...
  const citiesRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceCreateIssueInputCountyViewDefaultCountyViewEditCitiesLabelWrapperCitiesNameFilter',
      attributeName: 'name',
  ...
  const citiesRowActions: TableRowAction<ServiceCityStored>[] = [
    {
      id: 'DeleteActionedemokraciaServiceUserEdemokraciaServiceCreateIssueInputCountyViewEdemokraciaServiceUserEdemokraciaServiceCountyCitiesRowDelete',
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              <Button
                id="CreateActionedemokraciaServiceUserEdemokraciaServiceCreateIssueInputCountyViewEdemokraciaServiceUserEdemokraciaServiceCountyCitiesTableCreate"
              ...
              <Button
                id="TableedemokraciaServiceUserEdemokraciaServiceCreateIssueInputCountyViewDefaultCountyViewEditCitiesLabelWrapperCities-filter"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() =>
                  filter(
                    'TableedemokraciaServiceUserEdemokraciaServiceCreateIssueInputCountyViewDefaultCountyViewEditCitiesLabelWrapperCities-filter',
                    filterOptions,
                    filters,
                  )
                }
