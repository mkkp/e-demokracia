...
// Page name: edemokracia::service::CreateIssueInput.issueType#View
// Page owner name: edemokracia::service::User
// Page DataElement name: issueType
// Page DataElement owner name: edemokracia::service::CreateIssueInput
...
/**
 * Name: edemokracia::service::CreateIssueInput.issueType#View
 * Is Access: false
 * Type: View
      ...
      <DialogContent dividers>
        <Grid container spacing={2} direction="column" alignItems="stretch" justifyContent="flex-start">
          <Grid item xs={12} sm={12}>
            <Card id="FlexedemokraciaServiceUserEdemokraciaServiceCreateIssueInputIssueTypeViewDefaultIssueTypeViewEditGroup">
              <CardContent>
                <Grid container direction="column" alignItems="stretch" justifyContent="flex-start" spacing={2}>
                  <Grid item xs={12} sm={12}>
                    <TextField
                      required={true}
                      name="title"
                      id="TextInputedemokraciaServiceUserEdemokraciaServiceCreateIssueInputIssueTypeViewDefaultIssueTypeViewEditGroupTitle"
                  ...
                  <Grid item xs={12} sm={12}>
                    <TextField
                      required={false}
                      name="voteType"
                      id="EnumerationComboedemokraciaServiceUserEdemokraciaServiceCreateIssueInputIssueTypeViewDefaultIssueTypeViewEditGroupVoteType"
                  ...
                  <Grid item xs={12} sm={12}>
                    <TextField
                      required={true}
                      name="description"
                      id="TextAreaedemokraciaServiceUserEdemokraciaServiceCreateIssueInputIssueTypeViewDefaultIssueTypeViewEditGroupDescription"
