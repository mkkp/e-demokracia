...
export const SERVICE_YES_NO_ABSTAIN_VOTE_DEFINITION_ISSUE_VIEW_COMMENTS =
  'ServiceYesNoAbstainVoteDefinitionIssueViewComments';
...
export const CommentsTable = (props: CommentsTableProps) => {
  ...
  const filterModelKey = `TableedemokraciaServiceUserEdemokraciaServiceYesNoAbstainVoteDefinitionIssueViewDefaultIssueViewEditOtherCommentsCommentsActionsCommentsLabelWrapperComments-${ownerData.__identifier}-filterModel`;
  const filtersKey = `TableedemokraciaServiceUserEdemokraciaServiceYesNoAbstainVoteDefinitionIssueViewDefaultIssueViewEditOtherCommentsCommentsActionsCommentsLabelWrapperComments-${ownerData.__identifier}-filters`;
  ...
  const commentsRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceYesNoAbstainVoteDefinitionIssueViewDefaultIssueViewEditOtherCommentsCommentsActionsCommentsLabelWrapperCommentsCommentFilter',
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceYesNoAbstainVoteDefinitionIssueViewDefaultIssueViewEditOtherCommentsCommentsActionsCommentsLabelWrapperCommentsCreatedFilter',
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceYesNoAbstainVoteDefinitionIssueViewDefaultIssueViewEditOtherCommentsCommentsActionsCommentsLabelWrapperCommentsCreatedByNameFilter',
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceYesNoAbstainVoteDefinitionIssueViewDefaultIssueViewEditOtherCommentsCommentsActionsCommentsLabelWrapperCommentsUpVotesFilter',
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceYesNoAbstainVoteDefinitionIssueViewDefaultIssueViewEditOtherCommentsCommentsActionsCommentsLabelWrapperCommentsDownVotesFilter',
  ...
  const commentsRowActions: TableRowAction<ServiceCommentStored>[] = [
    {
      id: 'CallOperationActionedemokraciaServiceUserEdemokraciaServiceYesNoAbstainVoteDefinitionIssueViewEdemokraciaServiceUserEdemokraciaServiceCommentVoteUpButtonCallOperation',
    ...
    {
      id: 'CallOperationActionedemokraciaServiceUserEdemokraciaServiceYesNoAbstainVoteDefinitionIssueViewEdemokraciaServiceUserEdemokraciaServiceCommentVoteDownButtonCallOperation',
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              <Button
                id="TableedemokraciaServiceUserEdemokraciaServiceYesNoAbstainVoteDefinitionIssueViewDefaultIssueViewEditOtherCommentsCommentsActionsCommentsLabelWrapperComments-filter"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() =>
                  filter(
                    'TableedemokraciaServiceUserEdemokraciaServiceYesNoAbstainVoteDefinitionIssueViewDefaultIssueViewEditOtherCommentsCommentsActionsCommentsLabelWrapperComments-filter',
                    filterOptions,
                    filters,
                  )
                }
