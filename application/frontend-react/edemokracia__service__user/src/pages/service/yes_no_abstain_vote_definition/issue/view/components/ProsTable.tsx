...
export const SERVICE_YES_NO_ABSTAIN_VOTE_DEFINITION_ISSUE_VIEW_PROS = 'ServiceYesNoAbstainVoteDefinitionIssueViewPros';
...
export const ProsTable = (props: ProsTableProps) => {
  ...
  const filterModelKey = `TableedemokraciaServiceUserEdemokraciaServiceYesNoAbstainVoteDefinitionIssueViewDefaultIssueViewEditOtherArgumentsArgumentsProsLabelWrapperProsTableProsLabelWrapperPros-${ownerData.__identifier}-filterModel`;
  const filtersKey = `TableedemokraciaServiceUserEdemokraciaServiceYesNoAbstainVoteDefinitionIssueViewDefaultIssueViewEditOtherArgumentsArgumentsProsLabelWrapperProsTableProsLabelWrapperPros-${ownerData.__identifier}-filters`;
  ...
  const prosRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceYesNoAbstainVoteDefinitionIssueViewDefaultIssueViewEditOtherArgumentsArgumentsProsLabelWrapperProsTableProsLabelWrapperProsTitleFilter',
      attributeName: 'title',
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceYesNoAbstainVoteDefinitionIssueViewDefaultIssueViewEditOtherArgumentsArgumentsProsLabelWrapperProsTableProsLabelWrapperProsUpVotesFilter',
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceYesNoAbstainVoteDefinitionIssueViewDefaultIssueViewEditOtherArgumentsArgumentsProsLabelWrapperProsTableProsLabelWrapperProsDownVotesFilter',
  ...
  const prosRowActions: TableRowAction<ServiceProStored>[] = [
    {
      id: 'DeleteActionedemokraciaServiceUserEdemokraciaServiceYesNoAbstainVoteDefinitionIssueViewEdemokraciaServiceUserEdemokraciaServiceIssueProsRowDelete',
    ...
    {
      id: 'CallOperationActionedemokraciaServiceUserEdemokraciaServiceYesNoAbstainVoteDefinitionIssueViewEdemokraciaServiceUserEdemokraciaServiceProVoteUpButtonCallOperation',
    ...
    {
      id: 'CallOperationActionedemokraciaServiceUserEdemokraciaServiceYesNoAbstainVoteDefinitionIssueViewEdemokraciaServiceUserEdemokraciaServiceProVoteDownButtonCallOperation',
    ...
    {
      id: 'CallOperationActionedemokraciaServiceUserEdemokraciaServiceYesNoAbstainVoteDefinitionIssueViewEdemokraciaServiceUserEdemokraciaServiceProCreateProArgumentButtonCallOperation',
    ...
    {
      id: 'CallOperationActionedemokraciaServiceUserEdemokraciaServiceYesNoAbstainVoteDefinitionIssueViewEdemokraciaServiceUserEdemokraciaServiceProCreateConArgumentButtonCallOperation',
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              <Button
                id="TableedemokraciaServiceUserEdemokraciaServiceYesNoAbstainVoteDefinitionIssueViewDefaultIssueViewEditOtherArgumentsArgumentsProsLabelWrapperProsTableProsLabelWrapperPros-filter"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() =>
                  filter(
                    'TableedemokraciaServiceUserEdemokraciaServiceYesNoAbstainVoteDefinitionIssueViewDefaultIssueViewEditOtherArgumentsArgumentsProsLabelWrapperProsTableProsLabelWrapperPros-filter',
                    filterOptions,
                    filters,
                  )
                }
