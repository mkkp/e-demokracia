...
export function UserLink(props: UserLinkProps) {
  ...
  const ownerRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceYesNoAbstainVoteDefinitionVoteEntriesViewDefaultYesNoAbstainVoteEntryViewEditUserRepresentationFilter',
  ...
  return (
    <AggregationInput
      name="owner"
      id="LinkedemokraciaServiceUserEdemokraciaServiceYesNoAbstainVoteDefinitionVoteEntriesViewDefaultYesNoAbstainVoteEntryViewEditUser"
      required={true}
