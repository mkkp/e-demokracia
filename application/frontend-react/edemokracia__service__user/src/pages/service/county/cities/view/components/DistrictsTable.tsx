...
export const DistrictsTable = (props: DistrictsTableProps) => {
  ...
  const filterModelKey = `TableedemokraciaServiceUserEdemokraciaServiceCountyCitiesViewDefaultCityViewEditDistrictsLabelWrapperDistricts-${ownerData.__identifier}-filterModel`;
  const filtersKey = `TableedemokraciaServiceUserEdemokraciaServiceCountyCitiesViewDefaultCityViewEditDistrictsLabelWrapperDistricts-${ownerData.__identifier}-filters`;
  ...
  const districtsRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceCountyCitiesViewDefaultCityViewEditDistrictsLabelWrapperDistrictsNameFilter',
      attributeName: 'name',
  ...
  const districtsRowActions: TableRowAction<ServiceDistrictStored>[] = [
    {
      id: 'DeleteActionedemokraciaServiceUserEdemokraciaServiceCountyCitiesViewEdemokraciaServiceUserEdemokraciaServiceCityDistrictsRowDelete',
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              <Button
                id="CreateActionedemokraciaServiceUserEdemokraciaServiceCountyCitiesViewEdemokraciaServiceUserEdemokraciaServiceCityDistrictsTableCreate"
              ...
              <Button
                id="TableedemokraciaServiceUserEdemokraciaServiceCountyCitiesViewDefaultCityViewEditDistrictsLabelWrapperDistricts-filter"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() =>
                  filter(
                    'TableedemokraciaServiceUserEdemokraciaServiceCountyCitiesViewDefaultCityViewEditDistrictsLabelWrapperDistricts-filter',
                    filterOptions,
                    filters,
                  )
                }
