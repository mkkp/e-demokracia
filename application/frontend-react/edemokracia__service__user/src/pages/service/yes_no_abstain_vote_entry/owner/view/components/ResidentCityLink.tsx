...
export function ResidentCityLink(props: ResidentCityLinkProps) {
  ...
  const residentCityRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceYesNoAbstainVoteEntryOwnerViewDefaultServiceUserViewEditAreasLabelWrapperAreasResidencyResidentCityRepresentationFilter',
  ...
  return (
    <AggregationInput
      name="residentCity"
      id="LinkedemokraciaServiceUserEdemokraciaServiceYesNoAbstainVoteEntryOwnerViewDefaultServiceUserViewEditAreasLabelWrapperAreasResidencyResidentCity"
