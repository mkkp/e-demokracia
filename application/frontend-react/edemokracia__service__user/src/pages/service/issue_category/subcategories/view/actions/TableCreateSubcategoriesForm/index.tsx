...
import ServiceUserView from '~/pages/service/issue_category/subcategories/view/index';
...
import {
  serviceIssueCategoryServiceForSubcategoriesImpl,
...
export default function TableCreateSubcategoriesForm({
  ...
  const submit = async () => {
    ...
    try {
      const res = await serviceIssueCategoryServiceForSubcategoriesImpl.createSubcategories(owner, payloadDiff);
  ...
  return (
    <>
      <DialogTitle>
        {title}
        <IconButton
          id="CreateActionedemokraciaServiceUserEdemokraciaServiceIssueCategorySubcategoriesViewEdemokraciaServiceUserEdemokraciaServiceIssueCategorySubcategoriesTableCreate-dialog-close"
          aria-label="close"
          onClick={() => cancel()}
          sx={{
            position: 'absolute',
        ...
        <Grid container spacing={2} direction="column" alignItems="stretch" justifyContent="flex-start">
          <Grid item xs={12} sm={12}>
            <TextField
              required={true}
              name="title"
              id="TextInputedemokraciaServiceUserEdemokraciaServiceIssueCategorySubcategoriesCreateDefaultIssueCategoryFormTitle"
              autoFocus
          ...
          <Grid item xs={12} sm={12}>
            <TextField
              required={true}
              name="description"
              id="TextInputedemokraciaServiceUserEdemokraciaServiceIssueCategorySubcategoriesCreateDefaultIssueCategoryFormDescription"
      ...
      <DialogActions>
        <Button
          id="CreateActionedemokraciaServiceUserEdemokraciaServiceIssueCategorySubcategoriesViewEdemokraciaServiceUserEdemokraciaServiceIssueCategorySubcategoriesTableCreate-action-form-action-cancel"
          variant="text"
          onClick={() => cancel()}
          disabled={isLoading}
        >
        ...
        <ButtonGroup size="small" ref={anchorRef} aria-label="split button" disabled={isLoading}>
          <LoadingButton
            ...
            id="CreateActionedemokraciaServiceUserEdemokraciaServiceIssueCategorySubcategoriesViewEdemokraciaServiceUserEdemokraciaServiceIssueCategorySubcategoriesTableCreate-action-form-action-create"
            variant="contained"
            onClick={async () => {
