...
import { serviceIssueCategoryServiceForClassImpl, serviceServiceUserServiceForClassImpl } from '~/generated/data-axios';
import { useLinkViewOwnerAction } from '../actions';

export type OwnerLinkFilterInitializer = (ownerData: ServiceIssueCategoryStored) => Filter[] | undefined;
...
export interface OwnerLinkProps {
  ...
  validation: Map<keyof ServiceIssueCategoryStored, string>;
...
export function OwnerLink(props: OwnerLinkProps) {
  ...
  const ownerColumns: GridColDef<ServiceServiceUserStored>[] = [
    {
      ...
      headerName: t('service.IssueCategoryView.owner.representation', { defaultValue: 'Representation' }) as string,
  ...
  const ownerRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceIssueCategorySubcategoriesViewDefaultIssueCategoryViewEditOwnerRepresentationFilter',
      attributeName: 'representation',
      label: t('service.IssueCategoryView.owner.representation', { defaultValue: 'Representation' }) as string,
  ...
  return (
    <AggregationInput
      name="owner"
      id="LinkedemokraciaServiceUserEdemokraciaServiceIssueCategorySubcategoriesViewDefaultIssueCategoryViewEditOwner"
      label={t('service.IssueCategoryView.owner', { defaultValue: 'Owner' }) as string}
