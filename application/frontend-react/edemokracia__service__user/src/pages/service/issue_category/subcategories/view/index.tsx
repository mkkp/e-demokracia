...
// Page name: edemokracia::service::IssueCategory.subcategories#View
...
/**
 * Name: edemokracia::service::IssueCategory.subcategories#View
 * Is Access: false
 * Type: View
        ...
        <Grid container spacing={2} direction="column" alignItems="stretch" justifyContent="flex-start">
          <Grid item xs={12} sm={12}>
            <TextField
              required={true}
              name="title"
              id="TextInputedemokraciaServiceUserEdemokraciaServiceIssueCategorySubcategoriesViewDefaultIssueCategoryViewEditTitle"
          ...
          <Grid item xs={12} sm={12}>
            <TextField
              required={true}
              name="description"
              id="TextInputedemokraciaServiceUserEdemokraciaServiceIssueCategorySubcategoriesViewDefaultIssueCategoryViewEditDescription"
          ...
          <Grid item xs={12} sm={12}>
            <Grid
              id="FlexedemokraciaServiceUserEdemokraciaServiceIssueCategorySubcategoriesViewDefaultIssueCategoryViewEditSubcategoriesLabelWrapper"
              container
              direction="column"
              alignItems="stretch"
            ...
            >
              <Grid item xs={12} sm={12}>
                <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                  ...
                  <Typography
                    id="LabeledemokraciaServiceUserEdemokraciaServiceIssueCategorySubcategoriesViewDefaultIssueCategoryViewEditSubcategoriesLabelWrapperSubcategoriesLabel"
                    variant="h5"
                    component="h1"
                  >
              ...
              <Grid item xs={12} sm={12}>
                <Grid
                  id="TableedemokraciaServiceUserEdemokraciaServiceIssueCategorySubcategoriesViewDefaultIssueCategoryViewEditSubcategoriesLabelWrapperSubcategories"
                  container
                  direction="column"
                  alignItems="stretch"
                  justifyContent="flex-start"
