...
import { serviceCountyServiceForClassImpl, serviceCityServiceForClassImpl } from '~/generated/data-axios';
import {
...
export const SERVICE_USER_VIEW_CITIES = 'ServiceUserViewCities';
...
export const CitiesTable = (props: CitiesTableProps) => {
  ...
  const filterModelKey = `TableedemokraciaServiceUserEdemokraciaServiceUserProfileActivityCountiesViewDefaultCountyViewEditCitiesLabelWrapperCities-${ownerData.__identifier}-filterModel`;
  const filtersKey = `TableedemokraciaServiceUserEdemokraciaServiceUserProfileActivityCountiesViewDefaultCountyViewEditCitiesLabelWrapperCities-${ownerData.__identifier}-filters`;
  ...
  const citiesColumns: GridColDef<ServiceCityStored>[] = [
    {
      ...baseColumnConfig,
      field: 'name',
      headerName: t('service.CountyView.cities.name', { defaultValue: 'Name' }) as string,
  ...
  const citiesRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserProfileActivityCountiesViewDefaultCountyViewEditCitiesLabelWrapperCitiesNameFilter',
      attributeName: 'name',
      label: t('service.CountyView.cities.name', { defaultValue: 'Name' }) as string,
      filterType: FilterType.string,
    },
  ];

  const citiesInitialQueryCustomizer: ServiceCityQueryCustomizer = {
    _mask: '{name}',
  ...
  const citiesRowActions: TableRowAction<ServiceCityStored>[] = [
    {
      id: 'DeleteActionedemokraciaServiceUserEdemokraciaServiceUserProfileActivityCountiesViewEdemokraciaServiceUserEdemokraciaServiceCountyCitiesRowDelete',
      label: t('judo.pages.table.delete', { defaultValue: 'Delete' }) as string,
      icon: <MdiIcon path="delete_forever" />,
      action: async (row: ServiceCityStored) => rowDeleteCitiesAction(ownerData, row, () => fetchOwnerData()),
      disabled: (row: ServiceCityStored) => editMode || !row.__deleteable,
    },
  ];
      ...
      <StripedDataGrid
        ...
        columns={[
          ...
          ...columnsActionCalculator(
            'RelationTypeedemokraciaServiceUserEdemokraciaServiceCountyCities',
            citiesRowActions,
            t,
            { shownActions: 2 },
          ),
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              <Button
                id="CreateActionedemokraciaServiceUserEdemokraciaServiceUserProfileActivityCountiesViewEdemokraciaServiceUserEdemokraciaServiceCountyCitiesTableCreate"
              ...
              <Button
                id="TableedemokraciaServiceUserEdemokraciaServiceUserProfileActivityCountiesViewDefaultCountyViewEditCitiesLabelWrapperCities-filter"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() =>
                  filter(
                    'TableedemokraciaServiceUserEdemokraciaServiceUserProfileActivityCountiesViewDefaultCountyViewEditCitiesLabelWrapperCities-filter',
                    filterOptions,
                    filters,
                  )
                }
              ...
              {isBulkDeleteAvailable() ? (
                <Button
                  id="RelationTypeedemokraciaServiceUserEdemokraciaServiceCountyCities-bulk-delete"
