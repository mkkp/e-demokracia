...
// Page name: edemokracia::service::UserProfile.activityCounties#View
// Page owner name: edemokracia::service::User
// Page DataElement name: activityCounties
// Page DataElement owner name: edemokracia::service::UserProfile
...
/**
 * Name: edemokracia::service::UserProfile.activityCounties#View
 * Is Access: false
 * Type: View
        ...
        <Grid container spacing={2} direction="column" alignItems="stretch" justifyContent="flex-start">
          <Grid item xs={12} sm={12}>
            <TextField
              required={true}
              name="name"
              id="TextInputedemokraciaServiceUserEdemokraciaServiceUserProfileActivityCountiesViewDefaultCountyViewEditName"
          ...
          <Grid item xs={12} sm={12}>
            <Grid
              id="FlexedemokraciaServiceUserEdemokraciaServiceUserProfileActivityCountiesViewDefaultCountyViewEditCitiesLabelWrapper"
              container
              direction="column"
              alignItems="stretch"
            ...
            >
              <Grid item xs={12} sm={12}>
                <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                  ...
                  <Typography
                    id="LabeledemokraciaServiceUserEdemokraciaServiceUserProfileActivityCountiesViewDefaultCountyViewEditCitiesLabelWrapperCitiesLabel"
                    variant="h5"
                    component="h1"
                  >
              ...
              <Grid item xs={12} sm={12}>
                <Grid
                  id="TableedemokraciaServiceUserEdemokraciaServiceUserProfileActivityCountiesViewDefaultCountyViewEditCitiesLabelWrapperCities"
                  container
                  direction="column"
                  alignItems="stretch"
                  justifyContent="flex-start"
