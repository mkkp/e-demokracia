...
export const DistrictsTable = (props: DistrictsTableProps) => {
  ...
  const filterModelKey = `TableedemokraciaServiceUserEdemokraciaServiceUserProfileActivityCitiesViewDefaultCityViewEditDistrictsLabelWrapperDistricts-${ownerData.__identifier}-filterModel`;
  const filtersKey = `TableedemokraciaServiceUserEdemokraciaServiceUserProfileActivityCitiesViewDefaultCityViewEditDistrictsLabelWrapperDistricts-${ownerData.__identifier}-filters`;
  ...
  const districtsRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserProfileActivityCitiesViewDefaultCityViewEditDistrictsLabelWrapperDistrictsNameFilter',
      attributeName: 'name',
  ...
  const districtsRowActions: TableRowAction<ServiceDistrictStored>[] = [
    {
      id: 'DeleteActionedemokraciaServiceUserEdemokraciaServiceUserProfileActivityCitiesViewEdemokraciaServiceUserEdemokraciaServiceCityDistrictsRowDelete',
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              <Button
                id="CreateActionedemokraciaServiceUserEdemokraciaServiceUserProfileActivityCitiesViewEdemokraciaServiceUserEdemokraciaServiceCityDistrictsTableCreate"
              ...
              <Button
                id="TableedemokraciaServiceUserEdemokraciaServiceUserProfileActivityCitiesViewDefaultCityViewEditDistrictsLabelWrapperDistricts-filter"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() =>
                  filter(
                    'TableedemokraciaServiceUserEdemokraciaServiceUserProfileActivityCitiesViewDefaultCityViewEditDistrictsLabelWrapperDistricts-filter',
                    filterOptions,
                    filters,
                  )
                }
