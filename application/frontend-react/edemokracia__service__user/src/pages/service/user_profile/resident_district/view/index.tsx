...
// Page name: edemokracia::service::UserProfile.residentDistrict#View
...
/**
 * Name: edemokracia::service::UserProfile.residentDistrict#View
 * Is Access: false
 * Type: View
        ...
        <Grid container spacing={2} direction="column" alignItems="stretch" justifyContent="flex-start">
          <Grid item xs={12} sm={12}>
            <TextField
              required={true}
              name="name"
              id="TextInputedemokraciaServiceUserEdemokraciaServiceUserProfileResidentDistrictViewDefaultDistrictViewEditName"
