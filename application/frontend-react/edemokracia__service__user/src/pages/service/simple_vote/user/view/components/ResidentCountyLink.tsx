...
export function ResidentCountyLink(props: ResidentCountyLinkProps) {
  ...
  const residentCountyRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceSimpleVoteUserViewDefaultServiceUserViewEditAreasLabelWrapperAreasResidencyResidentCountyRepresentationFilter',
  ...
  return (
    <AggregationInput
      name="residentCounty"
      id="LinkedemokraciaServiceUserEdemokraciaServiceSimpleVoteUserViewDefaultServiceUserViewEditAreasLabelWrapperAreasResidencyResidentCounty"
