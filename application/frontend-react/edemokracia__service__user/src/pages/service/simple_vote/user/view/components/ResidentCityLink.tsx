...
export function ResidentCityLink(props: ResidentCityLinkProps) {
  ...
  const residentCityRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceSimpleVoteUserViewDefaultServiceUserViewEditAreasLabelWrapperAreasResidencyResidentCityRepresentationFilter',
  ...
  return (
    <AggregationInput
      name="residentCity"
      id="LinkedemokraciaServiceUserEdemokraciaServiceSimpleVoteUserViewDefaultServiceUserViewEditAreasLabelWrapperAreasResidencyResidentCity"
