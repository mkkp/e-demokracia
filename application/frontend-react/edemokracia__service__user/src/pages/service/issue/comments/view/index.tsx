...
// Page name: edemokracia::service::Issue.comments#View
...
export type ServiceIssueCommentsViewPostRefreshAction = (
...
export const SERVICE_ISSUE_COMMENTS_VIEW_POST_REFRESH_HOOK_INTERFACE_KEY = 'ServiceIssueCommentsViewPostRefreshHook';
export type ServiceIssueCommentsViewPostRefreshHook = () => ServiceIssueCommentsViewPostRefreshAction;

/**
 * Name: edemokracia::service::Issue.comments#View
 * Is Access: false
 * Type: View
 * Edit Mode Available: false
 **/
export default function ServiceIssueCommentsView() {
  ...
  const { service: postRefreshHook } = useTrackService<ServiceIssueCommentsViewPostRefreshHook>(
    `(${OBJECTCLASS}=${SERVICE_ISSUE_COMMENTS_VIEW_POST_REFRESH_HOOK_INTERFACE_KEY})`,
  );
  const postRefreshAction: ServiceIssueCommentsViewPostRefreshAction | undefined = postRefreshHook && postRefreshHook();
        ...
        <Box sx={mainContainerPadding}>
          ...
          >
            <Grid item xs={12} sm={12}>
              <Card id="FlexedemokraciaServiceUserEdemokraciaServiceIssueCommentsViewDefaultCommentViewEditGroupLabelWrapper">
                <CardContent>
                  <Grid container direction="column" alignItems="stretch" justifyContent="flex-start" spacing={2}>
                    <Grid item xs={12} sm={12}>
                      <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                        ...
                        <Typography
                          id="LabeledemokraciaServiceUserEdemokraciaServiceIssueCommentsViewDefaultCommentViewEditGroupLabelWrapperGroupLabel"
                          variant="h5"
                          component="h1"
                        >
                    ...
                    <Grid item xs={12} sm={12}>
                      <Grid
                        id="FlexedemokraciaServiceUserEdemokraciaServiceIssueCommentsViewDefaultCommentViewEditGroupLabelWrapperGroup"
                        container
                        direction="row"
                        alignItems="stretch"
                        justifyContent="flex-start"
                      ...
                      >
                        <Grid item xs={12} sm={12} md={4.0}>
                          <DateTimePicker
                            ...
                            slotProps={{
                              textField: {
                                id: 'DateTimeInputedemokraciaServiceUserEdemokraciaServiceIssueCommentsViewDefaultCommentViewEditGroupLabelWrapperGroupCreated',
                                required: false,
                        ...
                        <Grid item xs={12} sm={12}>
                          <TextField
                            required={true}
                            name="comment"
                            id="TextAreaedemokraciaServiceUserEdemokraciaServiceIssueCommentsViewDefaultCommentViewEditGroupLabelWrapperGroupComment"
                        ...
                        <Grid item xs={12} sm={12} md={1.0}>
                          <LoadingButton
                            id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceIssueCommentsViewEdemokraciaServiceUserEdemokraciaServiceCommentVoteUpButtonCallOperation"
                            loading={isLoading}
                            variant={undefined}
                        ...
                        <Grid item xs={12} sm={12} md={1.0}>
                          <NumericInput
                            required={false}
                            name="upVotes"
                            id="NumericInputedemokraciaServiceUserEdemokraciaServiceIssueCommentsViewDefaultCommentViewEditGroupLabelWrapperGroupUpVotes"
                        ...
                        <Grid item xs={12} sm={12} md={1.0}>
                          <LoadingButton
                            id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceIssueCommentsViewEdemokraciaServiceUserEdemokraciaServiceCommentVoteDownButtonCallOperation"
                            loading={isLoading}
                            variant={undefined}
                        ...
                        <Grid item xs={12} sm={12} md={1.0}>
                          <NumericInput
                            required={false}
                            name="downVotes"
                            id="NumericInputedemokraciaServiceUserEdemokraciaServiceIssueCommentsViewDefaultCommentViewEditGroupLabelWrapperGroupDownVotes"
                        ...
                        <Grid item xs={12} sm={12} md={2.0}>
                          <CollectionAssociationButton
                            id="NavigationToPageActionedemokraciaServiceUserEdemokraciaServiceIssueCommentsViewEdemokraciaServiceUserEdemokraciaServiceCommentVotesButtonNavigate"
                            variant={undefined}
                            editMode={editMode}
