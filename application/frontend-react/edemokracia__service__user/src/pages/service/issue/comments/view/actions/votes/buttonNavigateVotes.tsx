...
import { routeToServiceCommentVotesTable } from '~/routes';

export const BUTTON_NAVIGATE_VOTES_ACTION_INTERFACE_KEY = 'ButtonNavigateVotesAction';
export type ButtonNavigateVotesAction = () => (owner: JudoIdentifiable<ServiceComment>) => Promise<void>;
...
export const useButtonNavigateVotesAction: ButtonNavigateVotesAction = () => {
  ...
  return async function (owner: JudoIdentifiable<ServiceComment>) {
    navigate(routeToServiceCommentVotesTable(owner.__signedIdentifier));
  };
};
