...
export const ProsTable = (props: ProsTableProps) => {
  ...
  const filterModelKey = `TableedemokraciaServiceUserEdemokraciaServiceIssueConsViewDefaultConViewEditArgumentsProsLabelWrapperProsTableProsLabelWrapperPros-${ownerData.__identifier}-filterModel`;
  const filtersKey = `TableedemokraciaServiceUserEdemokraciaServiceIssueConsViewDefaultConViewEditArgumentsProsLabelWrapperProsTableProsLabelWrapperPros-${ownerData.__identifier}-filters`;
  ...
  const prosRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceIssueConsViewDefaultConViewEditArgumentsProsLabelWrapperProsTableProsLabelWrapperProsTitleFilter',
      attributeName: 'title',
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceIssueConsViewDefaultConViewEditArgumentsProsLabelWrapperProsTableProsLabelWrapperProsUpVotesFilter',
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceIssueConsViewDefaultConViewEditArgumentsProsLabelWrapperProsTableProsLabelWrapperProsDownVotesFilter',
  ...
  const prosRowActions: TableRowAction<ServiceProStored>[] = [
    {
      id: 'DeleteActionedemokraciaServiceUserEdemokraciaServiceIssueConsViewEdemokraciaServiceUserEdemokraciaServiceConProsRowDelete',
    ...
    {
      id: 'CallOperationActionedemokraciaServiceUserEdemokraciaServiceIssueConsViewEdemokraciaServiceUserEdemokraciaServiceProVoteUpButtonCallOperation',
    ...
    {
      id: 'CallOperationActionedemokraciaServiceUserEdemokraciaServiceIssueConsViewEdemokraciaServiceUserEdemokraciaServiceProVoteDownButtonCallOperation',
    ...
    {
      id: 'CallOperationActionedemokraciaServiceUserEdemokraciaServiceIssueConsViewEdemokraciaServiceUserEdemokraciaServiceProCreateProArgumentButtonCallOperation',
    ...
    {
      id: 'CallOperationActionedemokraciaServiceUserEdemokraciaServiceIssueConsViewEdemokraciaServiceUserEdemokraciaServiceProCreateConArgumentButtonCallOperation',
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              <Button
                id="TableedemokraciaServiceUserEdemokraciaServiceIssueConsViewDefaultConViewEditArgumentsProsLabelWrapperProsTableProsLabelWrapperPros-filter"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() =>
                  filter(
                    'TableedemokraciaServiceUserEdemokraciaServiceIssueConsViewDefaultConViewEditArgumentsProsLabelWrapperProsTableProsLabelWrapperPros-filter',
                    filterOptions,
                    filters,
                  )
                }
