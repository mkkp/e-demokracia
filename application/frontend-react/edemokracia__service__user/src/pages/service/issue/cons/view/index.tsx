...
// Page name: edemokracia::service::Issue.cons#View
...
/**
 * Name: edemokracia::service::Issue.cons#View
 * Is Access: false
 * Type: View
...
export default function ServiceUserView(props: ServiceUserViewProps) {
  ...
  const [data, setData] = useState<ServiceConStored>(entry ? { ...entry } : ({} as unknown as ServiceConStored));
  ...
  async function fetchData() {
    ...
    try {
      const res = await serviceConServiceForClassImpl.refresh(
        { __signedIdentifier: entry.__signedIdentifier } as JudoIdentifiable<ServiceCon>,
      ...
      <DialogContent dividers>
        <Grid container spacing={2} direction="column" alignItems="stretch" justifyContent="flex-start">
          <Grid item xs={12} sm={12}>
            <Card id="FlexedemokraciaServiceUserEdemokraciaServiceIssueConsViewDefaultConViewEditConLabelWrapper">
              <CardContent>
                <Grid container direction="column" alignItems="stretch" justifyContent="flex-start" spacing={2}>
                  <Grid item xs={12} sm={12}>
                    <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                      ...
                      <Typography
                        id="LabeledemokraciaServiceUserEdemokraciaServiceIssueConsViewDefaultConViewEditConLabelWrapperConLabel"
                        variant="h5"
                        component="h1"
                      >
                  ...
                  <Grid item xs={12} sm={12}>
                    <Grid
                      id="FlexedemokraciaServiceUserEdemokraciaServiceIssueConsViewDefaultConViewEditConLabelWrapperCon"
                      container
                      direction="row"
                      alignItems="stretch"
                    ...
                    >
                      <Grid item xs={12} sm={12} md={6.0}>
                        <TextField
                          required={true}
                          name="title"
                          id="TextInputedemokraciaServiceUserEdemokraciaServiceIssueConsViewDefaultConViewEditConLabelWrapperConTitle"
                      ...
                      <Grid item xs={12} sm={12} md={3.0}>
                        <DateTimePicker
                          ...
                          slotProps={{
                            textField: {
                              id: 'DateTimeInputedemokraciaServiceUserEdemokraciaServiceIssueConsViewDefaultConViewEditConLabelWrapperConCreated',
                              required: true,
                      ...
                      <Grid item xs={12} sm={12}>
                        <TextField
                          required={true}
                          name="description"
                          id="TextAreaedemokraciaServiceUserEdemokraciaServiceIssueConsViewDefaultConViewEditConLabelWrapperConDescription"
                      ...
                      <Grid item xs={12} sm={12} md={1.0}>
                        <LoadingButton
                          id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceIssueConsViewEdemokraciaServiceUserEdemokraciaServiceConVoteUpButtonCallOperation"
                          loading={isLoading}
                          variant={undefined}
                      ...
                      <Grid item xs={12} sm={12} md={1.0}>
                        <NumericInput
                          required={false}
                          name="upVotes"
                          id="NumericInputedemokraciaServiceUserEdemokraciaServiceIssueConsViewDefaultConViewEditConLabelWrapperConUpVotes"
                      ...
                      <Grid item xs={12} sm={12} md={1.0}>
                        <LoadingButton
                          id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceIssueConsViewEdemokraciaServiceUserEdemokraciaServiceConVoteDownButtonCallOperation"
                          loading={isLoading}
                          variant={undefined}
                      ...
                      <Grid item xs={12} sm={12} md={1.0}>
                        <NumericInput
                          required={false}
                          name="downVotes"
                          id="NumericInputedemokraciaServiceUserEdemokraciaServiceIssueConsViewDefaultConViewEditConLabelWrapperConDownVotes"
                      ...
                      <Grid item xs={12} sm={12} md={2.0}>
                        <CollectionAssociationButton
                          id="NavigationToPageActionedemokraciaServiceUserEdemokraciaServiceIssueConsViewEdemokraciaServiceUserEdemokraciaServiceConVotesButtonNavigate"
                          variant={undefined}
                          editMode={editMode}
          ...
          <Grid item xs={12} sm={12}>
            <Grid
              id="FlexedemokraciaServiceUserEdemokraciaServiceIssueConsViewDefaultConViewEditArguments"
              container
              direction="row"
            ...
            >
              <Grid item xs={12} sm={12} md={6.0}>
                <Card id="FlexedemokraciaServiceUserEdemokraciaServiceIssueConsViewDefaultConViewEditArgumentsProsLabelWrapper">
                  <CardContent>
                    <Grid container direction="column" alignItems="stretch" justifyContent="flex-start" spacing={2}>
                      <Grid item xs={12} sm={12}>
                        <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                          ...
                          <Typography
                            id="LabeledemokraciaServiceUserEdemokraciaServiceIssueConsViewDefaultConViewEditArgumentsProsLabelWrapperProsLabel"
                            variant="h5"
                            component="h1"
                          >
                      ...
                      <Grid item xs={12} sm={12}>
                        <Grid
                          id="FlexedemokraciaServiceUserEdemokraciaServiceIssueConsViewDefaultConViewEditArgumentsProsLabelWrapperPros"
                          container
                          direction="row"
                          alignItems="stretch"
                          justifyContent="flex-start"
                        ...
                        >
                          <Grid item xs={12} sm={12}>
                            <Grid
                              id="FlexedemokraciaServiceUserEdemokraciaServiceIssueConsViewDefaultConViewEditArgumentsProsLabelWrapperProsActions"
                              container
                              direction="row"
                              alignItems="flex-start"
                              justifyContent="flex-start"
                            ...
                            >
                              <Grid item xs={12} sm={12}>
                                <LoadingButton
                                  id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceIssueConsViewEdemokraciaServiceUserEdemokraciaServiceConCreateProArgumentButtonCallOperation"
                                  loading={isLoading}
                                  variant={undefined}
                                  ...
                                  onClick={async () => {
                                    try {
                                      setIsLoading(true);
                                      await serviceConCreateProArgumentAction(data, () => fetchData());
                                    } finally {
                                      setIsLoading(false);
                                    }
                                  }}
                                ...
                                >
                                  <span>
                                    {t('service.ConView.cons.createProArgument.ButtonCallOperation', {
                          ...
                          <Grid item xs={12} sm={12}>
                            <Grid
                              id="FlexedemokraciaServiceUserEdemokraciaServiceIssueConsViewDefaultConViewEditArgumentsProsLabelWrapperProsTable"
                              container
                              direction="row"
                              alignItems="flex-start"
                              justifyContent="flex-start"
                            ...
                            >
                              <Grid item xs={12} sm={12}>
                                <Grid
                                  id="FlexedemokraciaServiceUserEdemokraciaServiceIssueConsViewDefaultConViewEditArgumentsProsLabelWrapperProsTableProsLabelWrapper"
                                  container
                                  direction="column"
                                  alignItems="stretch"
                                  justifyContent="flex-start"
                                ...
                                >
                                  <Grid item xs={12} sm={12}>
                                    <Grid
                                      id="TableedemokraciaServiceUserEdemokraciaServiceIssueConsViewDefaultConViewEditArgumentsProsLabelWrapperProsTableProsLabelWrapperPros"
                                      container
                                      direction="column"
                                      alignItems="stretch"
                                      justifyContent="flex-start"
              ...
              <Grid item xs={12} sm={12} md={6.0}>
                <Card id="FlexedemokraciaServiceUserEdemokraciaServiceIssueConsViewDefaultConViewEditArgumentsConsLabelWrapper">
                  <CardContent>
                    <Grid container direction="column" alignItems="stretch" justifyContent="flex-start" spacing={2}>
                      <Grid item xs={12} sm={12}>
                        <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                          <MdiIcon path="chat-minus" sx={{ marginRight: 1 }} />
                          <Typography
                            id="LabeledemokraciaServiceUserEdemokraciaServiceIssueConsViewDefaultConViewEditArgumentsConsLabelWrapperConsLabel"
                            variant="h5"
                            component="h1"
                          >
                      ...
                      <Grid item xs={12} sm={12}>
                        <Grid
                          id="FlexedemokraciaServiceUserEdemokraciaServiceIssueConsViewDefaultConViewEditArgumentsConsLabelWrapperCons"
                          container
                          direction="row"
                          alignItems="stretch"
                          justifyContent="flex-start"
                        ...
                        >
                          <Grid item xs={12} sm={12}>
                            <Grid
                              id="FlexedemokraciaServiceUserEdemokraciaServiceIssueConsViewDefaultConViewEditArgumentsConsLabelWrapperConsActions"
                              container
                              direction="row"
                              alignItems="flex-start"
                              justifyContent="flex-start"
                            ...
                            >
                              <Grid item xs={12} sm={12}>
                                <LoadingButton
                                  id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceIssueConsViewEdemokraciaServiceUserEdemokraciaServiceConCreateConArgumentButtonCallOperation"
                                  loading={isLoading}
                                  variant={undefined}
                                  ...
                                  onClick={async () => {
                                    try {
                                      setIsLoading(true);
                                      await serviceConCreateConArgumentAction(data, () => fetchData());
                                    } finally {
                                      setIsLoading(false);
                                    }
                                  }}
                                ...
                                >
                                  <span>
                                    {t('service.ConView.cons.createConArgument.ButtonCallOperation', {
                          ...
                          <Grid item xs={12} sm={12}>
                            <Grid
                              id="FlexedemokraciaServiceUserEdemokraciaServiceIssueConsViewDefaultConViewEditArgumentsConsLabelWrapperConsTable"
                              container
                              direction="row"
                              alignItems="flex-start"
                              justifyContent="flex-start"
                            ...
                            >
                              <Grid item xs={12} sm={12}>
                                <Grid
                                  id="FlexedemokraciaServiceUserEdemokraciaServiceIssueConsViewDefaultConViewEditArgumentsConsLabelWrapperConsTableConsLabelWrapper"
                                  container
                                  direction="column"
                                  alignItems="stretch"
                                  justifyContent="flex-start"
                                ...
                                >
                                  <Grid item xs={12} sm={12}>
                                    <Grid
                                      id="TableedemokraciaServiceUserEdemokraciaServiceIssueConsViewDefaultConViewEditArgumentsConsLabelWrapperConsTableConsLabelWrapperCons"
                                      container
                                      direction="column"
                                      alignItems="stretch"
                                      justifyContent="flex-start"
