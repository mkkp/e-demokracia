...
// Page name: edemokracia::service::Issue.closeDebate#Output
...
export type ServiceIssueClosedebateOutputPostRefreshAction = (
...
export const SERVICE_ISSUE_CLOSEDEBATE_OUTPUT_POST_REFRESH_HOOK_INTERFACE_KEY =
  'ServiceIssueClosedebateOutputPostRefreshHook';
export type ServiceIssueClosedebateOutputPostRefreshHook = () => ServiceIssueClosedebateOutputPostRefreshAction;

/**
 * Name: edemokracia::service::Issue.closeDebate#Output
 * Is Operation Output: true
 * Type: OperationOutput
 **/
export default function ServiceIssueClosedebateOutput() {
  ...
  const { service: postRefreshHook } = useTrackService<ServiceIssueClosedebateOutputPostRefreshHook>(
    `(${OBJECTCLASS}=${SERVICE_ISSUE_CLOSEDEBATE_OUTPUT_POST_REFRESH_HOOK_INTERFACE_KEY})`,
  );
  const postRefreshAction: ServiceIssueClosedebateOutputPostRefreshAction | undefined =
          ...
          >
            <Grid item xs={12} sm={12}>
              <TextField
                required={false}
                name="context"
                id="TextInputedemokraciaServiceUserEdemokraciaServiceIssueCloseDebateOutputDefaultCloseDebateOutputVoteDefinitionReferenceViewEditContext"
