...
// Page name: edemokracia::service::Issue.issueType#View
...
/**
 * Name: edemokracia::service::Issue.issueType#View
 * Is Access: false
 * Type: View
      ...
      <DialogContent dividers>
        <Grid container spacing={2} direction="column" alignItems="stretch" justifyContent="flex-start">
          <Grid item xs={12} sm={12}>
            <Card id="FlexedemokraciaServiceUserEdemokraciaServiceIssueIssueTypeViewDefaultIssueTypeViewEditGroup">
              <CardContent>
                <Grid container direction="column" alignItems="stretch" justifyContent="flex-start" spacing={2}>
                  <Grid item xs={12} sm={12}>
                    <TextField
                      required={true}
                      name="title"
                      id="TextInputedemokraciaServiceUserEdemokraciaServiceIssueIssueTypeViewDefaultIssueTypeViewEditGroupTitle"
                  ...
                  <Grid item xs={12} sm={12}>
                    <TextField
                      required={false}
                      name="voteType"
                      id="EnumerationComboedemokraciaServiceUserEdemokraciaServiceIssueIssueTypeViewDefaultIssueTypeViewEditGroupVoteType"
                  ...
                  <Grid item xs={12} sm={12}>
                    <TextField
                      required={true}
                      name="description"
                      id="TextAreaedemokraciaServiceUserEdemokraciaServiceIssueIssueTypeViewDefaultIssueTypeViewEditGroupDescription"
