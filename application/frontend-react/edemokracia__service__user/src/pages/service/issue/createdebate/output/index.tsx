...
// Page name: edemokracia::service::Issue.createDebate#Output
...
export type ServiceIssueCreatedebateOutputPostRefreshAction = (
...
export const SERVICE_ISSUE_CREATEDEBATE_OUTPUT_POST_REFRESH_HOOK_INTERFACE_KEY =
  'ServiceIssueCreatedebateOutputPostRefreshHook';
export type ServiceIssueCreatedebateOutputPostRefreshHook = () => ServiceIssueCreatedebateOutputPostRefreshAction;

/**
 * Name: edemokracia::service::Issue.createDebate#Output
 * Is Operation Output: true
 * Type: OperationOutput
 **/
export default function ServiceIssueCreatedebateOutput() {
  ...
  const { service: postRefreshHook } = useTrackService<ServiceIssueCreatedebateOutputPostRefreshHook>(
    `(${OBJECTCLASS}=${SERVICE_ISSUE_CREATEDEBATE_OUTPUT_POST_REFRESH_HOOK_INTERFACE_KEY})`,
  );
  const postRefreshAction: ServiceIssueCreatedebateOutputPostRefreshAction | undefined =
          ...
          >
            <Grid item xs={12} sm={12}>
              <TextField
                required={false}
                name="context"
                id="TextInputedemokraciaServiceUserEdemokraciaServiceIssueCreateDebateOutputDefaultCreateDebateOutputDebateReferenceViewEditContext"
