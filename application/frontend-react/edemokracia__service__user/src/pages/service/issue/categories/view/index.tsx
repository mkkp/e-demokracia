...
// Page name: edemokracia::service::Issue.categories#View
...
/**
 * Name: edemokracia::service::Issue.categories#View
 * Is Access: false
 * Type: View
        ...
        <Grid container spacing={2} direction="column" alignItems="stretch" justifyContent="flex-start">
          <Grid item xs={12} sm={12}>
            <TextField
              required={true}
              name="title"
              id="TextInputedemokraciaServiceUserEdemokraciaServiceIssueCategoriesViewDefaultIssueCategoryViewEditTitle"
          ...
          <Grid item xs={12} sm={12}>
            <TextField
              required={true}
              name="description"
              id="TextInputedemokraciaServiceUserEdemokraciaServiceIssueCategoriesViewDefaultIssueCategoryViewEditDescription"
          ...
          <Grid item xs={12} sm={12}>
            <Grid
              id="FlexedemokraciaServiceUserEdemokraciaServiceIssueCategoriesViewDefaultIssueCategoryViewEditSubcategoriesLabelWrapper"
              container
              direction="column"
              alignItems="stretch"
            ...
            >
              <Grid item xs={12} sm={12}>
                <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                  ...
                  <Typography
                    id="LabeledemokraciaServiceUserEdemokraciaServiceIssueCategoriesViewDefaultIssueCategoryViewEditSubcategoriesLabelWrapperSubcategoriesLabel"
                    variant="h5"
                    component="h1"
                  >
              ...
              <Grid item xs={12} sm={12}>
                <Grid
                  id="TableedemokraciaServiceUserEdemokraciaServiceIssueCategoriesViewDefaultIssueCategoryViewEditSubcategoriesLabelWrapperSubcategories"
                  container
                  direction="column"
                  alignItems="stretch"
                  justifyContent="flex-start"
