...
export const SubcategoriesTable = (props: SubcategoriesTableProps) => {
  ...
  const filterModelKey = `TableedemokraciaServiceUserEdemokraciaServiceIssueCategoriesViewDefaultIssueCategoryViewEditSubcategoriesLabelWrapperSubcategories-${ownerData.__identifier}-filterModel`;
  const filtersKey = `TableedemokraciaServiceUserEdemokraciaServiceIssueCategoriesViewDefaultIssueCategoryViewEditSubcategoriesLabelWrapperSubcategories-${ownerData.__identifier}-filters`;
  ...
  const subcategoriesRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceIssueCategoriesViewDefaultIssueCategoryViewEditSubcategoriesLabelWrapperSubcategoriesTitleFilter',
      attributeName: 'title',
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceIssueCategoriesViewDefaultIssueCategoryViewEditSubcategoriesLabelWrapperSubcategoriesDescriptionFilter',
  ...
  const subcategoriesRowActions: TableRowAction<ServiceIssueCategoryStored>[] = [
    {
      id: 'DeleteActionedemokraciaServiceUserEdemokraciaServiceIssueCategoriesViewEdemokraciaServiceUserEdemokraciaServiceIssueCategorySubcategoriesRowDelete',
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              <Button
                id="CreateActionedemokraciaServiceUserEdemokraciaServiceIssueCategoriesViewEdemokraciaServiceUserEdemokraciaServiceIssueCategorySubcategoriesTableCreate"
              ...
              <Button
                id="TableedemokraciaServiceUserEdemokraciaServiceIssueCategoriesViewDefaultIssueCategoryViewEditSubcategoriesLabelWrapperSubcategories-filter"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() =>
                  filter(
                    'TableedemokraciaServiceUserEdemokraciaServiceIssueCategoriesViewDefaultIssueCategoryViewEditSubcategoriesLabelWrapperSubcategories-filter',
                    filterOptions,
                    filters,
                  )
                }
