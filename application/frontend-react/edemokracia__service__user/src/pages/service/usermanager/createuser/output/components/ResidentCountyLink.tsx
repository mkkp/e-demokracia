...
export function ResidentCountyLink(props: ResidentCountyLinkProps) {
  ...
  const residentCountyRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserManagerCreateUserOutputDefaultServiceUserViewEditAreasLabelWrapperAreasResidencyResidentCountyRepresentationFilter',
  ...
  return (
    <AggregationInput
      name="residentCounty"
      id="LinkedemokraciaServiceUserEdemokraciaServiceUserManagerCreateUserOutputDefaultServiceUserViewEditAreasLabelWrapperAreasResidencyResidentCounty"
