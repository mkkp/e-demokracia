...
export const SERVICE_USER_OPERATION_OUTPUT_ACTIVITY_COUNTIES = 'ServiceUserOperationOutputActivityCounties';
...
export const ActivityCountiesTable = (props: ActivityCountiesTableProps) => {
  ...
  const filterModelKey = `TableedemokraciaServiceUserEdemokraciaServiceUserManagerCreateUserOutputDefaultServiceUserViewEditAreasLabelWrapperAreasActivityTabActivityCountiesTabActivityCountiesActivityCountiesLabelWrapperActivityCounties-${ownerData.__identifier}-filterModel`;
  const filtersKey = `TableedemokraciaServiceUserEdemokraciaServiceUserManagerCreateUserOutputDefaultServiceUserViewEditAreasLabelWrapperAreasActivityTabActivityCountiesTabActivityCountiesActivityCountiesLabelWrapperActivityCounties-${ownerData.__identifier}-filters`;
  ...
  const activityCountiesRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserManagerCreateUserOutputDefaultServiceUserViewEditAreasLabelWrapperAreasActivityTabActivityCountiesTabActivityCountiesActivityCountiesLabelWrapperActivityCountiesRepresentationFilter',
  ...
  const activityCountiesRowActions: TableRowAction<ServiceCountyStored>[] = [
    {
      id: 'RemoveActionedemokraciaServiceUserEdemokraciaServiceUserManagerCreateUserOutputEdemokraciaServiceUserEdemokraciaServiceServiceUserActivityCountiesRowRemove',
      label: t('judo.pages.table.remove', { defaultValue: 'Remove' }) as string,
      icon: <MdiIcon path="link_off" />,
      action: async (row: ServiceCountyStored) => {
        storeDiff('activityCounties', [
          ...(ownerData.activityCounties || []).filter(
            (e: ServiceCountyStored) => e.__signedIdentifier !== row.__signedIdentifier,
          ),
        ]);
      },
    },
      ...
      <StripedDataGrid
        ...
        columns={[
          ...
          ...columnsActionCalculator(
            'RelationTypeedemokraciaServiceUserEdemokraciaServiceServiceUserActivityCounties',
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              <Button
                id="RelationTypeedemokraciaServiceUserEdemokraciaServiceServiceUserActivityCounties-clear"
              ...
              <Button
                id="RelationTypeedemokraciaServiceUserEdemokraciaServiceServiceUserActivityCounties-add"
                startIcon={<MdiIcon path="attachment-plus" />}
                variant="text"
                onClick={async () => {
                  const res = await openRangeDialog<ServiceCountyStored, ServiceCountyQueryCustomizer>({
                    id: 'RelationTypeedemokraciaServiceUserEdemokraciaServiceServiceUserActivityCounties',
                  ...
                  if (res) {
                    const newList = [...(ownerData.activityCounties || []), ...(res.value as ServiceCountyStored[])];
              ...
              <Button
                id="TableedemokraciaServiceUserEdemokraciaServiceUserManagerCreateUserOutputDefaultServiceUserViewEditAreasLabelWrapperAreasActivityTabActivityCountiesTabActivityCountiesActivityCountiesLabelWrapperActivityCounties-filter"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() =>
                  filter(
                    'TableedemokraciaServiceUserEdemokraciaServiceUserManagerCreateUserOutputDefaultServiceUserViewEditAreasLabelWrapperAreasActivityTabActivityCountiesTabActivityCountiesActivityCountiesLabelWrapperActivityCounties-filter',
                    filterOptions,
                    filters,
                  )
                }
              ...
              {isBulkRemoveAvailable() ? (
                <Button
                  id="RelationTypeedemokraciaServiceUserEdemokraciaServiceServiceUserActivityCounties-bulk-remove"
                  disabled={isOwnerLoading}
                  variant="text"
