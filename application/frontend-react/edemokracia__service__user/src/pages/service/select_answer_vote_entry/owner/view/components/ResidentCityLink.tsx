...
export function ResidentCityLink(props: ResidentCityLinkProps) {
  ...
  const residentCityRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceSelectAnswerVoteEntryOwnerViewDefaultServiceUserViewEditAreasLabelWrapperAreasResidencyResidentCityRepresentationFilter',
  ...
  return (
    <AggregationInput
      name="residentCity"
      id="LinkedemokraciaServiceUserEdemokraciaServiceSelectAnswerVoteEntryOwnerViewDefaultServiceUserViewEditAreasLabelWrapperAreasResidencyResidentCity"
