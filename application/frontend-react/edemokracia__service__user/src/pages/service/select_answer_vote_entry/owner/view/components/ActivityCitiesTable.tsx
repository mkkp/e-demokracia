...
export const ActivityCitiesTable = (props: ActivityCitiesTableProps) => {
  ...
  const filterModelKey = `TableedemokraciaServiceUserEdemokraciaServiceSelectAnswerVoteEntryOwnerViewDefaultServiceUserViewEditAreasLabelWrapperAreasActivityActivityCitiesActivityCitiesActivityCitiesLabelWrapperActivityCities-${ownerData.__identifier}-filterModel`;
  const filtersKey = `TableedemokraciaServiceUserEdemokraciaServiceSelectAnswerVoteEntryOwnerViewDefaultServiceUserViewEditAreasLabelWrapperAreasActivityActivityCitiesActivityCitiesActivityCitiesLabelWrapperActivityCities-${ownerData.__identifier}-filters`;
  ...
  const activityCitiesRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceSelectAnswerVoteEntryOwnerViewDefaultServiceUserViewEditAreasLabelWrapperAreasActivityActivityCitiesActivityCitiesActivityCitiesLabelWrapperActivityCitiesRepresentationFilter',
  ...
  const activityCitiesRowActions: TableRowAction<ServiceCityStored>[] = [
    {
      id: 'RemoveActionedemokraciaServiceUserEdemokraciaServiceSelectAnswerVoteEntryOwnerViewEdemokraciaServiceUserEdemokraciaServiceServiceUserActivityCitiesRowRemove',
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              ...
              <Button
                id="TableedemokraciaServiceUserEdemokraciaServiceSelectAnswerVoteEntryOwnerViewDefaultServiceUserViewEditAreasLabelWrapperAreasActivityActivityCitiesActivityCitiesActivityCitiesLabelWrapperActivityCities-filter"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() =>
                  filter(
                    'TableedemokraciaServiceUserEdemokraciaServiceSelectAnswerVoteEntryOwnerViewDefaultServiceUserViewEditAreasLabelWrapperAreasActivityActivityCitiesActivityCitiesActivityCitiesLabelWrapperActivityCities-filter',
                    filterOptions,
                    filters,
                  )
                }
