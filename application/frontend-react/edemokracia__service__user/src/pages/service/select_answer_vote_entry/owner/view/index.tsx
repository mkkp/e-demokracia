...
// Page name: edemokracia::service::SelectAnswerVoteEntry.owner#View
...
/**
 * Name: edemokracia::service::SelectAnswerVoteEntry.owner#View
 * Is Access: false
 * Type: View
      ...
      <DialogContent dividers>
        <Grid container spacing={2} direction="column" alignItems="stretch" justifyContent="flex-start">
          <Grid item xs={12} sm={12}>
            <Card id="FlexedemokraciaServiceUserEdemokraciaServiceSelectAnswerVoteEntryOwnerViewDefaultServiceUserViewEditSecurityLabelWrapper">
              <CardContent>
                <Grid container direction="column" alignItems="stretch" justifyContent="flex-start" spacing={2}>
                  <Grid item xs={12} sm={12}>
                    <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                      ...
                      <Typography
                        id="LabeledemokraciaServiceUserEdemokraciaServiceSelectAnswerVoteEntryOwnerViewDefaultServiceUserViewEditSecurityLabelWrapperSecurityLabel"
                        variant="h5"
                        component="h1"
                      >
                  ...
                  <Grid item xs={12} sm={12}>
                    <Grid
                      id="FlexedemokraciaServiceUserEdemokraciaServiceSelectAnswerVoteEntryOwnerViewDefaultServiceUserViewEditSecurityLabelWrapperSecurity"
                      container
                      direction="row"
                      alignItems="stretch"
                    ...
                    >
                      <Grid item xs={12} sm={12} md={4.0}>
                        <TextField
                          required={true}
                          name="userName"
                          id="TextInputedemokraciaServiceUserEdemokraciaServiceSelectAnswerVoteEntryOwnerViewDefaultServiceUserViewEditSecurityLabelWrapperSecurityUserName"
                      ...
                      <Grid item xs={12} sm={12} md={4.0}>
                        <DateTimePicker
                          ...
                          slotProps={{
                            textField: {
                              id: 'DateTimeInputedemokraciaServiceUserEdemokraciaServiceSelectAnswerVoteEntryOwnerViewDefaultServiceUserViewEditSecurityLabelWrapperSecurityCreated',
                              required: false,
          ...
          <Grid item xs={12} sm={12}>
            <Card id="FlexedemokraciaServiceUserEdemokraciaServiceSelectAnswerVoteEntryOwnerViewDefaultServiceUserViewEditPersonalLabelWrapper">
              <CardContent>
                <Grid container direction="column" alignItems="stretch" justifyContent="flex-start" spacing={2}>
                  <Grid item xs={12} sm={12}>
                    <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                      ...
                      <Typography
                        id="LabeledemokraciaServiceUserEdemokraciaServiceSelectAnswerVoteEntryOwnerViewDefaultServiceUserViewEditPersonalLabelWrapperPersonalLabel"
                        variant="h5"
                        component="h1"
                      >
                  ...
                  <Grid item xs={12} sm={12}>
                    <Grid
                      id="FlexedemokraciaServiceUserEdemokraciaServiceSelectAnswerVoteEntryOwnerViewDefaultServiceUserViewEditPersonalLabelWrapperPersonal"
                      container
                      direction="row"
                      alignItems="stretch"
                      justifyContent="flex-start"
                    ...
                    >
                      <Grid item xs={12} sm={12}>
                        <Grid
                          id="FlexedemokraciaServiceUserEdemokraciaServiceSelectAnswerVoteEntryOwnerViewDefaultServiceUserViewEditPersonalLabelWrapperPersonalName"
                          container
                          direction="row"
                        ...
                        >
                          <Grid item xs={12} sm={12} md={4.0}>
                            <TextField
                              required={true}
                              name="firstName"
                              id="TextInputedemokraciaServiceUserEdemokraciaServiceSelectAnswerVoteEntryOwnerViewDefaultServiceUserViewEditPersonalLabelWrapperPersonalNameFirstName"
                          ...
                          <Grid item xs={12} sm={12} md={4.0}>
                            <TextField
                              required={true}
                              name="lastName"
                              id="TextInputedemokraciaServiceUserEdemokraciaServiceSelectAnswerVoteEntryOwnerViewDefaultServiceUserViewEditPersonalLabelWrapperPersonalNameLastName"
                      ...
                      <Grid item xs={12} sm={12}>
                        <Grid
                          id="FlexedemokraciaServiceUserEdemokraciaServiceSelectAnswerVoteEntryOwnerViewDefaultServiceUserViewEditPersonalLabelWrapperPersonalContact"
                          container
                          direction="row"
                          alignItems="flex-start"
                          justifyContent="flex-start"
                        ...
                        >
                          <Grid item xs={12} sm={12} md={4.0}>
                            <TextField
                              required={true}
                              name="email"
                              id="TextInputedemokraciaServiceUserEdemokraciaServiceSelectAnswerVoteEntryOwnerViewDefaultServiceUserViewEditPersonalLabelWrapperPersonalContactEmail"
                          ...
                          <Grid item xs={12} sm={12} md={4.0}>
                            <TextField
                              required={false}
                              name="phone"
                              id="TextInputedemokraciaServiceUserEdemokraciaServiceSelectAnswerVoteEntryOwnerViewDefaultServiceUserViewEditPersonalLabelWrapperPersonalContactPhone"
                      ...
                      <Grid item xs={12} sm={12}>
                        <CollectionAssociationButton
                          id="NavigationToPageActionedemokraciaServiceUserEdemokraciaServiceSelectAnswerVoteEntryOwnerViewEdemokraciaServiceUserEdemokraciaServiceServiceUserVotesButtonNavigate"
                          variant={undefined}
                          editMode={editMode}
          ...
          <Grid item xs={12} sm={12}>
            <Card id="FlexedemokraciaServiceUserEdemokraciaServiceSelectAnswerVoteEntryOwnerViewDefaultServiceUserViewEditAreasLabelWrapper">
              <CardContent>
                <Grid container direction="column" alignItems="stretch" justifyContent="flex-start" spacing={2}>
                  <Grid item xs={12} sm={12}>
                    <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                      ...
                      <Typography
                        id="LabeledemokraciaServiceUserEdemokraciaServiceSelectAnswerVoteEntryOwnerViewDefaultServiceUserViewEditAreasLabelWrapperAreasLabel"
                        variant="h5"
                        component="h1"
                      >
                  ...
                  <Grid item xs={12} sm={12}>
                    <Grid
                      id="FlexedemokraciaServiceUserEdemokraciaServiceSelectAnswerVoteEntryOwnerViewDefaultServiceUserViewEditAreasLabelWrapperAreas"
                      container
                      direction="row"
                      alignItems="stretch"
                    ...
                    >
                      <Grid item xs={12} sm={12}>
                        <Grid
                          id="FlexedemokraciaServiceUserEdemokraciaServiceSelectAnswerVoteEntryOwnerViewDefaultServiceUserViewEditAreasLabelWrapperAreasResidency"
                          container
                          direction="row"
                          alignItems="flex-start"
                          justifyContent="flex-start"
                      ...
                      <Grid container item xs={12} sm={12}>
                        <ModeledTabs
                          id="TabControlleredemokraciaServiceUserEdemokraciaServiceSelectAnswerVoteEntryOwnerViewDefaultServiceUserViewEditAreasLabelWrapperAreasActivity"
                          ownerData={data}
                          validation={validation}
                          orientation='horizontal'
                          childTabs={[
                            {
                              id: 'TabedemokraciaServiceUserEdemokraciaServiceSelectAnswerVoteEntryOwnerViewDefaultServiceUserViewEditAreasLabelWrapperAreasActivityTabActivityCounties',
                            ...
                            {
                              id: 'TabedemokraciaServiceUserEdemokraciaServiceSelectAnswerVoteEntryOwnerViewDefaultServiceUserViewEditAreasLabelWrapperAreasActivityActivityCities',
                            ...
                            {
                              id: 'TabedemokraciaServiceUserEdemokraciaServiceSelectAnswerVoteEntryOwnerViewDefaultServiceUserViewEditAreasLabelWrapperAreasActivityActivityDistricts',
                        ...
                        >
                          <Grid item xs={12} sm={12}>
                            <Grid
                              id="FlexedemokraciaServiceUserEdemokraciaServiceSelectAnswerVoteEntryOwnerViewDefaultServiceUserViewEditAreasLabelWrapperAreasActivityTabActivityCountiesTabActivityCounties"
                              container
                              direction="row"
                              alignItems="flex-start"
                              justifyContent="flex-start"
                            ...
                            >
                              <Grid item xs={12} sm={12}>
                                <Grid
                                  id="FlexedemokraciaServiceUserEdemokraciaServiceSelectAnswerVoteEntryOwnerViewDefaultServiceUserViewEditAreasLabelWrapperAreasActivityTabActivityCountiesTabActivityCountiesActivityCountiesLabelWrapper"
                                  container
                                  direction="column"
                                  alignItems="stretch"
                                  justifyContent="flex-start"
                                ...
                                >
                                  <Grid item xs={12} sm={12}>
                                    <Grid
                                      id="TableedemokraciaServiceUserEdemokraciaServiceSelectAnswerVoteEntryOwnerViewDefaultServiceUserViewEditAreasLabelWrapperAreasActivityTabActivityCountiesTabActivityCountiesActivityCountiesLabelWrapperActivityCounties"
                                      container
                                      direction="column"
                                      alignItems="stretch"
                                      justifyContent="flex-start"
                          ...
                          <Grid item xs={12} sm={12} md={4.0}>
                            <Grid
                              id="FlexedemokraciaServiceUserEdemokraciaServiceSelectAnswerVoteEntryOwnerViewDefaultServiceUserViewEditAreasLabelWrapperAreasActivityActivityCitiesActivityCities"
                              container
                              direction="row"
                              alignItems="flex-start"
                              justifyContent="flex-start"
                            ...
                            >
                              <Grid item xs={12} sm={12}>
                                <Grid
                                  id="FlexedemokraciaServiceUserEdemokraciaServiceSelectAnswerVoteEntryOwnerViewDefaultServiceUserViewEditAreasLabelWrapperAreasActivityActivityCitiesActivityCitiesActivityCitiesLabelWrapper"
                                  container
                                  direction="column"
                                  alignItems="stretch"
                                  justifyContent="flex-start"
                                ...
                                >
                                  <Grid item xs={12} sm={12}>
                                    <Grid
                                      id="TableedemokraciaServiceUserEdemokraciaServiceSelectAnswerVoteEntryOwnerViewDefaultServiceUserViewEditAreasLabelWrapperAreasActivityActivityCitiesActivityCitiesActivityCitiesLabelWrapperActivityCities"
                                      container
                                      direction="column"
                                      alignItems="stretch"
                                      justifyContent="flex-start"
                          ...
                          <Grid item xs={12} sm={12}>
                            <Grid
                              id="FlexedemokraciaServiceUserEdemokraciaServiceSelectAnswerVoteEntryOwnerViewDefaultServiceUserViewEditAreasLabelWrapperAreasActivityActivityDistrictsActivityDistricts"
                              container
                              direction="row"
                              alignItems="flex-start"
                              justifyContent="flex-start"
                            ...
                            >
                              <Grid item xs={12} sm={12}>
                                <Grid
                                  id="FlexedemokraciaServiceUserEdemokraciaServiceSelectAnswerVoteEntryOwnerViewDefaultServiceUserViewEditAreasLabelWrapperAreasActivityActivityDistrictsActivityDistrictsActivityDistrictsLabelWrapper"
                                  container
                                  direction="column"
                                  alignItems="stretch"
                                  justifyContent="flex-start"
                                ...
                                >
                                  <Grid item xs={12} sm={12}>
                                    <Grid
                                      id="TableedemokraciaServiceUserEdemokraciaServiceSelectAnswerVoteEntryOwnerViewDefaultServiceUserViewEditAreasLabelWrapperAreasActivityActivityDistrictsActivityDistrictsActivityDistrictsLabelWrapperActivityDistricts"
                                      container
                                      direction="column"
                                      alignItems="stretch"
                                      justifyContent="flex-start"
