...
// Page name: edemokracia::service::UserVoteDefinition.activeVoteDefinitionsInResidentCity#View
// Page owner name: edemokracia::service::User
// Page DataElement name: activeVoteDefinitionsInResidentCity
...
export type ServiceUserVoteDefinitionActiveVoteDefinitionsInResidentCityViewPostRefreshAction = (
...
export const SERVICE_USER_VOTE_DEFINITION_ACTIVE_VOTE_DEFINITIONS_IN_RESIDENT_CITY_VIEW_POST_REFRESH_HOOK_INTERFACE_KEY =
  'ServiceUserVoteDefinitionActiveVoteDefinitionsInResidentCityViewPostRefreshHook';
export type ServiceUserVoteDefinitionActiveVoteDefinitionsInResidentCityViewPostRefreshHook =
  () => ServiceUserVoteDefinitionActiveVoteDefinitionsInResidentCityViewPostRefreshAction;

/**
 * Name: edemokracia::service::UserVoteDefinition.activeVoteDefinitionsInResidentCity#View
 * Is Access: false
 * Type: View
 * Edit Mode Available: true
 **/
export default function ServiceUserVoteDefinitionActiveVoteDefinitionsInResidentCityView() {
  ...
  const handleUpdateError = useErrorHandler<ServiceVoteDefinition>(
    `(&(${OBJECTCLASS}=${ERROR_PROCESSOR_HOOK_INTERFACE_KEY})(operation=Update)(component=ServiceUserVoteDefinitionActiveVoteDefinitionsInResidentCityView))`,
  );
  ...
  const { service: postRefreshHook } =
    useTrackService<ServiceUserVoteDefinitionActiveVoteDefinitionsInResidentCityViewPostRefreshHook>(
      `(${OBJECTCLASS}=${SERVICE_USER_VOTE_DEFINITION_ACTIVE_VOTE_DEFINITIONS_IN_RESIDENT_CITY_VIEW_POST_REFRESH_HOOK_INTERFACE_KEY})`,
    );
        ...
        <Box sx={mainContainerPadding}>
          ...
          >
            <Grid item xs={12} sm={12}>
              <Card id="FlexedemokraciaServiceUserEdemokraciaServiceUserVoteDefinitionActiveVoteDefinitionsInResidentCityViewDefaultVoteDefinitionViewEditGroup">
                <CardContent>
                  <Grid container direction="column" alignItems="stretch" justifyContent="flex-start" spacing={2}>
                    <Grid item xs={12} sm={12}>
                      <TextField
                        required={true}
                        name="title"
                        id="TextInputedemokraciaServiceUserEdemokraciaServiceUserVoteDefinitionActiveVoteDefinitionsInResidentCityViewDefaultVoteDefinitionViewEditGroupTitle"
                    ...
                    <Grid item xs={12} sm={12}>
                      <DateTimePicker
                        ...
                        slotProps={{
                          textField: {
                            id: 'DateTimeInputedemokraciaServiceUserEdemokraciaServiceUserVoteDefinitionActiveVoteDefinitionsInResidentCityViewDefaultVoteDefinitionViewEditGroupCloseAt',
                            required: true,
                    ...
                    <Grid item xs={12} sm={12}>
                      <TextField
                        required={true}
                        name="status"
                        id="EnumerationComboedemokraciaServiceUserEdemokraciaServiceUserVoteDefinitionActiveVoteDefinitionsInResidentCityViewDefaultVoteDefinitionViewEditGroupStatus"
                    ...
                    <Grid item xs={12} sm={12}>
                      <AssociationButton
                        id="NavigationToPageActionedemokraciaServiceUserEdemokraciaServiceUserVoteDefinitionActiveVoteDefinitionsInResidentCityViewEdemokraciaServiceUserEdemokraciaServiceVoteDefinitionDebateButtonNavigate"
                        variant={undefined}
                        editMode={editMode}
                    ...
                    <Grid item xs={12} sm={12}>
                      <AssociationButton
                        id="NavigationToPageActionedemokraciaServiceUserEdemokraciaServiceUserVoteDefinitionActiveVoteDefinitionsInResidentCityViewEdemokraciaServiceUserEdemokraciaServiceVoteDefinitionIssueButtonNavigate"
                        variant={undefined}
                        editMode={editMode}
                    ...
                    <Grid item xs={12} sm={12}>
                      <DateTimePicker
                        ...
                        slotProps={{
                          textField: {
                            id: 'DateTimeInputedemokraciaServiceUserEdemokraciaServiceUserVoteDefinitionActiveVoteDefinitionsInResidentCityViewDefaultVoteDefinitionViewEditGroupCreated',
                            required: true,
                    ...
                    <Grid item xs={12} sm={12}>
                      <TextField
                        required={true}
                        name="description"
                        id="TextAreaedemokraciaServiceUserEdemokraciaServiceUserVoteDefinitionActiveVoteDefinitionsInResidentCityViewDefaultVoteDefinitionViewEditGroupDescription"
            ...
            <Grid container item xs={12} sm={12}>
              <ModeledTabs
                id="TabControlleredemokraciaServiceUserEdemokraciaServiceUserVoteDefinitionActiveVoteDefinitionsInResidentCityViewDefaultVoteDefinitionViewEditTabBar"
                ownerData={data}
                validation={validation}
                orientation='horizontal'
                childTabs={[
                  {
                    id: 'TabedemokraciaServiceUserEdemokraciaServiceUserVoteDefinitionActiveVoteDefinitionsInResidentCityViewDefaultVoteDefinitionViewEditTabBarYesnovote',
                  ...
                  {
                    id: 'TabedemokraciaServiceUserEdemokraciaServiceUserVoteDefinitionActiveVoteDefinitionsInResidentCityViewDefaultVoteDefinitionViewEditTabBarYesnoabstainvote',
                  ...
                  {
                    id: 'TabedemokraciaServiceUserEdemokraciaServiceUserVoteDefinitionActiveVoteDefinitionsInResidentCityViewDefaultVoteDefinitionViewEditTabBarSelectanswervote',
                  ...
                  {
                    id: 'TabedemokraciaServiceUserEdemokraciaServiceUserVoteDefinitionActiveVoteDefinitionsInResidentCityViewDefaultVoteDefinitionViewEditTabBarRatingvote',
              ...
              >
                {!data.isNotYesNoType && (
                  <Grid item xs={12} sm={12}>
                    <Grid
                      id="FlexedemokraciaServiceUserEdemokraciaServiceUserVoteDefinitionActiveVoteDefinitionsInResidentCityViewDefaultVoteDefinitionViewEditTabBarYesnovoteYesnovote"
                      container
                      direction="row"
                    ...
                    >
                      {!data.isNotYesNoType && (
                        <Grid item xs={12} sm={12} md={4.0}>
                          <LoadingButton
                            id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceUserVoteDefinitionActiveVoteDefinitionsInResidentCityViewEdemokraciaServiceUserEdemokraciaServiceVoteDefinitionVoteYesNoButtonCallOperation"
                            loading={isLoading}
                            variant={undefined}
                ...
                {!data.isNotYesNoAbstainType && (
                  <Grid item xs={12} sm={12}>
                    <Grid
                      id="FlexedemokraciaServiceUserEdemokraciaServiceUserVoteDefinitionActiveVoteDefinitionsInResidentCityViewDefaultVoteDefinitionViewEditTabBarYesnoabstainvoteYesnoabstainvote"
                      container
                      direction="row"
                      alignItems="flex-start"
                      justifyContent="flex-start"
                    ...
                    >
                      {!data.isNotYesNoAbstainType && (
                        <Grid item xs={12} sm={12} md={4.0}>
                          <LoadingButton
                            id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceUserVoteDefinitionActiveVoteDefinitionsInResidentCityViewEdemokraciaServiceUserEdemokraciaServiceVoteDefinitionVoteYesNoAbstainButtonCallOperation"
                            loading={isLoading}
                            variant={undefined}
                            startIcon={<MdiIcon path="vote" />}
                            loadingPosition="start"
                ...
                {!data.isNotSelectAnswerType && (
                  <Grid item xs={12} sm={12}>
                    <Grid
                      id="FlexedemokraciaServiceUserEdemokraciaServiceUserVoteDefinitionActiveVoteDefinitionsInResidentCityViewDefaultVoteDefinitionViewEditTabBarSelectanswervoteSelectanswervote"
                      container
                      direction="row"
                      alignItems="flex-start"
                      justifyContent="flex-start"
                    ...
                    >
                      {!data.isNotSelectAnswerType && (
                        <Grid item xs={12} sm={12} md={4.0}>
                          <LoadingButton
                            id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceUserVoteDefinitionActiveVoteDefinitionsInResidentCityViewEdemokraciaServiceUserEdemokraciaServiceVoteDefinitionVoteSelectAnswerButtonCallOperation"
                            loading={isLoading}
                            variant={undefined}
                            startIcon={<MdiIcon path="vote" />}
                            loadingPosition="start"
                ...
                {!data.isNotRatingType && (
                  <Grid item xs={12} sm={12}>
                    <Grid
                      id="FlexedemokraciaServiceUserEdemokraciaServiceUserVoteDefinitionActiveVoteDefinitionsInResidentCityViewDefaultVoteDefinitionViewEditTabBarRatingvoteRatingvote"
                      container
                      direction="row"
                      alignItems="flex-start"
                      justifyContent="flex-start"
                    ...
                    >
                      {!data.isNotRatingType && (
                        <Grid item xs={12} sm={12} md={4.0}>
                          <LoadingButton
                            id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceUserVoteDefinitionActiveVoteDefinitionsInResidentCityViewEdemokraciaServiceUserEdemokraciaServiceVoteDefinitionVoteRatingButtonCallOperation"
                            loading={isLoading}
                            variant={undefined}
                            startIcon={<MdiIcon path="vote" />}
                            loadingPosition="start"
