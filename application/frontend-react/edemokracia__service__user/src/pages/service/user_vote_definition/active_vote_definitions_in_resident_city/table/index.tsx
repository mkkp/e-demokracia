...
// Page name: edemokracia::service::UserVoteDefinition.activeVoteDefinitionsInResidentCity#Table
...
/**
 * Name: edemokracia::service::UserVoteDefinition.activeVoteDefinitionsInResidentCity#Table
 * Is Access: false
 * Type: Table
 **/
export default function ServiceUserVoteDefinitionActiveVoteDefinitionsInResidentCityTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaServiceUserEdemokraciaServiceUserVoteDefinitionActiveVoteDefinitionsInResidentCityTable-data-grid">
