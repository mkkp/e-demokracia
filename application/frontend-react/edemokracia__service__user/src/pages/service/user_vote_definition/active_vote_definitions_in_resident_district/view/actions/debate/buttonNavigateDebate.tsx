...
import { routeToServiceVoteDefinitionDebateView } from '~/routes';
...
export const useButtonNavigateDebateAction: ButtonNavigateDebateAction = () => {
  ...
  return async function (owner: JudoIdentifiable<ServiceVoteDefinition>, target: JudoIdentifiable<ServiceDebate>) {
    navigate(routeToServiceVoteDefinitionDebateView(target.__signedIdentifier));
  };
};
