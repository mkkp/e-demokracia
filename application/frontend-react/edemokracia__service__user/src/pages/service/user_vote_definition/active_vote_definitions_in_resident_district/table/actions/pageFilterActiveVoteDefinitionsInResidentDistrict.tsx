...
export type PageFilterActiveVoteDefinitionsInResidentDistrictAction = (
  id: string,
  filterOptions: FilterOption[],
  filters: Filter[],
) => Promise<void>;

export const usePageFilterActiveVoteDefinitionsInResidentDistrictAction = (
  ...
  return async function pageFilterActiveVoteDefinitionsInResidentDistrictAction(
    id: string,
    filterOptions: FilterOption[],
    filters: Filter[],
  ) {
