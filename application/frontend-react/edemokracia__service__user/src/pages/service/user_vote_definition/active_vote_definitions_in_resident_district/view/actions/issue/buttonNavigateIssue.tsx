...
import { routeToServiceVoteDefinitionIssueView } from '~/routes';
...
export const useButtonNavigateIssueAction: ButtonNavigateIssueAction = () => {
  ...
  return async function (owner: JudoIdentifiable<ServiceVoteDefinition>, target: JudoIdentifiable<ServiceIssue>) {
    navigate(routeToServiceVoteDefinitionIssueView(target.__signedIdentifier));
  };
};
