...
// Page name: edemokracia::service::UserVoteDefinition.activeVoteDefinitionsInResidentDistrict#Table
...
/**
 * Name: edemokracia::service::UserVoteDefinition.activeVoteDefinitionsInResidentDistrict#Table
 * Is Access: false
 * Type: Table
 **/
export default function ServiceUserVoteDefinitionActiveVoteDefinitionsInResidentDistrictTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaServiceUserEdemokraciaServiceUserVoteDefinitionActiveVoteDefinitionsInResidentDistrictTable-data-grid">
