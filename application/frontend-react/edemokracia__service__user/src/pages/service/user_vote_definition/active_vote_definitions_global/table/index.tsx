...
// Page name: edemokracia::service::UserVoteDefinition.activeVoteDefinitionsGlobal#Table
...
/**
 * Name: edemokracia::service::UserVoteDefinition.activeVoteDefinitionsGlobal#Table
 * Is Access: false
 * Type: Table
 **/
export default function ServiceUserVoteDefinitionActiveVoteDefinitionsGlobalTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaServiceUserEdemokraciaServiceUserVoteDefinitionActiveVoteDefinitionsGlobalTable-data-grid">
