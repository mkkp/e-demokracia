...
export type PageFilterActiveVoteDefinitionsInActivityDistrictsAction = (
  id: string,
  filterOptions: FilterOption[],
  filters: Filter[],
) => Promise<void>;

export const usePageFilterActiveVoteDefinitionsInActivityDistrictsAction = (
  ...
  return async function pageFilterActiveVoteDefinitionsInActivityDistrictsAction(
    id: string,
    filterOptions: FilterOption[],
    filters: Filter[],
  ) {
