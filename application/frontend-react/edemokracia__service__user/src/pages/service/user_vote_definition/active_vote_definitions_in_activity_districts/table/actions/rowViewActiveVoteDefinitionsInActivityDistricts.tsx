...
import { routeToServiceUserVoteDefinitionActiveVoteDefinitionsInActivityDistrictsView } from '~/routes';
...
export const useRowViewActiveVoteDefinitionsInActivityDistrictsAction: RowViewActiveVoteDefinitionsInActivityDistrictsAction =
  () => {
    ...
    return async function (
      ...
      closeAllDialogs();
      navigate(routeToServiceUserVoteDefinitionActiveVoteDefinitionsInActivityDistrictsView(entry.__signedIdentifier));
    };
  };
