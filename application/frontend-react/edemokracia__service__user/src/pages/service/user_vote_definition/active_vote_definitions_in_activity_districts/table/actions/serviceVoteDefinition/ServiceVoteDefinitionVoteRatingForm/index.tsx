...
import { ratingVoteInputServiceForClassImpl, serviceVoteDefinitionServiceForClassImpl } from '~/generated/data-axios';

export interface ServiceVoteDefinitionVoteRatingFormProps {
  successCallback: () => void;
  cancel: () => void;
  owner: ServiceVoteDefinitionStored;
}

export default function ServiceVoteDefinitionVoteRatingForm({
  successCallback,
  cancel,
  owner,
}: ServiceVoteDefinitionVoteRatingFormProps) {
  ...
  const handleActionError = useErrorHandler<RatingVoteInput>(
    `(&(${OBJECTCLASS}=${ERROR_PROCESSOR_HOOK_INTERFACE_KEY})(operation=CallOperation)(component=ServiceVoteDefinitionVoteRatingForm))`,
  );
  ...
  const submit = async () => {
    ...
    try {
      await serviceVoteDefinitionServiceForClassImpl.voteRating(owner, payloadDiff);
  ...
  return (
    <>
      <DialogTitle>
        {title}
        <IconButton
          id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceUserVoteDefinitionActiveVoteDefinitionsInActivityDistrictsTableEdemokraciaServiceUserEdemokraciaServiceVoteDefinitionVoteRatingButtonCallOperation-dialog-close"
          aria-label="close"
          onClick={() => cancel()}
          sx={{
            position: 'absolute',
        ...
        <Grid container spacing={2} direction="column" alignItems="stretch" justifyContent="flex-start">
          <Grid item xs={12} sm={12}>
            <NumericInput
              required={false}
              name="value"
              id="NumericInputedemokraciaServiceUserEdemokraciaServiceVoteDefinitionVoteRatingInputDefaultRatingVoteInputFormValue"
              autoFocus
      ...
      <DialogActions>
        <Button
          id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceUserVoteDefinitionActiveVoteDefinitionsInActivityDistrictsTableEdemokraciaServiceUserEdemokraciaServiceVoteDefinitionVoteRatingButtonCallOperation-action-form-action-cancel"
          variant="text"
          onClick={() => cancel()}
          disabled={isLoading}
        ...
        <LoadingButton
          ...
          id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceUserVoteDefinitionActiveVoteDefinitionsInActivityDistrictsTableEdemokraciaServiceUserEdemokraciaServiceVoteDefinitionVoteRatingButtonCallOperation-action-form-action-submit"
          variant="contained"
          onClick={() => submit()}
