...
// Page name: edemokracia::service::UserVoteDefinition.activeVoteDefinitionsInActivityDistricts#Table
...
/**
 * Name: edemokracia::service::UserVoteDefinition.activeVoteDefinitionsInActivityDistricts#Table
 * Is Access: false
 * Type: Table
 **/
export default function ServiceUserVoteDefinitionActiveVoteDefinitionsInActivityDistrictsTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaServiceUserEdemokraciaServiceUserVoteDefinitionActiveVoteDefinitionsInActivityDistrictsTable-data-grid">
