...
import { routeToServiceUserVoteDefinitionOwnedVoteDefinitionsView } from '~/routes';
...
export const useRowViewOwnedVoteDefinitionsAction: RowViewOwnedVoteDefinitionsAction = () => {
  ...
  return async function (
    ...
    closeAllDialogs();
    navigate(routeToServiceUserVoteDefinitionOwnedVoteDefinitionsView(entry.__signedIdentifier));
  };
};
