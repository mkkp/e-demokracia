...
// Page name: edemokracia::service::UserVoteDefinition.ownedVoteDefinitions#Table
...
/**
 * Name: edemokracia::service::UserVoteDefinition.ownedVoteDefinitions#Table
 * Is Access: false
 * Type: Table
 **/
export default function ServiceUserVoteDefinitionOwnedVoteDefinitionsTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaServiceUserEdemokraciaServiceUserVoteDefinitionOwnedVoteDefinitionsTable-data-grid">
