...
// Page name: edemokracia::service::UserVoteDefinition.activeVoteDefinitionsInResidentCounty#Table
...
/**
 * Name: edemokracia::service::UserVoteDefinition.activeVoteDefinitionsInResidentCounty#Table
 * Is Access: false
 * Type: Table
 **/
export default function ServiceUserVoteDefinitionActiveVoteDefinitionsInResidentCountyTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaServiceUserEdemokraciaServiceUserVoteDefinitionActiveVoteDefinitionsInResidentCountyTable-data-grid">
