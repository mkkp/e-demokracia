...
export type PageFilterActiveVoteDefinitionsInResidentCountyAction = (
  id: string,
  filterOptions: FilterOption[],
  filters: Filter[],
) => Promise<void>;

export const usePageFilterActiveVoteDefinitionsInResidentCountyAction = (
  ...
  return async function pageFilterActiveVoteDefinitionsInResidentCountyAction(
    id: string,
    filterOptions: FilterOption[],
    filters: Filter[],
  ) {
