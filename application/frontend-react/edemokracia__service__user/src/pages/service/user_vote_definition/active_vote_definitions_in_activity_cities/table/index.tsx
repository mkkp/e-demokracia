...
// Page name: edemokracia::service::UserVoteDefinition.activeVoteDefinitionsInActivityCities#Table
...
/**
 * Name: edemokracia::service::UserVoteDefinition.activeVoteDefinitionsInActivityCities#Table
 * Is Access: false
 * Type: Table
 **/
export default function ServiceUserVoteDefinitionActiveVoteDefinitionsInActivityCitiesTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaServiceUserEdemokraciaServiceUserVoteDefinitionActiveVoteDefinitionsInActivityCitiesTable-data-grid">
