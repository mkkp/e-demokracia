...
export function ResidentCountyLink(props: ResidentCountyLinkProps) {
  ...
  const residentCountyRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceConCreatedByViewDefaultServiceUserViewEditAreasLabelWrapperAreasResidencyResidentCountyRepresentationFilter',
  ...
  return (
    <AggregationInput
      name="residentCounty"
      id="LinkedemokraciaServiceUserEdemokraciaServiceConCreatedByViewDefaultServiceUserViewEditAreasLabelWrapperAreasResidencyResidentCounty"
