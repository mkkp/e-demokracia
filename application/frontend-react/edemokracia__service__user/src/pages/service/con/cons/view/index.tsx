    ...
    <>
      ...
      <DialogContent dividers>
        <Grid container spacing={2} direction="column" alignItems="stretch" justifyContent="flex-start">
          ...
          <Grid item xs={12} sm={12}>
            <Grid
              id="FlexedemokraciaServiceUserEdemokraciaServiceConConsViewDefaultConViewEditArguments"
              container
              direction="row"
            ...
            >
              <Grid item xs={12} sm={12} md={6.0}>
                <Card id="FlexedemokraciaServiceUserEdemokraciaServiceConConsViewDefaultConViewEditArgumentsProsLabelWrapper">
                  <CardContent>
                    <Grid container direction="column" alignItems="stretch" justifyContent="flex-start" spacing={2}>
                      <Grid item xs={12} sm={12}>
                        <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                          ...
                          <Typography
                            id="LabeledemokraciaServiceUserEdemokraciaServiceConConsViewDefaultConViewEditArgumentsProsLabelWrapperProsLabel"
                            variant="h5"
                            component="h1"
                          >
                      ...
                      <Grid item xs={12} sm={12}>
                        <Grid
                          id="FlexedemokraciaServiceUserEdemokraciaServiceConConsViewDefaultConViewEditArgumentsProsLabelWrapperPros"
                          container
                          direction="row"
                          alignItems="stretch"
                          justifyContent="flex-start"
                        ...
                        >
                          <Grid item xs={12} sm={12}>
                            <Grid
                              id="FlexedemokraciaServiceUserEdemokraciaServiceConConsViewDefaultConViewEditArgumentsProsLabelWrapperProsActions"
                              container
                              direction="row"
                              alignItems="flex-start"
                              justifyContent="flex-start"
                            ...
                            >
                              <Grid item xs={12} sm={12}>
                                <LoadingButton
                                  id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceConConsViewEdemokraciaServiceUserEdemokraciaServiceConCreateProArgumentButtonCallOperation"
                                  loading={isLoading}
                                  variant={undefined}
                                  ...
                                  onClick={async () => {
                                    try {
                                      setIsLoading(true);
                                      await createProArgumentAction(data, () => fetchData());
                                    } finally {
                                      setIsLoading(false);
                                    }
                                  }}
                          ...
                          <Grid item xs={12} sm={12}>
                            <Grid
                              id="FlexedemokraciaServiceUserEdemokraciaServiceConConsViewDefaultConViewEditArgumentsProsLabelWrapperProsTable"
                              container
                              direction="row"
                              alignItems="flex-start"
                              justifyContent="flex-start"
                            ...
                            >
                              <Grid item xs={12} sm={12}>
                                <Grid
                                  id="FlexedemokraciaServiceUserEdemokraciaServiceConConsViewDefaultConViewEditArgumentsProsLabelWrapperProsTableProsLabelWrapper"
                                  container
                                  direction="column"
                                  alignItems="stretch"
                                  justifyContent="flex-start"
                                ...
                                >
                                  <Grid item xs={12} sm={12}>
                                    <Grid
                                      id="TableedemokraciaServiceUserEdemokraciaServiceConConsViewDefaultConViewEditArgumentsProsLabelWrapperProsTableProsLabelWrapperPros"
                                      container
                                      direction="column"
                                      alignItems="stretch"
                                      justifyContent="flex-start"
              ...
              <Grid item xs={12} sm={12} md={6.0}>
                <Card id="FlexedemokraciaServiceUserEdemokraciaServiceConConsViewDefaultConViewEditArgumentsConsLabelWrapper">
                  <CardContent>
                    <Grid container direction="column" alignItems="stretch" justifyContent="flex-start" spacing={2}>
                      <Grid item xs={12} sm={12}>
                        <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                          <MdiIcon path="chat-minus" sx={{ marginRight: 1 }} />
                          <Typography
                            id="LabeledemokraciaServiceUserEdemokraciaServiceConConsViewDefaultConViewEditArgumentsConsLabelWrapperConsLabel"
                            variant="h5"
                            component="h1"
                          >
                      ...
                      <Grid item xs={12} sm={12}>
                        <Grid
                          id="FlexedemokraciaServiceUserEdemokraciaServiceConConsViewDefaultConViewEditArgumentsConsLabelWrapperCons"
                          container
                          direction="row"
                          alignItems="stretch"
                          justifyContent="flex-start"
                        ...
                        >
                          <Grid item xs={12} sm={12}>
                            <Grid
                              id="FlexedemokraciaServiceUserEdemokraciaServiceConConsViewDefaultConViewEditArgumentsConsLabelWrapperConsActions"
                              container
                              direction="row"
                              alignItems="flex-start"
                              justifyContent="flex-start"
                            ...
                            >
                              <Grid item xs={12} sm={12}>
                                <LoadingButton
                                  id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceConConsViewEdemokraciaServiceUserEdemokraciaServiceConCreateConArgumentButtonCallOperation"
                                  loading={isLoading}
                                  variant={undefined}
                                  ...
                                  onClick={async () => {
                                    try {
                                      setIsLoading(true);
                                      await createConArgumentAction(data, () => fetchData());
                                    } finally {
                                      setIsLoading(false);
                                    }
                                  }}
                          ...
                          <Grid item xs={12} sm={12}>
                            <Grid
                              id="FlexedemokraciaServiceUserEdemokraciaServiceConConsViewDefaultConViewEditArgumentsConsLabelWrapperConsTable"
                              container
                              direction="row"
                              alignItems="flex-start"
                              justifyContent="flex-start"
                            ...
                            >
                              <Grid item xs={12} sm={12}>
                                <Grid
                                  id="FlexedemokraciaServiceUserEdemokraciaServiceConConsViewDefaultConViewEditArgumentsConsLabelWrapperConsTableConsLabelWrapper"
                                  container
                                  direction="column"
                                  alignItems="stretch"
                                  justifyContent="flex-start"
                                ...
                                >
                                  <Grid item xs={12} sm={12}>
                                    <Grid
                                      id="TableedemokraciaServiceUserEdemokraciaServiceConConsViewDefaultConViewEditArgumentsConsLabelWrapperConsTableConsLabelWrapperCons"
                                      container
                                      direction="column"
                                      alignItems="stretch"
                                      justifyContent="flex-start"
