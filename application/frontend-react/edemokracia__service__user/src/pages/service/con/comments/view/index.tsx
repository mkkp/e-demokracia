...
// Page name: edemokracia::service::Con.comments#View
...
export type ServiceConCommentsViewPostRefreshAction = (
...
export const SERVICE_CON_COMMENTS_VIEW_POST_REFRESH_HOOK_INTERFACE_KEY = 'ServiceConCommentsViewPostRefreshHook';
export type ServiceConCommentsViewPostRefreshHook = () => ServiceConCommentsViewPostRefreshAction;

/**
 * Name: edemokracia::service::Con.comments#View
 * Is Access: false
 * Type: View
 * Edit Mode Available: false
 **/
export default function ServiceConCommentsView() {
  ...
  const { service: postRefreshHook } = useTrackService<ServiceConCommentsViewPostRefreshHook>(
    `(${OBJECTCLASS}=${SERVICE_CON_COMMENTS_VIEW_POST_REFRESH_HOOK_INTERFACE_KEY})`,
  );
  const postRefreshAction: ServiceConCommentsViewPostRefreshAction | undefined = postRefreshHook && postRefreshHook();
        ...
        <Box sx={mainContainerPadding}>
          ...
          >
            <Grid item xs={12} sm={12}>
              <Card id="FlexedemokraciaServiceUserEdemokraciaServiceConCommentsViewDefaultCommentViewEditGroupLabelWrapper">
                <CardContent>
                  <Grid container direction="column" alignItems="stretch" justifyContent="flex-start" spacing={2}>
                    <Grid item xs={12} sm={12}>
                      <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                        ...
                        <Typography
                          id="LabeledemokraciaServiceUserEdemokraciaServiceConCommentsViewDefaultCommentViewEditGroupLabelWrapperGroupLabel"
                          variant="h5"
                          component="h1"
                        >
                    ...
                    <Grid item xs={12} sm={12}>
                      <Grid
                        id="FlexedemokraciaServiceUserEdemokraciaServiceConCommentsViewDefaultCommentViewEditGroupLabelWrapperGroup"
                        container
                        direction="row"
                        alignItems="stretch"
                        justifyContent="flex-start"
                      ...
                      >
                        <Grid item xs={12} sm={12} md={4.0}>
                          <DateTimePicker
                            ...
                            slotProps={{
                              textField: {
                                id: 'DateTimeInputedemokraciaServiceUserEdemokraciaServiceConCommentsViewDefaultCommentViewEditGroupLabelWrapperGroupCreated',
                                required: false,
                        ...
                        <Grid item xs={12} sm={12}>
                          <TextField
                            required={true}
                            name="comment"
                            id="TextAreaedemokraciaServiceUserEdemokraciaServiceConCommentsViewDefaultCommentViewEditGroupLabelWrapperGroupComment"
                        ...
                        <Grid item xs={12} sm={12} md={1.0}>
                          <LoadingButton
                            id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceConCommentsViewEdemokraciaServiceUserEdemokraciaServiceCommentVoteUpButtonCallOperation"
                            loading={isLoading}
                            variant={undefined}
                        ...
                        <Grid item xs={12} sm={12} md={1.0}>
                          <NumericInput
                            required={false}
                            name="upVotes"
                            id="NumericInputedemokraciaServiceUserEdemokraciaServiceConCommentsViewDefaultCommentViewEditGroupLabelWrapperGroupUpVotes"
                        ...
                        <Grid item xs={12} sm={12} md={1.0}>
                          <LoadingButton
                            id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceConCommentsViewEdemokraciaServiceUserEdemokraciaServiceCommentVoteDownButtonCallOperation"
                            loading={isLoading}
                            variant={undefined}
                        ...
                        <Grid item xs={12} sm={12} md={1.0}>
                          <NumericInput
                            required={false}
                            name="downVotes"
                            id="NumericInputedemokraciaServiceUserEdemokraciaServiceConCommentsViewDefaultCommentViewEditGroupLabelWrapperGroupDownVotes"
                        ...
                        <Grid item xs={12} sm={12} md={2.0}>
                          <CollectionAssociationButton
                            id="NavigationToPageActionedemokraciaServiceUserEdemokraciaServiceConCommentsViewEdemokraciaServiceUserEdemokraciaServiceCommentVotesButtonNavigate"
                            variant={undefined}
                            editMode={editMode}
