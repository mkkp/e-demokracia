...
// Page name: edemokracia::service::Con.votes#Table
...
/**
 * Name: edemokracia::service::Con.votes#Table
 * Is Access: false
 * Type: Table
 **/
export default function ServiceConVotesTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaServiceUserEdemokraciaServiceConVotesTable-data-grid">
