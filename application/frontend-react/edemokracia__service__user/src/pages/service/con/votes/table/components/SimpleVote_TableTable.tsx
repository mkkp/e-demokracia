...
export const SERVICE_CON_VOTES_TABLE_SIMPLE_VOTE_TABLE = 'ServiceConVotesTableSimpleVote_Table';

export interface SimpleVote_TableTableProps {
  ownerData: JudoIdentifiable<ServiceCon>;
...
export const SimpleVote_TableTable = forwardRef<RefreshableTable, SimpleVote_TableTableProps>((props, ref) => {
  ...
  const filterModelKey = `TableedemokraciaServiceUserEdemokraciaServiceConVotesTableDefaultVotesSimpleVoteTable-${__identifier}-filterModel`;
  const filtersKey = `TableedemokraciaServiceUserEdemokraciaServiceConVotesTableDefaultVotesSimpleVoteTable-${__identifier}-filters`;
  ...
  useEffect(() => {
    setFilters(
      getItemParsedWithDefault(
        `TableedemokraciaServiceUserEdemokraciaServiceConVotesTableDefaultVotesSimpleVoteTable-${__identifier}-filters`,
        [...filters],
      ),
    );
  }, [ownerData]);
  ...
  const votesRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceConVotesTableDefaultVotesSimpleVoteTableCreatedFilter',
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceConVotesTableDefaultVotesSimpleVoteTableTypeFilter',
      attributeName: 'type',
  ...
  async function fetchData() {
    ...
    try {
      const res = await serviceConServiceForClassImpl.getVotes(ownerData, processQueryCustomizer(queryCustomizer));
  ...
  return (
    <>
      <StripedDataGrid
        ...
        columns={[
          ...votesColumns,
          ...columnsActionCalculator('RelationTypeedemokraciaServiceUserEdemokraciaServiceConVotes', rowActions, t, {
            shownActions: 2,
          }),
        ]}
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              <Button
                id="FilterActionedemokraciaServiceUserEdemokraciaServiceConVotesTableEdemokraciaServiceUserEdemokraciaServiceConVotesPageFilter"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() => {
                  pageFilterVotesAction(
                    'FilterActionedemokraciaServiceUserEdemokraciaServiceConVotesTableEdemokraciaServiceUserEdemokraciaServiceConVotesPageFilter-filter',
                    filterOptions,
                    filters,
                  );
                }}
