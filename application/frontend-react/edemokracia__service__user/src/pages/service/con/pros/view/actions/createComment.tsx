...
export const useCreateCommentAction: CreateCommentAction = () => {
  ...
  const title: string = t('service.ProView.cons.createComment.ButtonCallOperation', { defaultValue: 'Add comment' });
  ...
  return async function createCommentAction(owner: ServiceConStored, successCallback: () => void) {
    createDialog({
      fullWidth: true,
      maxWidth: 'md',
