...
import { createArgumentInputServiceForClassImpl, serviceProServiceForClassImpl } from '~/generated/data-axios';

export interface ServiceProCreateSubArgumentFormProps {
  successCallback: () => void;
  cancel: () => void;
  owner: ServiceProStored;
}

export default function ServiceProCreateSubArgumentForm({
  successCallback,
  cancel,
  owner,
}: ServiceProCreateSubArgumentFormProps) {
  ...
  const handleActionError = useErrorHandler<CreateArgumentInput>(
    `(&(${OBJECTCLASS}=${ERROR_PROCESSOR_HOOK_INTERFACE_KEY})(operation=CallOperation)(component=ServiceProCreateSubArgumentForm))`,
  );
  ...
  const submit = async () => {
    ...
    try {
      await serviceProServiceForClassImpl.createSubArgument(owner, payloadDiff);
  ...
  return (
    <>
      <DialogTitle>
        {title}
        <IconButton
          id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceUserDebatesActiveDebatesInActivityDistrictsViewEdemokraciaServiceUserEdemokraciaServiceProCreateSubArgumentButtonCallOperation-dialog-close"
          aria-label="close"
          onClick={() => cancel()}
          sx={{
            position: 'absolute',
      ...
      <DialogContent dividers>
        <Grid container spacing={2} direction="column" alignItems="stretch" justifyContent="flex-start">
          <Grid item xs={12} sm={12}>
            <Card id="FlexedemokraciaServiceUserEdemokraciaServiceProCreateSubArgumentInputDefaultCreateArgumentInputFormGroupLabelWrapper">
              <CardContent>
                <Grid container direction="column" alignItems="stretch" justifyContent="flex-start" spacing={2}>
                  <Grid item xs={12} sm={12}>
                    <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                      ...
                      <Typography
                        id="LabeledemokraciaServiceUserEdemokraciaServiceProCreateSubArgumentInputDefaultCreateArgumentInputFormGroupLabelWrapperGroupLabel"
                        variant="h5"
                        component="h1"
                      >
                  ...
                  <Grid item xs={12} sm={12}>
                    <Grid
                      id="FlexedemokraciaServiceUserEdemokraciaServiceProCreateSubArgumentInputDefaultCreateArgumentInputFormGroupLabelWrapperGroup"
                      container
                      direction="row"
                      alignItems="stretch"
                    ...
                    >
                      <Grid item xs={12} sm={12} md={8.0}>
                        <TextField
                          required={true}
                          name="title"
                          id="TextInputedemokraciaServiceUserEdemokraciaServiceProCreateSubArgumentInputDefaultCreateArgumentInputFormGroupLabelWrapperGroupTitle"
                          autoFocus
                      ...
                      <Grid item xs={12} sm={12} md={4.0}>
                        <TextField
                          required={true}
                          name="type"
                          id="EnumerationComboedemokraciaServiceUserEdemokraciaServiceProCreateSubArgumentInputDefaultCreateArgumentInputFormGroupLabelWrapperGroupType"
                      ...
                      <Grid item xs={12} sm={12}>
                        <TextField
                          required={true}
                          name="description"
                          id="TextAreaedemokraciaServiceUserEdemokraciaServiceProCreateSubArgumentInputDefaultCreateArgumentInputFormGroupLabelWrapperGroupDescription"
          ...
          <Grid item xs={12} sm={12}>
            <Grid
              id="FlexedemokraciaServiceUserEdemokraciaServiceProCreateSubArgumentInputDefaultCreateArgumentInputFormButtons"
              container
              direction="row"
      ...
      <DialogActions>
        <Button
          id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceUserDebatesActiveDebatesInActivityDistrictsViewEdemokraciaServiceUserEdemokraciaServiceProCreateSubArgumentButtonCallOperation-action-form-action-cancel"
          variant="text"
          onClick={() => cancel()}
          disabled={isLoading}
        ...
        <LoadingButton
          ...
          id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceUserDebatesActiveDebatesInActivityDistrictsViewEdemokraciaServiceUserEdemokraciaServiceProCreateSubArgumentButtonCallOperation-action-form-action-submit"
          variant="contained"
          onClick={() => submit()}
