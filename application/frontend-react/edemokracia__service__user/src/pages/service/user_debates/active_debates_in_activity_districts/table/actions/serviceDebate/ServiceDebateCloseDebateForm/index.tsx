...
import { closeDebateInputServiceForClassImpl, serviceDebateServiceForClassImpl } from '~/generated/data-axios';

export interface ServiceDebateCloseDebateFormProps {
  successCallback: (result?: CloseDebateOutputVoteDefinitionReferenceStored) => void;
  cancel: () => void;
  owner: ServiceDebateStored;
}

export default function ServiceDebateCloseDebateForm({
  successCallback,
  cancel,
  owner,
}: ServiceDebateCloseDebateFormProps) {
  ...
  const handleActionError = useErrorHandler<CloseDebateInput>(
    `(&(${OBJECTCLASS}=${ERROR_PROCESSOR_HOOK_INTERFACE_KEY})(operation=CallOperation)(component=ServiceDebateCloseDebateForm))`,
  );
  ...
  const submit = async () => {
    ...
    try {
      const res = await serviceDebateServiceForClassImpl.closeDebate(owner, payloadDiff);
  ...
  return (
    <>
      <DialogTitle>
        {title}
        <IconButton
          id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceUserDebatesActiveDebatesInActivityDistrictsTableEdemokraciaServiceUserEdemokraciaServiceDebateCloseDebateButtonCallOperation-dialog-close"
          aria-label="close"
          onClick={() => cancel()}
          sx={{
            position: 'absolute',
      ...
      <DialogContent dividers>
        <Grid container spacing={2} direction="column" alignItems="stretch" justifyContent="flex-start">
          <Grid item xs={12} sm={12}>
            <Card id="FlexedemokraciaServiceUserEdemokraciaServiceDebateCloseDebateInputDefaultCloseDebateInputFormDebateLabelWrapper">
              <CardContent>
                <Grid container direction="column" alignItems="stretch" justifyContent="flex-start" spacing={2}>
                  <Grid item xs={12} sm={12}>
                    <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                      ...
                      <Typography
                        id="LabeledemokraciaServiceUserEdemokraciaServiceDebateCloseDebateInputDefaultCloseDebateInputFormDebateLabelWrapperDebateLabel"
                        variant="h5"
                        component="h1"
                      >
                  ...
                  <Grid item xs={12} sm={12}>
                    <Grid
                      id="FlexedemokraciaServiceUserEdemokraciaServiceDebateCloseDebateInputDefaultCloseDebateInputFormDebateLabelWrapperDebate"
                      container
                      direction="row"
                      alignItems="stretch"
                    ...
                    >
                      <Grid item xs={12} sm={12} md={4.0}>
                        <TextField
                          required={true}
                          name="voteType"
                          id="EnumerationComboedemokraciaServiceUserEdemokraciaServiceDebateCloseDebateInputDefaultCloseDebateInputFormDebateLabelWrapperDebateVoteType"
                          autoFocus
                      ...
                      <Grid item xs={12} sm={12} md={4.0}>
                        <DateTimePicker
                          ...
                          slotProps={{
                            textField: {
                              id: 'DateTimeInputedemokraciaServiceUserEdemokraciaServiceDebateCloseDebateInputDefaultCloseDebateInputFormDebateLabelWrapperDebateCloseAt',
                              required: true,
                      ...
                      <Grid item xs={12} sm={12}>
                        <TextField
                          required={true}
                          name="title"
                          id="TextInputedemokraciaServiceUserEdemokraciaServiceDebateCloseDebateInputDefaultCloseDebateInputFormDebateLabelWrapperDebateTitle"
                      ...
                      <Grid item xs={12} sm={12}>
                        <TextField
                          required={true}
                          name="description"
                          id="TextAreaedemokraciaServiceUserEdemokraciaServiceDebateCloseDebateInputDefaultCloseDebateInputFormDebateLabelWrapperDebateDescription"
      ...
      <DialogActions>
        <Button
          id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceUserDebatesActiveDebatesInActivityDistrictsTableEdemokraciaServiceUserEdemokraciaServiceDebateCloseDebateButtonCallOperation-action-form-action-cancel"
          variant="text"
          onClick={() => cancel()}
          disabled={isLoading}
        ...
        <LoadingButton
          ...
          id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceUserDebatesActiveDebatesInActivityDistrictsTableEdemokraciaServiceUserEdemokraciaServiceDebateCloseDebateButtonCallOperation-action-form-action-submit"
          variant="contained"
          onClick={() => submit()}
