...
import { createCommentInputServiceForClassImpl, serviceProServiceForClassImpl } from '~/generated/data-axios';

export interface ServiceProCreateCommentFormProps {
  successCallback: () => void;
  cancel: () => void;
  owner: ServiceProStored;
}

export default function ServiceProCreateCommentForm({
  successCallback,
  cancel,
  owner,
}: ServiceProCreateCommentFormProps) {
  ...
  const handleActionError = useErrorHandler<CreateCommentInput>(
    `(&(${OBJECTCLASS}=${ERROR_PROCESSOR_HOOK_INTERFACE_KEY})(operation=CallOperation)(component=ServiceProCreateCommentForm))`,
  );
  ...
  const submit = async () => {
    ...
    try {
      await serviceProServiceForClassImpl.createComment(owner, payloadDiff);
  ...
  return (
    <>
      <DialogTitle>
        {title}
        <IconButton
          id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceUserDebatesActiveDebatesInActivityDistrictsViewEdemokraciaServiceUserEdemokraciaServiceProCreateCommentButtonCallOperation-dialog-close"
          aria-label="close"
          onClick={() => cancel()}
          sx={{
            position: 'absolute',
      ...
      <DialogContent dividers>
        <Grid container spacing={2} direction="column" alignItems="stretch" justifyContent="flex-start">
          <Grid item xs={12} sm={12}>
            <Grid
              id="FlexedemokraciaServiceUserEdemokraciaServiceProCreateCommentInputDefaultCreateCommentInputFormComment"
              container
              direction="row"
            ...
            >
              <Grid item xs={12} sm={12}>
                <TextField
                  required={true}
                  name="comment"
                  id="TextAreaedemokraciaServiceUserEdemokraciaServiceProCreateCommentInputDefaultCreateCommentInputFormCommentComment"
                  autoFocus
          ...
          <Grid item xs={12} sm={12}>
            <Grid
              id="FlexedemokraciaServiceUserEdemokraciaServiceProCreateCommentInputDefaultCreateCommentInputFormButtons"
              container
              direction="row"
              alignItems="flex-start"
              justifyContent="flex-start"
      ...
      <DialogActions>
        <Button
          id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceUserDebatesActiveDebatesInActivityDistrictsViewEdemokraciaServiceUserEdemokraciaServiceProCreateCommentButtonCallOperation-action-form-action-cancel"
          variant="text"
          onClick={() => cancel()}
          disabled={isLoading}
        ...
        <LoadingButton
          ...
          id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceUserDebatesActiveDebatesInActivityDistrictsViewEdemokraciaServiceUserEdemokraciaServiceProCreateCommentButtonCallOperation-action-form-action-submit"
          variant="contained"
          onClick={() => submit()}
