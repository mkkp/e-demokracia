...
import { createArgumentInputServiceForClassImpl, serviceConServiceForClassImpl } from '~/generated/data-axios';

export interface ServiceConCreateSubArgumentFormProps {
  successCallback: () => void;
  cancel: () => void;
  owner: ServiceConStored;
}

export default function ServiceConCreateSubArgumentForm({
  successCallback,
  cancel,
  owner,
}: ServiceConCreateSubArgumentFormProps) {
  ...
  const handleActionError = useErrorHandler<CreateArgumentInput>(
    `(&(${OBJECTCLASS}=${ERROR_PROCESSOR_HOOK_INTERFACE_KEY})(operation=CallOperation)(component=ServiceConCreateSubArgumentForm))`,
  );
  ...
  const submit = async () => {
    ...
    try {
      await serviceConServiceForClassImpl.createSubArgument(owner, payloadDiff);
  ...
  return (
    <>
      <DialogTitle>
        {title}
        <IconButton
          id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceUserDebatesActiveDebatesInActivityDistrictsViewEdemokraciaServiceUserEdemokraciaServiceConCreateSubArgumentButtonCallOperation-dialog-close"
          aria-label="close"
          onClick={() => cancel()}
          sx={{
            position: 'absolute',
      ...
      <DialogContent dividers>
        <Grid container spacing={2} direction="column" alignItems="stretch" justifyContent="flex-start">
          <Grid item xs={12} sm={12}>
            <Card id="FlexedemokraciaServiceUserEdemokraciaServiceConCreateSubArgumentInputDefaultCreateArgumentInputFormGroupLabelWrapper">
              <CardContent>
                <Grid container direction="column" alignItems="stretch" justifyContent="flex-start" spacing={2}>
                  <Grid item xs={12} sm={12}>
                    <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                      ...
                      <Typography
                        id="LabeledemokraciaServiceUserEdemokraciaServiceConCreateSubArgumentInputDefaultCreateArgumentInputFormGroupLabelWrapperGroupLabel"
                        variant="h5"
                        component="h1"
                      >
                  ...
                  <Grid item xs={12} sm={12}>
                    <Grid
                      id="FlexedemokraciaServiceUserEdemokraciaServiceConCreateSubArgumentInputDefaultCreateArgumentInputFormGroupLabelWrapperGroup"
                      container
                      direction="row"
                      alignItems="stretch"
                    ...
                    >
                      <Grid item xs={12} sm={12} md={8.0}>
                        <TextField
                          required={true}
                          name="title"
                          id="TextInputedemokraciaServiceUserEdemokraciaServiceConCreateSubArgumentInputDefaultCreateArgumentInputFormGroupLabelWrapperGroupTitle"
                          autoFocus
                      ...
                      <Grid item xs={12} sm={12} md={4.0}>
                        <TextField
                          required={true}
                          name="type"
                          id="EnumerationComboedemokraciaServiceUserEdemokraciaServiceConCreateSubArgumentInputDefaultCreateArgumentInputFormGroupLabelWrapperGroupType"
                      ...
                      <Grid item xs={12} sm={12}>
                        <TextField
                          required={true}
                          name="description"
                          id="TextAreaedemokraciaServiceUserEdemokraciaServiceConCreateSubArgumentInputDefaultCreateArgumentInputFormGroupLabelWrapperGroupDescription"
          ...
          <Grid item xs={12} sm={12}>
            <Grid
              id="FlexedemokraciaServiceUserEdemokraciaServiceConCreateSubArgumentInputDefaultCreateArgumentInputFormButtons"
              container
              direction="row"
      ...
      <DialogActions>
        <Button
          id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceUserDebatesActiveDebatesInActivityDistrictsViewEdemokraciaServiceUserEdemokraciaServiceConCreateSubArgumentButtonCallOperation-action-form-action-cancel"
          variant="text"
          onClick={() => cancel()}
          disabled={isLoading}
        ...
        <LoadingButton
          ...
          id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceUserDebatesActiveDebatesInActivityDistrictsViewEdemokraciaServiceUserEdemokraciaServiceConCreateSubArgumentButtonCallOperation-action-form-action-submit"
          variant="contained"
          onClick={() => submit()}
