...
export const SERVICE_USER_DEBATES_ACTIVE_DEBATES_IN_ACTIVITY_DISTRICTS_VIEW_COMMENTS =
  'ServiceUserDebatesActiveDebatesInActivityDistrictsViewComments';
...
export const CommentsTable = (props: CommentsTableProps) => {
  ...
  const filterModelKey = `TableedemokraciaServiceUserEdemokraciaServiceUserDebatesActiveDebatesInActivityDistrictsViewDefaultDebateViewEditTabBarCommentsCommentsCommentsLabelWrapperComments-${ownerData.__identifier}-filterModel`;
  const filtersKey = `TableedemokraciaServiceUserEdemokraciaServiceUserDebatesActiveDebatesInActivityDistrictsViewDefaultDebateViewEditTabBarCommentsCommentsCommentsLabelWrapperComments-${ownerData.__identifier}-filters`;
  ...
  const commentsRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserDebatesActiveDebatesInActivityDistrictsViewDefaultDebateViewEditTabBarCommentsCommentsCommentsLabelWrapperCommentsCreatedFilter',
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserDebatesActiveDebatesInActivityDistrictsViewDefaultDebateViewEditTabBarCommentsCommentsCommentsLabelWrapperCommentsCommentFilter',
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserDebatesActiveDebatesInActivityDistrictsViewDefaultDebateViewEditTabBarCommentsCommentsCommentsLabelWrapperCommentsCreatedByNameFilter',
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserDebatesActiveDebatesInActivityDistrictsViewDefaultDebateViewEditTabBarCommentsCommentsCommentsLabelWrapperCommentsUpVotesFilter',
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserDebatesActiveDebatesInActivityDistrictsViewDefaultDebateViewEditTabBarCommentsCommentsCommentsLabelWrapperCommentsDownVotesFilter',
  ...
  const commentsRowActions: TableRowAction<ServiceCommentStored>[] = [
    {
      id: 'DeleteActionedemokraciaServiceUserEdemokraciaServiceUserDebatesActiveDebatesInActivityDistrictsViewEdemokraciaServiceUserEdemokraciaServiceDebateCommentsRowDelete',
    ...
    {
      id: 'CallOperationActionedemokraciaServiceUserEdemokraciaServiceUserDebatesActiveDebatesInActivityDistrictsViewEdemokraciaServiceUserEdemokraciaServiceCommentVoteUpButtonCallOperation',
    ...
    {
      id: 'CallOperationActionedemokraciaServiceUserEdemokraciaServiceUserDebatesActiveDebatesInActivityDistrictsViewEdemokraciaServiceUserEdemokraciaServiceCommentVoteDownButtonCallOperation',
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              <Button
                id="TableedemokraciaServiceUserEdemokraciaServiceUserDebatesActiveDebatesInActivityDistrictsViewDefaultDebateViewEditTabBarCommentsCommentsCommentsLabelWrapperComments-filter"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() =>
                  filter(
                    'TableedemokraciaServiceUserEdemokraciaServiceUserDebatesActiveDebatesInActivityDistrictsViewDefaultDebateViewEditTabBarCommentsCommentsCommentsLabelWrapperComments-filter',
                    filterOptions,
                    filters,
                  )
                }
