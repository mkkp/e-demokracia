...
// Page name: edemokracia::service::UserDebates.activeDebatesInActivityDistricts#Table
...
/**
 * Name: edemokracia::service::UserDebates.activeDebatesInActivityDistricts#Table
 * Is Access: false
 * Type: Table
 **/
export default function ServiceUserDebatesActiveDebatesInActivityDistrictsTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaServiceUserEdemokraciaServiceUserDebatesActiveDebatesInActivityDistrictsTable-data-grid">
                  <Debate_TableTable
                    ref={tableRef}
