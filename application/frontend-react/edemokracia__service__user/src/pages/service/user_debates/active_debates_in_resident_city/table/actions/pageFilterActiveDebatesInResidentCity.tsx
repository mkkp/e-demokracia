...
export type PageFilterActiveDebatesInResidentCityAction = (
  id: string,
  filterOptions: FilterOption[],
  filters: Filter[],
) => Promise<void>;

export const usePageFilterActiveDebatesInResidentCityAction = (
  ...
  return async function pageFilterActiveDebatesInResidentCityAction(
    id: string,
    filterOptions: FilterOption[],
    filters: Filter[],
  ) {
