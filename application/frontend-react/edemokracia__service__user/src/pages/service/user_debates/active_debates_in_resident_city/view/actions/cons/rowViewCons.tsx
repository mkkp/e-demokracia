...
import { routeToServiceDebateConsView } from '~/routes';
...
export const useRowViewConsAction: RowViewConsAction = () => {
  ...
  return async function (owner: JudoIdentifiable<ServiceDebate>, entry: ServiceConStored, successCallback: () => void) {
    closeAllDialogs();
    navigate(routeToServiceDebateConsView(entry.__signedIdentifier));
  };
};
