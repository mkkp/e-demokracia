...
// Page name: edemokracia::service::UserDebates.activeDebatesInResidentCity#Table
...
/**
 * Name: edemokracia::service::UserDebates.activeDebatesInResidentCity#Table
 * Is Access: false
 * Type: Table
 **/
export default function ServiceUserDebatesActiveDebatesInResidentCityTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaServiceUserEdemokraciaServiceUserDebatesActiveDebatesInResidentCityTable-data-grid">
                  <Debate_TableTable
                    ref={tableRef}
