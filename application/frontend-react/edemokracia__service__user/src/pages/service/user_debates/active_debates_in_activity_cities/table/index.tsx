...
// Page name: edemokracia::service::UserDebates.activeDebatesInActivityCities#Table
...
/**
 * Name: edemokracia::service::UserDebates.activeDebatesInActivityCities#Table
 * Is Access: false
 * Type: Table
 **/
export default function ServiceUserDebatesActiveDebatesInActivityCitiesTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaServiceUserEdemokraciaServiceUserDebatesActiveDebatesInActivityCitiesTable-data-grid">
                  <Debate_TableTable
                    ref={tableRef}
