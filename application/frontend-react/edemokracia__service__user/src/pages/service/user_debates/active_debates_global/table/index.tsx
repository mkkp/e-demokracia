...
// Page name: edemokracia::service::UserDebates.activeDebatesGlobal#Table
...
/**
 * Name: edemokracia::service::UserDebates.activeDebatesGlobal#Table
 * Is Access: false
 * Type: Table
 **/
export default function ServiceUserDebatesActiveDebatesGlobalTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaServiceUserEdemokraciaServiceUserDebatesActiveDebatesGlobalTable-data-grid">
                  <Debate_TableTable
                    ref={tableRef}
