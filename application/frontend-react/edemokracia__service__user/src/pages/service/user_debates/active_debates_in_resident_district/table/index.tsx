...
// Page name: edemokracia::service::UserDebates.activeDebatesInResidentDistrict#Table
...
/**
 * Name: edemokracia::service::UserDebates.activeDebatesInResidentDistrict#Table
 * Is Access: false
 * Type: Table
 **/
export default function ServiceUserDebatesActiveDebatesInResidentDistrictTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaServiceUserEdemokraciaServiceUserDebatesActiveDebatesInResidentDistrictTable-data-grid">
                  <Debate_TableTable
                    ref={tableRef}
