...
export type PageFilterActiveDebatesInResidentDistrictAction = (
  id: string,
  filterOptions: FilterOption[],
  filters: Filter[],
) => Promise<void>;

export const usePageFilterActiveDebatesInResidentDistrictAction = (
  ...
  return async function pageFilterActiveDebatesInResidentDistrictAction(
    id: string,
    filterOptions: FilterOption[],
    filters: Filter[],
  ) {
