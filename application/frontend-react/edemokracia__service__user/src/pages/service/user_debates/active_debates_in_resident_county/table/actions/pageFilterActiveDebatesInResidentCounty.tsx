...
export type PageFilterActiveDebatesInResidentCountyAction = (
  id: string,
  filterOptions: FilterOption[],
  filters: Filter[],
) => Promise<void>;

export const usePageFilterActiveDebatesInResidentCountyAction = (
  ...
  return async function pageFilterActiveDebatesInResidentCountyAction(
    id: string,
    filterOptions: FilterOption[],
    filters: Filter[],
  ) {
