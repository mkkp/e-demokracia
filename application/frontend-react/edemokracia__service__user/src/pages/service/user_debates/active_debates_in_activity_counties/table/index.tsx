...
// Page name: edemokracia::service::UserDebates.activeDebatesInActivityCounties#Table
...
/**
 * Name: edemokracia::service::UserDebates.activeDebatesInActivityCounties#Table
 * Is Access: false
 * Type: Table
 **/
export default function ServiceUserDebatesActiveDebatesInActivityCountiesTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaServiceUserEdemokraciaServiceUserDebatesActiveDebatesInActivityCountiesTable-data-grid">
                  <Debate_TableTable
                    ref={tableRef}
