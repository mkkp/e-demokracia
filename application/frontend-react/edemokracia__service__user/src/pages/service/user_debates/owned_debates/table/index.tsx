...
// Page name: edemokracia::service::UserDebates.ownedDebates#Table
...
/**
 * Name: edemokracia::service::UserDebates.ownedDebates#Table
 * Is Access: false
 * Type: Table
 **/
export default function ServiceUserDebatesOwnedDebatesTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaServiceUserEdemokraciaServiceUserDebatesOwnedDebatesTable-data-grid">
                  <Debate_TableTable
                    ref={tableRef}
