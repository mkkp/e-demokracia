...
// Page name: edemokracia::service::UserDebates.ownedDebates#View
...
export type ServiceUserDebatesOwnedDebatesViewPostRefreshAction = (
...
export const SERVICE_USER_DEBATES_OWNED_DEBATES_VIEW_POST_REFRESH_HOOK_INTERFACE_KEY =
  'ServiceUserDebatesOwnedDebatesViewPostRefreshHook';
export type ServiceUserDebatesOwnedDebatesViewPostRefreshHook =
  () => ServiceUserDebatesOwnedDebatesViewPostRefreshAction;

/**
 * Name: edemokracia::service::UserDebates.ownedDebates#View
 * Is Access: false
 * Type: View
 * Edit Mode Available: true
 **/
export default function ServiceUserDebatesOwnedDebatesView() {
  ...
  const handleUpdateError = useErrorHandler<ServiceDebate>(
    `(&(${OBJECTCLASS}=${ERROR_PROCESSOR_HOOK_INTERFACE_KEY})(operation=Update)(component=ServiceUserDebatesOwnedDebatesView))`,
  );
  ...
  const { service: postRefreshHook } = useTrackService<ServiceUserDebatesOwnedDebatesViewPostRefreshHook>(
    `(${OBJECTCLASS}=${SERVICE_USER_DEBATES_OWNED_DEBATES_VIEW_POST_REFRESH_HOOK_INTERFACE_KEY})`,
  );
  const postRefreshAction: ServiceUserDebatesOwnedDebatesViewPostRefreshAction | undefined =
        ...
        <Box sx={mainContainerPadding}>
          ...
          >
            <Grid item xs={12} sm={12}>
              <Grid
                id="FlexedemokraciaServiceUserEdemokraciaServiceUserDebatesOwnedDebatesViewDefaultDebateViewEditActions"
                container
                direction="row"
              ...
              >
                <Grid item xs={12}>
                  <Grid container spacing={2}>
                    <Grid item>
                      <LoadingButton
                        id="ButtonedemokraciaServiceUserEdemokraciaServiceUserDebatesOwnedDebatesViewDefaultDebateViewEditActionsPageActionButtonsCloseDebate"
                        loading={isLoading}
                    ...
                    {!data.isFavorite && (
                      <Grid item>
                        <LoadingButton
                          id="ButtonedemokraciaServiceUserEdemokraciaServiceUserDebatesOwnedDebatesViewDefaultDebateViewEditActionsPageActionButtonsAddToFavorites"
                          loading={isLoading}
                    ...
                    {!data.isNotFavorite && (
                      <Grid item>
                        <LoadingButton
                          id="ButtonedemokraciaServiceUserEdemokraciaServiceUserDebatesOwnedDebatesViewDefaultDebateViewEditActionsPageActionButtonsRemoveFromFavorites"
                          loading={isLoading}
            ...
            <Grid item xs={12} sm={12}>
              <Card id="FlexedemokraciaServiceUserEdemokraciaServiceUserDebatesOwnedDebatesViewDefaultDebateViewEditDebateLabelWrapper">
                <CardContent>
                  <Grid container direction="column" alignItems="stretch" justifyContent="flex-start" spacing={2}>
                    <Grid item xs={12} sm={12}>
                      <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                        ...
                        <Typography
                          id="LabeledemokraciaServiceUserEdemokraciaServiceUserDebatesOwnedDebatesViewDefaultDebateViewEditDebateLabelWrapperDebateLabel"
                          variant="h5"
                          component="h1"
                        >
                    ...
                    <Grid item xs={12} sm={12}>
                      <Grid
                        id="FlexedemokraciaServiceUserEdemokraciaServiceUserDebatesOwnedDebatesViewDefaultDebateViewEditDebateLabelWrapperDebate"
                        container
                        direction="row"
                        alignItems="stretch"
                        justifyContent="flex-start"
                      ...
                      >
                        <Grid item xs={12} sm={12} md={8.0}>
                          <TextField
                            required={true}
                            name="title"
                            id="TextInputedemokraciaServiceUserEdemokraciaServiceUserDebatesOwnedDebatesViewDefaultDebateViewEditDebateLabelWrapperDebateTitle"
                        ...
                        <Grid item xs={12} sm={12} md={2.0}>
                          <TextField
                            required={true}
                            name="status"
                            id="EnumerationComboedemokraciaServiceUserEdemokraciaServiceUserDebatesOwnedDebatesViewDefaultDebateViewEditDebateLabelWrapperDebateStatus"
                        ...
                        <Grid item xs={12} sm={12} md={2.0}>
                          <DateTimePicker
                            ...
                            slotProps={{
                              textField: {
                                id: 'DateTimeInputedemokraciaServiceUserEdemokraciaServiceUserDebatesOwnedDebatesViewDefaultDebateViewEditDebateLabelWrapperDebateCloseAt',
                                required: true,
                        ...
                        <Grid item xs={12} sm={12}>
                          <TextField
                            required={true}
                            name="description"
                            id="TextAreaedemokraciaServiceUserEdemokraciaServiceUserDebatesOwnedDebatesViewDefaultDebateViewEditDebateLabelWrapperDebateDescription"
            ...
            <Grid container item xs={12} sm={12}>
              <ModeledTabs
                id="TabControlleredemokraciaServiceUserEdemokraciaServiceUserDebatesOwnedDebatesViewDefaultDebateViewEditTabBar"
                ownerData={data}
                validation={validation}
                orientation='horizontal'
                childTabs={[
                  {
                    id: 'TabedemokraciaServiceUserEdemokraciaServiceUserDebatesOwnedDebatesViewDefaultDebateViewEditTabBarArguments',
                  ...
                  {
                    id: 'TabedemokraciaServiceUserEdemokraciaServiceUserDebatesOwnedDebatesViewDefaultDebateViewEditTabBarComments',
              ...
              >
                <Grid item xs={12} sm={12}>
                  <Grid
                    id="FlexedemokraciaServiceUserEdemokraciaServiceUserDebatesOwnedDebatesViewDefaultDebateViewEditTabBarArgumentsArguments"
                    container
                    direction="row"
                    alignItems="flex-start"
                    justifyContent="flex-start"
                  ...
                  >
                    <Grid item xs={12} sm={12}>
                      <Grid
                        id="FlexedemokraciaServiceUserEdemokraciaServiceUserDebatesOwnedDebatesViewDefaultDebateViewEditTabBarArgumentsArgumentsActions"
                        container
                        direction="row"
                        alignItems="flex-start"
                        justifyContent="flex-start"
                      ...
                      >
                        <Grid item xs={12} sm={12} md={4.0}>
                          <LoadingButton
                            id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceUserDebatesOwnedDebatesViewEdemokraciaServiceUserEdemokraciaServiceDebateCreateArgumentButtonCallOperation"
                            loading={isLoading}
                            variant={undefined}
                    ...
                    <Grid item xs={12} sm={12} md={6.0}>
                      <Grid
                        id="FlexedemokraciaServiceUserEdemokraciaServiceUserDebatesOwnedDebatesViewDefaultDebateViewEditTabBarArgumentsArgumentsProsLabelWrapper"
                        container
                        direction="column"
                        alignItems="stretch"
                        justifyContent="flex-start"
                      ...
                      >
                        <Grid item xs={12} sm={12}>
                          <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                            ...
                            <Typography
                              id="LabeledemokraciaServiceUserEdemokraciaServiceUserDebatesOwnedDebatesViewDefaultDebateViewEditTabBarArgumentsArgumentsProsLabelWrapperProsLabel"
                              variant="h5"
                              component="h1"
                            >
                        ...
                        <Grid item xs={12} sm={12}>
                          <Grid
                            id="TableedemokraciaServiceUserEdemokraciaServiceUserDebatesOwnedDebatesViewDefaultDebateViewEditTabBarArgumentsArgumentsProsLabelWrapperPros"
                            container
                            direction="column"
                            alignItems="stretch"
                            justifyContent="flex-start"
                    ...
                    <Grid item xs={12} sm={12} md={6.0}>
                      <Grid
                        id="FlexedemokraciaServiceUserEdemokraciaServiceUserDebatesOwnedDebatesViewDefaultDebateViewEditTabBarArgumentsArgumentsConsLabelWrapper"
                        container
                        direction="column"
                        alignItems="stretch"
                        justifyContent="flex-start"
                      ...
                      >
                        <Grid item xs={12} sm={12}>
                          <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                            ...
                            <Typography
                              id="LabeledemokraciaServiceUserEdemokraciaServiceUserDebatesOwnedDebatesViewDefaultDebateViewEditTabBarArgumentsArgumentsConsLabelWrapperConsLabel"
                              variant="h5"
                              component="h1"
                            >
                        ...
                        <Grid item xs={12} sm={12}>
                          <Grid
                            id="TableedemokraciaServiceUserEdemokraciaServiceUserDebatesOwnedDebatesViewDefaultDebateViewEditTabBarArgumentsArgumentsConsLabelWrapperCons"
                            container
                            direction="column"
                            alignItems="stretch"
                            justifyContent="flex-start"
                ...
                <Grid item xs={12} sm={12}>
                  <Grid
                    id="FlexedemokraciaServiceUserEdemokraciaServiceUserDebatesOwnedDebatesViewDefaultDebateViewEditTabBarCommentsComments"
                    container
                    direction="row"
                    alignItems="flex-start"
                    justifyContent="flex-start"
                  ...
                  >
                    <Grid item xs={12} sm={12}>
                      <Grid
                        id="FlexedemokraciaServiceUserEdemokraciaServiceUserDebatesOwnedDebatesViewDefaultDebateViewEditTabBarCommentsCommentsActions"
                        container
                        direction="row"
                        alignItems="flex-start"
                        justifyContent="flex-start"
                      ...
                      >
                        <Grid item xs={12} sm={12} md={4.0}>
                          <LoadingButton
                            id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceUserDebatesOwnedDebatesViewEdemokraciaServiceUserEdemokraciaServiceDebateCreateCommentButtonCallOperation"
                            loading={isLoading}
                            variant={undefined}
                    ...
                    <Grid item xs={12} sm={12}>
                      <Grid
                        id="FlexedemokraciaServiceUserEdemokraciaServiceUserDebatesOwnedDebatesViewDefaultDebateViewEditTabBarCommentsCommentsCommentsLabelWrapper"
                        container
                        direction="column"
                        alignItems="stretch"
                        justifyContent="flex-start"
                      ...
                      >
                        <Grid item xs={12} sm={12}>
                          <Grid
                            id="TableedemokraciaServiceUserEdemokraciaServiceUserDebatesOwnedDebatesViewDefaultDebateViewEditTabBarCommentsCommentsCommentsLabelWrapperComments"
                            container
                            direction="column"
                            alignItems="stretch"
                            justifyContent="flex-start"
