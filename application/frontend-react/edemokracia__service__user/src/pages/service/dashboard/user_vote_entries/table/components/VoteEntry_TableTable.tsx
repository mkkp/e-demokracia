...
export const SERVICE_DASHBOARD_USER_VOTE_ENTRIES_TABLE_VOTE_ENTRY_TABLE =
  'ServiceDashboardUserVoteEntriesTableVoteEntry_Table';
...
export const VoteEntry_TableTable = forwardRef<RefreshableTable, VoteEntry_TableTableProps>((props, ref) => {
  ...
  const filterModelKey = `TableedemokraciaServiceUserEdemokraciaServiceDashboardUserVoteEntriesTableDefaultUserVoteEntriesVoteEntryTable-${__identifier}-filterModel`;
  const filtersKey = `TableedemokraciaServiceUserEdemokraciaServiceDashboardUserVoteEntriesTableDefaultUserVoteEntriesVoteEntryTable-${__identifier}-filters`;
  ...
  useEffect(() => {
    setFilters(
      getItemParsedWithDefault(
        `TableedemokraciaServiceUserEdemokraciaServiceDashboardUserVoteEntriesTableDefaultUserVoteEntriesVoteEntryTable-${__identifier}-filters`,
        [...filters],
      ),
    );
  }, [ownerData]);
  ...
  const userVoteEntriesColumns: GridColDef<ServiceVoteEntryStored>[] = [
    {
      ...baseColumnConfig,
      field: 'userName',
      headerName: t('service.VoteEntryTable.userVoteEntries.userName', { defaultValue: 'UserName' }) as string,
    ...
    },
    {
      ...baseColumnConfig,
      field: 'created',
      headerName: t('service.VoteEntryTable.userVoteEntries.created', { defaultValue: 'Created' }) as string,
      headerClassName: 'data-grid-column-header',
    ...
    },
    {
      ...baseColumnConfig,
      field: 'voteTitle',
      headerName: t('service.VoteEntryTable.userVoteEntries.voteTitle', { defaultValue: 'VoteTitle' }) as string,
      headerClassName: 'data-grid-column-header',
    ...
    },
    {
      ...baseColumnConfig,
      field: 'voteStatus',
      headerName: t('service.VoteEntryTable.userVoteEntries.voteStatus', { defaultValue: 'VoteStatus' }) as string,
      headerClassName: 'data-grid-column-header',
  ...
  const userVoteEntriesRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceDashboardUserVoteEntriesTableDefaultUserVoteEntriesVoteEntryTableUserNameFilter',
      attributeName: 'userName',
      label: t('service.VoteEntryTable.userVoteEntries.userName', { defaultValue: 'UserName' }) as string,
      filterType: FilterType.string,
    },

    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceDashboardUserVoteEntriesTableDefaultUserVoteEntriesVoteEntryTableCreatedFilter',
      attributeName: 'created',
      label: t('service.VoteEntryTable.userVoteEntries.created', { defaultValue: 'Created' }) as string,
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceDashboardUserVoteEntriesTableDefaultUserVoteEntriesVoteEntryTableVoteStatusFilter',
      attributeName: 'voteStatus',
      label: t('service.VoteEntryTable.userVoteEntries.voteStatus', { defaultValue: 'VoteStatus' }) as string,
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              <Button
                id="FilterActionedemokraciaServiceUserEdemokraciaServiceDashboardUserVoteEntriesTableEdemokraciaServiceUserEdemokraciaServiceDashboardUserVoteEntriesPageFilter"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() => {
                  pageFilterUserVoteEntriesAction(
                    'FilterActionedemokraciaServiceUserEdemokraciaServiceDashboardUserVoteEntriesTableEdemokraciaServiceUserEdemokraciaServiceDashboardUserVoteEntriesPageFilter-filter',
                    filterOptions,
                    filters,
                  );
                }}
