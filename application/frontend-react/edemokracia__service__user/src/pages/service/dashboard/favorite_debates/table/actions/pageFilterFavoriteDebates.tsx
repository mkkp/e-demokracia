...
export type PageFilterFavoriteDebatesAction = (
  id: string,
  filterOptions: FilterOption[],
  filters: Filter[],
) => Promise<void>;

export const usePageFilterFavoriteDebatesAction = (
  ...
  return async function pageFilterFavoriteDebatesAction(id: string, filterOptions: FilterOption[], filters: Filter[]) {
