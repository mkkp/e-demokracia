...
// Page name: edemokracia::service::Dashboard.favoriteDebates#Table
...
/**
 * Name: edemokracia::service::Dashboard.favoriteDebates#Table
 * Is Access: false
 * Type: Table
 **/
export default function ServiceDashboardFavoriteDebatesTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaServiceUserEdemokraciaServiceDashboardFavoriteDebatesTable-data-grid">
                  <Debate_TableTable
                    ref={tableRef}
