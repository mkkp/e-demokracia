...
// Page name: edemokracia::service::Dashboard.ownedDebates#Table
...
/**
 * Name: edemokracia::service::Dashboard.ownedDebates#Table
 * Is Access: false
 * Type: Table
 **/
export default function ServiceDashboardOwnedDebatesTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaServiceUserEdemokraciaServiceDashboardOwnedDebatesTable-data-grid">
                  <Debate_TableTable
                    ref={tableRef}
