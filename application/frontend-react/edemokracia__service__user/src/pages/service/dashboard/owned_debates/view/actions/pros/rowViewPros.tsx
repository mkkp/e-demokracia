...
import { routeToServiceDebateProsView } from '~/routes';
...
export const useRowViewProsAction: RowViewProsAction = () => {
  ...
  return async function (owner: JudoIdentifiable<ServiceDebate>, entry: ServiceProStored, successCallback: () => void) {
    closeAllDialogs();
    navigate(routeToServiceDebateProsView(entry.__signedIdentifier));
  };
};
