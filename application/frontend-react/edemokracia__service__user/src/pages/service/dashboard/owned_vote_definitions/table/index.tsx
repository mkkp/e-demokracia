...
// Page name: edemokracia::service::Dashboard.ownedVoteDefinitions#Table
...
/**
 * Name: edemokracia::service::Dashboard.ownedVoteDefinitions#Table
 * Is Access: false
 * Type: Table
 **/
export default function ServiceDashboardOwnedVoteDefinitionsTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaServiceUserEdemokraciaServiceDashboardOwnedVoteDefinitionsTable-data-grid">
