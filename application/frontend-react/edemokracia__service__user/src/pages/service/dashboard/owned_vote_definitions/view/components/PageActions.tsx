...
import { usePageDeleteOwnedVoteDefinitionsAction, usePageRefreshOwnedVoteDefinitionsAction } from '../actions';
...
export function PageActions(props: PageActionsProps) {
  ...
  const pageDeleteOwnedVoteDefinitionsAction = usePageDeleteOwnedVoteDefinitionsAction();
