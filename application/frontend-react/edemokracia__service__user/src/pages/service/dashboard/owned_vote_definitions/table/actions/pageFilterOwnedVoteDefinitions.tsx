...
export type PageFilterOwnedVoteDefinitionsAction = (
  id: string,
  filterOptions: FilterOption[],
  filters: Filter[],
) => Promise<void>;

export const usePageFilterOwnedVoteDefinitionsAction = (
  ...
  return async function pageFilterOwnedVoteDefinitionsAction(
    id: string,
    filterOptions: FilterOption[],
    filters: Filter[],
  ) {
