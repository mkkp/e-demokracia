...
export type PageFilterFavoriteVoteDefinitionsAction = (
  id: string,
  filterOptions: FilterOption[],
  filters: Filter[],
) => Promise<void>;

export const usePageFilterFavoriteVoteDefinitionsAction = (
  ...
  return async function pageFilterFavoriteVoteDefinitionsAction(
    id: string,
    filterOptions: FilterOption[],
    filters: Filter[],
  ) {
