...
// Page name: edemokracia::service::Dashboard.favoriteVoteDefinitions#Table
...
/**
 * Name: edemokracia::service::Dashboard.favoriteVoteDefinitions#Table
 * Is Access: false
 * Type: Table
 **/
export default function ServiceDashboardFavoriteVoteDefinitionsTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaServiceUserEdemokraciaServiceDashboardFavoriteVoteDefinitionsTable-data-grid">
