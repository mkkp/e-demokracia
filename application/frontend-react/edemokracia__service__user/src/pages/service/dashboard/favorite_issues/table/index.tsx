...
// Page name: edemokracia::service::Dashboard.favoriteIssues#Table
...
/**
 * Name: edemokracia::service::Dashboard.favoriteIssues#Table
 * Is Access: false
 * Type: Table
 **/
export default function ServiceDashboardFavoriteIssuesTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaServiceUserEdemokraciaServiceDashboardFavoriteIssuesTable-data-grid">
                  <Issue_TableTable
                    ref={tableRef}
