...
export function DistrictLink(props: DistrictLinkProps) {
  ...
  const districtRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceDashboardFavoriteIssuesViewDefaultIssueViewEditOtherAreaAreaDistrictRepresentationFilter',
  ...
  return (
    <AggregationInput
      name="district"
      id="LinkedemokraciaServiceUserEdemokraciaServiceDashboardFavoriteIssuesViewDefaultIssueViewEditOtherAreaAreaDistrict"
