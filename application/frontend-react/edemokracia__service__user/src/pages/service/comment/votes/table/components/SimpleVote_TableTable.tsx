...
export const SERVICE_COMMENT_VOTES_TABLE_SIMPLE_VOTE_TABLE = 'ServiceCommentVotesTableSimpleVote_Table';

export interface SimpleVote_TableTableProps {
  ownerData: JudoIdentifiable<ServiceComment>;
...
export const SimpleVote_TableTable = forwardRef<RefreshableTable, SimpleVote_TableTableProps>((props, ref) => {
  ...
  const filterModelKey = `TableedemokraciaServiceUserEdemokraciaServiceCommentVotesTableDefaultVotesSimpleVoteTable-${__identifier}-filterModel`;
  const filtersKey = `TableedemokraciaServiceUserEdemokraciaServiceCommentVotesTableDefaultVotesSimpleVoteTable-${__identifier}-filters`;
  ...
  useEffect(() => {
    setFilters(
      getItemParsedWithDefault(
        `TableedemokraciaServiceUserEdemokraciaServiceCommentVotesTableDefaultVotesSimpleVoteTable-${__identifier}-filters`,
        [...filters],
      ),
    );
  }, [ownerData]);
  ...
  const votesRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceCommentVotesTableDefaultVotesSimpleVoteTableCreatedFilter',
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceCommentVotesTableDefaultVotesSimpleVoteTableTypeFilter',
      attributeName: 'type',
  ...
  async function fetchData() {
    ...
    try {
      const res = await serviceCommentServiceForClassImpl.getVotes(ownerData, processQueryCustomizer(queryCustomizer));
      ...
      <StripedDataGrid
        ...
        columns={[
          ...
          ...columnsActionCalculator(
            'RelationTypeedemokraciaServiceUserEdemokraciaServiceCommentVotes',
            rowActions,
            t,
            { shownActions: 2 },
          ),
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              <Button
                id="FilterActionedemokraciaServiceUserEdemokraciaServiceCommentVotesTableEdemokraciaServiceUserEdemokraciaServiceCommentVotesPageFilter"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() => {
                  pageFilterVotesAction(
                    'FilterActionedemokraciaServiceUserEdemokraciaServiceCommentVotesTableEdemokraciaServiceUserEdemokraciaServiceCommentVotesPageFilter-filter',
                    filterOptions,
                    filters,
                  );
                }}
