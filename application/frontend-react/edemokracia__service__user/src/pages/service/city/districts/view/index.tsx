...
// Page name: edemokracia::service::City.districts#View
// Page owner name: edemokracia::service::User
// Page DataElement name: districts
// Page DataElement owner name: edemokracia::service::City
...
/**
 * Name: edemokracia::service::City.districts#View
 * Is Access: false
 * Type: View
...
export default function ServiceUserView(props: ServiceUserViewProps) {
  ...
  const handleDeleteError = useErrorHandler<ServiceDistrict>(
  ...
  async function deleteData() {
    ...
    try {
      await serviceDistrictServiceForClassImpl.delete(data);
        ...
        <Grid container spacing={2} direction="column" alignItems="stretch" justifyContent="flex-start">
          <Grid item xs={12} sm={12}>
            <TextField
              required={true}
              name="name"
              id="TextInputedemokraciaServiceUserEdemokraciaServiceCityDistrictsViewDefaultDistrictViewEditName"
