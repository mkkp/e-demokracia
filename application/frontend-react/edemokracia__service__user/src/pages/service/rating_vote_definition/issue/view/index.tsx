          ...
          >
              ...
              >
                <Grid item xs={12}>
                  <Grid container spacing={2}>
                    ...
                    <Grid item>
                      <LoadingButton
                        id="ButtonedemokraciaServiceUserEdemokraciaServiceRatingVoteDefinitionIssueViewDefaultIssueViewEditActionsPageActionButtonsCloseDebate"
                        loading={isLoading}
                    ...
                    <Grid item>
                      <LoadingButton
                        id="ButtonedemokraciaServiceUserEdemokraciaServiceRatingVoteDefinitionIssueViewDefaultIssueViewEditActionsPageActionButtonsCloseVote"
                        loading={isLoading}
                    ...
                    <Grid item>
                      <LoadingButton
                        id="ButtonedemokraciaServiceUserEdemokraciaServiceRatingVoteDefinitionIssueViewDefaultIssueViewEditActionsPageActionButtonsActivate"
                        loading={isLoading}
                    ...
                    <Grid item>
                      <LoadingButton
                        id="ButtonedemokraciaServiceUserEdemokraciaServiceRatingVoteDefinitionIssueViewDefaultIssueViewEditActionsPageActionButtonsDeleteOrArchive"
                        loading={isLoading}
            ...
            <Grid container item xs={12} sm={12}>
              <ModeledTabs
                ...
                childTabs={[
                  {
                    id: 'TabedemokraciaServiceUserEdemokraciaServiceRatingVoteDefinitionIssueViewDefaultIssueViewEditOtherArguments',
              ...
              >
                <Grid item xs={12} sm={12}>
                  <Grid
                    id="FlexedemokraciaServiceUserEdemokraciaServiceRatingVoteDefinitionIssueViewDefaultIssueViewEditOtherArgumentsArguments"
                    container
                    direction="row"
                    alignItems="flex-start"
                    justifyContent="flex-start"
                  ...
                  >
                    <Grid item xs={12} sm={12} md={6.0}>
                      <Card id="FlexedemokraciaServiceUserEdemokraciaServiceRatingVoteDefinitionIssueViewDefaultIssueViewEditOtherArgumentsArgumentsConsLabelWrapper">
                        <CardContent>
                          <Grid
                            container
                            direction="column"
                          ...
                          >
                            <Grid item xs={12} sm={12}>
                              <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                                ...
                                <Typography
                                  id="LabeledemokraciaServiceUserEdemokraciaServiceRatingVoteDefinitionIssueViewDefaultIssueViewEditOtherArgumentsArgumentsConsLabelWrapperConsLabel"
                                  variant="h5"
                                  component="h1"
                                >
                            ...
                            <Grid item xs={12} sm={12}>
                              <Grid
                                id="FlexedemokraciaServiceUserEdemokraciaServiceRatingVoteDefinitionIssueViewDefaultIssueViewEditOtherArgumentsArgumentsConsLabelWrapperCons"
                                container
                                direction="row"
                                alignItems="stretch"
                                justifyContent="flex-start"
                              ...
                              >
                                <Grid item xs={12} sm={12}>
                                  <Grid
                                    id="FlexedemokraciaServiceUserEdemokraciaServiceRatingVoteDefinitionIssueViewDefaultIssueViewEditOtherArgumentsArgumentsConsLabelWrapperConsActions"
                                    container
                                    direction="row"
                                    alignItems="flex-start"
                                    justifyContent="flex-start"
                                  ...
                                  >
                                    <Grid item xs={12} sm={12}>
                                      <LoadingButton
                                        id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceRatingVoteDefinitionIssueViewEdemokraciaServiceUserEdemokraciaServiceIssueCreateConArgumentButtonCallOperation"
                                        loading={isLoading}
                                        variant={undefined}
                                ...
                                <Grid item xs={12} sm={12}>
                                  <Grid
                                    id="FlexedemokraciaServiceUserEdemokraciaServiceRatingVoteDefinitionIssueViewDefaultIssueViewEditOtherArgumentsArgumentsConsLabelWrapperConsTable"
                                    container
                                    direction="row"
                                    alignItems="flex-start"
                                    justifyContent="flex-start"
                                  ...
                                  >
                                    <Grid item xs={12} sm={12}>
                                      <Grid
                                        id="FlexedemokraciaServiceUserEdemokraciaServiceRatingVoteDefinitionIssueViewDefaultIssueViewEditOtherArgumentsArgumentsConsLabelWrapperConsTableConsLabelWrapper"
                                        container
                                        direction="column"
                                        alignItems="stretch"
                                        justifyContent="flex-start"
                                      ...
                                      >
                                        <Grid item xs={12} sm={12}>
                                          <Grid
                                            id="TableedemokraciaServiceUserEdemokraciaServiceRatingVoteDefinitionIssueViewDefaultIssueViewEditOtherArgumentsArgumentsConsLabelWrapperConsTableConsLabelWrapperCons"
                                            container
                                            direction="column"
                                            alignItems="stretch"
                                            justifyContent="flex-start"
                    ...
                    <Grid item xs={12} sm={12} md={6.0}>
                      <Card id="FlexedemokraciaServiceUserEdemokraciaServiceRatingVoteDefinitionIssueViewDefaultIssueViewEditOtherArgumentsArgumentsProsLabelWrapper">
                        <CardContent>
                          <Grid
                            container
                            direction="column"
                          ...
                          >
                            <Grid item xs={12} sm={12}>
                              <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                                ...
                                <Typography
                                  id="LabeledemokraciaServiceUserEdemokraciaServiceRatingVoteDefinitionIssueViewDefaultIssueViewEditOtherArgumentsArgumentsProsLabelWrapperProsLabel"
                                  variant="h5"
                                  component="h1"
                                >
                            ...
                            <Grid item xs={12} sm={12}>
                              <Grid
                                id="FlexedemokraciaServiceUserEdemokraciaServiceRatingVoteDefinitionIssueViewDefaultIssueViewEditOtherArgumentsArgumentsProsLabelWrapperPros"
                                container
                                direction="row"
                                alignItems="stretch"
                                justifyContent="flex-start"
                              ...
                              >
                                <Grid item xs={12} sm={12}>
                                  <Grid
                                    id="FlexedemokraciaServiceUserEdemokraciaServiceRatingVoteDefinitionIssueViewDefaultIssueViewEditOtherArgumentsArgumentsProsLabelWrapperProsActions"
                                    container
                                    direction="row"
                                    alignItems="flex-start"
                                    justifyContent="flex-start"
                                  ...
                                  >
                                    <Grid item xs={12} sm={12}>
                                      <LoadingButton
                                        id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceRatingVoteDefinitionIssueViewEdemokraciaServiceUserEdemokraciaServiceIssueCreateProArgumentButtonCallOperation"
                                        loading={isLoading}
                                        variant={undefined}
                                ...
                                <Grid item xs={12} sm={12}>
                                  <Grid
                                    id="FlexedemokraciaServiceUserEdemokraciaServiceRatingVoteDefinitionIssueViewDefaultIssueViewEditOtherArgumentsArgumentsProsLabelWrapperProsTable"
                                    container
                                    direction="row"
                                    alignItems="flex-start"
                                    justifyContent="flex-start"
                                  ...
                                  >
                                    <Grid item xs={12} sm={12}>
                                      <Grid
                                        id="FlexedemokraciaServiceUserEdemokraciaServiceRatingVoteDefinitionIssueViewDefaultIssueViewEditOtherArgumentsArgumentsProsLabelWrapperProsTableProsLabelWrapper"
                                        container
                                        direction="column"
                                        alignItems="stretch"
                                        justifyContent="flex-start"
                                      ...
                                      >
                                        <Grid item xs={12} sm={12}>
                                          <Grid
                                            id="TableedemokraciaServiceUserEdemokraciaServiceRatingVoteDefinitionIssueViewDefaultIssueViewEditOtherArgumentsArgumentsProsLabelWrapperProsTableProsLabelWrapperPros"
                                            container
                                            direction="column"
                                            alignItems="stretch"
                                            justifyContent="flex-start"
