...
export type OwnerLinkFilterInitializer = (ownerData: ServiceRatingVoteEntryStored) => Filter[] | undefined;
...
export interface OwnerLinkProps {
  ownerData: ServiceRatingVoteEntryStored;
  validation: Map<keyof ServiceRatingVoteEntryStored, string>;
...
export function OwnerLink(props: OwnerLinkProps) {
  ...
  const ownerColumns: GridColDef<ServiceServiceUserStored>[] = [
    {
      ...
      headerName: t('service.RatingVoteEntryView.owner.representation', { defaultValue: 'Representation' }) as string,
  ...
  const ownerRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceRatingVoteDefinitionUserVoteEntryViewDefaultRatingVoteEntryViewEditOwnerRepresentationFilter',
      attributeName: 'representation',
      label: t('service.RatingVoteEntryView.owner.representation', { defaultValue: 'Representation' }) as string,
  ...
  return (
    <AggregationInput
      name="owner"
      id="LinkedemokraciaServiceUserEdemokraciaServiceRatingVoteDefinitionUserVoteEntryViewDefaultRatingVoteEntryViewEditOwner"
      required={true}
      label={t('service.RatingVoteEntryView.owner', { defaultValue: 'Owner' }) as string}
