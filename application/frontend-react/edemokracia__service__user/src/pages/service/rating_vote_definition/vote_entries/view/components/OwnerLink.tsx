...
export function OwnerLink(props: OwnerLinkProps) {
  ...
  const ownerRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceRatingVoteDefinitionVoteEntriesViewDefaultRatingVoteEntryViewEditOwnerRepresentationFilter',
  ...
  return (
    <AggregationInput
      name="owner"
      id="LinkedemokraciaServiceUserEdemokraciaServiceRatingVoteDefinitionVoteEntriesViewDefaultRatingVoteEntryViewEditOwner"
      required={true}
