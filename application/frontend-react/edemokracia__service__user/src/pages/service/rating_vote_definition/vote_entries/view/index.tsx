...
// Page name: edemokracia::service::RatingVoteDefinition.voteEntries#View
...
/**
 * Name: edemokracia::service::RatingVoteDefinition.voteEntries#View
 * Is Access: false
 * Type: View
        ...
        <Grid container spacing={2} direction="column" alignItems="stretch" justifyContent="flex-start">
          <Grid item xs={12} sm={12}>
            <DateTimePicker
              ...
              slotProps={{
                textField: {
                  id: 'DateTimeInputedemokraciaServiceUserEdemokraciaServiceRatingVoteDefinitionVoteEntriesViewDefaultRatingVoteEntryViewEditCreated',
                  required: true,
          ...
          <Grid item xs={12} sm={12}>
            <NumericInput
              required={true}
              name="value"
              id="NumericInputedemokraciaServiceUserEdemokraciaServiceRatingVoteDefinitionVoteEntriesViewDefaultRatingVoteEntryViewEditValue"
