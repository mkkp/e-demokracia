...
export const SERVICE_VOTE_DEFINITION_ISSUE_VIEW_ATTACHMENTS = 'ServiceVoteDefinitionIssueViewAttachments';
...
export const AttachmentsTable = (props: AttachmentsTableProps) => {
  ...
  const filterModelKey = `TableedemokraciaServiceUserEdemokraciaServiceVoteDefinitionIssueViewDefaultIssueViewEditOtherAttachmentsAttachmentsAttachmentsLabelWrapperAttachments-${ownerData.__identifier}-filterModel`;
  const filtersKey = `TableedemokraciaServiceUserEdemokraciaServiceVoteDefinitionIssueViewDefaultIssueViewEditOtherAttachmentsAttachmentsAttachmentsLabelWrapperAttachments-${ownerData.__identifier}-filters`;
      ...
      renderCell: (params: GridRenderCellParams<any, ServiceIssueAttachmentStored>) => {
        return params.row.file ? (
          <ButtonGroup size="small" variant="outlined">
            <Button
              id="ColumnedemokraciaServiceUserEdemokraciaServiceVoteDefinitionIssueViewDefaultIssueViewEditOtherAttachmentsAttachmentsAttachmentsLabelWrapperAttachmentsFile-download"
            ...
            <Button
              id="ColumnedemokraciaServiceUserEdemokraciaServiceVoteDefinitionIssueViewDefaultIssueViewEditOtherAttachmentsAttachmentsAttachmentsLabelWrapperAttachmentsFile-view"
              onClick={(event: any) => {
                event.preventDefault();
                event.stopPropagation();
  ...
  const attachmentsRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceVoteDefinitionIssueViewDefaultIssueViewEditOtherAttachmentsAttachmentsAttachmentsLabelWrapperAttachmentsLinkFilter',
      attributeName: 'link',
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceVoteDefinitionIssueViewDefaultIssueViewEditOtherAttachmentsAttachmentsAttachmentsLabelWrapperAttachmentsTypeFilter',
      attributeName: 'type',
  ...
  const attachmentsRowActions: TableRowAction<ServiceIssueAttachmentStored>[] = [
    {
      id: 'DeleteActionedemokraciaServiceUserEdemokraciaServiceVoteDefinitionIssueViewEdemokraciaServiceUserEdemokraciaServiceIssueAttachmentsRowDelete',
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              <Button
                id="CreateActionedemokraciaServiceUserEdemokraciaServiceVoteDefinitionIssueViewEdemokraciaServiceUserEdemokraciaServiceIssueAttachmentsTableCreate"
              ...
              <Button
                id="TableedemokraciaServiceUserEdemokraciaServiceVoteDefinitionIssueViewDefaultIssueViewEditOtherAttachmentsAttachmentsAttachmentsLabelWrapperAttachments-filter"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() =>
                  filter(
                    'TableedemokraciaServiceUserEdemokraciaServiceVoteDefinitionIssueViewDefaultIssueViewEditOtherAttachmentsAttachmentsAttachmentsLabelWrapperAttachments-filter',
                    filterOptions,
                    filters,
                  )
                }
