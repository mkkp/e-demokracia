...
export function OwnerLink(props: OwnerLinkProps) {
  ...
  const ownerRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceSelectAnswerVoteDefinitionVoteEntriesViewDefaultSelectAnswerVoteEntryViewEditOwnerRepresentationFilter',
  ...
  return (
    <AggregationInput
      name="owner"
      id="LinkedemokraciaServiceUserEdemokraciaServiceSelectAnswerVoteDefinitionVoteEntriesViewDefaultSelectAnswerVoteEntryViewEditOwner"
      required={true}
