...
// Page name: edemokracia::service::SelectAnswerVoteDefinition.voteEntries#View
...
/**
 * Name: edemokracia::service::SelectAnswerVoteDefinition.voteEntries#View
 * Is Access: false
 * Type: View
        ...
        <Grid container spacing={2} direction="column" alignItems="stretch" justifyContent="flex-start">
          <Grid item xs={12} sm={12}>
            <DateTimePicker
              ...
              slotProps={{
                textField: {
                  id: 'DateTimeInputedemokraciaServiceUserEdemokraciaServiceSelectAnswerVoteDefinitionVoteEntriesViewDefaultSelectAnswerVoteEntryViewEditCreated',
                  required: true,
          ...
          <Grid item xs={12} sm={12}>
            <TextField
              ...
              id="TextInputedemokraciaServiceUserEdemokraciaServiceSelectAnswerVoteDefinitionVoteEntriesViewDefaultSelectAnswerVoteEntryViewEditValueRepresentation"
              label={
