...
// Page name: edemokracia::service::SelectAnswerVoteDefinition.voteSelections#View
...
/**
 * Name: edemokracia::service::SelectAnswerVoteDefinition.voteSelections#View
 * Is Access: false
 * Type: View
...
export default function ServiceUserView(props: ServiceUserViewProps) {
  ...
  const handleUpdateError = useErrorHandler<ServiceSelectAnswerVoteSelection>(
    `(&(${OBJECTCLASS}=${ERROR_PROCESSOR_HOOK_INTERFACE_KEY})(operation=Update)(component=ServiceUserView))`,
  );
  const handleDeleteError = useErrorHandler<ServiceSelectAnswerVoteSelection>(
  ...
  async function submit() {
    ...
    try {
      const res = await serviceSelectAnswerVoteSelectionServiceForClassImpl.update(payloadDiff);
  ...
  async function deleteData() {
    ...
    try {
      await serviceSelectAnswerVoteSelectionServiceForClassImpl.delete(data);
        ...
        <Grid container spacing={2} direction="column" alignItems="stretch" justifyContent="flex-start">
          <Grid item xs={12} sm={12}>
            <TextField
              required={true}
              name="title"
              id="TextInputedemokraciaServiceUserEdemokraciaServiceSelectAnswerVoteDefinitionVoteSelectionsViewDefaultSelectAnswerVoteSelectionViewEditTitle"
          ...
          <Grid item xs={12} sm={12}>
            <TextField
              required={false}
              name="description"
              id="TextAreaedemokraciaServiceUserEdemokraciaServiceSelectAnswerVoteDefinitionVoteSelectionsViewDefaultSelectAnswerVoteSelectionViewEditDescription"
