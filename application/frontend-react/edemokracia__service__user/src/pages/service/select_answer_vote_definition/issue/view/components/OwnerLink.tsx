...
export function OwnerLink(props: OwnerLinkProps) {
  ...
  const ownerRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceSelectAnswerVoteDefinitionIssueViewDefaultIssueViewEditIssueLabelWrapperIssueOwnerRepresentationFilter',
  ...
  return (
    <AggregationInput
      name="owner"
      id="LinkedemokraciaServiceUserEdemokraciaServiceSelectAnswerVoteDefinitionIssueViewDefaultIssueViewEditIssueLabelWrapperIssueOwner"
