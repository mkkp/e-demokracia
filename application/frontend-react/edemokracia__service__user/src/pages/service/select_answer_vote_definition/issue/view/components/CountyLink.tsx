...
export function CountyLink(props: CountyLinkProps) {
  ...
  const countyRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceSelectAnswerVoteDefinitionIssueViewDefaultIssueViewEditOtherAreaAreaCountyRepresentationFilter',
  ...
  return (
    <AggregationInput
      name="county"
      id="LinkedemokraciaServiceUserEdemokraciaServiceSelectAnswerVoteDefinitionIssueViewDefaultIssueViewEditOtherAreaAreaCounty"
