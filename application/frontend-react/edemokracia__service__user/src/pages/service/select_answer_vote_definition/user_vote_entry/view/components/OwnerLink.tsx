...
export type OwnerLinkFilterInitializer = (ownerData: ServiceSelectAnswerVoteEntryStored) => Filter[] | undefined;
...
export interface OwnerLinkProps {
  ownerData: ServiceSelectAnswerVoteEntryStored;
  validation: Map<keyof ServiceSelectAnswerVoteEntryStored, string>;
...
export function OwnerLink(props: OwnerLinkProps) {
  ...
  const ownerColumns: GridColDef<ServiceServiceUserStored>[] = [
    {
      ...
      headerName: t('service.SelectAnswerVoteEntryView.owner.representation', {
  ...
  const ownerRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceSelectAnswerVoteDefinitionUserVoteEntryViewDefaultSelectAnswerVoteEntryViewEditOwnerRepresentationFilter',
      attributeName: 'representation',
      label: t('service.SelectAnswerVoteEntryView.owner.representation', { defaultValue: 'Representation' }) as string,
  ...
  return (
    <AggregationInput
      name="owner"
      id="LinkedemokraciaServiceUserEdemokraciaServiceSelectAnswerVoteDefinitionUserVoteEntryViewDefaultSelectAnswerVoteEntryViewEditOwner"
      required={true}
      label={t('service.SelectAnswerVoteEntryView.owner', { defaultValue: 'Owner' }) as string}
