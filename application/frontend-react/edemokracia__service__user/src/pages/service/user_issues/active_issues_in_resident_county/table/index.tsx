...
// Page name: edemokracia::service::UserIssues.activeIssuesInResidentCounty#Table
...
/**
 * Name: edemokracia::service::UserIssues.activeIssuesInResidentCounty#Table
 * Is Access: false
 * Type: Table
 **/
export default function ServiceUserIssuesActiveIssuesInResidentCountyTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInResidentCountyTable-data-grid">
                  <Issue_TableTable
                    ref={tableRef}
