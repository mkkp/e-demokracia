...
export function IssueTypeLink(props: IssueTypeLinkProps) {
  ...
  const issueTypeRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInResidentCountyViewDefaultIssueViewEditIssueLabelWrapperIssueIssueTypeTitleFilter',
      attributeName: 'title',
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInResidentCountyViewDefaultIssueViewEditIssueLabelWrapperIssueIssueTypeDescriptionFilter',
  ...
  return (
    <AggregationInput
      name="issueType"
      id="LinkedemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInResidentCountyViewDefaultIssueViewEditIssueLabelWrapperIssueIssueType"
