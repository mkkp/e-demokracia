...
export type PageFilterActiveIssuesInResidentCountyAction = (
  id: string,
  filterOptions: FilterOption[],
  filters: Filter[],
) => Promise<void>;

export const usePageFilterActiveIssuesInResidentCountyAction = (
  ...
  return async function pageFilterActiveIssuesInResidentCountyAction(
    id: string,
    filterOptions: FilterOption[],
    filters: Filter[],
  ) {
