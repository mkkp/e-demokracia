...
export const SERVICE_USER_ISSUES_ACTIVE_ISSUES_IN_RESIDENT_COUNTY_TABLE_ISSUE_TABLE =
  'ServiceUserIssuesActiveIssuesInResidentCountyTableIssue_Table';
...
export const Issue_TableTable = forwardRef<RefreshableTable, Issue_TableTableProps>((props, ref) => {
  ...
  const filterModelKey = `TableedemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInResidentCountyTableDefaultActiveIssuesInResidentCountyIssueTable-${__identifier}-filterModel`;
  const filtersKey = `TableedemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInResidentCountyTableDefaultActiveIssuesInResidentCountyIssueTable-${__identifier}-filters`;
  ...
  useEffect(() => {
    setFilters(
      getItemParsedWithDefault(
        `TableedemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInResidentCountyTableDefaultActiveIssuesInResidentCountyIssueTable-${__identifier}-filters`,
        [...filters],
      ),
    );
  }, [ownerData]);
  ...
  const activeIssuesInResidentCountyColumns: GridColDef<ServiceIssueStored>[] = [
    {
      ...baseColumnConfig,
      field: 'scope',
      headerName: t('service.IssueTable.activeIssuesInResidentCounty.scope', { defaultValue: 'Scope' }) as string,
    ...
    },
    {
      ...baseColumnConfig,
      field: 'title',
      headerName: t('service.IssueTable.activeIssuesInResidentCounty.title', { defaultValue: 'Title' }) as string,
      headerClassName: 'data-grid-column-header',
    ...
    },
    {
      ...baseColumnConfig,
      field: 'status',
      headerName: t('service.IssueTable.activeIssuesInResidentCounty.status', { defaultValue: 'Status' }) as string,
      headerClassName: 'data-grid-column-header',
    ...
    },
    {
      ...baseColumnConfig,
      field: 'created',
      headerName: t('service.IssueTable.activeIssuesInResidentCounty.created', { defaultValue: 'Created' }) as string,
      headerClassName: 'data-grid-column-header',
  ...
  const activeIssuesInResidentCountyRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInResidentCountyTableDefaultActiveIssuesInResidentCountyIssueTableScopeFilter',
      attributeName: 'scope',
      label: t('service.IssueTable.activeIssuesInResidentCounty.scope', { defaultValue: 'Scope' }) as string,
      filterType: FilterType.enumeration,
      enumValues: ['GLOBAL', 'COUNTY', 'CITY', 'DISTRICT'],
    },

    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInResidentCountyTableDefaultActiveIssuesInResidentCountyIssueTableTitleFilter',
      attributeName: 'title',
      label: t('service.IssueTable.activeIssuesInResidentCounty.title', { defaultValue: 'Title' }) as string,
      filterType: FilterType.string,
    },

    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInResidentCountyTableDefaultActiveIssuesInResidentCountyIssueTableStatusFilter',
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInResidentCountyTableDefaultActiveIssuesInResidentCountyIssueTableCreatedFilter',
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInResidentCountyTableDefaultActiveIssuesInResidentCountyIssueTableDescriptionFilter',
      attributeName: 'description',
      label: t('service.IssueTable.activeIssuesInResidentCounty.description', {
        defaultValue: 'Description',
      }) as string,
      filterType: FilterType.string,
    },
  ...
  const rowActions: TableRowAction<ServiceIssueStored>[] = [
    ...
    {
      id: 'CallOperationActionedemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInResidentCountyTableEdemokraciaServiceUserEdemokraciaServiceIssueRemoveFromFavoritesButtonCallOperation',
      label: t('service.IssueTable.activeIssuesInResidentCounty.removeFromFavorites.ButtonCallOperation', {
    ...
    },
    {
      ...
      label: t('service.IssueTable.activeIssuesInResidentCounty.createComment.ButtonCallOperation', {
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              <Button
                id="FilterActionedemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInResidentCountyTableEdemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInResidentCountyPageFilter"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() => {
                  pageFilterActiveIssuesInResidentCountyAction(
                    'FilterActionedemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInResidentCountyTableEdemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInResidentCountyPageFilter-filter',
                    filterOptions,
                    filters,
                  );
                }}
