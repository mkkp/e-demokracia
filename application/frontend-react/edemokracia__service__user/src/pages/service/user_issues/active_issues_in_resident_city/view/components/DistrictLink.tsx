...
export function DistrictLink(props: DistrictLinkProps) {
  ...
  const districtRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInResidentCityViewDefaultIssueViewEditOtherAreaAreaDistrictRepresentationFilter',
  ...
  return (
    <AggregationInput
      name="district"
      id="LinkedemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInResidentCityViewDefaultIssueViewEditOtherAreaAreaDistrict"
