...
// Page name: edemokracia::service::UserIssues.activeIssuesInResidentCity#Table
...
/**
 * Name: edemokracia::service::UserIssues.activeIssuesInResidentCity#Table
 * Is Access: false
 * Type: Table
 **/
export default function ServiceUserIssuesActiveIssuesInResidentCityTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInResidentCityTable-data-grid">
                  <Issue_TableTable
                    ref={tableRef}
