...
// Page name: edemokracia::service::UserIssues.activeIssuesInActivityDistricts#Table
...
/**
 * Name: edemokracia::service::UserIssues.activeIssuesInActivityDistricts#Table
 * Is Access: false
 * Type: Table
 **/
export default function ServiceUserIssuesActiveIssuesInActivityDistrictsTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInActivityDistrictsTable-data-grid">
                  <Issue_TableTable
                    ref={tableRef}
