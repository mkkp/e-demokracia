...
export type PageFilterActiveIssuesInActivityDistrictsAction = (
  id: string,
  filterOptions: FilterOption[],
  filters: Filter[],
) => Promise<void>;

export const usePageFilterActiveIssuesInActivityDistrictsAction = (
  ...
  return async function pageFilterActiveIssuesInActivityDistrictsAction(
    id: string,
    filterOptions: FilterOption[],
    filters: Filter[],
  ) {
