...
import { createDebateInputServiceForClassImpl, serviceIssueServiceForClassImpl } from '~/generated/data-axios';

export interface ServiceIssueCreateDebateFormProps {
  successCallback: (result?: CreateDebateOutputDebateReferenceStored) => void;
  cancel: () => void;
  owner: ServiceIssueStored;
}

export default function ServiceIssueCreateDebateForm({
  successCallback,
  cancel,
  owner,
}: ServiceIssueCreateDebateFormProps) {
  ...
  const handleActionError = useErrorHandler<CreateDebateInput>(
    `(&(${OBJECTCLASS}=${ERROR_PROCESSOR_HOOK_INTERFACE_KEY})(operation=CallOperation)(component=ServiceIssueCreateDebateForm))`,
  );
  ...
  const submit = async () => {
    ...
    try {
      const res = await serviceIssueServiceForClassImpl.createDebate(owner, payloadDiff);
  ...
  return (
    <>
      <DialogTitle>
        {title}
        <IconButton
          id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInActivityDistrictsTableEdemokraciaServiceUserEdemokraciaServiceIssueCreateDebateButtonCallOperation-dialog-close"
          aria-label="close"
          onClick={() => cancel()}
          sx={{
            position: 'absolute',
      ...
      <DialogContent dividers>
        <Grid container spacing={2} direction="column" alignItems="stretch" justifyContent="flex-start">
          <Grid item xs={12} sm={12}>
            <Grid
              id="FlexedemokraciaServiceUserEdemokraciaServiceIssueCreateDebateInputDefaultCreateDebateInputFormDebate"
              container
              direction="row"
            ...
            >
              <Grid item xs={12} sm={12} md={8.0}>
                <TextField
                  required={true}
                  name="title"
                  id="TextInputedemokraciaServiceUserEdemokraciaServiceIssueCreateDebateInputDefaultCreateDebateInputFormDebateTitle"
                  autoFocus
              ...
              <Grid item xs={12} sm={12} md={4.0}>
                <DateTimePicker
                  ...
                  slotProps={{
                    textField: {
                      id: 'DateTimeInputedemokraciaServiceUserEdemokraciaServiceIssueCreateDebateInputDefaultCreateDebateInputFormDebateCloseAt',
                      required: true,
              ...
              <Grid item xs={12} sm={12}>
                <TextField
                  required={true}
                  name="description"
                  id="TextAreaedemokraciaServiceUserEdemokraciaServiceIssueCreateDebateInputDefaultCreateDebateInputFormDebateDescription"
          ...
          <Grid item xs={12} sm={12}>
            <Grid
              id="FlexedemokraciaServiceUserEdemokraciaServiceIssueCreateDebateInputDefaultCreateDebateInputFormButtons"
              container
              direction="row"
              alignItems="flex-start"
      ...
      <DialogActions>
        <Button
          id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInActivityDistrictsTableEdemokraciaServiceUserEdemokraciaServiceIssueCreateDebateButtonCallOperation-action-form-action-cancel"
          variant="text"
          onClick={() => cancel()}
          disabled={isLoading}
        ...
        <LoadingButton
          ...
          id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInActivityDistrictsTableEdemokraciaServiceUserEdemokraciaServiceIssueCreateDebateButtonCallOperation-action-form-action-submit"
          variant="contained"
          onClick={() => submit()}
