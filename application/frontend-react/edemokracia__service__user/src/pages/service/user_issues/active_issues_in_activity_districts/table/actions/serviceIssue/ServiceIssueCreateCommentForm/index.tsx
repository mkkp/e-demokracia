...
import { createCommentInputServiceForClassImpl, serviceIssueServiceForClassImpl } from '~/generated/data-axios';

export interface ServiceIssueCreateCommentFormProps {
  successCallback: () => void;
  cancel: () => void;
  owner: ServiceIssueStored;
}

export default function ServiceIssueCreateCommentForm({
  successCallback,
  cancel,
  owner,
}: ServiceIssueCreateCommentFormProps) {
  ...
  const handleActionError = useErrorHandler<CreateCommentInput>(
    `(&(${OBJECTCLASS}=${ERROR_PROCESSOR_HOOK_INTERFACE_KEY})(operation=CallOperation)(component=ServiceIssueCreateCommentForm))`,
  );
  ...
  const submit = async () => {
    ...
    try {
      await serviceIssueServiceForClassImpl.createComment(owner, payloadDiff);
  ...
  return (
    <>
      <DialogTitle>
        {title}
        <IconButton
          id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInActivityDistrictsTableEdemokraciaServiceUserEdemokraciaServiceIssueCreateCommentButtonCallOperation-dialog-close"
          aria-label="close"
          onClick={() => cancel()}
          sx={{
            position: 'absolute',
      ...
      <DialogContent dividers>
        <Grid container spacing={2} direction="column" alignItems="stretch" justifyContent="flex-start">
          <Grid item xs={12} sm={12}>
            <Grid
              id="FlexedemokraciaServiceUserEdemokraciaServiceIssueCreateCommentInputDefaultCreateCommentInputFormComment"
              container
              direction="row"
            ...
            >
              <Grid item xs={12} sm={12}>
                <TextField
                  required={true}
                  name="comment"
                  id="TextAreaedemokraciaServiceUserEdemokraciaServiceIssueCreateCommentInputDefaultCreateCommentInputFormCommentComment"
                  autoFocus
          ...
          <Grid item xs={12} sm={12}>
            <Grid
              id="FlexedemokraciaServiceUserEdemokraciaServiceIssueCreateCommentInputDefaultCreateCommentInputFormButtons"
              container
              direction="row"
              alignItems="flex-start"
              justifyContent="flex-start"
      ...
      <DialogActions>
        <Button
          id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInActivityDistrictsTableEdemokraciaServiceUserEdemokraciaServiceIssueCreateCommentButtonCallOperation-action-form-action-cancel"
          variant="text"
          onClick={() => cancel()}
          disabled={isLoading}
        ...
        <LoadingButton
          ...
          id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInActivityDistrictsTableEdemokraciaServiceUserEdemokraciaServiceIssueCreateCommentButtonCallOperation-action-form-action-submit"
          variant="contained"
          onClick={() => submit()}
