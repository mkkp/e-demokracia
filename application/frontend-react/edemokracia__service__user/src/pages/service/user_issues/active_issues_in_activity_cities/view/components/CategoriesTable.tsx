...
export const SERVICE_USER_ISSUES_ACTIVE_ISSUES_IN_ACTIVITY_CITIES_VIEW_CATEGORIES =
  'ServiceUserIssuesActiveIssuesInActivityCitiesViewCategories';
...
export const CategoriesTable = (props: CategoriesTableProps) => {
  ...
  const filterModelKey = `TableedemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInActivityCitiesViewDefaultIssueViewEditOtherCategoriesCategoriesCategoriesLabelWrapperCategories-${ownerData.__identifier}-filterModel`;
  const filtersKey = `TableedemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInActivityCitiesViewDefaultIssueViewEditOtherCategoriesCategoriesCategoriesLabelWrapperCategories-${ownerData.__identifier}-filters`;
  ...
  const categoriesRowActions: TableRowAction<ServiceIssueCategoryStored>[] = [
    {
      id: 'RemoveActionedemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInActivityCitiesViewEdemokraciaServiceUserEdemokraciaServiceIssueCategoriesRowRemove',
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              ...
              <Button
                id="TableedemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInActivityCitiesViewDefaultIssueViewEditOtherCategoriesCategoriesCategoriesLabelWrapperCategories-filter"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() =>
                  filter(
                    'TableedemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInActivityCitiesViewDefaultIssueViewEditOtherCategoriesCategoriesCategoriesLabelWrapperCategories-filter',
                    filterOptions,
                    filters,
                  )
                }
