              ...
              >
                <Grid item xs={12}>
                  <Grid container spacing={2}>
                    <Grid item>
                      <LoadingButton
                        id="ButtonedemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInActivityCitiesViewDefaultIssueViewEditActionsPageActionButtonsCreateDebate"
                        loading={isLoading}
            ...
            <Grid container item xs={12} sm={12}>
              <ModeledTabs
                ...
                childTabs={[
                  ...
                  {
                    id: 'TabedemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInActivityCitiesViewDefaultIssueViewEditOtherDebates',
              ...
              >
                ...
                <Grid item xs={12} sm={12}>
                  <Grid
                    id="FlexedemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInActivityCitiesViewDefaultIssueViewEditOtherDebatesDebates"
                    container
                    direction="row"
                    alignItems="flex-start"
                    justifyContent="flex-start"
                  ...
                  >
                    <Grid item xs={12} sm={12}>
                      <Grid
                        id="FlexedemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInActivityCitiesViewDefaultIssueViewEditOtherDebatesDebatesDebatesLabelWrapper"
                        container
                        direction="column"
                        alignItems="stretch"
                        justifyContent="flex-start"
                      ...
                      >
                        <Grid item xs={12} sm={12}>
                          <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                            ...
                            <Typography
                              id="LabeledemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInActivityCitiesViewDefaultIssueViewEditOtherDebatesDebatesDebatesLabelWrapperDebatesLabel"
                              variant="h5"
                              component="h1"
                            >
                        ...
                        <Grid item xs={12} sm={12}>
                          <Grid
                            id="TableedemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInActivityCitiesViewDefaultIssueViewEditOtherDebatesDebatesDebatesLabelWrapperDebates"
                            container
                            direction="column"
                            alignItems="stretch"
                            justifyContent="flex-start"
