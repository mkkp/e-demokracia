...
// Page name: edemokracia::service::UserIssues.activeIssuesInActivityCities#Table
...
/**
 * Name: edemokracia::service::UserIssues.activeIssuesInActivityCities#Table
 * Is Access: false
 * Type: Table
 **/
export default function ServiceUserIssuesActiveIssuesInActivityCitiesTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInActivityCitiesTable-data-grid">
                  <Issue_TableTable
                    ref={tableRef}
