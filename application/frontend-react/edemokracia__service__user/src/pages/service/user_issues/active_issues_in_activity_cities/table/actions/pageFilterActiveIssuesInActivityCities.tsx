...
export type PageFilterActiveIssuesInActivityCitiesAction = (
  id: string,
  filterOptions: FilterOption[],
  filters: Filter[],
) => Promise<void>;

export const usePageFilterActiveIssuesInActivityCitiesAction = (
  ...
  return async function pageFilterActiveIssuesInActivityCitiesAction(
    id: string,
    filterOptions: FilterOption[],
    filters: Filter[],
  ) {
