...
export function IssueTypeLink(props: IssueTypeLinkProps) {
  ...
  const issueTypeRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInResidentDistrictViewDefaultIssueViewEditIssueLabelWrapperIssueIssueTypeTitleFilter',
      attributeName: 'title',
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInResidentDistrictViewDefaultIssueViewEditIssueLabelWrapperIssueIssueTypeDescriptionFilter',
  ...
  return (
    <AggregationInput
      name="issueType"
      id="LinkedemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInResidentDistrictViewDefaultIssueViewEditIssueLabelWrapperIssueIssueType"
