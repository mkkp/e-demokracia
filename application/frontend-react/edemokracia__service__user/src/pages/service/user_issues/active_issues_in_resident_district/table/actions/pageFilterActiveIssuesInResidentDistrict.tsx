...
export type PageFilterActiveIssuesInResidentDistrictAction = (
  id: string,
  filterOptions: FilterOption[],
  filters: Filter[],
) => Promise<void>;

export const usePageFilterActiveIssuesInResidentDistrictAction = (
  ...
  return async function pageFilterActiveIssuesInResidentDistrictAction(
    id: string,
    filterOptions: FilterOption[],
    filters: Filter[],
  ) {
