              ...
              >
                <Grid item xs={12}>
                  <Grid container spacing={2}>
                    <Grid item>
                      <LoadingButton
                        id="ButtonedemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInResidentDistrictViewDefaultIssueViewEditActionsPageActionButtonsCreateDebate"
                        loading={isLoading}
            ...
            <Grid container item xs={12} sm={12}>
              <ModeledTabs
                ...
                childTabs={[
                  ...
                  {
                    id: 'TabedemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInResidentDistrictViewDefaultIssueViewEditOtherDebates',
              ...
              >
                ...
                <Grid item xs={12} sm={12}>
                  <Grid
                    id="FlexedemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInResidentDistrictViewDefaultIssueViewEditOtherDebatesDebates"
                    container
                    direction="row"
                    alignItems="flex-start"
                    justifyContent="flex-start"
                  ...
                  >
                    <Grid item xs={12} sm={12}>
                      <Grid
                        id="FlexedemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInResidentDistrictViewDefaultIssueViewEditOtherDebatesDebatesDebatesLabelWrapper"
                        container
                        direction="column"
                        alignItems="stretch"
                        justifyContent="flex-start"
                      ...
                      >
                        <Grid item xs={12} sm={12}>
                          <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                            ...
                            <Typography
                              id="LabeledemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInResidentDistrictViewDefaultIssueViewEditOtherDebatesDebatesDebatesLabelWrapperDebatesLabel"
                              variant="h5"
                              component="h1"
                            >
                        ...
                        <Grid item xs={12} sm={12}>
                          <Grid
                            id="TableedemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInResidentDistrictViewDefaultIssueViewEditOtherDebatesDebatesDebatesLabelWrapperDebates"
                            container
                            direction="column"
                            alignItems="stretch"
                            justifyContent="flex-start"
