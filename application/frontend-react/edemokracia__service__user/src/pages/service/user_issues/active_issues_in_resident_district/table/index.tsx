...
// Page name: edemokracia::service::UserIssues.activeIssuesInResidentDistrict#Table
...
/**
 * Name: edemokracia::service::UserIssues.activeIssuesInResidentDistrict#Table
 * Is Access: false
 * Type: Table
 **/
export default function ServiceUserIssuesActiveIssuesInResidentDistrictTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInResidentDistrictTable-data-grid">
                  <Issue_TableTable
                    ref={tableRef}
