...
export function DistrictLink(props: DistrictLinkProps) {
  ...
  const districtRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesGlobalViewDefaultIssueViewEditOtherAreaAreaDistrictRepresentationFilter',
  ...
  return (
    <AggregationInput
      name="district"
      id="LinkedemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesGlobalViewDefaultIssueViewEditOtherAreaAreaDistrict"
