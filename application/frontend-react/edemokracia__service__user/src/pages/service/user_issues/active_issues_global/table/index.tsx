...
// Page name: edemokracia::service::UserIssues.activeIssuesGlobal#Table
...
/**
 * Name: edemokracia::service::UserIssues.activeIssuesGlobal#Table
 * Is Access: false
 * Type: Table
 **/
export default function ServiceUserIssuesActiveIssuesGlobalTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesGlobalTable-data-grid">
                  <Issue_TableTable
                    ref={tableRef}
