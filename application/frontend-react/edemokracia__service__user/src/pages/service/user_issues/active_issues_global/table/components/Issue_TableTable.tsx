...
export const Issue_TableTable = forwardRef<RefreshableTable, Issue_TableTableProps>((props, ref) => {
  ...
  const activeIssuesGlobalColumns: GridColDef<ServiceIssueStored>[] = [
    ...
    },
    {
      ...
      headerName: t('service.IssueTable.activeIssuesGlobal.numberOfDebates', { defaultValue: 'Debates' }) as string,
      headerClassName: 'data-grid-column-header',
  ...
  const activeIssuesGlobalRangeFilterOptions: FilterOption[] = [
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesGlobalTableDefaultActiveIssuesGlobalIssueTableNumberOfDebatesFilter',
      attributeName: 'numberOfDebates',
      label: t('service.IssueTable.activeIssuesGlobal.numberOfDebates', { defaultValue: 'Debates' }) as string,
  ...
  const rowActions: TableRowAction<ServiceIssueStored>[] = [
    {
      id: 'CallOperationActionedemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesGlobalTableEdemokraciaServiceUserEdemokraciaServiceIssueCreateDebateButtonCallOperation',
      label: t('service.IssueTable.activeIssuesGlobal.createDebate.ButtonCallOperation', {
