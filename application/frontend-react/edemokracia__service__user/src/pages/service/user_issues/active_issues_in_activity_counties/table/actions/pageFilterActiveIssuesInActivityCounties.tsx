...
export type PageFilterActiveIssuesInActivityCountiesAction = (
  id: string,
  filterOptions: FilterOption[],
  filters: Filter[],
) => Promise<void>;

export const usePageFilterActiveIssuesInActivityCountiesAction = (
  ...
  return async function pageFilterActiveIssuesInActivityCountiesAction(
    id: string,
    filterOptions: FilterOption[],
    filters: Filter[],
  ) {
