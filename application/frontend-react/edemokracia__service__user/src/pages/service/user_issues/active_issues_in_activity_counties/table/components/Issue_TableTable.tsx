...
export const Issue_TableTable = forwardRef<RefreshableTable, Issue_TableTableProps>((props, ref) => {
  ...
  const activeIssuesInActivityCountiesColumns: GridColDef<ServiceIssueStored>[] = [
    ...
    },
    {
      ...
      headerName: t('service.IssueTable.activeIssuesInActivityCounties.numberOfDebates', {
  ...
  const activeIssuesInActivityCountiesRangeFilterOptions: FilterOption[] = [
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInActivityCountiesTableDefaultActiveIssuesInActivityCountiesIssueTableNumberOfDebatesFilter',
      attributeName: 'numberOfDebates',
      label: t('service.IssueTable.activeIssuesInActivityCounties.numberOfDebates', {
        defaultValue: 'Debates',
      }) as string,
  ...
  const rowActions: TableRowAction<ServiceIssueStored>[] = [
    {
      id: 'CallOperationActionedemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInActivityCountiesTableEdemokraciaServiceUserEdemokraciaServiceIssueCreateDebateButtonCallOperation',
      label: t('service.IssueTable.activeIssuesInActivityCounties.createDebate.ButtonCallOperation', {
