...
import ServiceUserView from '~/pages/service/issue/cons/view/index';
...
export const useRowViewConsAction: RowViewConsAction = () => {
  ...
  return async function (owner: JudoIdentifiable<ServiceIssue>, entry: ServiceConStored, successCallback: () => void) {
    createDialog({
      fullWidth: true,
      maxWidth: 'xl',
