...
export const SERVICE_USER_ISSUES_OWNED_ISSUES_VIEW_CONS = 'ServiceUserIssuesOwnedIssuesViewCons';
...
export const ConsTable = (props: ConsTableProps) => {
  ...
  const filterModelKey = `TableedemokraciaServiceUserEdemokraciaServiceUserIssuesOwnedIssuesViewDefaultIssueViewEditOtherArgumentsArgumentsConsLabelWrapperConsTableConsLabelWrapperCons-${ownerData.__identifier}-filterModel`;
  const filtersKey = `TableedemokraciaServiceUserEdemokraciaServiceUserIssuesOwnedIssuesViewDefaultIssueViewEditOtherArgumentsArgumentsConsLabelWrapperConsTableConsLabelWrapperCons-${ownerData.__identifier}-filters`;
  ...
  const consRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserIssuesOwnedIssuesViewDefaultIssueViewEditOtherArgumentsArgumentsConsLabelWrapperConsTableConsLabelWrapperConsTitleFilter',
      attributeName: 'title',
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserIssuesOwnedIssuesViewDefaultIssueViewEditOtherArgumentsArgumentsConsLabelWrapperConsTableConsLabelWrapperConsUpVotesFilter',
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserIssuesOwnedIssuesViewDefaultIssueViewEditOtherArgumentsArgumentsConsLabelWrapperConsTableConsLabelWrapperConsDownVotesFilter',
  ...
  const consRowActions: TableRowAction<ServiceConStored>[] = [
    {
      id: 'DeleteActionedemokraciaServiceUserEdemokraciaServiceUserIssuesOwnedIssuesViewEdemokraciaServiceUserEdemokraciaServiceIssueConsRowDelete',
    ...
    {
      id: 'CallOperationActionedemokraciaServiceUserEdemokraciaServiceUserIssuesOwnedIssuesViewEdemokraciaServiceUserEdemokraciaServiceConVoteUpButtonCallOperation',
    ...
    {
      id: 'CallOperationActionedemokraciaServiceUserEdemokraciaServiceUserIssuesOwnedIssuesViewEdemokraciaServiceUserEdemokraciaServiceConVoteDownButtonCallOperation',
    ...
    {
      id: 'CallOperationActionedemokraciaServiceUserEdemokraciaServiceUserIssuesOwnedIssuesViewEdemokraciaServiceUserEdemokraciaServiceConCreateProArgumentButtonCallOperation',
    ...
    {
      id: 'CallOperationActionedemokraciaServiceUserEdemokraciaServiceUserIssuesOwnedIssuesViewEdemokraciaServiceUserEdemokraciaServiceConCreateConArgumentButtonCallOperation',
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              <Button
                id="TableedemokraciaServiceUserEdemokraciaServiceUserIssuesOwnedIssuesViewDefaultIssueViewEditOtherArgumentsArgumentsConsLabelWrapperConsTableConsLabelWrapperCons-filter"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() =>
                  filter(
                    'TableedemokraciaServiceUserEdemokraciaServiceUserIssuesOwnedIssuesViewDefaultIssueViewEditOtherArgumentsArgumentsConsLabelWrapperConsTableConsLabelWrapperCons-filter',
                    filterOptions,
                    filters,
                  )
                }
