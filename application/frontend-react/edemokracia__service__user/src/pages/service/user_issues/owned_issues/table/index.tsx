...
// Page name: edemokracia::service::UserIssues.ownedIssues#Table
...
/**
 * Name: edemokracia::service::UserIssues.ownedIssues#Table
 * Is Access: false
 * Type: Table
 **/
export default function ServiceUserIssuesOwnedIssuesTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaServiceUserEdemokraciaServiceUserIssuesOwnedIssuesTable-data-grid">
                  <Issue_TableTable
                    ref={tableRef}
