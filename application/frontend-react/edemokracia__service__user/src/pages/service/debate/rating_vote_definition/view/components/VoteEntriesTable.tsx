...
export const SERVICE_DEBATE_RATING_VOTE_DEFINITION_VIEW_VOTE_ENTRIES =
  'ServiceDebateRatingVoteDefinitionViewVoteEntries';
...
export const VoteEntriesTable = forwardRef<RefreshableTable, VoteEntriesTableProps>((props, ref) => {
  ...
  const filterModelKey = `TableedemokraciaServiceUserEdemokraciaServiceDebateRatingVoteDefinitionViewDefaultRatingVoteDefinitionViewEditEntriesLabelWrapperEntriesVoteEntriesLabelWrapperVoteEntries-${ownerData.__signedIdentifier}-filterModel`;
  const filtersKey = `TableedemokraciaServiceUserEdemokraciaServiceDebateRatingVoteDefinitionViewDefaultRatingVoteDefinitionViewEditEntriesLabelWrapperEntriesVoteEntriesLabelWrapperVoteEntries-${ownerData.__signedIdentifier}-filters`;
  ...
  const voteEntriesRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceDebateRatingVoteDefinitionViewDefaultRatingVoteDefinitionViewEditEntriesLabelWrapperEntriesVoteEntriesLabelWrapperVoteEntriesCreatedFilter',
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceDebateRatingVoteDefinitionViewDefaultRatingVoteDefinitionViewEditEntriesLabelWrapperEntriesVoteEntriesLabelWrapperVoteEntriesCreatedByFilter',
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceDebateRatingVoteDefinitionViewDefaultRatingVoteDefinitionViewEditEntriesLabelWrapperEntriesVoteEntriesLabelWrapperVoteEntriesValueFilter',
      attributeName: 'value',
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              <Button
                id="FilterRelationActionedemokraciaServiceUserEdemokraciaServiceDebateRatingVoteDefinitionViewEdemokraciaServiceUserEdemokraciaServiceRatingVoteDefinitionVoteEntriesTableAction"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() => {
                  tableActionVoteEntriesAction(
                    'FilterRelationActionedemokraciaServiceUserEdemokraciaServiceDebateRatingVoteDefinitionViewEdemokraciaServiceUserEdemokraciaServiceRatingVoteDefinitionVoteEntriesTableAction-filter',
                    filterOptions,
                    filters,
                  );
                }}
