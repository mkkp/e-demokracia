...
// Page name: edemokracia::service::Debate.ratingVoteDefinition#View
...
export type ServiceDebateRatingVoteDefinitionViewPostRefreshAction = (
...
export const SERVICE_DEBATE_RATING_VOTE_DEFINITION_VIEW_POST_REFRESH_HOOK_INTERFACE_KEY =
  'ServiceDebateRatingVoteDefinitionViewPostRefreshHook';
export type ServiceDebateRatingVoteDefinitionViewPostRefreshHook =
  () => ServiceDebateRatingVoteDefinitionViewPostRefreshAction;

/**
 * Name: edemokracia::service::Debate.ratingVoteDefinition#View
 * Is Access: false
 * Type: View
 * Edit Mode Available: false
 **/
export default function ServiceDebateRatingVoteDefinitionView() {
  ...
  const { service: postRefreshHook } = useTrackService<ServiceDebateRatingVoteDefinitionViewPostRefreshHook>(
    `(${OBJECTCLASS}=${SERVICE_DEBATE_RATING_VOTE_DEFINITION_VIEW_POST_REFRESH_HOOK_INTERFACE_KEY})`,
  );
  const postRefreshAction: ServiceDebateRatingVoteDefinitionViewPostRefreshAction | undefined =
  ...
  async function fetchData() {
    ...
    try {
      const res = await serviceRatingVoteDefinitionServiceForClassImpl.refresh(
        { __signedIdentifier: signedIdentifier } as JudoIdentifiable<ServiceRatingVoteDefinition>,
        ...
        <Box sx={mainContainerPadding}>
          ...
          >
            <Grid item xs={12} sm={12}>
              <Card id="FlexedemokraciaServiceUserEdemokraciaServiceDebateRatingVoteDefinitionViewDefaultRatingVoteDefinitionViewEditVoteEntryBase">
                <CardContent>
                  <Grid container direction="column" alignItems="stretch" justifyContent="flex-start" spacing={2}>
                    <Grid item xs={12} sm={12}>
                      <Grid
                        id="FlexedemokraciaServiceUserEdemokraciaServiceDebateRatingVoteDefinitionViewDefaultRatingVoteDefinitionViewEditVoteEntryBaseVirtual"
                        container
                        direction="row"
                      ...
                      >
                        <Grid item xs={12} sm={12}>
                          <TextField
                            required={true}
                            name="title"
                            id="TextInputedemokraciaServiceUserEdemokraciaServiceDebateRatingVoteDefinitionViewDefaultRatingVoteDefinitionViewEditVoteEntryBaseVirtualTitle"
                        ...
                        <Grid item xs={12} sm={12} md={4.0}>
                          <DateTimePicker
                            ...
                            slotProps={{
                              textField: {
                                id: 'DateTimeInputedemokraciaServiceUserEdemokraciaServiceDebateRatingVoteDefinitionViewDefaultRatingVoteDefinitionViewEditVoteEntryBaseVirtualCloseAt',
                                required: true,
                        ...
                        <Grid item xs={12} sm={12} md={4.0}>
                          <TextField
                            required={true}
                            name="status"
                            id="EnumerationComboedemokraciaServiceUserEdemokraciaServiceDebateRatingVoteDefinitionViewDefaultRatingVoteDefinitionViewEditVoteEntryBaseVirtualStatus"
                        ...
                        <Grid item xs={12} sm={12} md={6.0}>
                          <AssociationButton
                            id="NavigationToPageActionedemokraciaServiceUserEdemokraciaServiceDebateRatingVoteDefinitionViewEdemokraciaServiceUserEdemokraciaServiceRatingVoteDefinitionDebateButtonNavigate"
                            variant={undefined}
                            editMode={editMode}
                        ...
                        <Grid item xs={12} sm={12} md={6.0}>
                          <AssociationButton
                            id="NavigationToPageActionedemokraciaServiceUserEdemokraciaServiceDebateRatingVoteDefinitionViewEdemokraciaServiceUserEdemokraciaServiceRatingVoteDefinitionIssueButtonNavigate"
                            variant={undefined}
                            editMode={editMode}
                        ...
                        <Grid item xs={12} sm={12} md={4.0}>
                          <DateTimePicker
                            ...
                            slotProps={{
                              textField: {
                                id: 'DateTimeInputedemokraciaServiceUserEdemokraciaServiceDebateRatingVoteDefinitionViewDefaultRatingVoteDefinitionViewEditVoteEntryBaseVirtualCreated',
                                required: true,
                        ...
                        <Grid item xs={12} sm={12}>
                          <TextField
                            required={true}
                            name="description"
                            id="TextAreaedemokraciaServiceUserEdemokraciaServiceDebateRatingVoteDefinitionViewDefaultRatingVoteDefinitionViewEditVoteEntryBaseVirtualDescription"
                            label={
                        ...
                        <Grid item xs={12} sm={12} md={2.0}>
                          <NumericInput
                            required={false}
                            name="maxRateValue"
                            id="NumericInputedemokraciaServiceUserEdemokraciaServiceDebateRatingVoteDefinitionViewDefaultRatingVoteDefinitionViewEditVoteEntryBaseVirtualMaxRateValue"
                            label={
                        ...
                        <Grid item xs={12} sm={12} md={2.0}>
                          <NumericInput
                            required={false}
                            name="minRateValue"
                            id="NumericInputedemokraciaServiceUserEdemokraciaServiceDebateRatingVoteDefinitionViewDefaultRatingVoteDefinitionViewEditVoteEntryBaseVirtualMinRateValue"
                            label={
            ...
            <Grid item xs={12} sm={12}>
              <Card id="FlexedemokraciaServiceUserEdemokraciaServiceDebateRatingVoteDefinitionViewDefaultRatingVoteDefinitionViewEditUserVoteEntryGroupLabelWrapper">
                <CardContent>
                  <Grid container direction="column" alignItems="stretch" justifyContent="flex-start" spacing={2}>
                    <Grid item xs={12} sm={12}>
                      <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                        <Typography
                          id="LabeledemokraciaServiceUserEdemokraciaServiceDebateRatingVoteDefinitionViewDefaultRatingVoteDefinitionViewEditUserVoteEntryGroupLabelWrapperUserVoteEntryGroupLabel"
                          variant="h5"
                          component="h1"
                        >
                    ...
                    <Grid item xs={12} sm={12}>
                      <Grid
                        id="FlexedemokraciaServiceUserEdemokraciaServiceDebateRatingVoteDefinitionViewDefaultRatingVoteDefinitionViewEditUserVoteEntryGroupLabelWrapperUserVoteEntryGroup"
                        container
                        direction="row"
                        alignItems="stretch"
                        justifyContent="flex-start"
                      ...
                      >
                        {!data.userHasNoVoteEntry && (
                          <Grid item xs={12} sm={12}>
                            <Grid
                              id="FlexedemokraciaServiceUserEdemokraciaServiceDebateRatingVoteDefinitionViewDefaultRatingVoteDefinitionViewEditUserVoteEntryGroupLabelWrapperUserVoteEntryGroupUserVote"
                              container
                              direction="row"
                              alignItems="flex-start"
                              justifyContent="flex-start"
                            ...
                            >
                              <Grid item xs={12} sm={12}>
                                <Grid
                                  id="FlexedemokraciaServiceUserEdemokraciaServiceDebateRatingVoteDefinitionViewDefaultRatingVoteDefinitionViewEditUserVoteEntryGroupLabelWrapperUserVoteEntryGroupUserVoteVirtualForUserVote"
                                  container
                                  direction="row"
                                  alignItems="flex-start"
                                  justifyContent="flex-start"
                                ...
                                >
                                  <Grid item xs={12} sm={12} md={2.0}>
                                    <LoadingButton
                                      id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceDebateRatingVoteDefinitionViewEdemokraciaServiceUserEdemokraciaServiceRatingVoteDefinitionTakeBackVoteButtonCallOperation"
                                      loading={isLoading}
                                      variant={undefined}
                        ...
                        {!data.userHasVoteEntry && (
                          <Grid item xs={12} sm={12}>
                            <Grid
                              id="FlexedemokraciaServiceUserEdemokraciaServiceDebateRatingVoteDefinitionViewDefaultRatingVoteDefinitionViewEditUserVoteEntryGroupLabelWrapperUserVoteEntryGroupTakeVote"
                              container
                              direction="row"
                              alignItems="flex-start"
                              justifyContent="flex-start"
                            ...
                            >
                              <Grid item xs={12} sm={12} md={2.0}>
                                <LoadingButton
                                  id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceDebateRatingVoteDefinitionViewEdemokraciaServiceUserEdemokraciaServiceRatingVoteDefinitionVoteButtonCallOperation"
                                  loading={isLoading}
                                  variant={undefined}
            ...
            <Grid item xs={12} sm={12}>
              <Grid
                id="FlexedemokraciaServiceUserEdemokraciaServiceDebateRatingVoteDefinitionViewDefaultRatingVoteDefinitionViewEditEntriesLabelWrapper"
                container
                direction="column"
                alignItems="flex-start"
                justifyContent="flex-start"
              ...
              >
                <Grid item xs={12} sm={12}>
                  <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                    <Typography
                      id="LabeledemokraciaServiceUserEdemokraciaServiceDebateRatingVoteDefinitionViewDefaultRatingVoteDefinitionViewEditEntriesLabelWrapperEntriesLabel"
                      variant="h5"
                      component="h1"
                    >
                ...
                <Grid item xs={12} sm={12}>
                  <Grid
                    id="FlexedemokraciaServiceUserEdemokraciaServiceDebateRatingVoteDefinitionViewDefaultRatingVoteDefinitionViewEditEntriesLabelWrapperEntries"
                    container
                    direction="row"
                    alignItems="stretch"
                    justifyContent="flex-start"
                  ...
                  >
                    <Grid item xs={12} sm={12}>
                      <Grid
                        id="FlexedemokraciaServiceUserEdemokraciaServiceDebateRatingVoteDefinitionViewDefaultRatingVoteDefinitionViewEditEntriesLabelWrapperEntriesVoteEntriesLabelWrapper"
                        container
                        direction="column"
                        alignItems="stretch"
                        justifyContent="flex-start"
                      ...
                      >
                        <Grid item xs={12} sm={12}>
                          <Grid
                            id="TableedemokraciaServiceUserEdemokraciaServiceDebateRatingVoteDefinitionViewDefaultRatingVoteDefinitionViewEditEntriesLabelWrapperEntriesVoteEntriesLabelWrapperVoteEntries"
                            container
                            direction="column"
                            alignItems="stretch"
                            justifyContent="flex-start"
