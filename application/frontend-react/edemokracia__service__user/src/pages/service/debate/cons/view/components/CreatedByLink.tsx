...
import { serviceConServiceForClassImpl, serviceServiceUserServiceForClassImpl } from '~/generated/data-axios';
import { useLinkViewCreatedByAction } from '../actions';

export type CreatedByLinkFilterInitializer = (ownerData: ServiceConStored) => Filter[] | undefined;
...
export interface CreatedByLinkProps {
  ...
  validation: Map<keyof ServiceConStored, string>;
...
export function CreatedByLink(props: CreatedByLinkProps) {
  ...
  return (
    <AggregationInput
      name="createdBy"
      id="LinkedemokraciaServiceUserEdemokraciaServiceDebateConsViewDefaultConViewEditConLabelWrapperConCreatedBy"
      label={t('service.ConView.createdBy', { defaultValue: 'Created by' }) as string}
