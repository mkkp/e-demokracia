...
export function ResidentCityLink(props: ResidentCityLinkProps) {
  ...
  const residentCityRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceDebateCreatedByViewDefaultServiceUserViewEditAreasLabelWrapperAreasResidencyResidentCityRepresentationFilter',
  ...
  return (
    <AggregationInput
      name="residentCity"
      id="LinkedemokraciaServiceUserEdemokraciaServiceDebateCreatedByViewDefaultServiceUserViewEditAreasLabelWrapperAreasResidencyResidentCity"
