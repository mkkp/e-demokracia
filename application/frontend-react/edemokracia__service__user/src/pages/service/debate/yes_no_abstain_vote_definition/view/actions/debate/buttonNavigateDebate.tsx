...
import { routeToServiceYesNoAbstainVoteDefinitionDebateView } from '~/routes';
...
export const useButtonNavigateDebateAction: ButtonNavigateDebateAction = () => {
  ...
  return async function (
    ...
    navigate(routeToServiceYesNoAbstainVoteDefinitionDebateView(target.__signedIdentifier));
  };
};
