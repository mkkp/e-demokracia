...
import { routeToServiceYesNoAbstainVoteDefinitionIssueView } from '~/routes';
...
export const useButtonNavigateIssueAction: ButtonNavigateIssueAction = () => {
  ...
  return async function (
    ...
    navigate(routeToServiceYesNoAbstainVoteDefinitionIssueView(target.__signedIdentifier));
  };
};
