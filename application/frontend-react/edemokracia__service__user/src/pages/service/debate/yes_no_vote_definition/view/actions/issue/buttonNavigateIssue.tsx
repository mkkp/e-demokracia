...
import { routeToServiceYesNoVoteDefinitionIssueView } from '~/routes';
...
export const useButtonNavigateIssueAction: ButtonNavigateIssueAction = () => {
  ...
  return async function (owner: JudoIdentifiable<ServiceYesNoVoteDefinition>, target: JudoIdentifiable<ServiceIssue>) {
    navigate(routeToServiceYesNoVoteDefinitionIssueView(target.__signedIdentifier));
  };
};
