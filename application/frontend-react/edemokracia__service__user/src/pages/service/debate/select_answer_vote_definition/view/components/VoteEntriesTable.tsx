...
export const SERVICE_DEBATE_SELECT_ANSWER_VOTE_DEFINITION_VIEW_VOTE_ENTRIES =
  'ServiceDebateSelectAnswerVoteDefinitionViewVoteEntries';
...
export const VoteEntriesTable = forwardRef<RefreshableTable, VoteEntriesTableProps>((props, ref) => {
  ...
  const filterModelKey = `TableedemokraciaServiceUserEdemokraciaServiceDebateSelectAnswerVoteDefinitionViewDefaultSelectAnswerVoteDefinitionViewEditEntriesLabelWrapperEntriesVoteEntriesLabelWrapperVoteEntries-${ownerData.__signedIdentifier}-filterModel`;
  const filtersKey = `TableedemokraciaServiceUserEdemokraciaServiceDebateSelectAnswerVoteDefinitionViewDefaultSelectAnswerVoteDefinitionViewEditEntriesLabelWrapperEntriesVoteEntriesLabelWrapperVoteEntries-${ownerData.__signedIdentifier}-filters`;
  ...
  const voteEntriesRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceDebateSelectAnswerVoteDefinitionViewDefaultSelectAnswerVoteDefinitionViewEditEntriesLabelWrapperEntriesVoteEntriesLabelWrapperVoteEntriesCreatedFilter',
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceDebateSelectAnswerVoteDefinitionViewDefaultSelectAnswerVoteDefinitionViewEditEntriesLabelWrapperEntriesVoteEntriesLabelWrapperVoteEntriesCreatedByFilter',
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceDebateSelectAnswerVoteDefinitionViewDefaultSelectAnswerVoteDefinitionViewEditEntriesLabelWrapperEntriesVoteEntriesLabelWrapperVoteEntriesValueRepresentationFilter',
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              <Button
                id="FilterRelationActionedemokraciaServiceUserEdemokraciaServiceDebateSelectAnswerVoteDefinitionViewEdemokraciaServiceUserEdemokraciaServiceSelectAnswerVoteDefinitionVoteEntriesTableAction"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() => {
                  tableActionVoteEntriesAction(
                    'FilterRelationActionedemokraciaServiceUserEdemokraciaServiceDebateSelectAnswerVoteDefinitionViewEdemokraciaServiceUserEdemokraciaServiceSelectAnswerVoteDefinitionVoteEntriesTableAction-filter',
                    filterOptions,
                    filters,
                  );
                }}
