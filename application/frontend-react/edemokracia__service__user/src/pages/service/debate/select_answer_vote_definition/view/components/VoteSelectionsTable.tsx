...
export const SERVICE_DEBATE_SELECT_ANSWER_VOTE_DEFINITION_VIEW_VOTE_SELECTIONS =
  'ServiceDebateSelectAnswerVoteDefinitionViewVoteSelections';
...
export const VoteSelectionsTable = (props: VoteSelectionsTableProps) => {
  ...
  const filterModelKey = `TableedemokraciaServiceUserEdemokraciaServiceDebateSelectAnswerVoteDefinitionViewDefaultSelectAnswerVoteDefinitionViewEditVoteEntryBaseVirtualVoteSelectionsLabelWrapperVoteSelections-${ownerData.__identifier}-filterModel`;
  const filtersKey = `TableedemokraciaServiceUserEdemokraciaServiceDebateSelectAnswerVoteDefinitionViewDefaultSelectAnswerVoteDefinitionViewEditVoteEntryBaseVirtualVoteSelectionsLabelWrapperVoteSelections-${ownerData.__identifier}-filters`;
  ...
  const voteSelectionsRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceDebateSelectAnswerVoteDefinitionViewDefaultSelectAnswerVoteDefinitionViewEditVoteEntryBaseVirtualVoteSelectionsLabelWrapperVoteSelectionsDescriptionFilter',
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceDebateSelectAnswerVoteDefinitionViewDefaultSelectAnswerVoteDefinitionViewEditVoteEntryBaseVirtualVoteSelectionsLabelWrapperVoteSelectionsTitleFilter',
      attributeName: 'title',
  ...
  const voteSelectionsRowActions: TableRowAction<ServiceSelectAnswerVoteSelectionStored>[] = [
    {
      id: 'DeleteActionedemokraciaServiceUserEdemokraciaServiceDebateSelectAnswerVoteDefinitionViewEdemokraciaServiceUserEdemokraciaServiceSelectAnswerVoteDefinitionVoteSelectionsRowDelete',
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              <Button
                id="CreateActionedemokraciaServiceUserEdemokraciaServiceDebateSelectAnswerVoteDefinitionViewEdemokraciaServiceUserEdemokraciaServiceSelectAnswerVoteDefinitionVoteSelectionsTableCreate"
              ...
              <Button
                id="TableedemokraciaServiceUserEdemokraciaServiceDebateSelectAnswerVoteDefinitionViewDefaultSelectAnswerVoteDefinitionViewEditVoteEntryBaseVirtualVoteSelectionsLabelWrapperVoteSelections-filter"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() =>
                  filter(
                    'TableedemokraciaServiceUserEdemokraciaServiceDebateSelectAnswerVoteDefinitionViewDefaultSelectAnswerVoteDefinitionViewEditVoteEntryBaseVirtualVoteSelectionsLabelWrapperVoteSelections-filter',
                    filterOptions,
                    filters,
                  )
                }
