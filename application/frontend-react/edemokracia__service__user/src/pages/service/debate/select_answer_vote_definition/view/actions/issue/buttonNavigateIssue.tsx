...
import { routeToServiceSelectAnswerVoteDefinitionIssueView } from '~/routes';
...
export const useButtonNavigateIssueAction: ButtonNavigateIssueAction = () => {
  ...
  return async function (
    ...
    navigate(routeToServiceSelectAnswerVoteDefinitionIssueView(target.__signedIdentifier));
  };
};
