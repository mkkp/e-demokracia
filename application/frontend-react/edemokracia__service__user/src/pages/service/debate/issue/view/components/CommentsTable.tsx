...
export const SERVICE_DEBATE_ISSUE_VIEW_COMMENTS = 'ServiceDebateIssueViewComments';
...
export const CommentsTable = (props: CommentsTableProps) => {
  ...
  const filterModelKey = `TableedemokraciaServiceUserEdemokraciaServiceDebateIssueViewDefaultIssueViewEditOtherCommentsCommentsActionsCommentsLabelWrapperComments-${ownerData.__identifier}-filterModel`;
  const filtersKey = `TableedemokraciaServiceUserEdemokraciaServiceDebateIssueViewDefaultIssueViewEditOtherCommentsCommentsActionsCommentsLabelWrapperComments-${ownerData.__identifier}-filters`;
  ...
  const commentsRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceDebateIssueViewDefaultIssueViewEditOtherCommentsCommentsActionsCommentsLabelWrapperCommentsCommentFilter',
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceDebateIssueViewDefaultIssueViewEditOtherCommentsCommentsActionsCommentsLabelWrapperCommentsCreatedFilter',
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceDebateIssueViewDefaultIssueViewEditOtherCommentsCommentsActionsCommentsLabelWrapperCommentsCreatedByNameFilter',
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceDebateIssueViewDefaultIssueViewEditOtherCommentsCommentsActionsCommentsLabelWrapperCommentsUpVotesFilter',
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceDebateIssueViewDefaultIssueViewEditOtherCommentsCommentsActionsCommentsLabelWrapperCommentsDownVotesFilter',
  ...
  const commentsRowActions: TableRowAction<ServiceCommentStored>[] = [
    {
      id: 'CallOperationActionedemokraciaServiceUserEdemokraciaServiceDebateIssueViewEdemokraciaServiceUserEdemokraciaServiceCommentVoteUpButtonCallOperation',
    ...
    {
      id: 'CallOperationActionedemokraciaServiceUserEdemokraciaServiceDebateIssueViewEdemokraciaServiceUserEdemokraciaServiceCommentVoteDownButtonCallOperation',
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              <Button
                id="TableedemokraciaServiceUserEdemokraciaServiceDebateIssueViewDefaultIssueViewEditOtherCommentsCommentsActionsCommentsLabelWrapperComments-filter"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() =>
                  filter(
                    'TableedemokraciaServiceUserEdemokraciaServiceDebateIssueViewDefaultIssueViewEditOtherCommentsCommentsActionsCommentsLabelWrapperComments-filter',
                    filterOptions,
                    filters,
                  )
                }
