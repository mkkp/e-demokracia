...
import { serviceProServiceForClassImpl, serviceServiceUserServiceForClassImpl } from '~/generated/data-axios';
import { useLinkViewCreatedByAction } from '../actions';

export type CreatedByLinkFilterInitializer = (ownerData: ServiceProStored) => Filter[] | undefined;
...
export interface CreatedByLinkProps {
  ...
  validation: Map<keyof ServiceProStored, string>;
...
export function CreatedByLink(props: CreatedByLinkProps) {
  ...
  return (
    <AggregationInput
      name="createdBy"
      id="LinkedemokraciaServiceUserEdemokraciaServiceDebateProsViewDefaultProViewEditProLabelWrapperProCreatedBy"
      label={t('service.ProView.createdBy', { defaultValue: 'Created by' }) as string}
