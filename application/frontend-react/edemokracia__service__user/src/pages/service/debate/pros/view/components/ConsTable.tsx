...
export const SERVICE_DEBATE_PROS_VIEW_CONS = 'ServiceDebateProsViewCons';
...
export const ConsTable = (props: ConsTableProps) => {
  ...
  const filterModelKey = `TableedemokraciaServiceUserEdemokraciaServiceDebateProsViewDefaultProViewEditTabBarArgumentsArgumentsConsLabelWrapperCons-${ownerData.__identifier}-filterModel`;
  const filtersKey = `TableedemokraciaServiceUserEdemokraciaServiceDebateProsViewDefaultProViewEditTabBarArgumentsArgumentsConsLabelWrapperCons-${ownerData.__identifier}-filters`;
  ...
  const consColumns: GridColDef<ServiceConStored>[] = [
    {
      ...baseColumnConfig,
      field: 'title',
      headerName: t('service.ProView.cons.title', { defaultValue: 'Title' }) as string,
    ...
    },
    {
      ...baseColumnConfig,
      field: 'upVotes',
      headerName: t('service.ProView.cons.upVotes', { defaultValue: 'up' }) as string,
      headerClassName: 'data-grid-column-header',
    ...
    },
    {
      ...baseColumnConfig,
      field: 'downVotes',
      headerName: t('service.ProView.cons.downVotes', { defaultValue: 'down' }) as string,
      headerClassName: 'data-grid-column-header',
  ...
  const consRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceDebateProsViewDefaultProViewEditTabBarArgumentsArgumentsConsLabelWrapperConsTitleFilter',
      attributeName: 'title',
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceDebateProsViewDefaultProViewEditTabBarArgumentsArgumentsConsLabelWrapperConsUpVotesFilter',
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceDebateProsViewDefaultProViewEditTabBarArgumentsArgumentsConsLabelWrapperConsDownVotesFilter',
  ...
  const consRowActions: TableRowAction<ServiceConStored>[] = [
    {
      id: 'DeleteActionedemokraciaServiceUserEdemokraciaServiceDebateProsViewEdemokraciaServiceUserEdemokraciaServiceProConsRowDelete',
    ...
    {
      id: 'CallOperationActionedemokraciaServiceUserEdemokraciaServiceDebateProsViewEdemokraciaServiceUserEdemokraciaServiceConVoteUpButtonCallOperation',
      label: t('service.ProView.cons.voteUp.ButtonCallOperation', { defaultValue: '' }) as string,
      icon: <MdiIcon path="thumb-up" />,
      action: async (row: ServiceConStored) => serviceConVoteUpAction(row, () => fetchOwnerData()),
      disabled: (row: ServiceConStored) => editMode,
    },
    {
      id: 'CallOperationActionedemokraciaServiceUserEdemokraciaServiceDebateProsViewEdemokraciaServiceUserEdemokraciaServiceConVoteDownButtonCallOperation',
      label: t('service.ProView.cons.voteDown.ButtonCallOperation', { defaultValue: '' }) as string,
      icon: <MdiIcon path="thumb-down" />,
      action: async (row: ServiceConStored) => serviceConVoteDownAction(row, () => fetchOwnerData()),
      disabled: (row: ServiceConStored) => editMode,
    },
    {
      id: 'CallOperationActionedemokraciaServiceUserEdemokraciaServiceDebateProsViewEdemokraciaServiceUserEdemokraciaServiceConCreateSubArgumentButtonCallOperation',
    ...
    {
      id: 'CallOperationActionedemokraciaServiceUserEdemokraciaServiceDebateProsViewEdemokraciaServiceUserEdemokraciaServiceConCreateCommentButtonCallOperation',
  ...
  return (
    <>
      <StripedDataGrid
        ...
        columns={[
          ...consColumns,
          ...columnsActionCalculator('RelationTypeedemokraciaServiceUserEdemokraciaServiceProCons', consRowActions, t, {
            shownActions: 2,
          }),
        ]}
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              <Button
                id="TableedemokraciaServiceUserEdemokraciaServiceDebateProsViewDefaultProViewEditTabBarArgumentsArgumentsConsLabelWrapperCons-filter"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() =>
                  filter(
                    'TableedemokraciaServiceUserEdemokraciaServiceDebateProsViewDefaultProViewEditTabBarArgumentsArgumentsConsLabelWrapperCons-filter',
                    filterOptions,
                    filters,
                  )
                }
              ...
              {isBulkDeleteAvailable() ? (
                <Button
                  id="RelationTypeedemokraciaServiceUserEdemokraciaServiceProCons-bulk-delete"
