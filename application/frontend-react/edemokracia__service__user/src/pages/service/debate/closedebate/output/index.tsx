...
// Page name: edemokracia::service::Debate.closeDebate#Output
...
export type ServiceDebateClosedebateOutputPostRefreshAction = (
...
export const SERVICE_DEBATE_CLOSEDEBATE_OUTPUT_POST_REFRESH_HOOK_INTERFACE_KEY =
  'ServiceDebateClosedebateOutputPostRefreshHook';
export type ServiceDebateClosedebateOutputPostRefreshHook = () => ServiceDebateClosedebateOutputPostRefreshAction;

/**
 * Name: edemokracia::service::Debate.closeDebate#Output
 * Is Operation Output: true
 * Type: OperationOutput
 **/
export default function ServiceDebateClosedebateOutput() {
  ...
  const storeDiff: (attributeName: keyof CloseDebateOutputVoteDefinitionReferenceStored, value: any) => void =
    useCallback(
      (attributeName: keyof CloseDebateOutputVoteDefinitionReferenceStored, value: any) => {
  ...
  const { service: postRefreshHook } = useTrackService<ServiceDebateClosedebateOutputPostRefreshHook>(
    `(${OBJECTCLASS}=${SERVICE_DEBATE_CLOSEDEBATE_OUTPUT_POST_REFRESH_HOOK_INTERFACE_KEY})`,
  );
  const postRefreshAction: ServiceDebateClosedebateOutputPostRefreshAction | undefined =
          ...
          >
            <Grid item xs={12} sm={12}>
              <TextField
                required={false}
                name="context"
                id="TextInputedemokraciaServiceUserEdemokraciaServiceDebateCloseDebateOutputDefaultCloseDebateOutputVoteDefinitionReferenceViewEditContext"
                label={t('CloseDebateOutputVoteDefinitionReferenceView.context', { defaultValue: 'Context' }) as string}
                value={data.context ?? ''}
                className={clsx({
