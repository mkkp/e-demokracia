...
import { serviceCommentServiceForClassImpl, serviceServiceUserServiceForClassImpl } from '~/generated/data-axios';
import { useLinkViewCreatedByAction } from '../actions';

export type CreatedByLinkFilterInitializer = (ownerData: ServiceCommentStored) => Filter[] | undefined;
...
export interface CreatedByLinkProps {
  ownerData: ServiceCommentStored;
  validation: Map<keyof ServiceCommentStored, string>;
...
export function CreatedByLink(props: CreatedByLinkProps) {
  ...
  return (
    <AggregationInput
      name="createdBy"
      id="LinkedemokraciaServiceUserEdemokraciaServiceDebateCommentsViewDefaultCommentViewEditGroupLabelWrapperGroupCreatedBy"
      label={t('service.CommentView.createdBy', { defaultValue: 'CreatedBy' }) as string}
