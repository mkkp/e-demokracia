...
// Page name: edemokracia::service::Debate.comments#View
...
export type ServiceDebateCommentsViewPostRefreshAction = (
...
export const SERVICE_DEBATE_COMMENTS_VIEW_POST_REFRESH_HOOK_INTERFACE_KEY = 'ServiceDebateCommentsViewPostRefreshHook';
export type ServiceDebateCommentsViewPostRefreshHook = () => ServiceDebateCommentsViewPostRefreshAction;

/**
 * Name: edemokracia::service::Debate.comments#View
 * Is Access: false
 * Type: View
 * Edit Mode Available: true
 **/
export default function ServiceDebateCommentsView() {
  ...
  const handleUpdateError = useErrorHandler<ServiceComment>(
    `(&(${OBJECTCLASS}=${ERROR_PROCESSOR_HOOK_INTERFACE_KEY})(operation=Update)(component=ServiceDebateCommentsView))`,
  );
  const handleDeleteError = useErrorHandler<ServiceComment>(
    `(&(${OBJECTCLASS}=${ERROR_PROCESSOR_HOOK_INTERFACE_KEY})(operation=Delete)(component=ServiceDebateCommentsView))`,
  );
  ...
  const { service: postRefreshHook } = useTrackService<ServiceDebateCommentsViewPostRefreshHook>(
    `(${OBJECTCLASS}=${SERVICE_DEBATE_COMMENTS_VIEW_POST_REFRESH_HOOK_INTERFACE_KEY})`,
  );
  const postRefreshAction: ServiceDebateCommentsViewPostRefreshAction | undefined =
  ...
  async function submit() {
    ...
    try {
      const res = await serviceCommentServiceForClassImpl.update(payloadDiff);
      ...
      if (res) {
        ...
        setValidation(new Map<keyof ServiceComment, string>());
        await fetchData();
        setEditMode(false);
      }
    } catch (error) {
  ...
  async function deleteData() {
    ...
    try {
      await serviceCommentServiceForClassImpl.delete(data);
        ...
        <Box sx={mainContainerPadding}>
          ...
          >
            <Grid item xs={12} sm={12}>
              <Card id="FlexedemokraciaServiceUserEdemokraciaServiceDebateCommentsViewDefaultCommentViewEditGroupLabelWrapper">
                <CardContent>
                  <Grid container direction="column" alignItems="stretch" justifyContent="flex-start" spacing={2}>
                    <Grid item xs={12} sm={12}>
                      <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                        ...
                        <Typography
                          id="LabeledemokraciaServiceUserEdemokraciaServiceDebateCommentsViewDefaultCommentViewEditGroupLabelWrapperGroupLabel"
                          variant="h5"
                          component="h1"
                        >
                    ...
                    <Grid item xs={12} sm={12}>
                      <Grid
                        id="FlexedemokraciaServiceUserEdemokraciaServiceDebateCommentsViewDefaultCommentViewEditGroupLabelWrapperGroup"
                        container
                        direction="row"
                        alignItems="stretch"
                        justifyContent="flex-start"
                      ...
                      >
                        <Grid item xs={12} sm={12} md={4.0}>
                          <DateTimePicker
                            ...
                            slotProps={{
                              textField: {
                                id: 'DateTimeInputedemokraciaServiceUserEdemokraciaServiceDebateCommentsViewDefaultCommentViewEditGroupLabelWrapperGroupCreated',
                                required: false,
                        ...
                        <Grid item xs={12} sm={12}>
                          <TextField
                            required={true}
                            name="comment"
                            id="TextAreaedemokraciaServiceUserEdemokraciaServiceDebateCommentsViewDefaultCommentViewEditGroupLabelWrapperGroupComment"
                        ...
                        <Grid item xs={12} sm={12} md={1.0}>
                          <LoadingButton
                            id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceDebateCommentsViewEdemokraciaServiceUserEdemokraciaServiceCommentVoteUpButtonCallOperation"
                            loading={isLoading}
                            variant={undefined}
                        ...
                        <Grid item xs={12} sm={12} md={1.0}>
                          <NumericInput
                            required={false}
                            name="upVotes"
                            id="NumericInputedemokraciaServiceUserEdemokraciaServiceDebateCommentsViewDefaultCommentViewEditGroupLabelWrapperGroupUpVotes"
                        ...
                        <Grid item xs={12} sm={12} md={1.0}>
                          <LoadingButton
                            id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceDebateCommentsViewEdemokraciaServiceUserEdemokraciaServiceCommentVoteDownButtonCallOperation"
                            loading={isLoading}
                            variant={undefined}
                        ...
                        <Grid item xs={12} sm={12} md={1.0}>
                          <NumericInput
                            required={false}
                            name="downVotes"
                            id="NumericInputedemokraciaServiceUserEdemokraciaServiceDebateCommentsViewDefaultCommentViewEditGroupLabelWrapperGroupDownVotes"
                        ...
                        <Grid item xs={12} sm={12} md={2.0}>
                          <CollectionAssociationButton
                            id="NavigationToPageActionedemokraciaServiceUserEdemokraciaServiceDebateCommentsViewEdemokraciaServiceUserEdemokraciaServiceCommentVotesButtonNavigate"
                            variant={undefined}
                            editMode={editMode}
