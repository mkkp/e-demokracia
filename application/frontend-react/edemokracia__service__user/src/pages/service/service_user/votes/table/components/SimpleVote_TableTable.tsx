...
export const SERVICE_SERVICE_USER_VOTES_TABLE_SIMPLE_VOTE_TABLE = 'ServiceServiceUserVotesTableSimpleVote_Table';

export interface SimpleVote_TableTableProps {
  ownerData: JudoIdentifiable<ServiceServiceUser>;
...
export const SimpleVote_TableTable = forwardRef<RefreshableTable, SimpleVote_TableTableProps>((props, ref) => {
  ...
  const filterModelKey = `TableedemokraciaServiceUserEdemokraciaServiceServiceUserVotesTableDefaultVotesSimpleVoteTable-${__identifier}-filterModel`;
  const filtersKey = `TableedemokraciaServiceUserEdemokraciaServiceServiceUserVotesTableDefaultVotesSimpleVoteTable-${__identifier}-filters`;
  ...
  useEffect(() => {
    setFilters(
      getItemParsedWithDefault(
        `TableedemokraciaServiceUserEdemokraciaServiceServiceUserVotesTableDefaultVotesSimpleVoteTable-${__identifier}-filters`,
        [...filters],
      ),
    );
  }, [ownerData]);
  ...
  const rowActions: TableRowAction<ServiceSimpleVoteStored>[] = [
    {
      id: 'RemoveActionedemokraciaServiceUserEdemokraciaServiceServiceUserVotesTableEdemokraciaServiceUserEdemokraciaServiceServiceUserVotesRowRemove',
      label: t('judo.pages.table.remove', { defaultValue: 'Remove' }) as string,
      icon: <MdiIcon path="link_off" />,
      action: async (row: ServiceSimpleVoteStored) => rowRemoveVotesAction(ownerData, row, () => fetchData()),
    },
  ];
  ...
  const bulkRemoveSelected = useCallback(() => {
    openCRUDDialog<ServiceSimpleVoteStored>({
      ...
      action: async (item, successHandler: () => void, errorHandler: (error: any) => void) => {
        await rowRemoveVotesAction(ownerData, item, successHandler, errorHandler);
      },
  ...
  async function fetchData() {
    ...
    try {
      const res = await serviceServiceUserServiceForClassImpl.getVotes(
        ownerData,
      ...
      <StripedDataGrid
        ...
        columns={[
          ...
          ...columnsActionCalculator(
            'RelationTypeedemokraciaServiceUserEdemokraciaServiceServiceUserVotes',
            rowActions,
            t,
            { shownActions: 2 },
          ),
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              <Button
                id="FilterActionedemokraciaServiceUserEdemokraciaServiceServiceUserVotesTableEdemokraciaServiceUserEdemokraciaServiceServiceUserVotesPageFilter"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() => {
                  pageFilterVotesAction(
                    'FilterActionedemokraciaServiceUserEdemokraciaServiceServiceUserVotesTableEdemokraciaServiceUserEdemokraciaServiceServiceUserVotesPageFilter-filter',
                    filterOptions,
                    filters,
                  );
                }}
              ...
              {isBulkRemoveAvailable() ? (
                <Button
                  id="RelationTypeedemokraciaServiceUserEdemokraciaServiceServiceUserVotes-bulk-remove"
                  disabled={isOwnerLoading}
                  variant="text"
