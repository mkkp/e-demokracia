...
export const usePageClearVotesAction: PageClearVotesAction = () => {
  ...
  return async function pageClearVotesAction(owner: JudoIdentifiable<ServiceServiceUser>, successCallback: () => void) {
    try {
      await serviceServiceUserServiceForClassImpl.setVotes(
