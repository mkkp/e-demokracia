...
// Page name: edemokracia::service::ServiceUser.votes#Table
...
/**
 * Name: edemokracia::service::ServiceUser.votes#Table
 * Is Access: false
 * Type: Table
 **/
export default function ServiceServiceUserVotesTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaServiceUserEdemokraciaServiceServiceUserVotesTable-data-grid">
