...
export const CitiesTable = (props: CitiesTableProps) => {
  ...
  const filterModelKey = `TableedemokraciaServiceUserEdemokraciaServiceServiceUserResidentCountyViewDefaultCountyViewEditCitiesLabelWrapperCities-${ownerData.__identifier}-filterModel`;
  const filtersKey = `TableedemokraciaServiceUserEdemokraciaServiceServiceUserResidentCountyViewDefaultCountyViewEditCitiesLabelWrapperCities-${ownerData.__identifier}-filters`;
  ...
  const citiesRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceServiceUserResidentCountyViewDefaultCountyViewEditCitiesLabelWrapperCitiesNameFilter',
      attributeName: 'name',
  ...
  const citiesRowActions: TableRowAction<ServiceCityStored>[] = [
    {
      id: 'DeleteActionedemokraciaServiceUserEdemokraciaServiceServiceUserResidentCountyViewEdemokraciaServiceUserEdemokraciaServiceCountyCitiesRowDelete',
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              <Button
                id="CreateActionedemokraciaServiceUserEdemokraciaServiceServiceUserResidentCountyViewEdemokraciaServiceUserEdemokraciaServiceCountyCitiesTableCreate"
              ...
              <Button
                id="TableedemokraciaServiceUserEdemokraciaServiceServiceUserResidentCountyViewDefaultCountyViewEditCitiesLabelWrapperCities-filter"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() =>
                  filter(
                    'TableedemokraciaServiceUserEdemokraciaServiceServiceUserResidentCountyViewDefaultCountyViewEditCitiesLabelWrapperCities-filter',
                    filterOptions,
                    filters,
                  )
                }
