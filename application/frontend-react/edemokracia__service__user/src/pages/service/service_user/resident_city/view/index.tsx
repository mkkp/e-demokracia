...
// Page name: edemokracia::service::ServiceUser.residentCity#View
...
/**
 * Name: edemokracia::service::ServiceUser.residentCity#View
 * Is Access: false
 * Type: View
        ...
        <Grid container spacing={2} direction="column" alignItems="stretch" justifyContent="flex-start">
          <Grid item xs={12} sm={12}>
            <TextField
              required={true}
              name="name"
              id="TextInputedemokraciaServiceUserEdemokraciaServiceServiceUserResidentCityViewDefaultCityViewEditName"
          ...
          <Grid item xs={12} sm={12}>
            <Grid
              id="FlexedemokraciaServiceUserEdemokraciaServiceServiceUserResidentCityViewDefaultCityViewEditDistrictsLabelWrapper"
              container
              direction="column"
              alignItems="stretch"
            ...
            >
              <Grid item xs={12} sm={12}>
                <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                  ...
                  <Typography
                    id="LabeledemokraciaServiceUserEdemokraciaServiceServiceUserResidentCityViewDefaultCityViewEditDistrictsLabelWrapperDistrictsLabel"
                    variant="h5"
                    component="h1"
                  >
              ...
              <Grid item xs={12} sm={12}>
                <Grid
                  id="TableedemokraciaServiceUserEdemokraciaServiceServiceUserResidentCityViewDefaultCityViewEditDistrictsLabelWrapperDistricts"
                  container
                  direction="column"
                  alignItems="stretch"
                  justifyContent="flex-start"
