...
export const DistrictsTable = (props: DistrictsTableProps) => {
  ...
  const filterModelKey = `TableedemokraciaServiceUserEdemokraciaServiceServiceUserResidentCityViewDefaultCityViewEditDistrictsLabelWrapperDistricts-${ownerData.__identifier}-filterModel`;
  const filtersKey = `TableedemokraciaServiceUserEdemokraciaServiceServiceUserResidentCityViewDefaultCityViewEditDistrictsLabelWrapperDistricts-${ownerData.__identifier}-filters`;
  ...
  const districtsRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceServiceUserResidentCityViewDefaultCityViewEditDistrictsLabelWrapperDistrictsNameFilter',
      attributeName: 'name',
  ...
  const districtsRowActions: TableRowAction<ServiceDistrictStored>[] = [
    {
      id: 'DeleteActionedemokraciaServiceUserEdemokraciaServiceServiceUserResidentCityViewEdemokraciaServiceUserEdemokraciaServiceCityDistrictsRowDelete',
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              <Button
                id="CreateActionedemokraciaServiceUserEdemokraciaServiceServiceUserResidentCityViewEdemokraciaServiceUserEdemokraciaServiceCityDistrictsTableCreate"
              ...
              <Button
                id="TableedemokraciaServiceUserEdemokraciaServiceServiceUserResidentCityViewDefaultCityViewEditDistrictsLabelWrapperDistricts-filter"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() =>
                  filter(
                    'TableedemokraciaServiceUserEdemokraciaServiceServiceUserResidentCityViewDefaultCityViewEditDistrictsLabelWrapperDistricts-filter',
                    filterOptions,
                    filters,
                  )
                }
