...
import { serviceCityServiceForClassImpl, serviceDistrictServiceForClassImpl } from '~/generated/data-axios';
import {
...
export const SERVICE_USER_VIEW_DISTRICTS = 'ServiceUserViewDistricts';
...
export const DistrictsTable = (props: DistrictsTableProps) => {
  ...
  const filterModelKey = `TableedemokraciaServiceUserEdemokraciaServiceServiceUserActivityCitiesViewDefaultCityViewEditDistrictsLabelWrapperDistricts-${ownerData.__identifier}-filterModel`;
  const filtersKey = `TableedemokraciaServiceUserEdemokraciaServiceServiceUserActivityCitiesViewDefaultCityViewEditDistrictsLabelWrapperDistricts-${ownerData.__identifier}-filters`;
  ...
  const districtsColumns: GridColDef<ServiceDistrictStored>[] = [
    {
      ...baseColumnConfig,
      field: 'name',
      headerName: t('service.CityView.districts.name', { defaultValue: 'Name' }) as string,
  ...
  const districtsRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceServiceUserActivityCitiesViewDefaultCityViewEditDistrictsLabelWrapperDistrictsNameFilter',
      attributeName: 'name',
      label: t('service.CityView.districts.name', { defaultValue: 'Name' }) as string,
      filterType: FilterType.string,
    },
  ];

  const districtsInitialQueryCustomizer: ServiceDistrictQueryCustomizer = {
    _mask: '{name}',
  ...
  const districtsRowActions: TableRowAction<ServiceDistrictStored>[] = [
    {
      id: 'DeleteActionedemokraciaServiceUserEdemokraciaServiceServiceUserActivityCitiesViewEdemokraciaServiceUserEdemokraciaServiceCityDistrictsRowDelete',
      label: t('judo.pages.table.delete', { defaultValue: 'Delete' }) as string,
      icon: <MdiIcon path="delete_forever" />,
      action: async (row: ServiceDistrictStored) => rowDeleteDistrictsAction(ownerData, row, () => fetchOwnerData()),
      disabled: (row: ServiceDistrictStored) => editMode || !row.__deleteable,
    },
  ];
      ...
      <StripedDataGrid
        ...
        columns={[
          ...
          ...columnsActionCalculator(
            'RelationTypeedemokraciaServiceUserEdemokraciaServiceCityDistricts',
            districtsRowActions,
            t,
            { shownActions: 2 },
          ),
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              <Button
                id="CreateActionedemokraciaServiceUserEdemokraciaServiceServiceUserActivityCitiesViewEdemokraciaServiceUserEdemokraciaServiceCityDistrictsTableCreate"
              ...
              <Button
                id="TableedemokraciaServiceUserEdemokraciaServiceServiceUserActivityCitiesViewDefaultCityViewEditDistrictsLabelWrapperDistricts-filter"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() =>
                  filter(
                    'TableedemokraciaServiceUserEdemokraciaServiceServiceUserActivityCitiesViewDefaultCityViewEditDistrictsLabelWrapperDistricts-filter',
                    filterOptions,
                    filters,
                  )
                }
              ...
              {isBulkDeleteAvailable() ? (
                <Button
                  id="RelationTypeedemokraciaServiceUserEdemokraciaServiceCityDistricts-bulk-delete"
