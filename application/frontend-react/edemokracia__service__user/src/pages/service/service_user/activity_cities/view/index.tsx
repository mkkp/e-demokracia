...
// Page name: edemokracia::service::ServiceUser.activityCities#View
...
/**
 * Name: edemokracia::service::ServiceUser.activityCities#View
 * Is Access: false
 * Type: View
        ...
        <Grid container spacing={2} direction="column" alignItems="stretch" justifyContent="flex-start">
          <Grid item xs={12} sm={12}>
            <TextField
              required={true}
              name="name"
              id="TextInputedemokraciaServiceUserEdemokraciaServiceServiceUserActivityCitiesViewDefaultCityViewEditName"
          ...
          <Grid item xs={12} sm={12}>
            <Grid
              id="FlexedemokraciaServiceUserEdemokraciaServiceServiceUserActivityCitiesViewDefaultCityViewEditDistrictsLabelWrapper"
              container
              direction="column"
              alignItems="stretch"
            ...
            >
              <Grid item xs={12} sm={12}>
                <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                  ...
                  <Typography
                    id="LabeledemokraciaServiceUserEdemokraciaServiceServiceUserActivityCitiesViewDefaultCityViewEditDistrictsLabelWrapperDistrictsLabel"
                    variant="h5"
                    component="h1"
                  >
              ...
              <Grid item xs={12} sm={12}>
                <Grid
                  id="TableedemokraciaServiceUserEdemokraciaServiceServiceUserActivityCitiesViewDefaultCityViewEditDistrictsLabelWrapperDistricts"
                  container
                  direction="column"
                  alignItems="stretch"
                  justifyContent="flex-start"
