...
export function UserLink(props: UserLinkProps) {
  ...
  const ownerRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceYesNoVoteDefinitionVoteEntriesViewDefaultYesNoVoteEntryViewEditUserRepresentationFilter',
  ...
  return (
    <AggregationInput
      name="owner"
      id="LinkedemokraciaServiceUserEdemokraciaServiceYesNoVoteDefinitionVoteEntriesViewDefaultYesNoVoteEntryViewEditUser"
      required={true}
