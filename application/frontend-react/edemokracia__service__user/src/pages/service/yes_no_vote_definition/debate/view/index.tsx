...
// Page name: edemokracia::service::YesNoVoteDefinition.debate#View
...
export type ServiceYesNoVoteDefinitionDebateViewPostRefreshAction = (
...
export const SERVICE_YES_NO_VOTE_DEFINITION_DEBATE_VIEW_POST_REFRESH_HOOK_INTERFACE_KEY =
  'ServiceYesNoVoteDefinitionDebateViewPostRefreshHook';
export type ServiceYesNoVoteDefinitionDebateViewPostRefreshHook =
  () => ServiceYesNoVoteDefinitionDebateViewPostRefreshAction;

/**
 * Name: edemokracia::service::YesNoVoteDefinition.debate#View
 * Is Access: false
 * Type: View
 * Edit Mode Available: false
 **/
export default function ServiceYesNoVoteDefinitionDebateView() {
  ...
  const { service: postRefreshHook } = useTrackService<ServiceYesNoVoteDefinitionDebateViewPostRefreshHook>(
    `(${OBJECTCLASS}=${SERVICE_YES_NO_VOTE_DEFINITION_DEBATE_VIEW_POST_REFRESH_HOOK_INTERFACE_KEY})`,
  );
  const postRefreshAction: ServiceYesNoVoteDefinitionDebateViewPostRefreshAction | undefined =
        ...
        <Box sx={mainContainerPadding}>
          ...
          >
            <Grid item xs={12} sm={12}>
              <Grid
                id="FlexedemokraciaServiceUserEdemokraciaServiceYesNoVoteDefinitionDebateViewDefaultDebateViewEditActions"
                container
                direction="row"
              ...
              >
                <Grid item xs={12}>
                  <Grid container spacing={2}>
                    <Grid item>
                      <LoadingButton
                        id="ButtonedemokraciaServiceUserEdemokraciaServiceYesNoVoteDefinitionDebateViewDefaultDebateViewEditActionsPageActionButtonsCloseDebate"
                        loading={isLoading}
                    ...
                    {!data.isFavorite && (
                      <Grid item>
                        <LoadingButton
                          id="ButtonedemokraciaServiceUserEdemokraciaServiceYesNoVoteDefinitionDebateViewDefaultDebateViewEditActionsPageActionButtonsAddToFavorites"
                          loading={isLoading}
                    ...
                    {!data.isNotFavorite && (
                      <Grid item>
                        <LoadingButton
                          id="ButtonedemokraciaServiceUserEdemokraciaServiceYesNoVoteDefinitionDebateViewDefaultDebateViewEditActionsPageActionButtonsRemoveFromFavorites"
                          loading={isLoading}
            ...
            <Grid item xs={12} sm={12}>
              <Card id="FlexedemokraciaServiceUserEdemokraciaServiceYesNoVoteDefinitionDebateViewDefaultDebateViewEditDebateLabelWrapper">
                <CardContent>
                  <Grid container direction="column" alignItems="stretch" justifyContent="flex-start" spacing={2}>
                    <Grid item xs={12} sm={12}>
                      <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                        ...
                        <Typography
                          id="LabeledemokraciaServiceUserEdemokraciaServiceYesNoVoteDefinitionDebateViewDefaultDebateViewEditDebateLabelWrapperDebateLabel"
                          variant="h5"
                          component="h1"
                        >
                    ...
                    <Grid item xs={12} sm={12}>
                      <Grid
                        id="FlexedemokraciaServiceUserEdemokraciaServiceYesNoVoteDefinitionDebateViewDefaultDebateViewEditDebateLabelWrapperDebate"
                        container
                        direction="row"
                        alignItems="stretch"
                        justifyContent="flex-start"
                      ...
                      >
                        <Grid item xs={12} sm={12} md={8.0}>
                          <TextField
                            required={true}
                            name="title"
                            id="TextInputedemokraciaServiceUserEdemokraciaServiceYesNoVoteDefinitionDebateViewDefaultDebateViewEditDebateLabelWrapperDebateTitle"
                        ...
                        <Grid item xs={12} sm={12} md={2.0}>
                          <TextField
                            required={true}
                            name="status"
                            id="EnumerationComboedemokraciaServiceUserEdemokraciaServiceYesNoVoteDefinitionDebateViewDefaultDebateViewEditDebateLabelWrapperDebateStatus"
                        ...
                        <Grid item xs={12} sm={12} md={2.0}>
                          <DateTimePicker
                            ...
                            slotProps={{
                              textField: {
                                id: 'DateTimeInputedemokraciaServiceUserEdemokraciaServiceYesNoVoteDefinitionDebateViewDefaultDebateViewEditDebateLabelWrapperDebateCloseAt',
                                required: true,
                        ...
                        <Grid item xs={12} sm={12}>
                          <TextField
                            required={true}
                            name="description"
                            id="TextAreaedemokraciaServiceUserEdemokraciaServiceYesNoVoteDefinitionDebateViewDefaultDebateViewEditDebateLabelWrapperDebateDescription"
            ...
            <Grid container item xs={12} sm={12}>
              <ModeledTabs
                id="TabControlleredemokraciaServiceUserEdemokraciaServiceYesNoVoteDefinitionDebateViewDefaultDebateViewEditTabBar"
                ownerData={data}
                validation={validation}
                orientation='horizontal'
                childTabs={[
                  {
                    id: 'TabedemokraciaServiceUserEdemokraciaServiceYesNoVoteDefinitionDebateViewDefaultDebateViewEditTabBarArguments',
                  ...
                  {
                    id: 'TabedemokraciaServiceUserEdemokraciaServiceYesNoVoteDefinitionDebateViewDefaultDebateViewEditTabBarComments',
              ...
              >
                <Grid item xs={12} sm={12}>
                  <Grid
                    id="FlexedemokraciaServiceUserEdemokraciaServiceYesNoVoteDefinitionDebateViewDefaultDebateViewEditTabBarArgumentsArguments"
                    container
                    direction="row"
                    alignItems="flex-start"
                    justifyContent="flex-start"
                  ...
                  >
                    <Grid item xs={12} sm={12}>
                      <Grid
                        id="FlexedemokraciaServiceUserEdemokraciaServiceYesNoVoteDefinitionDebateViewDefaultDebateViewEditTabBarArgumentsArgumentsActions"
                        container
                        direction="row"
                        alignItems="flex-start"
                        justifyContent="flex-start"
                      ...
                      >
                        <Grid item xs={12} sm={12} md={4.0}>
                          <LoadingButton
                            id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceYesNoVoteDefinitionDebateViewEdemokraciaServiceUserEdemokraciaServiceDebateCreateArgumentButtonCallOperation"
                            loading={isLoading}
                            variant={undefined}
                    ...
                    <Grid item xs={12} sm={12} md={6.0}>
                      <Grid
                        id="FlexedemokraciaServiceUserEdemokraciaServiceYesNoVoteDefinitionDebateViewDefaultDebateViewEditTabBarArgumentsArgumentsProsLabelWrapper"
                        container
                        direction="column"
                        alignItems="stretch"
                        justifyContent="flex-start"
                      ...
                      >
                        <Grid item xs={12} sm={12}>
                          <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                            ...
                            <Typography
                              id="LabeledemokraciaServiceUserEdemokraciaServiceYesNoVoteDefinitionDebateViewDefaultDebateViewEditTabBarArgumentsArgumentsProsLabelWrapperProsLabel"
                              variant="h5"
                              component="h1"
                            >
                        ...
                        <Grid item xs={12} sm={12}>
                          <Grid
                            id="TableedemokraciaServiceUserEdemokraciaServiceYesNoVoteDefinitionDebateViewDefaultDebateViewEditTabBarArgumentsArgumentsProsLabelWrapperPros"
                            container
                            direction="column"
                            alignItems="stretch"
                            justifyContent="flex-start"
                    ...
                    <Grid item xs={12} sm={12} md={6.0}>
                      <Grid
                        id="FlexedemokraciaServiceUserEdemokraciaServiceYesNoVoteDefinitionDebateViewDefaultDebateViewEditTabBarArgumentsArgumentsConsLabelWrapper"
                        container
                        direction="column"
                        alignItems="stretch"
                        justifyContent="flex-start"
                      ...
                      >
                        <Grid item xs={12} sm={12}>
                          <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                            ...
                            <Typography
                              id="LabeledemokraciaServiceUserEdemokraciaServiceYesNoVoteDefinitionDebateViewDefaultDebateViewEditTabBarArgumentsArgumentsConsLabelWrapperConsLabel"
                              variant="h5"
                              component="h1"
                            >
                        ...
                        <Grid item xs={12} sm={12}>
                          <Grid
                            id="TableedemokraciaServiceUserEdemokraciaServiceYesNoVoteDefinitionDebateViewDefaultDebateViewEditTabBarArgumentsArgumentsConsLabelWrapperCons"
                            container
                            direction="column"
                            alignItems="stretch"
                            justifyContent="flex-start"
                ...
                <Grid item xs={12} sm={12}>
                  <Grid
                    id="FlexedemokraciaServiceUserEdemokraciaServiceYesNoVoteDefinitionDebateViewDefaultDebateViewEditTabBarCommentsComments"
                    container
                    direction="row"
                    alignItems="flex-start"
                    justifyContent="flex-start"
                  ...
                  >
                    <Grid item xs={12} sm={12}>
                      <Grid
                        id="FlexedemokraciaServiceUserEdemokraciaServiceYesNoVoteDefinitionDebateViewDefaultDebateViewEditTabBarCommentsCommentsActions"
                        container
                        direction="row"
                        alignItems="flex-start"
                        justifyContent="flex-start"
                      ...
                      >
                        <Grid item xs={12} sm={12} md={4.0}>
                          <LoadingButton
                            id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceYesNoVoteDefinitionDebateViewEdemokraciaServiceUserEdemokraciaServiceDebateCreateCommentButtonCallOperation"
                            loading={isLoading}
                            variant={undefined}
                    ...
                    <Grid item xs={12} sm={12}>
                      <Grid
                        id="FlexedemokraciaServiceUserEdemokraciaServiceYesNoVoteDefinitionDebateViewDefaultDebateViewEditTabBarCommentsCommentsCommentsLabelWrapper"
                        container
                        direction="column"
                        alignItems="stretch"
                        justifyContent="flex-start"
                      ...
                      >
                        <Grid item xs={12} sm={12}>
                          <Grid
                            id="TableedemokraciaServiceUserEdemokraciaServiceYesNoVoteDefinitionDebateViewDefaultDebateViewEditTabBarCommentsCommentsCommentsLabelWrapperComments"
                            container
                            direction="column"
                            alignItems="stretch"
                            justifyContent="flex-start"
