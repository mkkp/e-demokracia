...
export type UserLinkFilterInitializer = (ownerData: ServiceYesNoVoteEntryStored) => Filter[] | undefined;
...
export interface UserLinkProps {
  ownerData: ServiceYesNoVoteEntryStored;
  validation: Map<keyof ServiceYesNoVoteEntryStored, string>;
...
export function UserLink(props: UserLinkProps) {
  ...
  const ownerColumns: GridColDef<ServiceServiceUserStored>[] = [
    {
      ...
      headerName: t('service.YesNoVoteEntryView.owner.representation', { defaultValue: 'Representation' }) as string,
  ...
  const ownerRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceYesNoVoteDefinitionUserVoteEntryViewDefaultYesNoVoteEntryViewEditUserRepresentationFilter',
      attributeName: 'representation',
      label: t('service.YesNoVoteEntryView.owner.representation', { defaultValue: 'Representation' }) as string,
  ...
  return (
    <AggregationInput
      name="owner"
      id="LinkedemokraciaServiceUserEdemokraciaServiceYesNoVoteDefinitionUserVoteEntryViewDefaultYesNoVoteEntryViewEditUser"
      required={true}
      label={t('service.YesNoVoteEntryView.owner', { defaultValue: 'User' }) as string}
