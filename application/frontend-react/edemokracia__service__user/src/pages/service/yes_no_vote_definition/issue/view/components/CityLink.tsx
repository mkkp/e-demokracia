...
export function CityLink(props: CityLinkProps) {
  ...
  const cityRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceYesNoVoteDefinitionIssueViewDefaultIssueViewEditOtherAreaAreaCityRepresentationFilter',
  ...
  return (
    <AggregationInput
      name="city"
      id="LinkedemokraciaServiceUserEdemokraciaServiceYesNoVoteDefinitionIssueViewDefaultIssueViewEditOtherAreaAreaCity"
