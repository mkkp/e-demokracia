...
// Page name: edemokracia::service::User.adminVoteEntries#Table
...
/**
 * Name: edemokracia::service::User.adminVoteEntries#Table
 * Is Access: true
 * Is Dashboard: false
 * Type: Table
 **/
export default function ServiceUserAdminVoteEntriesTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaServiceUserEdemokraciaServiceUserAdminVoteEntriesTable-data-grid">
