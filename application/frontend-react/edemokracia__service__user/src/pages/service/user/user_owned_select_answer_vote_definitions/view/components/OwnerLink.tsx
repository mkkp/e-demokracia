...
export type OwnerLinkFilterInitializer = (ownerData: ServiceSelectAnswerVoteDefinitionStored) => Filter[] | undefined;
...
export function OwnerLink(props: OwnerLinkProps) {
  ...
  const ownerColumns: GridColDef<ServiceServiceUserStored>[] = [
    {
      ...
      headerName: t('service.SelectAnswerVoteDefinitionView.owner.representation', {
  ...
  const ownerRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserUserOwnedSelectAnswerVoteDefinitionsViewDefaultSelectAnswerVoteDefinitionViewEditVoteEntryBaseVirtualOwnerRepresentationFilter',
      attributeName: 'representation',
      label: t('service.SelectAnswerVoteDefinitionView.owner.representation', {
        defaultValue: 'Representation',
      }) as string,
  ...
  return (
    <AggregationInput
      name="owner"
      id="LinkedemokraciaServiceUserEdemokraciaServiceUserUserOwnedSelectAnswerVoteDefinitionsViewDefaultSelectAnswerVoteDefinitionViewEditVoteEntryBaseVirtualOwner"
      label={t('service.SelectAnswerVoteDefinitionView.owner', { defaultValue: 'Owner' }) as string}
      ...
      onSet={async () => {
        const res = await openRangeDialog<ServiceServiceUserStored, ServiceServiceUserQueryCustomizer>({
          id: 'RelationTypeedemokraciaServiceUserEdemokraciaServiceSelectAnswerVoteDefinitionOwner',
          columns: ownerColumns,
          defaultSortField: ([{ field: 'representation', sort: null }] as GridSortItem[])[0],
          rangeCall: async (queryCustomizer) =>
            await serviceSelectAnswerVoteDefinitionServiceForClassImpl.getRangeForOwner(
              ownerData,
      ...
      onAutoCompleteSearch={async (searchText: string) => {
        ...
        return await serviceSelectAnswerVoteDefinitionServiceForClassImpl.getRangeForOwner(
          ownerData,
          processQueryCustomizer(queryCustomizer),
        );
      }}
