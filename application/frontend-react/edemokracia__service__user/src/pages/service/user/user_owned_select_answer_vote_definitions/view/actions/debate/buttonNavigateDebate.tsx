...
import { routeToServiceSelectAnswerVoteDefinitionDebateView } from '~/routes';
...
export const useButtonNavigateDebateAction: ButtonNavigateDebateAction = () => {
  ...
  return async function (
    ...
    navigate(routeToServiceSelectAnswerVoteDefinitionDebateView(target.__signedIdentifier));
  };
};
