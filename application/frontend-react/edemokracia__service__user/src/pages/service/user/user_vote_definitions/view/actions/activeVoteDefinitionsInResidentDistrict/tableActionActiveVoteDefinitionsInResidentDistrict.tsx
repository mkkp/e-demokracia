...
export type TableActionActiveVoteDefinitionsInResidentDistrictAction = (
  id: string,
  filterOptions: FilterOption[],
  filters: Filter[],
) => Promise<void>;

export const useTableActionActiveVoteDefinitionsInResidentDistrictAction = (
  ...
  return async function tableActionActiveVoteDefinitionsInResidentDistrictAction(
    id: string,
    filterOptions: FilterOption[],
    filters: Filter[],
  ) {
