...
export type TableActionActiveVoteDefinitionsGlobalAction = (
  id: string,
  filterOptions: FilterOption[],
  filters: Filter[],
) => Promise<void>;

export const useTableActionActiveVoteDefinitionsGlobalAction = (
  ...
  const columnNames = ['scope', 'title', 'voteType', 'numberOfVotes', 'created', 'closeAt', 'status'];

  return async function tableActionActiveVoteDefinitionsGlobalAction(
    id: string,
    filterOptions: FilterOption[],
    filters: Filter[],
  ) {
