...
export type TableActionActiveVoteDefinitionsInResidentCityAction = (
  id: string,
  filterOptions: FilterOption[],
  filters: Filter[],
) => Promise<void>;

export const useTableActionActiveVoteDefinitionsInResidentCityAction = (
  ...
  return async function tableActionActiveVoteDefinitionsInResidentCityAction(
    id: string,
    filterOptions: FilterOption[],
    filters: Filter[],
  ) {
