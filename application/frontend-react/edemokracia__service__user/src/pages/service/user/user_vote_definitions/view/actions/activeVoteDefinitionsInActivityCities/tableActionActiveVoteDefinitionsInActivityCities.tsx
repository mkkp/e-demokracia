...
export type TableActionActiveVoteDefinitionsInActivityCitiesAction = (
  id: string,
  filterOptions: FilterOption[],
  filters: Filter[],
) => Promise<void>;

export const useTableActionActiveVoteDefinitionsInActivityCitiesAction = (
  ...
  return async function tableActionActiveVoteDefinitionsInActivityCitiesAction(
    id: string,
    filterOptions: FilterOption[],
    filters: Filter[],
  ) {
