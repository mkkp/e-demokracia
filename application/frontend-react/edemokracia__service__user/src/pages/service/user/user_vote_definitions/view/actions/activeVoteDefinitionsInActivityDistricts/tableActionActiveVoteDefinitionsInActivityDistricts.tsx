...
export type TableActionActiveVoteDefinitionsInActivityDistrictsAction = (
  id: string,
  filterOptions: FilterOption[],
  filters: Filter[],
) => Promise<void>;

export const useTableActionActiveVoteDefinitionsInActivityDistrictsAction = (
  ...
  return async function tableActionActiveVoteDefinitionsInActivityDistrictsAction(
    id: string,
    filterOptions: FilterOption[],
    filters: Filter[],
  ) {
