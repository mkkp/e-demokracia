...
export type TableActionActiveVoteDefinitionsInResidentCountyAction = (
  id: string,
  filterOptions: FilterOption[],
  filters: Filter[],
) => Promise<void>;

export const useTableActionActiveVoteDefinitionsInResidentCountyAction = (
  ...
  return async function tableActionActiveVoteDefinitionsInResidentCountyAction(
    id: string,
    filterOptions: FilterOption[],
    filters: Filter[],
  ) {
