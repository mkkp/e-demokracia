...
import { ServiceCountyQueryCustomizer } from '~/generated/data-api';
import { useFilterDialog } from '~/components/dialog';
import type { Filter, FilterOption } from '~/components-api';
import { mapAllFiltersToQueryCustomizerProperties } from '~/utilities';

export type PageFilterAdminCountiesAction = (
  id: string,
  filterOptions: FilterOption[],
  filters: Filter[],
) => Promise<void>;

export const usePageFilterAdminCountiesAction = (
  ...
  return async function pageFilterAdminCountiesAction(id: string, filterOptions: FilterOption[], filters: Filter[]) {
