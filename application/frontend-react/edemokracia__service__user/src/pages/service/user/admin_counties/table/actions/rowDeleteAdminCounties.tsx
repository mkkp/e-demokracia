...
export type RowDeleteAdminCountiesAction = () => (
...
export const useRowDeleteAdminCountiesAction: RowDeleteAdminCountiesAction = () => {
  ...
  return async function rowDeleteAdminCountiesAction(
    selected: ServiceCountyStored,
    successCallback: () => void,
    errorCallback?: (error: any) => void,
    silentMode?: boolean,
