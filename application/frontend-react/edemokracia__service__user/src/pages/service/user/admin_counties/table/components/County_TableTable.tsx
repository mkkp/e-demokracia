...
import { serviceUserServiceForAdminCountiesImpl } from '~/generated/data-axios';
import {
...
export const SERVICE_USER_ADMIN_COUNTIES_TABLE_COUNTY_TABLE = 'ServiceUserAdminCountiesTableCounty_Table';
...
export const County_TableTable = forwardRef<RefreshableTable, County_TableTableProps>((props, ref) => {
  ...
  const filterModelKey = `TableedemokraciaServiceUserEdemokraciaServiceUserAdminCountiesTableDefaultAdminCountiesCountyTable-filterModel`;
  const filtersKey = `TableedemokraciaServiceUserEdemokraciaServiceUserAdminCountiesTableDefaultAdminCountiesCountyTable-filters`;
  ...
  const adminCountiesColumns: GridColDef<ServiceCountyStored>[] = [
    {
      ...baseColumnConfig,
      field: 'name',
      headerName: t('service.CountyTable.adminCounties.name', { defaultValue: 'Name' }) as string,
  ...
  const adminCountiesRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserAdminCountiesTableDefaultAdminCountiesCountyTableNameFilter',
      attributeName: 'name',
      label: t('service.CountyTable.adminCounties.name', { defaultValue: 'Name' }) as string,
      filterType: FilterType.string,
    },
  ];

  const adminCountiesInitialQueryCustomizer: ServiceCountyQueryCustomizer = {
    _mask: '{name}',
  ...
  const rowActions: TableRowAction<ServiceCountyStored>[] = [
    {
      id: 'DeleteActionedemokraciaServiceUserEdemokraciaServiceUserAdminCountiesTableEdemokraciaServiceUserEdemokraciaServiceUserAdminCountiesRowDelete',
      label: t('judo.pages.table.delete', { defaultValue: 'Delete' }) as string,
      icon: <MdiIcon path="delete_forever" />,
      action: async (row: ServiceCountyStored) => rowDeleteAdminCountiesAction(row, () => fetchData()),
      disabled: (row: ServiceCountyStored) => !row.__deleteable,
    },
  ];
  ...
  async function fetchData() {
    ...
    try {
      const res = await serviceUserServiceForAdminCountiesImpl.listAdminCounties(
      ...
      <StripedDataGrid
        ...
        columns={[
          ...
          ...columnsActionCalculator(
            'RelationTypeedemokraciaServiceUserEdemokraciaServiceUserAdminCounties',
            rowActions,
            t,
            { shownActions: 2 },
          ),
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              <Button
                id="FilterActionedemokraciaServiceUserEdemokraciaServiceUserAdminCountiesTableEdemokraciaServiceUserEdemokraciaServiceUserAdminCountiesPageFilter"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() => {
                  pageFilterAdminCountiesAction(
                    'FilterActionedemokraciaServiceUserEdemokraciaServiceUserAdminCountiesTableEdemokraciaServiceUserEdemokraciaServiceUserAdminCountiesPageFilter-filter',
                    filterOptions,
                    filters,
                  );
                }}
              ...
              {isBulkDeleteAvailable() ? (
                <Button
                  id="RelationTypeedemokraciaServiceUserEdemokraciaServiceUserAdminCounties-bulk-delete"
                  disabled={isOwnerLoading}
                  variant="text"
