...
export type PageDeleteAdminCountiesAction = () => (
...
export const usePageDeleteAdminCountiesAction: PageDeleteAdminCountiesAction = () => {
  ...
  return async function pageDeleteAdminCountiesAction(
    selected: ServiceCountyStored,
    successCallback: () => void,
    errorCallback?: (error: any) => void,
    silentMode?: boolean,
    ...
    try {
      ...
      if (confirmed) {
        await serviceCountyServiceForClassImpl.delete(selected);
        if (!silentMode) {
