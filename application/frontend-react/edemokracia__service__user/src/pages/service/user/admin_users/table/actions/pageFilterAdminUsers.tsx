...
import { ServiceServiceUserQueryCustomizer } from '~/generated/data-api';
import { useFilterDialog } from '~/components/dialog';
import type { Filter, FilterOption } from '~/components-api';
import { mapAllFiltersToQueryCustomizerProperties } from '~/utilities';

export type PageFilterAdminUsersAction = (
  id: string,
  filterOptions: FilterOption[],
  filters: Filter[],
) => Promise<void>;

export const usePageFilterAdminUsersAction = (
  ...
  const columnNames = ['userName', 'isAdmin', 'firstName', 'lastName', 'phone', 'email', 'created'];

  return async function pageFilterAdminUsersAction(id: string, filterOptions: FilterOption[], filters: Filter[]) {
