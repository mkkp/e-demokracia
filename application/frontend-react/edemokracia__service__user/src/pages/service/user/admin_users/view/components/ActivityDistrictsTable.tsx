...
export const ActivityDistrictsTable = (props: ActivityDistrictsTableProps) => {
  ...
  const filterModelKey = `TableedemokraciaServiceUserEdemokraciaServiceUserAdminUsersViewDefaultServiceUserViewEditAreasLabelWrapperAreasActivityActivityDistrictsActivityDistrictsActivityDistrictsLabelWrapperActivityDistricts-${ownerData.__identifier}-filterModel`;
  const filtersKey = `TableedemokraciaServiceUserEdemokraciaServiceUserAdminUsersViewDefaultServiceUserViewEditAreasLabelWrapperAreasActivityActivityDistrictsActivityDistrictsActivityDistrictsLabelWrapperActivityDistricts-${ownerData.__identifier}-filters`;
  ...
  const activityDistrictsRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserAdminUsersViewDefaultServiceUserViewEditAreasLabelWrapperAreasActivityActivityDistrictsActivityDistrictsActivityDistrictsLabelWrapperActivityDistrictsRepresentationFilter',
  ...
  const activityDistrictsRowActions: TableRowAction<ServiceDistrictStored>[] = [
    {
      id: 'RemoveActionedemokraciaServiceUserEdemokraciaServiceUserAdminUsersViewEdemokraciaServiceUserEdemokraciaServiceServiceUserActivityDistrictsRowRemove',
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              ...
              <Button
                id="TableedemokraciaServiceUserEdemokraciaServiceUserAdminUsersViewDefaultServiceUserViewEditAreasLabelWrapperAreasActivityActivityDistrictsActivityDistrictsActivityDistrictsLabelWrapperActivityDistricts-filter"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() =>
                  filter(
                    'TableedemokraciaServiceUserEdemokraciaServiceUserAdminUsersViewDefaultServiceUserViewEditAreasLabelWrapperAreasActivityActivityDistrictsActivityDistrictsActivityDistrictsLabelWrapperActivityDistricts-filter',
                    filterOptions,
                    filters,
                  )
                }
