...
import { routeToServiceUserActiveIssuesView } from '~/routes';

export const ROW_VIEW_ACTIVE_ISSUES_ACTION_INTERFACE_KEY = 'RowViewActiveIssuesAction';
export type RowViewActiveIssuesAction = () => (entry: ServiceIssueStored, successCallback: () => void) => Promise<void>;
...
export const useRowViewActiveIssuesAction: RowViewActiveIssuesAction = () => {
  ...
  return async function (entry: ServiceIssueStored, successCallback: () => void) {
    closeAllDialogs();
    navigate(routeToServiceUserActiveIssuesView(entry.__signedIdentifier));
  };
};
