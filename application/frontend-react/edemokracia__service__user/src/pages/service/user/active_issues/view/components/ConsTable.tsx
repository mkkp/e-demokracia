...
export const SERVICE_USER_ACTIVE_ISSUES_VIEW_CONS = 'ServiceUserActiveIssuesViewCons';
...
export const ConsTable = (props: ConsTableProps) => {
  ...
  const filterModelKey = `TableedemokraciaServiceUserEdemokraciaServiceUserActiveIssuesViewDefaultIssueViewEditOtherArgumentsArgumentsConsLabelWrapperConsTableConsLabelWrapperCons-${ownerData.__identifier}-filterModel`;
  const filtersKey = `TableedemokraciaServiceUserEdemokraciaServiceUserActiveIssuesViewDefaultIssueViewEditOtherArgumentsArgumentsConsLabelWrapperConsTableConsLabelWrapperCons-${ownerData.__identifier}-filters`;
  ...
  const consRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserActiveIssuesViewDefaultIssueViewEditOtherArgumentsArgumentsConsLabelWrapperConsTableConsLabelWrapperConsTitleFilter',
      attributeName: 'title',
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserActiveIssuesViewDefaultIssueViewEditOtherArgumentsArgumentsConsLabelWrapperConsTableConsLabelWrapperConsUpVotesFilter',
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserActiveIssuesViewDefaultIssueViewEditOtherArgumentsArgumentsConsLabelWrapperConsTableConsLabelWrapperConsDownVotesFilter',
  ...
  const consRowActions: TableRowAction<ServiceConStored>[] = [
    {
      id: 'DeleteActionedemokraciaServiceUserEdemokraciaServiceUserActiveIssuesViewEdemokraciaServiceUserEdemokraciaServiceIssueConsRowDelete',
    ...
    {
      id: 'CallOperationActionedemokraciaServiceUserEdemokraciaServiceUserActiveIssuesViewEdemokraciaServiceUserEdemokraciaServiceConVoteUpButtonCallOperation',
    ...
    {
      id: 'CallOperationActionedemokraciaServiceUserEdemokraciaServiceUserActiveIssuesViewEdemokraciaServiceUserEdemokraciaServiceConVoteDownButtonCallOperation',
    ...
    {
      id: 'CallOperationActionedemokraciaServiceUserEdemokraciaServiceUserActiveIssuesViewEdemokraciaServiceUserEdemokraciaServiceConCreateProArgumentButtonCallOperation',
    ...
    {
      id: 'CallOperationActionedemokraciaServiceUserEdemokraciaServiceUserActiveIssuesViewEdemokraciaServiceUserEdemokraciaServiceConCreateConArgumentButtonCallOperation',
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              <Button
                id="TableedemokraciaServiceUserEdemokraciaServiceUserActiveIssuesViewDefaultIssueViewEditOtherArgumentsArgumentsConsLabelWrapperConsTableConsLabelWrapperCons-filter"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() =>
                  filter(
                    'TableedemokraciaServiceUserEdemokraciaServiceUserActiveIssuesViewDefaultIssueViewEditOtherArgumentsArgumentsConsLabelWrapperConsTableConsLabelWrapperCons-filter',
                    filterOptions,
                    filters,
                  )
                }
