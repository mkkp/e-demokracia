...
import {
  ratingVoteInputServiceForClassImpl,
  serviceRatingVoteDefinitionServiceForClassImpl,
} from '~/generated/data-axios';

export interface ServiceRatingVoteDefinitionVoteFormProps {
  successCallback: () => void;
  cancel: () => void;
  owner: ServiceRatingVoteDefinitionStored;
}

export default function ServiceRatingVoteDefinitionVoteForm({
  successCallback,
  cancel,
  owner,
}: ServiceRatingVoteDefinitionVoteFormProps) {
  ...
  const handleActionError = useErrorHandler<RatingVoteInput>(
    `(&(${OBJECTCLASS}=${ERROR_PROCESSOR_HOOK_INTERFACE_KEY})(operation=CallOperation)(component=ServiceRatingVoteDefinitionVoteForm))`,
  );
  ...
  const submit = async () => {
    ...
    try {
      await serviceRatingVoteDefinitionServiceForClassImpl.vote(owner, payloadDiff);
  ...
  return (
    <>
      <DialogTitle>
        {title}
        <IconButton
          id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceUserUserOwnedRatingVoteDefinitionsTableEdemokraciaServiceUserEdemokraciaServiceRatingVoteDefinitionVoteButtonCallOperation-dialog-close"
          aria-label="close"
          onClick={() => cancel()}
          sx={{
            position: 'absolute',
        ...
        <Grid container spacing={2} direction="column" alignItems="stretch" justifyContent="flex-start">
          <Grid item xs={12} sm={12}>
            <NumericInput
              required={false}
              name="value"
              id="NumericInputedemokraciaServiceUserEdemokraciaServiceRatingVoteDefinitionVoteInputDefaultRatingVoteInputFormValue"
              autoFocus
      ...
      <DialogActions>
        <Button
          id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceUserUserOwnedRatingVoteDefinitionsTableEdemokraciaServiceUserEdemokraciaServiceRatingVoteDefinitionVoteButtonCallOperation-action-form-action-cancel"
          variant="text"
          onClick={() => cancel()}
          disabled={isLoading}
        ...
        <LoadingButton
          ...
          id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceUserUserOwnedRatingVoteDefinitionsTableEdemokraciaServiceUserEdemokraciaServiceRatingVoteDefinitionVoteButtonCallOperation-action-form-action-submit"
          variant="contained"
          onClick={() => submit()}
