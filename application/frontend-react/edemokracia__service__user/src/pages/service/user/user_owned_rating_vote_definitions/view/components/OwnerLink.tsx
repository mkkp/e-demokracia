...
export type OwnerLinkFilterInitializer = (ownerData: ServiceRatingVoteDefinitionStored) => Filter[] | undefined;
...
export function OwnerLink(props: OwnerLinkProps) {
  ...
  const ownerColumns: GridColDef<ServiceServiceUserStored>[] = [
    {
      ...
      headerName: t('service.RatingVoteDefinitionView.owner.representation', {
  ...
  const ownerRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserUserOwnedRatingVoteDefinitionsViewDefaultRatingVoteDefinitionViewEditVoteEntryBaseVirtualOwnerRepresentationFilter',
      attributeName: 'representation',
      label: t('service.RatingVoteDefinitionView.owner.representation', { defaultValue: 'Representation' }) as string,
  ...
  return (
    <AggregationInput
      name="owner"
      id="LinkedemokraciaServiceUserEdemokraciaServiceUserUserOwnedRatingVoteDefinitionsViewDefaultRatingVoteDefinitionViewEditVoteEntryBaseVirtualOwner"
      label={t('service.RatingVoteDefinitionView.owner', { defaultValue: 'Owner' }) as string}
      ...
      onSet={async () => {
        const res = await openRangeDialog<ServiceServiceUserStored, ServiceServiceUserQueryCustomizer>({
          id: 'RelationTypeedemokraciaServiceUserEdemokraciaServiceRatingVoteDefinitionOwner',
          columns: ownerColumns,
          defaultSortField: ([{ field: 'representation', sort: null }] as GridSortItem[])[0],
          rangeCall: async (queryCustomizer) =>
            await serviceRatingVoteDefinitionServiceForClassImpl.getRangeForOwner(
              ownerData,
      ...
      onAutoCompleteSearch={async (searchText: string) => {
        ...
        return await serviceRatingVoteDefinitionServiceForClassImpl.getRangeForOwner(
          ownerData,
          processQueryCustomizer(queryCustomizer),
        );
      }}
