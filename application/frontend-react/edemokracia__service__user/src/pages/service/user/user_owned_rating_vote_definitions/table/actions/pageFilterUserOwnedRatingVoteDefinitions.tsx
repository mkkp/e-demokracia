...
import { ServiceRatingVoteDefinitionQueryCustomizer } from '~/generated/data-api';
import { useFilterDialog } from '~/components/dialog';
import type { Filter, FilterOption } from '~/components-api';
import { mapAllFiltersToQueryCustomizerProperties } from '~/utilities';

export type PageFilterUserOwnedRatingVoteDefinitionsAction = (
  id: string,
  filterOptions: FilterOption[],
  filters: Filter[],
) => Promise<void>;

export const usePageFilterUserOwnedRatingVoteDefinitionsAction = (
  ...
  const columnNames = ['minRateValue', 'maxRateValue', 'title', 'created', 'description', 'status', 'closeAt'];

  return async function pageFilterUserOwnedRatingVoteDefinitionsAction(
    id: string,
    filterOptions: FilterOption[],
    filters: Filter[],
  ) {
