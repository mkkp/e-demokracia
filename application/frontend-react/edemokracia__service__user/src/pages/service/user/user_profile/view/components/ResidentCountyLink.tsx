...
export type ResidentCountyLinkFilterInitializer = (ownerData: ServiceUserProfileStored) => Filter[] | undefined;
...
export function ResidentCountyLink(props: ResidentCountyLinkProps) {
  ...
  const residentCountyColumns: GridColDef<ServiceCountyStored>[] = [
    {
      ...
      headerName: t('service.UserProfileView.residentCounty.representation', { defaultValue: 'County' }) as string,
  ...
  const residentCountyRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserUserProfileViewDefaultUserProfileViewEditAreasLabelWrapperAreasResidencyResidentCountyRepresentationFilter',
      attributeName: 'representation',
      label: t('service.UserProfileView.residentCounty.representation', { defaultValue: 'County' }) as string,
  ...
  return (
    <AggregationInput
      name="residentCounty"
      id="LinkedemokraciaServiceUserEdemokraciaServiceUserUserProfileViewDefaultUserProfileViewEditAreasLabelWrapperAreasResidencyResidentCounty"
      label={t('service.UserProfileView.residentCounty', { defaultValue: 'Resident county' }) as string}
