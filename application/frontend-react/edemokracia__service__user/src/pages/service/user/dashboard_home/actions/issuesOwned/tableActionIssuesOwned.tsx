...
export type TableActionIssuesOwnedAction = (
  id: string,
  filterOptions: FilterOption[],
  filters: Filter[],
) => Promise<void>;

export const useTableActionIssuesOwnedAction = (
  ...
  return async function tableActionIssuesOwnedAction(id: string, filterOptions: FilterOption[], filters: Filter[]) {
