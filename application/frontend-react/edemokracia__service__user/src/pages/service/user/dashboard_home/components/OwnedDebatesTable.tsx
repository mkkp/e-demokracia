...
export const SERVICE_USER_DASHBOARD_HOME_DASHBOARD_OWNED_DEBATES = 'ServiceUserDashboardHomeDashboardOwnedDebates';
...
export const OwnedDebatesTable = forwardRef<RefreshableTable, OwnedDebatesTableProps>((props, ref) => {
  ...
  const filterModelKey = `TableedemokraciaServiceUserEdemokraciaServiceUserDashboardHomeDashboardDefaultDashboardViewEditSelectorDebatesDebatesDebateTabBarMydebatesMydebatesOwnedDebatesLabelWrapperOwnedDebates-${ownerData.__signedIdentifier}-filterModel`;
  const filtersKey = `TableedemokraciaServiceUserEdemokraciaServiceUserDashboardHomeDashboardDefaultDashboardViewEditSelectorDebatesDebatesDebateTabBarMydebatesMydebatesOwnedDebatesLabelWrapperOwnedDebates-${ownerData.__signedIdentifier}-filters`;
  ...
  const ownedDebatesColumns: GridColDef<ServiceDebateStored>[] = [
    {
      ...baseColumnConfig,
      field: 'scope',
      headerName: t('edemokracia.service.User.dashboardHome.Dashboard.ownedDebates.scope', {
        defaultValue: 'Scope',
      }) as string,
    ...
    },
    {
      ...
      headerName: t('edemokracia.service.User.dashboardHome.Dashboard.ownedDebates.countyRepresentation', {
    ...
    },
    {
      ...
      headerName: t('edemokracia.service.User.dashboardHome.Dashboard.ownedDebates.cityRepresentation', {
    ...
    },
    {
      ...
      headerName: t('edemokracia.service.User.dashboardHome.Dashboard.ownedDebates.districtRepresentation', {
    ...
    },
    {
      ...baseColumnConfig,
      field: 'title',
      headerName: t('edemokracia.service.User.dashboardHome.Dashboard.ownedDebates.title', {
        defaultValue: 'Title',
      }) as string,
      headerClassName: 'data-grid-column-header',
    ...
    },
    {
      ...baseColumnConfig,
      field: 'closeAt',
      headerName: t('edemokracia.service.User.dashboardHome.Dashboard.ownedDebates.closeAt', {
    ...
    },
    {
      ...baseColumnConfig,
      field: 'status',
      headerName: t('edemokracia.service.User.dashboardHome.Dashboard.ownedDebates.status', {
        defaultValue: 'Status',
      }) as string,
      headerClassName: 'data-grid-column-header',
    ...
    },
    {
      ...baseColumnConfig,
      field: 'issueTitle',
      headerName: t('edemokracia.service.User.dashboardHome.Dashboard.ownedDebates.issueTitle', {
  ...
  const ownedDebatesRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserDashboardHomeDashboardDefaultDashboardViewEditSelectorDebatesDebatesDebateTabBarMydebatesMydebatesOwnedDebatesLabelWrapperOwnedDebatesScopeFilter',
      attributeName: 'scope',
      label: t('edemokracia.service.User.dashboardHome.Dashboard.ownedDebates.scope', {
        defaultValue: 'Scope',
      }) as string,
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserDashboardHomeDashboardDefaultDashboardViewEditSelectorDebatesDebatesDebateTabBarMydebatesMydebatesOwnedDebatesLabelWrapperOwnedDebatesCountyRepresentationFilter',
      attributeName: 'countyRepresentation',
      label: t('edemokracia.service.User.dashboardHome.Dashboard.ownedDebates.countyRepresentation', {
        defaultValue: 'CountyRepresentation',
      }) as string,
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserDashboardHomeDashboardDefaultDashboardViewEditSelectorDebatesDebatesDebateTabBarMydebatesMydebatesOwnedDebatesLabelWrapperOwnedDebatesCityRepresentationFilter',
      attributeName: 'cityRepresentation',
      label: t('edemokracia.service.User.dashboardHome.Dashboard.ownedDebates.cityRepresentation', {
        defaultValue: 'CityRepresentation',
      }) as string,
      filterType: FilterType.string,
    },
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserDashboardHomeDashboardDefaultDashboardViewEditSelectorDebatesDebatesDebateTabBarMydebatesMydebatesOwnedDebatesLabelWrapperOwnedDebatesDistrictRepresentationFilter',
      attributeName: 'districtRepresentation',
      label: t('edemokracia.service.User.dashboardHome.Dashboard.ownedDebates.districtRepresentation', {
        defaultValue: 'DistrictRepresentation',
      }) as string,
      filterType: FilterType.string,
    },
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserDashboardHomeDashboardDefaultDashboardViewEditSelectorDebatesDebatesDebateTabBarMydebatesMydebatesOwnedDebatesLabelWrapperOwnedDebatesTitleFilter',
      attributeName: 'title',
      label: t('edemokracia.service.User.dashboardHome.Dashboard.ownedDebates.title', {
        defaultValue: 'Title',
      }) as string,
      filterType: FilterType.string,
    },
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserDashboardHomeDashboardDefaultDashboardViewEditSelectorDebatesDebatesDebateTabBarMydebatesMydebatesOwnedDebatesLabelWrapperOwnedDebatesCloseAtFilter',
      attributeName: 'closeAt',
      label: t('edemokracia.service.User.dashboardHome.Dashboard.ownedDebates.closeAt', {
        defaultValue: 'CloseAt',
      }) as string,
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserDashboardHomeDashboardDefaultDashboardViewEditSelectorDebatesDebatesDebateTabBarMydebatesMydebatesOwnedDebatesLabelWrapperOwnedDebatesStatusFilter',
      attributeName: 'status',
      label: t('edemokracia.service.User.dashboardHome.Dashboard.ownedDebates.status', {
        defaultValue: 'Status',
      }) as string,
      filterType: FilterType.enumeration,
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserDashboardHomeDashboardDefaultDashboardViewEditSelectorDebatesDebatesDebateTabBarMydebatesMydebatesOwnedDebatesLabelWrapperOwnedDebatesIssueTitleFilter',
      attributeName: 'issueTitle',
      label: t('edemokracia.service.User.dashboardHome.Dashboard.ownedDebates.issueTitle', {
        defaultValue: 'IssueTitle',
      }) as string,
      filterType: FilterType.string,
    },
  ...
  const rowActions: TableRowAction<ServiceDebateStored>[] = [
    {
      id: 'DeleteActionedemokraciaServiceUserEdemokraciaServiceUserDashboardHomeDashboardEdemokraciaServiceUserEdemokraciaServiceDashboardOwnedDebatesRowDelete',
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              <Button
                id="FilterRelationActionedemokraciaServiceUserEdemokraciaServiceUserDashboardHomeDashboardEdemokraciaServiceUserEdemokraciaServiceDashboardOwnedDebatesTableAction"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() => {
                  tableActionOwnedDebatesAction(
                    'FilterRelationActionedemokraciaServiceUserEdemokraciaServiceUserDashboardHomeDashboardEdemokraciaServiceUserEdemokraciaServiceDashboardOwnedDebatesTableAction-filter',
                    filterOptions,
                    filters,
                  );
                }}
