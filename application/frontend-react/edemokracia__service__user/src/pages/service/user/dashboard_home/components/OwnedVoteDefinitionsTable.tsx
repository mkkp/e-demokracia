...
export const SERVICE_USER_DASHBOARD_HOME_DASHBOARD_OWNED_VOTE_DEFINITIONS =
  'ServiceUserDashboardHomeDashboardOwnedVoteDefinitions';
...
export const OwnedVoteDefinitionsTable = forwardRef<RefreshableTable, OwnedVoteDefinitionsTableProps>((props, ref) => {
  ...
  const filterModelKey = `TableedemokraciaServiceUserEdemokraciaServiceUserDashboardHomeDashboardDefaultDashboardViewEditSelectorVotesVotesVotesTabBarMyVotesGroupMyVotesGroupOwnedVoteDefinitionsLabelWrapperOwnedVoteDefinitions-${ownerData.__signedIdentifier}-filterModel`;
  const filtersKey = `TableedemokraciaServiceUserEdemokraciaServiceUserDashboardHomeDashboardDefaultDashboardViewEditSelectorVotesVotesVotesTabBarMyVotesGroupMyVotesGroupOwnedVoteDefinitionsLabelWrapperOwnedVoteDefinitions-${ownerData.__signedIdentifier}-filters`;
  ...
  const ownedVoteDefinitionsColumns: GridColDef<ServiceVoteDefinitionStored>[] = [
    {
      ...baseColumnConfig,
      field: 'scope',
      headerName: t('edemokracia.service.User.dashboardHome.Dashboard.ownedVoteDefinitions.scope', {
        defaultValue: 'Scope',
      }) as string,
    ...
    },
    {
      ...
      headerName: t('edemokracia.service.User.dashboardHome.Dashboard.ownedVoteDefinitions.countyRepresentation', {
    ...
    },
    {
      ...
      headerName: t('edemokracia.service.User.dashboardHome.Dashboard.ownedVoteDefinitions.cityRepresentation', {
    ...
    },
    {
      ...
      headerName: t('edemokracia.service.User.dashboardHome.Dashboard.ownedVoteDefinitions.districtRepresentation', {
    ...
    },
    {
      ...baseColumnConfig,
      field: 'title',
      headerName: t('edemokracia.service.User.dashboardHome.Dashboard.ownedVoteDefinitions.title', {
        defaultValue: 'Title',
      }) as string,
      headerClassName: 'data-grid-column-header',
    ...
    },
    {
      ...baseColumnConfig,
      field: 'voteType',
      headerName: t('edemokracia.service.User.dashboardHome.Dashboard.ownedVoteDefinitions.voteType', {
    ...
    },
    {
      ...baseColumnConfig,
      field: 'created',
      headerName: t('edemokracia.service.User.dashboardHome.Dashboard.ownedVoteDefinitions.created', {
    ...
    },
    {
      ...baseColumnConfig,
      field: 'closeAt',
      headerName: t('edemokracia.service.User.dashboardHome.Dashboard.ownedVoteDefinitions.closeAt', {
    ...
    },
    {
      ...baseColumnConfig,
      field: 'numberOfVotes',
      headerName: t('edemokracia.service.User.dashboardHome.Dashboard.ownedVoteDefinitions.numberOfVotes', {
    ...
    },
    {
      ...baseColumnConfig,
      field: 'status',
      headerName: t('edemokracia.service.User.dashboardHome.Dashboard.ownedVoteDefinitions.status', {
        defaultValue: 'Status',
      }) as string,
      headerClassName: 'data-grid-column-header',
  ...
  const ownedVoteDefinitionsRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserDashboardHomeDashboardDefaultDashboardViewEditSelectorVotesVotesVotesTabBarMyVotesGroupMyVotesGroupOwnedVoteDefinitionsLabelWrapperOwnedVoteDefinitionsScopeFilter',
      attributeName: 'scope',
      label: t('edemokracia.service.User.dashboardHome.Dashboard.ownedVoteDefinitions.scope', {
        defaultValue: 'Scope',
      }) as string,
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserDashboardHomeDashboardDefaultDashboardViewEditSelectorVotesVotesVotesTabBarMyVotesGroupMyVotesGroupOwnedVoteDefinitionsLabelWrapperOwnedVoteDefinitionsCountyRepresentationFilter',
      attributeName: 'countyRepresentation',
      label: t('edemokracia.service.User.dashboardHome.Dashboard.ownedVoteDefinitions.countyRepresentation', {
        defaultValue: 'CountyRepresentation',
      }) as string,
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserDashboardHomeDashboardDefaultDashboardViewEditSelectorVotesVotesVotesTabBarMyVotesGroupMyVotesGroupOwnedVoteDefinitionsLabelWrapperOwnedVoteDefinitionsCityRepresentationFilter',
      attributeName: 'cityRepresentation',
      label: t('edemokracia.service.User.dashboardHome.Dashboard.ownedVoteDefinitions.cityRepresentation', {
        defaultValue: 'CityRepresentation',
      }) as string,
      filterType: FilterType.string,
    },
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserDashboardHomeDashboardDefaultDashboardViewEditSelectorVotesVotesVotesTabBarMyVotesGroupMyVotesGroupOwnedVoteDefinitionsLabelWrapperOwnedVoteDefinitionsDistrictRepresentationFilter',
      attributeName: 'districtRepresentation',
      label: t('edemokracia.service.User.dashboardHome.Dashboard.ownedVoteDefinitions.districtRepresentation', {
        defaultValue: 'DistrictRepresentation',
      }) as string,
      filterType: FilterType.string,
    },
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserDashboardHomeDashboardDefaultDashboardViewEditSelectorVotesVotesVotesTabBarMyVotesGroupMyVotesGroupOwnedVoteDefinitionsLabelWrapperOwnedVoteDefinitionsTitleFilter',
      attributeName: 'title',
      label: t('edemokracia.service.User.dashboardHome.Dashboard.ownedVoteDefinitions.title', {
        defaultValue: 'Title',
      }) as string,
      filterType: FilterType.string,
    },
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserDashboardHomeDashboardDefaultDashboardViewEditSelectorVotesVotesVotesTabBarMyVotesGroupMyVotesGroupOwnedVoteDefinitionsLabelWrapperOwnedVoteDefinitionsVoteTypeFilter',
      attributeName: 'voteType',
      label: t('edemokracia.service.User.dashboardHome.Dashboard.ownedVoteDefinitions.voteType', {
        defaultValue: 'VoteType',
      }) as string,
      filterType: FilterType.enumeration,
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserDashboardHomeDashboardDefaultDashboardViewEditSelectorVotesVotesVotesTabBarMyVotesGroupMyVotesGroupOwnedVoteDefinitionsLabelWrapperOwnedVoteDefinitionsCreatedFilter',
      attributeName: 'created',
      label: t('edemokracia.service.User.dashboardHome.Dashboard.ownedVoteDefinitions.created', {
        defaultValue: 'Created',
      }) as string,
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserDashboardHomeDashboardDefaultDashboardViewEditSelectorVotesVotesVotesTabBarMyVotesGroupMyVotesGroupOwnedVoteDefinitionsLabelWrapperOwnedVoteDefinitionsCloseAtFilter',
      attributeName: 'closeAt',
      label: t('edemokracia.service.User.dashboardHome.Dashboard.ownedVoteDefinitions.closeAt', {
        defaultValue: 'CloseAt',
      }) as string,
      filterType: FilterType.dateTime,
    },
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserDashboardHomeDashboardDefaultDashboardViewEditSelectorVotesVotesVotesTabBarMyVotesGroupMyVotesGroupOwnedVoteDefinitionsLabelWrapperOwnedVoteDefinitionsNumberOfVotesFilter',
      attributeName: 'numberOfVotes',
      label: t('edemokracia.service.User.dashboardHome.Dashboard.ownedVoteDefinitions.numberOfVotes', {
        defaultValue: 'NumberOfVotes',
      }) as string,
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserDashboardHomeDashboardDefaultDashboardViewEditSelectorVotesVotesVotesTabBarMyVotesGroupMyVotesGroupOwnedVoteDefinitionsLabelWrapperOwnedVoteDefinitionsStatusFilter',
      attributeName: 'status',
      label: t('edemokracia.service.User.dashboardHome.Dashboard.ownedVoteDefinitions.status', {
        defaultValue: 'Status',
      }) as string,
      filterType: FilterType.enumeration,
  ...
  const rowActions: TableRowAction<ServiceVoteDefinitionStored>[] = [
    {
      id: 'DeleteActionedemokraciaServiceUserEdemokraciaServiceUserDashboardHomeDashboardEdemokraciaServiceUserEdemokraciaServiceDashboardOwnedVoteDefinitionsRowDelete',
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              <Button
                id="FilterRelationActionedemokraciaServiceUserEdemokraciaServiceUserDashboardHomeDashboardEdemokraciaServiceUserEdemokraciaServiceDashboardOwnedVoteDefinitionsTableAction"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() => {
                  tableActionOwnedVoteDefinitionsAction(
                    'FilterRelationActionedemokraciaServiceUserEdemokraciaServiceUserDashboardHomeDashboardEdemokraciaServiceUserEdemokraciaServiceDashboardOwnedVoteDefinitionsTableAction-filter',
                    filterOptions,
                    filters,
                  );
                }}
