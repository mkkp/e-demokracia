...
export type TableActionFavoriteVoteDefinitionsAction = (
  id: string,
  filterOptions: FilterOption[],
  filters: Filter[],
) => Promise<void>;

export const useTableActionFavoriteVoteDefinitionsAction = (
  ...
  return async function tableActionFavoriteVoteDefinitionsAction(
    id: string,
    filterOptions: FilterOption[],
    filters: Filter[],
  ) {
