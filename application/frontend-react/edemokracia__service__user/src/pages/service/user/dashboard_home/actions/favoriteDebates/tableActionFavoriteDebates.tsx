...
export type TableActionFavoriteDebatesAction = (
  id: string,
  filterOptions: FilterOption[],
  filters: Filter[],
) => Promise<void>;

export const useTableActionFavoriteDebatesAction = (
  ...
  const columnNames = ['title', 'closeAt', 'status', 'issueTitle'];

  return async function tableActionFavoriteDebatesAction(id: string, filterOptions: FilterOption[], filters: Filter[]) {
