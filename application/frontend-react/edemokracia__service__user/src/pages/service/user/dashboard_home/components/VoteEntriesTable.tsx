...
export const SERVICE_USER_DASHBOARD_HOME_DASHBOARD_VOTE_ENTRIES = 'ServiceUserDashboardHomeDashboardVoteEntries';
...
export const VoteEntriesTable = forwardRef<RefreshableTable, VoteEntriesTableProps>((props, ref) => {
  ...
  const filterModelKey = `TableedemokraciaServiceUserEdemokraciaServiceUserDashboardHomeDashboardDefaultDashboardViewEditSelectorVotesCastVotesCastVoteEntriesLabelWrapperVoteEntries-${ownerData.__signedIdentifier}-filterModel`;
  const filtersKey = `TableedemokraciaServiceUserEdemokraciaServiceUserDashboardHomeDashboardDefaultDashboardViewEditSelectorVotesCastVotesCastVoteEntriesLabelWrapperVoteEntries-${ownerData.__signedIdentifier}-filters`;
  ...
  const userVoteEntriesColumns: GridColDef<ServiceVoteEntryStored>[] = [
    {
      ...baseColumnConfig,
      field: 'created',
      headerName: t('edemokracia.service.User.dashboardHome.Dashboard.userVoteEntries.created', {
    ...
    },
    {
      ...baseColumnConfig,
      field: 'issueTitle',
      headerName: t('edemokracia.service.User.dashboardHome.Dashboard.userVoteEntries.issueTitle', {
    ...
    },
    {
      ...baseColumnConfig,
      field: 'debateTitle',
      headerName: t('edemokracia.service.User.dashboardHome.Dashboard.userVoteEntries.debateTitle', {
    ...
    },
    {
      ...baseColumnConfig,
      field: 'voteTitle',
      headerName: t('edemokracia.service.User.dashboardHome.Dashboard.userVoteEntries.voteTitle', {
    ...
    },
    {
      ...baseColumnConfig,
      field: 'voteStatus',
      headerName: t('edemokracia.service.User.dashboardHome.Dashboard.userVoteEntries.voteStatus', {
  ...
  const userVoteEntriesRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserDashboardHomeDashboardDefaultDashboardViewEditSelectorVotesCastVotesCastVoteEntriesLabelWrapperVoteEntriesCreatedFilter',
      attributeName: 'created',
      label: t('edemokracia.service.User.dashboardHome.Dashboard.userVoteEntries.created', {
        defaultValue: 'Created',
      }) as string,
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserDashboardHomeDashboardDefaultDashboardViewEditSelectorVotesCastVotesCastVoteEntriesLabelWrapperVoteEntriesIssueTitleFilter',
      attributeName: 'issueTitle',
      label: t('edemokracia.service.User.dashboardHome.Dashboard.userVoteEntries.issueTitle', {
        defaultValue: 'IssueTitle',
      }) as string,
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserDashboardHomeDashboardDefaultDashboardViewEditSelectorVotesCastVotesCastVoteEntriesLabelWrapperVoteEntriesDebateTitleFilter',
      attributeName: 'debateTitle',
      label: t('edemokracia.service.User.dashboardHome.Dashboard.userVoteEntries.debateTitle', {
        defaultValue: 'DebateTitle',
      }) as string,
      filterType: FilterType.string,
    },
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserDashboardHomeDashboardDefaultDashboardViewEditSelectorVotesCastVotesCastVoteEntriesLabelWrapperVoteEntriesVoteTitleFilter',
      attributeName: 'voteTitle',
      label: t('edemokracia.service.User.dashboardHome.Dashboard.userVoteEntries.voteTitle', {
        defaultValue: 'VoteTitle',
      }) as string,
      filterType: FilterType.string,
    },
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserDashboardHomeDashboardDefaultDashboardViewEditSelectorVotesCastVotesCastVoteEntriesLabelWrapperVoteEntriesVoteStatusFilter',
      attributeName: 'voteStatus',
      label: t('edemokracia.service.User.dashboardHome.Dashboard.userVoteEntries.voteStatus', {
        defaultValue: 'VoteStatus',
      }) as string,
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              <Button
                id="FilterRelationActionedemokraciaServiceUserEdemokraciaServiceUserDashboardHomeDashboardEdemokraciaServiceUserEdemokraciaServiceDashboardUserVoteEntriesTableAction"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() => {
                  tableActionUserVoteEntriesAction(
                    'FilterRelationActionedemokraciaServiceUserEdemokraciaServiceUserDashboardHomeDashboardEdemokraciaServiceUserEdemokraciaServiceDashboardUserVoteEntriesTableAction-filter',
                    filterOptions,
                    filters,
                  );
                }}
