...
import { usePageDeleteAdminVoteDefinitionsAction, usePageRefreshAdminVoteDefinitionsAction } from '../actions';
...
export function PageActions(props: PageActionsProps) {
  ...
  const pageDeleteAdminVoteDefinitionsAction = usePageDeleteAdminVoteDefinitionsAction();
