...
// Page name: edemokracia::service::User.adminVoteDefinitions#Table
...
/**
 * Name: edemokracia::service::User.adminVoteDefinitions#Table
 * Is Access: true
 * Is Dashboard: false
 * Type: Table
 **/
export default function ServiceUserAdminVoteDefinitionsTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaServiceUserEdemokraciaServiceUserAdminVoteDefinitionsTable-data-grid">
