...
import { routeToServiceUserUserOwnedYesNoAbstainVoteDefinitionsView } from '~/routes';
...
export type RowViewUserOwnedYesNoAbstainVoteDefinitionsAction = () => (
  entry: ServiceYesNoAbstainVoteDefinitionStored,
...
export const useRowViewUserOwnedYesNoAbstainVoteDefinitionsAction: RowViewUserOwnedYesNoAbstainVoteDefinitionsAction =
  () => {
    ...
    return async function (entry: ServiceYesNoAbstainVoteDefinitionStored, successCallback: () => void) {
      closeAllDialogs();
      navigate(routeToServiceUserUserOwnedYesNoAbstainVoteDefinitionsView(entry.__signedIdentifier));
    };
  };
