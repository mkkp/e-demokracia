...
import { ServiceYesNoAbstainVoteDefinitionQueryCustomizer } from '~/generated/data-api';
import { useFilterDialog } from '~/components/dialog';
import type { Filter, FilterOption } from '~/components-api';
import { mapAllFiltersToQueryCustomizerProperties } from '~/utilities';

export type PageFilterUserOwnedYesNoAbstainVoteDefinitionsAction = (
  id: string,
  filterOptions: FilterOption[],
  filters: Filter[],
) => Promise<void>;

export const usePageFilterUserOwnedYesNoAbstainVoteDefinitionsAction = (
  ...
  return async function pageFilterUserOwnedYesNoAbstainVoteDefinitionsAction(
    id: string,
    filterOptions: FilterOption[],
    filters: Filter[],
  ) {
