...
export interface UserVoteEntryLinkProps {
  ...
  onChange: (value: ServiceYesNoAbstainVoteEntry | ServiceYesNoAbstainVoteEntryStored | null) => void;
  disabled: boolean;
  readOnly: boolean;
  editMode: boolean;
}
...
export function UserVoteEntryLink(props: UserVoteEntryLinkProps) {
  ...
  return (
    <AggregationInput
      name="userVoteEntry"
      id="LinkedemokraciaServiceUserEdemokraciaServiceUserUserOwnedYesNoAbstainVoteDefinitionsViewDefaultYesNoAbstainVoteDefinitionViewEditUserVoteEntryGroupLabelWrapperUserVoteEntryGroupUserVoteVirtualForUserVoteUserVoteEntry"
      label={t('service.YesNoAbstainVoteDefinitionView.userVoteEntry', { defaultValue: 'Value' }) as string}
      ...
      onAutoCompleteSelect={(userVoteEntry) => {
        ...
        onChange(userVoteEntry as ServiceYesNoAbstainVoteEntryStored);
      }}
