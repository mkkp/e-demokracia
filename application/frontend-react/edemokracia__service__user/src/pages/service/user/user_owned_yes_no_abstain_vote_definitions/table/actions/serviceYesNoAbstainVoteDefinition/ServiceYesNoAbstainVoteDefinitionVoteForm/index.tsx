...
export interface ServiceYesNoAbstainVoteDefinitionVoteFormProps {
  successCallback: () => void;
  cancel: () => void;
  owner: ServiceYesNoAbstainVoteDefinitionStored;
}

export default function ServiceYesNoAbstainVoteDefinitionVoteForm({
  successCallback,
  cancel,
  owner,
}: ServiceYesNoAbstainVoteDefinitionVoteFormProps) {
  ...
  const handleActionError = useErrorHandler<YesNoAbstainVoteInput>(
    `(&(${OBJECTCLASS}=${ERROR_PROCESSOR_HOOK_INTERFACE_KEY})(operation=CallOperation)(component=ServiceYesNoAbstainVoteDefinitionVoteForm))`,
  );
  ...
  const submit = async () => {
    ...
    try {
      await serviceYesNoAbstainVoteDefinitionServiceForClassImpl.vote(owner, payloadDiff);
  ...
  return (
    <>
      <DialogTitle>
        {title}
        <IconButton
          id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceUserUserOwnedYesNoAbstainVoteDefinitionsTableEdemokraciaServiceUserEdemokraciaServiceYesNoAbstainVoteDefinitionVoteButtonCallOperation-dialog-close"
          aria-label="close"
          onClick={() => cancel()}
          sx={{
            position: 'absolute',
        ...
        <Grid container spacing={2} direction="column" alignItems="stretch" justifyContent="flex-start">
          <Grid item xs={12} sm={12}>
            <TextField
              required={false}
              name="value"
              id="EnumerationComboedemokraciaServiceUserEdemokraciaServiceYesNoAbstainVoteDefinitionVoteInputDefaultYesNoAbstainVoteInputFormValue"
              autoFocus
      ...
      <DialogActions>
        <Button
          id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceUserUserOwnedYesNoAbstainVoteDefinitionsTableEdemokraciaServiceUserEdemokraciaServiceYesNoAbstainVoteDefinitionVoteButtonCallOperation-action-form-action-cancel"
          variant="text"
          onClick={() => cancel()}
          disabled={isLoading}
        ...
        <LoadingButton
          ...
          id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceUserUserOwnedYesNoAbstainVoteDefinitionsTableEdemokraciaServiceUserEdemokraciaServiceYesNoAbstainVoteDefinitionVoteButtonCallOperation-action-form-action-submit"
          variant="contained"
          onClick={() => submit()}
