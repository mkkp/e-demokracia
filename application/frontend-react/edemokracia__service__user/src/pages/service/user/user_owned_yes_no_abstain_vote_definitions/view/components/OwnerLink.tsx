...
export type OwnerLinkFilterInitializer = (ownerData: ServiceYesNoAbstainVoteDefinitionStored) => Filter[] | undefined;
...
export interface OwnerLinkProps {
  ...
  validation: Map<keyof ServiceYesNoAbstainVoteDefinitionStored, string>;
...
export function OwnerLink(props: OwnerLinkProps) {
  ...
  const ownerColumns: GridColDef<ServiceServiceUserStored>[] = [
    {
      ...
      headerName: t('service.YesNoAbstainVoteDefinitionView.owner.representation', {
  ...
  const ownerRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserUserOwnedYesNoAbstainVoteDefinitionsViewDefaultYesNoAbstainVoteDefinitionViewEditVoteEntryBaseVirtualOwnerRepresentationFilter',
      attributeName: 'representation',
      label: t('service.YesNoAbstainVoteDefinitionView.owner.representation', {
        defaultValue: 'Representation',
      }) as string,
  ...
  return (
    <AggregationInput
      name="owner"
      id="LinkedemokraciaServiceUserEdemokraciaServiceUserUserOwnedYesNoAbstainVoteDefinitionsViewDefaultYesNoAbstainVoteDefinitionViewEditVoteEntryBaseVirtualOwner"
      label={t('service.YesNoAbstainVoteDefinitionView.owner', { defaultValue: 'Owner' }) as string}
      ...
      onSet={async () => {
        const res = await openRangeDialog<ServiceServiceUserStored, ServiceServiceUserQueryCustomizer>({
          id: 'RelationTypeedemokraciaServiceUserEdemokraciaServiceYesNoAbstainVoteDefinitionOwner',
          columns: ownerColumns,
          defaultSortField: ([{ field: 'representation', sort: null }] as GridSortItem[])[0],
          rangeCall: async (queryCustomizer) =>
            await serviceYesNoAbstainVoteDefinitionServiceForClassImpl.getRangeForOwner(
              ownerData,
      ...
      onAutoCompleteSearch={async (searchText: string) => {
        ...
        return await serviceYesNoAbstainVoteDefinitionServiceForClassImpl.getRangeForOwner(
          ownerData,
          processQueryCustomizer(queryCustomizer),
        );
      }}
