...
// Page name: edemokracia::service::User.userOwnedVoteEntries#Table
...
/**
 * Name: edemokracia::service::User.userOwnedVoteEntries#Table
 * Is Access: true
 * Is Dashboard: false
 * Type: Table
 **/
export default function ServiceUserUserOwnedVoteEntriesTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaServiceUserEdemokraciaServiceUserUserOwnedVoteEntriesTable-data-grid">
