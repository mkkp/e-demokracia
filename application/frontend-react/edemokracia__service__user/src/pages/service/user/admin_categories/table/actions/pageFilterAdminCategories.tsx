...
import { ServiceIssueCategoryQueryCustomizer } from '~/generated/data-api';
import { useFilterDialog } from '~/components/dialog';
import type { Filter, FilterOption } from '~/components-api';
import { mapAllFiltersToQueryCustomizerProperties } from '~/utilities';

export type PageFilterAdminCategoriesAction = (
  id: string,
  filterOptions: FilterOption[],
  filters: Filter[],
) => Promise<void>;

export const usePageFilterAdminCategoriesAction = (
  ...
  return async function pageFilterAdminCategoriesAction(id: string, filterOptions: FilterOption[], filters: Filter[]) {
