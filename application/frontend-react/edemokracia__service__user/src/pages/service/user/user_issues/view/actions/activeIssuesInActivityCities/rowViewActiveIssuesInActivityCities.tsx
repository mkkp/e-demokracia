...
import { routeToServiceUserIssuesActiveIssuesInActivityCitiesView } from '~/routes';
...
export const useRowViewActiveIssuesInActivityCitiesAction: RowViewActiveIssuesInActivityCitiesAction = () => {
  ...
  return async function (
    ...
    closeAllDialogs();
    navigate(routeToServiceUserIssuesActiveIssuesInActivityCitiesView(entry.__signedIdentifier));
  };
};
