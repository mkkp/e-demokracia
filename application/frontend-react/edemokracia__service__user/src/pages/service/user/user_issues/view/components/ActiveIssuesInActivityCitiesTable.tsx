...
export const SERVICE_USER_USER_ISSUES_VIEW_ACTIVE_ISSUES_IN_ACTIVITY_CITIES =
  'ServiceUserUserIssuesViewActiveIssuesInActivityCities';
...
export const ActiveIssuesInActivityCitiesTable = forwardRef<RefreshableTable, ActiveIssuesInActivityCitiesTableProps>(
  (props, ref) => {
    ...
    const filterModelKey = `-${ownerData.__signedIdentifier}-filterModel`;
    const filtersKey = `-${ownerData.__signedIdentifier}-filters`;
    ...
    const activeIssuesInActivityCitiesColumns: GridColDef<ServiceIssueStored>[] = [
      {
        ...
        headerName: t('service.UserIssuesView.activeIssuesInActivityCities.countyRepresentation', {
      ...
      },
      {
        ...
        headerName: t('service.UserIssuesView.activeIssuesInActivityCities.cityRepresentation', {
      ...
      },
      {
        ...baseColumnConfig,
        field: 'title',
        headerName: t('service.UserIssuesView.activeIssuesInActivityCities.title', { defaultValue: 'Title' }) as string,
        headerClassName: 'data-grid-column-header',
      ...
      },
      {
        ...baseColumnConfig,
        field: 'created',
        headerName: t('service.UserIssuesView.activeIssuesInActivityCities.created', {
      ...
      },
      {
        ...
        headerName: t('service.UserIssuesView.activeIssuesInActivityCities.numberOfDebates', {
      ...
      },
      {
        ...baseColumnConfig,
        field: 'status',
        headerName: t('service.UserIssuesView.activeIssuesInActivityCities.status', {
          defaultValue: 'Status',
        }) as string,
        headerClassName: 'data-grid-column-header',
    ...
    const activeIssuesInActivityCitiesRangeFilterOptions: FilterOption[] = [
      {
        id: '',
        attributeName: 'countyRepresentation',
        label: t('service.UserIssuesView.activeIssuesInActivityCities.countyRepresentation', {
          defaultValue: 'CountyRepresentation',
        }) as string,
      ...
      {
        id: '',
        attributeName: 'cityRepresentation',
        label: t('service.UserIssuesView.activeIssuesInActivityCities.cityRepresentation', {
          defaultValue: 'CityRepresentation',
        }) as string,
        filterType: FilterType.string,
      },
      ...
      {
        id: '',
        attributeName: 'title',
        label: t('service.UserIssuesView.activeIssuesInActivityCities.title', { defaultValue: 'Title' }) as string,
        filterType: FilterType.string,
      },

      {
        id: '',
        attributeName: 'created',
        label: t('service.UserIssuesView.activeIssuesInActivityCities.created', { defaultValue: 'Created' }) as string,
        filterType: FilterType.dateTime,
      },

      {
        id: '',
        attributeName: 'numberOfDebates',
        label: t('service.UserIssuesView.activeIssuesInActivityCities.numberOfDebates', {
          defaultValue: 'NumberOfDebates',
        }) as string,
      ...
      {
        id: '',
        attributeName: 'status',
        label: t('service.UserIssuesView.activeIssuesInActivityCities.status', { defaultValue: 'Status' }) as string,
          ...
          components={{
            Toolbar: () => (
              <GridToolbarContainer>
                <Button
                  id="FilterRelationActionedemokraciaServiceUserEdemokraciaServiceUserUserIssuesViewEdemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInActivityCitiesTableAction"
                  startIcon={<MdiIcon path="filter" />}
                  variant="text"
                  onClick={() => {
                    tableActionActiveIssuesInActivityCitiesAction(
                      'FilterRelationActionedemokraciaServiceUserEdemokraciaServiceUserUserIssuesViewEdemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInActivityCitiesTableAction-filter',
                      filterOptions,
                      filters,
                    );
                  }}
