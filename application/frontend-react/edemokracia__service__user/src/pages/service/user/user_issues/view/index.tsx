...
export default function ServiceUserUserIssuesView() {
  ...
  const queryCustomizer: ServiceUserIssuesQueryCustomizer = {
    _mask:
      '{userName,ownedIssues{scope,countyRepresentation,cityRepresentation,districtRepresentation,title,created,status,isFavorite,isNotFavorite,isVoteClosable,isIssueDraft,isIssueDeletable},activeIssuesGlobal{title,created,status,isFavorite,isNotFavorite,isVoteClosable,isIssueDraft,isIssueDeletable},activeIssuesInActivityCounties{countyRepresentation,title,created,status,isFavorite,isNotFavorite,isVoteClosable,isIssueDraft,isIssueDeletable},activeIssuesInActivityCities{countyRepresentation,cityRepresentation,title,created,status,isFavorite,isNotFavorite,isVoteClosable,isIssueDraft,isIssueDeletable},activeIssuesInActivityDistricts{countyRepresentation,cityRepresentation,districtRepresentation,title,created,status,isFavorite,isNotFavorite,isVoteClosable,isIssueDraft,isIssueDeletable},activeIssuesInResidentCounty{title,created,status,isFavorite,isNotFavorite,isVoteClosable,isIssueDraft,isIssueDeletable},activeIssuesInResidentCity{countyRepresentation,cityRepresentation,title,created,status,isFavorite,isNotFavorite,isVoteClosable,isIssueDraft,isIssueDeletable},activeIssuesInResidentDistrict{countyRepresentation,cityRepresentation,districtRepresentation,title,created,status,isFavorite,isNotFavorite,isVoteClosable,isIssueDraft,isIssueDeletable}}',
  };
