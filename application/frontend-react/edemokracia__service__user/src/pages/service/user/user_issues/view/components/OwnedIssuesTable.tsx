...
export const SERVICE_USER_USER_ISSUES_VIEW_OWNED_ISSUES = 'ServiceUserUserIssuesViewOwnedIssues';
...
export const OwnedIssuesTable = forwardRef<RefreshableTable, OwnedIssuesTableProps>((props, ref) => {
  ...
  const filterModelKey = `TableedemokraciaServiceUserEdemokraciaServiceUserUserIssuesViewDefaultUserIssuesViewEditRootTabBarOwnedIssuesGroupOwnedIssuesGroupOwnedIssuesLabelWrapperOwnedIssues-${ownerData.__signedIdentifier}-filterModel`;
  const filtersKey = `TableedemokraciaServiceUserEdemokraciaServiceUserUserIssuesViewDefaultUserIssuesViewEditRootTabBarOwnedIssuesGroupOwnedIssuesGroupOwnedIssuesLabelWrapperOwnedIssues-${ownerData.__signedIdentifier}-filters`;
  ...
  const ownedIssuesColumns: GridColDef<ServiceIssueStored>[] = [
    {
      ...baseColumnConfig,
      field: 'scope',
      headerName: t('service.UserIssuesView.ownedIssues.scope', { defaultValue: 'Scope' }) as string,
    ...
    },
    {
      ...
      headerName: t('service.UserIssuesView.ownedIssues.countyRepresentation', {
    ...
    },
    {
      ...
      headerName: t('service.UserIssuesView.ownedIssues.cityRepresentation', {
    ...
    },
    {
      ...
      headerName: t('service.UserIssuesView.ownedIssues.districtRepresentation', {
    ...
    },
    {
      ...baseColumnConfig,
      field: 'title',
      headerName: t('service.UserIssuesView.ownedIssues.title', { defaultValue: 'Title' }) as string,
      headerClassName: 'data-grid-column-header',
    ...
    },
    {
      ...baseColumnConfig,
      field: 'created',
      headerName: t('service.UserIssuesView.ownedIssues.created', { defaultValue: 'Created' }) as string,
      headerClassName: 'data-grid-column-header',
    ...
    },
    {
      ...
      headerName: t('service.UserIssuesView.ownedIssues.numberOfDebates', {
    ...
    },
    {
      ...baseColumnConfig,
      field: 'status',
      headerName: t('service.UserIssuesView.ownedIssues.status', { defaultValue: 'Status' }) as string,
      headerClassName: 'data-grid-column-header',
  ...
  const ownedIssuesRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserUserIssuesViewDefaultUserIssuesViewEditRootTabBarOwnedIssuesGroupOwnedIssuesGroupOwnedIssuesLabelWrapperOwnedIssuesScopeFilter',
      attributeName: 'scope',
      label: t('service.UserIssuesView.ownedIssues.scope', { defaultValue: 'Scope' }) as string,
      filterType: FilterType.enumeration,
      enumValues: ['GLOBAL', 'COUNTY', 'CITY', 'DISTRICT'],
    },

    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserUserIssuesViewDefaultUserIssuesViewEditRootTabBarOwnedIssuesGroupOwnedIssuesGroupOwnedIssuesLabelWrapperOwnedIssuesCountyRepresentationFilter',
      attributeName: 'countyRepresentation',
      label: t('service.UserIssuesView.ownedIssues.countyRepresentation', {
        defaultValue: 'CountyRepresentation',
      }) as string,
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserUserIssuesViewDefaultUserIssuesViewEditRootTabBarOwnedIssuesGroupOwnedIssuesGroupOwnedIssuesLabelWrapperOwnedIssuesCityRepresentationFilter',
      attributeName: 'cityRepresentation',
      label: t('service.UserIssuesView.ownedIssues.cityRepresentation', {
        defaultValue: 'CityRepresentation',
      }) as string,
      filterType: FilterType.string,
    },
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserUserIssuesViewDefaultUserIssuesViewEditRootTabBarOwnedIssuesGroupOwnedIssuesGroupOwnedIssuesLabelWrapperOwnedIssuesDistrictRepresentationFilter',
      attributeName: 'districtRepresentation',
      label: t('service.UserIssuesView.ownedIssues.districtRepresentation', {
        defaultValue: 'DistrictRepresentation',
      }) as string,
      filterType: FilterType.string,
    },
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserUserIssuesViewDefaultUserIssuesViewEditRootTabBarOwnedIssuesGroupOwnedIssuesGroupOwnedIssuesLabelWrapperOwnedIssuesTitleFilter',
      attributeName: 'title',
      label: t('service.UserIssuesView.ownedIssues.title', { defaultValue: 'Title' }) as string,
      filterType: FilterType.string,
    },

    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserUserIssuesViewDefaultUserIssuesViewEditRootTabBarOwnedIssuesGroupOwnedIssuesGroupOwnedIssuesLabelWrapperOwnedIssuesCreatedFilter',
      attributeName: 'created',
      label: t('service.UserIssuesView.ownedIssues.created', { defaultValue: 'Created' }) as string,
      filterType: FilterType.dateTime,
    },

    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserUserIssuesViewDefaultUserIssuesViewEditRootTabBarOwnedIssuesGroupOwnedIssuesGroupOwnedIssuesLabelWrapperOwnedIssuesNumberOfDebatesFilter',
      attributeName: 'numberOfDebates',
      label: t('service.UserIssuesView.ownedIssues.numberOfDebates', { defaultValue: 'NumberOfDebates' }) as string,
      filterType: FilterType.numeric,
    },

    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserUserIssuesViewDefaultUserIssuesViewEditRootTabBarOwnedIssuesGroupOwnedIssuesGroupOwnedIssuesLabelWrapperOwnedIssuesStatusFilter',
      attributeName: 'status',
      label: t('service.UserIssuesView.ownedIssues.status', { defaultValue: 'Status' }) as string,
      filterType: FilterType.enumeration,
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              <Button
                id="FilterRelationActionedemokraciaServiceUserEdemokraciaServiceUserUserIssuesViewEdemokraciaServiceUserEdemokraciaServiceUserIssuesOwnedIssuesTableAction"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() => {
                  tableActionOwnedIssuesAction(
                    'FilterRelationActionedemokraciaServiceUserEdemokraciaServiceUserUserIssuesViewEdemokraciaServiceUserEdemokraciaServiceUserIssuesOwnedIssuesTableAction-filter',
                    filterOptions,
                    filters,
                  );
                }}
