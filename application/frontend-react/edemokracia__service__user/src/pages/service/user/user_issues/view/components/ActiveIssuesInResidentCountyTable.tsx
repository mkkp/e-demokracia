...
export const SERVICE_USER_USER_ISSUES_VIEW_ACTIVE_ISSUES_IN_RESIDENT_COUNTY =
  'ServiceUserUserIssuesViewActiveIssuesInResidentCounty';
...
export const ActiveIssuesInResidentCountyTable = forwardRef<RefreshableTable, ActiveIssuesInResidentCountyTableProps>(
  (props, ref) => {
    ...
    const filterModelKey = `-${ownerData.__signedIdentifier}-filterModel`;
    const filtersKey = `-${ownerData.__signedIdentifier}-filters`;
    ...
    const activeIssuesInResidentCountyColumns: GridColDef<ServiceIssueStored>[] = [
      {
        ...baseColumnConfig,
        field: 'title',
        headerName: t('service.UserIssuesView.activeIssuesInResidentCounty.title', { defaultValue: 'Title' }) as string,
      ...
      },
      {
        ...baseColumnConfig,
        field: 'created',
        headerName: t('service.UserIssuesView.activeIssuesInResidentCounty.created', {
      ...
      },
      {
        ...
        headerName: t('service.UserIssuesView.activeIssuesInResidentCounty.numberOfDebates', {
      ...
      },
      {
        ...baseColumnConfig,
        field: 'status',
        headerName: t('service.UserIssuesView.activeIssuesInResidentCounty.status', {
          defaultValue: 'Status',
        }) as string,
        headerClassName: 'data-grid-column-header',
    ...
    const activeIssuesInResidentCountyRangeFilterOptions: FilterOption[] = [
      {
        id: '',
        attributeName: 'title',
        label: t('service.UserIssuesView.activeIssuesInResidentCounty.title', { defaultValue: 'Title' }) as string,
        filterType: FilterType.string,
      },

      {
        id: '',
        attributeName: 'created',
        label: t('service.UserIssuesView.activeIssuesInResidentCounty.created', { defaultValue: 'Created' }) as string,
        filterType: FilterType.dateTime,
      },

      {
        id: '',
        attributeName: 'numberOfDebates',
        label: t('service.UserIssuesView.activeIssuesInResidentCounty.numberOfDebates', {
          defaultValue: 'NumberOfDebates',
        }) as string,
      ...
      {
        id: '',
        attributeName: 'status',
        label: t('service.UserIssuesView.activeIssuesInResidentCounty.status', { defaultValue: 'Status' }) as string,
    ...
    async function fetchData() {
      if (ownerData && ownerData.__signedIdentifier) {
        ...
        try {
          const res = await serviceUserIssuesServiceForClassImpl.getActiveIssuesInResidentCounty(
            ownerData,
        ...
        <StripedDataGrid
          ...
          columns={[
            ...
            ...columnsActionCalculator(
              'RelationTypeedemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInResidentCounty',
              rowActions,
              t,
              { shownActions: 2 },
            ),
          ...
          components={{
            Toolbar: () => (
              <GridToolbarContainer>
                <Button
                  id="FilterRelationActionedemokraciaServiceUserEdemokraciaServiceUserUserIssuesViewEdemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInResidentCountyTableAction"
                  startIcon={<MdiIcon path="filter" />}
                  variant="text"
                  onClick={() => {
                    tableActionActiveIssuesInResidentCountyAction(
                      'FilterRelationActionedemokraciaServiceUserEdemokraciaServiceUserUserIssuesViewEdemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInResidentCountyTableAction-filter',
                      filterOptions,
                      filters,
                    );
                  }}
