...
export const SERVICE_USER_USER_ISSUES_VIEW_ACTIVE_ISSUES_IN_RESIDENT_CITY =
  'ServiceUserUserIssuesViewActiveIssuesInResidentCity';

export interface ActiveIssuesInResidentCityTableProps {
...
export const ActiveIssuesInResidentCityTable = forwardRef<RefreshableTable, ActiveIssuesInResidentCityTableProps>(
  (props, ref) => {
    ...
    const filterModelKey = `-${ownerData.__signedIdentifier}-filterModel`;
    const filtersKey = `-${ownerData.__signedIdentifier}-filters`;
    ...
    const activeIssuesInResidentCityColumns: GridColDef<ServiceIssueStored>[] = [
      {
        ...
        headerName: t('service.UserIssuesView.activeIssuesInResidentCity.countyRepresentation', {
      ...
      },
      {
        ...
        headerName: t('service.UserIssuesView.activeIssuesInResidentCity.cityRepresentation', {
      ...
      },
      {
        ...baseColumnConfig,
        field: 'title',
        headerName: t('service.UserIssuesView.activeIssuesInResidentCity.title', { defaultValue: 'Title' }) as string,
        headerClassName: 'data-grid-column-header',
      ...
      },
      {
        ...baseColumnConfig,
        field: 'created',
        headerName: t('service.UserIssuesView.activeIssuesInResidentCity.created', {
      ...
      },
      {
        ...
        headerName: t('service.UserIssuesView.activeIssuesInResidentCity.numberOfDebates', {
      ...
      },
      {
        ...baseColumnConfig,
        field: 'status',
        headerName: t('service.UserIssuesView.activeIssuesInResidentCity.status', { defaultValue: 'Status' }) as string,
        headerClassName: 'data-grid-column-header',
    ...
    const activeIssuesInResidentCityRangeFilterOptions: FilterOption[] = [
      {
        id: '',
        attributeName: 'countyRepresentation',
        label: t('service.UserIssuesView.activeIssuesInResidentCity.countyRepresentation', {
          defaultValue: 'CountyRepresentation',
        }) as string,
      ...
      {
        id: '',
        attributeName: 'cityRepresentation',
        label: t('service.UserIssuesView.activeIssuesInResidentCity.cityRepresentation', {
          defaultValue: 'CityRepresentation',
        }) as string,
        filterType: FilterType.string,
      },
      ...
      {
        id: '',
        attributeName: 'title',
        label: t('service.UserIssuesView.activeIssuesInResidentCity.title', { defaultValue: 'Title' }) as string,
        filterType: FilterType.string,
      },

      {
        id: '',
        attributeName: 'created',
        label: t('service.UserIssuesView.activeIssuesInResidentCity.created', { defaultValue: 'Created' }) as string,
        filterType: FilterType.dateTime,
      },

      {
        id: '',
        attributeName: 'numberOfDebates',
        label: t('service.UserIssuesView.activeIssuesInResidentCity.numberOfDebates', {
          defaultValue: 'NumberOfDebates',
        }) as string,
      ...
      {
        id: '',
        attributeName: 'status',
        label: t('service.UserIssuesView.activeIssuesInResidentCity.status', { defaultValue: 'Status' }) as string,
    ...
    const tableRefreshRelationActiveIssuesInResidentCityAction =
      useTableRefreshRelationActiveIssuesInResidentCityAction();
      ...
      <>
        <StripedDataGrid
          ...
          sx={{
            ...
            display: 'grid',
            border: (theme) =>
              props.validation.has('activeIssuesInResidentCity') ? `2px solid ${theme.palette.error.main}` : undefined,
          }}
          slotProps={{
            filterPanel: {
          ...
          onRowClick={(params: GridRowParams<ServiceIssueStored>) =>
            rowViewActiveIssuesInResidentCityAction(ownerData, params.row, () => fetchOwnerData())
          }
          sortModel={sortModel}
          ...
          components={{
            Toolbar: () => (
              <GridToolbarContainer>
                <Button
                  id="FilterRelationActionedemokraciaServiceUserEdemokraciaServiceUserUserIssuesViewEdemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInResidentCityTableAction"
                  startIcon={<MdiIcon path="filter" />}
                  variant="text"
                  onClick={() => {
                    tableActionActiveIssuesInResidentCityAction(
                      'FilterRelationActionedemokraciaServiceUserEdemokraciaServiceUserUserIssuesViewEdemokraciaServiceUserEdemokraciaServiceUserIssuesActiveIssuesInResidentCityTableAction-filter',
                      filterOptions,
                      filters,
                    );
                  }}
        ...
        />
        {props.validation.has('activeIssuesInResidentCity') && (
          <Box
            sx={{
          ...
          >
            ...
            <Typography>{props.validation.get('activeIssuesInResidentCity')}</Typography>
          </Box>
        )}
      </>
    );
