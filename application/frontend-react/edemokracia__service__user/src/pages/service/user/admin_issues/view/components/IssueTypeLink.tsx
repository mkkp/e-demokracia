...
export function IssueTypeLink(props: IssueTypeLinkProps) {
  ...
  const issueTypeRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserAdminIssuesViewDefaultIssueViewEditIssueLabelWrapperIssueIssueTypeTitleFilter',
      attributeName: 'title',
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserAdminIssuesViewDefaultIssueViewEditIssueLabelWrapperIssueIssueTypeDescriptionFilter',
  ...
  return (
    <AggregationInput
      name="issueType"
      id="LinkedemokraciaServiceUserEdemokraciaServiceUserAdminIssuesViewDefaultIssueViewEditIssueLabelWrapperIssueIssueType"
