...
export type PageFilterAdminIssuesAction = (
  id: string,
  filterOptions: FilterOption[],
  filters: Filter[],
) => Promise<void>;

export const usePageFilterAdminIssuesAction = (
  ...
  return async function pageFilterAdminIssuesAction(id: string, filterOptions: FilterOption[], filters: Filter[]) {
