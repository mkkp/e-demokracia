...
export const SERVICE_USER_USER_DEBATES_VIEW_OWNED_DEBATES = 'ServiceUserUserDebatesViewOwnedDebates';
...
export const OwnedDebatesTable = forwardRef<RefreshableTable, OwnedDebatesTableProps>((props, ref) => {
  ...
  const filterModelKey = `TableedemokraciaServiceUserEdemokraciaServiceUserUserDebatesViewDefaultUserDebatesViewEditRootTabBarOwnedDebatesGroupOwnedDebatesGroupOwnedDebatesLabelWrapperOwnedDebates-${ownerData.__signedIdentifier}-filterModel`;
  const filtersKey = `TableedemokraciaServiceUserEdemokraciaServiceUserUserDebatesViewDefaultUserDebatesViewEditRootTabBarOwnedDebatesGroupOwnedDebatesGroupOwnedDebatesLabelWrapperOwnedDebates-${ownerData.__signedIdentifier}-filters`;
  ...
  const ownedDebatesColumns: GridColDef<ServiceDebateStored>[] = [
    {
      ...baseColumnConfig,
      field: 'scope',
      headerName: t('service.UserDebatesView.ownedDebates.scope', { defaultValue: 'Scope' }) as string,
    ...
    },
    {
      ...
      headerName: t('service.UserDebatesView.ownedDebates.countyRepresentation', {
    ...
    },
    {
      ...
      headerName: t('service.UserDebatesView.ownedDebates.cityRepresentation', {
    ...
    },
    {
      ...
      headerName: t('service.UserDebatesView.ownedDebates.districtRepresentation', {
    ...
    },
    {
      ...baseColumnConfig,
      field: 'title',
      headerName: t('service.UserDebatesView.ownedDebates.title', { defaultValue: 'Title' }) as string,
      headerClassName: 'data-grid-column-header',
    ...
    },
    {
      ...baseColumnConfig,
      field: 'issueTitle',
      headerName: t('service.UserDebatesView.ownedDebates.issueTitle', { defaultValue: 'IssueTitle' }) as string,
      headerClassName: 'data-grid-column-header',
    ...
    },
    {
      ...baseColumnConfig,
      field: 'closeAt',
      headerName: t('service.UserDebatesView.ownedDebates.closeAt', { defaultValue: 'CloseAt' }) as string,
      headerClassName: 'data-grid-column-header',
    ...
    },
    {
      ...baseColumnConfig,
      field: 'status',
      headerName: t('service.UserDebatesView.ownedDebates.status', { defaultValue: 'Status' }) as string,
      headerClassName: 'data-grid-column-header',
  ...
  const ownedDebatesRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserUserDebatesViewDefaultUserDebatesViewEditRootTabBarOwnedDebatesGroupOwnedDebatesGroupOwnedDebatesLabelWrapperOwnedDebatesScopeFilter',
      attributeName: 'scope',
      label: t('service.UserDebatesView.ownedDebates.scope', { defaultValue: 'Scope' }) as string,
      filterType: FilterType.enumeration,
      enumValues: ['GLOBAL', 'COUNTY', 'CITY', 'DISTRICT'],
    },

    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserUserDebatesViewDefaultUserDebatesViewEditRootTabBarOwnedDebatesGroupOwnedDebatesGroupOwnedDebatesLabelWrapperOwnedDebatesCountyRepresentationFilter',
      attributeName: 'countyRepresentation',
      label: t('service.UserDebatesView.ownedDebates.countyRepresentation', {
        defaultValue: 'CountyRepresentation',
      }) as string,
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserUserDebatesViewDefaultUserDebatesViewEditRootTabBarOwnedDebatesGroupOwnedDebatesGroupOwnedDebatesLabelWrapperOwnedDebatesCityRepresentationFilter',
      attributeName: 'cityRepresentation',
      label: t('service.UserDebatesView.ownedDebates.cityRepresentation', {
        defaultValue: 'CityRepresentation',
      }) as string,
      filterType: FilterType.string,
    },
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserUserDebatesViewDefaultUserDebatesViewEditRootTabBarOwnedDebatesGroupOwnedDebatesGroupOwnedDebatesLabelWrapperOwnedDebatesDistrictRepresentationFilter',
      attributeName: 'districtRepresentation',
      label: t('service.UserDebatesView.ownedDebates.districtRepresentation', {
        defaultValue: 'DistrictRepresentation',
      }) as string,
      filterType: FilterType.string,
    },
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserUserDebatesViewDefaultUserDebatesViewEditRootTabBarOwnedDebatesGroupOwnedDebatesGroupOwnedDebatesLabelWrapperOwnedDebatesTitleFilter',
      attributeName: 'title',
      label: t('service.UserDebatesView.ownedDebates.title', { defaultValue: 'Title' }) as string,
      filterType: FilterType.string,
    },

    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserUserDebatesViewDefaultUserDebatesViewEditRootTabBarOwnedDebatesGroupOwnedDebatesGroupOwnedDebatesLabelWrapperOwnedDebatesIssueTitleFilter',
      attributeName: 'issueTitle',
      label: t('service.UserDebatesView.ownedDebates.issueTitle', { defaultValue: 'IssueTitle' }) as string,
      filterType: FilterType.string,
    },

    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserUserDebatesViewDefaultUserDebatesViewEditRootTabBarOwnedDebatesGroupOwnedDebatesGroupOwnedDebatesLabelWrapperOwnedDebatesCloseAtFilter',
      attributeName: 'closeAt',
      label: t('service.UserDebatesView.ownedDebates.closeAt', { defaultValue: 'CloseAt' }) as string,
      filterType: FilterType.dateTime,
    },

    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserUserDebatesViewDefaultUserDebatesViewEditRootTabBarOwnedDebatesGroupOwnedDebatesGroupOwnedDebatesLabelWrapperOwnedDebatesStatusFilter',
      attributeName: 'status',
      label: t('service.UserDebatesView.ownedDebates.status', { defaultValue: 'Status' }) as string,
      filterType: FilterType.enumeration,
  ...
  async function fetchData() {
    if (ownerData && ownerData.__signedIdentifier) {
      ...
      try {
        const res = await serviceUserDebatesServiceForClassImpl.getOwnedDebates(
          ownerData,
      ...
      <StripedDataGrid
        ...
        columns={[
          ...
          ...columnsActionCalculator(
            'RelationTypeedemokraciaServiceUserEdemokraciaServiceUserDebatesOwnedDebates',
            rowActions,
            t,
            { shownActions: 2 },
          ),
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              <Button
                id="FilterRelationActionedemokraciaServiceUserEdemokraciaServiceUserUserDebatesViewEdemokraciaServiceUserEdemokraciaServiceUserDebatesOwnedDebatesTableAction"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() => {
                  tableActionOwnedDebatesAction(
                    'FilterRelationActionedemokraciaServiceUserEdemokraciaServiceUserUserDebatesViewEdemokraciaServiceUserEdemokraciaServiceUserDebatesOwnedDebatesTableAction-filter',
                    filterOptions,
                    filters,
                  );
                }}
