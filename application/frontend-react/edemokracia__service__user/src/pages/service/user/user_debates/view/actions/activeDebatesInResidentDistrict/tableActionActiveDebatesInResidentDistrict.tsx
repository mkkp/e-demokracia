...
export type TableActionActiveDebatesInResidentDistrictAction = (
  id: string,
  filterOptions: FilterOption[],
  filters: Filter[],
) => Promise<void>;

export const useTableActionActiveDebatesInResidentDistrictAction = (
  ...
  return async function tableActionActiveDebatesInResidentDistrictAction(
    id: string,
    filterOptions: FilterOption[],
    filters: Filter[],
  ) {
