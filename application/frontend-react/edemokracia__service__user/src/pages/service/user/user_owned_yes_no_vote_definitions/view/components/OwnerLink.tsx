...
export type OwnerLinkFilterInitializer = (ownerData: ServiceYesNoVoteDefinitionStored) => Filter[] | undefined;
...
export interface OwnerLinkProps {
  ...
  validation: Map<keyof ServiceYesNoVoteDefinitionStored, string>;
...
export function OwnerLink(props: OwnerLinkProps) {
  ...
  const ownerColumns: GridColDef<ServiceServiceUserStored>[] = [
    {
      ...
      headerName: t('service.YesNoVoteDefinitionView.owner.representation', {
  ...
  const ownerRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserUserOwnedYesNoVoteDefinitionsViewDefaultYesNoVoteDefinitionViewEditVoteEntryBaseVirtualOwnerRepresentationFilter',
      attributeName: 'representation',
      label: t('service.YesNoVoteDefinitionView.owner.representation', { defaultValue: 'Representation' }) as string,
  ...
  return (
    <AggregationInput
      name="owner"
      id="LinkedemokraciaServiceUserEdemokraciaServiceUserUserOwnedYesNoVoteDefinitionsViewDefaultYesNoVoteDefinitionViewEditVoteEntryBaseVirtualOwner"
      label={t('service.YesNoVoteDefinitionView.owner', { defaultValue: 'Owner' }) as string}
      ...
      onSet={async () => {
        const res = await openRangeDialog<ServiceServiceUserStored, ServiceServiceUserQueryCustomizer>({
          id: 'RelationTypeedemokraciaServiceUserEdemokraciaServiceYesNoVoteDefinitionOwner',
          columns: ownerColumns,
          defaultSortField: ([{ field: 'representation', sort: null }] as GridSortItem[])[0],
          rangeCall: async (queryCustomizer) =>
            await serviceYesNoVoteDefinitionServiceForClassImpl.getRangeForOwner(
              ownerData,
      ...
      onAutoCompleteSearch={async (searchText: string) => {
        ...
        return await serviceYesNoVoteDefinitionServiceForClassImpl.getRangeForOwner(
          ownerData,
          processQueryCustomizer(queryCustomizer),
        );
      }}
