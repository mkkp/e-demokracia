...
import {
  yesNoVoteInputServiceForClassImpl,
  serviceYesNoVoteDefinitionServiceForClassImpl,
} from '~/generated/data-axios';

export interface ServiceYesNoVoteDefinitionVoteFormProps {
  successCallback: () => void;
  cancel: () => void;
  owner: ServiceYesNoVoteDefinitionStored;
}

export default function ServiceYesNoVoteDefinitionVoteForm({
  successCallback,
  cancel,
  owner,
}: ServiceYesNoVoteDefinitionVoteFormProps) {
  ...
  const handleActionError = useErrorHandler<YesNoVoteInput>(
    `(&(${OBJECTCLASS}=${ERROR_PROCESSOR_HOOK_INTERFACE_KEY})(operation=CallOperation)(component=ServiceYesNoVoteDefinitionVoteForm))`,
  );
  ...
  const submit = async () => {
    ...
    try {
      await serviceYesNoVoteDefinitionServiceForClassImpl.vote(owner, payloadDiff);
  ...
  return (
    <>
      <DialogTitle>
        {title}
        <IconButton
          id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceUserUserOwnedYesNoVoteDefinitionsTableEdemokraciaServiceUserEdemokraciaServiceYesNoVoteDefinitionVoteButtonCallOperation-dialog-close"
          aria-label="close"
          onClick={() => cancel()}
          sx={{
            position: 'absolute',
        ...
        <Grid container spacing={2} direction="column" alignItems="stretch" justifyContent="flex-start">
          <Grid item xs={12} sm={12}>
            <TextField
              required={false}
              name="value"
              id="EnumerationComboedemokraciaServiceUserEdemokraciaServiceYesNoVoteDefinitionVoteInputDefaultYesNoVoteInputFormValue"
              autoFocus
      ...
      <DialogActions>
        <Button
          id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceUserUserOwnedYesNoVoteDefinitionsTableEdemokraciaServiceUserEdemokraciaServiceYesNoVoteDefinitionVoteButtonCallOperation-action-form-action-cancel"
          variant="text"
          onClick={() => cancel()}
          disabled={isLoading}
        ...
        <LoadingButton
          ...
          id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceUserUserOwnedYesNoVoteDefinitionsTableEdemokraciaServiceUserEdemokraciaServiceYesNoVoteDefinitionVoteButtonCallOperation-action-form-action-submit"
          variant="contained"
          onClick={() => submit()}
