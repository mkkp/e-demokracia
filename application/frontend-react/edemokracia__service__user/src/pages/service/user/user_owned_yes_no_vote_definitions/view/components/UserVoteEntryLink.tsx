...
export type UserVoteEntryLinkFilterInitializer = (ownerData: ServiceYesNoVoteDefinitionStored) => Filter[] | undefined;
...
export interface UserVoteEntryLinkProps {
  ...
  onChange: (value: ServiceYesNoVoteEntry | ServiceYesNoVoteEntryStored | null) => void;
  disabled: boolean;
  readOnly: boolean;
  editMode: boolean;
}
...
export function UserVoteEntryLink(props: UserVoteEntryLinkProps) {
  ...
  return (
    <AggregationInput
      name="userVoteEntry"
      id="LinkedemokraciaServiceUserEdemokraciaServiceUserUserOwnedYesNoVoteDefinitionsViewDefaultYesNoVoteDefinitionViewEditUserVoteEntryGroupLabelWrapperUserVoteEntryGroupUserVoteVirtualForUserVoteUserVoteEntry"
      label={t('service.YesNoVoteDefinitionView.userVoteEntry', { defaultValue: 'Value' }) as string}
      ...
      onAutoCompleteSelect={(userVoteEntry) => {
        ...
        onChange(userVoteEntry as ServiceYesNoVoteEntryStored);
      }}
