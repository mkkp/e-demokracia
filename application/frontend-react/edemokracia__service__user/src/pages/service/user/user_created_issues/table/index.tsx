...
// Page name: edemokracia::service::User.userCreatedIssues#Table
...
/**
 * Name: edemokracia::service::User.userCreatedIssues#Table
 * Is Access: true
 * Is Dashboard: false
 * Type: Table
 **/
export default function ServiceUserUserCreatedIssuesTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaServiceUserEdemokraciaServiceUserUserCreatedIssuesTable-data-grid">
