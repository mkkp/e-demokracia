...
// Page name: edemokracia::service::User.userCreatedIssues#View
...
import { serviceUserServiceForUserCreatedIssuesImpl, serviceIssueServiceForClassImpl } from '~/generated/data-axios';
import {
...
export type ServiceUserUserCreatedIssuesViewPostRefreshAction = (
...
export const SERVICE_USER_USER_CREATED_ISSUES_VIEW_POST_REFRESH_HOOK_INTERFACE_KEY =
  'ServiceUserUserCreatedIssuesViewPostRefreshHook';
export type ServiceUserUserCreatedIssuesViewPostRefreshHook = () => ServiceUserUserCreatedIssuesViewPostRefreshAction;

/**
 * Name: edemokracia::service::User.userCreatedIssues#View
 * Is Access: true
 * Is Dashboard: false
 * Type: View
 * Edit Mode Available: true
 **/
export default function ServiceUserUserCreatedIssuesView() {
  ...
  const { service: postRefreshHook } = useTrackService<ServiceUserUserCreatedIssuesViewPostRefreshHook>(
    `(${OBJECTCLASS}=${SERVICE_USER_USER_CREATED_ISSUES_VIEW_POST_REFRESH_HOOK_INTERFACE_KEY})`,
  );
  const postRefreshAction: ServiceUserUserCreatedIssuesViewPostRefreshAction | undefined =
        ...
        <Box sx={mainContainerPadding}>
          ...
          >
            <Grid item xs={12} sm={12}>
              <Grid
                id="FlexedemokraciaServiceUserEdemokraciaServiceUserUserCreatedIssuesViewDefaultIssueViewEditActions"
                container
                direction="row"
                ...
                <Grid item xs={12}>
                  <Grid container spacing={2}>
                    {!data.isFavorite && (
                      <Grid item>
                        <LoadingButton
                          id="ButtonedemokraciaServiceUserEdemokraciaServiceUserUserCreatedIssuesViewDefaultIssueViewEditActionsPageActionButtonsAddToFavorites"
                          loading={isLoading}
                    ...
                    {!data.isNotFavorite && (
                      <Grid item>
                        <LoadingButton
                          id="ButtonedemokraciaServiceUserEdemokraciaServiceUserUserCreatedIssuesViewDefaultIssueViewEditActionsPageActionButtonsRemoveFromFavorites"
                          loading={isLoading}
            ...
            <Grid item xs={12} sm={12}>
              <Card id="FlexedemokraciaServiceUserEdemokraciaServiceUserUserCreatedIssuesViewDefaultIssueViewEditIssueLabelWrapper">
                <CardContent>
                  <Grid container direction="column" alignItems="stretch" justifyContent="flex-start" spacing={2}>
                    <Grid item xs={12} sm={12}>
                      <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                        ...
                        <Typography
                          id="LabeledemokraciaServiceUserEdemokraciaServiceUserUserCreatedIssuesViewDefaultIssueViewEditIssueLabelWrapperIssueLabel"
                          variant="h5"
                          component="h1"
                        >
                    ...
                    <Grid item xs={12} sm={12}>
                      <Grid
                        id="FlexedemokraciaServiceUserEdemokraciaServiceUserUserCreatedIssuesViewDefaultIssueViewEditIssueLabelWrapperIssue"
                        container
                        direction="row"
                        alignItems="stretch"
                        justifyContent="flex-start"
                      ...
                      >
                        ...
                        <Grid item xs={12} sm={12} md={4.0}>
                          <TextField
                            ...
                            id="EnumerationComboedemokraciaServiceUserEdemokraciaServiceUserUserCreatedIssuesViewDefaultIssueViewEditIssueLabelWrapperIssueDefaultVoteType"
                            label={
                        ...
                        <Grid item xs={12} sm={12} md={4.0}>
                          <TextField
                            required={true}
                            name="title"
                            id="TextInputedemokraciaServiceUserEdemokraciaServiceUserUserCreatedIssuesViewDefaultIssueViewEditIssueLabelWrapperIssueTitle"
                        ...
                        <Grid item xs={12} sm={12} md={4.0}>
                          <TextField
                            required={true}
                            name="status"
                            id="EnumerationComboedemokraciaServiceUserEdemokraciaServiceUserUserCreatedIssuesViewDefaultIssueViewEditIssueLabelWrapperIssueStatus"
                        ...
                        <Grid item xs={12} sm={12} md={4.0}>
                          <DateTimePicker
                            ...
                            slotProps={{
                              textField: {
                                id: 'DateTimeInputedemokraciaServiceUserEdemokraciaServiceUserUserCreatedIssuesViewDefaultIssueViewEditIssueLabelWrapperIssueCreated',
                                required: false,
                        ...
                        <Grid item xs={12} sm={12}>
                          <TextField
                            required={true}
                            name="description"
                            id="TextAreaedemokraciaServiceUserEdemokraciaServiceUserUserCreatedIssuesViewDefaultIssueViewEditIssueLabelWrapperIssueDescription"
            ...
            <Grid container item xs={12} sm={12}>
              <ModeledTabs
                id="TabControlleredemokraciaServiceUserEdemokraciaServiceUserUserCreatedIssuesViewDefaultIssueViewEditOther"
                ownerData={data}
                validation={validation}
                orientation='horizontal'
                childTabs={[
                  {
                    id: 'TabedemokraciaServiceUserEdemokraciaServiceUserUserCreatedIssuesViewDefaultIssueViewEditOtherArguments',
                  ...
                  {
                    id: 'TabedemokraciaServiceUserEdemokraciaServiceUserUserCreatedIssuesViewDefaultIssueViewEditOtherArea',
                  ...
                  {
                    id: 'TabedemokraciaServiceUserEdemokraciaServiceUserUserCreatedIssuesViewDefaultIssueViewEditOtherAttachments',
                  ...
                  {
                    id: 'TabedemokraciaServiceUserEdemokraciaServiceUserUserCreatedIssuesViewDefaultIssueViewEditOtherCategories',
                  ...
                  {
                    id: 'TabedemokraciaServiceUserEdemokraciaServiceUserUserCreatedIssuesViewDefaultIssueViewEditOtherComments',
              ...
              >
                <Grid item xs={12} sm={12}>
                  <Grid
                    id="FlexedemokraciaServiceUserEdemokraciaServiceUserUserCreatedIssuesViewDefaultIssueViewEditOtherArgumentsArguments"
                    container
                    direction="row"
                    alignItems="flex-start"
                    justifyContent="flex-start"
                  ...
                  >
                    <Grid item xs={12} sm={12} md={6.0}>
                      <Card id="FlexedemokraciaServiceUserEdemokraciaServiceUserUserCreatedIssuesViewDefaultIssueViewEditOtherArgumentsArgumentsConsLabelWrapper">
                        <CardContent>
                          <Grid
                            container
                            direction="column"
                          ...
                          >
                            <Grid item xs={12} sm={12}>
                              <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                                ...
                                <Typography
                                  id="LabeledemokraciaServiceUserEdemokraciaServiceUserUserCreatedIssuesViewDefaultIssueViewEditOtherArgumentsArgumentsConsLabelWrapperConsLabel"
                                  variant="h5"
                                  component="h1"
                                >
                            ...
                            <Grid item xs={12} sm={12}>
                              <Grid
                                id="FlexedemokraciaServiceUserEdemokraciaServiceUserUserCreatedIssuesViewDefaultIssueViewEditOtherArgumentsArgumentsConsLabelWrapperCons"
                                container
                                direction="row"
                                alignItems="stretch"
                                justifyContent="flex-start"
                              ...
                              >
                                <Grid item xs={12} sm={12}>
                                  <Grid
                                    id="FlexedemokraciaServiceUserEdemokraciaServiceUserUserCreatedIssuesViewDefaultIssueViewEditOtherArgumentsArgumentsConsLabelWrapperConsActions"
                                    container
                                    direction="row"
                                    alignItems="flex-start"
                                    justifyContent="flex-start"
                                  ...
                                  >
                                    <Grid item xs={12} sm={12}>
                                      <LoadingButton
                                        id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceUserUserCreatedIssuesViewEdemokraciaServiceUserEdemokraciaServiceIssueCreateConArgumentButtonCallOperation"
                                        loading={isLoading}
                                        variant={undefined}
                                ...
                                <Grid item xs={12} sm={12}>
                                  <Grid
                                    id="FlexedemokraciaServiceUserEdemokraciaServiceUserUserCreatedIssuesViewDefaultIssueViewEditOtherArgumentsArgumentsConsLabelWrapperConsTable"
                                    container
                                    direction="row"
                                    alignItems="flex-start"
                                    justifyContent="flex-start"
                                  ...
                                  >
                                    <Grid item xs={12} sm={12}>
                                      <Grid
                                        id="FlexedemokraciaServiceUserEdemokraciaServiceUserUserCreatedIssuesViewDefaultIssueViewEditOtherArgumentsArgumentsConsLabelWrapperConsTableConsLabelWrapper"
                                        container
                                        direction="column"
                                        alignItems="stretch"
                                        justifyContent="flex-start"
                                      ...
                                      >
                                        <Grid item xs={12} sm={12}>
                                          <Grid
                                            id="TableedemokraciaServiceUserEdemokraciaServiceUserUserCreatedIssuesViewDefaultIssueViewEditOtherArgumentsArgumentsConsLabelWrapperConsTableConsLabelWrapperCons"
                                            container
                                            direction="column"
                                            alignItems="stretch"
                                            justifyContent="flex-start"
                    ...
                    <Grid item xs={12} sm={12} md={6.0}>
                      <Card id="FlexedemokraciaServiceUserEdemokraciaServiceUserUserCreatedIssuesViewDefaultIssueViewEditOtherArgumentsArgumentsProsLabelWrapper">
                        <CardContent>
                          <Grid
                            container
                            direction="column"
                          ...
                          >
                            <Grid item xs={12} sm={12}>
                              <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                                ...
                                <Typography
                                  id="LabeledemokraciaServiceUserEdemokraciaServiceUserUserCreatedIssuesViewDefaultIssueViewEditOtherArgumentsArgumentsProsLabelWrapperProsLabel"
                                  variant="h5"
                                  component="h1"
                                >
                            ...
                            <Grid item xs={12} sm={12}>
                              <Grid
                                id="FlexedemokraciaServiceUserEdemokraciaServiceUserUserCreatedIssuesViewDefaultIssueViewEditOtherArgumentsArgumentsProsLabelWrapperPros"
                                container
                                direction="row"
                                alignItems="stretch"
                                justifyContent="flex-start"
                              ...
                              >
                                <Grid item xs={12} sm={12}>
                                  <Grid
                                    id="FlexedemokraciaServiceUserEdemokraciaServiceUserUserCreatedIssuesViewDefaultIssueViewEditOtherArgumentsArgumentsProsLabelWrapperProsActions"
                                    container
                                    direction="row"
                                    alignItems="flex-start"
                                    justifyContent="flex-start"
                                  ...
                                  >
                                    <Grid item xs={12} sm={12}>
                                      <LoadingButton
                                        id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceUserUserCreatedIssuesViewEdemokraciaServiceUserEdemokraciaServiceIssueCreateProArgumentButtonCallOperation"
                                        loading={isLoading}
                                        variant={undefined}
                                ...
                                <Grid item xs={12} sm={12}>
                                  <Grid
                                    id="FlexedemokraciaServiceUserEdemokraciaServiceUserUserCreatedIssuesViewDefaultIssueViewEditOtherArgumentsArgumentsProsLabelWrapperProsTable"
                                    container
                                    direction="row"
                                    alignItems="flex-start"
                                    justifyContent="flex-start"
                                  ...
                                  >
                                    <Grid item xs={12} sm={12}>
                                      <Grid
                                        id="FlexedemokraciaServiceUserEdemokraciaServiceUserUserCreatedIssuesViewDefaultIssueViewEditOtherArgumentsArgumentsProsLabelWrapperProsTableProsLabelWrapper"
                                        container
                                        direction="column"
                                        alignItems="stretch"
                                        justifyContent="flex-start"
                                      ...
                                      >
                                        <Grid item xs={12} sm={12}>
                                          <Grid
                                            id="TableedemokraciaServiceUserEdemokraciaServiceUserUserCreatedIssuesViewDefaultIssueViewEditOtherArgumentsArgumentsProsLabelWrapperProsTableProsLabelWrapperPros"
                                            container
                                            direction="column"
                                            alignItems="stretch"
                                            justifyContent="flex-start"
                ...
                <Grid item xs={12} sm={12}>
                  <Grid
                    id="FlexedemokraciaServiceUserEdemokraciaServiceUserUserCreatedIssuesViewDefaultIssueViewEditOtherAreaArea"
                    container
                    direction="row"
                    alignItems="flex-start"
                    justifyContent="flex-start"
                ...
                <Grid item xs={12} sm={12}>
                  <Grid
                    id="FlexedemokraciaServiceUserEdemokraciaServiceUserUserCreatedIssuesViewDefaultIssueViewEditOtherAttachmentsAttachments"
                    container
                    direction="row"
                    alignItems="flex-start"
                    justifyContent="flex-start"
                  ...
                  >
                    <Grid item xs={12} sm={12}>
                      <Grid
                        id="FlexedemokraciaServiceUserEdemokraciaServiceUserUserCreatedIssuesViewDefaultIssueViewEditOtherAttachmentsAttachmentsAttachmentsLabelWrapper"
                        container
                        direction="column"
                        alignItems="stretch"
                        justifyContent="flex-start"
                      ...
                      >
                        <Grid item xs={12} sm={12}>
                          <Grid
                            id="TableedemokraciaServiceUserEdemokraciaServiceUserUserCreatedIssuesViewDefaultIssueViewEditOtherAttachmentsAttachmentsAttachmentsLabelWrapperAttachments"
                            container
                            direction="column"
                            alignItems="stretch"
                            justifyContent="flex-start"
                ...
                <Grid item xs={12} sm={12}>
                  <Grid
                    id="FlexedemokraciaServiceUserEdemokraciaServiceUserUserCreatedIssuesViewDefaultIssueViewEditOtherCategoriesCategories"
                    container
                    direction="row"
                    alignItems="flex-start"
                    justifyContent="flex-start"
                  ...
                  >
                    <Grid item xs={12} sm={12}>
                      <Grid
                        id="FlexedemokraciaServiceUserEdemokraciaServiceUserUserCreatedIssuesViewDefaultIssueViewEditOtherCategoriesCategoriesCategoriesLabelWrapper"
                        container
                        direction="column"
                        alignItems="stretch"
                        justifyContent="flex-start"
                      ...
                      >
                        <Grid item xs={12} sm={12}>
                          <Grid
                            id="TableedemokraciaServiceUserEdemokraciaServiceUserUserCreatedIssuesViewDefaultIssueViewEditOtherCategoriesCategoriesCategoriesLabelWrapperCategories"
                            container
                            direction="column"
                            alignItems="stretch"
                            justifyContent="flex-start"
                ...
                <Grid item xs={12} sm={12}>
                  <Grid
                    id="FlexedemokraciaServiceUserEdemokraciaServiceUserUserCreatedIssuesViewDefaultIssueViewEditOtherCommentsComments"
                    container
                    direction="row"
                    alignItems="flex-start"
                    justifyContent="flex-start"
                  ...
                  >
                    <Grid item xs={12} sm={12}>
                      <Grid
                        id="FlexedemokraciaServiceUserEdemokraciaServiceUserUserCreatedIssuesViewDefaultIssueViewEditOtherCommentsCommentsActions"
                        container
                        direction="row"
                        alignItems="flex-start"
                        justifyContent="flex-start"
                      ...
                      >
                        <Grid item xs={12} sm={12} md={4.0}>
                          <LoadingButton
                            id="CallOperationActionedemokraciaServiceUserEdemokraciaServiceUserUserCreatedIssuesViewEdemokraciaServiceUserEdemokraciaServiceIssueCreateCommentButtonCallOperation"
                            loading={isLoading}
                            variant={undefined}
                        ...
                        <Grid item xs={12} sm={12}>
                          <Grid
                            id="FlexedemokraciaServiceUserEdemokraciaServiceUserUserCreatedIssuesViewDefaultIssueViewEditOtherCommentsCommentsActionsCommentsLabelWrapper"
                            container
                            direction="column"
                            alignItems="stretch"
                            justifyContent="flex-start"
                          ...
                          >
                            <Grid item xs={12} sm={12}>
                              <Grid
                                id="TableedemokraciaServiceUserEdemokraciaServiceUserUserCreatedIssuesViewDefaultIssueViewEditOtherCommentsCommentsActionsCommentsLabelWrapperComments"
                                container
                                direction="column"
                                alignItems="stretch"
                                justifyContent="flex-start"
