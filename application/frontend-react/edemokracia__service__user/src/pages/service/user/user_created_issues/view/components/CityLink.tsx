...
export function CityLink(props: CityLinkProps) {
  ...
  const cityRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserUserCreatedIssuesViewDefaultIssueViewEditOtherAreaAreaCityRepresentationFilter',
  ...
  return (
    <AggregationInput
      name="city"
      id="LinkedemokraciaServiceUserEdemokraciaServiceUserUserCreatedIssuesViewDefaultIssueViewEditOtherAreaAreaCity"
