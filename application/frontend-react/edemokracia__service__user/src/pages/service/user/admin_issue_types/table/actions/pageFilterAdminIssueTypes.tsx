...
import { ServiceIssueTypeQueryCustomizer } from '~/generated/data-api';
import { useFilterDialog } from '~/components/dialog';
import type { Filter, FilterOption } from '~/components-api';
import { mapAllFiltersToQueryCustomizerProperties } from '~/utilities';

export type PageFilterAdminIssueTypesAction = (
  id: string,
  filterOptions: FilterOption[],
  filters: Filter[],
) => Promise<void>;

export const usePageFilterAdminIssueTypesAction = (
  ...
  const columnNames = ['title', 'voteType', 'description'];

  return async function pageFilterAdminIssueTypesAction(id: string, filterOptions: FilterOption[], filters: Filter[]) {
