  ...
  return (
    <>
      <DialogTitle>
        {title}
        <IconButton
          id="CreateActionedemokraciaServiceUserEdemokraciaServiceUserUserOwnedActiveIssuesViewEdemokraciaServiceUserEdemokraciaServiceIssueAttachmentsTableCreate-dialog-close"
          aria-label="close"
          onClick={() => cancel()}
          sx={{
            position: 'absolute',
      ...
      <DialogActions>
        <Button
          id="CreateActionedemokraciaServiceUserEdemokraciaServiceUserUserOwnedActiveIssuesViewEdemokraciaServiceUserEdemokraciaServiceIssueAttachmentsTableCreate-action-form-action-cancel"
          variant="text"
          onClick={() => cancel()}
          disabled={isLoading}
        >
        ...
        <ButtonGroup size="small" ref={anchorRef} aria-label="split button" disabled={isLoading}>
          <LoadingButton
            ...
            id="CreateActionedemokraciaServiceUserEdemokraciaServiceUserUserOwnedActiveIssuesViewEdemokraciaServiceUserEdemokraciaServiceIssueAttachmentsTableCreate-action-form-action-create"
            variant="contained"
            onClick={async () => {
