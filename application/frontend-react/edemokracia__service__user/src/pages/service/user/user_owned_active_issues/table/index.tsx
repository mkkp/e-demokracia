...
// Page name: edemokracia::service::User.userOwnedActiveIssues#Table
...
/**
 * Name: edemokracia::service::User.userOwnedActiveIssues#Table
 * Is Access: true
 * Is Dashboard: false
 * Type: Table
 **/
export default function ServiceUserUserOwnedActiveIssuesTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaServiceUserEdemokraciaServiceUserUserOwnedActiveIssuesTable-data-grid">
