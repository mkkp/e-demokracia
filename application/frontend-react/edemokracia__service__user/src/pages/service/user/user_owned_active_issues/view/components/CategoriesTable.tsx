...
export const SERVICE_USER_USER_OWNED_ACTIVE_ISSUES_VIEW_CATEGORIES = 'ServiceUserUserOwnedActiveIssuesViewCategories';
...
export const CategoriesTable = (props: CategoriesTableProps) => {
  ...
  const filterModelKey = `TableedemokraciaServiceUserEdemokraciaServiceUserUserOwnedActiveIssuesViewDefaultIssueViewEditOtherCategoriesCategoriesCategoriesLabelWrapperCategories-${ownerData.__identifier}-filterModel`;
  const filtersKey = `TableedemokraciaServiceUserEdemokraciaServiceUserUserOwnedActiveIssuesViewDefaultIssueViewEditOtherCategoriesCategoriesCategoriesLabelWrapperCategories-${ownerData.__identifier}-filters`;
  ...
  const categoriesRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserUserOwnedActiveIssuesViewDefaultIssueViewEditOtherCategoriesCategoriesCategoriesLabelWrapperCategoriesTitleFilter',
      attributeName: 'title',
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserUserOwnedActiveIssuesViewDefaultIssueViewEditOtherCategoriesCategoriesCategoriesLabelWrapperCategoriesDescriptionFilter',
  ...
  const categoriesRowActions: TableRowAction<ServiceIssueCategoryStored>[] = [
    {
      id: 'RemoveActionedemokraciaServiceUserEdemokraciaServiceUserUserOwnedActiveIssuesViewEdemokraciaServiceUserEdemokraciaServiceIssueCategoriesRowRemove',
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              ...
              <Button
                id="TableedemokraciaServiceUserEdemokraciaServiceUserUserOwnedActiveIssuesViewDefaultIssueViewEditOtherCategoriesCategoriesCategoriesLabelWrapperCategories-filter"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() =>
                  filter(
                    'TableedemokraciaServiceUserEdemokraciaServiceUserUserOwnedActiveIssuesViewDefaultIssueViewEditOtherCategoriesCategoriesCategoriesLabelWrapperCategories-filter',
                    filterOptions,
                    filters,
                  )
                }
