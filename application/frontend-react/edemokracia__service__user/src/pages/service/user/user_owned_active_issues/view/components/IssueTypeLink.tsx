...
export function IssueTypeLink(props: IssueTypeLinkProps) {
  ...
  const issueTypeRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserUserOwnedActiveIssuesViewDefaultIssueViewEditIssueLabelWrapperIssueIssueTypeTitleFilter',
      attributeName: 'title',
    ...
    {
      id: 'FilteredemokraciaServiceUserEdemokraciaServiceUserUserOwnedActiveIssuesViewDefaultIssueViewEditIssueLabelWrapperIssueIssueTypeDescriptionFilter',
  ...
  return (
    <AggregationInput
      name="issueType"
      id="LinkedemokraciaServiceUserEdemokraciaServiceUserUserOwnedActiveIssuesViewDefaultIssueViewEditIssueLabelWrapperIssueIssueType"
