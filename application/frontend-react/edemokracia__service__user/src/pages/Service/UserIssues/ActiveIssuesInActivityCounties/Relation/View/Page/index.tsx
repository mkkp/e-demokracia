...
import { serviceUserIssuesServiceForActiveIssuesInActivityCountiesImpl } from '~/services/data-axios';
...
// Name: service::UserIssues::activeIssuesInActivityCounties::Relation::View::Page
export default function ServiceUserIssuesActiveIssuesInActivityCountiesRelationViewPage() {
  ...
  const serviceIssueIssue_View_EditIssueOwnerAutocomplete = async (
    ...
    try {
      return serviceUserIssuesServiceForActiveIssuesInActivityCountiesImpl.getRangeForOwner(data, queryCustomizer);
    } catch (error) {
      handleError(error);
  ...
  const serviceIssueIssue_View_EditIssueIssueTypeAutocomplete = async (
    ...
    try {
      return serviceUserIssuesServiceForActiveIssuesInActivityCountiesImpl.getRangeForIssueType(data, queryCustomizer);
    } catch (error) {
      handleError(error);
      return Promise.resolve([]);
    }
