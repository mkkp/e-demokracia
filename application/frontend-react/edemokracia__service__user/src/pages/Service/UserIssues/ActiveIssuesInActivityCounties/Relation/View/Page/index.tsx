...
export default function ServiceUserIssuesActiveIssuesInActivityCountiesRelationViewPage() {
  ...
  const countyAutocompleteRangeAction = async (
    ...
    // page service::UserIssues::activeIssuesInActivityCounties::Relation::View::Page
    try {
  ...
  return (
    <div
      ...
      data-page-name="service::UserIssues::activeIssuesInActivityCounties::Relation::View::Page"
    >
      <Suspense>
