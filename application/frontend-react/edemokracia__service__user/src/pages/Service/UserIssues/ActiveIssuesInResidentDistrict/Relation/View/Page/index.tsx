...
export default function ServiceUserIssuesActiveIssuesInResidentDistrictRelationViewPage() {
  ...
  const countyAutocompleteRangeAction = async (
    ...
    // page service::UserIssues::activeIssuesInResidentDistrict::Relation::View::Page
    try {
  ...
  return (
    <div
      ...
      data-page-name="service::UserIssues::activeIssuesInResidentDistrict::Relation::View::Page"
    >
      <Suspense>
