...
import { serviceUserIssuesServiceForActiveIssuesInActivityDistrictsImpl } from '~/services/data-axios';
...
// Name: service::UserIssues::activeIssuesInActivityDistricts::Relation::View::Page
export default function ServiceUserIssuesActiveIssuesInActivityDistrictsRelationViewPage() {
  ...
  const serviceIssueIssue_View_EditIssueOwnerAutocomplete = async (
    ...
    try {
      return serviceUserIssuesServiceForActiveIssuesInActivityDistrictsImpl.getRangeForOwner(data, queryCustomizer);
    } catch (error) {
      handleError(error);
  ...
  const serviceIssueIssue_View_EditIssueIssueTypeAutocomplete = async (
    ...
    try {
      return serviceUserIssuesServiceForActiveIssuesInActivityDistrictsImpl.getRangeForIssueType(data, queryCustomizer);
    } catch (error) {
      handleError(error);
      return Promise.resolve([]);
    }
