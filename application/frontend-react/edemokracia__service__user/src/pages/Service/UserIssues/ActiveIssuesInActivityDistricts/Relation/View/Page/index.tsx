...
export default function ServiceUserIssuesActiveIssuesInActivityDistrictsRelationViewPage() {
  ...
  const countyAutocompleteRangeAction = async (
    ...
    // page service::UserIssues::activeIssuesInActivityDistricts::Relation::View::Page
    try {
  ...
  return (
    <div
      ...
      data-page-name="service::UserIssues::activeIssuesInActivityDistricts::Relation::View::Page"
    >
      <Suspense>
