...
export default function ServiceUserIssuesActiveIssuesInActivityDistrictsRelationViewPage() {
  ...
  const issueTypeAutocompleteRangeAction = async (
    ...
    try {
      return serviceUserIssuesServiceForActiveIssuesInActivityDistrictsImpl.getRangeForIssueType(
        cleanUpPayload(data),
        queryCustomizer,
      );
    } catch (error) {
  ...
  const ownerAutocompleteRangeAction = async (
    ...
    try {
      return serviceUserIssuesServiceForActiveIssuesInActivityDistrictsImpl.getRangeForOwner(
        cleanUpPayload(data),
        queryCustomizer,
      );
    } catch (error) {
  ...
  const cityAutocompleteRangeAction = async (
    ...
    try {
      return serviceUserIssuesServiceForActiveIssuesInActivityDistrictsImpl.getRangeForCity(
        cleanUpPayload(data),
        queryCustomizer,
      );
    } catch (error) {
  ...
  const countyAutocompleteRangeAction = async (
    ...
    try {
      return serviceUserIssuesServiceForActiveIssuesInActivityDistrictsImpl.getRangeForCounty(
        cleanUpPayload(data),
        queryCustomizer,
      );
    } catch (error) {
  ...
  const districtAutocompleteRangeAction = async (
    ...
    try {
      return serviceUserIssuesServiceForActiveIssuesInActivityDistrictsImpl.getRangeForDistrict(
        cleanUpPayload(data),
        queryCustomizer,
      );
    } catch (error) {
  ...
  const refreshAction = async (queryCustomizer: ServiceIssueQueryCustomizer): Promise<ServiceIssueStored> => {
    try {
      setIsLoading(true);
      setEditMode(false);
      const result = await serviceUserIssuesServiceForActiveIssuesInActivityDistrictsImpl.refresh(
        { __signedIdentifier: signedIdentifier } as JudoIdentifiable<any>,
  ...
  const updateAction = async () => {
    setIsLoading(true);
    try {
      const res = await serviceUserIssuesServiceForActiveIssuesInActivityDistrictsImpl.update(payloadDiff.current);
      if (res) {
