...
// Name: service::UserIssues::activeIssuesInActivityDistricts::Relation::Table::Page
// Access: false
// Single Access: false
export default function ServiceUserIssuesActiveIssuesInActivityDistrictsRelationTablePage() {
  ...
  return (
    <div
      ...
      data-page-name="service::UserIssues::activeIssuesInActivityDistricts::Relation::Table::Page"
    >
      <Suspense>
