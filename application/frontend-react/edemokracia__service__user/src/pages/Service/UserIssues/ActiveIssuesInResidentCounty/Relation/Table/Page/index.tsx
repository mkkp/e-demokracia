...
// Name: service::UserIssues::activeIssuesInResidentCounty::Relation::Table::Page
// Access: false
// Single Access: false
export default function ServiceUserIssuesActiveIssuesInResidentCountyRelationTablePage() {
  ...
  return (
    <div
      ...
      data-page-name="service::UserIssues::activeIssuesInResidentCounty::Relation::Table::Page"
    >
      <Suspense>
