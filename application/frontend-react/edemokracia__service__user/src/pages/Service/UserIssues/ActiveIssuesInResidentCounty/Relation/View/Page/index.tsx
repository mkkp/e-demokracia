...
export default function ServiceUserIssuesActiveIssuesInResidentCountyRelationViewPage() {
  ...
  const countyAutocompleteRangeAction = async (
    ...
    // page service::UserIssues::activeIssuesInResidentCounty::Relation::View::Page
    try {
  ...
  return (
    <div
      ...
      data-page-name="service::UserIssues::activeIssuesInResidentCounty::Relation::View::Page"
    >
      <Suspense>
