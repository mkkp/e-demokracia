...
import { serviceUserIssuesServiceForActiveIssuesInResidentCountyImpl } from '~/services/data-axios';
...
// Name: service::UserIssues::activeIssuesInResidentCounty::Relation::View::Page
export default function ServiceUserIssuesActiveIssuesInResidentCountyRelationViewPage() {
  ...
  const serviceIssueIssue_View_EditIssueOwnerAutocomplete = async (
    ...
    try {
      return serviceUserIssuesServiceForActiveIssuesInResidentCountyImpl.getRangeForOwner(data, queryCustomizer);
    } catch (error) {
      handleError(error);
  ...
  const serviceIssueIssue_View_EditIssueIssueTypeAutocomplete = async (
    ...
    try {
      return serviceUserIssuesServiceForActiveIssuesInResidentCountyImpl.getRangeForIssueType(data, queryCustomizer);
    } catch (error) {
      handleError(error);
      return Promise.resolve([]);
    }
