...
import { serviceUserIssuesServiceForActiveIssuesInActivityCitiesImpl } from '~/services/data-axios';
...
// Name: service::UserIssues::activeIssuesInActivityCities::Relation::Table::Page
export default function ServiceUserIssuesActiveIssuesInActivityCitiesRelationTablePage() {
  ...
  return (
    <div
      ...
      data-page-name="service::UserIssues::activeIssuesInActivityCities::Relation::Table::Page"
    >
      <Suspense>
