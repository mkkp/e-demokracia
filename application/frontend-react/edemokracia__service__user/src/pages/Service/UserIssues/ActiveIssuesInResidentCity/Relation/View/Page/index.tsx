...
import { serviceUserIssuesServiceForActiveIssuesInResidentCityImpl } from '~/services/data-axios';
...
// Name: service::UserIssues::activeIssuesInResidentCity::Relation::View::Page
export default function ServiceUserIssuesActiveIssuesInResidentCityRelationViewPage() {
  ...
  const serviceIssueIssue_View_EditIssueOwnerAutocomplete = async (
    ...
    try {
      return serviceUserIssuesServiceForActiveIssuesInResidentCityImpl.getRangeForOwner(data, queryCustomizer);
    } catch (error) {
      handleError(error);
  ...
  const serviceIssueIssue_View_EditIssueIssueTypeAutocomplete = async (
    ...
    try {
      return serviceUserIssuesServiceForActiveIssuesInResidentCityImpl.getRangeForIssueType(data, queryCustomizer);
    } catch (error) {
      handleError(error);
      return Promise.resolve([]);
    }
