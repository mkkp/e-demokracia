...
// Name: service::UserIssues::activeIssuesInResidentCity::Relation::Table::Page
export default function ServiceUserIssuesActiveIssuesInResidentCityRelationTablePage() {
  ...
  return (
    <div
      ...
      data-page-name="service::UserIssues::activeIssuesInResidentCity::Relation::Table::Page"
    >
      <Suspense>
