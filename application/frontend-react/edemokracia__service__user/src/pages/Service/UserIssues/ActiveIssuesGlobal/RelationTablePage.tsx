...
export const SERVICE_USER_ISSUES_ACTIVE_ISSUES_GLOBAL_RELATION_TABLE_PAGE_ACTIONS_HOOK_INTERFACE_KEY =
  'SERVICE_USER_ISSUES_ACTIVE_ISSUES_GLOBAL_RELATION_TABLE_PAGE_ACTIONS_HOOK';
...
export default function ServiceUserIssuesActiveIssuesGlobalRelationTablePage() {
  ...
  const openPageAction = async (target: ServiceIssue | ServiceIssueStored, isDraft?: boolean) => {
    if (isDraft && (!target || !(target as ServiceIssueStored).__signedIdentifier)) {
      ...
      navigate(
        routeToServiceUserIssuesActiveIssuesGlobalRelationViewPage((target as ServiceIssueStored)!.__signedIdentifier),
      );
    }
  };
