...
import { serviceUserIssuesServiceForActiveIssuesGlobalImpl } from '~/services/data-axios';
...
// Name: service::UserIssues::activeIssuesGlobal::Relation::View::Page
export default function ServiceUserIssuesActiveIssuesGlobalRelationViewPage() {
  ...
  const serviceIssueIssue_View_EditIssueOwnerAutocomplete = async (
    ...
    try {
      return serviceUserIssuesServiceForActiveIssuesGlobalImpl.getRangeForOwner(data, queryCustomizer);
    } catch (error) {
      handleError(error);
  ...
  const serviceIssueIssue_View_EditIssueIssueTypeAutocomplete = async (
    ...
    try {
      return serviceUserIssuesServiceForActiveIssuesGlobalImpl.getRangeForIssueType(data, queryCustomizer);
    } catch (error) {
      handleError(error);
      return Promise.resolve([]);
    }
