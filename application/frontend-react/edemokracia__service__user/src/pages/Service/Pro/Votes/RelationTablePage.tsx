...
export const SERVICE_PRO_VOTES_RELATION_TABLE_PAGE_ACTIONS_HOOK_INTERFACE_KEY =
  'SERVICE_PRO_VOTES_RELATION_TABLE_PAGE_ACTIONS_HOOK';
...
export default function ServiceProVotesRelationTablePage() {
  ...
  const openPageAction = async (target: ServiceSimpleVote | ServiceSimpleVoteStored, isDraft?: boolean) => {
    if (isDraft && (!target || !(target as ServiceSimpleVoteStored).__signedIdentifier)) {
      ...
      navigate(routeToServiceProVotesRelationViewPage((target as ServiceSimpleVoteStored)!.__signedIdentifier));
    }
  };
