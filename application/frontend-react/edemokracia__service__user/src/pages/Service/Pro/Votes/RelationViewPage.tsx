...
export const SERVICE_PRO_VOTES_RELATION_VIEW_PAGE_ACTIONS_HOOK_INTERFACE_KEY =
  'SERVICE_PRO_VOTES_RELATION_VIEW_PAGE_ACTIONS_HOOK';
...
export const convertServiceProVotesRelationViewPagePayload = (
...
// XMIID: User/(esm/_qSoboGksEe25ONJ3V89cVA)/RelationFeatureView
// Name: service::Pro::votes::RelationViewPage
export default function ServiceProVotesRelationViewPage() {
  ...
  const storeDiff: (attributeName: keyof ServiceSimpleVote, value: any) => void = useCallback(
    (attributeName: keyof ServiceSimpleVote, value: any) => {
      payloadDiff.current![attributeName] = convertServiceProVotesRelationViewPagePayload(attributeName, value);
      setData((prevData) => ({
        ...prevData,
        [attributeName]: value,
      }));
  ...
  const { service: customActionsHook } = useTrackService<ServiceSimpleVoteSimpleVote_View_EditActionsHook>(
    `(${OBJECTCLASS}=${SERVICE_PRO_VOTES_RELATION_VIEW_PAGE_ACTIONS_HOOK_INTERFACE_KEY})`,
  );
  ...
  return (
    <ServiceSimpleVoteSimpleVote_View_EditViewModelContext.Provider value={viewModel}>
      <Suspense>
        <div
          id="User/(esm/_qSoboGksEe25ONJ3V89cVA)/RelationFeatureView"
          data-page-name="service::Pro::votes::RelationViewPage"
        />
