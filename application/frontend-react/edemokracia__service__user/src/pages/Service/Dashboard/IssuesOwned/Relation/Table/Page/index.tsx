...
// Name: service::Dashboard::issuesOwned::Relation::Table::Page
export default function ServiceDashboardIssuesOwnedRelationTablePage() {
  ...
  const serviceIssueIssue_TableDelete = async (target: ServiceIssueStored, silentMode?: boolean) => {
    try {
  ...
  const serviceIssueIssue_TableBulkDelete = async (
    ...
    return new Promise((resolve) => {
      openCRUDDialog<ServiceIssueStored>({
        ...
        action: async (item, successHandler: () => void, errorHandler: (error: any) => void) => {
          try {
            if (actions.serviceIssueIssue_TableDelete) {
              await actions.serviceIssueIssue_TableDelete!(item, true);
            }
            successHandler();
          } catch (error) {
            errorHandler(error);
