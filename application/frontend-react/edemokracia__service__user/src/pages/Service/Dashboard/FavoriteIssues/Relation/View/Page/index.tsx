...
import { serviceDashboardServiceForFavoriteIssuesImpl } from '~/services/data-axios';
...
export default function ServiceDashboardFavoriteIssuesRelationViewPage() {
  ...
  const serviceIssueIssue_View_EditIssueOwnerAutocomplete = async (
    ...
    try {
      return serviceDashboardServiceForFavoriteIssuesImpl.getRangeForOwner(data, queryCustomizer);
    } catch (error) {
      handleError(error);
  ...
  const serviceIssueIssue_View_EditIssueIssueTypeAutocomplete = async (
    ...
    try {
      return serviceDashboardServiceForFavoriteIssuesImpl.getRangeForIssueType(data, queryCustomizer);
    } catch (error) {
      handleError(error);
      return Promise.resolve([]);
    }
