...
export const SERVICE_DASHBOARD_OWNED_VOTE_DEFINITIONS_RELATION_VIEW_PAGE_ACTIONS_HOOK_INTERFACE_KEY =
  'SERVICE_DASHBOARD_OWNED_VOTE_DEFINITIONS_RELATION_VIEW_PAGE_ACTIONS_HOOK';
...
// Name: service::Dashboard::ownedVoteDefinitions::RelationViewPage
export default function ServiceDashboardOwnedVoteDefinitionsRelationViewPage() {
  ...
  const { service: customActionsHook } = useTrackService<ServiceVoteDefinitionVoteDefinition_View_EditActionsHook>(
    `(${OBJECTCLASS}=${SERVICE_DASHBOARD_OWNED_VOTE_DEFINITIONS_RELATION_VIEW_PAGE_ACTIONS_HOOK_INTERFACE_KEY})`,
  );
  ...
  return (
    <ServiceVoteDefinitionVoteDefinition_View_EditViewModelContext.Provider value={viewModel}>
      <Suspense>
        <div
          id="User/(esm/_LYtscGBWEe6M1JBD8stPIg)/RelationFeatureView"
          data-page-name="service::Dashboard::ownedVoteDefinitions::RelationViewPage"
        />
