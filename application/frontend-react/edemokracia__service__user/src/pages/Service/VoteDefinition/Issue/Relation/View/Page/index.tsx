...
import { serviceVoteDefinitionServiceForIssueImpl } from '~/services/data-axios';
...
// Name: service::VoteDefinition::issue::Relation::View::Page
export default function ServiceVoteDefinitionIssueRelationViewPage() {
  ...
  const serviceIssueIssue_View_EditIssueOwnerAutocomplete = async (
    ...
    try {
      return serviceVoteDefinitionServiceForIssueImpl.getRangeForOwner(data, queryCustomizer);
    } catch (error) {
      handleError(error);
  ...
  const serviceIssueIssue_View_EditIssueIssueTypeAutocomplete = async (
    ...
    try {
      return serviceVoteDefinitionServiceForIssueImpl.getRangeForIssueType(data, queryCustomizer);
    } catch (error) {
      handleError(error);
      return Promise.resolve([]);
    }
