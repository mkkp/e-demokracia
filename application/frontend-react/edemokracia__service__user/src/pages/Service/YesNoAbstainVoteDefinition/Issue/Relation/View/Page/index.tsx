...
import { serviceYesNoAbstainVoteDefinitionServiceForIssueImpl } from '~/services/data-axios';
...
// Name: service::YesNoAbstainVoteDefinition::issue::Relation::View::Page
export default function ServiceYesNoAbstainVoteDefinitionIssueRelationViewPage() {
  ...
  const serviceIssueIssue_View_EditIssueOwnerAutocomplete = async (
    ...
    try {
      return serviceYesNoAbstainVoteDefinitionServiceForIssueImpl.getRangeForOwner(data, queryCustomizer);
    } catch (error) {
      handleError(error);
  ...
  const serviceIssueIssue_View_EditIssueIssueTypeAutocomplete = async (
    ...
    try {
      return serviceYesNoAbstainVoteDefinitionServiceForIssueImpl.getRangeForIssueType(data, queryCustomizer);
    } catch (error) {
      handleError(error);
      return Promise.resolve([]);
    }
