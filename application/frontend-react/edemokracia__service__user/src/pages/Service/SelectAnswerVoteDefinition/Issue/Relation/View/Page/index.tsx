...
import { serviceSelectAnswerVoteDefinitionServiceForIssueImpl } from '~/services/data-axios';
...
// Name: service::SelectAnswerVoteDefinition::issue::Relation::View::Page
export default function ServiceSelectAnswerVoteDefinitionIssueRelationViewPage() {
  ...
  const serviceIssueIssue_View_EditIssueOwnerAutocomplete = async (
    ...
    try {
      return serviceSelectAnswerVoteDefinitionServiceForIssueImpl.getRangeForOwner(data, queryCustomizer);
    } catch (error) {
      handleError(error);
  ...
  const serviceIssueIssue_View_EditIssueIssueTypeAutocomplete = async (
    ...
    try {
      return serviceSelectAnswerVoteDefinitionServiceForIssueImpl.getRangeForIssueType(data, queryCustomizer);
    } catch (error) {
      handleError(error);
      return Promise.resolve([]);
    }
