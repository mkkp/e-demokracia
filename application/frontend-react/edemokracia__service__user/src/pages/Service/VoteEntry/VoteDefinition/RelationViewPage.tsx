...
export const SERVICE_VOTE_ENTRY_VOTE_DEFINITION_RELATION_VIEW_PAGE_ACTIONS_HOOK_INTERFACE_KEY =
  'SERVICE_VOTE_ENTRY_VOTE_DEFINITION_RELATION_VIEW_PAGE_ACTIONS_HOOK';
...
// Name: service::VoteEntry::voteDefinition::RelationViewPage
export default function ServiceVoteEntryVoteDefinitionRelationViewPage() {
  // Router params section
  const { signedIdentifier } = useParams();

  // Services
  const serviceVoteEntryServiceForVoteDefinitionImpl = useMemo(
  ...
  const storeDiff: (attributeName: keyof ServiceVoteDefinition, value: any) => void = useCallback(
    (attributeName: keyof ServiceVoteDefinition, value: any) => {
      payloadDiff.current![attributeName] = convertServiceVoteEntryVoteDefinitionRelationViewPagePayload(
        attributeName,
        value,
      );
      setData((prevData) => ({
    ...
    <ServiceVoteDefinitionVoteDefinition_View_EditViewModelContext.Provider value={viewModel}>
      <Suspense>
        <div
          ...
          data-page-name="service::VoteEntry::voteDefinition::RelationViewPage"
        />
