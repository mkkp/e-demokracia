...
import { serviceRatingVoteDefinitionServiceForIssueImpl } from '~/services/data-axios';
...
// Name: service::RatingVoteDefinition::issue::Relation::View::Page
export default function ServiceRatingVoteDefinitionIssueRelationViewPage() {
  ...
  const serviceIssueIssue_View_EditIssueOwnerAutocomplete = async (
    ...
    try {
      return serviceRatingVoteDefinitionServiceForIssueImpl.getRangeForOwner(data, queryCustomizer);
    } catch (error) {
      handleError(error);
  ...
  const serviceIssueIssue_View_EditIssueIssueTypeAutocomplete = async (
    ...
    try {
      return serviceRatingVoteDefinitionServiceForIssueImpl.getRangeForIssueType(data, queryCustomizer);
    } catch (error) {
      handleError(error);
      return Promise.resolve([]);
    }
