...
// Name: service::UserVoteDefinition::activeVoteDefinitionsInResidentDistrict::Relation::Table::Page
export default function ServiceUserVoteDefinitionActiveVoteDefinitionsInResidentDistrictRelationTablePage() {
  ...
  return (
    <div
      ...
      data-page-name="service::UserVoteDefinition::activeVoteDefinitionsInResidentDistrict::Relation::Table::Page"
    >
      <Suspense>
