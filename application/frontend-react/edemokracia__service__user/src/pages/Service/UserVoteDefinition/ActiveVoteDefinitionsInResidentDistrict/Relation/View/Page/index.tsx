...
// Name: service::UserVoteDefinition::activeVoteDefinitionsInResidentDistrict::Relation::View::Page
export default function ServiceUserVoteDefinitionActiveVoteDefinitionsInResidentDistrictRelationViewPage() {
  ...
  return (
    <div
      ...
      data-page-name="service::UserVoteDefinition::activeVoteDefinitionsInResidentDistrict::Relation::View::Page"
    >
      <Suspense>
