...
import { serviceUserVoteDefinitionServiceForActiveVoteDefinitionsGlobalImpl } from '~/services/data-axios';
...
// Name: service::UserVoteDefinition::activeVoteDefinitionsGlobal::Relation::Table::Page
// Access: false
// Single Access: false
export default function ServiceUserVoteDefinitionActiveVoteDefinitionsGlobalRelationTablePage() {
  ...
  return (
    <div
      ...
      data-page-name="service::UserVoteDefinition::activeVoteDefinitionsGlobal::Relation::Table::Page"
    >
      <Suspense>
