...
export default function ServiceUserVoteDefinitionActiveVoteDefinitionsInResidentCityRelationViewPage() {
  ...
  const refreshAction = async (
    ...
    try {
      setIsLoading(true);
      setEditMode(false);
      const result = await serviceUserVoteDefinitionServiceForActiveVoteDefinitionsInResidentCityImpl.refresh(
  ...
  const updateAction = async () => {
    setIsLoading(true);
    try {
      const res = await serviceUserVoteDefinitionServiceForActiveVoteDefinitionsInResidentCityImpl.update(
        payloadDiff.current,
      );
      if (res) {
