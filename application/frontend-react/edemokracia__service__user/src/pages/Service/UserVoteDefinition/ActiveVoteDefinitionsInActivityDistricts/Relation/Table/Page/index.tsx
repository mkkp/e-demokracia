...
import { serviceUserVoteDefinitionServiceForActiveVoteDefinitionsInActivityDistrictsImpl } from '~/services/data-axios';
...
// Name: service::UserVoteDefinition::activeVoteDefinitionsInActivityDistricts::Relation::Table::Page
// Access: false
// Single Access: false
export default function ServiceUserVoteDefinitionActiveVoteDefinitionsInActivityDistrictsRelationTablePage() {
  ...
  return (
    <div
      ...
      data-page-name="service::UserVoteDefinition::activeVoteDefinitionsInActivityDistricts::Relation::Table::Page"
    >
      <Suspense>
