...
// Name: service::UserVoteDefinition::activeVoteDefinitionsInActivityDistricts::Relation::View::Page
export default function ServiceUserVoteDefinitionActiveVoteDefinitionsInActivityDistrictsRelationViewPage() {
  ...
  return (
    <div
      ...
      data-page-name="service::UserVoteDefinition::activeVoteDefinitionsInActivityDistricts::Relation::View::Page"
    >
      <Suspense>
