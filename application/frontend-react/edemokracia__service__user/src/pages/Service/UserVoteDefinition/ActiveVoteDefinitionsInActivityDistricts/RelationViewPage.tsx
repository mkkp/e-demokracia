...
export default function ServiceUserVoteDefinitionActiveVoteDefinitionsInActivityDistrictsRelationViewPage() {
  ...
  const refreshAction = async (
    ...
    try {
      setIsLoading(true);
      setEditMode(false);
      const response = await serviceUserVoteDefinitionServiceForActiveVoteDefinitionsInActivityDistrictsImpl.refresh(
  ...
  const updateAction = async () => {
    ...
    try {
      const { data: res } =
        await serviceUserVoteDefinitionServiceForActiveVoteDefinitionsInActivityDistrictsImpl.update(
          payloadDiff.current,
        );
      if (res) {
