...
export default function ServiceUserVoteDefinitionActiveVoteDefinitionsInResidentCountyRelationViewPage() {
  ...
  const refreshAction = async (
    ...
    try {
      setIsLoading(true);
      setEditMode(false);
      const result = await serviceUserVoteDefinitionServiceForActiveVoteDefinitionsInResidentCountyImpl.refresh(
  ...
  const updateAction = async () => {
    setIsLoading(true);
    try {
      const res = await serviceUserVoteDefinitionServiceForActiveVoteDefinitionsInResidentCountyImpl.update(
        payloadDiff.current,
      );
      if (res) {
