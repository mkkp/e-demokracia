...
// Name: service::UserVoteDefinition::activeVoteDefinitionsInResidentCounty::Relation::View::Page
// Access: false
// Single Access: false
export default function ServiceUserVoteDefinitionActiveVoteDefinitionsInResidentCountyRelationViewPage() {
  ...
  return (
    <div
      ...
      data-page-name="service::UserVoteDefinition::activeVoteDefinitionsInResidentCounty::Relation::View::Page"
    >
      <Suspense>
