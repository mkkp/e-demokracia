...
export default function ServiceUserVoteDefinitionActiveVoteDefinitionsInActivityCountiesRelationViewPage() {
  ...
  const refreshAction = async (
    ...
    try {
      setIsLoading(true);
      setEditMode(false);
      const result = await serviceUserVoteDefinitionServiceForActiveVoteDefinitionsInActivityCountiesImpl.refresh(
  ...
  const updateAction = async () => {
    setIsLoading(true);
    try {
      const res = await serviceUserVoteDefinitionServiceForActiveVoteDefinitionsInActivityCountiesImpl.update(
        payloadDiff.current,
      );
      if (res) {
