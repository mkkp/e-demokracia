...
import { serviceUserVoteDefinitionServiceForActiveVoteDefinitionsInActivityCitiesImpl } from '~/services/data-axios';
...
// Name: service::UserVoteDefinition::activeVoteDefinitionsInActivityCities::Relation::Table::Page
// Access: false
// Single Access: false
export default function ServiceUserVoteDefinitionActiveVoteDefinitionsInActivityCitiesRelationTablePage() {
  ...
  return (
    <div
      ...
      data-page-name="service::UserVoteDefinition::activeVoteDefinitionsInActivityCities::Relation::Table::Page"
    >
      <Suspense>
