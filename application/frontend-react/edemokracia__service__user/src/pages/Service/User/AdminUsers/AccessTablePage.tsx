...
import { useServiceUserAdminUsersAccessViewPage } from '~/dialogs/Service/User/AdminUsers/AccessViewPage';
...
export default function ServiceUserAdminUsersAccessTablePage() {
  ...
  return (
    <div
      ...
      data-page-name="service::User::adminUsers::AccessTablePage"
    >
      <Suspense>
