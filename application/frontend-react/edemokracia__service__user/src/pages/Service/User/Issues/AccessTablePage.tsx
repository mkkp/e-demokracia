...
export const SERVICE_USER_ISSUES_ACCESS_TABLE_PAGE_ACTIONS_HOOK_INTERFACE_KEY = 'ServiceIssueIssue_TableActionsHook';
...
export default function ServiceUserIssuesAccessTablePage() {
  ...
  const openPageAction = async (target?: ServiceIssueStored) => {
    ...
    navigate(routeToServiceUserIssuesAccessViewPage(target!.__signedIdentifier));
  };
