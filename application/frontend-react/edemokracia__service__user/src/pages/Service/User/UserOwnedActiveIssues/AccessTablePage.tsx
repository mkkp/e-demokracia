...
import { UserServiceForUserOwnedActiveIssuesImpl } from '~/services/data-axios/UserServiceForUserOwnedActiveIssuesImpl';
...
// Name: service::User::userOwnedActiveIssues::AccessTablePage
export default function ServiceUserUserOwnedActiveIssuesAccessTablePage() {
  // Services
  const userServiceForUserOwnedActiveIssuesImpl = useMemo(
  ...
  return (
    <div
      ...
      data-page-name="service::User::userOwnedActiveIssues::AccessTablePage"
    >
      <Suspense>
