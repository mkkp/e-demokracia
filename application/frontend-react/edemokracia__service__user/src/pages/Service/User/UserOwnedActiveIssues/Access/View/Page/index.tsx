...
export const SERVICE_USER_USER_OWNED_ACTIVE_ISSUES_ACCESS_VIEW_PAGE_ACTIONS_HOOK_INTERFACE_KEY =
...
export default function ServiceUserUserOwnedActiveIssuesAccessViewPage() {
  ...
  const { service: customActionsHook } = useTrackService<ServiceIssueIssue_View_EditActionsHook>(
    `(${OBJECTCLASS}=${SERVICE_USER_USER_OWNED_ACTIVE_ISSUES_ACCESS_VIEW_PAGE_ACTIONS_HOOK_INTERFACE_KEY})`,
  );
  ...
  const countyAutocompleteRangeAction = async (
    ...
    // page service::User::userOwnedActiveIssues::Access::View::Page
    try {
  ...
  return (
    <div
      id="User/(esm/_LY9IoFqmEe6_67aMO2jOsw)/AccessViewPageDefinition"
      data-page-name="service::User::userOwnedActiveIssues::Access::View::Page"
    >
      <Suspense>
