...
// Name: service::User::userOwnedActiveIssues::AccessViewPage
export default function ServiceUserUserOwnedActiveIssuesAccessViewPage() {
  ...
  const issueTypeAutocompleteRangeAction = async (
    ...
    // page service::User::userOwnedActiveIssues::AccessViewPage
    try {
  ...
  return (
    <div
      ...
      data-page-name="service::User::userOwnedActiveIssues::AccessViewPage"
    >
      <Suspense>
