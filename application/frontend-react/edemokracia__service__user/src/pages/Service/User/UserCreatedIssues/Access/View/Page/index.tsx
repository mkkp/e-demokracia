...
export const SERVICE_USER_USER_CREATED_ISSUES_ACCESS_VIEW_PAGE_ACTIONS_HOOK_INTERFACE_KEY =
...
export default function ServiceUserUserCreatedIssuesAccessViewPage() {
  ...
  const { service: customActionsHook } = useTrackService<ServiceIssueIssue_View_EditActionsHook>(
    `(${OBJECTCLASS}=${SERVICE_USER_USER_CREATED_ISSUES_ACCESS_VIEW_PAGE_ACTIONS_HOOK_INTERFACE_KEY})`,
  );
  ...
  const countyAutocompleteRangeAction = async (
    ...
    // page service::User::userCreatedIssues::Access::View::Page
    try {
  ...
  return (
    <div
      id="User/(esm/_ITVmEFqnEe6_67aMO2jOsw)/AccessViewPageDefinition"
      data-page-name="service::User::userCreatedIssues::Access::View::Page"
    >
      <Suspense>
