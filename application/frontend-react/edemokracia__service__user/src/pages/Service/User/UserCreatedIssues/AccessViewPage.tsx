...
// Name: service::User::userCreatedIssues::AccessViewPage
export default function ServiceUserUserCreatedIssuesAccessViewPage() {
  ...
  const issueTypeAutocompleteRangeAction = async (
    ...
    // page service::User::userCreatedIssues::AccessViewPage
    try {
  ...
  return (
    <div
      ...
      data-page-name="service::User::userCreatedIssues::AccessViewPage"
    >
      <Suspense>
