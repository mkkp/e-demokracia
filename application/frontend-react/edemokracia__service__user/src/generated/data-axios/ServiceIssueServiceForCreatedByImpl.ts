...
/**
 * Relation Service Implementation for ServiceIssue.createdBy
 */
export class ServiceIssueServiceForCreatedByImpl extends JudoAxiosService implements ServiceIssueServiceForCreatedBy {
  /**
   * @throws {AxiosError} With data containing {@link Array<FeedbackItem>} for status codes: 401, 403.
   */
  async getCreatedBy(owner: JudoIdentifiable<ServiceIssue>, mask?: string): Promise<ServiceServiceUserStored> {
