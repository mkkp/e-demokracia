...
import type { ServiceIssueCategoryServiceForClass } from '../data-service';

/**
 * Class Service Implementation for ServiceIssueCategory
 */
export class ServiceIssueCategoryServiceForClassImpl
  extends JudoAxiosService
  implements ServiceIssueCategoryServiceForClass
{
  /**
  ...
  async getRangeForSubcategories(
    ...
    const path = '/service/IssueCategory/subcategories/~range';
   ...
   * @throws {AxiosError} With data containing {@link Array<FeedbackItem>} for status codes: 400, 401, 403.
   */
  async unsetOwner(target: JudoIdentifiable<ServiceIssueCategory>): Promise<void> {
