...
import type { ServiceServicePrincipalUserServiceForClass } from '../data-service';

/**
 * Class Service Implementation for ServiceServicePrincipalUser
 */
export class ServiceServicePrincipalUserServiceForClassImpl
  extends JudoAxiosService
  implements ServiceServicePrincipalUserServiceForClass
{
  /**
