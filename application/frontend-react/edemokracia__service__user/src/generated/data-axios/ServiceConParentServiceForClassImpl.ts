...
import type { ServiceConParentServiceForClass } from '../data-service';

/**
 * Class Service Implementation for ServiceConParent
 */
export class ServiceConParentServiceForClassImpl extends JudoAxiosService implements ServiceConParentServiceForClass {
  /**
