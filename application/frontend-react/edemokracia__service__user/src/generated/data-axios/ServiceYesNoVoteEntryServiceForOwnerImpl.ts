...
/**
 * Relation Service Implementation for ServiceYesNoVoteEntry.owner
 */
export class ServiceYesNoVoteEntryServiceForOwnerImpl
  extends JudoAxiosService
  implements ServiceYesNoVoteEntryServiceForOwner
{
  /**
   * @throws {AxiosError} With data containing {@link Array<FeedbackItem>} for status codes: 401, 403.
   */
  async getOwner(owner: JudoIdentifiable<ServiceYesNoVoteEntry>, mask?: string): Promise<ServiceServiceUserStored> {
