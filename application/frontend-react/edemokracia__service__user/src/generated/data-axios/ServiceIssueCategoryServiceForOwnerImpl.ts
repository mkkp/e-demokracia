...
/**
 * Relation Service Implementation for ServiceIssueCategory.owner
 */
export class ServiceIssueCategoryServiceForOwnerImpl
  extends JudoAxiosService
  implements ServiceIssueCategoryServiceForOwner
{
  /**
   * @throws {AxiosError} With data containing {@link Array<FeedbackItem>} for status codes: 401, 403.
   */
  async getOwner(owner: JudoIdentifiable<ServiceIssueCategory>, mask?: string): Promise<ServiceServiceUserStored> {
