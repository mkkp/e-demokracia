...
/**
 * Relation Service for ServiceUserDebates.activeDebatesInResidentCity
 */
export interface ServiceUserDebatesServiceForActiveDebatesInResidentCity {
  listActiveDebatesInResidentCity(
