...
/**
 * Relation Service for ServiceUserIssues.activeIssuesInActivityCounties
 */
export interface ServiceUserIssuesServiceForActiveIssuesInActivityCounties {
  ...
  addActiveIssuesInActivityCountiesCategories(
    owner: JudoIdentifiable<ServiceUserIssues>,
    target: JudoIdentifiable<ServiceIssueCategory>,
    selected: Array<JudoIdentifiable<ServiceIssueCategory>>,
  ): Promise<void>;

  removeActiveIssuesInActivityCountiesCategories(
    owner: JudoIdentifiable<ServiceUserIssues>,
    target: JudoIdentifiable<ServiceIssueCategory>,
    selected: Array<JudoIdentifiable<ServiceIssueCategory>>,
  ): Promise<void>;
