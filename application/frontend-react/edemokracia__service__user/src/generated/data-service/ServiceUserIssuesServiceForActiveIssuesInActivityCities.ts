...
/**
 * Relation Service for ServiceUserIssues.activeIssuesInActivityCities
 */
export interface ServiceUserIssuesServiceForActiveIssuesInActivityCities {
  ...
  addActiveIssuesInActivityCitiesCategories(
    owner: JudoIdentifiable<ServiceUserIssues>,
    target: JudoIdentifiable<ServiceIssueCategory>,
    selected: Array<JudoIdentifiable<ServiceIssueCategory>>,
  ): Promise<void>;

  removeActiveIssuesInActivityCitiesCategories(
    owner: JudoIdentifiable<ServiceUserIssues>,
    target: JudoIdentifiable<ServiceIssueCategory>,
    selected: Array<JudoIdentifiable<ServiceIssueCategory>>,
  ): Promise<void>;
