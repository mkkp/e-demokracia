...
/**
 * Relation Service for User.acitveIssuesInActivityDistricts
 */
export interface UserServiceForAcitveIssuesInActivityDistricts {
  listAcitveIssuesInActivityDistricts(
