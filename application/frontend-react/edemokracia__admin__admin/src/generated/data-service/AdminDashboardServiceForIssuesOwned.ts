...
/**
 * Relation Service for AdminDashboard.issuesOwned
 */
export interface AdminDashboardServiceForIssuesOwned {
  listIssuesOwned(
    owner: JudoIdentifiable<AdminDashboard>,
    queryCustomizer?: AdminIssueQueryCustomizer,
  ): Promise<Array<AdminIssueStored>>;

  deleteIssuesOwned(owner: JudoIdentifiable<AdminDashboard>, target: JudoIdentifiable<AdminIssue>): Promise<void>;
