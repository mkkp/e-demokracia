...
/**
 * Relation Service for AdminUserIssues.activeIssuesGlobal
 */
export interface AdminUserIssuesServiceForActiveIssuesGlobal {
  ...
  addActiveIssuesGlobalCategories(
    owner: JudoIdentifiable<AdminUserIssues>,
    target: JudoIdentifiable<AdminIssueCategory>,
    selected: Array<JudoIdentifiable<AdminIssueCategory>>,
  ): Promise<void>;

  removeActiveIssuesGlobalCategories(
    owner: JudoIdentifiable<AdminUserIssues>,
    target: JudoIdentifiable<AdminIssueCategory>,
    selected: Array<JudoIdentifiable<AdminIssueCategory>>,
  ): Promise<void>;
