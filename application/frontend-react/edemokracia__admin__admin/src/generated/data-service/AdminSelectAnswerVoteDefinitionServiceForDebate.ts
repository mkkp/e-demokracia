...
/**
 * Relation Service for AdminSelectAnswerVoteDefinition.debate
 */
export interface AdminSelectAnswerVoteDefinitionServiceForDebate {
  getDebate(owner: JudoIdentifiable<AdminSelectAnswerVoteDefinition>, mask?: string): Promise<AdminDebateStored>;
}
