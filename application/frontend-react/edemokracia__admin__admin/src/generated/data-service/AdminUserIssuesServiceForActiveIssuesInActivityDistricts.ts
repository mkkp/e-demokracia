...
/**
 * Relation Service for AdminUserIssues.activeIssuesInActivityDistricts
 */
export interface AdminUserIssuesServiceForActiveIssuesInActivityDistricts {
  ...
  addActiveIssuesInActivityDistrictsCategories(
    owner: JudoIdentifiable<AdminUserIssues>,
    target: JudoIdentifiable<AdminIssueCategory>,
    selected: Array<JudoIdentifiable<AdminIssueCategory>>,
  ): Promise<void>;

  removeActiveIssuesInActivityDistrictsCategories(
    owner: JudoIdentifiable<AdminUserIssues>,
    target: JudoIdentifiable<AdminIssueCategory>,
    selected: Array<JudoIdentifiable<AdminIssueCategory>>,
  ): Promise<void>;
