 ...
 */
export interface AdminIssueServiceForClass {
  ...
  addToFavorites(owner: JudoIdentifiable<AdminIssue>): Promise<void>;

  removeFromFavorites(owner: JudoIdentifiable<AdminIssue>): Promise<void>;
}
