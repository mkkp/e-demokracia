...
/**
 * Relation Service for AdminUserIssues.activeIssuesInResidentCity
 */
export interface AdminUserIssuesServiceForActiveIssuesInResidentCity {
  ...
  addActiveIssuesInResidentCityCategories(
    owner: JudoIdentifiable<AdminUserIssues>,
    target: JudoIdentifiable<AdminIssueCategory>,
    selected: Array<JudoIdentifiable<AdminIssueCategory>>,
  ): Promise<void>;

  removeActiveIssuesInResidentCityCategories(
    owner: JudoIdentifiable<AdminUserIssues>,
    target: JudoIdentifiable<AdminIssueCategory>,
    selected: Array<JudoIdentifiable<AdminIssueCategory>>,
  ): Promise<void>;
