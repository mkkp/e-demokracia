...
/**
 * Relation Service for VoteDefinition.userVoteEntry
 */
export interface VoteDefinitionServiceForUserVoteEntry {
  getUserVoteEntry(owner: JudoIdentifiable<VoteDefinition>, mask?: string): Promise<VoteEntryStored>;
