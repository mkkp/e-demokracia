...
import type { UserServiceForActiveIssuesInResidentDistrict } from '../data-service';

/**
 * Relation Service Implementation for User.activeIssuesInResidentDistrict
 */
export class UserServiceForActiveIssuesInResidentDistrictImpl
  extends JudoAxiosService
  implements UserServiceForActiveIssuesInResidentDistrict
{
  /**
