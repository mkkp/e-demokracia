...
import type { AdminYesNoVoteEntryServiceForUser } from '../data-service';

/**
 * Relation Service Implementation for AdminYesNoVoteEntry.user
 */
export class AdminYesNoVoteEntryServiceForUserImpl extends JudoAxiosService implements AdminYesNoVoteEntryServiceForUser {
  /**
   * @throws {AxiosError} With data containing {@link Array<FeedbackItem>} for status codes: 401, 403.
   */
  async getUser(owner: JudoIdentifiable<AdminYesNoVoteEntry>, mask?: string): Promise<AdminUserStored> {
