...
import type { AdminUserIssuesServiceForActiveIssuesInResidentDistrict } from '../data-service';

/**
 * Relation Service Implementation for AdminUserIssues.activeIssuesInResidentDistrict
 */
export class AdminUserIssuesServiceForActiveIssuesInResidentDistrictImpl
  extends JudoAxiosService
  implements AdminUserIssuesServiceForActiveIssuesInResidentDistrict
{
  /**
  ...
  async updateActiveIssuesInResidentDistrict(
    ...
    const path = '/admin/UserIssues/~update/activeIssuesInResidentDistrict/~update';
   ...
   * @throws {AxiosError} With data containing {@link Array<FeedbackItem>} for status codes: 400, 401, 403.
   */
  async addActiveIssuesInResidentDistrictCategories(
    owner: JudoIdentifiable<AdminUserIssues>,
    target: JudoIdentifiable<AdminIssue>,
    selected: Array<JudoIdentifiable<AdminIssueCategory>>,
  ): Promise<void> {
   ...
   * @throws {AxiosError} With data containing {@link Array<FeedbackItem>} for status codes: 400, 401, 403.
   */
  async removeActiveIssuesInResidentDistrictCategories(
    owner: JudoIdentifiable<AdminUserIssues>,
    target: JudoIdentifiable<AdminIssue>,
    selected: Array<JudoIdentifiable<AdminIssueCategory>>,
  ): Promise<void> {
