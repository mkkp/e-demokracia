...
import type { AdminUserIssuesServiceForActiveIssuesInResidentCounty } from '../data-service';

/**
 * Relation Service Implementation for AdminUserIssues.activeIssuesInResidentCounty
 */
export class AdminUserIssuesServiceForActiveIssuesInResidentCountyImpl
  extends JudoAxiosService
  implements AdminUserIssuesServiceForActiveIssuesInResidentCounty
{
  /**
  ...
  async updateActiveIssuesInResidentCounty(
    ...
    const path = '/admin/UserIssues/~update/activeIssuesInResidentCounty/~update';
   ...
   * @throws {AxiosError} With data containing {@link Array<FeedbackItem>} for status codes: 400, 401, 403.
   */
  async addActiveIssuesInResidentCountyCategories(
    owner: JudoIdentifiable<AdminUserIssues>,
    target: JudoIdentifiable<AdminIssue>,
    selected: Array<JudoIdentifiable<AdminIssueCategory>>,
  ): Promise<void> {
   ...
   * @throws {AxiosError} With data containing {@link Array<FeedbackItem>} for status codes: 400, 401, 403.
   */
  async removeActiveIssuesInResidentCountyCategories(
    owner: JudoIdentifiable<AdminUserIssues>,
    target: JudoIdentifiable<AdminIssue>,
    selected: Array<JudoIdentifiable<AdminIssueCategory>>,
  ): Promise<void> {
