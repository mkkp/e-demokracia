...
import type { AdminUserIssuesServiceForActiveIssuesInActivityCities } from '../data-service';

/**
 * Relation Service Implementation for AdminUserIssues.activeIssuesInActivityCities
 */
export class AdminUserIssuesServiceForActiveIssuesInActivityCitiesImpl
  extends JudoAxiosService
  implements AdminUserIssuesServiceForActiveIssuesInActivityCities
{
  /**
  ...
  async updateActiveIssuesInActivityCities(
    ...
    const path = '/admin/UserIssues/~update/activeIssuesInActivityCities/~update';
   ...
   * @throws {AxiosError} With data containing {@link Array<FeedbackItem>} for status codes: 400, 401, 403.
   */
  async addActiveIssuesInActivityCitiesCategories(
    owner: JudoIdentifiable<AdminUserIssues>,
    target: JudoIdentifiable<AdminIssue>,
    selected: Array<JudoIdentifiable<AdminIssueCategory>>,
  ): Promise<void> {
   ...
   * @throws {AxiosError} With data containing {@link Array<FeedbackItem>} for status codes: 400, 401, 403.
   */
  async removeActiveIssuesInActivityCitiesCategories(
    owner: JudoIdentifiable<AdminUserIssues>,
    target: JudoIdentifiable<AdminIssue>,
    selected: Array<JudoIdentifiable<AdminIssueCategory>>,
  ): Promise<void> {
