...
import type { AdminUserIssuesServiceForActiveIssuesGlobal } from '../data-service';

/**
 * Relation Service Implementation for AdminUserIssues.activeIssuesGlobal
 */
export class AdminUserIssuesServiceForActiveIssuesGlobalImpl
  extends JudoAxiosService
  implements AdminUserIssuesServiceForActiveIssuesGlobal
{
  /**
  ...
  async updateActiveIssuesGlobal(
    ...
    const path = '/admin/UserIssues/~update/activeIssuesGlobal/~update';
