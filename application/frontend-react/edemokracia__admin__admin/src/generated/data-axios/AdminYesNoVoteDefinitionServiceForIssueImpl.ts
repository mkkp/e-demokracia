...
import type { AdminYesNoVoteDefinitionServiceForIssue } from '../data-service';

/**
 * Relation Service Implementation for AdminYesNoVoteDefinition.issue
 */
export class AdminYesNoVoteDefinitionServiceForIssueImpl
  extends JudoAxiosService
  implements AdminYesNoVoteDefinitionServiceForIssue
{
  /**
   * @throws {AxiosError} With data containing {@link Array<FeedbackItem>} for status codes: 401, 403.
   */
  async getIssue(owner: JudoIdentifiable<AdminYesNoVoteDefinition>, mask?: string): Promise<AdminIssueStored> {
