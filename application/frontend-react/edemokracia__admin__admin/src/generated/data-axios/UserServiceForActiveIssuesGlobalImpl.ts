...
import type { UserServiceForActiveIssuesGlobal } from '../data-service';

/**
 * Relation Service Implementation for User.activeIssuesGlobal
 */
export class UserServiceForActiveIssuesGlobalImpl extends JudoAxiosService implements UserServiceForActiveIssuesGlobal {
  /**
