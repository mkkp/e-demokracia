...
import type { IssueCategoryServiceForClass } from '../data-service';

/**
 * Class Service Implementation for IssueCategory
 */
export class IssueCategoryServiceForClassImpl extends JudoAxiosService implements IssueCategoryServiceForClass {
  /**
