...
import type { AdminUserIssuesServiceForActiveIssuesInResidentCity } from '../data-service';

/**
 * Relation Service Implementation for AdminUserIssues.activeIssuesInResidentCity
 */
export class AdminUserIssuesServiceForActiveIssuesInResidentCityImpl
  extends JudoAxiosService
  implements AdminUserIssuesServiceForActiveIssuesInResidentCity
{
  /**
  ...
  async updateActiveIssuesInResidentCity(
    ...
    const path = '/admin/UserIssues/~update/activeIssuesInResidentCity/~update';
   ...
   * @throws {AxiosError} With data containing {@link Array<FeedbackItem>} for status codes: 400, 401, 403.
   */
  async addActiveIssuesInResidentCityCategories(
    owner: JudoIdentifiable<AdminUserIssues>,
    target: JudoIdentifiable<AdminIssue>,
    selected: Array<JudoIdentifiable<AdminIssueCategory>>,
  ): Promise<void> {
   ...
   * @throws {AxiosError} With data containing {@link Array<FeedbackItem>} for status codes: 400, 401, 403.
   */
  async removeActiveIssuesInResidentCityCategories(
    owner: JudoIdentifiable<AdminUserIssues>,
    target: JudoIdentifiable<AdminIssue>,
    selected: Array<JudoIdentifiable<AdminIssueCategory>>,
  ): Promise<void> {
