...
import type { AdminVoteEntryServiceForClass } from '../data-service';

/**
 * Class Service Implementation for AdminVoteEntry
 */
export class AdminVoteEntryServiceForClassImpl extends JudoAxiosService implements AdminVoteEntryServiceForClass {
  /**
