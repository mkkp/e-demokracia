...
import type { AdminRatingVoteEntryServiceForOwner } from '../data-service';

/**
 * Relation Service Implementation for AdminRatingVoteEntry.owner
 */
export class AdminRatingVoteEntryServiceForOwnerImpl
  extends JudoAxiosService
  implements AdminRatingVoteEntryServiceForOwner
{
  /**
   * @throws {AxiosError} With data containing {@link Array<FeedbackItem>} for status codes: 401, 403.
   */
  async getOwner(owner: JudoIdentifiable<AdminRatingVoteEntry>, mask?: string): Promise<AdminUserStored> {
