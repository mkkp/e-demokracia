...
import type { AdminYesNoVoteEntryServiceForOwner } from '../data-service';

/**
 * Relation Service Implementation for AdminYesNoVoteEntry.owner
 */
export class AdminYesNoVoteEntryServiceForOwnerImpl
  extends JudoAxiosService
  implements AdminYesNoVoteEntryServiceForOwner
{
  /**
   * @throws {AxiosError} With data containing {@link Array<FeedbackItem>} for status codes: 401, 403.
   */
  async getOwner(owner: JudoIdentifiable<AdminYesNoVoteEntry>, mask?: string): Promise<AdminUserStored> {
