...
import type { AdminIssueCategoryServiceForClass } from '../data-service';

/**
 * Class Service Implementation for AdminIssueCategory
 */
export class AdminIssueCategoryServiceForClassImpl extends JudoAxiosService implements AdminIssueCategoryServiceForClass {
  /**
