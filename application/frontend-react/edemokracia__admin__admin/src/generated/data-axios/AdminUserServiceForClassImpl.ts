...
import type { AdminUserServiceForClass } from '../data-service';

/**
 * Class Service Implementation for AdminUser
 */
export class AdminUserServiceForClassImpl extends JudoAxiosService implements AdminUserServiceForClass {
  /**
