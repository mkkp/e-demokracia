...
import type { AdminUserDebatesServiceForActiveDebatesInActivityCities } from '../data-service';

/**
 * Relation Service Implementation for AdminUserDebates.activeDebatesInActivityCities
 */
export class AdminUserDebatesServiceForActiveDebatesInActivityCitiesImpl
  extends JudoAxiosService
  implements AdminUserDebatesServiceForActiveDebatesInActivityCities
{
  /**
  ...
  async updateActiveDebatesInActivityCities(
    ...
    const path = '/admin/UserDebates/~update/activeDebatesInActivityCities/~update';
