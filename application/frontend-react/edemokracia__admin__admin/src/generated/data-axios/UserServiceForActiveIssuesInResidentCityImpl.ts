...
import type { UserServiceForActiveIssuesInResidentCity } from '../data-service';

/**
 * Relation Service Implementation for User.activeIssuesInResidentCity
 */
export class UserServiceForActiveIssuesInResidentCityImpl
  extends JudoAxiosService
  implements UserServiceForActiveIssuesInResidentCity
{
  /**
