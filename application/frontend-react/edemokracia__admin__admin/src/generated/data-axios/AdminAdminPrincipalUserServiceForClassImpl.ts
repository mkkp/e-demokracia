...
import type { AdminAdminPrincipalUserServiceForClass } from '../data-service';

/**
 * Class Service Implementation for AdminAdminPrincipalUser
 */
export class AdminAdminPrincipalUserServiceForClassImpl
  extends JudoAxiosService
  implements AdminAdminPrincipalUserServiceForClass
{
  /**
