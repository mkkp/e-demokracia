...
import type { UserServiceForOwnedIssues } from '../data-service';

/**
 * Relation Service Implementation for User.ownedIssues
 */
export class UserServiceForOwnedIssuesImpl extends JudoAxiosService implements UserServiceForOwnedIssues {
  /**
