...
import type { UserServiceForActiveIssuesInActivityCities } from '../data-service';

/**
 * Relation Service Implementation for User.activeIssuesInActivityCities
 */
export class UserServiceForActiveIssuesInActivityCitiesImpl
  extends JudoAxiosService
  implements UserServiceForActiveIssuesInActivityCities
{
  /**
