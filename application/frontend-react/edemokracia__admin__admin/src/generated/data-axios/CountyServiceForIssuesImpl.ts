...
import type { CountyServiceForIssues } from '../data-service';

/**
 * Relation Service Implementation for County.issues
 */
export class CountyServiceForIssuesImpl extends JudoAxiosService implements CountyServiceForIssues {
  /**
   * @throws {AxiosError} With data containing {@link Array<FeedbackItem>} for status codes: 401, 403.
   */
  async listIssues(
    owner: JudoIdentifiable<County>,
