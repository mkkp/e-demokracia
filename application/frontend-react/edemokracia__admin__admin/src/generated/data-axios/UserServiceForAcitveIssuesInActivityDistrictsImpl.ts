...
import type { UserServiceForAcitveIssuesInActivityDistricts } from '../data-service';

/**
 * Relation Service Implementation for User.acitveIssuesInActivityDistricts
 */
export class UserServiceForAcitveIssuesInActivityDistrictsImpl
  extends JudoAxiosService
  implements UserServiceForAcitveIssuesInActivityDistricts
{
  /**
   * @throws {AxiosError} With data containing {@link Array<FeedbackItem>} for status codes: 401, 403.
   */
  async listAcitveIssuesInActivityDistricts(
