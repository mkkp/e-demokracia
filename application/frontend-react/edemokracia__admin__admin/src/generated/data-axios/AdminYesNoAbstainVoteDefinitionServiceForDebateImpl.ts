...
import type { AdminYesNoAbstainVoteDefinitionServiceForDebate } from '../data-service';

/**
 * Relation Service Implementation for AdminYesNoAbstainVoteDefinition.debate
 */
export class AdminYesNoAbstainVoteDefinitionServiceForDebateImpl
  extends JudoAxiosService
  implements AdminYesNoAbstainVoteDefinitionServiceForDebate
{
  /**
   * @throws {AxiosError} With data containing {@link Array<FeedbackItem>} for status codes: 401, 403.
   */
  async getDebate(owner: JudoIdentifiable<AdminYesNoAbstainVoteDefinition>, mask?: string): Promise<AdminDebateStored> {
