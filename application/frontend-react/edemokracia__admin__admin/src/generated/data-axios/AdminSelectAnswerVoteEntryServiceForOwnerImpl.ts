...
import type { AdminSelectAnswerVoteEntryServiceForOwner } from '../data-service';

/**
 * Relation Service Implementation for AdminSelectAnswerVoteEntry.owner
 */
export class AdminSelectAnswerVoteEntryServiceForOwnerImpl
  extends JudoAxiosService
  implements AdminSelectAnswerVoteEntryServiceForOwner
{
  /**
   * @throws {AxiosError} With data containing {@link Array<FeedbackItem>} for status codes: 401, 403.
   */
  async getOwner(owner: JudoIdentifiable<AdminSelectAnswerVoteEntry>, mask?: string): Promise<AdminUserStored> {
