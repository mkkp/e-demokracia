...
import type { AdminUserIssuesServiceForActiveIssuesInActivityCounties } from '../data-service';

/**
 * Relation Service Implementation for AdminUserIssues.activeIssuesInActivityCounties
 */
export class AdminUserIssuesServiceForActiveIssuesInActivityCountiesImpl
  extends JudoAxiosService
  implements AdminUserIssuesServiceForActiveIssuesInActivityCounties
{
  /**
  ...
  async updateActiveIssuesInActivityCounties(
    ...
    const path = '/admin/UserIssues/~update/activeIssuesInActivityCounties/~update';
   ...
   * @throws {AxiosError} With data containing {@link Array<FeedbackItem>} for status codes: 400, 401, 403.
   */
  async addActiveIssuesInActivityCountiesCategories(
    owner: JudoIdentifiable<AdminUserIssues>,
    target: JudoIdentifiable<AdminIssue>,
    selected: Array<JudoIdentifiable<AdminIssueCategory>>,
  ): Promise<void> {
   ...
   * @throws {AxiosError} With data containing {@link Array<FeedbackItem>} for status codes: 400, 401, 403.
   */
  async removeActiveIssuesInActivityCountiesCategories(
    owner: JudoIdentifiable<AdminUserIssues>,
    target: JudoIdentifiable<AdminIssue>,
    selected: Array<JudoIdentifiable<AdminIssueCategory>>,
  ): Promise<void> {
