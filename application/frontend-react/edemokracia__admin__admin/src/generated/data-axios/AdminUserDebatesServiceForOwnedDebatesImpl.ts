...
import type { AdminUserDebatesServiceForOwnedDebates } from '../data-service';

/**
 * Relation Service Implementation for AdminUserDebates.ownedDebates
 */
export class AdminUserDebatesServiceForOwnedDebatesImpl
  extends JudoAxiosService
  implements AdminUserDebatesServiceForOwnedDebates
{
  /**
  ...
  async updateOwnedDebates(
    ...
    const path = '/admin/UserDebates/~update/ownedDebates/~update';
