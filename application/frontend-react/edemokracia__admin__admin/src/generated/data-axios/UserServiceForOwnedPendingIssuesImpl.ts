...
import type { UserServiceForOwnedPendingIssues } from '../data-service';

/**
 * Relation Service Implementation for User.ownedPendingIssues
 */
export class UserServiceForOwnedPendingIssuesImpl extends JudoAxiosService implements UserServiceForOwnedPendingIssues {
  /**
   * @throws {AxiosError} With data containing {@link Array<FeedbackItem>} for status codes: 401, 403.
   */
  async listOwnedPendingIssues(
