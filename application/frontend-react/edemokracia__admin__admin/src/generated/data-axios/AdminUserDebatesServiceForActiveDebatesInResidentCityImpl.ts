...
import type { AdminUserDebatesServiceForActiveDebatesInResidentCity } from '../data-service';

/**
 * Relation Service Implementation for AdminUserDebates.activeDebatesInResidentCity
 */
export class AdminUserDebatesServiceForActiveDebatesInResidentCityImpl
  extends JudoAxiosService
  implements AdminUserDebatesServiceForActiveDebatesInResidentCity
{
  /**
