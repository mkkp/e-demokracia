...
import type { AdminRatingVoteDefinitionServiceForIssue } from '../data-service';

/**
 * Relation Service Implementation for AdminRatingVoteDefinition.issue
 */
export class AdminRatingVoteDefinitionServiceForIssueImpl
  extends JudoAxiosService
  implements AdminRatingVoteDefinitionServiceForIssue
{
  /**
   * @throws {AxiosError} With data containing {@link Array<FeedbackItem>} for status codes: 401, 403.
   */
  async getIssue(owner: JudoIdentifiable<AdminRatingVoteDefinition>, mask?: string): Promise<AdminIssueStored> {
