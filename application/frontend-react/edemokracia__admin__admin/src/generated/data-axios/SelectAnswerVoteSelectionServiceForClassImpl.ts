...
import type { SelectAnswerVoteSelectionServiceForClass } from '../data-service';

/**
 * Class Service Implementation for SelectAnswerVoteSelection
 */
export class SelectAnswerVoteSelectionServiceForClassImpl
  extends JudoAxiosService
  implements SelectAnswerVoteSelectionServiceForClass
{
  /**
