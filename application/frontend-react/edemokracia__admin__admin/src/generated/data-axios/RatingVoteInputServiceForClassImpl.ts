...
import type { RatingVoteInputServiceForClass } from '../data-service';

/**
 * Class Service Implementation for RatingVoteInput
 */
export class RatingVoteInputServiceForClassImpl extends JudoAxiosService implements RatingVoteInputServiceForClass {
  /**
