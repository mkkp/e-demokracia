...
import type { AdminDistrict, AdminDistrictStored, AdminDistrictQueryCustomizer } from '../data-api';
import type { AdminDistrictServiceForClass } from '../data-service';

/**
 * Class Service Implementation for AdminDistrict
 */
export class AdminDistrictServiceForClassImpl extends JudoAxiosService implements AdminDistrictServiceForClass {
  /**
