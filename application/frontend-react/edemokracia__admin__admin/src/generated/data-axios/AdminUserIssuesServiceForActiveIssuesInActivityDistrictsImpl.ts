...
import type { AdminUserIssuesServiceForActiveIssuesInActivityDistricts } from '../data-service';

/**
 * Relation Service Implementation for AdminUserIssues.activeIssuesInActivityDistricts
 */
export class AdminUserIssuesServiceForActiveIssuesInActivityDistrictsImpl
  extends JudoAxiosService
  implements AdminUserIssuesServiceForActiveIssuesInActivityDistricts
{
  /**
  ...
  async updateActiveIssuesInActivityDistricts(
    ...
    const path = '/admin/UserIssues/~update/activeIssuesInActivityDistricts/~update';
   ...
   * @throws {AxiosError} With data containing {@link Array<FeedbackItem>} for status codes: 400, 401, 403.
   */
  async unsetOwner(owner: JudoIdentifiable<AdminUserIssues>, target: JudoIdentifiable<AdminIssue>): Promise<void> {
   ...
   * @throws {AxiosError} With data containing {@link Array<FeedbackItem>} for status codes: 400, 401, 403.
   */
  async addActiveIssuesInActivityDistrictsCategories(
    owner: JudoIdentifiable<AdminUserIssues>,
    target: JudoIdentifiable<AdminIssue>,
    selected: Array<JudoIdentifiable<AdminIssueCategory>>,
  ): Promise<void> {
   ...
   * @throws {AxiosError} With data containing {@link Array<FeedbackItem>} for status codes: 400, 401, 403.
   */
  async removeActiveIssuesInActivityDistrictsCategories(
    owner: JudoIdentifiable<AdminUserIssues>,
    target: JudoIdentifiable<AdminIssue>,
    selected: Array<JudoIdentifiable<AdminIssueCategory>>,
  ): Promise<void> {
   ...
   * @throws {AxiosError} With data containing {@link Array<FeedbackItem>} for status codes: 400, 401, 403.
   */
  async unsetIssueType(owner: JudoIdentifiable<AdminUserIssues>, target: JudoIdentifiable<AdminIssue>): Promise<void> {
   ...
   * @throws {AxiosError} With data containing {@link Array<FeedbackItem>} for status codes: 400, 401, 403.
   */
  async unsetCounty(owner: JudoIdentifiable<AdminUserIssues>, target: JudoIdentifiable<AdminIssue>): Promise<void> {
   ...
   * @throws {AxiosError} With data containing {@link Array<FeedbackItem>} for status codes: 400, 401, 403.
   */
  async unsetCity(owner: JudoIdentifiable<AdminUserIssues>, target: JudoIdentifiable<AdminIssue>): Promise<void> {
   ...
   * @throws {AxiosError} With data containing {@link Array<FeedbackItem>} for status codes: 400, 401, 403.
   */
  async unsetDistrict(owner: JudoIdentifiable<AdminUserIssues>, target: JudoIdentifiable<AdminIssue>): Promise<void> {
