...
import type { AdminYesNoAbstainVoteDefinitionServiceForIssue } from '../data-service';

/**
 * Relation Service Implementation for AdminYesNoAbstainVoteDefinition.issue
 */
export class AdminYesNoAbstainVoteDefinitionServiceForIssueImpl
  extends JudoAxiosService
  implements AdminYesNoAbstainVoteDefinitionServiceForIssue
{
  /**
   * @throws {AxiosError} With data containing {@link Array<FeedbackItem>} for status codes: 401, 403.
   */
  async getIssue(owner: JudoIdentifiable<AdminYesNoAbstainVoteDefinition>, mask?: string): Promise<AdminIssueStored> {
