...
import type { AdminUserDebatesServiceForActiveDebatesGlobal } from '../data-service';

/**
 * Relation Service Implementation for AdminUserDebates.activeDebatesGlobal
 */
export class AdminUserDebatesServiceForActiveDebatesGlobalImpl
  extends JudoAxiosService
  implements AdminUserDebatesServiceForActiveDebatesGlobal
{
  /**
  ...
  async updateActiveDebatesGlobal(
    ...
    const path = '/admin/UserDebates/~update/activeDebatesGlobal/~update';
