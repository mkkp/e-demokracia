...
import type { AdminUserIssuesServiceForOwnedIssues } from '../data-service';

/**
 * Relation Service Implementation for AdminUserIssues.ownedIssues
 */
export class AdminUserIssuesServiceForOwnedIssuesImpl
  extends JudoAxiosService
  implements AdminUserIssuesServiceForOwnedIssues
{
  /**
  ...
  async updateOwnedIssues(
    ...
    const path = '/admin/UserIssues/~update/ownedIssues/~update';
   ...
   * @throws {AxiosError} With data containing {@link Array<FeedbackItem>} for status codes: 400, 401, 403.
   */
  async addOwnedIssuesCategories(
    owner: JudoIdentifiable<AdminUserIssues>,
    target: JudoIdentifiable<AdminIssue>,
    selected: Array<JudoIdentifiable<AdminIssueCategory>>,
  ): Promise<void> {
   ...
   * @throws {AxiosError} With data containing {@link Array<FeedbackItem>} for status codes: 400, 401, 403.
   */
  async removeOwnedIssuesCategories(
    owner: JudoIdentifiable<AdminUserIssues>,
    target: JudoIdentifiable<AdminIssue>,
    selected: Array<JudoIdentifiable<AdminIssueCategory>>,
  ): Promise<void> {
