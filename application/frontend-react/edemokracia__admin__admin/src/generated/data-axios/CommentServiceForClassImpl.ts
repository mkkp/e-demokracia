...
import type { CommentServiceForClass } from '../data-service';

/**
 * Class Service Implementation for Comment
 */
export class CommentServiceForClassImpl extends JudoAxiosService implements CommentServiceForClass {
  /**
