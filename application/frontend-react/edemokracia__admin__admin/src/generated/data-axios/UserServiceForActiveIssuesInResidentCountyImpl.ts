...
import type { UserServiceForActiveIssuesInResidentCounty } from '../data-service';

/**
 * Relation Service Implementation for User.activeIssuesInResidentCounty
 */
export class UserServiceForActiveIssuesInResidentCountyImpl
  extends JudoAxiosService
  implements UserServiceForActiveIssuesInResidentCounty
{
  /**
