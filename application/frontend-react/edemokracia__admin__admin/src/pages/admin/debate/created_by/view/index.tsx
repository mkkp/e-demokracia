...
export type AdminDebateCreatedByViewPostRefreshAction = (
...
export const ADMIN_DEBATE_CREATED_BY_VIEW_POST_REFRESH_HOOK_INTERFACE_KEY = 'AdminDebateCreatedByViewPostRefreshHook';
export type AdminDebateCreatedByViewPostRefreshHook = () => AdminDebateCreatedByViewPostRefreshAction;
...
export default function AdminDebateCreatedByView() {
  ...
  const { service: postRefreshHook } = useTrackService<AdminDebateCreatedByViewPostRefreshHook>(
    `(${OBJECTCLASS}=${ADMIN_DEBATE_CREATED_BY_VIEW_POST_REFRESH_HOOK_INTERFACE_KEY})`,
  );
  const postRefreshAction: AdminDebateCreatedByViewPostRefreshAction | undefined = postRefreshHook && postRefreshHook();
