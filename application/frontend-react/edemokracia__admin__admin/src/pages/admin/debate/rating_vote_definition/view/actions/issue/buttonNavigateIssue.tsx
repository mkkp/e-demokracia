...
import { routeToAdminRatingVoteDefinitionIssueView } from '~/routes';
...
export const useButtonNavigateIssueAction: ButtonNavigateIssueAction = () => {
  ...
  return async function (owner: JudoIdentifiable<AdminRatingVoteDefinition>, target: JudoIdentifiable<AdminIssue>) {
    navigate(routeToAdminRatingVoteDefinitionIssueView(target.__signedIdentifier));
  };
};
