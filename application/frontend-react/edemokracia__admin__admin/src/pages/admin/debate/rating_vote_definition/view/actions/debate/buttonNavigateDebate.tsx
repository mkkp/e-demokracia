...
import { routeToAdminRatingVoteDefinitionDebateView } from '~/routes';
...
export const useButtonNavigateDebateAction: ButtonNavigateDebateAction = () => {
  ...
  return async function (owner: JudoIdentifiable<AdminRatingVoteDefinition>, target: JudoIdentifiable<AdminDebate>) {
    navigate(routeToAdminRatingVoteDefinitionDebateView(target.__signedIdentifier));
  };
};
