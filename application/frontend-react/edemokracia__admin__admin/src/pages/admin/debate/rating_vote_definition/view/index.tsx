          ...
          >
            <Grid item xs={12} sm={12}>
              <NumericInput
                required={false}
                name="minRateValue"
                id="NumericInputedemokraciaAdminAdminEdemokraciaAdminDebateRatingVoteDefinitionViewDefaultRatingVoteDefinitionViewEditMinRateValue"
                label={t('admin.RatingVoteDefinitionView.minRateValue', { defaultValue: 'MinRateValue' }) as string}
            ...
            <Grid item xs={12} sm={12}>
              <NumericInput
                required={false}
                name="maxRateValue"
                id="NumericInputedemokraciaAdminAdminEdemokraciaAdminDebateRatingVoteDefinitionViewDefaultRatingVoteDefinitionViewEditMaxRateValue"
                label={t('admin.RatingVoteDefinitionView.maxRateValue', { defaultValue: 'MaxRateValue' }) as string}
                customInput={TextField}
            ...
            <Grid item xs={12} sm={12}>
              <TextField
                required={true}
                name="title"
                id="TextInputedemokraciaAdminAdminEdemokraciaAdminDebateRatingVoteDefinitionViewDefaultRatingVoteDefinitionViewEditTitle"
            ...
            <Grid item xs={12} sm={12}>
              <DateTimePicker
                ...
                slotProps={{
                  textField: {
                    id: 'DateTimeInputedemokraciaAdminAdminEdemokraciaAdminDebateRatingVoteDefinitionViewDefaultRatingVoteDefinitionViewEditCreated',
                    required: true,
            ...
            <Grid item xs={12} sm={12}>
              <TextField
                required={true}
                name="description"
                id="TextInputedemokraciaAdminAdminEdemokraciaAdminDebateRatingVoteDefinitionViewDefaultRatingVoteDefinitionViewEditDescription"
                label={t('admin.RatingVoteDefinitionView.description', { defaultValue: 'Description' }) as string}
            ...
            <Grid item xs={12} sm={12}>
              <TextField
                required={true}
                name="status"
                id="EnumerationComboedemokraciaAdminAdminEdemokraciaAdminDebateRatingVoteDefinitionViewDefaultRatingVoteDefinitionViewEditStatus"
            ...
            <Grid item xs={12} sm={12}>
              <DateTimePicker
                ...
                slotProps={{
                  textField: {
                    id: 'DateTimeInputedemokraciaAdminAdminEdemokraciaAdminDebateRatingVoteDefinitionViewDefaultRatingVoteDefinitionViewEditCloseAt',
                    required: true,
