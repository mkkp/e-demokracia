...
import { routeToAdminYesNoAbstainVoteDefinitionDebateView } from '~/routes';
...
export const useButtonNavigateDebateAction: ButtonNavigateDebateAction = () => {
  ...
  return async function (
    ...
    navigate(routeToAdminYesNoAbstainVoteDefinitionDebateView(target.__signedIdentifier));
  };
};
