...
export default function AdminDebateYesNoAbstainVoteDefinitionView() {
  ...
  const queryCustomizer: AdminYesNoAbstainVoteDefinitionQueryCustomizer = {
    _mask: '{title,closeAt,status,created,description}',
  };
        ...
        <Box sx={mainContainerPadding}>
          ...
          >
            <Grid item xs={12} sm={12}>
              <Card id="FlexedemokraciaAdminAdminEdemokraciaAdminDebateYesNoAbstainVoteDefinitionViewDefaultYesNoAbstainVoteDefinitionViewEditGroup">
                <CardContent>
                  <Grid container direction="column" alignItems="stretch" justifyContent="flex-start" spacing={2}>
                    <Grid item xs={12} sm={12}>
                      <TextField
                        required={true}
                        name="title"
                        id="TextInputedemokraciaAdminAdminEdemokraciaAdminDebateYesNoAbstainVoteDefinitionViewDefaultYesNoAbstainVoteDefinitionViewEditGroupTitle"
                    ...
                    <Grid item xs={12} sm={12}>
                      <DateTimePicker
                        ...
                        slotProps={{
                          textField: {
                            id: 'DateTimeInputedemokraciaAdminAdminEdemokraciaAdminDebateYesNoAbstainVoteDefinitionViewDefaultYesNoAbstainVoteDefinitionViewEditGroupCloseAt',
                            required: true,
                        ...
                        label={t('admin.YesNoAbstainVoteDefinitionView.closeAt', { defaultValue: 'CloseAt' }) as string}
                    ...
                    <Grid item xs={12} sm={12}>
                      <TextField
                        required={true}
                        name="status"
                        id="EnumerationComboedemokraciaAdminAdminEdemokraciaAdminDebateYesNoAbstainVoteDefinitionViewDefaultYesNoAbstainVoteDefinitionViewEditGroupStatus"
                        label={t('admin.YesNoAbstainVoteDefinitionView.status', { defaultValue: 'Status' }) as string}
                        value={data.status || ''}
                        className={clsx({
                          'JUDO-viewMode': !editMode,
                          'JUDO-required': true,
                    ...
                    <Grid item xs={12} sm={12}>
                      ...
                      >
                        {t('admin.YesNoAbstainVoteDefinitionView.debate.ButtonNavigate', { defaultValue: 'Debate' })}
                    ...
                    <Grid item xs={12} sm={12}>
                      <DateTimePicker
                        ...
                        slotProps={{
                          textField: {
                            id: 'DateTimeInputedemokraciaAdminAdminEdemokraciaAdminDebateYesNoAbstainVoteDefinitionViewDefaultYesNoAbstainVoteDefinitionViewEditGroupCreated',
                            required: true,
                        ...
                        views={['year', 'month', 'day', 'hours', 'minutes', 'seconds']}
                        label={t('admin.YesNoAbstainVoteDefinitionView.created', { defaultValue: 'Created' }) as string}
                    ...
                    <Grid item xs={12} sm={12}>
                      <TextField
                        required={true}
                        name="description"
                        id="TextAreaedemokraciaAdminAdminEdemokraciaAdminDebateYesNoAbstainVoteDefinitionViewDefaultYesNoAbstainVoteDefinitionViewEditGroupDescription"
                        label={
