...
export type CreatedByLinkFilterInitializer = (ownerData: AdminConStored) => Filter[] | undefined;
...
export interface CreatedByLinkProps {
  ...
  validation: Map<keyof AdminConStored, string>;
...
export function CreatedByLink(props: CreatedByLinkProps) {
  ...
  return (
    <AggregationInput
      name="createdBy"
      id="LinkedemokraciaAdminAdminEdemokraciaAdminDebateConsViewDefaultConViewEditConLabelWrapperConCreatedBy"
      label={t('admin.ConView.createdBy', { defaultValue: 'Created by' }) as string}
