...
export type CreatedByLinkFilterInitializer = (ownerData: AdminCommentStored) => Filter[] | undefined;
...
export function CreatedByLink(props: CreatedByLinkProps) {
  ...
  return (
    <AggregationInput
      name="createdBy"
      id="LinkedemokraciaAdminAdminEdemokraciaAdminDebateCommentsViewDefaultCommentViewEditGroupLabelWrapperGroupCreatedBy"
