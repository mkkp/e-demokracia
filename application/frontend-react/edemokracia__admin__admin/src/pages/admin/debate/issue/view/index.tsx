...
export type AdminDebateIssueViewPostRefreshAction = (
...
export const ADMIN_DEBATE_ISSUE_VIEW_POST_REFRESH_HOOK_INTERFACE_KEY = 'AdminDebateIssueViewPostRefreshHook';
export type AdminDebateIssueViewPostRefreshHook = () => AdminDebateIssueViewPostRefreshAction;
...
export default function AdminDebateIssueView() {
  ...
  const { service: postRefreshHook } = useTrackService<AdminDebateIssueViewPostRefreshHook>(
    `(${OBJECTCLASS}=${ADMIN_DEBATE_ISSUE_VIEW_POST_REFRESH_HOOK_INTERFACE_KEY})`,
  );
  const postRefreshAction: AdminDebateIssueViewPostRefreshAction | undefined = postRefreshHook && postRefreshHook();
        ...
        <Box sx={mainContainerPadding}>
          ...
          >
            <Grid item xs={12} sm={12}>
              <Grid
                id="FlexedemokraciaAdminAdminEdemokraciaAdminDebateIssueViewDefaultIssueViewEditActions"
                container
                direction="row"
              ...
              >
                <Grid item xs={12}>
                  <Grid container spacing={2}>
                    <Grid item>
                      <LoadingButton
                        id="ButtonedemokraciaAdminAdminEdemokraciaAdminDebateIssueViewDefaultIssueViewEditActionsPageActionButtonsCreateDebate"
                        loading={isLoading}
                    ...
                    {!data.isFavorite && (
                      <Grid item>
                        <LoadingButton
                          id="ButtonedemokraciaAdminAdminEdemokraciaAdminDebateIssueViewDefaultIssueViewEditActionsPageActionButtonsAddToFavorites"
                          loading={isLoading}
                    ...
                    {!data.isNotFavorite && (
                      <Grid item>
                        <LoadingButton
                          id="ButtonedemokraciaAdminAdminEdemokraciaAdminDebateIssueViewDefaultIssueViewEditActionsPageActionButtonsRemoveFromFavorites"
                          loading={isLoading}
