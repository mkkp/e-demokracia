...
export const ADMIN_DEBATE_YES_NO_VOTE_DEFINITION_VIEW_VOTE_ENTRIES = 'AdminDebateYesNoVoteDefinitionViewVoteEntries';
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              <Button
                id="FilterRelationActionedemokraciaAdminAdminEdemokraciaAdminDebateYesNoVoteDefinitionViewEdemokraciaAdminAdminEdemokraciaAdminYesNoVoteDefinitionVoteEntriesTableAction"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() => {
                  tableActionVoteEntriesAction(
                    'FilterRelationActionedemokraciaAdminAdminEdemokraciaAdminDebateYesNoVoteDefinitionViewEdemokraciaAdminAdminEdemokraciaAdminYesNoVoteDefinitionVoteEntriesTableAction-filter',
                    filterOptions,
                    filters,
                  );
                }}
