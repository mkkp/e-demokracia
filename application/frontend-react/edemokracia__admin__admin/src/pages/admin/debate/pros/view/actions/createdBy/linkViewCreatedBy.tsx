...
import AdminAdminView from '~/pages/admin/pro/created_by/view/index';
...
export const useLinkViewCreatedByAction: LinkViewCreatedByAction = () => {
  ...
  return async function (owner: JudoIdentifiable<AdminPro>, entry: AdminUserStored, successCallback: () => void) {
    createDialog({
      fullWidth: true,
      maxWidth: 'lg',
