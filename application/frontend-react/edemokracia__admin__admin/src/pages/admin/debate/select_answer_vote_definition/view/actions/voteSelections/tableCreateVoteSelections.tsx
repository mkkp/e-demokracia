...
export type TableCreateVoteSelectionsAction = () => (
  owner: JudoIdentifiable<AdminSelectAnswerVoteSelection>,
  successCallback: (result: AdminSelectAnswerVoteSelectionStored) => void,
  closedCallback?: () => void,
) => void;
    ...
    createDialog({
      ...
      children: (
        <TableCreateVoteSelectionsForm
          successCallback={(result: AdminSelectAnswerVoteSelectionStored, open?: boolean) => {
            if (!open) {
              closeDialog();
