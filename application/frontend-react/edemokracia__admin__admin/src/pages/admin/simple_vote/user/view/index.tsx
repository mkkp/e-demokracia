...
import { adminSimpleVoteServiceForClassImpl, adminUserServiceForClassImpl } from '~/generated/data-axios';
...
export type AdminSimpleVoteUserViewPostRefreshAction = (
...
export const ADMIN_SIMPLE_VOTE_USER_VIEW_POST_REFRESH_HOOK_INTERFACE_KEY = 'AdminSimpleVoteUserViewPostRefreshHook';
export type AdminSimpleVoteUserViewPostRefreshHook = () => AdminSimpleVoteUserViewPostRefreshAction;
...
export default function AdminSimpleVoteUserView() {
  ...
  const { service: postRefreshHook } = useTrackService<AdminSimpleVoteUserViewPostRefreshHook>(
    `(${OBJECTCLASS}=${ADMIN_SIMPLE_VOTE_USER_VIEW_POST_REFRESH_HOOK_INTERFACE_KEY})`,
  );
  const postRefreshAction: AdminSimpleVoteUserViewPostRefreshAction | undefined = postRefreshHook && postRefreshHook();
