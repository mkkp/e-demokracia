...
export const ADMIN_SIMPLE_VOTE_USER_VIEW_ACTIVITY_DISTRICTS = 'AdminSimpleVoteUserViewActivityDistricts';
...
export const ActivityDistrictsTable = (props: ActivityDistrictsTableProps) => {
  ...
  const activityDistrictsRowActions: TableRowAction<AdminDistrictStored>[] = [
    {
      id: 'RemoveActionedemokraciaAdminAdminEdemokraciaAdminSimpleVoteUserViewEdemokraciaAdminAdminEdemokraciaAdminUserActivityDistrictsRowRemove',
