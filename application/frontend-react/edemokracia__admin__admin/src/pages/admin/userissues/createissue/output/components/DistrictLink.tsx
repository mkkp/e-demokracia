...
export function DistrictLink(props: DistrictLinkProps) {
  ...
  const districtRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminUserIssuesCreateIssueOutputDefaultIssueViewEditOtherAreaAreaDistrictRepresentationFilter',
  ...
  return (
    <AggregationInput
      name="district"
      id="LinkedemokraciaAdminAdminEdemokraciaAdminUserIssuesCreateIssueOutputDefaultIssueViewEditOtherAreaAreaDistrict"
