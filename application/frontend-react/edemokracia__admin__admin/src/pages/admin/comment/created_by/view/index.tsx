...
export type AdminCommentCreatedByViewPostRefreshAction = (
...
export const ADMIN_COMMENT_CREATED_BY_VIEW_POST_REFRESH_HOOK_INTERFACE_KEY = 'AdminCommentCreatedByViewPostRefreshHook';
export type AdminCommentCreatedByViewPostRefreshHook = () => AdminCommentCreatedByViewPostRefreshAction;
...
export default function AdminCommentCreatedByView() {
  ...
  const { service: postRefreshHook } = useTrackService<AdminCommentCreatedByViewPostRefreshHook>(
    `(${OBJECTCLASS}=${ADMIN_COMMENT_CREATED_BY_VIEW_POST_REFRESH_HOOK_INTERFACE_KEY})`,
  );
  const postRefreshAction: AdminCommentCreatedByViewPostRefreshAction | undefined =
