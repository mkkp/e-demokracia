      ...
      <DialogContent dividers>
        <Grid container spacing={2} direction="column" alignItems="stretch" justifyContent="flex-start">
          <Grid item xs={12} sm={12}>
            <Grid
              id="FlexedemokraciaAdminAdminEdemokraciaAdminCommentVotesCreateDefaultSimpleVoteFormGroup"
              container
              direction="row"
            ...
            >
              <Grid item xs={12} sm={12} md={4.0}>
                <DateTimePicker
                  ...
                  slotProps={{
                    textField: {
                      id: 'DateTimeInputedemokraciaAdminAdminEdemokraciaAdminCommentVotesCreateDefaultSimpleVoteFormGroupCreated',
                      required: true,
              ...
              <Grid item xs={12} sm={12} md={4.0}>
                <TextField
                  required={true}
                  name="type"
                  id="EnumerationComboedemokraciaAdminAdminEdemokraciaAdminCommentVotesCreateDefaultSimpleVoteFormGroupType"
          ...
          <Grid item xs={12} sm={12}>
            <Grid
              id="FlexedemokraciaAdminAdminEdemokraciaAdminCommentVotesCreateDefaultSimpleVoteFormGroup2"
              container
              direction="row"
              alignItems="flex-start"
              justifyContent="flex-start"
