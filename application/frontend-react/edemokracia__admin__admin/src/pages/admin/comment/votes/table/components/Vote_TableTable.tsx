...
export const Vote_TableTable = forwardRef<RefreshableTable, Vote_TableTableProps>((props, ref) => {
  ...
  async function fetchData() {
    ...
    try {
      const res = await adminCommentServiceImpl.getVotes(ownerData, processQueryCustomizer(queryCustomizer));
  ...
  return (
    <DataGrid
      ...
      columns={[
        ...votesColumns,
        ...columnsActionCalculator('RelationTypeedemokraciaAdminAdminEdemokraciaAdminCommentVotes', rowActions, {
          shownActions: 2,
        }),
      ]}
