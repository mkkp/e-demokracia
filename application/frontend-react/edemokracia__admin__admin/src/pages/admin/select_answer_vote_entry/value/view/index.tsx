...
// Page name: edemokracia::admin::SelectAnswerVoteEntry.value#View
...
/**
 * Name: edemokracia::admin::SelectAnswerVoteEntry.value#View
 * Is Access: false
 * Type: View
        ...
        <Grid container spacing={2} direction="column" alignItems="stretch" justifyContent="flex-start">
          <Grid item xs={12} sm={12}>
            <TextField
              required={true}
              name="title"
              id="TextInputedemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteEntryValueViewDefaultSelectAnswerVoteSelectionViewEditTitle"
          ...
          <Grid item xs={12} sm={12}>
            <TextField
              required={false}
              name="description"
              id="TextAreaedemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteEntryValueViewDefaultSelectAnswerVoteSelectionViewEditDescription"
