...
export type AdminIssueCategorySubcategoriesViewPostRefreshAction = (
...
export const ADMIN_ISSUE_CATEGORY_SUBCATEGORIES_VIEW_POST_REFRESH_HOOK_INTERFACE_KEY =
  'AdminIssueCategorySubcategoriesViewPostRefreshHook';
export type AdminIssueCategorySubcategoriesViewPostRefreshHook =
  () => AdminIssueCategorySubcategoriesViewPostRefreshAction;
...
export default function AdminIssueCategorySubcategoriesView() {
  ...
  const { service: postRefreshHook } = useTrackService<AdminIssueCategorySubcategoriesViewPostRefreshHook>(
    `(${OBJECTCLASS}=${ADMIN_ISSUE_CATEGORY_SUBCATEGORIES_VIEW_POST_REFRESH_HOOK_INTERFACE_KEY})`,
  );
  const postRefreshAction: AdminIssueCategorySubcategoriesViewPostRefreshAction | undefined =
  ...
  async function submit() {
    ...
    try {
      const res = await adminIssueCategoryServiceForClassImpl.update(payloadDiff);
  ...
  async function deleteData() {
    ...
    try {
      await adminIssueCategoryServiceForClassImpl.delete(data);
          ...
          >
            <Grid item xs={12} sm={12}>
              <TextField
                required={true}
                name="title"
                id="TextInputedemokraciaAdminAdminEdemokraciaAdminIssueCategorySubcategoriesViewDefaultIssueCategoryViewEditTitle"
            ...
            <Grid item xs={12} sm={12}>
              <TextField
                required={true}
                name="description"
                id="TextInputedemokraciaAdminAdminEdemokraciaAdminIssueCategorySubcategoriesViewDefaultIssueCategoryViewEditDescription"
            ...
            <Grid item xs={12} sm={12}>
              <Grid
                id="FlexedemokraciaAdminAdminEdemokraciaAdminIssueCategorySubcategoriesViewDefaultIssueCategoryViewEditSubcategoriesLabelWrapper"
                container
                direction="column"
                alignItems="stretch"
                justifyContent="flex-start"
              ...
              >
                <Grid item xs={12} sm={12}>
                  <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                    ...
                    <Typography
                      id="LabeledemokraciaAdminAdminEdemokraciaAdminIssueCategorySubcategoriesViewDefaultIssueCategoryViewEditSubcategoriesLabelWrapperSubcategoriesLabel"
                      variant="h5"
                      component="h1"
                    >
                ...
                <Grid item xs={12} sm={12}>
                  <Grid
                    id="TableedemokraciaAdminAdminEdemokraciaAdminIssueCategorySubcategoriesViewDefaultIssueCategoryViewEditSubcategoriesLabelWrapperSubcategories"
                    container
                    direction="column"
                    alignItems="stretch"
                    justifyContent="flex-start"
