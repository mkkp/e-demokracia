...
// Page name: edemokracia::admin::Dashboard.ownedDebates#Table
...
/**
 * Name: edemokracia::admin::Dashboard.ownedDebates#Table
 * Is Access: false
 * Type: Table
 **/
export default function AdminDashboardOwnedDebatesTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaAdminAdminEdemokraciaAdminDashboardOwnedDebatesTable-data-grid">
                  <Debate_TableTable
                    ref={tableRef}
