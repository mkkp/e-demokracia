...
export const ADMIN_DASHBOARD_OWNED_DEBATES_TABLE_DEBATE_TABLE = 'AdminDashboardOwnedDebatesTableDebate_Table';
...
export const Debate_TableTable = forwardRef<RefreshableTable, Debate_TableTableProps>((props, ref) => {
  ...
  const filterModelKey = `TableedemokraciaAdminAdminEdemokraciaAdminDashboardOwnedDebatesTableDefaultOwnedDebatesDebateTable-${__identifier}-filterModel`;
  const filtersKey = `TableedemokraciaAdminAdminEdemokraciaAdminDashboardOwnedDebatesTableDefaultOwnedDebatesDebateTable-${__identifier}-filters`;
  ...
  useEffect(() => {
    setFilters(
      getItemParsedWithDefault(
        `TableedemokraciaAdminAdminEdemokraciaAdminDashboardOwnedDebatesTableDefaultOwnedDebatesDebateTable-${__identifier}-filters`,
        [...filters],
      ),
    );
  }, [ownerData]);
  ...
  const ownedDebatesRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminDashboardOwnedDebatesTableDefaultOwnedDebatesDebateTableIssueTitleFilter',
    ...
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminDashboardOwnedDebatesTableDefaultOwnedDebatesDebateTableTitleFilter',
      attributeName: 'title',
    ...
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminDashboardOwnedDebatesTableDefaultOwnedDebatesDebateTableStatusFilter',
    ...
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminDashboardOwnedDebatesTableDefaultOwnedDebatesDebateTableCloseAtFilter',
    ...
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminDashboardOwnedDebatesTableDefaultOwnedDebatesDebateTableDescriptionFilter',
  ...
  const rowActions: TableRowAction<AdminDebateStored>[] = [
    {
      id: 'DeleteActionedemokraciaAdminAdminEdemokraciaAdminDashboardOwnedDebatesTableEdemokraciaAdminAdminEdemokraciaAdminDashboardOwnedDebatesRowDelete',
      label: t('judo.pages.table.delete', { defaultValue: 'Delete' }) as string,
      icon: <MdiIcon path="delete_forever" />,
      action: async (row: AdminDebateStored) => rowDeleteOwnedDebatesAction(ownerData, row, () => fetchData()),
      disabled: (row: AdminDebateStored) => !row.__deleteable,
    },
    {
      id: 'CallOperationActionedemokraciaAdminAdminEdemokraciaAdminDashboardOwnedDebatesTableEdemokraciaAdminAdminEdemokraciaAdminDebateCloseDebateButtonCallOperation',
    ...
    {
      id: 'CallOperationActionedemokraciaAdminAdminEdemokraciaAdminDashboardOwnedDebatesTableEdemokraciaAdminAdminEdemokraciaAdminDebateAddToFavoritesButtonCallOperation',
    ...
    {
      id: 'CallOperationActionedemokraciaAdminAdminEdemokraciaAdminDashboardOwnedDebatesTableEdemokraciaAdminAdminEdemokraciaAdminDebateRemoveFromFavoritesButtonCallOperation',
    ...
    {
      id: 'CallOperationActionedemokraciaAdminAdminEdemokraciaAdminDashboardOwnedDebatesTableEdemokraciaAdminAdminEdemokraciaAdminDebateCreateArgumentButtonCallOperation',
    ...
    {
      id: 'CallOperationActionedemokraciaAdminAdminEdemokraciaAdminDashboardOwnedDebatesTableEdemokraciaAdminAdminEdemokraciaAdminDebateCreateCommentButtonCallOperation',
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              <Button
                id="FilterActionedemokraciaAdminAdminEdemokraciaAdminDashboardOwnedDebatesTableEdemokraciaAdminAdminEdemokraciaAdminDashboardOwnedDebatesPageFilter"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() => {
                  pageFilterOwnedDebatesAction(
                    'FilterActionedemokraciaAdminAdminEdemokraciaAdminDashboardOwnedDebatesTableEdemokraciaAdminAdminEdemokraciaAdminDashboardOwnedDebatesPageFilter-filter',
                    filterOptions,
                    filters,
                  );
                }}
