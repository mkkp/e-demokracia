...
export type PageFilterOwnedDebatesAction = (
  id: string,
  filterOptions: FilterOption[],
  filters: Filter[],
) => Promise<void>;

export const usePageFilterOwnedDebatesAction = (
  ...
  return async function pageFilterOwnedDebatesAction(id: string, filterOptions: FilterOption[], filters: Filter[]) {
