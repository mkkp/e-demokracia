...
// Page name: edemokracia::admin::Dashboard.voteEntries#Table
...
/**
 * Name: edemokracia::admin::Dashboard.voteEntries#Table
 * Is Access: false
 * Type: Table
 **/
export default function AdminDashboardVoteEntriesTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaAdminAdminEdemokraciaAdminDashboardVoteEntriesTable-data-grid">
