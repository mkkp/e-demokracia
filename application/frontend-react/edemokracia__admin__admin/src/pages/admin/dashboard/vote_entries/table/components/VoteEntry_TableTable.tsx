...
export const ADMIN_DASHBOARD_VOTE_ENTRIES_TABLE_VOTE_ENTRY_TABLE = 'AdminDashboardVoteEntriesTableVoteEntry_Table';
...
export const VoteEntry_TableTable = forwardRef<RefreshableTable, VoteEntry_TableTableProps>((props, ref) => {
  ...
  const filterModelKey = `TableedemokraciaAdminAdminEdemokraciaAdminDashboardVoteEntriesTableDefaultVoteEntriesVoteEntryTable-${__identifier}-filterModel`;
  const filtersKey = `TableedemokraciaAdminAdminEdemokraciaAdminDashboardVoteEntriesTableDefaultVoteEntriesVoteEntryTable-${__identifier}-filters`;
  ...
  useEffect(() => {
    setFilters(
      getItemParsedWithDefault(
        `TableedemokraciaAdminAdminEdemokraciaAdminDashboardVoteEntriesTableDefaultVoteEntriesVoteEntryTable-${__identifier}-filters`,
        [...filters],
      ),
    );
  }, [ownerData]);
  ...
  const voteEntriesRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminDashboardVoteEntriesTableDefaultVoteEntriesVoteEntryTableUserNameFilter',
    ...
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminDashboardVoteEntriesTableDefaultVoteEntriesVoteEntryTableCreatedFilter',
    ...
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminDashboardVoteEntriesTableDefaultVoteEntriesVoteEntryTableVoteTitleFilter',
    ...
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminDashboardVoteEntriesTableDefaultVoteEntriesVoteEntryTableDebateTitleFilter',
    ...
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminDashboardVoteEntriesTableDefaultVoteEntriesVoteEntryTableIssueTitleFilter',
    ...
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminDashboardVoteEntriesTableDefaultVoteEntriesVoteEntryTableVoteStatusFilter',
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              <Button
                id="FilterActionedemokraciaAdminAdminEdemokraciaAdminDashboardVoteEntriesTableEdemokraciaAdminAdminEdemokraciaAdminDashboardVoteEntriesPageFilter"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() => {
                  pageFilterVoteEntriesAction(
                    'FilterActionedemokraciaAdminAdminEdemokraciaAdminDashboardVoteEntriesTableEdemokraciaAdminAdminEdemokraciaAdminDashboardVoteEntriesPageFilter-filter',
                    filterOptions,
                    filters,
                  );
                }}
