...
// Page name: edemokracia::admin::Dashboard.ownedVoteDefinitions#Table
...
/**
 * Name: edemokracia::admin::Dashboard.ownedVoteDefinitions#Table
 * Is Access: false
 * Type: Table
 **/
export default function AdminDashboardOwnedVoteDefinitionsTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaAdminAdminEdemokraciaAdminDashboardOwnedVoteDefinitionsTable-data-grid">
