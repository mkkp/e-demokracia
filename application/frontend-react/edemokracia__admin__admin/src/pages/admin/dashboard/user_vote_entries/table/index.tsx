...
// Page name: edemokracia::admin::Dashboard.userVoteEntries#Table
...
/**
 * Name: edemokracia::admin::Dashboard.userVoteEntries#Table
 * Is Access: false
 * Type: Table
 **/
export default function AdminDashboardUserVoteEntriesTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaAdminAdminEdemokraciaAdminDashboardUserVoteEntriesTable-data-grid">
