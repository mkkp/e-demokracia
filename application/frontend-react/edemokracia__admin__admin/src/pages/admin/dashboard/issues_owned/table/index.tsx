...
// Page name: edemokracia::admin::Dashboard.issuesOwned#Table
...
/**
 * Name: edemokracia::admin::Dashboard.issuesOwned#Table
 * Is Access: false
 * Type: Table
 **/
export default function AdminDashboardIssuesOwnedTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaAdminAdminEdemokraciaAdminDashboardIssuesOwnedTable-data-grid">
                  <Issue_TableTable
                    ref={tableRef}
