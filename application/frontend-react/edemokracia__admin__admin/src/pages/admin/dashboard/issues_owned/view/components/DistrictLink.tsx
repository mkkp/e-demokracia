...
export function DistrictLink(props: DistrictLinkProps) {
  ...
  const districtRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminDashboardIssuesOwnedViewDefaultIssueViewEditOtherAreaAreaDistrictRepresentationFilter',
  ...
  return (
    <AggregationInput
      name="district"
      id="LinkedemokraciaAdminAdminEdemokraciaAdminDashboardIssuesOwnedViewDefaultIssueViewEditOtherAreaAreaDistrict"
