              ...
              >
                <Grid item xs={12}>
                  <Grid container spacing={2}>
                    <Grid item>
                      <LoadingButton
                        id="ButtonedemokraciaAdminAdminEdemokraciaAdminDashboardFavoriteIssuesViewDefaultIssueViewEditActionsActionGroupCreateDebate"
                        loading={isLoading}
                    ...
                    {!data.isFavorite && (
                      <Grid item>
                        <LoadingButton
                          id="ButtonedemokraciaAdminAdminEdemokraciaAdminDashboardFavoriteIssuesViewDefaultIssueViewEditActionsActionGroupAddToFavorites"
                          loading={isLoading}
                    ...
                    {!data.isNotFavorite && (
                      <Grid item>
                        <LoadingButton
                          id="ButtonedemokraciaAdminAdminEdemokraciaAdminDashboardFavoriteIssuesViewDefaultIssueViewEditActionsActionGroupRemoveFromFavorites"
                          loading={isLoading}
