...
// Page name: edemokracia::admin::Dashboard.favoriteIssues#Table
...
/**
 * Name: edemokracia::admin::Dashboard.favoriteIssues#Table
 * Is Access: false
 * Type: Table
 **/
export default function AdminDashboardFavoriteIssuesTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaAdminAdminEdemokraciaAdminDashboardFavoriteIssuesTable-data-grid">
                  <Issue_TableTable
                    ref={tableRef}
