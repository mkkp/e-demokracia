...
import { usePageRefreshFavoriteVoteDefinitionsAction, usePageFilterFavoriteVoteDefinitionsAction } from '../actions';
    ...
    <>
      <Grid className="page-action" item>
        <LoadingButton
          ...
          onClick={() => pageRefreshFavoriteVoteDefinitionsAction(() => fetchData())}
          disabled={isLoading}
        >
