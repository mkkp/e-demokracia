...
// Page name: edemokracia::admin::Dashboard.favoriteVoteDefinitions#Table
...
/**
 * Name: edemokracia::admin::Dashboard.favoriteVoteDefinitions#Table
 * Is Access: false
 * Type: Table
 **/
export default function AdminDashboardFavoriteVoteDefinitionsTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaAdminAdminEdemokraciaAdminDashboardFavoriteVoteDefinitionsTable-data-grid">
