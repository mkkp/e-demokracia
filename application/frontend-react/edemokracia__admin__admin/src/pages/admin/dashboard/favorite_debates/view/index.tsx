              ...
              >
                <Grid item xs={12}>
                  <Grid container spacing={2}>
                    <Grid item>
                      <LoadingButton
                        id="ButtonedemokraciaAdminAdminEdemokraciaAdminDashboardFavoriteDebatesViewDefaultDebateViewEditActionsActionButtonBarCloseDebate"
                        loading={isLoading}
                    ...
                    {!data.isNotFavorite && (
                      <Grid item>
                        <LoadingButton
                          id="ButtonedemokraciaAdminAdminEdemokraciaAdminDashboardFavoriteDebatesViewDefaultDebateViewEditActionsActionButtonBarAddToFavorites"
                          loading={isLoading}
                    ...
                    {!data.isFavorite && (
                      <Grid item>
                        <LoadingButton
                          id="ButtonedemokraciaAdminAdminEdemokraciaAdminDashboardFavoriteDebatesViewDefaultDebateViewEditActionsActionButtonBarRemoveFromFavorites"
                          loading={isLoading}
