...
// Page name: edemokracia::admin::UserDebates.ownedDebates#View
...
export type AdminUserDebatesOwnedDebatesViewPostRefreshAction = (
...
export const ADMIN_USER_DEBATES_OWNED_DEBATES_VIEW_POST_REFRESH_HOOK_INTERFACE_KEY =
  'AdminUserDebatesOwnedDebatesViewPostRefreshHook';
export type AdminUserDebatesOwnedDebatesViewPostRefreshHook = () => AdminUserDebatesOwnedDebatesViewPostRefreshAction;

/**
 * Name: edemokracia::admin::UserDebates.ownedDebates#View
 * Is Access: false
 * Type: View
 * Edit Mode Available: true
 **/
export default function AdminUserDebatesOwnedDebatesView() {
  ...
  const handleUpdateError = useErrorHandler<AdminDebate>(
    `(&(${OBJECTCLASS}=${ERROR_PROCESSOR_HOOK_INTERFACE_KEY})(operation=Update)(component=AdminUserDebatesOwnedDebatesView))`,
  );
  ...
  const { service: postRefreshHook } = useTrackService<AdminUserDebatesOwnedDebatesViewPostRefreshHook>(
    `(${OBJECTCLASS}=${ADMIN_USER_DEBATES_OWNED_DEBATES_VIEW_POST_REFRESH_HOOK_INTERFACE_KEY})`,
  );
  const postRefreshAction: AdminUserDebatesOwnedDebatesViewPostRefreshAction | undefined =
        ...
        <Box sx={mainContainerPadding}>
          ...
          >
            <Grid item xs={12} sm={12}>
              <Grid
                id="FlexedemokraciaAdminAdminEdemokraciaAdminUserDebatesOwnedDebatesViewDefaultDebateViewEditActions"
                container
                direction="row"
              ...
              >
                <Grid item xs={12}>
                  <Grid container spacing={2}>
                    <Grid item>
                      <LoadingButton
                        id="ButtonedemokraciaAdminAdminEdemokraciaAdminUserDebatesOwnedDebatesViewDefaultDebateViewEditActionsPageActionButtonsCloseDebate"
                        loading={isLoading}
                    ...
                    {!data.isFavorite && (
                      <Grid item>
                        <LoadingButton
                          id="ButtonedemokraciaAdminAdminEdemokraciaAdminUserDebatesOwnedDebatesViewDefaultDebateViewEditActionsPageActionButtonsAddToFavorites"
                          loading={isLoading}
                    ...
                    {!data.isNotFavorite && (
                      <Grid item>
                        <LoadingButton
                          id="ButtonedemokraciaAdminAdminEdemokraciaAdminUserDebatesOwnedDebatesViewDefaultDebateViewEditActionsPageActionButtonsRemoveFromFavorites"
                          loading={isLoading}
            ...
            <Grid item xs={12} sm={12}>
              <Card id="FlexedemokraciaAdminAdminEdemokraciaAdminUserDebatesOwnedDebatesViewDefaultDebateViewEditDebateLabelWrapper">
                <CardContent>
                  <Grid container direction="column" alignItems="stretch" justifyContent="flex-start" spacing={2}>
                    <Grid item xs={12} sm={12}>
                      <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                        ...
                        <Typography
                          id="LabeledemokraciaAdminAdminEdemokraciaAdminUserDebatesOwnedDebatesViewDefaultDebateViewEditDebateLabelWrapperDebateLabel"
                          variant="h5"
                          component="h1"
                        >
                    ...
                    <Grid item xs={12} sm={12}>
                      <Grid
                        id="FlexedemokraciaAdminAdminEdemokraciaAdminUserDebatesOwnedDebatesViewDefaultDebateViewEditDebateLabelWrapperDebate"
                        container
                        direction="row"
                        alignItems="stretch"
                        justifyContent="flex-start"
                      ...
                      >
                        <Grid item xs={12} sm={12} md={8.0}>
                          <TextField
                            required={true}
                            name="title"
                            id="TextInputedemokraciaAdminAdminEdemokraciaAdminUserDebatesOwnedDebatesViewDefaultDebateViewEditDebateLabelWrapperDebateTitle"
                        ...
                        <Grid item xs={12} sm={12} md={2.0}>
                          <TextField
                            required={true}
                            name="status"
                            id="EnumerationComboedemokraciaAdminAdminEdemokraciaAdminUserDebatesOwnedDebatesViewDefaultDebateViewEditDebateLabelWrapperDebateStatus"
                        ...
                        <Grid item xs={12} sm={12} md={2.0}>
                          <DateTimePicker
                            ...
                            slotProps={{
                              textField: {
                                id: 'DateTimeInputedemokraciaAdminAdminEdemokraciaAdminUserDebatesOwnedDebatesViewDefaultDebateViewEditDebateLabelWrapperDebateCloseAt',
                                required: true,
                        ...
                        <Grid item xs={12} sm={12}>
                          <TextField
                            required={true}
                            name="description"
                            id="TextAreaedemokraciaAdminAdminEdemokraciaAdminUserDebatesOwnedDebatesViewDefaultDebateViewEditDebateLabelWrapperDebateDescription"
            ...
            <Grid container item xs={12} sm={12}>
              <ModeledTabs
                id="TabControlleredemokraciaAdminAdminEdemokraciaAdminUserDebatesOwnedDebatesViewDefaultDebateViewEditTabBar"
                ownerData={data}
                validation={validation}
                orientation='horizontal'
                childTabs={[
                  {
                    id: 'TabedemokraciaAdminAdminEdemokraciaAdminUserDebatesOwnedDebatesViewDefaultDebateViewEditTabBarArguments',
                  ...
                  {
                    id: 'TabedemokraciaAdminAdminEdemokraciaAdminUserDebatesOwnedDebatesViewDefaultDebateViewEditTabBarComments',
              ...
              >
                <Grid item xs={12} sm={12}>
                  <Grid
                    id="FlexedemokraciaAdminAdminEdemokraciaAdminUserDebatesOwnedDebatesViewDefaultDebateViewEditTabBarArgumentsArguments"
                    container
                    direction="row"
                    alignItems="flex-start"
                    justifyContent="flex-start"
                  ...
                  >
                    <Grid item xs={12} sm={12}>
                      <Grid
                        id="FlexedemokraciaAdminAdminEdemokraciaAdminUserDebatesOwnedDebatesViewDefaultDebateViewEditTabBarArgumentsArgumentsActions"
                        container
                        direction="row"
                        alignItems="flex-start"
                        justifyContent="flex-start"
                      ...
                      >
                        <Grid item xs={12} sm={12} md={4.0}>
                          <LoadingButton
                            id="CallOperationActionedemokraciaAdminAdminEdemokraciaAdminUserDebatesOwnedDebatesViewEdemokraciaAdminAdminEdemokraciaAdminDebateCreateArgumentButtonCallOperation"
                            loading={isLoading}
                            variant={undefined}
                    ...
                    <Grid item xs={12} sm={12} md={6.0}>
                      <Grid
                        id="FlexedemokraciaAdminAdminEdemokraciaAdminUserDebatesOwnedDebatesViewDefaultDebateViewEditTabBarArgumentsArgumentsProsLabelWrapper"
                        container
                        direction="column"
                        alignItems="stretch"
                        justifyContent="flex-start"
                      ...
                      >
                        <Grid item xs={12} sm={12}>
                          <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                            ...
                            <Typography
                              id="LabeledemokraciaAdminAdminEdemokraciaAdminUserDebatesOwnedDebatesViewDefaultDebateViewEditTabBarArgumentsArgumentsProsLabelWrapperProsLabel"
                              variant="h5"
                              component="h1"
                            >
                        ...
                        <Grid item xs={12} sm={12}>
                          <Grid
                            id="TableedemokraciaAdminAdminEdemokraciaAdminUserDebatesOwnedDebatesViewDefaultDebateViewEditTabBarArgumentsArgumentsProsLabelWrapperPros"
                            container
                            direction="column"
                            alignItems="stretch"
                            justifyContent="flex-start"
                    ...
                    <Grid item xs={12} sm={12} md={6.0}>
                      <Grid
                        id="FlexedemokraciaAdminAdminEdemokraciaAdminUserDebatesOwnedDebatesViewDefaultDebateViewEditTabBarArgumentsArgumentsConsLabelWrapper"
                        container
                        direction="column"
                        alignItems="stretch"
                        justifyContent="flex-start"
                      ...
                      >
                        <Grid item xs={12} sm={12}>
                          <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                            ...
                            <Typography
                              id="LabeledemokraciaAdminAdminEdemokraciaAdminUserDebatesOwnedDebatesViewDefaultDebateViewEditTabBarArgumentsArgumentsConsLabelWrapperConsLabel"
                              variant="h5"
                              component="h1"
                            >
                        ...
                        <Grid item xs={12} sm={12}>
                          <Grid
                            id="TableedemokraciaAdminAdminEdemokraciaAdminUserDebatesOwnedDebatesViewDefaultDebateViewEditTabBarArgumentsArgumentsConsLabelWrapperCons"
                            container
                            direction="column"
                            alignItems="stretch"
                            justifyContent="flex-start"
                ...
                <Grid item xs={12} sm={12}>
                  <Grid
                    id="FlexedemokraciaAdminAdminEdemokraciaAdminUserDebatesOwnedDebatesViewDefaultDebateViewEditTabBarCommentsComments"
                    container
                    direction="row"
                    alignItems="flex-start"
                    justifyContent="flex-start"
                  ...
                  >
                    <Grid item xs={12} sm={12}>
                      <Grid
                        id="FlexedemokraciaAdminAdminEdemokraciaAdminUserDebatesOwnedDebatesViewDefaultDebateViewEditTabBarCommentsCommentsActions"
                        container
                        direction="row"
                        alignItems="flex-start"
                        justifyContent="flex-start"
                      ...
                      >
                        <Grid item xs={12} sm={12} md={4.0}>
                          <LoadingButton
                            id="CallOperationActionedemokraciaAdminAdminEdemokraciaAdminUserDebatesOwnedDebatesViewEdemokraciaAdminAdminEdemokraciaAdminDebateCreateCommentButtonCallOperation"
                            loading={isLoading}
                            variant={undefined}
                    ...
                    <Grid item xs={12} sm={12}>
                      <Grid
                        id="FlexedemokraciaAdminAdminEdemokraciaAdminUserDebatesOwnedDebatesViewDefaultDebateViewEditTabBarCommentsCommentsCommentsLabelWrapper"
                        container
                        direction="column"
                        alignItems="stretch"
                        justifyContent="flex-start"
                      ...
                      >
                        <Grid item xs={12} sm={12}>
                          <Grid
                            id="TableedemokraciaAdminAdminEdemokraciaAdminUserDebatesOwnedDebatesViewDefaultDebateViewEditTabBarCommentsCommentsCommentsLabelWrapperComments"
                            container
                            direction="column"
                            alignItems="stretch"
                            justifyContent="flex-start"
