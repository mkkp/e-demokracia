...
export const ADMIN_USER_DEBATES_OWNED_DEBATES_VIEW_CONS = 'AdminUserDebatesOwnedDebatesViewCons';
...
export const ConsTable = (props: ConsTableProps) => {
  ...
  const filterModelKey = `TableedemokraciaAdminAdminEdemokraciaAdminUserDebatesOwnedDebatesViewDefaultDebateViewEditTabBarArgumentsArgumentsConsLabelWrapperCons-${ownerData.__identifier}-filterModel`;
  const filtersKey = `TableedemokraciaAdminAdminEdemokraciaAdminUserDebatesOwnedDebatesViewDefaultDebateViewEditTabBarArgumentsArgumentsConsLabelWrapperCons-${ownerData.__identifier}-filters`;
  ...
  const consRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminUserDebatesOwnedDebatesViewDefaultDebateViewEditTabBarArgumentsArgumentsConsLabelWrapperConsTitleFilter',
      attributeName: 'title',
    ...
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminUserDebatesOwnedDebatesViewDefaultDebateViewEditTabBarArgumentsArgumentsConsLabelWrapperConsUpVotesFilter',
    ...
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminUserDebatesOwnedDebatesViewDefaultDebateViewEditTabBarArgumentsArgumentsConsLabelWrapperConsDownVotesFilter',
  ...
  const consRowActions: TableRowAction<AdminConStored>[] = [
    {
      id: 'DeleteActionedemokraciaAdminAdminEdemokraciaAdminUserDebatesOwnedDebatesViewEdemokraciaAdminAdminEdemokraciaAdminDebateConsRowDelete',
    ...
    {
      id: 'CallOperationActionedemokraciaAdminAdminEdemokraciaAdminUserDebatesOwnedDebatesViewEdemokraciaAdminAdminEdemokraciaAdminConVoteUpButtonCallOperation',
    ...
    {
      id: 'CallOperationActionedemokraciaAdminAdminEdemokraciaAdminUserDebatesOwnedDebatesViewEdemokraciaAdminAdminEdemokraciaAdminConVoteDownButtonCallOperation',
    ...
    {
      id: 'CallOperationActionedemokraciaAdminAdminEdemokraciaAdminUserDebatesOwnedDebatesViewEdemokraciaAdminAdminEdemokraciaAdminConCreateSubArgumentButtonCallOperation',
    ...
    {
      id: 'CallOperationActionedemokraciaAdminAdminEdemokraciaAdminUserDebatesOwnedDebatesViewEdemokraciaAdminAdminEdemokraciaAdminConCreateCommentButtonCallOperation',
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              <Button
                id="TableedemokraciaAdminAdminEdemokraciaAdminUserDebatesOwnedDebatesViewDefaultDebateViewEditTabBarArgumentsArgumentsConsLabelWrapperCons-filter"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() =>
                  filter(
                    'TableedemokraciaAdminAdminEdemokraciaAdminUserDebatesOwnedDebatesViewDefaultDebateViewEditTabBarArgumentsArgumentsConsLabelWrapperCons-filter',
                    filterOptions,
                    filters,
                  )
                }
