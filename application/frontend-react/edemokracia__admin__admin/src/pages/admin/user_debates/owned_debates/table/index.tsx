...
// Page name: edemokracia::admin::UserDebates.ownedDebates#Table
...
/**
 * Name: edemokracia::admin::UserDebates.ownedDebates#Table
 * Is Access: false
 * Type: Table
 **/
export default function AdminUserDebatesOwnedDebatesTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaAdminAdminEdemokraciaAdminUserDebatesOwnedDebatesTable-data-grid">
                  <Debate_TableTable
                    ref={tableRef}
