...
// Page name: edemokracia::admin::UserDebates.activeDebatesInActivityCounties#Table
...
/**
 * Name: edemokracia::admin::UserDebates.activeDebatesInActivityCounties#Table
 * Is Access: false
 * Type: Table
 **/
export default function AdminUserDebatesActiveDebatesInActivityCountiesTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaAdminAdminEdemokraciaAdminUserDebatesActiveDebatesInActivityCountiesTable-data-grid">
                  <Debate_TableTable
                    ref={tableRef}
