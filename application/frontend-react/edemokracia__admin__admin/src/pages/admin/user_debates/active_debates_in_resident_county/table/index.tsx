...
// Page name: edemokracia::admin::UserDebates.activeDebatesInResidentCounty#Table
...
/**
 * Name: edemokracia::admin::UserDebates.activeDebatesInResidentCounty#Table
 * Is Access: false
 * Type: Table
 **/
export default function AdminUserDebatesActiveDebatesInResidentCountyTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaAdminAdminEdemokraciaAdminUserDebatesActiveDebatesInResidentCountyTable-data-grid">
                  <Debate_TableTable
                    ref={tableRef}
