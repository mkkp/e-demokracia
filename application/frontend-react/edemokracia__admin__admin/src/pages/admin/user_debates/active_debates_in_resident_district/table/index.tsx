...
// Page name: edemokracia::admin::UserDebates.activeDebatesInResidentDistrict#Table
...
/**
 * Name: edemokracia::admin::UserDebates.activeDebatesInResidentDistrict#Table
 * Is Access: false
 * Type: Table
 **/
export default function AdminUserDebatesActiveDebatesInResidentDistrictTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaAdminAdminEdemokraciaAdminUserDebatesActiveDebatesInResidentDistrictTable-data-grid">
                  <Debate_TableTable
                    ref={tableRef}
