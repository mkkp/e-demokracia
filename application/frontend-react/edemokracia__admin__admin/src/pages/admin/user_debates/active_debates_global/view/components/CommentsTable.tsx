...
export const ADMIN_USER_DEBATES_ACTIVE_DEBATES_GLOBAL_VIEW_COMMENTS = 'AdminUserDebatesActiveDebatesGlobalViewComments';
...
export const CommentsTable = (props: CommentsTableProps) => {
  ...
  const filterModelKey = `TableedemokraciaAdminAdminEdemokraciaAdminUserDebatesActiveDebatesGlobalViewDefaultDebateViewEditTabBarCommentsCommentsCommentsLabelWrapperComments-${ownerData.__identifier}-filterModel`;
  const filtersKey = `TableedemokraciaAdminAdminEdemokraciaAdminUserDebatesActiveDebatesGlobalViewDefaultDebateViewEditTabBarCommentsCommentsCommentsLabelWrapperComments-${ownerData.__identifier}-filters`;
  ...
  const commentsRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminUserDebatesActiveDebatesGlobalViewDefaultDebateViewEditTabBarCommentsCommentsCommentsLabelWrapperCommentsCreatedFilter',
    ...
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminUserDebatesActiveDebatesGlobalViewDefaultDebateViewEditTabBarCommentsCommentsCommentsLabelWrapperCommentsCommentFilter',
    ...
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminUserDebatesActiveDebatesGlobalViewDefaultDebateViewEditTabBarCommentsCommentsCommentsLabelWrapperCommentsCreatedByNameFilter',
    ...
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminUserDebatesActiveDebatesGlobalViewDefaultDebateViewEditTabBarCommentsCommentsCommentsLabelWrapperCommentsUpVotesFilter',
    ...
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminUserDebatesActiveDebatesGlobalViewDefaultDebateViewEditTabBarCommentsCommentsCommentsLabelWrapperCommentsDownVotesFilter',
  ...
  const commentsRowActions: TableRowAction<AdminCommentStored>[] = [
    {
      id: 'DeleteActionedemokraciaAdminAdminEdemokraciaAdminUserDebatesActiveDebatesGlobalViewEdemokraciaAdminAdminEdemokraciaAdminDebateCommentsRowDelete',
    ...
    {
      id: 'CallOperationActionedemokraciaAdminAdminEdemokraciaAdminUserDebatesActiveDebatesGlobalViewEdemokraciaAdminAdminEdemokraciaAdminCommentVoteUpButtonCallOperation',
    ...
    {
      id: 'CallOperationActionedemokraciaAdminAdminEdemokraciaAdminUserDebatesActiveDebatesGlobalViewEdemokraciaAdminAdminEdemokraciaAdminCommentVoteDownButtonCallOperation',
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              <Button
                id="TableedemokraciaAdminAdminEdemokraciaAdminUserDebatesActiveDebatesGlobalViewDefaultDebateViewEditTabBarCommentsCommentsCommentsLabelWrapperComments-filter"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() =>
                  filter(
                    'TableedemokraciaAdminAdminEdemokraciaAdminUserDebatesActiveDebatesGlobalViewDefaultDebateViewEditTabBarCommentsCommentsCommentsLabelWrapperComments-filter',
                    filterOptions,
                    filters,
                  )
                }
