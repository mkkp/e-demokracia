...
// Page name: edemokracia::admin::UserDebates.activeDebatesGlobal#Table
...
/**
 * Name: edemokracia::admin::UserDebates.activeDebatesGlobal#Table
 * Is Access: false
 * Type: Table
 **/
export default function AdminUserDebatesActiveDebatesGlobalTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaAdminAdminEdemokraciaAdminUserDebatesActiveDebatesGlobalTable-data-grid">
                  <Debate_TableTable
                    ref={tableRef}
