...
export type PageFilterActiveDebatesGlobalAction = (
  id: string,
  filterOptions: FilterOption[],
  filters: Filter[],
) => Promise<void>;

export const usePageFilterActiveDebatesGlobalAction = (
  ...
  return async function pageFilterActiveDebatesGlobalAction(
    id: string,
    filterOptions: FilterOption[],
    filters: Filter[],
  ) {
