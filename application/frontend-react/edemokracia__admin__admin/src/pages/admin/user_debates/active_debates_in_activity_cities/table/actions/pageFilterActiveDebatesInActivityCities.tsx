...
export type PageFilterActiveDebatesInActivityCitiesAction = (
  id: string,
  filterOptions: FilterOption[],
  filters: Filter[],
) => Promise<void>;

export const usePageFilterActiveDebatesInActivityCitiesAction = (
  ...
  return async function pageFilterActiveDebatesInActivityCitiesAction(
    id: string,
    filterOptions: FilterOption[],
    filters: Filter[],
  ) {
