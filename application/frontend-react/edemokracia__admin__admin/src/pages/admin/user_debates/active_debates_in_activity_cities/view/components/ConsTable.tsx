...
export const ADMIN_USER_DEBATES_ACTIVE_DEBATES_IN_ACTIVITY_CITIES_VIEW_CONS =
  'AdminUserDebatesActiveDebatesInActivityCitiesViewCons';
...
export const ConsTable = (props: ConsTableProps) => {
  ...
  const filterModelKey = `TableedemokraciaAdminAdminEdemokraciaAdminUserDebatesActiveDebatesInActivityCitiesViewDefaultDebateViewEditTabBarArgumentsArgumentsConsLabelWrapperCons-${ownerData.__identifier}-filterModel`;
  const filtersKey = `TableedemokraciaAdminAdminEdemokraciaAdminUserDebatesActiveDebatesInActivityCitiesViewDefaultDebateViewEditTabBarArgumentsArgumentsConsLabelWrapperCons-${ownerData.__identifier}-filters`;
  ...
  const consRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminUserDebatesActiveDebatesInActivityCitiesViewDefaultDebateViewEditTabBarArgumentsArgumentsConsLabelWrapperConsTitleFilter',
      attributeName: 'title',
    ...
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminUserDebatesActiveDebatesInActivityCitiesViewDefaultDebateViewEditTabBarArgumentsArgumentsConsLabelWrapperConsUpVotesFilter',
    ...
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminUserDebatesActiveDebatesInActivityCitiesViewDefaultDebateViewEditTabBarArgumentsArgumentsConsLabelWrapperConsDownVotesFilter',
  ...
  const consRowActions: TableRowAction<AdminConStored>[] = [
    {
      id: 'DeleteActionedemokraciaAdminAdminEdemokraciaAdminUserDebatesActiveDebatesInActivityCitiesViewEdemokraciaAdminAdminEdemokraciaAdminDebateConsRowDelete',
    ...
    {
      id: 'CallOperationActionedemokraciaAdminAdminEdemokraciaAdminUserDebatesActiveDebatesInActivityCitiesViewEdemokraciaAdminAdminEdemokraciaAdminConVoteUpButtonCallOperation',
    ...
    {
      id: 'CallOperationActionedemokraciaAdminAdminEdemokraciaAdminUserDebatesActiveDebatesInActivityCitiesViewEdemokraciaAdminAdminEdemokraciaAdminConVoteDownButtonCallOperation',
    ...
    {
      id: 'CallOperationActionedemokraciaAdminAdminEdemokraciaAdminUserDebatesActiveDebatesInActivityCitiesViewEdemokraciaAdminAdminEdemokraciaAdminConCreateSubArgumentButtonCallOperation',
    ...
    {
      id: 'CallOperationActionedemokraciaAdminAdminEdemokraciaAdminUserDebatesActiveDebatesInActivityCitiesViewEdemokraciaAdminAdminEdemokraciaAdminConCreateCommentButtonCallOperation',
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              <Button
                id="TableedemokraciaAdminAdminEdemokraciaAdminUserDebatesActiveDebatesInActivityCitiesViewDefaultDebateViewEditTabBarArgumentsArgumentsConsLabelWrapperCons-filter"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() =>
                  filter(
                    'TableedemokraciaAdminAdminEdemokraciaAdminUserDebatesActiveDebatesInActivityCitiesViewDefaultDebateViewEditTabBarArgumentsArgumentsConsLabelWrapperCons-filter',
                    filterOptions,
                    filters,
                  )
                }
