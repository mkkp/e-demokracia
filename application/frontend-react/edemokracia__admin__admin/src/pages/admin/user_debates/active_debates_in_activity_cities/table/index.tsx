...
// Page name: edemokracia::admin::UserDebates.activeDebatesInActivityCities#Table
...
/**
 * Name: edemokracia::admin::UserDebates.activeDebatesInActivityCities#Table
 * Is Access: false
 * Type: Table
 **/
export default function AdminUserDebatesActiveDebatesInActivityCitiesTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaAdminAdminEdemokraciaAdminUserDebatesActiveDebatesInActivityCitiesTable-data-grid">
                  <Debate_TableTable
                    ref={tableRef}
