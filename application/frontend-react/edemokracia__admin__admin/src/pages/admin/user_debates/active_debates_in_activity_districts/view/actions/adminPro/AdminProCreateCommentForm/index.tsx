...
export default function AdminProCreateCommentForm({ successCallback, cancel, owner }: AdminProCreateCommentFormProps) {
  ...
  return (
    <>
      <DialogTitle>
        {title}
        <IconButton
          id="CallOperationActionedemokraciaAdminAdminEdemokraciaAdminUserDebatesActiveDebatesInActivityDistrictsViewEdemokraciaAdminAdminEdemokraciaAdminProCreateCommentButtonCallOperation-dialog-close"
          aria-label="close"
          onClick={() => cancel()}
          sx={{
            position: 'absolute',
      ...
      <DialogContent dividers>
        <Grid container spacing={2} direction="column" alignItems="stretch" justifyContent="flex-start">
          <Grid item xs={12} sm={12}>
            <Grid
              id="FlexedemokraciaAdminAdminEdemokraciaAdminProCreateCommentInputDefaultCreateCommentInputFormComment"
              container
              direction="row"
            ...
            >
              <Grid item xs={12} sm={12}>
                <TextField
                  required={true}
                  name="comment"
                  id="TextAreaedemokraciaAdminAdminEdemokraciaAdminProCreateCommentInputDefaultCreateCommentInputFormCommentComment"
                  autoFocus
      ...
      <DialogActions>
        <Button
          id="CallOperationActionedemokraciaAdminAdminEdemokraciaAdminUserDebatesActiveDebatesInActivityDistrictsViewEdemokraciaAdminAdminEdemokraciaAdminProCreateCommentButtonCallOperation-action-form-action-cancel"
          variant="text"
          onClick={() => cancel()}
          disabled={isLoading}
        ...
        <LoadingButton
          ...
          id="CallOperationActionedemokraciaAdminAdminEdemokraciaAdminUserDebatesActiveDebatesInActivityDistrictsViewEdemokraciaAdminAdminEdemokraciaAdminProCreateCommentButtonCallOperation-action-form-action-submit"
          variant="contained"
          onClick={() => submit()}
