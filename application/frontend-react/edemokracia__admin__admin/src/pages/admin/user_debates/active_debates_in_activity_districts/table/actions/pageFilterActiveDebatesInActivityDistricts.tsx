...
export type PageFilterActiveDebatesInActivityDistrictsAction = (
  id: string,
  filterOptions: FilterOption[],
  filters: Filter[],
) => Promise<void>;

export const usePageFilterActiveDebatesInActivityDistrictsAction = (
  ...
  return async function pageFilterActiveDebatesInActivityDistrictsAction(
    id: string,
    filterOptions: FilterOption[],
    filters: Filter[],
  ) {
