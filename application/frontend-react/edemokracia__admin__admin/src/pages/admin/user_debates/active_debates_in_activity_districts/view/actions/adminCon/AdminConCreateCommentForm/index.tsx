...
import { createCommentInputServiceForClassImpl, adminConServiceForClassImpl } from '~/generated/data-axios';
...
export default function AdminConCreateCommentForm({ successCallback, cancel, owner }: AdminConCreateCommentFormProps) {
  ...
  const submit = async () => {
    ...
    try {
      await adminConServiceForClassImpl.createComment(owner, payloadDiff);
  ...
  return (
    <>
      <DialogTitle>
        {title}
        <IconButton
          id="CallOperationActionedemokraciaAdminAdminEdemokraciaAdminUserDebatesActiveDebatesInActivityDistrictsViewEdemokraciaAdminAdminEdemokraciaAdminConCreateCommentButtonCallOperation-dialog-close"
          aria-label="close"
          onClick={() => cancel()}
          sx={{
            position: 'absolute',
      ...
      <DialogContent dividers>
        <Grid container spacing={2} direction="column" alignItems="stretch" justifyContent="flex-start">
          <Grid item xs={12} sm={12}>
            <Grid
              id="FlexedemokraciaAdminAdminEdemokraciaAdminConCreateCommentInputDefaultCreateCommentInputFormComment"
              container
              direction="row"
            ...
            >
              <Grid item xs={12} sm={12}>
                <TextField
                  required={true}
                  name="comment"
                  id="TextAreaedemokraciaAdminAdminEdemokraciaAdminConCreateCommentInputDefaultCreateCommentInputFormCommentComment"
                  autoFocus
      ...
      <DialogActions>
        <Button
          id="CallOperationActionedemokraciaAdminAdminEdemokraciaAdminUserDebatesActiveDebatesInActivityDistrictsViewEdemokraciaAdminAdminEdemokraciaAdminConCreateCommentButtonCallOperation-action-form-action-cancel"
          variant="text"
          onClick={() => cancel()}
          disabled={isLoading}
        ...
        <LoadingButton
          ...
          id="CallOperationActionedemokraciaAdminAdminEdemokraciaAdminUserDebatesActiveDebatesInActivityDistrictsViewEdemokraciaAdminAdminEdemokraciaAdminConCreateCommentButtonCallOperation-action-form-action-submit"
          variant="contained"
          onClick={() => submit()}
