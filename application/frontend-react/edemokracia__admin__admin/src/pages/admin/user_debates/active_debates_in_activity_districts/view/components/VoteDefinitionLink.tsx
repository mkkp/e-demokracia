...
export function VoteDefinitionLink(props: VoteDefinitionLinkProps) {
  ...
  return (
    <AggregationInput
      name="voteDefinition"
      id="LinkedemokraciaAdminAdminEdemokraciaAdminUserDebatesActiveDebatesInActivityDistrictsViewDefaultDebateViewEditDebateLabelWrapperDebateVoteDefinition"
