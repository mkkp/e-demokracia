...
// Page name: edemokracia::admin::UserDebates.activeDebatesInActivityDistricts#Table
...
/**
 * Name: edemokracia::admin::UserDebates.activeDebatesInActivityDistricts#Table
 * Is Access: false
 * Type: Table
 **/
export default function AdminUserDebatesActiveDebatesInActivityDistrictsTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaAdminAdminEdemokraciaAdminUserDebatesActiveDebatesInActivityDistrictsTable-data-grid">
                  <Debate_TableTable
                    ref={tableRef}
