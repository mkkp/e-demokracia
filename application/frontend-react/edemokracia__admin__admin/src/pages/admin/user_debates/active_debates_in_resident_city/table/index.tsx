...
// Page name: edemokracia::admin::UserDebates.activeDebatesInResidentCity#Table
...
/**
 * Name: edemokracia::admin::UserDebates.activeDebatesInResidentCity#Table
 * Is Access: false
 * Type: Table
 **/
export default function AdminUserDebatesActiveDebatesInResidentCityTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaAdminAdminEdemokraciaAdminUserDebatesActiveDebatesInResidentCityTable-data-grid">
                  <Debate_TableTable
                    ref={tableRef}
