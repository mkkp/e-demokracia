...
// Page name: edemokracia::admin::RatingVoteDefinition.issue#View
// Page owner name: edemokracia::admin::Admin
// Page DataElement name: issue
// Page DataElement owner name: edemokracia::admin::RatingVoteDefinition
...
import { adminRatingVoteDefinitionServiceForClassImpl, adminIssueServiceForClassImpl } from '~/generated/data-axios';
import {
...
export type AdminRatingVoteDefinitionIssueViewPostRefreshAction = (
...
export const ADMIN_RATING_VOTE_DEFINITION_ISSUE_VIEW_POST_REFRESH_HOOK_INTERFACE_KEY =
  'AdminRatingVoteDefinitionIssueViewPostRefreshHook';
export type AdminRatingVoteDefinitionIssueViewPostRefreshHook =
  () => AdminRatingVoteDefinitionIssueViewPostRefreshAction;

/**
 * Name: edemokracia::admin::RatingVoteDefinition.issue#View
 * Is Access: false
 * Type: View
 * Edit Mode Available: false
 **/
export default function AdminRatingVoteDefinitionIssueView() {
  ...
  const { service: postRefreshHook } = useTrackService<AdminRatingVoteDefinitionIssueViewPostRefreshHook>(
    `(${OBJECTCLASS}=${ADMIN_RATING_VOTE_DEFINITION_ISSUE_VIEW_POST_REFRESH_HOOK_INTERFACE_KEY})`,
  );
  const postRefreshAction: AdminRatingVoteDefinitionIssueViewPostRefreshAction | undefined =
        ...
        <Box sx={mainContainerPadding}>
          ...
          >
            <Grid item xs={12} sm={12}>
              <Grid
                id="FlexedemokraciaAdminAdminEdemokraciaAdminRatingVoteDefinitionIssueViewDefaultIssueViewEditActions"
                container
                direction="row"
              ...
              >
                <Grid item xs={12}>
                  <Grid container spacing={2}>
                    <Grid item>
                      <LoadingButton
                        id="ButtonedemokraciaAdminAdminEdemokraciaAdminRatingVoteDefinitionIssueViewDefaultIssueViewEditActionsPageActionButtonsCreateDebate"
                        loading={isLoading}
                    ...
                    {!data.isFavorite && (
                      <Grid item>
                        <LoadingButton
                          id="ButtonedemokraciaAdminAdminEdemokraciaAdminRatingVoteDefinitionIssueViewDefaultIssueViewEditActionsPageActionButtonsAddToFavorites"
                          loading={isLoading}
                    ...
                    {!data.isNotFavorite && (
                      <Grid item>
                        <LoadingButton
                          id="ButtonedemokraciaAdminAdminEdemokraciaAdminRatingVoteDefinitionIssueViewDefaultIssueViewEditActionsPageActionButtonsRemoveFromFavorites"
                          loading={isLoading}
            ...
            <Grid item xs={12} sm={12}>
              <Card id="FlexedemokraciaAdminAdminEdemokraciaAdminRatingVoteDefinitionIssueViewDefaultIssueViewEditIssueLabelWrapper">
                <CardContent>
                  <Grid container direction="column" alignItems="stretch" justifyContent="flex-start" spacing={2}>
                    <Grid item xs={12} sm={12}>
                      <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                        ...
                        <Typography
                          id="LabeledemokraciaAdminAdminEdemokraciaAdminRatingVoteDefinitionIssueViewDefaultIssueViewEditIssueLabelWrapperIssueLabel"
                          variant="h5"
                          component="h1"
                        >
                    ...
                    <Grid item xs={12} sm={12}>
                      <Grid
                        id="FlexedemokraciaAdminAdminEdemokraciaAdminRatingVoteDefinitionIssueViewDefaultIssueViewEditIssueLabelWrapperIssue"
                        container
                        direction="row"
                        alignItems="stretch"
                        justifyContent="flex-start"
                      ...
                      >
                        ...
                        <Grid item xs={12} sm={12} md={4.0}>
                          <TextField
                            ...
                            id="EnumerationComboedemokraciaAdminAdminEdemokraciaAdminRatingVoteDefinitionIssueViewDefaultIssueViewEditIssueLabelWrapperIssueDefaultVoteType"
                            label={
                        ...
                        <Grid item xs={12} sm={12} md={4.0}>
                          <TextField
                            required={true}
                            name="title"
                            id="TextInputedemokraciaAdminAdminEdemokraciaAdminRatingVoteDefinitionIssueViewDefaultIssueViewEditIssueLabelWrapperIssueTitle"
                        ...
                        <Grid item xs={12} sm={12} md={4.0}>
                          <TextField
                            required={true}
                            name="status"
                            id="EnumerationComboedemokraciaAdminAdminEdemokraciaAdminRatingVoteDefinitionIssueViewDefaultIssueViewEditIssueLabelWrapperIssueStatus"
                        ...
                        <Grid item xs={12} sm={12} md={4.0}>
                          <DateTimePicker
                            ...
                            slotProps={{
                              textField: {
                                id: 'DateTimeInputedemokraciaAdminAdminEdemokraciaAdminRatingVoteDefinitionIssueViewDefaultIssueViewEditIssueLabelWrapperIssueCreated',
                                required: false,
                        ...
                        <Grid item xs={12} sm={12}>
                          <TextField
                            required={true}
                            name="description"
                            id="TextAreaedemokraciaAdminAdminEdemokraciaAdminRatingVoteDefinitionIssueViewDefaultIssueViewEditIssueLabelWrapperIssueDescription"
            ...
            <Grid container item xs={12} sm={12}>
              <ModeledTabs
                id="TabControlleredemokraciaAdminAdminEdemokraciaAdminRatingVoteDefinitionIssueViewDefaultIssueViewEditOther"
                ownerData={data}
                validation={validation}
                orientation='horizontal'
                childTabs={[
                  {
                    id: 'TabedemokraciaAdminAdminEdemokraciaAdminRatingVoteDefinitionIssueViewDefaultIssueViewEditOtherArea',
                  ...
                  {
                    id: 'TabedemokraciaAdminAdminEdemokraciaAdminRatingVoteDefinitionIssueViewDefaultIssueViewEditOtherAttachments',
                  ...
                  {
                    id: 'TabedemokraciaAdminAdminEdemokraciaAdminRatingVoteDefinitionIssueViewDefaultIssueViewEditOtherCategories',
                  ...
                  {
                    id: 'TabedemokraciaAdminAdminEdemokraciaAdminRatingVoteDefinitionIssueViewDefaultIssueViewEditOtherDebates',
                  ...
                  {
                    id: 'TabedemokraciaAdminAdminEdemokraciaAdminRatingVoteDefinitionIssueViewDefaultIssueViewEditOtherComments',
              ...
              >
                <Grid item xs={12} sm={12}>
                  <Grid
                    id="FlexedemokraciaAdminAdminEdemokraciaAdminRatingVoteDefinitionIssueViewDefaultIssueViewEditOtherAreaArea"
                    container
                    direction="row"
                    alignItems="flex-start"
                    justifyContent="flex-start"
                ...
                <Grid item xs={12} sm={12}>
                  <Grid
                    id="FlexedemokraciaAdminAdminEdemokraciaAdminRatingVoteDefinitionIssueViewDefaultIssueViewEditOtherAttachmentsAttachments"
                    container
                    direction="row"
                    alignItems="flex-start"
                    justifyContent="flex-start"
                  ...
                  >
                    <Grid item xs={12} sm={12}>
                      <Grid
                        id="FlexedemokraciaAdminAdminEdemokraciaAdminRatingVoteDefinitionIssueViewDefaultIssueViewEditOtherAttachmentsAttachmentsAttachmentsLabelWrapper"
                        container
                        direction="column"
                        alignItems="stretch"
                        justifyContent="flex-start"
                      ...
                      >
                        <Grid item xs={12} sm={12}>
                          <Grid
                            id="TableedemokraciaAdminAdminEdemokraciaAdminRatingVoteDefinitionIssueViewDefaultIssueViewEditOtherAttachmentsAttachmentsAttachmentsLabelWrapperAttachments"
                            container
                            direction="column"
                            alignItems="stretch"
                            justifyContent="flex-start"
                ...
                <Grid item xs={12} sm={12}>
                  <Grid
                    id="FlexedemokraciaAdminAdminEdemokraciaAdminRatingVoteDefinitionIssueViewDefaultIssueViewEditOtherCategoriesCategories"
                    container
                    direction="row"
                    alignItems="flex-start"
                    justifyContent="flex-start"
                  ...
                  >
                    <Grid item xs={12} sm={12}>
                      <Grid
                        id="FlexedemokraciaAdminAdminEdemokraciaAdminRatingVoteDefinitionIssueViewDefaultIssueViewEditOtherCategoriesCategoriesCategoriesLabelWrapper"
                        container
                        direction="column"
                        alignItems="stretch"
                        justifyContent="flex-start"
                      ...
                      >
                        <Grid item xs={12} sm={12}>
                          <Grid
                            id="TableedemokraciaAdminAdminEdemokraciaAdminRatingVoteDefinitionIssueViewDefaultIssueViewEditOtherCategoriesCategoriesCategoriesLabelWrapperCategories"
                            container
                            direction="column"
                            alignItems="stretch"
                            justifyContent="flex-start"
                ...
                <Grid item xs={12} sm={12}>
                  <Grid
                    id="FlexedemokraciaAdminAdminEdemokraciaAdminRatingVoteDefinitionIssueViewDefaultIssueViewEditOtherDebatesDebates"
                    container
                    direction="row"
                    alignItems="flex-start"
                    justifyContent="flex-start"
                  ...
                  >
                    <Grid item xs={12} sm={12}>
                      <Grid
                        id="FlexedemokraciaAdminAdminEdemokraciaAdminRatingVoteDefinitionIssueViewDefaultIssueViewEditOtherDebatesDebatesDebatesLabelWrapper"
                        container
                        direction="column"
                        alignItems="stretch"
                        justifyContent="flex-start"
                      ...
                      >
                        <Grid item xs={12} sm={12}>
                          <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                            ...
                            <Typography
                              id="LabeledemokraciaAdminAdminEdemokraciaAdminRatingVoteDefinitionIssueViewDefaultIssueViewEditOtherDebatesDebatesDebatesLabelWrapperDebatesLabel"
                              variant="h5"
                              component="h1"
                            >
                        ...
                        <Grid item xs={12} sm={12}>
                          <Grid
                            id="TableedemokraciaAdminAdminEdemokraciaAdminRatingVoteDefinitionIssueViewDefaultIssueViewEditOtherDebatesDebatesDebatesLabelWrapperDebates"
                            container
                            direction="column"
                            alignItems="stretch"
                            justifyContent="flex-start"
                ...
                <Grid item xs={12} sm={12}>
                  <Grid
                    id="FlexedemokraciaAdminAdminEdemokraciaAdminRatingVoteDefinitionIssueViewDefaultIssueViewEditOtherCommentsComments"
                    container
                    direction="row"
                    alignItems="flex-start"
                    justifyContent="flex-start"
                  ...
                  >
                    <Grid item xs={12} sm={12}>
                      <Grid
                        id="FlexedemokraciaAdminAdminEdemokraciaAdminRatingVoteDefinitionIssueViewDefaultIssueViewEditOtherCommentsCommentsActions"
                        container
                        direction="row"
                        alignItems="flex-start"
                        justifyContent="flex-start"
                      ...
                      >
                        <Grid item xs={12} sm={12} md={4.0}>
                          <LoadingButton
                            id="CallOperationActionedemokraciaAdminAdminEdemokraciaAdminRatingVoteDefinitionIssueViewEdemokraciaAdminAdminEdemokraciaAdminIssueCreateCommentButtonCallOperation"
                            loading={isLoading}
                            variant={undefined}
                        ...
                        <Grid item xs={12} sm={12}>
                          <Grid
                            id="FlexedemokraciaAdminAdminEdemokraciaAdminRatingVoteDefinitionIssueViewDefaultIssueViewEditOtherCommentsCommentsActionsCommentsLabelWrapper"
                            container
                            direction="column"
                            alignItems="stretch"
                            justifyContent="flex-start"
                          ...
                          >
                            <Grid item xs={12} sm={12}>
                              <Grid
                                id="TableedemokraciaAdminAdminEdemokraciaAdminRatingVoteDefinitionIssueViewDefaultIssueViewEditOtherCommentsCommentsActionsCommentsLabelWrapperComments"
                                container
                                direction="column"
                                alignItems="stretch"
                                justifyContent="flex-start"
