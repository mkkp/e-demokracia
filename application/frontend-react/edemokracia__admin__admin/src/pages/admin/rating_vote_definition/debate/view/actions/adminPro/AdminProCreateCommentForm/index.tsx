  ...
  return (
    <>
      <DialogTitle>
        {title}
        <IconButton
          id="CallOperationActionedemokraciaAdminAdminEdemokraciaAdminRatingVoteDefinitionDebateViewEdemokraciaAdminAdminEdemokraciaAdminProCreateCommentButtonCallOperation-dialog-close"
          aria-label="close"
          onClick={() => cancel()}
          sx={{
            position: 'absolute',
      ...
      <DialogActions>
        <Button
          id="CallOperationActionedemokraciaAdminAdminEdemokraciaAdminRatingVoteDefinitionDebateViewEdemokraciaAdminAdminEdemokraciaAdminProCreateCommentButtonCallOperation-action-form-action-cancel"
          variant="text"
          onClick={() => cancel()}
          disabled={isLoading}
        ...
        <LoadingButton
          ...
          id="CallOperationActionedemokraciaAdminAdminEdemokraciaAdminRatingVoteDefinitionDebateViewEdemokraciaAdminAdminEdemokraciaAdminProCreateCommentButtonCallOperation-action-form-action-submit"
          variant="contained"
          onClick={() => submit()}
