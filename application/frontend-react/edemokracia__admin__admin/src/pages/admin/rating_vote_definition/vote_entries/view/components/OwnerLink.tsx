...
export function OwnerLink(props: OwnerLinkProps) {
  ...
  const ownerRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminRatingVoteDefinitionVoteEntriesViewDefaultRatingVoteEntryViewEditOwnerRepresentationFilter',
  ...
  return (
    <AggregationInput
      name="owner"
      id="LinkedemokraciaAdminAdminEdemokraciaAdminRatingVoteDefinitionVoteEntriesViewDefaultRatingVoteEntryViewEditOwner"
      required={true}
