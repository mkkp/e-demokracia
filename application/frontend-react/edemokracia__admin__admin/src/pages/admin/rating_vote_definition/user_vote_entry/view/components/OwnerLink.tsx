...
export type OwnerLinkFilterInitializer = (ownerData: AdminRatingVoteEntryStored) => Filter[] | undefined;
...
export interface OwnerLinkProps {
  ownerData: AdminRatingVoteEntryStored;
  validation: Map<keyof AdminRatingVoteEntryStored, string>;
...
export function OwnerLink(props: OwnerLinkProps) {
  ...
  const ownerColumns: GridColDef<AdminUserStored>[] = [
    {
      ...
      headerName: t('admin.RatingVoteEntryView.owner.representation', { defaultValue: 'Representation' }) as string,
  ...
  const ownerRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminRatingVoteDefinitionUserVoteEntryViewDefaultRatingVoteEntryViewEditOwnerRepresentationFilter',
      attributeName: 'representation',
      label: t('admin.RatingVoteEntryView.owner.representation', { defaultValue: 'Representation' }) as string,
  ...
  return (
    <AggregationInput
      name="owner"
      id="LinkedemokraciaAdminAdminEdemokraciaAdminRatingVoteDefinitionUserVoteEntryViewDefaultRatingVoteEntryViewEditOwner"
      required={true}
      label={t('admin.RatingVoteEntryView.owner', { defaultValue: 'Owner' }) as string}
