              ...
              >
                <Grid item xs={12}>
                  <Grid container spacing={2}>
                    <Grid item>
                      <LoadingButton
                        id="ButtonedemokraciaAdminAdminEdemokraciaAdminYesNoVoteDefinitionIssueViewDefaultIssueViewEditActionsActionGroupCreateDebate"
                        loading={isLoading}
                    ...
                    {!data.isFavorite && (
                      <Grid item>
                        <LoadingButton
                          id="ButtonedemokraciaAdminAdminEdemokraciaAdminYesNoVoteDefinitionIssueViewDefaultIssueViewEditActionsActionGroupAddToFavorites"
                          loading={isLoading}
                    ...
                    {!data.isNotFavorite && (
                      <Grid item>
                        <LoadingButton
                          id="ButtonedemokraciaAdminAdminEdemokraciaAdminYesNoVoteDefinitionIssueViewDefaultIssueViewEditActionsActionGroupRemoveFromFavorites"
                          loading={isLoading}
