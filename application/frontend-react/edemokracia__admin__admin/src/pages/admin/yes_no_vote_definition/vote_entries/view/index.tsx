...
// Page name: edemokracia::admin::YesNoVoteDefinition.voteEntries#View
...
/**
 * Name: edemokracia::admin::YesNoVoteDefinition.voteEntries#View
 * Is Access: false
 * Type: View
        ...
        <Grid container spacing={2} direction="column" alignItems="stretch" justifyContent="flex-start">
          <Grid item xs={12} sm={12}>
            <DateTimePicker
              ...
              slotProps={{
                textField: {
                  id: 'DateTimeInputedemokraciaAdminAdminEdemokraciaAdminYesNoVoteDefinitionVoteEntriesViewDefaultYesNoVoteEntryViewEditCreated',
                  required: true,
          ...
          <Grid item xs={12} sm={12}>
            <TextField
              required={true}
              name="value"
              id="EnumerationComboedemokraciaAdminAdminEdemokraciaAdminYesNoVoteDefinitionVoteEntriesViewDefaultYesNoVoteEntryViewEditValue"
