...
import { routeToAdminDebateCreatedByView } from '~/routes';
...
export const useLinkViewCreatedByAction: LinkViewCreatedByAction = () => {
  ...
  return async function (owner: JudoIdentifiable<AdminDebate>, entry: AdminUserStored, successCallback: () => void) {
    closeAllDialogs();
    navigate(routeToAdminDebateCreatedByView(entry.__signedIdentifier));
  };
};
