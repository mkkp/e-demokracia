...
export const ADMIN_YES_NO_VOTE_DEFINITION_DEBATE_VIEW_CONS = 'AdminYesNoVoteDefinitionDebateViewCons';
...
export const ConsTable = (props: ConsTableProps) => {
  ...
  const filterModelKey = `TableedemokraciaAdminAdminEdemokraciaAdminYesNoVoteDefinitionDebateViewDefaultDebateViewEditTabBarArgumentsArgumentsConsLabelWrapperCons-${ownerData.__identifier}-filterModel`;
  const filtersKey = `TableedemokraciaAdminAdminEdemokraciaAdminYesNoVoteDefinitionDebateViewDefaultDebateViewEditTabBarArgumentsArgumentsConsLabelWrapperCons-${ownerData.__identifier}-filters`;
  ...
  const consRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminYesNoVoteDefinitionDebateViewDefaultDebateViewEditTabBarArgumentsArgumentsConsLabelWrapperConsTitleFilter',
      attributeName: 'title',
    ...
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminYesNoVoteDefinitionDebateViewDefaultDebateViewEditTabBarArgumentsArgumentsConsLabelWrapperConsUpVotesFilter',
    ...
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminYesNoVoteDefinitionDebateViewDefaultDebateViewEditTabBarArgumentsArgumentsConsLabelWrapperConsDownVotesFilter',
  ...
  const consRowActions: TableRowAction<AdminConStored>[] = [
    {
      id: 'DeleteActionedemokraciaAdminAdminEdemokraciaAdminYesNoVoteDefinitionDebateViewEdemokraciaAdminAdminEdemokraciaAdminDebateConsRowDelete',
    ...
    {
      id: 'CallOperationActionedemokraciaAdminAdminEdemokraciaAdminYesNoVoteDefinitionDebateViewEdemokraciaAdminAdminEdemokraciaAdminConVoteUpButtonCallOperation',
    ...
    {
      id: 'CallOperationActionedemokraciaAdminAdminEdemokraciaAdminYesNoVoteDefinitionDebateViewEdemokraciaAdminAdminEdemokraciaAdminConVoteDownButtonCallOperation',
    ...
    {
      id: 'CallOperationActionedemokraciaAdminAdminEdemokraciaAdminYesNoVoteDefinitionDebateViewEdemokraciaAdminAdminEdemokraciaAdminConCreateSubArgumentButtonCallOperation',
    ...
    {
      id: 'CallOperationActionedemokraciaAdminAdminEdemokraciaAdminYesNoVoteDefinitionDebateViewEdemokraciaAdminAdminEdemokraciaAdminConCreateCommentButtonCallOperation',
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              <Button
                id="TableedemokraciaAdminAdminEdemokraciaAdminYesNoVoteDefinitionDebateViewDefaultDebateViewEditTabBarArgumentsArgumentsConsLabelWrapperCons-filter"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() =>
                  filter(
                    'TableedemokraciaAdminAdminEdemokraciaAdminYesNoVoteDefinitionDebateViewDefaultDebateViewEditTabBarArgumentsArgumentsConsLabelWrapperCons-filter',
                    filterOptions,
                    filters,
                  )
                }
