...
export const ADMIN_YES_NO_ABSTAIN_VOTE_DEFINITION_ISSUE_VIEW_CATEGORIES =
  'AdminYesNoAbstainVoteDefinitionIssueViewCategories';
...
export const CategoriesTable = (props: CategoriesTableProps) => {
  ...
  const filterModelKey = `TableedemokraciaAdminAdminEdemokraciaAdminYesNoAbstainVoteDefinitionIssueViewDefaultIssueViewEditOtherCategoriesCategoriesCategoriesLabelWrapperCategories-${ownerData.__identifier}-filterModel`;
  const filtersKey = `TableedemokraciaAdminAdminEdemokraciaAdminYesNoAbstainVoteDefinitionIssueViewDefaultIssueViewEditOtherCategoriesCategoriesCategoriesLabelWrapperCategories-${ownerData.__identifier}-filters`;
  ...
  const categoriesRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminYesNoAbstainVoteDefinitionIssueViewDefaultIssueViewEditOtherCategoriesCategoriesCategoriesLabelWrapperCategoriesTitleFilter',
      attributeName: 'title',
    ...
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminYesNoAbstainVoteDefinitionIssueViewDefaultIssueViewEditOtherCategoriesCategoriesCategoriesLabelWrapperCategoriesDescriptionFilter',
  ...
  const categoriesRowActions: TableRowAction<AdminIssueCategoryStored>[] = [
    {
      id: 'RemoveActionedemokraciaAdminAdminEdemokraciaAdminYesNoAbstainVoteDefinitionIssueViewEdemokraciaAdminAdminEdemokraciaAdminIssueCategoriesRowRemove',
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              ...
              <Button
                id="TableedemokraciaAdminAdminEdemokraciaAdminYesNoAbstainVoteDefinitionIssueViewDefaultIssueViewEditOtherCategoriesCategoriesCategoriesLabelWrapperCategories-filter"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() =>
                  filter(
                    'TableedemokraciaAdminAdminEdemokraciaAdminYesNoAbstainVoteDefinitionIssueViewDefaultIssueViewEditOtherCategoriesCategoriesCategoriesLabelWrapperCategories-filter',
                    filterOptions,
                    filters,
                  )
                }
