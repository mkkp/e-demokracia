...
export type UserLinkFilterInitializer = (ownerData: AdminYesNoAbstainVoteEntryStored) => Filter[] | undefined;
...
export function UserLink(props: UserLinkProps) {
  ...
  const ownerRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminYesNoAbstainVoteDefinitionUserVoteEntryViewDefaultYesNoAbstainVoteEntryViewEditUserRepresentationFilter',
  ...
  return (
    <AggregationInput
      name="owner"
      id="LinkedemokraciaAdminAdminEdemokraciaAdminYesNoAbstainVoteDefinitionUserVoteEntryViewDefaultYesNoAbstainVoteEntryViewEditUser"
      required={true}
