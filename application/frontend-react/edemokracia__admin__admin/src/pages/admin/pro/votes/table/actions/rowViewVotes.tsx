...
export const useRowViewVotesAction: RowViewVotesAction = () => {
  ...
  return async function (owner: JudoIdentifiable<AdminPro>, entry: AdminSimpleVoteStored, successCallback: () => void) {
    closeAllDialogs();
    navigate(routeToAdminProVotesView(entry.__signedIdentifier));
  };
};
