...
export function ResidentCityLink(props: ResidentCityLinkProps) {
  ...
  const residentCityRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminProCreatedByViewDefaultUserViewEditAreasLabelWrapperAreasResidencyResidentCityRepresentationFilter',
  ...
  return (
    <AggregationInput
      name="residentCity"
      id="LinkedemokraciaAdminAdminEdemokraciaAdminProCreatedByViewDefaultUserViewEditAreasLabelWrapperAreasResidencyResidentCity"
