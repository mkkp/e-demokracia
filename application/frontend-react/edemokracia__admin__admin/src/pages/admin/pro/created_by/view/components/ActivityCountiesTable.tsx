...
export const ADMIN_PRO_CREATED_BY_VIEW_ACTIVITY_COUNTIES = 'AdminProCreatedByViewActivityCounties';
...
export const ActivityCountiesTable = (props: ActivityCountiesTableProps) => {
  ...
  const activityCountiesRowActions: TableRowAction<AdminCountyStored>[] = [
    {
      id: 'RemoveActionedemokraciaAdminAdminEdemokraciaAdminProCreatedByViewEdemokraciaAdminAdminEdemokraciaAdminUserActivityCountiesRowRemove',
