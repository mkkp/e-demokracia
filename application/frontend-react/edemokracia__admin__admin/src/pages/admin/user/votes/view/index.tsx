...
export type AdminUserVotesViewPostRefreshAction = (
...
export const ADMIN_USER_VOTES_VIEW_POST_REFRESH_HOOK_INTERFACE_KEY = 'AdminUserVotesViewPostRefreshHook';
export type AdminUserVotesViewPostRefreshHook = () => AdminUserVotesViewPostRefreshAction;
...
export default function AdminUserVotesView() {
  ...
  const { service: postRefreshHook } = useTrackService<AdminUserVotesViewPostRefreshHook>(
    `(${OBJECTCLASS}=${ADMIN_USER_VOTES_VIEW_POST_REFRESH_HOOK_INTERFACE_KEY})`,
  );
  const postRefreshAction: AdminUserVotesViewPostRefreshAction | undefined = postRefreshHook && postRefreshHook();
        ...
        <Box sx={mainContainerPadding}>
          ...
          >
            <Grid item xs={12} sm={12}>
              <Grid
                id="FlexedemokraciaAdminAdminEdemokraciaAdminUserVotesViewDefaultSimpleVoteViewEditGroup"
                container
                direction="row"
              ...
              >
                <Grid item xs={12} sm={12} md={4.0}>
                  <DateTimePicker
                    ...
                    slotProps={{
                      textField: {
                        id: 'DateTimeInputedemokraciaAdminAdminEdemokraciaAdminUserVotesViewDefaultSimpleVoteViewEditGroupCreated',
                        required: true,
                ...
                <Grid item xs={12} sm={12} md={4.0}>
                  <TextField
                    required={true}
                    name="type"
                    id="EnumerationComboedemokraciaAdminAdminEdemokraciaAdminUserVotesViewDefaultSimpleVoteViewEditGroupType"
            ...
            <Grid item xs={12} sm={12}>
              <Grid
                id="FlexedemokraciaAdminAdminEdemokraciaAdminUserVotesViewDefaultSimpleVoteViewEditGroup2"
                container
                direction="row"
                alignItems="flex-start"
                justifyContent="flex-start"
