...
export const Vote_TableTable = forwardRef<RefreshableTable, Vote_TableTableProps>((props, ref) => {
  ...
  async function fetchData() {
    ...
    try {
      const res = await adminUserServiceImpl.getVotes(ownerData, processQueryCustomizer(queryCustomizer));
  ...
  return (
    <DataGrid
      ...
      columns={[
        ...votesColumns,
        ...columnsActionCalculator('RelationTypeedemokraciaAdminAdminEdemokraciaAdminUserVotes', rowActions, {
          shownActions: 2,
        }),
      ]}
