...
export const CitiesTable = (props: CitiesTableProps) => {
  ...
  const filterModelKey = `TableedemokraciaAdminAdminEdemokraciaAdminUserProfileActivityCountiesViewDefaultCountyViewEditCitiesLabelWrapperCities-${ownerData.__identifier}-filterModel`;
  const filtersKey = `TableedemokraciaAdminAdminEdemokraciaAdminUserProfileActivityCountiesViewDefaultCountyViewEditCitiesLabelWrapperCities-${ownerData.__identifier}-filters`;
  ...
  const citiesRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminUserProfileActivityCountiesViewDefaultCountyViewEditCitiesLabelWrapperCitiesNameFilter',
      attributeName: 'name',
  ...
  const citiesRowActions: TableRowAction<AdminCityStored>[] = [
    {
      id: 'DeleteActionedemokraciaAdminAdminEdemokraciaAdminUserProfileActivityCountiesViewEdemokraciaAdminAdminEdemokraciaAdminCountyCitiesRowDelete',
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              <Button
                id="CreateActionedemokraciaAdminAdminEdemokraciaAdminUserProfileActivityCountiesViewEdemokraciaAdminAdminEdemokraciaAdminCountyCitiesTableCreate"
              ...
              <Button
                id="TableedemokraciaAdminAdminEdemokraciaAdminUserProfileActivityCountiesViewDefaultCountyViewEditCitiesLabelWrapperCities-filter"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() =>
                  filter(
                    'TableedemokraciaAdminAdminEdemokraciaAdminUserProfileActivityCountiesViewDefaultCountyViewEditCitiesLabelWrapperCities-filter',
                    filterOptions,
                    filters,
                  )
                }
