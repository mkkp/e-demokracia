...
// Page name: edemokracia::admin::UserProfile.residentCounty#View
...
/**
 * Name: edemokracia::admin::UserProfile.residentCounty#View
 * Is Access: false
 * Type: View
        ...
        <Grid container spacing={2} direction="column" alignItems="stretch" justifyContent="flex-start">
          <Grid item xs={12} sm={12}>
            <TextField
              required={true}
              name="name"
              id="TextInputedemokraciaAdminAdminEdemokraciaAdminUserProfileResidentCountyViewDefaultCountyViewEditName"
          ...
          <Grid item xs={12} sm={12}>
            <Grid
              id="FlexedemokraciaAdminAdminEdemokraciaAdminUserProfileResidentCountyViewDefaultCountyViewEditCitiesLabelWrapper"
              container
              direction="column"
              alignItems="stretch"
            ...
            >
              <Grid item xs={12} sm={12}>
                <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                  ...
                  <Typography
                    id="LabeledemokraciaAdminAdminEdemokraciaAdminUserProfileResidentCountyViewDefaultCountyViewEditCitiesLabelWrapperCitiesLabel"
                    variant="h5"
                    component="h1"
                  >
              ...
              <Grid item xs={12} sm={12}>
                <Grid
                  id="TableedemokraciaAdminAdminEdemokraciaAdminUserProfileResidentCountyViewDefaultCountyViewEditCitiesLabelWrapperCities"
                  container
                  direction="column"
                  alignItems="stretch"
                  justifyContent="flex-start"
