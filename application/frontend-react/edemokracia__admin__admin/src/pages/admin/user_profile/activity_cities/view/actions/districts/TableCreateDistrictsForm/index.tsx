...
import AdminAdminView from '~/pages/admin/city/districts/view/index';
  ...
  return (
    <>
      <DialogTitle>
        {title}
        <IconButton
          id="CreateActionedemokraciaAdminAdminEdemokraciaAdminUserProfileActivityCitiesViewEdemokraciaAdminAdminEdemokraciaAdminCityDistrictsTableCreate-dialog-close"
          aria-label="close"
          onClick={() => cancel()}
          sx={{
            position: 'absolute',
      ...
      <DialogActions>
        <Button
          id="CreateActionedemokraciaAdminAdminEdemokraciaAdminUserProfileActivityCitiesViewEdemokraciaAdminAdminEdemokraciaAdminCityDistrictsTableCreate-action-form-action-cancel"
          variant="text"
          onClick={() => cancel()}
          disabled={isLoading}
        >
        ...
        <ButtonGroup size="small" ref={anchorRef} aria-label="split button" disabled={isLoading}>
          <LoadingButton
            ...
            id="CreateActionedemokraciaAdminAdminEdemokraciaAdminUserProfileActivityCitiesViewEdemokraciaAdminAdminEdemokraciaAdminCityDistrictsTableCreate-action-form-action-create"
            variant="contained"
            onClick={async () => {
