...
export type AdminCountyCitiesViewPostRefreshAction = (
...
export const ADMIN_COUNTY_CITIES_VIEW_POST_REFRESH_HOOK_INTERFACE_KEY = 'AdminCountyCitiesViewPostRefreshHook';
export type AdminCountyCitiesViewPostRefreshHook = () => AdminCountyCitiesViewPostRefreshAction;
...
export default function AdminCountyCitiesView() {
  ...
  const { service: postRefreshHook } = useTrackService<AdminCountyCitiesViewPostRefreshHook>(
    `(${OBJECTCLASS}=${ADMIN_COUNTY_CITIES_VIEW_POST_REFRESH_HOOK_INTERFACE_KEY})`,
  );
  const postRefreshAction: AdminCountyCitiesViewPostRefreshAction | undefined = postRefreshHook && postRefreshHook();
  ...
  async function deleteData() {
    ...
    try {
      await adminCityServiceForClassImpl.delete(data);
            ...
            >
              <Grid item xs={12} sm={12}>
                <TextField
                  required={true}
                  name="name"
                  id="TextInputedemokraciaAdminAdminEdemokraciaAdminCountyCitiesViewDefaultCityViewEditName"
              ...
              <Grid item xs={12} sm={12}>
                <Grid
                  id="FlexedemokraciaAdminAdminEdemokraciaAdminCountyCitiesViewDefaultCityViewEditDistrictsLabelWrapper"
                  container
                  direction="column"
                  alignItems="stretch"
                  justifyContent="flex-start"
                ...
                >
                  <Grid item xs={12} sm={12}>
                    <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                      ...
                      <Typography
                        id="LabeledemokraciaAdminAdminEdemokraciaAdminCountyCitiesViewDefaultCityViewEditDistrictsLabelWrapperDistrictsLabel"
                        variant="h6"
                        component="h1"
                      >
                  ...
                  <Grid item xs={12} sm={12}>
                    <Grid
                      id="TableedemokraciaAdminAdminEdemokraciaAdminCountyCitiesViewDefaultCityViewEditDistrictsLabelWrapperDistricts"
                      container
                      direction="column"
                      alignItems="stretch"
                      justifyContent="flex-start"
