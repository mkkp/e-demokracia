...
// Page name: edemokracia::admin::Admin.adminCounties#Table
...
/**
 * Name: edemokracia::admin::Admin.adminCounties#Table
 * Is Access: true
 * Is Dashboard: false
 * Type: Table
 **/
export default function AdminAdminAdminCountiesTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaAdminAdminEdemokraciaAdminAdminAdminCountiesTable-data-grid">
