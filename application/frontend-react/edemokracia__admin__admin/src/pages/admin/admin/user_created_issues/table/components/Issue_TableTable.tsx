...
export const ADMIN_ADMIN_USER_CREATED_ISSUES_TABLE_ISSUE_TABLE = 'AdminAdminUserCreatedIssuesTableIssue_Table';
...
export const Issue_TableTable = forwardRef<RefreshableTable, Issue_TableTableProps>((props, ref) => {
  ...
  const filterModelKey = `TableedemokraciaAdminAdminEdemokraciaAdminAdminUserCreatedIssuesTableDefaultUserCreatedIssuesIssueTable-filterModel`;
  const filtersKey = `TableedemokraciaAdminAdminEdemokraciaAdminAdminUserCreatedIssuesTableDefaultUserCreatedIssuesIssueTable-filters`;
  ...
  const userCreatedIssuesColumns: GridColDef<AdminIssueStored>[] = [
    {
      ...baseColumnConfig,
      field: 'scope',
      headerName: t('admin.IssueTable.userCreatedIssues.scope', { defaultValue: 'Scope' }) as string,
    ...
    },
    {
      ...baseColumnConfig,
      field: 'title',
      headerName: t('admin.IssueTable.userCreatedIssues.title', { defaultValue: 'Title' }) as string,
      headerClassName: 'data-grid-column-header',
    ...
    },
    {
      ...baseColumnConfig,
      field: 'status',
      headerName: t('admin.IssueTable.userCreatedIssues.status', { defaultValue: 'Status' }) as string,
      headerClassName: 'data-grid-column-header',
    ...
    },
    {
      ...baseColumnConfig,
      field: 'created',
      headerName: t('admin.IssueTable.userCreatedIssues.created', { defaultValue: 'Created' }) as string,
      headerClassName: 'data-grid-column-header',
    ...
    },
    {
      ...
      headerName: t('admin.IssueTable.userCreatedIssues.numberOfDebates', { defaultValue: 'Debates' }) as string,
      headerClassName: 'data-grid-column-header',
    ...
    },
    {
      ...baseColumnConfig,
      field: 'description',
      headerName: t('admin.IssueTable.userCreatedIssues.description', { defaultValue: 'Description' }) as string,
      headerClassName: 'data-grid-column-header',
  ...
  const userCreatedIssuesRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminAdminUserCreatedIssuesTableDefaultUserCreatedIssuesIssueTableScopeFilter',
      attributeName: 'scope',
      label: t('admin.IssueTable.userCreatedIssues.scope', { defaultValue: 'Scope' }) as string,
      filterType: FilterType.enumeration,
      enumValues: ['GLOBAL', 'COUNTY', 'CITY', 'DISTRICT'],
    },

    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminAdminUserCreatedIssuesTableDefaultUserCreatedIssuesIssueTableTitleFilter',
      attributeName: 'title',
      label: t('admin.IssueTable.userCreatedIssues.title', { defaultValue: 'Title' }) as string,
      filterType: FilterType.string,
    },

    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminAdminUserCreatedIssuesTableDefaultUserCreatedIssuesIssueTableStatusFilter',
      attributeName: 'status',
      label: t('admin.IssueTable.userCreatedIssues.status', { defaultValue: 'Status' }) as string,
      filterType: FilterType.enumeration,
      enumValues: ['CREATED', 'PENDING', 'ACTIVE', 'CLOSED', 'ARCHIVED'],
    },

    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminAdminUserCreatedIssuesTableDefaultUserCreatedIssuesIssueTableCreatedFilter',
      attributeName: 'created',
      label: t('admin.IssueTable.userCreatedIssues.created', { defaultValue: 'Created' }) as string,
      filterType: FilterType.dateTime,
    },

    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminAdminUserCreatedIssuesTableDefaultUserCreatedIssuesIssueTableNumberOfDebatesFilter',
      attributeName: 'numberOfDebates',
      label: t('admin.IssueTable.userCreatedIssues.numberOfDebates', { defaultValue: 'Debates' }) as string,
      filterType: FilterType.numeric,
    },

    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminAdminUserCreatedIssuesTableDefaultUserCreatedIssuesIssueTableDescriptionFilter',
      attributeName: 'description',
      label: t('admin.IssueTable.userCreatedIssues.description', { defaultValue: 'Description' }) as string,
      filterType: FilterType.string,
    },
  ];
  ...
  const rowActions: TableRowAction<AdminIssueStored>[] = [
    {
      id: 'DeleteActionedemokraciaAdminAdminEdemokraciaAdminAdminUserCreatedIssuesTableEdemokraciaAdminAdminEdemokraciaAdminAdminUserCreatedIssuesRowDelete',
      label: t('judo.pages.table.delete', { defaultValue: 'Delete' }) as string,
      icon: <MdiIcon path="delete_forever" />,
      action: async (row: AdminIssueStored) => rowDeleteUserCreatedIssuesAction(row, () => fetchData()),
      disabled: (row: AdminIssueStored) => !row.__deleteable,
    },
    {
      id: 'CallOperationActionedemokraciaAdminAdminEdemokraciaAdminAdminUserCreatedIssuesTableEdemokraciaAdminAdminEdemokraciaAdminIssueCreateDebateButtonCallOperation',
      label: t('admin.IssueTable.userCreatedIssues.createDebate.ButtonCallOperation', {
    ...
    },
    {
      ...
      label: t('admin.IssueTable.userCreatedIssues.createComment.ButtonCallOperation', {
      ...
      <StripedDataGrid
        ...
        columns={[
          ...
          ...columnsActionCalculator(
            'RelationTypeedemokraciaAdminAdminEdemokraciaAdminAdminUserCreatedIssues',
            rowActions,
            t,
            { shownActions: 2 },
          ),
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              <Button
                id="FilterActionedemokraciaAdminAdminEdemokraciaAdminAdminUserCreatedIssuesTableEdemokraciaAdminAdminEdemokraciaAdminAdminUserCreatedIssuesPageFilter"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() => {
                  pageFilterUserCreatedIssuesAction(
                    'FilterActionedemokraciaAdminAdminEdemokraciaAdminAdminUserCreatedIssuesTableEdemokraciaAdminAdminEdemokraciaAdminAdminUserCreatedIssuesPageFilter-filter',
                    filterOptions,
                    filters,
                  );
                }}
              ...
              {isBulkDeleteAvailable() ? (
                <Button
                  id="RelationTypeedemokraciaAdminAdminEdemokraciaAdminAdminUserCreatedIssues-bulk-delete"
                  disabled={isOwnerLoading}
                  variant="text"
