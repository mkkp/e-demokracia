...
// Page name: edemokracia::admin::Admin.userCreatedIssues#Table
...
/**
 * Name: edemokracia::admin::Admin.userCreatedIssues#Table
 * Is Access: true
 * Is Dashboard: false
 * Type: Table
 **/
export default function AdminAdminUserCreatedIssuesTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaAdminAdminEdemokraciaAdminAdminUserCreatedIssuesTable-data-grid">
