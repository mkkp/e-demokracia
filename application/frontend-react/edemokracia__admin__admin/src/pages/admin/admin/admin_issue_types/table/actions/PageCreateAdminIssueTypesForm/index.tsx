...
import AdminAdminView from '~/pages/admin/admin/admin_issue_types/view/index';
...
export default function PageCreateAdminIssueTypesForm({ successCallback, cancel }: PageCreateAdminIssueTypesFormProps) {
  ...
  const submit = async () => {
    ...
    try {
      const res = await adminAdminServiceForAdminIssueTypesImpl.createAdminIssueTypes(payloadDiff);
  ...
  return (
    <>
      <DialogTitle>
        {title}
        <IconButton
          id="CreateActionedemokraciaAdminAdminEdemokraciaAdminAdminAdminIssueTypesTableEdemokraciaAdminAdminEdemokraciaAdminAdminAdminIssueTypesPageCreate-dialog-close"
          aria-label="close"
          onClick={() => cancel()}
          sx={{
            position: 'absolute',
      ...
      <DialogContent dividers>
        <Grid container spacing={2} direction="column" alignItems="stretch" justifyContent="flex-start">
          <Grid item xs={12} sm={12}>
            <Card id="FlexedemokraciaAdminAdminEdemokraciaAdminAdminAdminIssueTypesCreateDefaultIssueTypeFormGroup">
              <CardContent>
                <Grid container direction="column" alignItems="stretch" justifyContent="flex-start" spacing={2}>
                  <Grid item xs={12} sm={12}>
                    <TextField
                      required={true}
                      name="title"
                      id="TextInputedemokraciaAdminAdminEdemokraciaAdminAdminAdminIssueTypesCreateDefaultIssueTypeFormGroupTitle"
                      autoFocus
                  ...
                  <Grid item xs={12} sm={12}>
                    <TextField
                      required={false}
                      name="voteType"
                      id="EnumerationComboedemokraciaAdminAdminEdemokraciaAdminAdminAdminIssueTypesCreateDefaultIssueTypeFormGroupVoteType"
                  ...
                  <Grid item xs={12} sm={12}>
                    <TextField
                      required={true}
                      name="description"
                      id="TextAreaedemokraciaAdminAdminEdemokraciaAdminAdminAdminIssueTypesCreateDefaultIssueTypeFormGroupDescription"
      ...
      <DialogActions>
        <Button
          id="CreateActionedemokraciaAdminAdminEdemokraciaAdminAdminAdminIssueTypesTableEdemokraciaAdminAdminEdemokraciaAdminAdminAdminIssueTypesPageCreate-action-form-action-cancel"
          variant="text"
          onClick={() => cancel()}
          disabled={isLoading}
        >
        ...
        <ButtonGroup size="small" ref={anchorRef} aria-label="split button" disabled={isLoading}>
          <LoadingButton
            ...
            id="CreateActionedemokraciaAdminAdminEdemokraciaAdminAdminAdminIssueTypesTableEdemokraciaAdminAdminEdemokraciaAdminAdminAdminIssueTypesPageCreate-action-form-action-create"
            variant="contained"
            onClick={async () => {
