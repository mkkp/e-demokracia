...
// Page name: edemokracia::admin::Admin.adminIssueTypes#Table
...
/**
 * Name: edemokracia::admin::Admin.adminIssueTypes#Table
 * Is Access: true
 * Is Dashboard: false
 * Type: Table
 **/
export default function AdminAdminAdminIssueTypesTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaAdminAdminEdemokraciaAdminAdminAdminIssueTypesTable-data-grid">
