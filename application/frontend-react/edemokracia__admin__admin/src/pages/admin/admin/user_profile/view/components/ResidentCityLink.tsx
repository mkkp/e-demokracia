...
export type ResidentCityLinkFilterInitializer = (ownerData: AdminUserProfileStored) => Filter[] | undefined;
...
export function ResidentCityLink(props: ResidentCityLinkProps) {
  ...
  const residentCityColumns: GridColDef<AdminCityStored>[] = [
    {
      ...
      headerName: t('admin.UserProfileView.residentCity.representation', { defaultValue: 'City' }) as string,
  ...
  const residentCityRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminAdminUserProfileViewDefaultUserProfileViewEditAreasLabelWrapperAreasResidencyResidentCityRepresentationFilter',
      attributeName: 'representation',
      label: t('admin.UserProfileView.residentCity.representation', { defaultValue: 'City' }) as string,
  ...
  return (
    <AggregationInput
      name="residentCity"
      id="LinkedemokraciaAdminAdminEdemokraciaAdminAdminUserProfileViewDefaultUserProfileViewEditAreasLabelWrapperAreasResidencyResidentCity"
      label={t('admin.UserProfileView.residentCity', { defaultValue: 'Resident city' }) as string}
