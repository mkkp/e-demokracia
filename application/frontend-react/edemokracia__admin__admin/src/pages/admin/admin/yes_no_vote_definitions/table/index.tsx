...
// Page name: edemokracia::admin::Admin.yesNoVoteDefinitions#Table
...
/**
 * Name: edemokracia::admin::Admin.yesNoVoteDefinitions#Table
 * Is Access: true
 * Is Dashboard: false
 * Type: Table
 **/
export default function AdminAdminYesNoVoteDefinitionsTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaAdminAdminEdemokraciaAdminAdminYesNoVoteDefinitionsTable-data-grid">
