...
import { routeToAdminAdminAdminIssuesView } from '~/routes';

export const ROW_VIEW_ADMIN_ISSUES_ACTION_INTERFACE_KEY = 'RowViewAdminIssuesAction';
export type RowViewAdminIssuesAction = () => (entry: AdminIssueStored, successCallback: () => void) => Promise<void>;
...
export const useRowViewAdminIssuesAction: RowViewAdminIssuesAction = () => {
  ...
  return async function (entry: AdminIssueStored, successCallback: () => void) {
    closeAllDialogs();
    navigate(routeToAdminAdminAdminIssuesView(entry.__signedIdentifier));
  };
};
