...
export function OwnerLink(props: OwnerLinkProps) {
  ...
  const ownerRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminAdminAdminIssuesViewDefaultIssueViewEditIssueLabelWrapperIssueOwnerRepresentationFilter',
  ...
  return (
    <AggregationInput
      name="owner"
      id="LinkedemokraciaAdminAdminEdemokraciaAdminAdminAdminIssuesViewDefaultIssueViewEditIssueLabelWrapperIssueOwner"
