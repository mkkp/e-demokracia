...
// Page name: edemokracia::admin::Admin.adminIssues#Table
...
/**
 * Name: edemokracia::admin::Admin.adminIssues#Table
 * Is Access: true
 * Is Dashboard: false
 * Type: Table
 **/
export default function AdminAdminAdminIssuesTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaAdminAdminEdemokraciaAdminAdminAdminIssuesTable-data-grid">
