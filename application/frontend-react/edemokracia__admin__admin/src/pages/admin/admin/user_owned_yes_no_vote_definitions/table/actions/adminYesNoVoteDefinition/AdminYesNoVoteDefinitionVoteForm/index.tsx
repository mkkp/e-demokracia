...
import { yesNoVoteInputServiceForClassImpl, adminYesNoVoteDefinitionServiceForClassImpl } from '~/generated/data-axios';

export interface AdminYesNoVoteDefinitionVoteFormProps {
  successCallback: () => void;
  cancel: () => void;
  owner: AdminYesNoVoteDefinitionStored;
}

export default function AdminYesNoVoteDefinitionVoteForm({
  successCallback,
  cancel,
  owner,
}: AdminYesNoVoteDefinitionVoteFormProps) {
  ...
  const handleActionError = useErrorHandler<YesNoVoteInput>(
    `(&(${OBJECTCLASS}=${ERROR_PROCESSOR_HOOK_INTERFACE_KEY})(operation=CallOperation)(component=AdminYesNoVoteDefinitionVoteForm))`,
  );
  ...
  const submit = async () => {
    ...
    try {
      await adminYesNoVoteDefinitionServiceForClassImpl.vote(owner, payloadDiff);
  ...
  return (
    <>
      <DialogTitle>
        {title}
        <IconButton
          id="CallOperationActionedemokraciaAdminAdminEdemokraciaAdminAdminUserOwnedYesNoVoteDefinitionsTableEdemokraciaAdminAdminEdemokraciaAdminYesNoVoteDefinitionVoteButtonCallOperation-dialog-close"
          aria-label="close"
          onClick={() => cancel()}
          sx={{
            position: 'absolute',
        ...
        <Grid container spacing={2} direction="column" alignItems="stretch" justifyContent="flex-start">
          <Grid item xs={12} sm={12}>
            <TextField
              required={false}
              name="value"
              id="EnumerationComboedemokraciaAdminAdminEdemokraciaAdminYesNoVoteDefinitionVoteInputDefaultYesNoVoteInputFormValue"
              autoFocus
      ...
      <DialogActions>
        <Button
          id="CallOperationActionedemokraciaAdminAdminEdemokraciaAdminAdminUserOwnedYesNoVoteDefinitionsTableEdemokraciaAdminAdminEdemokraciaAdminYesNoVoteDefinitionVoteButtonCallOperation-action-form-action-cancel"
          variant="text"
          onClick={() => cancel()}
          disabled={isLoading}
        ...
        <LoadingButton
          ...
          id="CallOperationActionedemokraciaAdminAdminEdemokraciaAdminAdminUserOwnedYesNoVoteDefinitionsTableEdemokraciaAdminAdminEdemokraciaAdminYesNoVoteDefinitionVoteButtonCallOperation-action-form-action-submit"
          variant="contained"
          onClick={() => submit()}
