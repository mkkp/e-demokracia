...
import { routeToAdminYesNoVoteDefinitionIssueView } from '~/routes';
...
export const useButtonNavigateIssueAction: ButtonNavigateIssueAction = () => {
  ...
  return async function (owner: JudoIdentifiable<AdminYesNoVoteDefinition>, target: JudoIdentifiable<AdminIssue>) {
    navigate(routeToAdminYesNoVoteDefinitionIssueView(target.__signedIdentifier));
  };
};
