...
// Page name: edemokracia::admin::Admin.userOwnedYesNoVoteDefinitions#Table
...
/**
 * Name: edemokracia::admin::Admin.userOwnedYesNoVoteDefinitions#Table
 * Is Access: true
 * Is Dashboard: false
 * Type: Table
 **/
export default function AdminAdminUserOwnedYesNoVoteDefinitionsTable() {
  const tableRef = useRef<RefreshableTable>(null);
  const { t } = useTranslation();
  const { locale: l10nLocale } = useL10N();
  const [isLoading, setIsLoading] = useState<boolean>(false);
  const title: string = t('admin.YesNoVoteDefinitionTable', { defaultValue: 'YesNoVoteDefinition Table' });
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaAdminAdminEdemokraciaAdminAdminUserOwnedYesNoVoteDefinitionsTable-data-grid">
