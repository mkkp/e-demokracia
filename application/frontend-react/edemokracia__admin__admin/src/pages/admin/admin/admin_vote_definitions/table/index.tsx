...
// Page name: edemokracia::admin::Admin.adminVoteDefinitions#Table
...
/**
 * Name: edemokracia::admin::Admin.adminVoteDefinitions#Table
 * Is Access: true
 * Is Dashboard: false
 * Type: Table
 **/
export default function AdminAdminAdminVoteDefinitionsTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaAdminAdminEdemokraciaAdminAdminAdminVoteDefinitionsTable-data-grid">
