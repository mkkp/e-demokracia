...
import { routeToAdminVoteDefinitionIssueView } from '~/routes';
...
export const useButtonNavigateIssueAction: ButtonNavigateIssueAction = () => {
  ...
  return async function (owner: JudoIdentifiable<AdminVoteDefinition>, target: JudoIdentifiable<AdminIssue>) {
    navigate(routeToAdminVoteDefinitionIssueView(target.__signedIdentifier));
  };
};
