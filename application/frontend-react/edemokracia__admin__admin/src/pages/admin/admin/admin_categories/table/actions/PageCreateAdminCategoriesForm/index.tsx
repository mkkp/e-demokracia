...
import AdminAdminView from '~/pages/admin/admin/admin_categories/view/index';
...
export function PageCreateAdminCategoriesForm({ successCallback, cancel }: PageCreateAdminCategoriesFormProps) {
  ...
  const submit = async () => {
    ...
    try {
      const res = await adminAdminServiceForAdminCategoriesImpl.createAdminCategories(payloadDiff);
  ...
  return (
    <>
      <DialogTitle>
        {title}
        <IconButton
          id="CreateActionedemokraciaAdminAdminEdemokraciaAdminAdminAdminCategoriesTableEdemokraciaAdminAdminEdemokraciaAdminAdminAdminCategoriesPageCreate-dialog-close"
          aria-label="close"
          onClick={() => cancel()}
          sx={{
            position: 'absolute',
        ...
        <Grid container spacing={2} direction="column" alignItems="stretch" justifyContent="flex-start">
          <Grid item xs={12} sm={12}>
            <TextField
              required={true}
              name="title"
              id="TextInputedemokraciaAdminAdminEdemokraciaAdminAdminAdminCategoriesCreateDefaultIssueCategoryFormTitle"
              autoFocus
          ...
          <Grid item xs={12} sm={12}>
            <TextField
              required={true}
              name="description"
              id="TextInputedemokraciaAdminAdminEdemokraciaAdminAdminAdminCategoriesCreateDefaultIssueCategoryFormDescription"
      ...
      <DialogActions>
        <Button
          id="CreateActionedemokraciaAdminAdminEdemokraciaAdminAdminAdminCategoriesTableEdemokraciaAdminAdminEdemokraciaAdminAdminAdminCategoriesPageCreate-action-form-action-cancel"
          variant="text"
          onClick={() => cancel()}
          disabled={isLoading}
        >
        ...
        <ButtonGroup size="small" ref={anchorRef} aria-label="split button" disabled={isLoading}>
          <LoadingButton
            ...
            id="CreateActionedemokraciaAdminAdminEdemokraciaAdminAdminAdminCategoriesTableEdemokraciaAdminAdminEdemokraciaAdminAdminAdminCategoriesPageCreate-action-form-action-create"
            variant="contained"
            onClick={async () => {
