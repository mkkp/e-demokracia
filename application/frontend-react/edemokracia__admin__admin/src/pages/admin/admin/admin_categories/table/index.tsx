...
// Page name: edemokracia::admin::Admin.adminCategories#Table
...
/**
 * Name: edemokracia::admin::Admin.adminCategories#Table
 * Is Access: true
 * Is Dashboard: false
 * Type: Table
 **/
export default function AdminAdminAdminCategoriesTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaAdminAdminEdemokraciaAdminAdminAdminCategoriesTable-data-grid">
