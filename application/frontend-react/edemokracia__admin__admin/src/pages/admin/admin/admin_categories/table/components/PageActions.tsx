...
import { usePageCreateAdminCategoriesAction, usePageRefreshAdminCategoriesAction } from '../actions';
    ...
    <>
      <Grid className="page-action" item>
        <Button
          ...
          onClick={() => pageCreateAdminCategoriesAction(() => fetchData())}
          disabled={isLoading}
        >
      ...
      <Grid className="page-action" item>
        <LoadingButton
          ...
          onClick={() => pageRefreshAdminCategoriesAction(() => fetchData())}
          disabled={isLoading}
        >
