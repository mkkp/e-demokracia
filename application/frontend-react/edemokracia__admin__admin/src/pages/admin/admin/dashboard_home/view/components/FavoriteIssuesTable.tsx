...
export const ADMIN_ADMIN_DASHBOARD_HOME_VIEW_FAVORITE_ISSUES = 'AdminAdminDashboardHomeViewFavoriteIssues';
...
export const FavoriteIssuesTable = forwardRef<RefreshableTable, FavoriteIssuesTableProps>((props, ref) => {
  ...
  const filterModelKey = `TableedemokraciaAdminAdminEdemokraciaAdminAdminDashboardHomeViewDefaultDashboardViewEditSelectorIssuesIssuesIssueTabBarFavoriteIssuesFavoriteIssuesFavoriteIssuesLabelWrapperFavoriteIssues-${ownerData.__signedIdentifier}-filterModel`;
  const filtersKey = `TableedemokraciaAdminAdminEdemokraciaAdminAdminDashboardHomeViewDefaultDashboardViewEditSelectorIssuesIssuesIssueTabBarFavoriteIssuesFavoriteIssuesFavoriteIssuesLabelWrapperFavoriteIssues-${ownerData.__signedIdentifier}-filters`;
  ...
  const favoriteIssuesColumns: GridColDef<AdminIssueStored>[] = [
    {
      ...baseColumnConfig,
      field: 'scope',
      headerName: t('admin.DashboardView.favoriteIssues.scope', { defaultValue: 'Scope' }) as string,
    ...
    },
    {
      ...
      headerName: t('admin.DashboardView.favoriteIssues.countyRepresentation', {
    ...
    },
    {
      ...
      headerName: t('admin.DashboardView.favoriteIssues.cityRepresentation', {
    ...
    },
    {
      ...
      headerName: t('admin.DashboardView.favoriteIssues.districtRepresentation', {
    ...
    },
    {
      ...baseColumnConfig,
      field: 'title',
      headerName: t('admin.DashboardView.favoriteIssues.title', { defaultValue: 'Title' }) as string,
      headerClassName: 'data-grid-column-header',
    ...
    },
    {
      ...baseColumnConfig,
      field: 'created',
      headerName: t('admin.DashboardView.favoriteIssues.created', { defaultValue: 'Created' }) as string,
      headerClassName: 'data-grid-column-header',
    ...
    },
    {
      ...
      headerName: t('admin.DashboardView.favoriteIssues.numberOfDebates', {
    ...
    },
    {
      ...baseColumnConfig,
      field: 'status',
      headerName: t('admin.DashboardView.favoriteIssues.status', { defaultValue: 'Status' }) as string,
      headerClassName: 'data-grid-column-header',
  ...
  const favoriteIssuesRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminAdminDashboardHomeViewDefaultDashboardViewEditSelectorIssuesIssuesIssueTabBarFavoriteIssuesFavoriteIssuesFavoriteIssuesLabelWrapperFavoriteIssuesScopeFilter',
      attributeName: 'scope',
      label: t('admin.DashboardView.favoriteIssues.scope', { defaultValue: 'Scope' }) as string,
      filterType: FilterType.enumeration,
      enumValues: ['GLOBAL', 'COUNTY', 'CITY', 'DISTRICT'],
    },

    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminAdminDashboardHomeViewDefaultDashboardViewEditSelectorIssuesIssuesIssueTabBarFavoriteIssuesFavoriteIssuesFavoriteIssuesLabelWrapperFavoriteIssuesCountyRepresentationFilter',
      attributeName: 'countyRepresentation',
      label: t('admin.DashboardView.favoriteIssues.countyRepresentation', {
        defaultValue: 'CountyRepresentation',
      }) as string,
    ...
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminAdminDashboardHomeViewDefaultDashboardViewEditSelectorIssuesIssuesIssueTabBarFavoriteIssuesFavoriteIssuesFavoriteIssuesLabelWrapperFavoriteIssuesCityRepresentationFilter',
      attributeName: 'cityRepresentation',
      label: t('admin.DashboardView.favoriteIssues.cityRepresentation', {
        defaultValue: 'CityRepresentation',
      }) as string,
      filterType: FilterType.string,
    },
    ...
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminAdminDashboardHomeViewDefaultDashboardViewEditSelectorIssuesIssuesIssueTabBarFavoriteIssuesFavoriteIssuesFavoriteIssuesLabelWrapperFavoriteIssuesDistrictRepresentationFilter',
      attributeName: 'districtRepresentation',
      label: t('admin.DashboardView.favoriteIssues.districtRepresentation', {
        defaultValue: 'DistrictRepresentation',
      }) as string,
      filterType: FilterType.string,
    },
    ...
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminAdminDashboardHomeViewDefaultDashboardViewEditSelectorIssuesIssuesIssueTabBarFavoriteIssuesFavoriteIssuesFavoriteIssuesLabelWrapperFavoriteIssuesTitleFilter',
      attributeName: 'title',
      label: t('admin.DashboardView.favoriteIssues.title', { defaultValue: 'Title' }) as string,
      filterType: FilterType.string,
    },

    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminAdminDashboardHomeViewDefaultDashboardViewEditSelectorIssuesIssuesIssueTabBarFavoriteIssuesFavoriteIssuesFavoriteIssuesLabelWrapperFavoriteIssuesCreatedFilter',
      attributeName: 'created',
      label: t('admin.DashboardView.favoriteIssues.created', { defaultValue: 'Created' }) as string,
      filterType: FilterType.dateTime,
    },

    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminAdminDashboardHomeViewDefaultDashboardViewEditSelectorIssuesIssuesIssueTabBarFavoriteIssuesFavoriteIssuesFavoriteIssuesLabelWrapperFavoriteIssuesNumberOfDebatesFilter',
      attributeName: 'numberOfDebates',
      label: t('admin.DashboardView.favoriteIssues.numberOfDebates', { defaultValue: 'NumberOfDebates' }) as string,
      filterType: FilterType.numeric,
    },

    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminAdminDashboardHomeViewDefaultDashboardViewEditSelectorIssuesIssuesIssueTabBarFavoriteIssuesFavoriteIssuesFavoriteIssuesLabelWrapperFavoriteIssuesStatusFilter',
      attributeName: 'status',
      label: t('admin.DashboardView.favoriteIssues.status', { defaultValue: 'Status' }) as string,
      filterType: FilterType.enumeration,
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              <Button
                id="FilterRelationActionedemokraciaAdminAdminEdemokraciaAdminAdminDashboardHomeViewEdemokraciaAdminAdminEdemokraciaAdminDashboardFavoriteIssuesTableAction"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() => {
                  tableActionFavoriteIssuesAction(
                    'FilterRelationActionedemokraciaAdminAdminEdemokraciaAdminAdminDashboardHomeViewEdemokraciaAdminAdminEdemokraciaAdminDashboardFavoriteIssuesTableAction-filter',
                    filterOptions,
                    filters,
                  );
                }}
