...
export const ADMIN_ADMIN_DASHBOARD_HOME_DASHBOARD_FAVORITE_DEBATES = 'AdminAdminDashboardHomeDashboardFavoriteDebates';
...
export const FavoriteDebatesTable = forwardRef<RefreshableTable, FavoriteDebatesTableProps>((props, ref) => {
  ...
  const filterModelKey = `TableedemokraciaAdminAdminEdemokraciaAdminAdminDashboardHomeDashboardDefaultDashboardViewEditSelectorDebatesDebatesDebateTabBarFavoriteDebatesFavoriteDebatesFavoriteDebatesLabelWrapperFavoriteDebates-${ownerData.__signedIdentifier}-filterModel`;
  const filtersKey = `TableedemokraciaAdminAdminEdemokraciaAdminAdminDashboardHomeDashboardDefaultDashboardViewEditSelectorDebatesDebatesDebateTabBarFavoriteDebatesFavoriteDebatesFavoriteDebatesLabelWrapperFavoriteDebates-${ownerData.__signedIdentifier}-filters`;
  ...
  const [queryCustomizer, setQueryCustomizer] = useState<AdminDebateQueryCustomizer>({
    _mask: '{title,closeAt,status,issueTitle,isNotClosed,isNotFavorite,isFavorite}',
    _seek: {
      limit: 10 + 1,
    },
  ...
  const favoriteDebatesColumns: GridColDef<AdminDebateStored>[] = [
    {
      ...baseColumnConfig,
      field: 'title',
      headerName: t('edemokracia.admin.Admin.dashboardHome.Dashboard.favoriteDebates.title', {
        defaultValue: 'Title',
      }) as string,
    ...
    },
    {
      ...baseColumnConfig,
      field: 'closeAt',
      headerName: t('edemokracia.admin.Admin.dashboardHome.Dashboard.favoriteDebates.closeAt', {
    ...
    },
    {
      ...baseColumnConfig,
      field: 'status',
      headerName: t('edemokracia.admin.Admin.dashboardHome.Dashboard.favoriteDebates.status', {
        defaultValue: 'Status',
      }) as string,
      headerClassName: 'data-grid-column-header',
    ...
    },
    {
      ...baseColumnConfig,
      field: 'issueTitle',
      headerName: t('edemokracia.admin.Admin.dashboardHome.Dashboard.favoriteDebates.issueTitle', {
  ...
  const favoriteDebatesRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminAdminDashboardHomeDashboardDefaultDashboardViewEditSelectorDebatesDebatesDebateTabBarFavoriteDebatesFavoriteDebatesFavoriteDebatesLabelWrapperFavoriteDebatesTitleFilter',
      attributeName: 'title',
      label: t('edemokracia.admin.Admin.dashboardHome.Dashboard.favoriteDebates.title', {
        defaultValue: 'Title',
      }) as string,
    ...
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminAdminDashboardHomeDashboardDefaultDashboardViewEditSelectorDebatesDebatesDebateTabBarFavoriteDebatesFavoriteDebatesFavoriteDebatesLabelWrapperFavoriteDebatesCloseAtFilter',
      attributeName: 'closeAt',
      label: t('edemokracia.admin.Admin.dashboardHome.Dashboard.favoriteDebates.closeAt', {
        defaultValue: 'CloseAt',
      }) as string,
    ...
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminAdminDashboardHomeDashboardDefaultDashboardViewEditSelectorDebatesDebatesDebateTabBarFavoriteDebatesFavoriteDebatesFavoriteDebatesLabelWrapperFavoriteDebatesStatusFilter',
      attributeName: 'status',
      label: t('edemokracia.admin.Admin.dashboardHome.Dashboard.favoriteDebates.status', {
        defaultValue: 'Status',
      }) as string,
    ...
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminAdminDashboardHomeDashboardDefaultDashboardViewEditSelectorDebatesDebatesDebateTabBarFavoriteDebatesFavoriteDebatesFavoriteDebatesLabelWrapperFavoriteDebatesIssueTitleFilter',
      attributeName: 'issueTitle',
      label: t('edemokracia.admin.Admin.dashboardHome.Dashboard.favoriteDebates.issueTitle', {
        defaultValue: 'IssueTitle',
      }) as string,
      filterType: FilterType.string,
    },
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              <Button
                id="FilterRelationActionedemokraciaAdminAdminEdemokraciaAdminAdminDashboardHomeDashboardEdemokraciaAdminAdminEdemokraciaAdminDashboardFavoriteDebatesTableAction"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() => {
                  tableActionFavoriteDebatesAction(
                    'FilterRelationActionedemokraciaAdminAdminEdemokraciaAdminAdminDashboardHomeDashboardEdemokraciaAdminAdminEdemokraciaAdminDashboardFavoriteDebatesTableAction-filter',
                    filterOptions,
                    filters,
                  );
                }}
