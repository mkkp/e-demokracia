...
export const ADMIN_ADMIN_DASHBOARD_HOME_DASHBOARD_OWNED_ISSUES = 'AdminAdminDashboardHomeDashboardOwnedIssues';
...
export const OwnedIssuesTable = forwardRef<RefreshableTable, OwnedIssuesTableProps>((props, ref) => {
  ...
  const filterModelKey = `TableedemokraciaAdminAdminEdemokraciaAdminAdminDashboardHomeDashboardDefaultDashboardViewEditSelectorIssuesIssuesIssueTabBarMyissuesMyissuesOwnedIssuesLabelWrapperOwnedIssues-${ownerData.__signedIdentifier}-filterModel`;
  const filtersKey = `TableedemokraciaAdminAdminEdemokraciaAdminAdminDashboardHomeDashboardDefaultDashboardViewEditSelectorIssuesIssuesIssueTabBarMyissuesMyissuesOwnedIssuesLabelWrapperOwnedIssues-${ownerData.__signedIdentifier}-filters`;
  ...
  const issuesOwnedColumns: GridColDef<AdminIssueStored>[] = [
    {
      ...baseColumnConfig,
      field: 'scope',
      headerName: t('edemokracia.admin.Admin.dashboardHome.Dashboard.issuesOwned.scope', {
        defaultValue: 'Scope',
      }) as string,
    ...
    },
    {
      ...
      headerName: t('edemokracia.admin.Admin.dashboardHome.Dashboard.issuesOwned.countyRepresentation', {
    ...
    },
    {
      ...
      headerName: t('edemokracia.admin.Admin.dashboardHome.Dashboard.issuesOwned.cityRepresentation', {
    ...
    },
    {
      ...
      headerName: t('edemokracia.admin.Admin.dashboardHome.Dashboard.issuesOwned.districtRepresentation', {
  ...
  const issuesOwnedRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminAdminDashboardHomeDashboardDefaultDashboardViewEditSelectorIssuesIssuesIssueTabBarMyissuesMyissuesOwnedIssuesLabelWrapperOwnedIssuesScopeFilter',
      attributeName: 'scope',
      label: t('edemokracia.admin.Admin.dashboardHome.Dashboard.issuesOwned.scope', {
        defaultValue: 'Scope',
      }) as string,
    ...
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminAdminDashboardHomeDashboardDefaultDashboardViewEditSelectorIssuesIssuesIssueTabBarMyissuesMyissuesOwnedIssuesLabelWrapperOwnedIssuesCountyRepresentationFilter',
      attributeName: 'countyRepresentation',
      label: t('edemokracia.admin.Admin.dashboardHome.Dashboard.issuesOwned.countyRepresentation', {
        defaultValue: 'CountyRepresentation',
      }) as string,
    ...
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminAdminDashboardHomeDashboardDefaultDashboardViewEditSelectorIssuesIssuesIssueTabBarMyissuesMyissuesOwnedIssuesLabelWrapperOwnedIssuesCityRepresentationFilter',
      attributeName: 'cityRepresentation',
      label: t('edemokracia.admin.Admin.dashboardHome.Dashboard.issuesOwned.cityRepresentation', {
        defaultValue: 'CityRepresentation',
      }) as string,
      filterType: FilterType.string,
    },
    ...
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminAdminDashboardHomeDashboardDefaultDashboardViewEditSelectorIssuesIssuesIssueTabBarMyissuesMyissuesOwnedIssuesLabelWrapperOwnedIssuesDistrictRepresentationFilter',
      attributeName: 'districtRepresentation',
      label: t('edemokracia.admin.Admin.dashboardHome.Dashboard.issuesOwned.districtRepresentation', {
        defaultValue: 'DistrictRepresentation',
      }) as string,
      filterType: FilterType.string,
    },
    ...
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminAdminDashboardHomeDashboardDefaultDashboardViewEditSelectorIssuesIssuesIssueTabBarMyissuesMyissuesOwnedIssuesLabelWrapperOwnedIssuesTitleFilter',
      attributeName: 'title',
    ...
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminAdminDashboardHomeDashboardDefaultDashboardViewEditSelectorIssuesIssuesIssueTabBarMyissuesMyissuesOwnedIssuesLabelWrapperOwnedIssuesCreatedFilter',
    ...
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminAdminDashboardHomeDashboardDefaultDashboardViewEditSelectorIssuesIssuesIssueTabBarMyissuesMyissuesOwnedIssuesLabelWrapperOwnedIssuesNumberOfDebatesFilter',
    ...
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminAdminDashboardHomeDashboardDefaultDashboardViewEditSelectorIssuesIssuesIssueTabBarMyissuesMyissuesOwnedIssuesLabelWrapperOwnedIssuesStatusFilter',
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              <Button
                id="FilterRelationActionedemokraciaAdminAdminEdemokraciaAdminAdminDashboardHomeDashboardEdemokraciaAdminAdminEdemokraciaAdminDashboardIssuesOwnedTableAction"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() => {
                  tableActionIssuesOwnedAction(
                    'FilterRelationActionedemokraciaAdminAdminEdemokraciaAdminAdminDashboardHomeDashboardEdemokraciaAdminAdminEdemokraciaAdminDashboardIssuesOwnedTableAction-filter',
                    filterOptions,
                    filters,
                  );
                }}
