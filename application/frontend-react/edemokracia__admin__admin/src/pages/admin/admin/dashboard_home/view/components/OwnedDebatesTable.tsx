...
export const ADMIN_ADMIN_DASHBOARD_HOME_VIEW_OWNED_DEBATES = 'AdminAdminDashboardHomeViewOwnedDebates';
...
export const OwnedDebatesTable = forwardRef<RefreshableTable, OwnedDebatesTableProps>((props, ref) => {
  ...
  const filterModelKey = `TableedemokraciaAdminAdminEdemokraciaAdminAdminDashboardHomeViewDefaultDashboardViewEditSelectorDebatesDebatesDebateTabBarMydebatesMydebatesOwnedDebatesLabelWrapperOwnedDebates-${ownerData.__signedIdentifier}-filterModel`;
  const filtersKey = `TableedemokraciaAdminAdminEdemokraciaAdminAdminDashboardHomeViewDefaultDashboardViewEditSelectorDebatesDebatesDebateTabBarMydebatesMydebatesOwnedDebatesLabelWrapperOwnedDebates-${ownerData.__signedIdentifier}-filters`;
  ...
  const ownedDebatesColumns: GridColDef<AdminDebateStored>[] = [
    {
      ...baseColumnConfig,
      field: 'scope',
      headerName: t('admin.DashboardView.ownedDebates.scope', { defaultValue: 'Scope' }) as string,
    ...
    },
    {
      ...
      headerName: t('admin.DashboardView.ownedDebates.countyRepresentation', {
    ...
    },
    {
      ...
      headerName: t('admin.DashboardView.ownedDebates.cityRepresentation', {
    ...
    },
    {
      ...
      headerName: t('admin.DashboardView.ownedDebates.districtRepresentation', {
    ...
    },
    {
      ...baseColumnConfig,
      field: 'title',
      headerName: t('admin.DashboardView.ownedDebates.title', { defaultValue: 'Title' }) as string,
      headerClassName: 'data-grid-column-header',
    ...
    },
    {
      ...baseColumnConfig,
      field: 'closeAt',
      headerName: t('admin.DashboardView.ownedDebates.closeAt', { defaultValue: 'CloseAt' }) as string,
      headerClassName: 'data-grid-column-header',
    ...
    },
    {
      ...baseColumnConfig,
      field: 'status',
      headerName: t('admin.DashboardView.ownedDebates.status', { defaultValue: 'Status' }) as string,
      headerClassName: 'data-grid-column-header',
    ...
    },
    {
      ...baseColumnConfig,
      field: 'issueTitle',
      headerName: t('admin.DashboardView.ownedDebates.issueTitle', { defaultValue: 'IssueTitle' }) as string,
      headerClassName: 'data-grid-column-header',
  ...
  const ownedDebatesRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminAdminDashboardHomeViewDefaultDashboardViewEditSelectorDebatesDebatesDebateTabBarMydebatesMydebatesOwnedDebatesLabelWrapperOwnedDebatesScopeFilter',
      attributeName: 'scope',
      label: t('admin.DashboardView.ownedDebates.scope', { defaultValue: 'Scope' }) as string,
      filterType: FilterType.enumeration,
      enumValues: ['GLOBAL', 'COUNTY', 'CITY', 'DISTRICT'],
    },

    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminAdminDashboardHomeViewDefaultDashboardViewEditSelectorDebatesDebatesDebateTabBarMydebatesMydebatesOwnedDebatesLabelWrapperOwnedDebatesCountyRepresentationFilter',
      attributeName: 'countyRepresentation',
      label: t('admin.DashboardView.ownedDebates.countyRepresentation', {
        defaultValue: 'CountyRepresentation',
      }) as string,
    ...
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminAdminDashboardHomeViewDefaultDashboardViewEditSelectorDebatesDebatesDebateTabBarMydebatesMydebatesOwnedDebatesLabelWrapperOwnedDebatesCityRepresentationFilter',
      attributeName: 'cityRepresentation',
      label: t('admin.DashboardView.ownedDebates.cityRepresentation', { defaultValue: 'CityRepresentation' }) as string,
      filterType: FilterType.string,
    },

    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminAdminDashboardHomeViewDefaultDashboardViewEditSelectorDebatesDebatesDebateTabBarMydebatesMydebatesOwnedDebatesLabelWrapperOwnedDebatesDistrictRepresentationFilter',
      attributeName: 'districtRepresentation',
      label: t('admin.DashboardView.ownedDebates.districtRepresentation', {
        defaultValue: 'DistrictRepresentation',
      }) as string,
      filterType: FilterType.string,
    },
    ...
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminAdminDashboardHomeViewDefaultDashboardViewEditSelectorDebatesDebatesDebateTabBarMydebatesMydebatesOwnedDebatesLabelWrapperOwnedDebatesTitleFilter',
      attributeName: 'title',
      label: t('admin.DashboardView.ownedDebates.title', { defaultValue: 'Title' }) as string,
      filterType: FilterType.string,
    },

    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminAdminDashboardHomeViewDefaultDashboardViewEditSelectorDebatesDebatesDebateTabBarMydebatesMydebatesOwnedDebatesLabelWrapperOwnedDebatesCloseAtFilter',
      attributeName: 'closeAt',
      label: t('admin.DashboardView.ownedDebates.closeAt', { defaultValue: 'CloseAt' }) as string,
      filterType: FilterType.dateTime,
    },

    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminAdminDashboardHomeViewDefaultDashboardViewEditSelectorDebatesDebatesDebateTabBarMydebatesMydebatesOwnedDebatesLabelWrapperOwnedDebatesStatusFilter',
    ...
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminAdminDashboardHomeViewDefaultDashboardViewEditSelectorDebatesDebatesDebateTabBarMydebatesMydebatesOwnedDebatesLabelWrapperOwnedDebatesIssueTitleFilter',
      attributeName: 'issueTitle',
      label: t('admin.DashboardView.ownedDebates.issueTitle', { defaultValue: 'IssueTitle' }) as string,
      filterType: FilterType.string,
    },
  ];
  ...
  const rowActions: TableRowAction<AdminDebateStored>[] = [
    {
      id: 'DeleteActionedemokraciaAdminAdminEdemokraciaAdminAdminDashboardHomeViewEdemokraciaAdminAdminEdemokraciaAdminDashboardOwnedDebatesRowDelete',
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              <Button
                id="FilterRelationActionedemokraciaAdminAdminEdemokraciaAdminAdminDashboardHomeViewEdemokraciaAdminAdminEdemokraciaAdminDashboardOwnedDebatesTableAction"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() => {
                  tableActionOwnedDebatesAction(
                    'FilterRelationActionedemokraciaAdminAdminEdemokraciaAdminAdminDashboardHomeViewEdemokraciaAdminAdminEdemokraciaAdminDashboardOwnedDebatesTableAction-filter',
                    filterOptions,
                    filters,
                  );
                }}
