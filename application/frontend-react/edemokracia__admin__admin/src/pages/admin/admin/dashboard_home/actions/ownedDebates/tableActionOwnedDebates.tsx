...
export type TableActionOwnedDebatesAction = (
  id: string,
  filterOptions: FilterOption[],
  filters: Filter[],
) => Promise<void>;

export const useTableActionOwnedDebatesAction = (
  ...
  return async function tableActionOwnedDebatesAction(id: string, filterOptions: FilterOption[], filters: Filter[]) {
