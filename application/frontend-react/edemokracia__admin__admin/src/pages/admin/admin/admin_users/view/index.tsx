...
// Page name: edemokracia::admin::Admin.adminUsers#View
...
/**
 * Name: edemokracia::admin::Admin.adminUsers#View
 * Is Access: true
 * Type: View
...
export default function AdminAdminView(props: AdminAdminViewProps) {
  ...
  async function deleteData() {
    ...
    try {
      await adminUserServiceForClassImpl.delete(data);
      ...
      <DialogContent dividers>
        <Grid container spacing={2} direction="column" alignItems="stretch" justifyContent="flex-start">
          <Grid item xs={12} sm={12}>
            <Card id="FlexedemokraciaAdminAdminEdemokraciaAdminAdminAdminUsersViewDefaultUserViewEditSecurityLabelWrapper">
              <CardContent>
                <Grid container direction="column" alignItems="stretch" justifyContent="flex-start" spacing={2}>
                  <Grid item xs={12} sm={12}>
                    <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                      ...
                      <Typography
                        id="LabeledemokraciaAdminAdminEdemokraciaAdminAdminAdminUsersViewDefaultUserViewEditSecurityLabelWrapperSecurityLabel"
                        variant="h5"
                        component="h1"
                      >
                  ...
                  <Grid item xs={12} sm={12}>
                    <Grid
                      id="FlexedemokraciaAdminAdminEdemokraciaAdminAdminAdminUsersViewDefaultUserViewEditSecurityLabelWrapperSecurity"
                      container
                      direction="row"
                      alignItems="stretch"
                    ...
                    >
                      <Grid item xs={12} sm={12} md={4.0}>
                        <TextField
                          required={true}
                          name="userName"
                          id="TextInputedemokraciaAdminAdminEdemokraciaAdminAdminAdminUsersViewDefaultUserViewEditSecurityLabelWrapperSecurityUserName"
                      ...
                      <Grid item xs={12} sm={12} md={4.0}>
                        <DateTimePicker
                          ...
                          slotProps={{
                            textField: {
                              id: 'DateTimeInputedemokraciaAdminAdminEdemokraciaAdminAdminAdminUsersViewDefaultUserViewEditSecurityLabelWrapperSecurityCreated',
                              required: false,
          ...
          <Grid item xs={12} sm={12}>
            <Card id="FlexedemokraciaAdminAdminEdemokraciaAdminAdminAdminUsersViewDefaultUserViewEditPersonalLabelWrapper">
              <CardContent>
                <Grid container direction="column" alignItems="stretch" justifyContent="flex-start" spacing={2}>
                  <Grid item xs={12} sm={12}>
                    <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                      ...
                      <Typography
                        id="LabeledemokraciaAdminAdminEdemokraciaAdminAdminAdminUsersViewDefaultUserViewEditPersonalLabelWrapperPersonalLabel"
                        variant="h5"
                        component="h1"
                      >
                  ...
                  <Grid item xs={12} sm={12}>
                    <Grid
                      id="FlexedemokraciaAdminAdminEdemokraciaAdminAdminAdminUsersViewDefaultUserViewEditPersonalLabelWrapperPersonal"
                      container
                      direction="row"
                      alignItems="stretch"
                      justifyContent="flex-start"
                    ...
                    >
                      <Grid item xs={12} sm={12}>
                        <Grid
                          id="FlexedemokraciaAdminAdminEdemokraciaAdminAdminAdminUsersViewDefaultUserViewEditPersonalLabelWrapperPersonalName"
                          container
                          direction="row"
                        ...
                        >
                          <Grid item xs={12} sm={12} md={4.0}>
                            <TextField
                              required={true}
                              name="firstName"
                              id="TextInputedemokraciaAdminAdminEdemokraciaAdminAdminAdminUsersViewDefaultUserViewEditPersonalLabelWrapperPersonalNameFirstName"
                          ...
                          <Grid item xs={12} sm={12} md={4.0}>
                            <TextField
                              required={true}
                              name="lastName"
                              id="TextInputedemokraciaAdminAdminEdemokraciaAdminAdminAdminUsersViewDefaultUserViewEditPersonalLabelWrapperPersonalNameLastName"
                      ...
                      <Grid item xs={12} sm={12}>
                        <Grid
                          id="FlexedemokraciaAdminAdminEdemokraciaAdminAdminAdminUsersViewDefaultUserViewEditPersonalLabelWrapperPersonalContact"
                          container
                          direction="row"
                          alignItems="flex-start"
                          justifyContent="flex-start"
                        ...
                        >
                          <Grid item xs={12} sm={12} md={4.0}>
                            <TextField
                              required={true}
                              name="email"
                              id="TextInputedemokraciaAdminAdminEdemokraciaAdminAdminAdminUsersViewDefaultUserViewEditPersonalLabelWrapperPersonalContactEmail"
                          ...
                          <Grid item xs={12} sm={12} md={4.0}>
                            <TextField
                              required={false}
                              name="phone"
                              id="TextInputedemokraciaAdminAdminEdemokraciaAdminAdminAdminUsersViewDefaultUserViewEditPersonalLabelWrapperPersonalContactPhone"
                      ...
                      <Grid item xs={12} sm={12}>
                        <CollectionAssociationButton
                          id="NavigationToPageActionedemokraciaAdminAdminEdemokraciaAdminAdminAdminUsersViewEdemokraciaAdminAdminEdemokraciaAdminUserVotesButtonNavigate"
                          variant={undefined}
                          editMode={editMode}
          ...
          <Grid item xs={12} sm={12}>
            <Card id="FlexedemokraciaAdminAdminEdemokraciaAdminAdminAdminUsersViewDefaultUserViewEditAreasLabelWrapper">
              <CardContent>
                <Grid container direction="column" alignItems="stretch" justifyContent="flex-start" spacing={2}>
                  <Grid item xs={12} sm={12}>
                    <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                      ...
                      <Typography
                        id="LabeledemokraciaAdminAdminEdemokraciaAdminAdminAdminUsersViewDefaultUserViewEditAreasLabelWrapperAreasLabel"
                        variant="h5"
                        component="h1"
                      >
                  ...
                  <Grid item xs={12} sm={12}>
                    <Grid
                      id="FlexedemokraciaAdminAdminEdemokraciaAdminAdminAdminUsersViewDefaultUserViewEditAreasLabelWrapperAreas"
                      container
                      direction="row"
                      alignItems="stretch"
                    ...
                    >
                      <Grid item xs={12} sm={12}>
                        <Grid
                          id="FlexedemokraciaAdminAdminEdemokraciaAdminAdminAdminUsersViewDefaultUserViewEditAreasLabelWrapperAreasResidency"
                          container
                          direction="row"
                          alignItems="flex-start"
                          justifyContent="flex-start"
                      ...
                      <Grid container item xs={12} sm={12}>
                        <ModeledTabs
                          id="TabControlleredemokraciaAdminAdminEdemokraciaAdminAdminAdminUsersViewDefaultUserViewEditAreasLabelWrapperAreasActivity"
                          ownerData={data}
                          validation={validation}
                          orientation='horizontal'
                          childTabs={[
                            {
                              id: 'TabedemokraciaAdminAdminEdemokraciaAdminAdminAdminUsersViewDefaultUserViewEditAreasLabelWrapperAreasActivityTabActivityCounties',
                            ...
                            {
                              id: 'TabedemokraciaAdminAdminEdemokraciaAdminAdminAdminUsersViewDefaultUserViewEditAreasLabelWrapperAreasActivityActivityCities',
                            ...
                            {
                              id: 'TabedemokraciaAdminAdminEdemokraciaAdminAdminAdminUsersViewDefaultUserViewEditAreasLabelWrapperAreasActivityActivityDistricts',
                        ...
                        >
                          <Grid item xs={12} sm={12}>
                            <Grid
                              id="FlexedemokraciaAdminAdminEdemokraciaAdminAdminAdminUsersViewDefaultUserViewEditAreasLabelWrapperAreasActivityTabActivityCountiesTabActivityCounties"
                              container
                              direction="row"
                              alignItems="flex-start"
                              justifyContent="flex-start"
                            ...
                            >
                              <Grid item xs={12} sm={12}>
                                <Grid
                                  id="FlexedemokraciaAdminAdminEdemokraciaAdminAdminAdminUsersViewDefaultUserViewEditAreasLabelWrapperAreasActivityTabActivityCountiesTabActivityCountiesActivityCountiesLabelWrapper"
                                  container
                                  direction="column"
                                  alignItems="stretch"
                                  justifyContent="flex-start"
                                ...
                                >
                                  <Grid item xs={12} sm={12}>
                                    <Grid
                                      id="TableedemokraciaAdminAdminEdemokraciaAdminAdminAdminUsersViewDefaultUserViewEditAreasLabelWrapperAreasActivityTabActivityCountiesTabActivityCountiesActivityCountiesLabelWrapperActivityCounties"
                                      container
                                      direction="column"
                                      alignItems="stretch"
                                      justifyContent="flex-start"
                          ...
                          <Grid item xs={12} sm={12} md={4.0}>
                            <Grid
                              id="FlexedemokraciaAdminAdminEdemokraciaAdminAdminAdminUsersViewDefaultUserViewEditAreasLabelWrapperAreasActivityActivityCitiesActivityCities"
                              container
                              direction="row"
                              alignItems="flex-start"
                              justifyContent="flex-start"
                            ...
                            >
                              <Grid item xs={12} sm={12}>
                                <Grid
                                  id="FlexedemokraciaAdminAdminEdemokraciaAdminAdminAdminUsersViewDefaultUserViewEditAreasLabelWrapperAreasActivityActivityCitiesActivityCitiesActivityCitiesLabelWrapper"
                                  container
                                  direction="column"
                                  alignItems="stretch"
                                  justifyContent="flex-start"
                                ...
                                >
                                  <Grid item xs={12} sm={12}>
                                    <Grid
                                      id="TableedemokraciaAdminAdminEdemokraciaAdminAdminAdminUsersViewDefaultUserViewEditAreasLabelWrapperAreasActivityActivityCitiesActivityCitiesActivityCitiesLabelWrapperActivityCities"
                                      container
                                      direction="column"
                                      alignItems="stretch"
                                      justifyContent="flex-start"
                          ...
                          <Grid item xs={12} sm={12}>
                            <Grid
                              id="FlexedemokraciaAdminAdminEdemokraciaAdminAdminAdminUsersViewDefaultUserViewEditAreasLabelWrapperAreasActivityActivityDistrictsActivityDistricts"
                              container
                              direction="row"
                              alignItems="flex-start"
                              justifyContent="flex-start"
                            ...
                            >
                              <Grid item xs={12} sm={12}>
                                <Grid
                                  id="FlexedemokraciaAdminAdminEdemokraciaAdminAdminAdminUsersViewDefaultUserViewEditAreasLabelWrapperAreasActivityActivityDistrictsActivityDistrictsActivityDistrictsLabelWrapper"
                                  container
                                  direction="column"
                                  alignItems="stretch"
                                  justifyContent="flex-start"
                                ...
                                >
                                  <Grid item xs={12} sm={12}>
                                    <Grid
                                      id="TableedemokraciaAdminAdminEdemokraciaAdminAdminAdminUsersViewDefaultUserViewEditAreasLabelWrapperAreasActivityActivityDistrictsActivityDistrictsActivityDistrictsLabelWrapperActivityDistricts"
                                      container
                                      direction="column"
                                      alignItems="stretch"
                                      justifyContent="flex-start"
