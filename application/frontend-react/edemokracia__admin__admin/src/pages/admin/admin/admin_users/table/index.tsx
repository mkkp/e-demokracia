...
// Page name: edemokracia::admin::Admin.adminUsers#Table
...
/**
 * Name: edemokracia::admin::Admin.adminUsers#Table
 * Is Access: true
 * Is Dashboard: false
 * Type: Table
 **/
export default function AdminAdminAdminUsersTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaAdminAdminEdemokraciaAdminAdminAdminUsersTable-data-grid">
