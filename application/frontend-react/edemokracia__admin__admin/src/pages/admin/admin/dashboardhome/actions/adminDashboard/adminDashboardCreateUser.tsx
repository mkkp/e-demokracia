...
import { routeToAdminDashboardCreateuserOutput } from '~/routes';
...
export const useAdminDashboardCreateUserAction: AdminDashboardCreateUserAction = () => {
  ...
  const title: string = t('edemokracia.admin.Admin.dashboardhome.Dashboard.createUser.ButtonCallOperation', {
      ...
      children: (
        <AdminDashboardCreateUserForm
          successCallback={(result?: AdminUserStored) => {
            ...
            if (result) {
              navigate(routeToAdminDashboardCreateuserOutput(result.__signedIdentifier));
            } else {
              successCallback();
            }
          }}
