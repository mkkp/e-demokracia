...
export interface AdminRatingVoteDefinitionVoteFormProps {
...
export function AdminRatingVoteDefinitionVoteForm({
  ...
  cancel,
  owner,
}: AdminRatingVoteDefinitionVoteFormProps) {
  ...
  const handleActionError = useErrorHandler<RatingVoteInput>(
    `(&(${OBJECTCLASS}=${ERROR_PROCESSOR_HOOK_INTERFACE_KEY})(operation=CallOperation)(component=AdminRatingVoteDefinitionVoteForm))`,
  );
  ...
  const submit = async () => {
    ...
    try {
      await adminRatingVoteDefinitionServiceForClassImpl.vote(owner, payloadDiff);
  ...
  return (
    <>
      <DialogTitle>
        {title}
        <IconButton
          id="CallOperationActionedemokraciaAdminAdminEdemokraciaAdminAdminUserOwnedRatingVoteDefinitionsTableEdemokraciaAdminAdminEdemokraciaAdminRatingVoteDefinitionVoteButtonCallOperation-dialog-close"
          aria-label="close"
          onClick={() => cancel()}
          sx={{
            position: 'absolute',
        ...
        <Grid container spacing={2} direction="column" alignItems="stretch" justifyContent="flex-start">
          <Grid item xs={12} sm={12}>
            <NumericInput
              required={false}
              name="value"
              id="NumericInputedemokraciaAdminAdminEdemokraciaAdminRatingVoteDefinitionVoteInputDefaultRatingVoteInputFormValue"
              autoFocus
      ...
      <DialogActions>
        <Button
          id="CallOperationActionedemokraciaAdminAdminEdemokraciaAdminAdminUserOwnedRatingVoteDefinitionsTableEdemokraciaAdminAdminEdemokraciaAdminRatingVoteDefinitionVoteButtonCallOperation-action-form-action-cancel"
          variant="text"
          onClick={() => cancel()}
          disabled={isLoading}
        ...
        <LoadingButton
          ...
          id="CallOperationActionedemokraciaAdminAdminEdemokraciaAdminAdminUserOwnedRatingVoteDefinitionsTableEdemokraciaAdminAdminEdemokraciaAdminRatingVoteDefinitionVoteButtonCallOperation-action-form-action-submit"
          variant="contained"
          onClick={() => submit()}
