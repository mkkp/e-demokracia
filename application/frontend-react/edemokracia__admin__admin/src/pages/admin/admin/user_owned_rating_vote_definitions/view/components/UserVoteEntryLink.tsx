...
export type UserVoteEntryLinkFilterInitializer = (ownerData: AdminRatingVoteDefinitionStored) => Filter[] | undefined;
...
export function UserVoteEntryLink(props: UserVoteEntryLinkProps) {
  ...
  return (
    <AggregationInput
      name="userVoteEntry"
      id="LinkedemokraciaAdminAdminEdemokraciaAdminAdminUserOwnedRatingVoteDefinitionsViewDefaultRatingVoteDefinitionViewEditUserVoteEntryGroupLabelWrapperUserVoteEntryGroupUserVoteVirtualForUserVoteUserVoteEntry"
