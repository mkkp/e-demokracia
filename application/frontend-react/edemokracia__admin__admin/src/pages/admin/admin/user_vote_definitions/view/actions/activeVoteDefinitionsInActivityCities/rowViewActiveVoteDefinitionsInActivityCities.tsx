...
import { routeToAdminUserVoteDefinitionActiveVoteDefinitionsInActivityCitiesView } from '~/routes';
...
export const useRowViewActiveVoteDefinitionsInActivityCitiesAction: RowViewActiveVoteDefinitionsInActivityCitiesAction =
  () => {
    ...
    return async function (
      ...
      closeAllDialogs();
      navigate(routeToAdminUserVoteDefinitionActiveVoteDefinitionsInActivityCitiesView(entry.__signedIdentifier));
    };
  };
