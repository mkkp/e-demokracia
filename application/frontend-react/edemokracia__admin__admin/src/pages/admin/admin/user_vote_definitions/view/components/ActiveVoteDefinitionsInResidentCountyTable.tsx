...
export const ADMIN_ADMIN_USER_VOTE_DEFINITIONS_VIEW_ACTIVE_VOTE_DEFINITIONS_IN_RESIDENT_COUNTY =
  'AdminAdminUserVoteDefinitionsViewActiveVoteDefinitionsInResidentCounty';
...
>((props, ref) => {
  ...
  const filterModelKey = `-${ownerData.__signedIdentifier}-filterModel`;
  const filtersKey = `-${ownerData.__signedIdentifier}-filters`;
  ...
  const activeVoteDefinitionsInResidentCountyColumns: GridColDef<AdminVoteDefinitionStored>[] = [
    {
      ...
      headerName: t('admin.UserVoteDefinitionView.activeVoteDefinitionsInResidentCounty.countyRepresentation', {
    ...
    },
    {
      ...baseColumnConfig,
      field: 'title',
      headerName: t('admin.UserVoteDefinitionView.activeVoteDefinitionsInResidentCounty.title', {
        defaultValue: 'Title',
      }) as string,
      headerClassName: 'data-grid-column-header',
    ...
    },
    {
      ...baseColumnConfig,
      field: 'voteType',
      headerName: t('admin.UserVoteDefinitionView.activeVoteDefinitionsInResidentCounty.voteType', {
    ...
    },
    {
      ...baseColumnConfig,
      field: 'numberOfVotes',
      headerName: t('admin.UserVoteDefinitionView.activeVoteDefinitionsInResidentCounty.numberOfVotes', {
    ...
    },
    {
      ...baseColumnConfig,
      field: 'created',
      headerName: t('admin.UserVoteDefinitionView.activeVoteDefinitionsInResidentCounty.created', {
    ...
    },
    {
      ...baseColumnConfig,
      field: 'closeAt',
      headerName: t('admin.UserVoteDefinitionView.activeVoteDefinitionsInResidentCounty.closeAt', {
    ...
    },
    {
      ...baseColumnConfig,
      field: 'status',
      headerName: t('admin.UserVoteDefinitionView.activeVoteDefinitionsInResidentCounty.status', {
        defaultValue: 'Status',
      }) as string,
      headerClassName: 'data-grid-column-header',
  ...
  const activeVoteDefinitionsInResidentCountyRangeFilterOptions: FilterOption[] = [
    {
      id: '',
      attributeName: 'countyRepresentation',
      label: t('admin.UserVoteDefinitionView.activeVoteDefinitionsInResidentCounty.countyRepresentation', {
        defaultValue: 'CountyRepresentation',
      }) as string,
    ...
    {
      id: '',
      attributeName: 'title',
      label: t('admin.UserVoteDefinitionView.activeVoteDefinitionsInResidentCounty.title', {
        defaultValue: 'Title',
      }) as string,
      filterType: FilterType.string,
    },
    ...
    {
      id: '',
      attributeName: 'voteType',
      label: t('admin.UserVoteDefinitionView.activeVoteDefinitionsInResidentCounty.voteType', {
        defaultValue: 'VoteType',
      }) as string,
    ...
    {
      id: '',
      attributeName: 'numberOfVotes',
      label: t('admin.UserVoteDefinitionView.activeVoteDefinitionsInResidentCounty.numberOfVotes', {
        defaultValue: 'NumberOfVotes',
      }) as string,
    ...
    {
      id: '',
      attributeName: 'created',
      label: t('admin.UserVoteDefinitionView.activeVoteDefinitionsInResidentCounty.created', {
        defaultValue: 'Created',
      }) as string,
    ...
    {
      id: '',
      attributeName: 'closeAt',
      label: t('admin.UserVoteDefinitionView.activeVoteDefinitionsInResidentCounty.closeAt', {
        defaultValue: 'CloseAt',
      }) as string,
      filterType: FilterType.dateTime,
    },
    ...
    {
      id: '',
      attributeName: 'status',
      label: t('admin.UserVoteDefinitionView.activeVoteDefinitionsInResidentCounty.status', {
        defaultValue: 'Status',
      }) as string,
      filterType: FilterType.enumeration,
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              <Button
                id="FilterRelationActionedemokraciaAdminAdminEdemokraciaAdminAdminUserVoteDefinitionsViewEdemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionActiveVoteDefinitionsInResidentCountyTableAction"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() => {
                  tableActionActiveVoteDefinitionsInResidentCountyAction(
                    'FilterRelationActionedemokraciaAdminAdminEdemokraciaAdminAdminUserVoteDefinitionsViewEdemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionActiveVoteDefinitionsInResidentCountyTableAction-filter',
                    filterOptions,
                    filters,
                  );
                }}
