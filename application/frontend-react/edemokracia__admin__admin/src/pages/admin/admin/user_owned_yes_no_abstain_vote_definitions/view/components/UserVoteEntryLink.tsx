...
export type UserVoteEntryLinkFilterInitializer = (
  ownerData: AdminYesNoAbstainVoteDefinitionStored,
) => Filter[] | undefined;
...
export interface UserVoteEntryLinkProps {
  ownerData: AdminYesNoAbstainVoteDefinitionStored;
  validation: Map<keyof AdminYesNoAbstainVoteDefinitionStored, string>;
  fetchOwnerData: () => Promise<void>;
  onChange: (value: AdminYesNoAbstainVoteEntry | AdminYesNoAbstainVoteEntryStored | null) => void;
  disabled: boolean;
  readOnly: boolean;
  editMode: boolean;
}
...
export function UserVoteEntryLink(props: UserVoteEntryLinkProps) {
  ...
  return (
    <AggregationInput
      name="userVoteEntry"
      id="LinkedemokraciaAdminAdminEdemokraciaAdminAdminUserOwnedYesNoAbstainVoteDefinitionsViewDefaultYesNoAbstainVoteDefinitionViewEditUserVoteEntryGroupLabelWrapperUserVoteEntryGroupUserVoteVirtualForUserVoteUserVoteEntry"
      label={t('admin.YesNoAbstainVoteDefinitionView.userVoteEntry', { defaultValue: 'Value' }) as string}
      ...
      onAutoCompleteSelect={(userVoteEntry) => {
        ...
        onChange(userVoteEntry as AdminYesNoAbstainVoteEntryStored);
      }}
