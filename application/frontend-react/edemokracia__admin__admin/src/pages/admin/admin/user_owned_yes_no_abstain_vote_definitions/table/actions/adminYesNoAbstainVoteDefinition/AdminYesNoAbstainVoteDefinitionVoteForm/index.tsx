...
export interface AdminYesNoAbstainVoteDefinitionVoteFormProps {
...
export default function AdminYesNoAbstainVoteDefinitionVoteForm({
  ...
  cancel,
  owner,
}: AdminYesNoAbstainVoteDefinitionVoteFormProps) {
  ...
  const handleActionError = useErrorHandler<YesNoAbstainVoteInput>(
    `(&(${OBJECTCLASS}=${ERROR_PROCESSOR_HOOK_INTERFACE_KEY})(operation=CallOperation)(component=AdminYesNoAbstainVoteDefinitionVoteForm))`,
  );
  ...
  const submit = async () => {
    ...
    try {
      await adminYesNoAbstainVoteDefinitionServiceForClassImpl.vote(owner, payloadDiff);
  ...
  return (
    <>
      <DialogTitle>
        {title}
        <IconButton
          id="CallOperationActionedemokraciaAdminAdminEdemokraciaAdminAdminUserOwnedYesNoAbstainVoteDefinitionsTableEdemokraciaAdminAdminEdemokraciaAdminYesNoAbstainVoteDefinitionVoteButtonCallOperation-dialog-close"
          aria-label="close"
          onClick={() => cancel()}
          sx={{
            position: 'absolute',
        ...
        <Grid container spacing={2} direction="column" alignItems="stretch" justifyContent="flex-start">
          <Grid item xs={12} sm={12}>
            <TextField
              required={false}
              name="value"
              id="EnumerationComboedemokraciaAdminAdminEdemokraciaAdminYesNoAbstainVoteDefinitionVoteInputDefaultYesNoAbstainVoteInputFormValue"
              autoFocus
      ...
      <DialogActions>
        <Button
          id="CallOperationActionedemokraciaAdminAdminEdemokraciaAdminAdminUserOwnedYesNoAbstainVoteDefinitionsTableEdemokraciaAdminAdminEdemokraciaAdminYesNoAbstainVoteDefinitionVoteButtonCallOperation-action-form-action-cancel"
          variant="text"
          onClick={() => cancel()}
          disabled={isLoading}
        ...
        <LoadingButton
          ...
          id="CallOperationActionedemokraciaAdminAdminEdemokraciaAdminAdminUserOwnedYesNoAbstainVoteDefinitionsTableEdemokraciaAdminAdminEdemokraciaAdminYesNoAbstainVoteDefinitionVoteButtonCallOperation-action-form-action-submit"
          variant="contained"
          onClick={() => submit()}
