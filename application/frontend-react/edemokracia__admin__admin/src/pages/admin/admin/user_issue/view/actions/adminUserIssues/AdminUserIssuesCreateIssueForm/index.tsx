...
export function AdminUserIssuesCreateIssueForm({ successCallback, cancel }: AdminUserIssuesCreateIssueFormProps) {
  ...
  return (
    <>
      <DialogTitle>
        {title}
        <IconButton
          id="CallOperationActionedemokraciaAdminAdminEdemokraciaAdminAdminUserIssueViewEdemokraciaAdminAdminEdemokraciaAdminUserIssuesCreateIssueButtonCallOperation-dialog-close"
          aria-label="close"
          onClick={() => cancel()}
          sx={{
            position: 'absolute',
      ...
      <DialogActions>
        <Button
          id="CallOperationActionedemokraciaAdminAdminEdemokraciaAdminAdminUserIssueViewEdemokraciaAdminAdminEdemokraciaAdminUserIssuesCreateIssueButtonCallOperation-action-form-action-cancel"
          variant="text"
          onClick={() => cancel()}
          disabled={isLoading}
        ...
        <LoadingButton
          ...
          id="CallOperationActionedemokraciaAdminAdminEdemokraciaAdminAdminUserIssueViewEdemokraciaAdminAdminEdemokraciaAdminUserIssuesCreateIssueButtonCallOperation-action-form-action-submit"
          variant="contained"
          onClick={() => submit()}
