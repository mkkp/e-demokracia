...
export const ADMIN_ADMIN_USER_ISSUE_VIEW_ACTIVE_ISSUES_IN_ACTIVITY_CITIES =
  'AdminAdminUserIssueViewActiveIssuesInActivityCities';
...
export const ActiveIssuesInActivityCitiesTable = forwardRef<RefreshableTable, ActiveIssuesInActivityCitiesTableProps>(
  (props, ref) => {
    ...
    const filterModelKey = `-${ownerData.__signedIdentifier}-filterModel`;
    const filtersKey = `-${ownerData.__signedIdentifier}-filters`;
    ...
    const activeIssuesInActivityCitiesColumns: GridColDef<AdminIssueStored>[] = [
      {
        ...baseColumnConfig,
        field: 'scope',
        headerName: t('admin.UserIssuesView.activeIssuesInActivityCities.scope', { defaultValue: 'Scope' }) as string,
    ...
    const activeIssuesInActivityCitiesRangeFilterOptions: FilterOption[] = [
      {
        id: '',
        attributeName: 'scope',
        label: t('admin.UserIssuesView.activeIssuesInActivityCities.scope', { defaultValue: 'Scope' }) as string,
        filterType: FilterType.enumeration,
        enumValues: ['GLOBAL', 'COUNTY', 'CITY', 'DISTRICT'],
      },

      {
        id: '',
        attributeName: 'title',
      ...
      {
        id: '',
      ...
      {
        id: '',
      ...
      {
        id: '',
          ...
          components={{
            Toolbar: () => (
              <GridToolbarContainer>
                <Button
                  id="FilterRelationActionedemokraciaAdminAdminEdemokraciaAdminAdminUserIssueViewEdemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInActivityCitiesTableAction"
                  startIcon={<MdiIcon path="filter" />}
                  variant="text"
                  onClick={() => {
                    tableActionActiveIssuesInActivityCitiesAction(
                      'FilterRelationActionedemokraciaAdminAdminEdemokraciaAdminAdminUserIssueViewEdemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInActivityCitiesTableAction-filter',
                      filterOptions,
                      filters,
                    );
                  }}
