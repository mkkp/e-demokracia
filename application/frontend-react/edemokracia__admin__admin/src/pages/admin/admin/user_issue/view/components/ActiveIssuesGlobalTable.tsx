...
export const ADMIN_ADMIN_USER_ISSUE_VIEW_ACTIVE_ISSUES_GLOBAL = 'AdminAdminUserIssueViewActiveIssuesGlobal';
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              <Button
                id="FilterRelationActionedemokraciaAdminAdminEdemokraciaAdminAdminUserIssueViewEdemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesGlobalTableAction"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() => {
                  tableActionActiveIssuesGlobalAction(
                    'FilterRelationActionedemokraciaAdminAdminEdemokraciaAdminAdminUserIssueViewEdemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesGlobalTableAction-filter',
                    filterOptions,
                    filters,
                  );
                }}
