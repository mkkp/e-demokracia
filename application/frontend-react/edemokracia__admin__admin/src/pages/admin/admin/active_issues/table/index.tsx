...
// Page name: edemokracia::admin::Admin.activeIssues#Table
...
/**
 * Name: edemokracia::admin::Admin.activeIssues#Table
 * Is Access: true
 * Is Dashboard: false
 * Type: Table
 **/
export default function AdminAdminActiveIssuesTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaAdminAdminEdemokraciaAdminAdminActiveIssuesTable-data-grid">
