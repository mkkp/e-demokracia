...
export type PageFilterUserOpenIssuesAction = (
  id: string,
  filterOptions: FilterOption[],
  filters: Filter[],
) => Promise<void>;

export const usePageFilterUserOpenIssuesAction = (
  ...
  return async function pageFilterUserOpenIssuesAction(id: string, filterOptions: FilterOption[], filters: Filter[]) {
