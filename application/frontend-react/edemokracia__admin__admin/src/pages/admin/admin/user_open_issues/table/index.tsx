...
// Page name: edemokracia::admin::Admin.userOpenIssues#Table
...
/**
 * Name: edemokracia::admin::Admin.userOpenIssues#Table
 * Is Access: true
 * Is Dashboard: false
 * Type: Table
 **/
export default function AdminAdminUserOpenIssuesTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaAdminAdminEdemokraciaAdminAdminUserOpenIssuesTable-data-grid">
