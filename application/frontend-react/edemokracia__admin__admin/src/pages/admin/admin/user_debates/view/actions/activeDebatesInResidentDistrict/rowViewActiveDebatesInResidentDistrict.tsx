...
import { routeToAdminUserDebatesActiveDebatesInResidentDistrictView } from '~/routes';
...
export const useRowViewActiveDebatesInResidentDistrictAction: RowViewActiveDebatesInResidentDistrictAction = () => {
  ...
  return async function (
    ...
    closeAllDialogs();
    navigate(routeToAdminUserDebatesActiveDebatesInResidentDistrictView(entry.__signedIdentifier));
  };
};
