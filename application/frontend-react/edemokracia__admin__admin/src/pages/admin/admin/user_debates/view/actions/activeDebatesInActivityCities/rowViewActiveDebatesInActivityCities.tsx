...
import { routeToAdminUserDebatesActiveDebatesInActivityCitiesView } from '~/routes';
...
export const useRowViewActiveDebatesInActivityCitiesAction: RowViewActiveDebatesInActivityCitiesAction = () => {
  ...
  return async function (
    ...
    closeAllDialogs();
    navigate(routeToAdminUserDebatesActiveDebatesInActivityCitiesView(entry.__signedIdentifier));
  };
};
