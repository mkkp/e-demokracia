...
export type TableActionActiveDebatesGlobalAction = (
  id: string,
  filterOptions: FilterOption[],
  filters: Filter[],
) => Promise<void>;

export const useTableActionActiveDebatesGlobalAction = (
  ...
  const columnNames = ['title', 'issueTitle', 'closeAt', 'status'];

  return async function tableActionActiveDebatesGlobalAction(
    id: string,
    filterOptions: FilterOption[],
    filters: Filter[],
  ) {
