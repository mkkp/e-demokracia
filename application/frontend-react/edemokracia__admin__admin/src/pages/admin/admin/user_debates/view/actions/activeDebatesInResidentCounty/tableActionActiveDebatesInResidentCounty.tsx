...
export type TableActionActiveDebatesInResidentCountyAction = (
  id: string,
  filterOptions: FilterOption[],
  filters: Filter[],
) => Promise<void>;

export const useTableActionActiveDebatesInResidentCountyAction = (
  ...
  return async function tableActionActiveDebatesInResidentCountyAction(
    id: string,
    filterOptions: FilterOption[],
    filters: Filter[],
  ) {
