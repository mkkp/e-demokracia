...
export type TableActionActiveDebatesInActivityCountiesAction = (
  id: string,
  filterOptions: FilterOption[],
  filters: Filter[],
) => Promise<void>;

export const useTableActionActiveDebatesInActivityCountiesAction = (
  ...
  const columnNames = ['countyRepresentation', 'title', 'issueTitle', 'closeAt', 'status'];

  return async function tableActionActiveDebatesInActivityCountiesAction(
    id: string,
    filterOptions: FilterOption[],
    filters: Filter[],
  ) {
