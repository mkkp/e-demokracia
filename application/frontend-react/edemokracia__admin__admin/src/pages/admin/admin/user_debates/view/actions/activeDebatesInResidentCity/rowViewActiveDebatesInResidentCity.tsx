...
import { routeToAdminUserDebatesActiveDebatesInResidentCityView } from '~/routes';
...
export const useRowViewActiveDebatesInResidentCityAction: RowViewActiveDebatesInResidentCityAction = () => {
  ...
  return async function (
    ...
    closeAllDialogs();
    navigate(routeToAdminUserDebatesActiveDebatesInResidentCityView(entry.__signedIdentifier));
  };
};
