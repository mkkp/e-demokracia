...
export type TableActionActiveDebatesInResidentCityAction = (
  id: string,
  filterOptions: FilterOption[],
  filters: Filter[],
) => Promise<void>;

export const useTableActionActiveDebatesInResidentCityAction = (
  ...
  return async function tableActionActiveDebatesInResidentCityAction(
    id: string,
    filterOptions: FilterOption[],
    filters: Filter[],
  ) {
