...
export type TableActionActiveDebatesInActivityCitiesAction = (
  id: string,
  filterOptions: FilterOption[],
  filters: Filter[],
) => Promise<void>;

export const useTableActionActiveDebatesInActivityCitiesAction = (
  ...
  const columnNames = ['countyRepresentation', 'cityRepresentation', 'title', 'issueTitle', 'closeAt', 'status'];

  return async function tableActionActiveDebatesInActivityCitiesAction(
    id: string,
    filterOptions: FilterOption[],
    filters: Filter[],
  ) {
