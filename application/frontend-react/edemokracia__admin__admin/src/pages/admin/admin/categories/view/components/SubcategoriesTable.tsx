...
export const ADMIN_ADMIN_CATEGORIES_VIEW_SUBCATEGORIES = 'AdminAdminCategoriesViewSubcategories';
...
export const SubcategoriesTable = (props: SubcategoriesTableProps) => {
  ...
  const filterModelKey = `TableedemokraciaAdminAdminEdemokraciaAdminAdminCategoriesViewDefaultIssueCategoryViewEditSubcategoriesLabelWrapperSubcategories-${ownerData.__identifier}-filterModel`;
  const filtersKey = `TableedemokraciaAdminAdminEdemokraciaAdminAdminCategoriesViewDefaultIssueCategoryViewEditSubcategoriesLabelWrapperSubcategories-${ownerData.__identifier}-filters`;
  ...
  const subcategoriesRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminAdminCategoriesViewDefaultIssueCategoryViewEditSubcategoriesLabelWrapperSubcategoriesTitleFilter',
      attributeName: 'title',
    ...
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminAdminCategoriesViewDefaultIssueCategoryViewEditSubcategoriesLabelWrapperSubcategoriesDescriptionFilter',
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              ...
              <Button
                id="TableedemokraciaAdminAdminEdemokraciaAdminAdminCategoriesViewDefaultIssueCategoryViewEditSubcategoriesLabelWrapperSubcategories-filter"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() =>
                  filter(
                    'TableedemokraciaAdminAdminEdemokraciaAdminAdminCategoriesViewDefaultIssueCategoryViewEditSubcategoriesLabelWrapperSubcategories-filter',
                    filterOptions,
                    filters,
                  )
                }
