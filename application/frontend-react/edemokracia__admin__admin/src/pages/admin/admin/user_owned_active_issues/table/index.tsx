...
// Page name: edemokracia::admin::Admin.userOwnedActiveIssues#Table
...
/**
 * Name: edemokracia::admin::Admin.userOwnedActiveIssues#Table
 * Is Access: true
 * Is Dashboard: false
 * Type: Table
 **/
export default function AdminAdminUserOwnedActiveIssuesTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaAdminAdminEdemokraciaAdminAdminUserOwnedActiveIssuesTable-data-grid">
