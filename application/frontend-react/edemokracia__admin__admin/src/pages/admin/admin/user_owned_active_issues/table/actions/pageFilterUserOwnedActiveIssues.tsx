...
export type PageFilterUserOwnedActiveIssuesAction = (
  id: string,
  filterOptions: FilterOption[],
  filters: Filter[],
) => Promise<void>;

export const usePageFilterUserOwnedActiveIssuesAction = (
  ...
  return async function pageFilterUserOwnedActiveIssuesAction(
    id: string,
    filterOptions: FilterOption[],
    filters: Filter[],
  ) {
