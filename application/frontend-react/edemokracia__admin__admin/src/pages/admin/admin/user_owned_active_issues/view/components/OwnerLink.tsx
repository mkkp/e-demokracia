...
export function OwnerLink(props: OwnerLinkProps) {
  ...
  const ownerRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminAdminUserOwnedActiveIssuesViewDefaultIssueViewEditIssueLabelWrapperIssueOwnerRepresentationFilter',
  ...
  return (
    <AggregationInput
      name="owner"
      id="LinkedemokraciaAdminAdminEdemokraciaAdminAdminUserOwnedActiveIssuesViewDefaultIssueViewEditIssueLabelWrapperIssueOwner"
