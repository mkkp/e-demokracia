...
import { routeToAdminSelectAnswerVoteDefinitionDebateView } from '~/routes';
...
export const useButtonNavigateDebateAction: ButtonNavigateDebateAction = () => {
  ...
  return async function (
    ...
    navigate(routeToAdminSelectAnswerVoteDefinitionDebateView(target.__signedIdentifier));
  };
};
