...
import { usePageRefreshUserOwnedSelectAnswerVoteDefinitionsAction } from '../actions';
import { applyInMemoryFilters } from '~/utilities';
import { GridLogicOperator } from '@mui/x-data-grid';

export const ADMIN_ADMIN_USER_OWNED_SELECT_ANSWER_VOTE_DEFINITIONS_VIEW_VOTE_SELECTIONS =
  'AdminAdminUserOwnedSelectAnswerVoteDefinitionsViewVoteSelections';
...
export const VoteSelectionsTable = (props: VoteSelectionsTableProps) => {
  ...
  const filterModelKey = `TableedemokraciaAdminAdminEdemokraciaAdminAdminUserOwnedSelectAnswerVoteDefinitionsViewDefaultSelectAnswerVoteDefinitionViewEditVoteEntryBaseVirtualVoteSelectionsLabelWrapperVoteSelections-${ownerData.__identifier}-filterModel`;
  const filtersKey = `TableedemokraciaAdminAdminEdemokraciaAdminAdminUserOwnedSelectAnswerVoteDefinitionsViewDefaultSelectAnswerVoteDefinitionViewEditVoteEntryBaseVirtualVoteSelectionsLabelWrapperVoteSelections-${ownerData.__identifier}-filters`;
  ...
  const voteSelectionsRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminAdminUserOwnedSelectAnswerVoteDefinitionsViewDefaultSelectAnswerVoteDefinitionViewEditVoteEntryBaseVirtualVoteSelectionsLabelWrapperVoteSelectionsDescriptionFilter',
    ...
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminAdminUserOwnedSelectAnswerVoteDefinitionsViewDefaultSelectAnswerVoteDefinitionViewEditVoteEntryBaseVirtualVoteSelectionsLabelWrapperVoteSelectionsTitleFilter',
      attributeName: 'title',
          ...
          Toolbar: () => (
            <GridToolbarContainer>
              <Button
                ...
                onClick={() =>
                  filter(
                    'TableedemokraciaAdminAdminEdemokraciaAdminAdminUserOwnedSelectAnswerVoteDefinitionsViewDefaultSelectAnswerVoteDefinitionViewEditVoteEntryBaseVirtualVoteSelectionsLabelWrapperVoteSelections-filter',
                    filterOptions,
                    filters,
                  )
                }
