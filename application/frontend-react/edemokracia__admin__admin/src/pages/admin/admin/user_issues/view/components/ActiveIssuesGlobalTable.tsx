...
export const ADMIN_ADMIN_USER_ISSUES_VIEW_ACTIVE_ISSUES_GLOBAL = 'AdminAdminUserIssuesViewActiveIssuesGlobal';
...
export const ActiveIssuesGlobalTable = forwardRef<RefreshableTable, ActiveIssuesGlobalTableProps>((props, ref) => {
  ...
  const filterModelKey = `TableedemokraciaAdminAdminEdemokraciaAdminAdminUserIssuesViewDefaultUserIssuesViewEditRootTabBarActiveGlobalIssuesActiveGlobalIssuesActiveGlobalLabelWrapperActiveGlobalActiveIssuesGlobalLabelWrapperActiveIssuesGlobal-${ownerData.__signedIdentifier}-filterModel`;
  const filtersKey = `TableedemokraciaAdminAdminEdemokraciaAdminAdminUserIssuesViewDefaultUserIssuesViewEditRootTabBarActiveGlobalIssuesActiveGlobalIssuesActiveGlobalLabelWrapperActiveGlobalActiveIssuesGlobalLabelWrapperActiveIssuesGlobal-${ownerData.__signedIdentifier}-filters`;
  ...
  const activeIssuesGlobalColumns: GridColDef<AdminIssueStored>[] = [
    ...
    },
    {
      ...baseColumnConfig,
      field: 'title',
      headerName: t('admin.UserIssuesView.activeIssuesGlobal.title', { defaultValue: 'Title' }) as string,
      headerClassName: 'data-grid-column-header',
    ...
    },
    {
      ...baseColumnConfig,
      field: 'created',
      headerName: t('admin.UserIssuesView.activeIssuesGlobal.created', { defaultValue: 'Created' }) as string,
      headerClassName: 'data-grid-column-header',
    ...
    },
    {
      ...
      headerName: t('admin.UserIssuesView.activeIssuesGlobal.numberOfDebates', {
    ...
    },
    {
      ...baseColumnConfig,
      field: 'status',
      headerName: t('admin.UserIssuesView.activeIssuesGlobal.status', { defaultValue: 'Status' }) as string,
      headerClassName: 'data-grid-column-header',
  ...
  const activeIssuesGlobalRangeFilterOptions: FilterOption[] = [
    ...
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminAdminUserIssuesViewDefaultUserIssuesViewEditRootTabBarActiveGlobalIssuesActiveGlobalIssuesActiveGlobalLabelWrapperActiveGlobalActiveIssuesGlobalLabelWrapperActiveIssuesGlobalCreatedFilter',
    ...
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminAdminUserIssuesViewDefaultUserIssuesViewEditRootTabBarActiveGlobalIssuesActiveGlobalIssuesActiveGlobalLabelWrapperActiveGlobalActiveIssuesGlobalLabelWrapperActiveIssuesGlobalNumberOfDebatesFilter',
    ...
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminAdminUserIssuesViewDefaultUserIssuesViewEditRootTabBarActiveGlobalIssuesActiveGlobalIssuesActiveGlobalLabelWrapperActiveGlobalActiveIssuesGlobalLabelWrapperActiveIssuesGlobalStatusFilter',
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              <Button
                id="FilterRelationActionedemokraciaAdminAdminEdemokraciaAdminAdminUserIssuesViewEdemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesGlobalTableAction"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() => {
                  tableActionActiveIssuesGlobalAction(
                    'FilterRelationActionedemokraciaAdminAdminEdemokraciaAdminAdminUserIssuesViewEdemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesGlobalTableAction-filter',
                    filterOptions,
                    filters,
                  );
                }}
