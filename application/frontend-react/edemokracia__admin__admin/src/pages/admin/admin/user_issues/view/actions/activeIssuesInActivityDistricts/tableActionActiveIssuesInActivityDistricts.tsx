...
export type TableActionActiveIssuesInActivityDistrictsAction = (
  id: string,
  filterOptions: FilterOption[],
  filters: Filter[],
) => Promise<void>;

export const useTableActionActiveIssuesInActivityDistrictsAction = (
  ...
  return async function tableActionActiveIssuesInActivityDistrictsAction(
    id: string,
    filterOptions: FilterOption[],
    filters: Filter[],
  ) {
