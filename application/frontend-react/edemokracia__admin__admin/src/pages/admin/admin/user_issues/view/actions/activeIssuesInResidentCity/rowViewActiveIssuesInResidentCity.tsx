...
import { routeToAdminUserIssuesActiveIssuesInResidentCityView } from '~/routes';
...
export const useRowViewActiveIssuesInResidentCityAction: RowViewActiveIssuesInResidentCityAction = () => {
  ...
  return async function (
    ...
    closeAllDialogs();
    navigate(routeToAdminUserIssuesActiveIssuesInResidentCityView(entry.__signedIdentifier));
  };
};
