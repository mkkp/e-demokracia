...
export const ADMIN_ADMIN_USER_ISSUES_VIEW_ACTIVE_ISSUES_IN_RESIDENT_CITY =
  'AdminAdminUserIssuesViewActiveIssuesInResidentCity';
...
export const ActiveIssuesInResidentCityTable = forwardRef<RefreshableTable, ActiveIssuesInResidentCityTableProps>(
  (props, ref) => {
    ...
    const activeIssuesInResidentCityRangeFilterOptions: FilterOption[] = [
      ...
      {
        id: '',
        attributeName: 'title',
      ...
      {
        id: '',
      ...
      {
        id: '',
      ...
      {
        id: '',
          ...
          components={{
            Toolbar: () => (
              <GridToolbarContainer>
                <Button
                  id="FilterRelationActionedemokraciaAdminAdminEdemokraciaAdminAdminUserIssuesViewEdemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInResidentCityTableAction"
                  startIcon={<MdiIcon path="filter" />}
                  variant="text"
                  onClick={() => {
                    tableActionActiveIssuesInResidentCityAction(
                      'FilterRelationActionedemokraciaAdminAdminEdemokraciaAdminAdminUserIssuesViewEdemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInResidentCityTableAction-filter',
                      filterOptions,
                      filters,
                    );
                  }}
