...
import { routeToAdminUserIssuesActiveIssuesInResidentCountyView } from '~/routes';
...
export const useRowViewActiveIssuesInResidentCountyAction: RowViewActiveIssuesInResidentCountyAction = () => {
  ...
  return async function (
    ...
    closeAllDialogs();
    navigate(routeToAdminUserIssuesActiveIssuesInResidentCountyView(entry.__signedIdentifier));
  };
};
