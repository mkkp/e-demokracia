...
import { routeToAdminUserIssuesActiveIssuesInActivityDistrictsView } from '~/routes';
...
export const useRowViewActiveIssuesInActivityDistrictsAction: RowViewActiveIssuesInActivityDistrictsAction = () => {
  ...
  return async function (
    ...
    closeAllDialogs();
    navigate(routeToAdminUserIssuesActiveIssuesInActivityDistrictsView(entry.__signedIdentifier));
  };
};
