...
export const ADMIN_ADMIN_USER_ISSUES_VIEW_ACTIVE_ISSUES_IN_ACTIVITY_COUNTIES =
  'AdminAdminUserIssuesViewActiveIssuesInActivityCounties';
...
>((props, ref) => {
  ...
  const filterModelKey = `-${ownerData.__signedIdentifier}-filterModel`;
  const filtersKey = `-${ownerData.__signedIdentifier}-filters`;
  ...
  const activeIssuesInActivityCountiesRangeFilterOptions: FilterOption[] = [
    {
      id: '',
      attributeName: 'scope',
    ...
    {
      id: '',
      attributeName: 'title',
    ...
    {
      id: '',
    ...
    {
      id: '',
    ...
    {
      id: '',
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              <Button
                id="FilterRelationActionedemokraciaAdminAdminEdemokraciaAdminAdminUserIssuesViewEdemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInActivityCountiesTableAction"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() => {
                  tableActionActiveIssuesInActivityCountiesAction(
                    'FilterRelationActionedemokraciaAdminAdminEdemokraciaAdminAdminUserIssuesViewEdemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInActivityCountiesTableAction-filter',
                    filterOptions,
                    filters,
                  );
                }}
