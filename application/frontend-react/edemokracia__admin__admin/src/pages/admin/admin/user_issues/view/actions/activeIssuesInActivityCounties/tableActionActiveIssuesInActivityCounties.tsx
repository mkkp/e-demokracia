...
export type TableActionActiveIssuesInActivityCountiesAction = (
  id: string,
  filterOptions: FilterOption[],
  filters: Filter[],
) => Promise<void>;

export const useTableActionActiveIssuesInActivityCountiesAction = (
  ...
  const columnNames = ['countyRepresentation', 'title', 'created', 'numberOfDebates', 'status'];

  return async function tableActionActiveIssuesInActivityCountiesAction(
    id: string,
    filterOptions: FilterOption[],
    filters: Filter[],
  ) {
