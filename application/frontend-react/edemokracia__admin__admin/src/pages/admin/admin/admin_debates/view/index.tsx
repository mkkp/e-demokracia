              ...
              >
                <Grid item xs={12}>
                  <Grid container spacing={2}>
                    <Grid item>
                      <LoadingButton
                        id="ButtonedemokraciaAdminAdminEdemokraciaAdminAdminAdminDebatesViewDefaultDebateViewEditActionsActionButtonBarCloseDebate"
                        loading={isLoading}
                    ...
                    {!data.isNotFavorite && (
                      <Grid item>
                        <LoadingButton
                          id="ButtonedemokraciaAdminAdminEdemokraciaAdminAdminAdminDebatesViewDefaultDebateViewEditActionsActionButtonBarAddToFavorites"
                          loading={isLoading}
                    ...
                    {!data.isFavorite && (
                      <Grid item>
                        <LoadingButton
                          id="ButtonedemokraciaAdminAdminEdemokraciaAdminAdminAdminDebatesViewDefaultDebateViewEditActionsActionButtonBarRemoveFromFavorites"
                          loading={isLoading}
