...
export type AdminIssueCommentsViewPostRefreshAction = (
...
export const ADMIN_ISSUE_COMMENTS_VIEW_POST_REFRESH_HOOK_INTERFACE_KEY = 'AdminIssueCommentsViewPostRefreshHook';
export type AdminIssueCommentsViewPostRefreshHook = () => AdminIssueCommentsViewPostRefreshAction;
...
export default function AdminIssueCommentsView() {
  ...
  const { service: postRefreshHook } = useTrackService<AdminIssueCommentsViewPostRefreshHook>(
    `(${OBJECTCLASS}=${ADMIN_ISSUE_COMMENTS_VIEW_POST_REFRESH_HOOK_INTERFACE_KEY})`,
  );
  const postRefreshAction: AdminIssueCommentsViewPostRefreshAction | undefined = postRefreshHook && postRefreshHook();
          ...
          <Box sx={mainContainerPadding}>
            ...
            >
              <Grid item xs={12} sm={12}>
                <Card id="FlexedemokraciaAdminAdminEdemokraciaAdminIssueCommentsViewDefaultCommentViewEditGroupLabelWrapper">
                  <CardContent>
                    <Grid container direction="column" alignItems="stretch" justifyContent="flex-start" spacing={2}>
                      <Grid item xs={12} sm={12}>
                        <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                          ...
                          <Typography
                            id="LabeledemokraciaAdminAdminEdemokraciaAdminIssueCommentsViewDefaultCommentViewEditGroupLabelWrapperGroupLabel"
                            variant="h6"
                            component="h1"
                          >
                      ...
                      <Grid item xs={12} sm={12}>
                        <Grid
                          id="FlexedemokraciaAdminAdminEdemokraciaAdminIssueCommentsViewDefaultCommentViewEditGroupLabelWrapperGroup"
                          container
                          direction="row"
                          alignItems="stretch"
                          justifyContent="flex-start"
                        ...
                        >
                          <Grid item xs={12} sm={12} md={4.0}>
                            <DateTimePicker
                              ...
                              slotProps={{
                                textField: {
                                  id: 'DateTimeInputedemokraciaAdminAdminEdemokraciaAdminIssueCommentsViewDefaultCommentViewEditGroupLabelWrapperGroupCreated',
                                  required: false,
                          ...
                          <Grid item xs={12} sm={12}>
                            <TextField
                              required={true}
                              name="comment"
                              id="TextAreaedemokraciaAdminAdminEdemokraciaAdminIssueCommentsViewDefaultCommentViewEditGroupLabelWrapperGroupComment"
                          ...
                          <Grid item xs={12} sm={12} md={1.0}>
                            <NumericInput
                              required={false}
                              name="upVotes"
                              id="NumericInputedemokraciaAdminAdminEdemokraciaAdminIssueCommentsViewDefaultCommentViewEditGroupLabelWrapperGroupUpVotes"
                          ...
                          <Grid item xs={12} sm={12} md={1.0}>
                            <NumericInput
                              required={false}
                              name="downVotes"
                              id="NumericInputedemokraciaAdminAdminEdemokraciaAdminIssueCommentsViewDefaultCommentViewEditGroupLabelWrapperGroupDownVotes"
