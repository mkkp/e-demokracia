...
export type AdminIssueCityViewPostRefreshAction = (
...
export const ADMIN_ISSUE_CITY_VIEW_POST_REFRESH_HOOK_INTERFACE_KEY = 'AdminIssueCityViewPostRefreshHook';
export type AdminIssueCityViewPostRefreshHook = () => AdminIssueCityViewPostRefreshAction;
...
export default function AdminIssueCityView() {
  ...
  const { service: postRefreshHook } = useTrackService<AdminIssueCityViewPostRefreshHook>(
    `(${OBJECTCLASS}=${ADMIN_ISSUE_CITY_VIEW_POST_REFRESH_HOOK_INTERFACE_KEY})`,
  );
  const postRefreshAction: AdminIssueCityViewPostRefreshAction | undefined = postRefreshHook && postRefreshHook();
