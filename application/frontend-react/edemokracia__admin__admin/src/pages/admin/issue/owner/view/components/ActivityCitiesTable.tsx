...
export const ADMIN_ISSUE_OWNER_VIEW_ACTIVITY_CITIES = 'AdminIssueOwnerViewActivityCities';
...
export const ActivityCitiesTable = (props: ActivityCitiesTableProps) => {
  ...
  const activityCitiesRowActions: TableRowAction<AdminCityStored>[] = [
    {
      id: 'RemoveActionedemokraciaAdminAdminEdemokraciaAdminIssueOwnerViewEdemokraciaAdminAdminEdemokraciaAdminUserActivityCitiesRowRemove',
