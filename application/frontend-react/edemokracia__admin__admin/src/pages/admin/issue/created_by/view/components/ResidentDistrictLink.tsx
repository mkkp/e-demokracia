...
export function ResidentDistrictLink(props: ResidentDistrictLinkProps) {
  ...
  const residentDistrictRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminIssueCreatedByViewDefaultUserViewEditAreasLabelWrapperAreasResidencyResidentDistrictRepresentationFilter',
  ...
  return (
    <AggregationInput
      ...
      id="LinkedemokraciaAdminAdminEdemokraciaAdminIssueCreatedByViewDefaultUserViewEditAreasLabelWrapperAreasResidencyResidentDistrict"
