...
export const ADMIN_ISSUE_CREATED_BY_VIEW_ACTIVITY_CITIES = 'AdminIssueCreatedByViewActivityCities';
...
export const ActivityCitiesTable = (props: ActivityCitiesTableProps) => {
  ...
  const activityCitiesRowActions: TableRowAction<AdminCityStored>[] = [
    {
      id: 'RemoveActionedemokraciaAdminAdminEdemokraciaAdminIssueCreatedByViewEdemokraciaAdminAdminEdemokraciaAdminUserActivityCitiesRowRemove',
