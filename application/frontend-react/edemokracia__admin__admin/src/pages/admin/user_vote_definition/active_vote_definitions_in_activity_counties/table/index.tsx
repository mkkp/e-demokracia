...
// Page name: edemokracia::admin::UserVoteDefinition.activeVoteDefinitionsInActivityCounties#Table
...
/**
 * Name: edemokracia::admin::UserVoteDefinition.activeVoteDefinitionsInActivityCounties#Table
 * Is Access: false
 * Type: Table
 **/
export default function AdminUserVoteDefinitionActiveVoteDefinitionsInActivityCountiesTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionActiveVoteDefinitionsInActivityCountiesTable-data-grid">
