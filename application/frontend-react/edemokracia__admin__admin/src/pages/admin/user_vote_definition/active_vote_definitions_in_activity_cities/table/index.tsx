...
// Page name: edemokracia::admin::UserVoteDefinition.activeVoteDefinitionsInActivityCities#Table
...
/**
 * Name: edemokracia::admin::UserVoteDefinition.activeVoteDefinitionsInActivityCities#Table
 * Is Access: false
 * Type: Table
 **/
export default function AdminUserVoteDefinitionActiveVoteDefinitionsInActivityCitiesTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionActiveVoteDefinitionsInActivityCitiesTable-data-grid">
