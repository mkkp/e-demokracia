...
// Page name: edemokracia::admin::UserVoteDefinition.ownedVoteDefinitions#View
...
export type AdminUserVoteDefinitionOwnedVoteDefinitionsViewPostRefreshAction = (
...
export const ADMIN_USER_VOTE_DEFINITION_OWNED_VOTE_DEFINITIONS_VIEW_POST_REFRESH_HOOK_INTERFACE_KEY =
  'AdminUserVoteDefinitionOwnedVoteDefinitionsViewPostRefreshHook';
export type AdminUserVoteDefinitionOwnedVoteDefinitionsViewPostRefreshHook =
  () => AdminUserVoteDefinitionOwnedVoteDefinitionsViewPostRefreshAction;

/**
 * Name: edemokracia::admin::UserVoteDefinition.ownedVoteDefinitions#View
 * Is Access: false
 * Type: View
 * Edit Mode Available: true
 **/
export default function AdminUserVoteDefinitionOwnedVoteDefinitionsView() {
  ...
  const handleUpdateError = useErrorHandler<AdminVoteDefinition>(
    `(&(${OBJECTCLASS}=${ERROR_PROCESSOR_HOOK_INTERFACE_KEY})(operation=Update)(component=AdminUserVoteDefinitionOwnedVoteDefinitionsView))`,
  );
  ...
  const { service: postRefreshHook } = useTrackService<AdminUserVoteDefinitionOwnedVoteDefinitionsViewPostRefreshHook>(
    `(${OBJECTCLASS}=${ADMIN_USER_VOTE_DEFINITION_OWNED_VOTE_DEFINITIONS_VIEW_POST_REFRESH_HOOK_INTERFACE_KEY})`,
  );
  const postRefreshAction: AdminUserVoteDefinitionOwnedVoteDefinitionsViewPostRefreshAction | undefined =
        ...
        <Box sx={mainContainerPadding}>
          ...
          >
            <Grid item xs={12} sm={12}>
              <Card id="FlexedemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionOwnedVoteDefinitionsViewDefaultVoteDefinitionViewEditGroup">
                <CardContent>
                  <Grid container direction="column" alignItems="stretch" justifyContent="flex-start" spacing={2}>
                    <Grid item xs={12} sm={12}>
                      <TextField
                        required={true}
                        name="title"
                        id="TextInputedemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionOwnedVoteDefinitionsViewDefaultVoteDefinitionViewEditGroupTitle"
                    ...
                    <Grid item xs={12} sm={12}>
                      <DateTimePicker
                        ...
                        slotProps={{
                          textField: {
                            id: 'DateTimeInputedemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionOwnedVoteDefinitionsViewDefaultVoteDefinitionViewEditGroupCloseAt',
                            required: true,
                    ...
                    <Grid item xs={12} sm={12}>
                      <TextField
                        required={true}
                        name="status"
                        id="EnumerationComboedemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionOwnedVoteDefinitionsViewDefaultVoteDefinitionViewEditGroupStatus"
                    ...
                    <Grid item xs={12} sm={12}>
                      <AssociationButton
                        id="NavigationToPageActionedemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionOwnedVoteDefinitionsViewEdemokraciaAdminAdminEdemokraciaAdminVoteDefinitionDebateButtonNavigate"
                        variant={undefined}
                        editMode={editMode}
                    ...
                    <Grid item xs={12} sm={12}>
                      <AssociationButton
                        id="NavigationToPageActionedemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionOwnedVoteDefinitionsViewEdemokraciaAdminAdminEdemokraciaAdminVoteDefinitionIssueButtonNavigate"
                        variant={undefined}
                        editMode={editMode}
                    ...
                    <Grid item xs={12} sm={12}>
                      <DateTimePicker
                        ...
                        slotProps={{
                          textField: {
                            id: 'DateTimeInputedemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionOwnedVoteDefinitionsViewDefaultVoteDefinitionViewEditGroupCreated',
                            required: true,
                    ...
                    <Grid item xs={12} sm={12}>
                      <TextField
                        required={true}
                        name="description"
                        id="TextAreaedemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionOwnedVoteDefinitionsViewDefaultVoteDefinitionViewEditGroupDescription"
            ...
            <Grid container item xs={12} sm={12}>
              <ModeledTabs
                id="TabControlleredemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionOwnedVoteDefinitionsViewDefaultVoteDefinitionViewEditTabBar"
                ownerData={data}
                validation={validation}
                orientation='horizontal'
                childTabs={[
                  {
                    id: 'TabedemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionOwnedVoteDefinitionsViewDefaultVoteDefinitionViewEditTabBarYesnovote',
                  ...
                  {
                    id: 'TabedemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionOwnedVoteDefinitionsViewDefaultVoteDefinitionViewEditTabBarYesnoabstainvote',
                  ...
                  {
                    id: 'TabedemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionOwnedVoteDefinitionsViewDefaultVoteDefinitionViewEditTabBarSelectanswervote',
                  ...
                  {
                    id: 'TabedemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionOwnedVoteDefinitionsViewDefaultVoteDefinitionViewEditTabBarRatingvote',
              ...
              >
                {!data.isNotYesNoType && (
                  <Grid item xs={12} sm={12}>
                    <Grid
                      id="FlexedemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionOwnedVoteDefinitionsViewDefaultVoteDefinitionViewEditTabBarYesnovoteYesnovote"
                      container
                      direction="row"
                    ...
                    >
                      {!data.isNotYesNoType && (
                        <Grid item xs={12} sm={12} md={4.0}>
                          <LoadingButton
                            id="CallOperationActionedemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionOwnedVoteDefinitionsViewEdemokraciaAdminAdminEdemokraciaAdminVoteDefinitionVoteYesNoButtonCallOperation"
                            loading={isLoading}
                            variant={undefined}
                ...
                {!data.isNotYesNoAbstainType && (
                  <Grid item xs={12} sm={12}>
                    <Grid
                      id="FlexedemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionOwnedVoteDefinitionsViewDefaultVoteDefinitionViewEditTabBarYesnoabstainvoteYesnoabstainvote"
                      container
                      direction="row"
                      alignItems="flex-start"
                      justifyContent="flex-start"
                    ...
                    >
                      {!data.isNotYesNoAbstainType && (
                        <Grid item xs={12} sm={12} md={4.0}>
                          <LoadingButton
                            id="CallOperationActionedemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionOwnedVoteDefinitionsViewEdemokraciaAdminAdminEdemokraciaAdminVoteDefinitionVoteYesNoAbstainButtonCallOperation"
                            loading={isLoading}
                            variant={undefined}
                            startIcon={<MdiIcon path="vote" />}
                            loadingPosition="start"
                ...
                {!data.isNotSelectAnswerType && (
                  <Grid item xs={12} sm={12}>
                    <Grid
                      id="FlexedemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionOwnedVoteDefinitionsViewDefaultVoteDefinitionViewEditTabBarSelectanswervoteSelectanswervote"
                      container
                      direction="row"
                      alignItems="flex-start"
                      justifyContent="flex-start"
                    ...
                    >
                      {!data.isNotSelectAnswerType && (
                        <Grid item xs={12} sm={12} md={4.0}>
                          <LoadingButton
                            id="CallOperationActionedemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionOwnedVoteDefinitionsViewEdemokraciaAdminAdminEdemokraciaAdminVoteDefinitionVoteSelectAnswerButtonCallOperation"
                            loading={isLoading}
                            variant={undefined}
                            startIcon={<MdiIcon path="vote" />}
                            loadingPosition="start"
                ...
                {!data.isNotRatingType && (
                  <Grid item xs={12} sm={12}>
                    <Grid
                      id="FlexedemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionOwnedVoteDefinitionsViewDefaultVoteDefinitionViewEditTabBarRatingvoteRatingvote"
                      container
                      direction="row"
                      alignItems="flex-start"
                      justifyContent="flex-start"
                    ...
                    >
                      {!data.isNotRatingType && (
                        <Grid item xs={12} sm={12} md={4.0}>
                          <LoadingButton
                            id="CallOperationActionedemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionOwnedVoteDefinitionsViewEdemokraciaAdminAdminEdemokraciaAdminVoteDefinitionVoteRatingButtonCallOperation"
                            loading={isLoading}
                            variant={undefined}
                            startIcon={<MdiIcon path="vote" />}
                            loadingPosition="start"
