...
// Page name: edemokracia::admin::UserVoteDefinition.ownedVoteDefinitions#Table
...
/**
 * Name: edemokracia::admin::UserVoteDefinition.ownedVoteDefinitions#Table
 * Is Access: false
 * Type: Table
 **/
export default function AdminUserVoteDefinitionOwnedVoteDefinitionsTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionOwnedVoteDefinitionsTable-data-grid">
