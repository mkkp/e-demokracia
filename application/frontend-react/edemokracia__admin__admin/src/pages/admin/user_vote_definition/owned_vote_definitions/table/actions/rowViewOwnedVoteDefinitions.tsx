...
import { routeToAdminUserVoteDefinitionOwnedVoteDefinitionsView } from '~/routes';
...
export const useRowViewOwnedVoteDefinitionsAction: RowViewOwnedVoteDefinitionsAction = () => {
  ...
  return async function (
    ...
    closeAllDialogs();
    navigate(routeToAdminUserVoteDefinitionOwnedVoteDefinitionsView(entry.__signedIdentifier));
  };
};
