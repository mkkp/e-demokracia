...
export const ADMIN_USER_VOTE_DEFINITION_OWNED_VOTE_DEFINITIONS_TABLE_VOTE_DEFINITION_TABLE =
  'AdminUserVoteDefinitionOwnedVoteDefinitionsTableVoteDefinition_Table';
...
export const VoteDefinition_TableTable = forwardRef<RefreshableTable, VoteDefinition_TableTableProps>((props, ref) => {
  ...
  const filterModelKey = `TableedemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionOwnedVoteDefinitionsTableDefaultOwnedVoteDefinitionsVoteDefinitionTable-${__identifier}-filterModel`;
  const filtersKey = `TableedemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionOwnedVoteDefinitionsTableDefaultOwnedVoteDefinitionsVoteDefinitionTable-${__identifier}-filters`;
  ...
  useEffect(() => {
    setFilters(
      getItemParsedWithDefault(
        `TableedemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionOwnedVoteDefinitionsTableDefaultOwnedVoteDefinitionsVoteDefinitionTable-${__identifier}-filters`,
        [...filters],
      ),
    );
  }, [ownerData]);
  ...
  const ownedVoteDefinitionsRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionOwnedVoteDefinitionsTableDefaultOwnedVoteDefinitionsVoteDefinitionTableVoteTypeFilter',
    ...
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionOwnedVoteDefinitionsTableDefaultOwnedVoteDefinitionsVoteDefinitionTableTitleFilter',
      attributeName: 'title',
    ...
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionOwnedVoteDefinitionsTableDefaultOwnedVoteDefinitionsVoteDefinitionTableNumberOfVotesFilter',
    ...
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionOwnedVoteDefinitionsTableDefaultOwnedVoteDefinitionsVoteDefinitionTableCreatedFilter',
    ...
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionOwnedVoteDefinitionsTableDefaultOwnedVoteDefinitionsVoteDefinitionTableStatusFilter',
    ...
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionOwnedVoteDefinitionsTableDefaultOwnedVoteDefinitionsVoteDefinitionTableCloseAtFilter',
    ...
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionOwnedVoteDefinitionsTableDefaultOwnedVoteDefinitionsVoteDefinitionTableDescriptionFilter',
  ...
  const rowActions: TableRowAction<AdminVoteDefinitionStored>[] = [
    {
      id: 'CallOperationActionedemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionOwnedVoteDefinitionsTableEdemokraciaAdminAdminEdemokraciaAdminVoteDefinitionVoteYesNoButtonCallOperation',
    ...
    {
      id: 'CallOperationActionedemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionOwnedVoteDefinitionsTableEdemokraciaAdminAdminEdemokraciaAdminVoteDefinitionVoteYesNoAbstainButtonCallOperation',
    ...
    {
      id: 'CallOperationActionedemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionOwnedVoteDefinitionsTableEdemokraciaAdminAdminEdemokraciaAdminVoteDefinitionVoteSelectAnswerButtonCallOperation',
    ...
    {
      id: 'CallOperationActionedemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionOwnedVoteDefinitionsTableEdemokraciaAdminAdminEdemokraciaAdminVoteDefinitionVoteRatingButtonCallOperation',
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              <Button
                id="FilterActionedemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionOwnedVoteDefinitionsTableEdemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionOwnedVoteDefinitionsPageFilter"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() => {
                  pageFilterOwnedVoteDefinitionsAction(
                    'FilterActionedemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionOwnedVoteDefinitionsTableEdemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionOwnedVoteDefinitionsPageFilter-filter',
                    filterOptions,
                    filters,
                  );
                }}
