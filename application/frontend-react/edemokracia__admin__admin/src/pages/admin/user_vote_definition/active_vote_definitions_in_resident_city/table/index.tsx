...
// Page name: edemokracia::admin::UserVoteDefinition.activeVoteDefinitionsInResidentCity#Table
...
/**
 * Name: edemokracia::admin::UserVoteDefinition.activeVoteDefinitionsInResidentCity#Table
 * Is Access: false
 * Type: Table
 **/
export default function AdminUserVoteDefinitionActiveVoteDefinitionsInResidentCityTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionActiveVoteDefinitionsInResidentCityTable-data-grid">
