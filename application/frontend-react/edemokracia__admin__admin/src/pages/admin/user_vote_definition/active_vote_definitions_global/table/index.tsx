...
// Page name: edemokracia::admin::UserVoteDefinition.activeVoteDefinitionsGlobal#Table
...
/**
 * Name: edemokracia::admin::UserVoteDefinition.activeVoteDefinitionsGlobal#Table
 * Is Access: false
 * Type: Table
 **/
export default function AdminUserVoteDefinitionActiveVoteDefinitionsGlobalTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionActiveVoteDefinitionsGlobalTable-data-grid">
