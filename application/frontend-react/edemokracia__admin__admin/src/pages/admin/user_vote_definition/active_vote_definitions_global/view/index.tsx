...
// Page name: edemokracia::admin::UserVoteDefinition.activeVoteDefinitionsGlobal#View
...
export type AdminUserVoteDefinitionActiveVoteDefinitionsGlobalViewPostRefreshAction = (
...
export const ADMIN_USER_VOTE_DEFINITION_ACTIVE_VOTE_DEFINITIONS_GLOBAL_VIEW_POST_REFRESH_HOOK_INTERFACE_KEY =
  'AdminUserVoteDefinitionActiveVoteDefinitionsGlobalViewPostRefreshHook';
export type AdminUserVoteDefinitionActiveVoteDefinitionsGlobalViewPostRefreshHook =
  () => AdminUserVoteDefinitionActiveVoteDefinitionsGlobalViewPostRefreshAction;
...
export default function AdminUserVoteDefinitionActiveVoteDefinitionsGlobalView() {
  ...
  const { service: postRefreshHook } =
    useTrackService<AdminUserVoteDefinitionActiveVoteDefinitionsGlobalViewPostRefreshHook>(
      `(${OBJECTCLASS}=${ADMIN_USER_VOTE_DEFINITION_ACTIVE_VOTE_DEFINITIONS_GLOBAL_VIEW_POST_REFRESH_HOOK_INTERFACE_KEY})`,
    );
  const postRefreshAction: AdminUserVoteDefinitionActiveVoteDefinitionsGlobalViewPostRefreshAction | undefined =
        ...
        <Box sx={mainContainerPadding}>
          ...
          >
            <Grid item xs={12} sm={12}>
              <Card id="FlexedemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionActiveVoteDefinitionsGlobalViewDefaultVoteDefinitionViewEditGroup">
                <CardContent>
                  <Grid container direction="column" alignItems="stretch" justifyContent="flex-start" spacing={2}>
                    <Grid item xs={12} sm={12}>
                      <TextField
                        required={true}
                        name="title"
                        id="TextInputedemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionActiveVoteDefinitionsGlobalViewDefaultVoteDefinitionViewEditGroupTitle"
                    ...
                    <Grid item xs={12} sm={12}>
                      <DateTimePicker
                        ...
                        slotProps={{
                          textField: {
                            id: 'DateTimeInputedemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionActiveVoteDefinitionsGlobalViewDefaultVoteDefinitionViewEditGroupCloseAt',
                            required: true,
                    ...
                    <Grid item xs={12} sm={12}>
                      <TextField
                        required={true}
                        name="status"
                        id="EnumerationComboedemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionActiveVoteDefinitionsGlobalViewDefaultVoteDefinitionViewEditGroupStatus"
                    ...
                    <Grid item xs={12} sm={12}>
                      <AssociationButton
                        id="NavigationToPageActionedemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionActiveVoteDefinitionsGlobalViewEdemokraciaAdminAdminEdemokraciaAdminVoteDefinitionDebateButtonNavigate"
                        variant={undefined}
                        editMode={editMode}
                    ...
                    <Grid item xs={12} sm={12}>
                      <AssociationButton
                        id="NavigationToPageActionedemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionActiveVoteDefinitionsGlobalViewEdemokraciaAdminAdminEdemokraciaAdminVoteDefinitionIssueButtonNavigate"
                        variant={undefined}
                        editMode={editMode}
                    ...
                    <Grid item xs={12} sm={12}>
                      <DateTimePicker
                        ...
                        slotProps={{
                          textField: {
                            id: 'DateTimeInputedemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionActiveVoteDefinitionsGlobalViewDefaultVoteDefinitionViewEditGroupCreated',
                            required: true,
                    ...
                    <Grid item xs={12} sm={12}>
                      <TextField
                        required={true}
                        name="description"
                        id="TextAreaedemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionActiveVoteDefinitionsGlobalViewDefaultVoteDefinitionViewEditGroupDescription"
            ...
            <Grid container item xs={12} sm={12}>
              <ModeledTabs
                id="TabControlleredemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionActiveVoteDefinitionsGlobalViewDefaultVoteDefinitionViewEditTabBar"
                ownerData={data}
                validation={validation}
                orientation='horizontal'
                childTabs={[
                  {
                    id: 'TabedemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionActiveVoteDefinitionsGlobalViewDefaultVoteDefinitionViewEditTabBarYesnovote',
                  ...
                  {
                    id: 'TabedemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionActiveVoteDefinitionsGlobalViewDefaultVoteDefinitionViewEditTabBarYesnoabstainvote',
                  ...
                  {
                    id: 'TabedemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionActiveVoteDefinitionsGlobalViewDefaultVoteDefinitionViewEditTabBarSelectanswervote',
                  ...
                  {
                    id: 'TabedemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionActiveVoteDefinitionsGlobalViewDefaultVoteDefinitionViewEditTabBarRatingvote',
              ...
              >
                {!data.isNotYesNoType && (
                  <Grid item xs={12} sm={12}>
                    <Grid
                      id="FlexedemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionActiveVoteDefinitionsGlobalViewDefaultVoteDefinitionViewEditTabBarYesnovoteYesnovote"
                      container
                      direction="row"
                    ...
                    >
                      {!data.isNotYesNoType && (
                        <Grid item xs={12} sm={12} md={4.0}>
                          <LoadingButton
                            id="CallOperationActionedemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionActiveVoteDefinitionsGlobalViewEdemokraciaAdminAdminEdemokraciaAdminVoteDefinitionVoteYesNoButtonCallOperation"
                            loading={isLoading}
                            variant={undefined}
                ...
                {!data.isNotYesNoAbstainType && (
                  <Grid item xs={12} sm={12}>
                    <Grid
                      id="FlexedemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionActiveVoteDefinitionsGlobalViewDefaultVoteDefinitionViewEditTabBarYesnoabstainvoteYesnoabstainvote"
                      container
                      direction="row"
                      alignItems="flex-start"
                      justifyContent="flex-start"
                    ...
                    >
                      {!data.isNotYesNoAbstainType && (
                        <Grid item xs={12} sm={12} md={4.0}>
                          <LoadingButton
                            id="CallOperationActionedemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionActiveVoteDefinitionsGlobalViewEdemokraciaAdminAdminEdemokraciaAdminVoteDefinitionVoteYesNoAbstainButtonCallOperation"
                            loading={isLoading}
                            variant={undefined}
                            startIcon={<MdiIcon path="vote" />}
                            loadingPosition="start"
                ...
                {!data.isNotSelectAnswerType && (
                  <Grid item xs={12} sm={12}>
                    <Grid
                      id="FlexedemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionActiveVoteDefinitionsGlobalViewDefaultVoteDefinitionViewEditTabBarSelectanswervoteSelectanswervote"
                      container
                      direction="row"
                      alignItems="flex-start"
                      justifyContent="flex-start"
                    ...
                    >
                      {!data.isNotSelectAnswerType && (
                        <Grid item xs={12} sm={12} md={4.0}>
                          <LoadingButton
                            id="CallOperationActionedemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionActiveVoteDefinitionsGlobalViewEdemokraciaAdminAdminEdemokraciaAdminVoteDefinitionVoteSelectAnswerButtonCallOperation"
                            loading={isLoading}
                            variant={undefined}
                            startIcon={<MdiIcon path="vote" />}
                            loadingPosition="start"
                ...
                {!data.isNotRatingType && (
                  <Grid item xs={12} sm={12}>
                    <Grid
                      id="FlexedemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionActiveVoteDefinitionsGlobalViewDefaultVoteDefinitionViewEditTabBarRatingvoteRatingvote"
                      container
                      direction="row"
                      alignItems="flex-start"
                      justifyContent="flex-start"
                    ...
                    >
                      {!data.isNotRatingType && (
                        <Grid item xs={12} sm={12} md={4.0}>
                          <LoadingButton
                            id="CallOperationActionedemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionActiveVoteDefinitionsGlobalViewEdemokraciaAdminAdminEdemokraciaAdminVoteDefinitionVoteRatingButtonCallOperation"
                            loading={isLoading}
                            variant={undefined}
                            startIcon={<MdiIcon path="vote" />}
                            loadingPosition="start"
