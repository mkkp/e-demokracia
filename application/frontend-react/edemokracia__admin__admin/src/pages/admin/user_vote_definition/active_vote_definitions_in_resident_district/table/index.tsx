...
// Page name: edemokracia::admin::UserVoteDefinition.activeVoteDefinitionsInResidentDistrict#Table
...
/**
 * Name: edemokracia::admin::UserVoteDefinition.activeVoteDefinitionsInResidentDistrict#Table
 * Is Access: false
 * Type: Table
 **/
export default function AdminUserVoteDefinitionActiveVoteDefinitionsInResidentDistrictTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaAdminAdminEdemokraciaAdminUserVoteDefinitionActiveVoteDefinitionsInResidentDistrictTable-data-grid">
