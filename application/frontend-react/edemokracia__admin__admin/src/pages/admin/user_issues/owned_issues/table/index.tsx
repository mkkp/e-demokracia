...
// Page name: edemokracia::admin::UserIssues.ownedIssues#Table
...
/**
 * Name: edemokracia::admin::UserIssues.ownedIssues#Table
 * Is Access: false
 * Type: Table
 **/
export default function AdminUserIssuesOwnedIssuesTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaAdminAdminEdemokraciaAdminUserIssuesOwnedIssuesTable-data-grid">
                  <Issue_TableTable
                    ref={tableRef}
