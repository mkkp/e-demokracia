...
// Page name: edemokracia::admin::UserIssues.activeIssuesGlobal#Table
...
/**
 * Name: edemokracia::admin::UserIssues.activeIssuesGlobal#Table
 * Is Access: false
 * Type: Table
 **/
export default function AdminUserIssuesActiveIssuesGlobalTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesGlobalTable-data-grid">
                  <Issue_TableTable
                    ref={tableRef}
