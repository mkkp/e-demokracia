...
export const ADMIN_USER_ISSUES_ACTIVE_ISSUES_GLOBAL_VIEW_ATTACHMENTS =
  'AdminUserIssuesActiveIssuesGlobalViewAttachments';
...
export const AttachmentsTable = (props: AttachmentsTableProps) => {
  ...
  const filterModelKey = `TableedemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesGlobalViewDefaultIssueViewEditOtherAttachmentsAttachmentsAttachmentsLabelWrapperAttachments-${ownerData.__identifier}-filterModel`;
  const filtersKey = `TableedemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesGlobalViewDefaultIssueViewEditOtherAttachmentsAttachmentsAttachmentsLabelWrapperAttachments-${ownerData.__identifier}-filters`;
      ...
      renderCell: (params: GridRenderCellParams<any, AdminIssueAttachmentStored>) => {
        return params.row.file ? (
          <ButtonGroup size="small" variant="outlined">
            <Button
              id="ColumnedemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesGlobalViewDefaultIssueViewEditOtherAttachmentsAttachmentsAttachmentsLabelWrapperAttachmentsFile-download"
            ...
            <Button
              id="ColumnedemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesGlobalViewDefaultIssueViewEditOtherAttachmentsAttachmentsAttachmentsLabelWrapperAttachmentsFile-view"
              onClick={(event: any) => {
                event.preventDefault();
                event.stopPropagation();
  ...
  const attachmentsRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesGlobalViewDefaultIssueViewEditOtherAttachmentsAttachmentsAttachmentsLabelWrapperAttachmentsLinkFilter',
      attributeName: 'link',
    ...
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesGlobalViewDefaultIssueViewEditOtherAttachmentsAttachmentsAttachmentsLabelWrapperAttachmentsTypeFilter',
      attributeName: 'type',
  ...
  const attachmentsRowActions: TableRowAction<AdminIssueAttachmentStored>[] = [
    {
      id: 'DeleteActionedemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesGlobalViewEdemokraciaAdminAdminEdemokraciaAdminIssueAttachmentsRowDelete',
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              <Button
                id="CreateActionedemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesGlobalViewEdemokraciaAdminAdminEdemokraciaAdminIssueAttachmentsTableCreate"
              ...
              <Button
                id="TableedemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesGlobalViewDefaultIssueViewEditOtherAttachmentsAttachmentsAttachmentsLabelWrapperAttachments-filter"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() =>
                  filter(
                    'TableedemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesGlobalViewDefaultIssueViewEditOtherAttachmentsAttachmentsAttachmentsLabelWrapperAttachments-filter',
                    filterOptions,
                    filters,
                  )
                }
