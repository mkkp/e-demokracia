...
// Page name: edemokracia::admin::UserIssues.activeIssuesInActivityCities#Table
...
/**
 * Name: edemokracia::admin::UserIssues.activeIssuesInActivityCities#Table
 * Is Access: false
 * Type: Table
 **/
export default function AdminUserIssuesActiveIssuesInActivityCitiesTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInActivityCitiesTable-data-grid">
                  <Issue_TableTable
                    ref={tableRef}
