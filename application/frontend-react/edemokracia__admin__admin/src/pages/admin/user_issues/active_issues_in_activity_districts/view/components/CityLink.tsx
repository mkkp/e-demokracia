...
export type CityLinkFilterInitializer = (ownerData: AdminIssueStored) => Filter[] | undefined;
...
export function CityLink(props: CityLinkProps) {
  ...
  const cityRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInActivityDistrictsViewDefaultIssueViewEditOtherAreaAreaCityRepresentationFilter',
  ...
  return (
    <AggregationInput
      name="city"
      id="LinkedemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInActivityDistrictsViewDefaultIssueViewEditOtherAreaAreaCity"
