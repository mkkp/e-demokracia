...
// Page name: edemokracia::admin::UserIssues.activeIssuesInActivityDistricts#Table
...
/**
 * Name: edemokracia::admin::UserIssues.activeIssuesInActivityDistricts#Table
 * Is Access: false
 * Type: Table
 **/
export default function AdminUserIssuesActiveIssuesInActivityDistrictsTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInActivityDistrictsTable-data-grid">
                  <Issue_TableTable
                    ref={tableRef}
