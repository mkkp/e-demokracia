...
// Page name: edemokracia::admin::UserIssues.activeIssuesInResidentCounty#Table
...
/**
 * Name: edemokracia::admin::UserIssues.activeIssuesInResidentCounty#Table
 * Is Access: false
 * Type: Table
 **/
export default function AdminUserIssuesActiveIssuesInResidentCountyTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInResidentCountyTable-data-grid">
                  <Issue_TableTable
                    ref={tableRef}
