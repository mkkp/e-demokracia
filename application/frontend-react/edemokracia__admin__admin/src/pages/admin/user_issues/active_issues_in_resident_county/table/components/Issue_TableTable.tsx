...
export const Issue_TableTable = forwardRef<RefreshableTable, Issue_TableTableProps>((props, ref) => {
  ...
  const rowActions: TableRowAction<AdminIssueStored>[] = [
    ...
    {
      id: 'CallOperationActionedemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInResidentCountyTableEdemokraciaAdminAdminEdemokraciaAdminIssueAddToFavoritesButtonCallOperation',
      label: t('admin.IssueTable.activeIssuesInResidentCounty.addToFavorites.ButtonCallOperation', {
    ...
    {
      id: 'CallOperationActionedemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInResidentCountyTableEdemokraciaAdminAdminEdemokraciaAdminIssueRemoveFromFavoritesButtonCallOperation',
      label: t('admin.IssueTable.activeIssuesInResidentCounty.removeFromFavorites.ButtonCallOperation', {
