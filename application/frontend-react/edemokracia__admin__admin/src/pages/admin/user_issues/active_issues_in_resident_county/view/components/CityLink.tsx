...
export function CityLink(props: CityLinkProps) {
  ...
  const cityRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInResidentCountyViewDefaultIssueViewEditOtherAreaAreaCityRepresentationFilter',
  ...
  return (
    <AggregationInput
      name="city"
      id="LinkedemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInResidentCountyViewDefaultIssueViewEditOtherAreaAreaCity"
