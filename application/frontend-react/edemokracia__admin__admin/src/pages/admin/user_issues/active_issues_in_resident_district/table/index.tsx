...
// Page name: edemokracia::admin::UserIssues.activeIssuesInResidentDistrict#Table
...
/**
 * Name: edemokracia::admin::UserIssues.activeIssuesInResidentDistrict#Table
 * Is Access: false
 * Type: Table
 **/
export default function AdminUserIssuesActiveIssuesInResidentDistrictTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInResidentDistrictTable-data-grid">
                  <Issue_TableTable
                    ref={tableRef}
