...
// Page name: edemokracia::admin::UserIssues.activeIssuesInResidentDistrict#View
...
export type AdminUserIssuesActiveIssuesInResidentDistrictViewPostRefreshAction = (
...
export const ADMIN_USER_ISSUES_ACTIVE_ISSUES_IN_RESIDENT_DISTRICT_VIEW_POST_REFRESH_HOOK_INTERFACE_KEY =
  'AdminUserIssuesActiveIssuesInResidentDistrictViewPostRefreshHook';
export type AdminUserIssuesActiveIssuesInResidentDistrictViewPostRefreshHook =
  () => AdminUserIssuesActiveIssuesInResidentDistrictViewPostRefreshAction;

/**
 * Name: edemokracia::admin::UserIssues.activeIssuesInResidentDistrict#View
 * Is Access: false
 * Type: View
 * Edit Mode Available: true
 **/
export default function AdminUserIssuesActiveIssuesInResidentDistrictView() {
  ...
  const handleUpdateError = useErrorHandler<AdminIssue>(
    `(&(${OBJECTCLASS}=${ERROR_PROCESSOR_HOOK_INTERFACE_KEY})(operation=Update)(component=AdminUserIssuesActiveIssuesInResidentDistrictView))`,
  );
  ...
  const { service: postRefreshHook } =
    useTrackService<AdminUserIssuesActiveIssuesInResidentDistrictViewPostRefreshHook>(
      `(${OBJECTCLASS}=${ADMIN_USER_ISSUES_ACTIVE_ISSUES_IN_RESIDENT_DISTRICT_VIEW_POST_REFRESH_HOOK_INTERFACE_KEY})`,
    );
  const postRefreshAction: AdminUserIssuesActiveIssuesInResidentDistrictViewPostRefreshAction | undefined =
        ...
        <Box sx={mainContainerPadding}>
          ...
          >
            <Grid item xs={12} sm={12}>
              <Grid
                id="FlexedemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInResidentDistrictViewDefaultIssueViewEditActions"
                container
                direction="row"
              ...
              >
                <Grid item xs={12}>
                  <Grid container spacing={2}>
                    <Grid item>
                      <LoadingButton
                        id="ButtonedemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInResidentDistrictViewDefaultIssueViewEditActionsPageActionButtonsCreateDebate"
                        loading={isLoading}
                    ...
                    {!data.isFavorite && (
                      <Grid item>
                        <LoadingButton
                          id="ButtonedemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInResidentDistrictViewDefaultIssueViewEditActionsPageActionButtonsAddToFavorites"
                          loading={isLoading}
                    ...
                    {!data.isNotFavorite && (
                      <Grid item>
                        <LoadingButton
                          id="ButtonedemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInResidentDistrictViewDefaultIssueViewEditActionsPageActionButtonsRemoveFromFavorites"
                          loading={isLoading}
            ...
            <Grid item xs={12} sm={12}>
              <Card id="FlexedemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInResidentDistrictViewDefaultIssueViewEditIssueLabelWrapper">
                <CardContent>
                  <Grid container direction="column" alignItems="stretch" justifyContent="flex-start" spacing={2}>
                    <Grid item xs={12} sm={12}>
                      <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                        ...
                        <Typography
                          id="LabeledemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInResidentDistrictViewDefaultIssueViewEditIssueLabelWrapperIssueLabel"
                          variant="h5"
                          component="h1"
                        >
                    ...
                    <Grid item xs={12} sm={12}>
                      <Grid
                        id="FlexedemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInResidentDistrictViewDefaultIssueViewEditIssueLabelWrapperIssue"
                        container
                        direction="row"
                        alignItems="stretch"
                        justifyContent="flex-start"
                      ...
                      >
                        ...
                        <Grid item xs={12} sm={12} md={4.0}>
                          <TextField
                            ...
                            id="EnumerationComboedemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInResidentDistrictViewDefaultIssueViewEditIssueLabelWrapperIssueDefaultVoteType"
                            label={
                        ...
                        <Grid item xs={12} sm={12} md={4.0}>
                          <TextField
                            required={true}
                            name="title"
                            id="TextInputedemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInResidentDistrictViewDefaultIssueViewEditIssueLabelWrapperIssueTitle"
                        ...
                        <Grid item xs={12} sm={12} md={4.0}>
                          <TextField
                            required={true}
                            name="status"
                            id="EnumerationComboedemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInResidentDistrictViewDefaultIssueViewEditIssueLabelWrapperIssueStatus"
                        ...
                        <Grid item xs={12} sm={12} md={4.0}>
                          <DateTimePicker
                            ...
                            slotProps={{
                              textField: {
                                id: 'DateTimeInputedemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInResidentDistrictViewDefaultIssueViewEditIssueLabelWrapperIssueCreated',
                                required: false,
                        ...
                        <Grid item xs={12} sm={12}>
                          <TextField
                            required={true}
                            name="description"
                            id="TextAreaedemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInResidentDistrictViewDefaultIssueViewEditIssueLabelWrapperIssueDescription"
            ...
            <Grid container item xs={12} sm={12}>
              <ModeledTabs
                id="TabControlleredemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInResidentDistrictViewDefaultIssueViewEditOther"
                ownerData={data}
                validation={validation}
                orientation='horizontal'
                childTabs={[
                  {
                    id: 'TabedemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInResidentDistrictViewDefaultIssueViewEditOtherArea',
                  ...
                  {
                    id: 'TabedemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInResidentDistrictViewDefaultIssueViewEditOtherAttachments',
                  ...
                  {
                    id: 'TabedemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInResidentDistrictViewDefaultIssueViewEditOtherCategories',
                  ...
                  {
                    id: 'TabedemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInResidentDistrictViewDefaultIssueViewEditOtherDebates',
                  ...
                  {
                    id: 'TabedemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInResidentDistrictViewDefaultIssueViewEditOtherComments',
              ...
              >
                <Grid item xs={12} sm={12}>
                  <Grid
                    id="FlexedemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInResidentDistrictViewDefaultIssueViewEditOtherAreaArea"
                    container
                    direction="row"
                    alignItems="flex-start"
                    justifyContent="flex-start"
                ...
                <Grid item xs={12} sm={12}>
                  <Grid
                    id="FlexedemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInResidentDistrictViewDefaultIssueViewEditOtherAttachmentsAttachments"
                    container
                    direction="row"
                    alignItems="flex-start"
                    justifyContent="flex-start"
                  ...
                  >
                    <Grid item xs={12} sm={12}>
                      <Grid
                        id="FlexedemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInResidentDistrictViewDefaultIssueViewEditOtherAttachmentsAttachmentsAttachmentsLabelWrapper"
                        container
                        direction="column"
                        alignItems="stretch"
                        justifyContent="flex-start"
                      ...
                      >
                        <Grid item xs={12} sm={12}>
                          <Grid
                            id="TableedemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInResidentDistrictViewDefaultIssueViewEditOtherAttachmentsAttachmentsAttachmentsLabelWrapperAttachments"
                            container
                            direction="column"
                            alignItems="stretch"
                            justifyContent="flex-start"
                ...
                <Grid item xs={12} sm={12}>
                  <Grid
                    id="FlexedemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInResidentDistrictViewDefaultIssueViewEditOtherCategoriesCategories"
                    container
                    direction="row"
                    alignItems="flex-start"
                    justifyContent="flex-start"
                  ...
                  >
                    <Grid item xs={12} sm={12}>
                      <Grid
                        id="FlexedemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInResidentDistrictViewDefaultIssueViewEditOtherCategoriesCategoriesCategoriesLabelWrapper"
                        container
                        direction="column"
                        alignItems="stretch"
                        justifyContent="flex-start"
                      ...
                      >
                        <Grid item xs={12} sm={12}>
                          <Grid
                            id="TableedemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInResidentDistrictViewDefaultIssueViewEditOtherCategoriesCategoriesCategoriesLabelWrapperCategories"
                            container
                            direction="column"
                            alignItems="stretch"
                            justifyContent="flex-start"
                ...
                <Grid item xs={12} sm={12}>
                  <Grid
                    id="FlexedemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInResidentDistrictViewDefaultIssueViewEditOtherDebatesDebates"
                    container
                    direction="row"
                    alignItems="flex-start"
                    justifyContent="flex-start"
                  ...
                  >
                    <Grid item xs={12} sm={12}>
                      <Grid
                        id="FlexedemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInResidentDistrictViewDefaultIssueViewEditOtherDebatesDebatesDebatesLabelWrapper"
                        container
                        direction="column"
                        alignItems="stretch"
                        justifyContent="flex-start"
                      ...
                      >
                        <Grid item xs={12} sm={12}>
                          <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                            ...
                            <Typography
                              id="LabeledemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInResidentDistrictViewDefaultIssueViewEditOtherDebatesDebatesDebatesLabelWrapperDebatesLabel"
                              variant="h5"
                              component="h1"
                            >
                        ...
                        <Grid item xs={12} sm={12}>
                          <Grid
                            id="TableedemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInResidentDistrictViewDefaultIssueViewEditOtherDebatesDebatesDebatesLabelWrapperDebates"
                            container
                            direction="column"
                            alignItems="stretch"
                            justifyContent="flex-start"
                ...
                <Grid item xs={12} sm={12}>
                  <Grid
                    id="FlexedemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInResidentDistrictViewDefaultIssueViewEditOtherCommentsComments"
                    container
                    direction="row"
                    alignItems="flex-start"
                    justifyContent="flex-start"
                  ...
                  >
                    <Grid item xs={12} sm={12}>
                      <Grid
                        id="FlexedemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInResidentDistrictViewDefaultIssueViewEditOtherCommentsCommentsActions"
                        container
                        direction="row"
                        alignItems="flex-start"
                        justifyContent="flex-start"
                      ...
                      >
                        <Grid item xs={12} sm={12} md={4.0}>
                          <LoadingButton
                            id="CallOperationActionedemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInResidentDistrictViewEdemokraciaAdminAdminEdemokraciaAdminIssueCreateCommentButtonCallOperation"
                            loading={isLoading}
                            variant={undefined}
                        ...
                        <Grid item xs={12} sm={12}>
                          <Grid
                            id="FlexedemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInResidentDistrictViewDefaultIssueViewEditOtherCommentsCommentsActionsCommentsLabelWrapper"
                            container
                            direction="column"
                            alignItems="stretch"
                            justifyContent="flex-start"
                          ...
                          >
                            <Grid item xs={12} sm={12}>
                              <Grid
                                id="TableedemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInResidentDistrictViewDefaultIssueViewEditOtherCommentsCommentsActionsCommentsLabelWrapperComments"
                                container
                                direction="column"
                                alignItems="stretch"
                                justifyContent="flex-start"
