...
export function CityLink(props: CityLinkProps) {
  ...
  const cityRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInResidentDistrictViewDefaultIssueViewEditOtherAreaAreaCityRepresentationFilter',
  ...
  return (
    <AggregationInput
      name="city"
      id="LinkedemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInResidentDistrictViewDefaultIssueViewEditOtherAreaAreaCity"
