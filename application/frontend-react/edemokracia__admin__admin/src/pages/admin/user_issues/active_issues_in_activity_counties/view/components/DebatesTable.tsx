...
export const ADMIN_USER_ISSUES_ACTIVE_ISSUES_IN_ACTIVITY_COUNTIES_VIEW_DEBATES =
  'AdminUserIssuesActiveIssuesInActivityCountiesViewDebates';
...
export const DebatesTable = (props: DebatesTableProps) => {
  ...
  const filterModelKey = `TableedemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInActivityCountiesViewDefaultIssueViewEditOtherDebatesDebatesDebatesLabelWrapperDebates-${ownerData.__identifier}-filterModel`;
  const filtersKey = `TableedemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInActivityCountiesViewDefaultIssueViewEditOtherDebatesDebatesDebatesLabelWrapperDebates-${ownerData.__identifier}-filters`;
  ...
  const debatesRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInActivityCountiesViewDefaultIssueViewEditOtherDebatesDebatesDebatesLabelWrapperDebatesStatusFilter',
    ...
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInActivityCountiesViewDefaultIssueViewEditOtherDebatesDebatesDebatesLabelWrapperDebatesTitleFilter',
      attributeName: 'title',
    ...
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInActivityCountiesViewDefaultIssueViewEditOtherDebatesDebatesDebatesLabelWrapperDebatesCloseAtFilter',
    ...
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInActivityCountiesViewDefaultIssueViewEditOtherDebatesDebatesDebatesLabelWrapperDebatesDescriptionFilter',
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              <Button
                id="TableedemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInActivityCountiesViewDefaultIssueViewEditOtherDebatesDebatesDebatesLabelWrapperDebates-filter"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() =>
                  filter(
                    'TableedemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInActivityCountiesViewDefaultIssueViewEditOtherDebatesDebatesDebatesLabelWrapperDebates-filter',
                    filterOptions,
                    filters,
                  )
                }
