...
// Page name: edemokracia::admin::UserIssues.activeIssuesInActivityCounties#Table
...
/**
 * Name: edemokracia::admin::UserIssues.activeIssuesInActivityCounties#Table
 * Is Access: false
 * Type: Table
 **/
export default function AdminUserIssuesActiveIssuesInActivityCountiesTable() {
      ...
      <PageContainerTransition>
        <Box sx={mainContainerPadding}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card>
                <CardContent id="PageDefinitionedemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInActivityCountiesTable-data-grid">
                  <Issue_TableTable
                    ref={tableRef}
