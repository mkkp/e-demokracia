...
export type PageFilterActiveIssuesInResidentCityAction = (
  id: string,
  filterOptions: FilterOption[],
  filters: Filter[],
) => Promise<void>;

export const usePageFilterActiveIssuesInResidentCityAction = (
  ...
  return async function pageFilterActiveIssuesInResidentCityAction(
    id: string,
    filterOptions: FilterOption[],
    filters: Filter[],
  ) {
