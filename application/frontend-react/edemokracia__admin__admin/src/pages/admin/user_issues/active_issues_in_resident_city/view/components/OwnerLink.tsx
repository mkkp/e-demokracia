...
export function OwnerLink(props: OwnerLinkProps) {
  ...
  const ownerRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInResidentCityViewDefaultIssueViewEditIssueLabelWrapperIssueOwnerRepresentationFilter',
  ...
  return (
    <AggregationInput
      name="owner"
      id="LinkedemokraciaAdminAdminEdemokraciaAdminUserIssuesActiveIssuesInResidentCityViewDefaultIssueViewEditIssueLabelWrapperIssueOwner"
