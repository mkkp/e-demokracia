...
export function OwnerLink(props: OwnerLinkProps) {
  ...
  const ownerRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteDefinitionVoteEntriesViewDefaultSelectAnswerVoteEntryViewEditOwnerRepresentationFilter',
  ...
  return (
    <AggregationInput
      name="owner"
      id="LinkedemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteDefinitionVoteEntriesViewDefaultSelectAnswerVoteEntryViewEditOwner"
      required={true}
