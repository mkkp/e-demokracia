...
export const ADMIN_SELECT_ANSWER_VOTE_DEFINITION_DEBATE_VIEW_PROS = 'AdminSelectAnswerVoteDefinitionDebateViewPros';
...
export const ProsTable = (props: ProsTableProps) => {
  ...
  const filterModelKey = `TableedemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteDefinitionDebateViewDefaultDebateViewEditTabBarArgumentsArgumentsProsLabelWrapperPros-${ownerData.__identifier}-filterModel`;
  const filtersKey = `TableedemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteDefinitionDebateViewDefaultDebateViewEditTabBarArgumentsArgumentsProsLabelWrapperPros-${ownerData.__identifier}-filters`;
  ...
  const prosRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteDefinitionDebateViewDefaultDebateViewEditTabBarArgumentsArgumentsProsLabelWrapperProsTitleFilter',
      attributeName: 'title',
    ...
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteDefinitionDebateViewDefaultDebateViewEditTabBarArgumentsArgumentsProsLabelWrapperProsUpVotesFilter',
    ...
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteDefinitionDebateViewDefaultDebateViewEditTabBarArgumentsArgumentsProsLabelWrapperProsDownVotesFilter',
  ...
  const prosRowActions: TableRowAction<AdminProStored>[] = [
    {
      id: 'DeleteActionedemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteDefinitionDebateViewEdemokraciaAdminAdminEdemokraciaAdminDebateProsRowDelete',
    ...
    {
      id: 'CallOperationActionedemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteDefinitionDebateViewEdemokraciaAdminAdminEdemokraciaAdminProVoteUpButtonCallOperation',
    ...
    {
      id: 'CallOperationActionedemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteDefinitionDebateViewEdemokraciaAdminAdminEdemokraciaAdminProVoteDownButtonCallOperation',
    ...
    {
      id: 'CallOperationActionedemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteDefinitionDebateViewEdemokraciaAdminAdminEdemokraciaAdminProCreateSubArgumentButtonCallOperation',
    ...
    {
      id: 'CallOperationActionedemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteDefinitionDebateViewEdemokraciaAdminAdminEdemokraciaAdminProCreateCommentButtonCallOperation',
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              <Button
                id="TableedemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteDefinitionDebateViewDefaultDebateViewEditTabBarArgumentsArgumentsProsLabelWrapperPros-filter"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() =>
                  filter(
                    'TableedemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteDefinitionDebateViewDefaultDebateViewEditTabBarArgumentsArgumentsProsLabelWrapperPros-filter',
                    filterOptions,
                    filters,
                  )
                }
