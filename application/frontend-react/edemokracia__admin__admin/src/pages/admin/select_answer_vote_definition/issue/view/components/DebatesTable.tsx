...
export const ADMIN_SELECT_ANSWER_VOTE_DEFINITION_ISSUE_VIEW_DEBATES = 'AdminSelectAnswerVoteDefinitionIssueViewDebates';
...
export const DebatesTable = (props: DebatesTableProps) => {
  ...
  const filterModelKey = `TableedemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteDefinitionIssueViewDefaultIssueViewEditOtherDebatesDebatesDebatesLabelWrapperDebates-${ownerData.__identifier}-filterModel`;
  const filtersKey = `TableedemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteDefinitionIssueViewDefaultIssueViewEditOtherDebatesDebatesDebatesLabelWrapperDebates-${ownerData.__identifier}-filters`;
  ...
  const debatesRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteDefinitionIssueViewDefaultIssueViewEditOtherDebatesDebatesDebatesLabelWrapperDebatesStatusFilter',
    ...
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteDefinitionIssueViewDefaultIssueViewEditOtherDebatesDebatesDebatesLabelWrapperDebatesTitleFilter',
      attributeName: 'title',
    ...
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteDefinitionIssueViewDefaultIssueViewEditOtherDebatesDebatesDebatesLabelWrapperDebatesCloseAtFilter',
    ...
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteDefinitionIssueViewDefaultIssueViewEditOtherDebatesDebatesDebatesLabelWrapperDebatesDescriptionFilter',
        ...
        components={{
          Toolbar: () => (
            <GridToolbarContainer>
              <Button
                id="TableedemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteDefinitionIssueViewDefaultIssueViewEditOtherDebatesDebatesDebatesLabelWrapperDebates-filter"
                startIcon={<MdiIcon path="filter" />}
                variant="text"
                onClick={() =>
                  filter(
                    'TableedemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteDefinitionIssueViewDefaultIssueViewEditOtherDebatesDebatesDebatesLabelWrapperDebates-filter',
                    filterOptions,
                    filters,
                  )
                }
