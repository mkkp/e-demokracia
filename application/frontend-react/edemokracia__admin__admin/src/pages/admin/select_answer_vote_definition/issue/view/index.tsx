...
// Page name: edemokracia::admin::SelectAnswerVoteDefinition.issue#View
// Page owner name: edemokracia::admin::Admin
// Page DataElement name: issue
// Page DataElement owner name: edemokracia::admin::SelectAnswerVoteDefinition
...
export type AdminSelectAnswerVoteDefinitionIssueViewPostRefreshAction = (
...
export const ADMIN_SELECT_ANSWER_VOTE_DEFINITION_ISSUE_VIEW_POST_REFRESH_HOOK_INTERFACE_KEY =
  'AdminSelectAnswerVoteDefinitionIssueViewPostRefreshHook';
export type AdminSelectAnswerVoteDefinitionIssueViewPostRefreshHook =
  () => AdminSelectAnswerVoteDefinitionIssueViewPostRefreshAction;

/**
 * Name: edemokracia::admin::SelectAnswerVoteDefinition.issue#View
 * Is Access: false
 * Type: View
 * Edit Mode Available: false
 **/
export default function AdminSelectAnswerVoteDefinitionIssueView() {
  ...
  const { service: postRefreshHook } = useTrackService<AdminSelectAnswerVoteDefinitionIssueViewPostRefreshHook>(
    `(${OBJECTCLASS}=${ADMIN_SELECT_ANSWER_VOTE_DEFINITION_ISSUE_VIEW_POST_REFRESH_HOOK_INTERFACE_KEY})`,
  );
  const postRefreshAction: AdminSelectAnswerVoteDefinitionIssueViewPostRefreshAction | undefined =
        ...
        <Box sx={mainContainerPadding}>
          ...
          >
            <Grid item xs={12} sm={12}>
              <Grid
                id="FlexedemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteDefinitionIssueViewDefaultIssueViewEditActions"
                container
                direction="row"
              ...
              >
                <Grid item xs={12}>
                  <Grid container spacing={2}>
                    <Grid item>
                      <LoadingButton
                        id="ButtonedemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteDefinitionIssueViewDefaultIssueViewEditActionsPageActionButtonsCreateDebate"
                        loading={isLoading}
                    ...
                    {!data.isFavorite && (
                      <Grid item>
                        <LoadingButton
                          id="ButtonedemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteDefinitionIssueViewDefaultIssueViewEditActionsPageActionButtonsAddToFavorites"
                          loading={isLoading}
                    ...
                    {!data.isNotFavorite && (
                      <Grid item>
                        <LoadingButton
                          id="ButtonedemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteDefinitionIssueViewDefaultIssueViewEditActionsPageActionButtonsRemoveFromFavorites"
                          loading={isLoading}
            ...
            <Grid item xs={12} sm={12}>
              <Card id="FlexedemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteDefinitionIssueViewDefaultIssueViewEditIssueLabelWrapper">
                <CardContent>
                  <Grid container direction="column" alignItems="stretch" justifyContent="flex-start" spacing={2}>
                    <Grid item xs={12} sm={12}>
                      <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                        ...
                        <Typography
                          id="LabeledemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteDefinitionIssueViewDefaultIssueViewEditIssueLabelWrapperIssueLabel"
                          variant="h5"
                          component="h1"
                        >
                    ...
                    <Grid item xs={12} sm={12}>
                      <Grid
                        id="FlexedemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteDefinitionIssueViewDefaultIssueViewEditIssueLabelWrapperIssue"
                        container
                        direction="row"
                        alignItems="stretch"
                        justifyContent="flex-start"
                      ...
                      >
                        ...
                        <Grid item xs={12} sm={12} md={4.0}>
                          <TextField
                            ...
                            id="EnumerationComboedemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteDefinitionIssueViewDefaultIssueViewEditIssueLabelWrapperIssueDefaultVoteType"
                            label={
                        ...
                        <Grid item xs={12} sm={12} md={4.0}>
                          <TextField
                            required={true}
                            name="title"
                            id="TextInputedemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteDefinitionIssueViewDefaultIssueViewEditIssueLabelWrapperIssueTitle"
                        ...
                        <Grid item xs={12} sm={12} md={4.0}>
                          <TextField
                            required={true}
                            name="status"
                            id="EnumerationComboedemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteDefinitionIssueViewDefaultIssueViewEditIssueLabelWrapperIssueStatus"
                        ...
                        <Grid item xs={12} sm={12} md={4.0}>
                          <DateTimePicker
                            ...
                            slotProps={{
                              textField: {
                                id: 'DateTimeInputedemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteDefinitionIssueViewDefaultIssueViewEditIssueLabelWrapperIssueCreated',
                                required: false,
                        ...
                        <Grid item xs={12} sm={12}>
                          <TextField
                            required={true}
                            name="description"
                            id="TextAreaedemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteDefinitionIssueViewDefaultIssueViewEditIssueLabelWrapperIssueDescription"
            ...
            <Grid container item xs={12} sm={12}>
              <ModeledTabs
                id="TabControlleredemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteDefinitionIssueViewDefaultIssueViewEditOther"
                ownerData={data}
                validation={validation}
                orientation='horizontal'
                childTabs={[
                  {
                    id: 'TabedemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteDefinitionIssueViewDefaultIssueViewEditOtherArea',
                  ...
                  {
                    id: 'TabedemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteDefinitionIssueViewDefaultIssueViewEditOtherAttachments',
                  ...
                  {
                    id: 'TabedemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteDefinitionIssueViewDefaultIssueViewEditOtherCategories',
                  ...
                  {
                    id: 'TabedemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteDefinitionIssueViewDefaultIssueViewEditOtherDebates',
                  ...
                  {
                    id: 'TabedemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteDefinitionIssueViewDefaultIssueViewEditOtherComments',
              ...
              >
                <Grid item xs={12} sm={12}>
                  <Grid
                    id="FlexedemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteDefinitionIssueViewDefaultIssueViewEditOtherAreaArea"
                    container
                    direction="row"
                    alignItems="flex-start"
                    justifyContent="flex-start"
                ...
                <Grid item xs={12} sm={12}>
                  <Grid
                    id="FlexedemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteDefinitionIssueViewDefaultIssueViewEditOtherAttachmentsAttachments"
                    container
                    direction="row"
                    alignItems="flex-start"
                    justifyContent="flex-start"
                  ...
                  >
                    <Grid item xs={12} sm={12}>
                      <Grid
                        id="FlexedemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteDefinitionIssueViewDefaultIssueViewEditOtherAttachmentsAttachmentsAttachmentsLabelWrapper"
                        container
                        direction="column"
                        alignItems="stretch"
                        justifyContent="flex-start"
                      ...
                      >
                        <Grid item xs={12} sm={12}>
                          <Grid
                            id="TableedemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteDefinitionIssueViewDefaultIssueViewEditOtherAttachmentsAttachmentsAttachmentsLabelWrapperAttachments"
                            container
                            direction="column"
                            alignItems="stretch"
                            justifyContent="flex-start"
                ...
                <Grid item xs={12} sm={12}>
                  <Grid
                    id="FlexedemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteDefinitionIssueViewDefaultIssueViewEditOtherCategoriesCategories"
                    container
                    direction="row"
                    alignItems="flex-start"
                    justifyContent="flex-start"
                  ...
                  >
                    <Grid item xs={12} sm={12}>
                      <Grid
                        id="FlexedemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteDefinitionIssueViewDefaultIssueViewEditOtherCategoriesCategoriesCategoriesLabelWrapper"
                        container
                        direction="column"
                        alignItems="stretch"
                        justifyContent="flex-start"
                      ...
                      >
                        <Grid item xs={12} sm={12}>
                          <Grid
                            id="TableedemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteDefinitionIssueViewDefaultIssueViewEditOtherCategoriesCategoriesCategoriesLabelWrapperCategories"
                            container
                            direction="column"
                            alignItems="stretch"
                            justifyContent="flex-start"
                ...
                <Grid item xs={12} sm={12}>
                  <Grid
                    id="FlexedemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteDefinitionIssueViewDefaultIssueViewEditOtherDebatesDebates"
                    container
                    direction="row"
                    alignItems="flex-start"
                    justifyContent="flex-start"
                  ...
                  >
                    <Grid item xs={12} sm={12}>
                      <Grid
                        id="FlexedemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteDefinitionIssueViewDefaultIssueViewEditOtherDebatesDebatesDebatesLabelWrapper"
                        container
                        direction="column"
                        alignItems="stretch"
                        justifyContent="flex-start"
                      ...
                      >
                        <Grid item xs={12} sm={12}>
                          <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                            ...
                            <Typography
                              id="LabeledemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteDefinitionIssueViewDefaultIssueViewEditOtherDebatesDebatesDebatesLabelWrapperDebatesLabel"
                              variant="h5"
                              component="h1"
                            >
                        ...
                        <Grid item xs={12} sm={12}>
                          <Grid
                            id="TableedemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteDefinitionIssueViewDefaultIssueViewEditOtherDebatesDebatesDebatesLabelWrapperDebates"
                            container
                            direction="column"
                            alignItems="stretch"
                            justifyContent="flex-start"
                ...
                <Grid item xs={12} sm={12}>
                  <Grid
                    id="FlexedemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteDefinitionIssueViewDefaultIssueViewEditOtherCommentsComments"
                    container
                    direction="row"
                    alignItems="flex-start"
                    justifyContent="flex-start"
                  ...
                  >
                    <Grid item xs={12} sm={12}>
                      <Grid
                        id="FlexedemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteDefinitionIssueViewDefaultIssueViewEditOtherCommentsCommentsActions"
                        container
                        direction="row"
                        alignItems="flex-start"
                        justifyContent="flex-start"
                      ...
                      >
                        <Grid item xs={12} sm={12} md={4.0}>
                          <LoadingButton
                            id="CallOperationActionedemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteDefinitionIssueViewEdemokraciaAdminAdminEdemokraciaAdminIssueCreateCommentButtonCallOperation"
                            loading={isLoading}
                            variant={undefined}
                        ...
                        <Grid item xs={12} sm={12}>
                          <Grid
                            id="FlexedemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteDefinitionIssueViewDefaultIssueViewEditOtherCommentsCommentsActionsCommentsLabelWrapper"
                            container
                            direction="column"
                            alignItems="stretch"
                            justifyContent="flex-start"
                          ...
                          >
                            <Grid item xs={12} sm={12}>
                              <Grid
                                id="TableedemokraciaAdminAdminEdemokraciaAdminSelectAnswerVoteDefinitionIssueViewDefaultIssueViewEditOtherCommentsCommentsActionsCommentsLabelWrapperComments"
                                container
                                direction="column"
                                alignItems="stretch"
                                justifyContent="flex-start"
