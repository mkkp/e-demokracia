...
export const menus: NavItemType[] = [
  ...
  {
    id: 'NavigationItemedemokraciaAdminAdminEdemokraciaAdminAdminNavigationControllerEdemokraciaAdminAdminUserDebatesNavigationItem',
    type: 'item',
    url: 'admin/admin/user_debates/view/:signedIdentifier',
    icon: 'wechat',
    title: 'Debates',
    children: [],
  },
  {
    ...
    children: [
      ...
      {
        id: 'NavigationItemedemokraciaAdminAdminEdemokraciaAdminAdminNavigationControllerEdemokraciaAdminAdminMenuItemGroupAdministrativeMenuGroupEdemokraciaAdminAdminAdminDebatesNavigationItem',
        type: 'item',
