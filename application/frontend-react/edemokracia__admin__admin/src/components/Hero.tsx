...
export function Hero(props: HeroProps) {
  ...
  return (
    <Box id="application-hero" sx={{ p: 2, display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
      ...
      <Box sx={{ p: 2, display: 'flex', flexDirection: 'column', alignItems: 'stretch', maxWidth }}>
        {props.preferredUsername && (
          <Typography
            id="application-hero-preferred-username"
        ...
        {props.email && (
          <Typography
            id="application-hero-email"
            sx={{ fontWeight: 'light', textOverflow: 'ellipsis', whiteSpace: 'nowrap', overflow: 'hidden' }}
          >
            {props.email}
          </Typography>
        )}
